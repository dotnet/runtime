...
| MSBuild task / target failure | `MSB####` | Missing file, malformed XML, broken import, or broken repository target. |
...
| ---- | ------- | --------- | ------- |
| `CS0103` | `System.Private.CoreLib` | `Foo.cs:42` | The name 'foo' does not exist… |
...
- Use the project's preferred terms (e.g., `CoreCLR`, `Mono`, `NativeAOT`, `libraries`, `eng/common`, `Helix`) instead of generic phrasing.
