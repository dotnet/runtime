...
- Do not fix existing code style mistakes unless they are in lines of code you are already working with, or have been explicitly instructed to address formatting in unrelated areas.
