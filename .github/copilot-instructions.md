...
If the changes are intended to improve performance, or if they could negatively impact performance, use the `microbenchmark` skill to validate the impact before completing.
