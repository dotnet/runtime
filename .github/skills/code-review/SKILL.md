...
10. **Format code suggestions correctly.** Any code you suggest must be intended matching the surrounding code and must follow the same formatting and code style.
