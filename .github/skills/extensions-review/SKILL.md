...
description: "Guidance for writing and modifying Microsoft.Extensions.* and System.IO.Compression code in dotnet/runtime. Covers DI lifetime management, configuration binding, options validation, logging provider patterns, caching semantics, compression format correctness, and host lifecycle. For full code review, delegates to the @extensions-reviewer agent. Trigger words: extensions, configuration, dependency injection, DI, logging, caching, hosting, options, compression, zip, gzip, brotli, IOptions, IServiceCollection, IConfiguration, ILogger, IHost, ZipArchive, IMemoryCache, HybridCache, FileProvider, HttpClientFactory."
---
