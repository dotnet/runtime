...
class IssueGenerator:
    ...
    def _one_failure(self, fail, go):
        ...
        out.append("")
        out.append("**Generated by ci-pipeline-monitor/scripts/generate_report.py**")

        temp_file = tempfile.NamedTemporaryFile('w', encoding="utf8", delete_on_close=False, newline="\r\n")
...
def main():
    ...
    parser.add_argument("--go", default=False, help=f"Actually file issues and comments instead of performing a dry run (default: False)")
