...
class ReportGenerator:
    ...
    def _footer(self, out):
        ...
        if self.validation_warnings:
            out.append("")
            out.append("⚠️ This report has unresolved validation warnings. See debug log for details.")
...
def main():
    ...
    parser.add_argument("--validation-warnings", action="store_true",
                        help="Add a note to the report footer about unresolved validation warnings")
