...
| `.github/skills/breaking-change-doc/Get-VersionInfo.ps1` | Git-based .NET version detection |
...
```
pwsh .github/skills/breaking-change-doc/Get-VersionInfo.ps1 -PrNumber <number> -RepoRoot .
```
...
### Post the comment (interactive use)
