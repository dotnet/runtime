...
usage()
{
  ...
  echo "                                  [Default: Debug]"
  echo "  --os                            Target operating system: windows, Linux, FreeBSD, OSX, Catalyst, tvOS, iOS, Android,"
     ...
     -os)
      ...
      case "$passedOS" in
        ...
        *)
          ...
          echo "The allowed values are windows, Linux, FreeBSD, OSX, Catalyst, tvOS, iOS, Android, Browser, illumos and Solaris."
          exit 1
          ;;
      esac
