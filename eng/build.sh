...
initDistroRid()
{
    ...
    if [[ $isCrossBuild == 1 && "$targetOs" != "osx" && "$targetOs" != "openharmony" && "$targetOs" != "android" && "$targetOs" != "ios" && "$targetOs" != "iossimulator" && "$targetOs" != "tvos" && "$targetOs" != "tvossimulator" && "$targetOs" != "maccatalyst" ]]; then
