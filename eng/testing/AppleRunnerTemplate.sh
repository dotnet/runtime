...
if [[ "$TARGET_OS" == "iOS-sim" && "$TARGET_ARCH" == "x86" ]]; then TARGET=ios-simulator-32; fi
if [[ "$TARGET_OS" == "iOS-sim" && "$TARGET_ARCH" == "x64" ]]; then TARGET=ios-simulator-64; fi
if [[ "$TARGET_OS" == "iOS-sim" && "$TARGET_ARCH" == "arm64" ]]; then TARGET=ios-simulator-64; fi
if [[ "$TARGET_OS" == "iOS" && "$TARGET_ARCH" == "arm" ]]; then TARGET=ios-device; fi
if [[ "$TARGET_OS" == "iOS" && "$TARGET_ARCH" == "arm64" ]]; then TARGET=ios-device; fi

if [[ "$TARGET_OS" == "tvOS-sim" && "$TARGET_ARCH" == "x64" ]]; then TARGET=tvos-simulator; fi
if [[ "$TARGET_OS" == "tvOS-sim" && "$TARGET_ARCH" == "arm64" ]]; then TARGET=tvos-simulator; fi
