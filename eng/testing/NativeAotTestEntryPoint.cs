...
/// <summary>
/// Custom entry point for NativeAOT test projects.
/// The default xunit v3 ConsoleRunner.Run(args) uses Assembly.GetEntryAssembly().Location
/// to find the test assembly file, but in NativeAOT Assembly.Location returns empty string.
/// This entry point constructs the XunitProjectAssembly directly using Environment.ProcessPath,
/// bypassing the file-based assembly lookup.
/// </summary>
internal static class NativeAotTestEntryPoint
{
