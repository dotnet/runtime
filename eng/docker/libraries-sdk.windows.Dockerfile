...
RUN Invoke-WebRequest -Uri https://raw.githubusercontent.com/dotnet/install-scripts/ed0fada7604a03898bf420a43984b2cc78a22523/src/dotnet-install.ps1 -OutFile .\dotnet-install.ps1
