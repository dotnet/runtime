...
elseif (ILLUMOS)
  ...
  message(FATAL_ERROR "Arch is ${TARGET_ARCH_NAME}. Only armel, arm, arm64, s390x, ppc64le and x86 are supported!")
endif()
...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
  message(STATUS "**************Sapana Debug*********************")
  message(STATUS "CMake system name is Linux")
  message(STATUS "CROSS_ROOTFS=${CROSS_ROOTFS}")
...
if((TARGET_ARCH_NAME MATCHES "^(arm|armel|arm64|s390x|ppc64le)$" AND NOT "$ENV{__DistroRid}" MATCHES "android.*") OR ILLUMOS)
  message(STATUS  "************Sapana Debug****************")
  message(STATUS  "inside if ^ppc64le")
...
message(STATUS "LLVM_CROSS_DIR:${LLVM_CROSS_DIR}")
