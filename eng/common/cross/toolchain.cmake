...
elseif(TARGET_ARCH_NAME STREQUAL "arm64")
  if(DEFINED TIZEN_TOOLCHAIN) # For Tizen only
    add_linker_flag("-B${CROSS_ROOTFS}/usr/lib64/gcc/${TIZEN_TOOLCHAIN}")
    add_linker_flag("-L${CROSS_ROOTFS}/lib64")
    add_linker_flag("-L${CROSS_ROOTFS}/usr/lib64")
    add_linker_flag("-L${CROSS_ROOTFS}/usr/lib64/gcc/${TIZEN_TOOLCHAIN}")

    add_linker_flag("-Wl,--rpath-link=${CROSS_ROOTFS}/lib64")
    add_linker_flag("-Wl,--rpath-link=${CROSS_ROOTFS}/usr/lib64")
    add_linker_flag("-Wl,--rpath-link=${CROSS_ROOTFS}/usr/lib64/gcc/${TIZEN_TOOLCHAIN}")
  endif()
elseif(TARGET_ARCH_NAME STREQUAL "x86")
  add_linker_flag(-m32)
elseif(ILLUMOS)
   add_linker_flag("-L${CROSS_ROOTFS}/lib/amd64")
   add_linker_flag("-L${CROSS_ROOTFS}/usr/amd64/lib")
endif()
