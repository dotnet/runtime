...
if /i "%__UseEmcmake%" == "1" (
    call "!EMSDK_PATH!/emsdk_env.cmd" > nul 2>&1 && echo "PAVEL PATH %PATH%" && emcmake "%CMakePath%" %__ExtraCmakeParams% --no-warn-unused-cli -G "%__CmakeGenerator%" -B %__IntermediatesDir% -S %__SourceDir%
) else (
