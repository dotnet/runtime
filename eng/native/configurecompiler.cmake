...
elseif (CLR_CMAKE_HOST_UNIX)
  ...
  if(UPPERCASE_CMAKE_BUILD_TYPE STREQUAL DEBUG OR UPPERCASE_CMAKE_BUILD_TYPE STREQUAL CHECKED)
    ...
    if ((${__ASAN_POS} GREATER -1) OR (${__UBSAN_POS} GREATER -1))
      ...
      add_linker_flag("${CLR_SANITIZE_LINK_OPTIONS}" DEBUG)
      add_linker_flag("${CLR_SANITIZE_LINK_OPTIONS}" CHECKED)
      # -Wl and --gc-sections: drop unused sections\functions (similar to Windows /Gy function-level-linking)
      add_linker_flag("-Wl,--gc-sections" DEBUG)
...
elseif(CLR_CMAKE_HOST_FREEBSD)
  ...
  if (CMAKE_CXX_COMPILER_ID STREQUAL Clang)
    add_linker_flag("-Xlinker --build-id=sha1")
  else()
    add_linker_flag("-Wl,--build-id=sha1")
  endif()
