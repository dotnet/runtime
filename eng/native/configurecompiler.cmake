...
if (CLR_CMAKE_HOST_UNIX)
  ...
  if(CLR_CMAKE_HOST_MACCATALYST)
    ...
    if(CLR_CMAKE_HOST_ARCH_ARM64)
      set(CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET "arm64-apple-ios15.0-macabi")
      add_link_options(-target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET})
    elseif(CLR_CMAKE_HOST_ARCH_AMD64)
      set(CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET "x86_64-apple-ios15.0-macabi")
      add_link_options(-target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET})
    else()
      clr_unknown_arch()
    endif()
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET} ${DISABLE_OVERRIDING_MIN_VERSION_ERROR}")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET} ${DISABLE_OVERRIDING_MIN_VERSION_ERROR}")
    set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET} ${DISABLE_OVERRIDING_MIN_VERSION_ERROR}")
    set(CMAKE_OBJC_FLAGS "${CMAKE_OBJC_FLAGS}-target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET} ${DISABLE_OVERRIDING_MIN_VERSION_ERROR}")
    set(CMAKE_OBJCXX_FLAGS "${CMAKE_OBJCXX_FLAGS} -target ${CLR_CMAKE_MACCATALYST_DEPLOYMENT_TARGET} ${DISABLE_OVERRIDING_MIN_VERSION_ERROR}")
