...
if (CLR_CMAKE_ENABLE_SANITIZERS)
  ...
  if(${__ASAN_POS} GREATER -1)
    ...
    if (CLR_CMAKE_ENABLE_ASAN)
      ...
      add_compile_options($<$<COMPILE_LANG_AND_ID:C,AppleClang>:-fsanitize-address-use-after-return=never>)
      add_compile_options($<$<COMPILE_LANG_AND_ID:CXX,AppleClang>:-fsanitize-address-use-after-return=never>)
    endif()
  endif()
