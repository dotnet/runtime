...
if(CLR_CMAKE_TARGET_UNIX)
  ...
  if(CLR_CMAKE_TARGET_APPLE_MOBILE)
    add_compile_definitions($<$<NOT:$<BOOL:$<TARGET_PROPERTY:IGNORE_DEFAULT_TARGET_OS>>>:TARGET_APPLE_MOBILE>)
  endif()
  if(CLR_CMAKE_TARGET_APPLE_MOBILE_SIMULATOR)
    add_compile_definitions($<$<NOT:$<BOOL:$<TARGET_PROPERTY:IGNORE_DEFAULT_TARGET_OS>>>:TARGET_APPLE_MOBILE_SIMULATOR>)
  endif()
