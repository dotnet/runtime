...
if(CLR_CMAKE_HOST_UNIX)
  if(CLR_CMAKE_HOST_APPLE)
    add_linker_flag(-Wl,-dead_strip CHECKED)
    add_linker_flag(-Wl,-dead_strip RELEASE)
    add_linker_flag(-Wl,-dead_strip RELWITHDEBINFO)
  else()
    add_linker_flag(-Wl,--gc-sections CHECKED)
    add_linker_flag(-Wl,--gc-sections RELEASE)
    add_linker_flag(-Wl,--gc-sections RELWITHDEBINFO)
  endif()
endif()
