...
function(install_with_stripped_symbols targetName kind destination)
    if(NOT CLR_CMAKE_KEEP_NATIVE_SYMBOLS)
      ...
      install_symbol_file(${symbol_file} ${destination})
    endif()
...
# install_clr(TARGETS targetName [targetName2 ...] [ADDITIONAL_DESTINATIONS destination])
  ...
  foreach(targetName ${INSTALL_CLR_TARGETS})
    if (NOT "${INSTALL_CLR_COMPONENT}" STREQUAL "${targetName}")
      ...
      if (${componentIdx} EQUAL -1)
        message(FATAL_ERROR "The ${INSTALL_CLR_COMPONENT} component is not defined. Call add_component to define the component in the build.")
      endif()
