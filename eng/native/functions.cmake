...
function(add_sanitizers targetName)
  if (CLR_CMAKE_ENABLE_ASAN)
    ...
    if (MSVC)
      ...
      target_compile_options("${targetName}" PRIVATE $<$<AND:$<COMPILE_LANGUAGE:C,CXX>,$<OR:$<CONFIG:DEBUG>,$<CONFIG:CHECKED>>>:-fno-sanitize-address-vcasan-lib>)
      target_link_libraries("${targetName}" PRIVATE $<$<OR:$<CONFIG:DEBUG>,$<CONFIG:CHECKED>>:/INFERASANLIBS>)
    ...
    message("ASAN Disabled for target ${targetName}")
  endif()
endfunction()
