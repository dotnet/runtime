...
if(CLR_CMAKE_HOST_OS STREQUAL Darwin)
    ...
    if(CMAKE_SYSTEM_PROCESSOR STREQUAL x86_64)
        if(NOT CLR_CROSS_COMPONENTS_BUILD AND CLR_CMAKE_TARGET_ARCH STREQUAL arm64)
            set(CLR_CMAKE_HOST_UNIX_ARM64 1)
        else(CLR_CMAKE_TARGET_ARCH STREQUAL arm64)
            set(CLR_CMAKE_HOST_UNIX_AMD64 1)
        endif(CLR_CMAKE_TARGET_ARCH STREQUAL arm64)
