...
message(STATUS "CLR_CROSS_COMPONENTS_BUILD=${CLR_CROSS_COMPONENTS_BUILD}")
...
if(CLR_CMAKE_HOST_OS STREQUAL Linux)
    ...
    if(CLR_CROSS_COMPONENTS_BUILD)
	    ...
	    message(STATUS "Setting CLR_CMAKE_HOST_UNIX_POWERPC64 to 1")
...
elseif(CLR_CMAKE_HOST_UNIX_POWERPC64)
    message(STATUS "setting host arch to ppc64le")
...
if(NOT DEFINED CLR_CMAKE_TARGET_ARCH OR CLR_CMAKE_TARGET_ARCH STREQUAL "" )
  message(STATUS "setting target arch to host arch")
...
if (NOT DEFINED CLR_CMAKE_TARGET_ARCH)
    message(STATUS "*****CLR_CMAKE_TARGET_ARCH is not defined")
endif()
# Set target architecture variables
...
elseif(CLR_CMAKE_TARGET_ARCH STREQUAL wasm)
    ...
    message(STATUS "CLR_CMAKE_TARGET_ARCH is set to ${CLR_CMAKE_TARGET_ARCH}")
    message(STATUS "TARGET_ARCH_NAME is set to ${TARGET_ARCH_NAME}")
    clr_unknown_arch()
endif()
...
message(STATUS "************************")
message(STATUS "CLR_CMAKE_TARGET_OS=${CLR_CMAKE_TARGET_OS}")
message(STATUS "CLR_CMAKE_HOST_OS=${CLR_CMAKE_HOST_OS}")
message(STATUS "CLR_CMAKE_TARGET_ARCH=${CLR_CMAKE_TARGET_ARCH}")
message(STATUS "CLR_CMAKE_HOST_ARCH=${CLR_CMAKE_HOST_ARCH}")
