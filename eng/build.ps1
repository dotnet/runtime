...
function Get-Help() {
  ...
  Write-Host ("                                 [Default: {0} (Depends on your machine's architecture.)]" -f [System.Runtime.InteropServices.RuntimeInformation]::ProcessArchitecture.ToString().ToLowerInvariant())
