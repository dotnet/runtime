...
function Get-Help() {
  ...
  Write-Host "                                 the DEBUG flag off."
  Write-Host "                                 For non-optimized code with the DEBUG flag on, use the Debug configuration."
  ...
  Write-Host "                                 Checked is exclusive to the CLR runtime. Use it for optimized code with asserts and"
  Write-Host "                                 the DEBUG flag off."
  Write-Host "                                 For non-optimized code with the DEBUG flag on, use the Debug configuration."
  Write-Host "                                 [Default: Debug]"
