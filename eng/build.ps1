...
function Get-Help() {
  ...
  Write-Host ""
  Write-Host "* Build Release mono corelib and update Debug libraries testhost to run test on an updated corelib."
  Write-Host ".\build.cmd mono.corelib+libs.pretest -rc debug"
  Write-Host ""
  Write-Host ""
