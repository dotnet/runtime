#!/bin/bash
cat << 'CS' > src/native/managed/cdac/tests/UnitTests/BugRepro.cs
using System;
using Xunit;
using Moq;
...
CS
dotnet test src/native/managed/cdac/tests/UnitTests -c Debug --filter "TestNullHandle" --logger "console;verbosity=detailed"
