...
* [How to use .NET](https://docs.microsoft.com/dotnet/core/get-started) (with VS, VS Code, command-line CLI)
  ...
  * [Install daily builds of the SDK](https://github.com/dotnet/installer#installers-and-binaries)
  * [Install daily builds of the runtime](docs/project/dogfooding.md)
