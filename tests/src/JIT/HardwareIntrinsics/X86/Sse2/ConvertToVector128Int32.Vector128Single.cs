...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToVector128Int32Vector128Single()
        {
            var test = new SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Single();
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Single testClass)
            {
        ...
        static SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2).GetMethod(nameof(Sse2.ConvertToVector128Int32), new Type[] { typeof(Vector128<Single>) })
