...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2).GetMethod(nameof(Sse2.ConvertToVector128Single), new Type[] { typeof(Vector128<Int32>) })
