...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendInt322()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendInt322
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__BlendInt322 testClass)
            {
        ...
        static ImmBinaryOpTest__BlendInt322()
        {
            var random = new Random();
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!Succeeded)
            {
                Console.WriteLine($"{nameof(Avx2)}.{nameof(Avx2.Blend)}<Int32>(Vector128<Int32>.2, Vector128<Int32>): {method} failed:");
