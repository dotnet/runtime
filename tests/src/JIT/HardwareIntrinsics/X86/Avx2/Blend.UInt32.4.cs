...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendUInt324()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendUInt324
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__BlendUInt324 testClass)
            {
        ...
        static ImmBinaryOpTest__BlendUInt324()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public ImmBinaryOpTest__BlendUInt324()
        {
            Succeeded = true;
