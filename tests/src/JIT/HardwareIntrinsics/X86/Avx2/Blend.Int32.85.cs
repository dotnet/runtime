...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendInt3285()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendInt3285
    {
        ...
        {
            var result = typeof(Avx2).GetMethod(nameof(Avx2.Blend), new Type[] { typeof(Vector256<Int32>), typeof(Vector256<Int32>), typeof(byte) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!Succeeded)
            {
                Console.WriteLine($"{nameof(Avx2)}.{nameof(Avx2.Blend)}<Int32>(Vector256<Int32>.85, Vector256<Int32>): {method} failed:");
