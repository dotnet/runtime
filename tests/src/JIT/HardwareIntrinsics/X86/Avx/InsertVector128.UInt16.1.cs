...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmBinaryOpTest__InsertVector128UInt161
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__InsertVector128UInt161 testClass)
            {
        ...
        static ImmBinaryOpTest__InsertVector128UInt161()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public ImmBinaryOpTest__InsertVector128UInt161()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.InsertVector128(
                ...
                Avx.LoadVector128((UInt16*)(_dataTable.inArray2Ptr)),
                1
            );
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.InsertVector128(
                ...
                Avx.LoadAlignedVector128((UInt16*)(_dataTable.inArray2Ptr)),
                1
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.InsertVector128), new Type[] { typeof(Vector256<UInt16>), typeof(Vector128<UInt16>), typeof(byte) })
        ...
        public void RunLclVarScenario_Load()
        {
            ...
            var right = Avx.LoadVector128((UInt16*)(_dataTable.inArray2Ptr));
            var result = Avx.InsertVector128(left, right, 1);
        ...
        public void RunLclVarScenario_LoadAligned()
        {
            ...
            var right = Avx.LoadAlignedVector128((UInt16*)(_dataTable.inArray2Ptr));
            var result = Avx.InsertVector128(left, right, 1);
