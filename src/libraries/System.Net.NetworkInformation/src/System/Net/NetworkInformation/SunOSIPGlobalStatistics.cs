...
// Similar to the Android code (minimal statistics for now).

// More stuff available from kstats.
// May implement later.
...
{
    internal sealed class SunOSIPGlobalStatistics : IPGlobalStatistics
    {
        public SunOSIPGlobalStatistics(bool ipv4)
        {
            SunOSNetworkInterface[] networkInterfaces = SunOSNetworkInterface.GetSunOSNetworkInterfaces();
