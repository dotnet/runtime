...
namespace Microsoft.Extensions.Primitives
{
    public class StringTokenizerTest
    {
        ...
        [Fact]
        public void Constructor_ThrowsForStringSegmentWithoutValue()
        {
            ArgumentException exception = Assert.Throws<ArgumentException>(() => new StringTokenizer(new StringSegment((string)null), new[] { ',' }));
