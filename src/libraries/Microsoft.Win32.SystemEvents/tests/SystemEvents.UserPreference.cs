...
namespace Microsoft.Win32.SystemEventsTests
{
    public class UserPreferenceTests : SystemEventsTest
    {
        ...
        [ConditionalTheory(typeof(PlatformDetection), nameof(PlatformDetection.IsNotWindowsNanoAndServerCore))]
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsNotWindowsNanoAndServerCore))]
