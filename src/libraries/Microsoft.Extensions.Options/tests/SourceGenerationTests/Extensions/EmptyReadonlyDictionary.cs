    ...
    where TKey : notnull
{
    ...
    {
#pragma warning disable CS8601 // The recommended implementation: https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.dictionary-2.trygetvalue
        value = default;
