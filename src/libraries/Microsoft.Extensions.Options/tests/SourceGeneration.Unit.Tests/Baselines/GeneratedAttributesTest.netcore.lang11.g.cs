    ...
    namespace ValidationTest
{
    partial class OptionsUsingGeneratedAttributesValidator
    {
        ...
        public global::Microsoft.Extensions.Options.ValidateOptionsResult Validate(string? name, global::ValidationTest.OptionsUsingGeneratedAttributes options)
        {
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P0" : "OptionsUsingGeneratedAttributes.P0";
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P1" : "OptionsUsingGeneratedAttributes.P1";
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P2" : "OptionsUsingGeneratedAttributes.P2";
            validationResults.Clear();
            validationAttributes.Clear();
            validationAttributes.Add(global::__OptionValidationStaticInstances.__Attributes.A1);
