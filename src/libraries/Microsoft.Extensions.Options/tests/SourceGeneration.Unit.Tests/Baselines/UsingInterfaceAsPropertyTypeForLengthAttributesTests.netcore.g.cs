    ...
    namespace Test
{
    partial class MyOptionsValidator
    {
        ...
        public global::Microsoft.Extensions.Options.ValidateOptionsResult Validate(string? name, global::Test.MyOptions options)
        {
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P1" : "MyOptions.P1";
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P2" : "MyOptions.P2";
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P3" : "MyOptions.P3";
            validationResults.Clear();
            validationAttributes.Clear();
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P4" : "MyOptions.P4";
            validationResults.Clear();
            validationAttributes.Clear();
            validationAttributes.Add(global::__OptionValidationStaticInstances.__Attributes.A1);
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P5" : "MyOptions.P5";
            validationResults.Clear();
            validationAttributes.Clear();
            validationAttributes.Add(global::__OptionValidationStaticInstances.__Attributes.A2);
            ...
            context.DisplayName = (!string.IsNullOrEmpty(name) && name.Contains(".")) ? $"{name}.P6" : "MyOptions.P6";
            validationResults.Clear();
            validationAttributes.Clear();
            validationAttributes.Add(global::__OptionValidationStaticInstances.__Attributes.A3);
