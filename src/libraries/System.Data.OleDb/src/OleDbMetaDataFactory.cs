...
namespace System.Data.OleDb
{
    ...
    { // V1.2.3300
            ...
            base(XMLStream, serverVersion, serverVersionNormalized)
        {
            ...
            if ((populationMechanism is null) || (typeof(string) != populationMechanism.DataType))
            {
            ...
            if ((collectionName is null) || (typeof(string) != collectionName.DataType))
            {
            ...
            if (restrictionsTable is not null)
            {
                ...
                if ((restrictionCollectionName is null) || (typeof(string) != restrictionCollectionName.DataType))
                {
