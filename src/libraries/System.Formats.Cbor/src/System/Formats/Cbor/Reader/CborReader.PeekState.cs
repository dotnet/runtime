...
namespace System.Formats.Cbor
{
    public partial class CborReader
    {
        ...
        /// when the next token is incomplete in the current buffer, or when <see cref="AllowMultipleRootLevelValues" /> is enabled
        /// and the buffer ends after a complete root-level value, instead of throwing <see cref="CborContentException" />.</para>
        /// <para>Any other returned token state guarantees that the method reading that single token will not fail
