    ...
    public class ManagementObject : ManagementBaseObject, ICloneable
    {
        ...
        private void ManagementObjectCTOR(ManagementScope scope, ManagementPath path, ObjectGetOptions options)
        {
            ...
            if ((path is not null) && !path.IsEmpty)
            {
                ...
                if ((scope is not null) && (scope.Path.NamespacePath.Length > 0))
                {
        ...
        public virtual ManagementPath Path
        {
            ...
            set
            {
                ManagementPath newPath = (value is not null) ? value : new ManagementPath();
        ...
        public void Get()
        {
            ...
            if ((path is null) || (path.Path.Length == 0))
                throw new InvalidOperationException();
            else
            {
                ObjectGetOptions gOptions =
                    (options is null) ? new ObjectGetOptions() : options;
            ...
            EnumerationOptions options)
        {
            ...
            EnumerationOptions o = (options is not null) ? options : new EnumerationOptions();
            ...
            EnumerationOptions options)
        {
            ...
            else
            {
                ...
                EnumerationOptions o = (options is not null)
            ...
            EnumerationOptions options)
        {
            ...
            EnumerationOptions o =
                (options is not null) ? options : new EnumerationOptions();
            ...
            EnumerationOptions options)
        {
            ...
            else
            {
                ...
                // Ensure we switch off ReturnImmediately as this is invalid for async calls
                EnumerationOptions o =
                    (options is not null) ? (EnumerationOptions)options.Clone() :
        ...
        public ManagementPath Put(PutOptions options)
        {
            ...
            Initialize(true);
            PutOptions o = (options is not null) ? options : new PutOptions();
        ...
        public void CopyTo(ManagementOperationObserver watcher, ManagementPath path, PutOptions options)
        {
            ...
            else
            {
                ...
                PutOptions o = (options is not null) ? (PutOptions)options.Clone() : new PutOptions();
        ...
        public void Delete(DeleteOptions options)
        {
            ...
            Initialize(false);
            DeleteOptions o = (options is not null) ? options : new DeleteOptions();
            IWbemServices wbemServices = scope.GetIWbemServices();
        ...
        public void Delete(ManagementOperationObserver watcher, DeleteOptions options)
        {
            ...
            {
                Initialize(false);
                DeleteOptions o = (options is not null) ? (DeleteOptions)options.Clone() : new DeleteOptions();
            ...
            InvokeMethodOptions options)
        {
            ...
            {
                Initialize(false);
                InvokeMethodOptions o = (options is not null) ? options : new InvokeMethodOptions();
                SecurityHandler securityHandler = null;
                int status = (int)ManagementStatus.NoError;
                ...
                try
                {
                    ...
                    IWbemClassObjectFreeThreaded inParams = (inParameters is null) ? null : inParameters.wbemObject;
            ...
            InvokeMethodOptions options)
        {
            ...
            {
                Initialize(false);
                InvokeMethodOptions o = (options is not null) ?
            ...
            out IWbemClassObjectFreeThreaded outParametersClass)
        {
            ...
            else
            {
                ...
                if (wmiClass is null)
                {
                    ...
                    if ((classPath is null) || !(classPath.IsClass))
                        throw new InvalidOperationException();
                    else
                    {
        ...
        internal override void Initialize(bool getObject)
        {
            ...
            lock (this)
            {
                ...
                else if ((scope.Path is null) || scope.Path.IsEmpty)
                {
