    ...
    public class ManagementClass : ManagementObject
    {
        ...
        public override ManagementPath Path
        {
            ...
            set
            {
                ...
                if ((value is null) || value.IsClass || value.IsEmpty)
                    base.Path = value;
                else
        ...
        {
            if ((Path is null) || (null == Path.Path) || (0 == Path.Path.Length))
                throw new InvalidOperationException();

            Initialize(false);
            IEnumWbemClassObject enumWbem = null;

            EnumerationOptions o = (options is null) ? new EnumerationOptions() : (EnumerationOptions)options.Clone();
                                        ...
                                        EnumerationOptions options)
        {
            ...
            EnumerationOptions o = (options is null) ? new EnumerationOptions() :
                                            ...
                                            EnumerationOptions options)
        {
            ...
            EnumerationOptions o = (options is not null) ? (EnumerationOptions)options.Clone() : new EnumerationOptions();
            ...
            EnumerationOptions options)
        {
            ...
            else
            {
                ...
                EnumerationOptions o =
                        (options is not null) ? (EnumerationOptions)options.Clone() : new EnumerationOptions();
