...
namespace System.Management
{
    ...
    public class ManagementScope : ICloneable
    {
        ...
        public bool IsConnected
        {
            get
            {
                return (wbemServices is not null);
            }
        }
        ...
        internal ManagementScope(ManagementPath path, ManagementScope scope)
            : this(path, (scope is not null) ? scope.options : null) { }
        ...
        private void InitializeGuts(object o)
        {
            ...
            if (threadParam.options is null)
            {
            ...
            if ((nsPath is null) || (0 == nsPath.Length))
            {
