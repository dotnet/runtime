...
namespace System.Runtime.InteropServices.JavaScript
{
    ...
    public sealed class Uint8Array : JSObject
    {
        public Uint8Array(int length)
            : base(JavaScriptImports.CreateCSOwnedObject(nameof(Uint8Array), new object[] { length }), JSProxyContext.MainInstance)
        {
        ...
        public Uint8Array(ArrayBuffer buffer)
            : base(JavaScriptImports.CreateCSOwnedObject(nameof(Uint8Array), new object[] { buffer }), JSProxyContext.MainInstance)
        {
#if FEATURE_WASM_THREADS
            LegacyHostImplementation.ThrowIfLegacyWorkerThread();
#endif
        ...
        internal Uint8Array(IntPtr jsHandle) : base(jsHandle, JSProxyContext.MainInstance)
        { }
