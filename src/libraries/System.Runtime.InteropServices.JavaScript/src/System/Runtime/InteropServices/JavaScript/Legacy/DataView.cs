...
namespace System.Runtime.InteropServices.JavaScript
{
    ...
    public class DataView : JSObject
    {
        ...
        public DataView(ArrayBuffer buffer)
            : base(JavaScriptImports.CreateCSOwnedObject(nameof(DataView), new object[] { buffer }), JSProxyContext.MainInstance)
        {
        ...
        public DataView(ArrayBuffer buffer, int byteOffset)
            : base(JavaScriptImports.CreateCSOwnedObject(nameof(DataView), new object[] { buffer, byteOffset }), JSProxyContext.MainInstance)
        {
#if FEATURE_WASM_THREADS
            LegacyHostImplementation.ThrowIfLegacyWorkerThread();
#endif
        ...
        public DataView(ArrayBuffer buffer, int byteOffset, int byteLength)
            : base(JavaScriptImports.CreateCSOwnedObject(nameof(DataView), new object[] { buffer, byteOffset, byteLength }), JSProxyContext.MainInstance)
        {
#if FEATURE_WASM_THREADS
            LegacyHostImplementation.ThrowIfLegacyWorkerThread();
#endif
        ...
        internal DataView(IntPtr jsHandle) : base(jsHandle, JSProxyContext.MainInstance)
        { }
