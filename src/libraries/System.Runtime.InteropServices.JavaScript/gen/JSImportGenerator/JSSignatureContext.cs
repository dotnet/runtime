...
namespace Microsoft.Interop.JavaScript
{
    internal sealed record JSSignatureContext
    {
            ...
            CancellationToken token)
        {
            ...
            SignatureContext sigContext = SignatureContext.Create(method, jsMarshallingAttributeParser, env, new CodeEmitOptions(SkipInit: false), typeof(JSImportGenerator).Assembly);
