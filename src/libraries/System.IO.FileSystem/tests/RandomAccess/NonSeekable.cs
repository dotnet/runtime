...
namespace System.IO.Tests
{
    ...
    public class RandomAccess_NonSeekable
    {
        ...
        [Fact]
        public async Task VectorizedIOIsSupported_AsyncWrite_SyncReads()
        {
            (SafeFileHandle readHandle, SafeFileHandle writeHandle) = await GetNamedPipeHandlesAsync();
        ...
        [Fact]
        public async Task VectorizedIOIsSupported_AsyncWrite_SyncRead()
        {
            (SafeFileHandle readHandle, SafeFileHandle writeHandle) = await GetNamedPipeHandlesAsync();
        ...
        [Fact]
        public async Task VectorizedIOIsSupported_AsyncWrite_AsyncRead()
        {
            (SafeFileHandle readHandle, SafeFileHandle writeHandle) = await GetNamedPipeHandlesAsync();
        ...
        [Fact]
        public async Task VectorizedIOIsSupported_AsyncRead_SyncWrite()
        {
            (SafeFileHandle readHandle, SafeFileHandle writeHandle) = await GetNamedPipeHandlesAsync();
