...
{
    public class Path_Exists : FileSystemTest
    {
        ...
        [Theory,
           MemberData(nameof(ValidPathComponentNames))]
        public void ValidFilePathExists_ReturnsTrue(string component)
        {
        ...
        public void FileSymLinksMayExistIndependentlyOfTarget()
        {
        ...
        [Theory,
            MemberData(nameof(ValidPathComponentNames))]
        public void ValidDirectoryPathExists_ReturnsTrue(string component)
        {
            string path = Path.Combine(TestDirectory, component);
        ...
        [ConditionalFact(typeof(MountHelper), nameof(MountHelper.CanCreateSymbolicLinks))]
        public void DirectorySymLinksMayExistIndependentlyOfTarget()
        {
            var path = GetTestFilePath();
            var linkPath = GetRandomLinkPath();
        ...
        #region Platform Specific Common Tests
        [Theory,
        ...
        #region Platform Specific File Tests
        ...
        public void DoesCaseInsensitiveInvariantFileComparions()
        {
        ...
        public void DoesCaseSensitiveFileComparisons()
        {
            FileInfo testFile = new FileInfo(GetTestFilePath());
            testFile.Create().Dispose();
            Assert.True(Exists(testFile.FullName));
        ...
        #region Platform Specific Directory Tests
        ...
        [Fact]
        [PlatformSpecific(CaseInsensitivePlatforms)]
        public void DoesCaseInsensitiveInvariantDirectoryComparisons()
        {
        ...
        [Fact]
        [PlatformSpecific(CaseSensitivePlatforms)]
        public void DoesCaseSensitiveDirectoryComparisons()
        {
            DirectoryInfo testDir = Directory.CreateDirectory(GetTestFilePath());
            Assert.True(Exists(testDir.FullName));
