...
namespace System.Diagnostics
{
    ...
    public partial class Process : Component
    {
        ...
        public bool Start()
        {
            ...
            ConfigureAfterStart(processHandle);
            ...
            {
                _standardInput = new StreamWriter(OpenStream(processHandle._parentInputPipeHandle!, FileAccess.Write),
            ...
            {
                _standardOutput = new StreamReader(OpenStream(processHandle._parentOutputPipeHandle!, FileAccess.Read),
                    startInfo.StandardOutputEncoding ?? GetStandardOutputEncoding(), true, StreamBufferSize);
            }
            if (startInfo.RedirectStandardError)
            {
                _standardError = new StreamReader(OpenStream(processHandle._parentErrorPipeHandle!, FileAccess.Read),
        ...
        /// <summary>Platform-specific logic invoked after a process has been started to configure process state.</summary>
