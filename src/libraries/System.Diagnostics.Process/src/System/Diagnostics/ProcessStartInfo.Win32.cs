...
namespace System.Diagnostics
{
    ...
    public sealed partial class ProcessStartInfo
    {
        ...
        /// When you use the <see cref="System.Diagnostics.ProcessStartInfo.Verbs" /> property, you must include the file name extension when you set the value of the <see cref="System.Diagnostics.ProcessStartInfo.FileName" /> property. The file name extension determines the set of possible verbs.
        /// ## Examples
        ...
        /// [!code-vb[ProcessVerbs_Diagnostics#3](~/samples/snippets/visualbasic/VS_Snippets_CLR/ProcessVerbs_Diagnostics/VB/source.vb#3)]</remarks>
        ...
        /// > [!NOTE]
        /// > <see cref="System.Diagnostics.ProcessStartInfo.UseShellExecute" /> must be <see langword="false" /> if the <see cref="System.Diagnostics.ProcessStartInfo.UserName" /> property is not <see langword="null" /> or an empty string, or an <see cref="System.InvalidOperationException" /> will be thrown when the <see cref="System.Diagnostics.Process.Start(System.Diagnostics.ProcessStartInfo)" /> method is called.
        ...
        /// > [!NOTE]
        /// > <see cref="System.Diagnostics.ProcessStartInfo.UseShellExecute" /> must be <see langword="true" /> if you set the <see cref="System.Diagnostics.ProcessStartInfo.ErrorDialog" /> property to <see langword="true" />.
