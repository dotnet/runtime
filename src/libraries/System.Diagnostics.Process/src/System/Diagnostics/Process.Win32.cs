...
namespace System.Diagnostics
{
    ...
    public partial class Process : IDisposable
    {
        ...
        /// <remarks>The main window is the window opened by the process that currently has the focus (the <see langword="System.Windows.Forms.Form.TopLevel" /> form). You must use the <xref:System.Diagnostics.Process.Refresh" /> method to refresh the <xref:System.Diagnostics.Process" /> object to get the most up to date main window handle if it has changed. In general, because the window handle is cached, use <xref:System.Diagnostics.Process.Refresh" /> beforehand to guarantee that you'll retrieve the current handle.
        /// You can get the <xref:System.Diagnostics.Process.MainWindowHandle" /> property only for processes that are running on the local computer. The <xref:System.Diagnostics.Process.MainWindowHandle" /> property is a value that uniquely identifies the window that is associated with the process.
        /// A process has a main window associated with it only if the process has a graphical interface. If the associated process does not have a main window, the <xref:System.Diagnostics.Process.MainWindowHandle" /> value is zero. The value is also zero for processes that have been hidden, that is, processes that are not visible in the taskbar. This can be the case for processes that appear as icons in the notification area, at the far right of the taskbar.
        /// If you have just started a process and want to use its main window handle, consider using the <xref:System.Diagnostics.Process.WaitForInputIdle()" /> method to allow the process to finish starting, ensuring that the main window handle has been created. Otherwise, an exception will be thrown.</remarks>
        /// <exception cref="System.InvalidOperationException">The <xref:System.Diagnostics.Process.MainWindowHandle" /> is not defined because the process has exited.</exception>
        /// <exception cref="System.NotSupportedException">You are trying to access the <xref:System.Diagnostics.Process.MainWindowHandle" /> property for a process that is running on a remote computer. This property is available only for processes that are running on the local computer.</exception>
        ...
        /// <remarks><format type="text/markdown"><![CDATA[
        /// A process has a main window associated with it only if the process has a graphical interface. If the associated process does not have a main window (so that <xref:System.Diagnostics.Process.MainWindowHandle> is zero), or if the system can't determine that there's a main window (such as may be the case on some Unix platforms), <xref:System.Diagnostics.Process.MainWindowTitle> is an empty string ("").
        /// If you have just started a process and want to use its main window title, consider using the <xref:System.Diagnostics.Process.WaitForInputIdle> method to allow the process to finish starting, ensuring that the main window handle has been created. Otherwise, the system throws an exception.
        /// > [!NOTE]
        /// > The main window is the window that currently has the focus; note that this might not be the primary window for the process. You must use the <xref:System.Diagnostics.Process.Refresh> method to refresh the <xref:System.Diagnostics.Process> object to get the most up to date main window handle if it has changed.
        /// ## Examples
        ...
        /// ]]></format></remarks>
        /// <exception cref="System.InvalidOperationException">The <xref:System.Diagnostics.Process.MainWindowTitle" /> property is not defined because the process has exited.</exception>
        /// <exception cref="System.NotSupportedException">You are trying to access the <xref:System.Diagnostics.Process.MainWindowTitle" /> property for a process that is running on a remote computer. This property is available only for processes that are running on the local computer.</exception>
        ...
        /// If a process has a user interface, the <xref:System.Diagnostics.Process.Responding> property contacts the user interface to determine whether the process is responding to user input. If the interface does not respond immediately, the <xref:System.Diagnostics.Process.Responding> property returns `false`. Use this property to determine whether the interface of the associated process has stopped responding.
        /// If the process does not have a <xref:System.Diagnostics.Process.MainWindowHandle>, this property returns `true`.
        /// ## Examples
        ...
        /// ]]></format></remarks>
        /// <exception cref="System.InvalidOperationException">There is no process associated with this <xref:System.Diagnostics.Process" /> object.</exception>
        /// <exception cref="System.NotSupportedException">You are attempting to access the <xref:System.Diagnostics.Process.Responding" /> property for a process that is running on a remote computer. This property is available only for processes that are running on the local computer.</exception>
