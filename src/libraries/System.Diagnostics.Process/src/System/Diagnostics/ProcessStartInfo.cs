...
namespace System.Diagnostics
{
    ...
    public sealed partial class ProcessStartInfo
    {
        ...
        /// [!code-vb[Process.Start_static#2](~/samples/snippets/visualbasic/VS_Snippets_CLR/Process.Start_static/VB/processstartstatic2.vb)]</remarks>
        ...
        /// > [!NOTE]
        /// >  You must set <see cref="System.Diagnostics.ProcessStartInfo.UseShellExecute" /> to <see langword="false" /> if you want to set <see cref="System.Diagnostics.ProcessStartInfo.RedirectStandardInput" /> to <see langword="true" />. Otherwise, writing to the <see cref="System.Diagnostics.Process.StandardInput" /> stream throws an exception.
        /// ## Examples
        /// The following example illustrates how to redirect the <see cref="System.Diagnostics.Process.StandardInput" /> stream of a process. The `sort` command is a console application that reads and sorts text input.
        ...
        /// [!code-vb[ProcessOneStream#1](~/samples/snippets/visualbasic/VS_Snippets_CLR/ProcessOneStream/VB/stdstr.vb#1)]</remarks>
        /// <altmember cref="System.Diagnostics.ProcessStartInfo.UseShellExecute"/>
        ...
        /// > [!NOTE]
        /// >  When <see cref="System.Diagnostics.ProcessStartInfo.UseShellExecute" /> is <see langword="true" />, the working directory of the application that starts the executable is also the working directory of the executable.
        ...
        /// <remarks>> [!NOTE]
        /// >  <see cref="System.Diagnostics.ProcessStartInfo.UseShellExecute" /> must be <see langword="true" /> if you want to set <see cref="System.Diagnostics.ProcessStartInfo.ErrorDialog" /> to <see langword="true" />.</remarks>
        ...
        /// When you use the <see cref="System.Diagnostics.ProcessStartInfo.Verb" /> property, you must include the file name extension when you set the value of the <see cref="System.Diagnostics.ProcessStartInfo.FileName" /> property. The file name does not need to have an extension if you manually enter a value for the <see cref="System.Diagnostics.ProcessStartInfo.Verb" /> property.
        /// ## Examples
        /// The following code example starts a new process by using the specified verb and file name. This code example is part of a larger example provided for the <see cref="System.Diagnostics.ProcessStartInfo.Verbs" /> property.
        /// [!code-csharp[ProcessVerbs_Diagnostics#4](~/samples/snippets/csharp/VS_Snippets_CLR/ProcessVerbs_Diagnostics/CS/source.cs#4)]
        /// [!code-vb[ProcessVerbs_Diagnostics#4](~/samples/snippets/visualbasic/VS_Snippets_CLR/ProcessVerbs_Diagnostics/VB/source.vb#4)]</remarks>
