...
namespace System.Diagnostics
{
    ...
    public class ProcessModule : Component
    {
        ...
        /// <remarks><format type="text/markdown"><![CDATA[
        /// <xref:System.Diagnostics.ProcessModule.ModuleMemorySize%2A> does not include any additional memory allocations that the module makes once it is running; it includes only the size of the static code and data in the module file.
        /// ## Examples
