...
& "C:/live-runtime-artifacts/testhost/net$env:VERSION-windows-$env:CONFIGURATION-x64/dotnet" exec --roll-forward Major ./bin/$env:CONFIGURATION/net$env:VERSION/WebSocketStress.dll $env:STRESS_ARGS.Split(' ',[System.StringSplitOptions]::RemoveEmptyEntries)

$ExitCode = $LASTEXITCODE

if ($ExitCode -ne 0) {
    Write-Host "WebSocketStress failed, copying artifacts for investigation"
