...
namespace System.ComponentModel
{
    ...
    internal sealed partial class ReflectTypeDescriptionProvider : TypeDescriptionProvider
    {
        ...
        private static Dictionary<object, IntrinsicTypeConverterData> IntrinsicTypeConverters
        {
            get
            {
                return LazyInitializer.EnsureInitialized<Dictionary<object, IntrinsicTypeConverterData>>(ref s_intrinsicTypeConverters, GetConverters);
            }
        }

        private static Dictionary<object, IntrinsicTypeConverterData> GetConverters()
        {
        ...
        private static void TestFeatureCheck ()
        {
            if (NullableConverter.IsSupported)
                DoSomethingNasty();
                // AddNullableConverter(new Dictionary<object, IntrinsicTypeConverterData>());
        }
        [RequiresUnreferencedCode("DoSomethingd")]
        private static void DoSomethingNasty() {}
