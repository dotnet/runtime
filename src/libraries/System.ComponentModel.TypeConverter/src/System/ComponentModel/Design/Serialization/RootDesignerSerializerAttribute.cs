...
namespace System.ComponentModel.Design.Serialization
{
    ...
    [Obsolete("RootDesignerSerializerAttribute has been deprecated. Use DesignerSerializerAttribute. For example, to specify a root designer for CodeDom, use DesignerSerializerAttribute(...,typeof(TypeCodeDomSerializer)).")]
