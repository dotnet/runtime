...
namespace System.Globalization.Tests
{
    public class DateTimeFormatInfoDayNames
    {
        ...
        public static IEnumerable<object[]> DayNames_Get_TestData()
        {
            ...
            yield return new object[] { new CultureInfo("et-EE").DateTimeFormat, new string[] { "Pühapäev", "Esmaspäev", "Teisipäev", "Kolmapäev", "Neljapäev", "Reede", "Laupäev" } }; // should not be capitalized but JS has a bug
