    ...
    public class DateTimeFormatInfoGetEraName
    {
        public static IEnumerable<object[]> GetEraName_TestData()
        {
            ...
            else
            {
                ...
                yield return new object[] { new CultureInfo("bn-IN").DateTimeFormat, 0, "খৃষ্টাব্দ" };
                yield return new object[] { new CultureInfo("bn-IN").DateTimeFormat, 1, "খৃষ্টাব্দ" };
                ...
                yield return new object[] { new CultureInfo("vi-VN").DateTimeFormat, 0, "Sau CN" }; // sau CN
                yield return new object[] { new CultureInfo("vi-VN").DateTimeFormat, 1, "Sau CN" }; // sau CN
