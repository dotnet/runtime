...
namespace System.Globalization.Tests
{
    public class DateTimeFormatInfoAbbreviatedDayNames
    {
        ...
        public static IEnumerable<object[]> AbbreviatedDayNames_Get_TestData()
        {
            ...
            yield return PlatformDetection.IsBrowserDomSupportedOrNodeJS ?
                new object[] { new CultureInfo("da-DK").DateTimeFormat, new string[] { "søn.", "man.", "tirs.", "ons.", "tors.", "fre.", "lør." } } :
                new object[] { new CultureInfo("da-DK").DateTimeFormat, new string[] { "søn", "man", "tir", "ons", "tor", "fre", "lør" } };
