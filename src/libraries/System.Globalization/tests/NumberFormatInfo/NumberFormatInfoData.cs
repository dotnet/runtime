...
namespace System.Globalization.Tests
{
    internal static class NumberFormatInfoData
    {
        ...
        internal static int[] GetCurrencyNegativePatterns(string localeName)
        {
            ...
            {
                case "en-US":
                    return PlatformDetection.ShouldUseNls ? new int[] { 0 } : new int[] { 1, 0 };

                case "en-CA":
                    return PlatformDetection.ShouldUseNls ? new int[] { 1 } : new int[] { 1, 0 };
                ...
                case "as":
                    return PlatformDetection.ShouldUseNls ? new int[] { 12 } : new int[] { 9 };

                case "es-BO":
                    return (PlatformDetection.ShouldUseNls && PlatformDetection.WindowsVersion < 10) ? new int[] { 14 } : new int[] { 1 };

                case "fr-CA":
                    return PlatformDetection.ShouldUseNls ? new int[] { 15 } : new int[] { 8, 15 };
            }
