...
namespace System.Globalization.Tests
{
    public class CompareInfoCompareTests : CompareInfoTestsBase
    {
        ...
        public static IEnumerable<object[]> Compare_TestData()
        {
            ...
            var validIgnoreKanaTypeOption = PlatformDetection.IsHybridGlobalizationOnBrowser ?
            ...
            if (!PlatformDetection.IsHybridGlobalizationOnBrowser)
            {
                ...
                yield return new object[] { s_invariantCompare, "ABCDE", "\uFF43D", CompareOptions.IgnoreWidth, -1 }; // None: -1
                yield return new object[] { s_invariantCompare, "ABCDE", "c", CompareOptions.IgnoreWidth, -1 }; // None: -1
            ...
            yield return new object[] { s_invariantCompare, "\u3070\uFF8C\uFF9E\uFF8D\uFF9E\u307C", "\u30D6", validIgnoreKanaTypeOption, -1 }; // None: -1

            yield return new object[] { s_invariantCompare, "ABDDE", "D", CompareOptions.None, -1 };
            yield return new object[] { s_invariantCompare, "\u3060", "\u305F", validIgnoreKanaTypeOption, 1 }; // None: 1
            yield return new object[] { s_invariantCompare, "\u3060", "\u30C0", validIgnoreKanaTypeOption, 0 };

            yield return new object[] { s_invariantCompare, "\u68EE\u9D0E\u5916", "\u68EE\u9DD7\u5916", validIgnoreKanaTypeOption, -1 }; // None: -1
            yield return new object[] { s_invariantCompare, "\u68EE\u9DD7\u5916", "\u68EE\u9DD7\u5916", CompareOptions.IgnoreCase, 0 }; // None: 0
            yield return new object[] { s_invariantCompare, "\u2019\u2019\u2019\u2019", "''''", CompareOptions.None, 1 };
            yield return new object[] { s_invariantCompare, "\u2019", "'", validIgnoreKanaTypeOption, 1 }; // None: 1
            yield return new object[] { s_invariantCompare, "", "'", validIgnoreKanaTypeOption, -1 }; // None: -1
