...
namespace System.Globalization.Tests
{
    public class CompareInfoTests : CompareInfoTestBase
    {
        ...
        [ConditionalTheory(typeof(PlatformDetection), nameof(PlatformDetection.IsNotHybridGlobalizationOnWasm))]
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsHybridGlobalizationOnWasm))]
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsNotHybridGlobalizationOnWasm))]
