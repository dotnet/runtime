...
namespace System.Diagnostics.Tests
{
    public class ProviderMetadataTests
    {
        ...
        [ConditionalFact(typeof(Helpers), nameof(Helpers.SupportsEventLogs))]
        [ActiveIssue("https://github.com/dotnet/runtime/issues/64153", typeof(PlatformDetection), nameof(PlatformDetection.IsWindows), nameof(PlatformDetection.IsX64Process))]
