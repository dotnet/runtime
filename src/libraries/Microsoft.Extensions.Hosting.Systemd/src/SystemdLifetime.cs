...
namespace Microsoft.Extensions.Hosting.Systemd
{
    ...
    public partial class SystemdLifetime : IHostLifetime, IDisposable
    {
        ...
        /// <summary>Asynchronously waits until the start operation is complete before continuing. This method is called at the beginning of <see cref="IHost.StartAsync(CancellationToken)" />. This can be used to delay startup until signaled by an external event.</summary>
        /// <param name="cancellationToken">A cancellation token that indicates when stop should no longer be graceful.</param>
