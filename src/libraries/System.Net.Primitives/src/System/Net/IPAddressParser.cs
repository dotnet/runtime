    ...
    internal static class IPAddressParser
    {
            ...
            where TChar : unmanaged, IBinaryInteger<TChar>
        {
            ...
            else
            {
                ...
                long address = IPv4AddressHelper.ParseNonCanonical(ipSpan, ref end, notImplicitFile: true);
        ...
        {
            int end = ipSpan.Length;
            long tmpAddr = IPv4AddressHelper.ParseNonCanonical(ipSpan, ref end, notImplicitFile: true);
