...
namespace System.Security.Authentication
{
    ...
    public enum SslProtocols
    {
        ...
        Ssl3 = 48,
        [System.ObsoleteAttribute("TLS versions 1.0 and 1.1 are obsolete and not considered secure by the industry. Consider using newer TLS protocol version.", DiagnosticId = "SYSLIB0039", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
        Tls = 192,
