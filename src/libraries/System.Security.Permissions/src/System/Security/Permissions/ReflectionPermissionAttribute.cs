...
namespace System.Security.Permissions
{
    ...
    public sealed partial class ReflectionPermissionAttribute : CodeAccessSecurityAttribute
    {
        ...
        [Obsolete("ReflectionPermissionAttribute.ReflectionEmit has been deprecated and is no longer supported.")]
        public bool ReflectionEmit { get; set; }
        public bool RestrictedMemberAccess { get; set; }
        [Obsolete("ReflectionPermissionAttribute.TypeInformation has been deprecated and is no longer supported.")]
