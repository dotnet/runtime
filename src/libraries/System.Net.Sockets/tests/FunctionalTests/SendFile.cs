    ...
    public class SendFileTest : FileCleanupTestBase
    {
        ...
        public void Disposed_ThrowsException()
        {
            using (Socket s = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp))
            {
                ...
                Assert.Throws<ObjectDisposedException>(() => s.SendFile(null, default, default, TransmitFileOptions.UseDefaultWorkerThread));
        ...
        public void NotConnected_ThrowsException()
        {
            using (Socket s = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp))
            {
                ...
                Assert.Throws<NotSupportedException>(() => s.SendFile(null, default, default, TransmitFileOptions.UseDefaultWorkerThread));
