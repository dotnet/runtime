    ...
    internal sealed class SocketAsyncEngine
    {
        ...
        internal static IoUringNativeDiagnosticsSnapshotForTest GetIoUringNativeDiagnosticsSnapshotForTest()
        {
            ...
            return new IoUringNativeDiagnosticsSnapshotForTest(
                ...
                ReadProperty<ulong>(snapshot, "AsyncCancelRequestCqeCount"),
                ReadProperty<ulong>(snapshot, "AsyncCancelRequestCqeEnoentCount"),
                ReadProperty<ulong>(snapshot, "AsyncCancelRequestCqeEalreadyCount"),
                ReadProperty<ulong>(snapshot, "AsyncCancelRequestCqeOtherCount"),
                ReadProperty<ulong>(snapshot, "SocketEventBufferFullCount"),
                ReadProperty<ulong>(snapshot, "UnsupportedOpcodePrepareCount"),
                ReadProperty<ulong>(snapshot, "CqOverflowCount"));
        }
