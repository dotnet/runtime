...
namespace System.Net.Sockets.Tests
{
    ...
    public abstract class SocketHelperBase
    {
        ...
        public virtual void ConfigureSocket(Socket s) { }
    }
    ...
    public sealed class SocketHelperSyncForceNonBlocking : SocketHelperArraySync
    {
        ...
        public override void ConfigureSocket(Socket s) => s.ForceNonBlocking(true);
    }
        ...
        where T : SocketHelperBase, new()
    {
        ...
        public void ConfigureSocket(Socket s) => _socketHelper.ConfigureSocket(s);
    }
