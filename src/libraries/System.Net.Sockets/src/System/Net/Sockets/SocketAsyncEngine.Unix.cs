...
namespace System.Net.Sockets
{
    internal sealed unsafe class SocketAsyncEngine : IThreadPoolWorkItem
    {
        ...
        {
            bool added = _handleToContextMap.TryAdd(socketHandle, context);
            if (!added)
            {
        ...
        private readonly struct SocketEventHandler
        {
            ...
            private readonly ConcurrentDictionary<IntPtr, SocketAsyncContext> _handleToContextMap;
            ...
            public bool HandleSocketEvents(int numEvents)
            {
                ...
                {
                    if (_handleToContextMap.TryGetValue(socketEvent.Data, out SocketAsyncContext? context))
                    {
