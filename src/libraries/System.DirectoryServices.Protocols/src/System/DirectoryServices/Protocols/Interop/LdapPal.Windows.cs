...
namespace System.DirectoryServices.Protocols
{
    internal static class LdapPal
    {
        ...
        internal static int LdapGetLastError(ConnectionHandle ldapHandle) => Interop.LdapGetLastError();
        ...
        internal static int LdapParseReference(ConnectionHandle ldapHandle, IntPtr result, ref IntPtr referrals) => Interop.ldap_parse_reference(ldapHandle, result, ref referrals);
        ...
        internal static int LdapSimpleBind(ConnectionHandle ld, string who, string passwd) => Interop.ldap_simple_bind_s(ld, who, passwd);
        ...
        internal static byte LdapStopTls(ConnectionHandle ldapHandle) => Interop.ldap_stop_tls(ldapHandle);
