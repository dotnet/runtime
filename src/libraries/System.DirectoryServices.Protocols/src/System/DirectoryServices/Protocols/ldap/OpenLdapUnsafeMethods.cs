...
namespace System.DirectoryServices.Protocols
{
    ...
    {
        /// <summary>
        /// We need to specify the versioned full-name library in order to not require a native shim to
        /// P/Invoke into the library.
        /// </summary>
        private const string _openldapdll = "libldap-2.4.so.2";
        ...
        [DllImport(_openldapdll, EntryPoint = "ldap_sasl_bind_s", CharSet = CharSet.Ansi, SetLastError = true)]
