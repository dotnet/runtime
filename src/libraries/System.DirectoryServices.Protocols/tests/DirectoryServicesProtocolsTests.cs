...
namespace System.DirectoryServices.Protocols.Tests
{
    public partial class DirectoryServicesProtocolsTests
    {
        ...
        public static IEnumerable<object[]> TestCompareRequestTheory_TestData()
        {
            ...
            yield return new object[] { "input", "input"u8, ResultCode.CompareTrue };
            ...
            yield return new object[] { "http://example.com/", "http://example.com/"u8, ResultCode.CompareTrue };
            ...
            yield return new object[] { "http://example.com/", "http://false/"u8, ResultCode.CompareFalse };
        }
