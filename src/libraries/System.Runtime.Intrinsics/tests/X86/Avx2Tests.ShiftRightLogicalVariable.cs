...
public partial class Avx2Tests
{
    ...
    [InlineData(-255, 0, -255, -255, 0, 0)]
    [InlineData(7, 64, 1, 0, 3, 64)]
    [InlineData(7, 64, -1, 0, 0, 0)]
    public void ShiftRightLogicalVariable_128_nint_64Bit(long lower, long upper, long lowerCount, long upperCount, long lowerExpected, long upperExpected)
    {
        ...
        Vector128<nint> actual = Avx2.ShiftRightLogicalVariable(vector, count);
    ...
    [InlineData(7, 64, 1, 0, 3, 64)]
    [InlineData(7, 64, -1, 0, 0, 0)]
    public void ShiftRightLogicalVariable_128_nint_32Bit(int lower, int upper, int lowerCount, int upperCount, int lowerExpected, int upperExpected)
    {
        Vector128<nint> vector = Vector128.Create(lower, upper).AsNInt();
        Vector128<nint> count = Vector128.Create(lowerCount, upperCount).AsNInt();
        Vector128<nint> expected = Vector128.Create(lowerExpected, upperExpected).AsNInt();
    ...
    */
    ...
    [InlineData(255, 0, 255, 255, 0, 0)]
    [InlineData(7, 64, 1, 0, 3, 64)]
    public void ShiftRightLogicalVariable_128_nuint_64Bit(ulong lower, ulong upper, ulong lowerCount, ulong upperCount, ulong lowerExpected, ulong upperExpected)
    {
        ...
        Vector128<nuint> actual = Avx2.ShiftRightLogicalVariable(vector, count);
        Assert.Equal(expected, actual);
    }
    ...
    [InlineData(255, 0, 255, 255, 0, 0)]
    [InlineData(7, 64, 1, 0, 3, 64)]
    public void ShiftRightLogicalVariable_128_nuint_32Bit(uint lower, uint upper, uint lowerCount, uint upperCount, uint lowerExpected, uint upperExpected)
    {
        Vector128<nuint> vector = Vector128.Create(lower, upper).AsNUInt();
        Vector128<nuint> count = Vector128.Create(lowerCount, upperCount).AsNUInt();
        Vector128<nuint> expected = Vector128.Create(lowerExpected, upperExpected).AsNUInt();
    ...
    [InlineData(-255, 0, -255, -255, -255, -255, -255, 0, 0, 0, 0, -255)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 0, 0, 0, 0)]
    public void ShiftRightLogicalVariable_256_nint_64Bit(long value1, long value2, long value3, long value4, long count1, long count2, long count3,
        long count4, long expected1, long expected2, long expected3, long expected4)
    {
        ...
        var actual = Avx2.ShiftRightLogicalVariable(value, count);
        Assert.Equal(expected, actual);
    }
    ...
    public void ShiftRightLogicalVariable_256_nint_32Bit(int value1, int value2, int value3, int value4, int count1, int count2, int count3,
    ...
    */
    ...
    [InlineData(255, 0, 255, 255, 255, 255, 255, 0, 0, 0, 0, 255)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 0, 0, 0, 0)]
    public void ShiftRightLogicalVariable_256_nuint_64Bit(ulong value1, ulong value2, ulong value3, ulong value4, ulong count1, ulong count2, ulong count3,
    ...
    [InlineData(255, 0, 255, 255, 255, 255, 255, 0, 0, 0, 0, 255)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 0, 0, 0, 0)]
    public void ShiftRightLogicalVariable_256_nuint_32Bit(uint value1, uint value2, uint value3, uint value4, uint count1, uint count2, uint count3,
