...
public partial class Avx2Tests
{
    ...
    [InlineData(255, 0, 255, 255, 255, 255, 255, 0, 0, 255, 255, 0)]
    [InlineData(-255, 0, -255, -255, -255, -255, -255, 0, 0, -255, -255, 0)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 64, 64, 0, 64)]
    public void UnpackHigh_nint_64Bit(long left1, long left2, long left3, long left4, long right1, long right2, long right3,
        long right4, long expected1, long expected2, long expected3, long expected4)
    {
        ...
        var actual = Avx2.UnpackHigh(left, right);
    ...
    [InlineData(-255, 0, -255, -255, -255, -255, -255, 0, 0, -255, -255, 0)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 64, 64, 0, 64)]
    public void UnpackHigh_nint_32Bit(int left1, int left2, int left3, int left4, int right1, int right2, int right3,
    ...
    [InlineData(255, 0, 255, 255, 255, 255, 255, 0, 0, 255, 255, 0)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 64, 64, 0, 64)]
    public void UnpackHigh_nuint_64Bit(ulong left1, ulong left2, ulong left3, ulong left4, ulong right1, ulong right2, ulong right3,
    ...
    [InlineData(255, 0, 255, 255, 255, 255, 255, 0, 0, 255, 255, 0)]
    [InlineData(7, 64, 1, 0, 7, 64, 7, 64, 64, 64, 0, 64)]
    public void UnpackHigh_nuint_32Bit(uint left1, uint left2, uint left3, uint left4, uint right1, uint right2, uint right3,
