...
public sealed partial class ShaTests
{
    ...
    public void TestSha256MessageSchedule1(long a0, long a1, long b0, long b1, long expected0, long expected1)
    {
        Vector128<byte> a = Vector128.Create(a0, a1).AsByte();
        Vector128<byte> b = Vector128.Create(b0, b1).AsByte();

        Vector128<byte> result = Sha.Sha256MessageSchedule1(a, b);
