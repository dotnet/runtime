...
public sealed partial class Avx2Tests
{
    ...
    [InlineData(255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0)]
    [InlineData(240, 240, 240, 240, 0, 0, 0, 0, 0, 0, 0, 0)]
    [InlineData(255, 0, 255, 0, 255, 255, 255, 255, 0, 255, 0, 255)]
    [InlineData(-255, 0, -255, 0, -255, -255, -255, -255, 0, -255, 0, -255)]
    public void AndNot_nint_64Bit(long left1, long left2, long left3, long left4, long right1, long right2, long right3,
        long right4, long expected1, long expected2, long expected3, long expected4)
    {
        ...
        Vector256<nint> actual = Avx2.AndNot(left, right);
    ...
    [InlineData(255, 0, 255, 0, 255, 255, 255, 255, 0, 255, 0, 255)]
    [InlineData(-255, 0, -255, 0, -255, -255, -255, -255, 0, -255, 0, -255)]
    public void AndNot_nint_32Bit(int left1, int left2, int left3, int left4, int right1, int right2, int right3,
    ...
    [InlineData(240, 240, 240, 240, 0, 0, 0, 0, 0, 0, 0, 0)]
    [InlineData(255, 0, 255, 0, 255, 255, 255, 255, 0, 255, 0, 255)]
    public void AndNot_nuint_64Bit(ulong left1, ulong left2, ulong left3, ulong left4, ulong right1, ulong right2, ulong right3,
        ulong right4, ulong expected1, ulong expected2, ulong expected3, ulong expected4)
    {
        ...
        Vector256<nuint> actual = Avx2.AndNot(left, right);
        Assert.Equal(expected, actual);
    }
    ...
    [InlineData(240, 240, 240, 240, 0, 0, 0, 0, 0, 0, 0, 0)]
    [InlineData(255, 0, 255, 0, 255, 255, 255, 255, 0, 255, 0, 255)]
    public void AndNot_nuint_32Bit(uint left1, uint left2, uint left3, uint left4, uint right1, uint right2, uint right3,
