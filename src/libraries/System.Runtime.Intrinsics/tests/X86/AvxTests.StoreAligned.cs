...
public sealed partial class AvxTests
{
    ...
    public void StoreAligned_nint_64Bit(long data1, long data2, long data3, long data4)
    {
        unsafe
        {
    ...
    [InlineData(1111, 2222, 3333, 4444)]
    [InlineData(-4444, -3333, 2222, -1111)]
    public void StoreAligned_nint_32Bit(int data1, int data2, int data3, int data4)
    {
        unsafe
        {
    ...
    [InlineData(0, 0, 0, 0)]
    [InlineData(1111, 2222, 3333, 4444)]
    public void StoreAligned_nuint_64Bit(ulong data1, ulong data2, ulong data3, ulong data4)
    {
        unsafe
        {
    ...
    [InlineData(0, 0, 0, 0)]
    [InlineData(1111, 2222, 3333, 4444)]
    public void StoreAligned_nuint_32Bit(uint data1, uint data2, uint data3, uint data4)
    {
        unsafe
        {
