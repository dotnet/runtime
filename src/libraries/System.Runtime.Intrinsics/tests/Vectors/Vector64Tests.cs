...
namespace System.Runtime.Intrinsics.Tests.Vectors
{
    public sealed class Vector64Tests
    {
        ...
        {
            Vector64<T> actualResult = Vector64.AddSaturate(Vector64.Create(left), Vector64.Create(right));
            Assert.Equal(Vector64.Create(expected), actualResult);
        }
        ...
        {
            Vector64<T> actualResult = Vector64.SubtractSaturate(Vector64.Create(left), Vector64.Create(right));
            Assert.Equal(Vector64.Create(expected), actualResult);
        }
    }
}
