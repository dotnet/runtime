...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract partial class X86Base
    {
        ...
        public (uint Quotient, uint Remainder) DivRem(uint lower, uint upper, uint divisor) { throw null; }
        public (int Quotient, int Remainder) DivRem(uint lower, int upper, int divisor) { throw null; }
        public (nuint Quotient, nuint Remainder) DivRem(nuint lower, nuint upper, nuint divisor) { throw null; }
        public (nint Quotient, nint Remainder) DivRem(nuint lower, nint upper, nint divisor) { throw null; }
        public static void Pause() { throw null; }
        public abstract partial class X64
        {
            internal X64() { }
            public static bool IsSupported { get { throw null; } }
            public (ulong Quotient, ulong Remainder) DivRem(ulong lower, ulong upper, ulong divisor) { throw null; }
            public (long Quotient, long Remainder) DivRem(ulong lower, long upper, long divisor) { throw null; }
        }
    }
}
