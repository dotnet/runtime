...
namespace System.Linq
{
    public static partial class AsyncEnumerable
    {
        ...
        /// <returns>An <see cref="IAsyncEnumerable{T}" /> that has elements of type <typeparamref name="TResult" /> that are obtained by performing a left outer join on two sequences.</returns>
        ...
        public static IAsyncEnumerable<TResult> LeftJoin<TOuter, TInner, TKey, TResult>(
