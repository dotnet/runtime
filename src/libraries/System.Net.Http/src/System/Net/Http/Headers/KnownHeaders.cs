...
namespace System.Net.Http.Headers
{
    internal static class KnownHeaders
    {
        ...
        public static readonly KnownHeader AcceptRanges = new("Accept-Ranges", HttpHeaderType.Response, GenericHeaderParser.TokenListParser, null, H2StaticTable.AcceptRanges, H3StaticTable.AcceptRangesBytes);
        ...
        public static readonly KnownHeader AccessControlAllowMethods = new("Access-Control-Allow-Methods", HttpHeaderType.Response, parser: null, ["*"], http3StaticTableIndex: H3StaticTable.AccessControlAllowMethodsGet);
        ...
        public static readonly KnownHeader Age = new("Age", HttpHeaderType.Response | HttpHeaderType.NonTrailing, TimeSpanHeaderParser.Parser, null, H2StaticTable.Age, H3StaticTable.Age0);
        ...
        public static readonly KnownHeader AltSvc = new("Alt-Svc", HttpHeaderType.Response, GetAltSvcHeaderParser(), http3StaticTableIndex: H3StaticTable.AltSvcClear);
        ...
        public static readonly KnownHeader Connection = new("Connection", HttpHeaderType.General, GenericHeaderParser.TokenListParser, ["close"]);
        ...
        public static readonly KnownHeader ContentEncoding = new("Content-Encoding", HttpHeaderType.Content | HttpHeaderType.NonTrailing, GenericHeaderParser.TokenListParser, ["gzip", "deflate", "br", "compress", "identity"], H2StaticTable.ContentEncoding, H3StaticTable.ContentEncodingBr);
        ...
        public static readonly KnownHeader ContentSecurityPolicy = new("Content-Security-Policy", http3StaticTableIndex: H3StaticTable.ContentSecurityPolicyAllNone);
        ...
        public static readonly KnownHeader Expires = new("Expires", HttpHeaderType.Content | HttpHeaderType.NonTrailing, DateHeaderParser.Parser, null, H2StaticTable.Expires);
        ...
        public static readonly KnownHeader GrpcEncoding = new("grpc-encoding", HttpHeaderType.Custom, null, ["identity", "gzip", "deflate"]);
        public static readonly KnownHeader GrpcMessage = new("grpc-message");
        public static readonly KnownHeader GrpcStatus = new("grpc-status", HttpHeaderType.Custom, null, ["0"]);
        ...
        public static readonly KnownHeader Link = new("Link", H2StaticTable.Link, H3StaticTable.Link);
        ...
        public static readonly KnownHeader ReferrerPolicy = new("Referrer-Policy", HttpHeaderType.Custom, null, ["strict-origin-when-cross-origin", "origin-when-cross-origin", "strict-origin", "origin", "same-origin", "no-referrer-when-downgrade", "no-referrer", "unsafe-url"]);
        public static readonly KnownHeader Refresh = new("Refresh", H2StaticTable.Refresh);
        ...
        public static readonly KnownHeader SetCookie2 = new("Set-Cookie2", HttpHeaderType.Custom | HttpHeaderType.NonTrailing, null, null);
        public static readonly KnownHeader StrictTransportSecurity = new("Strict-Transport-Security", H2StaticTable.StrictTransportSecurity, H3StaticTable.StrictTransportSecurityMaxAge31536000);
        ...
        public static readonly KnownHeader UpgradeInsecureRequests = new("Upgrade-Insecure-Requests", HttpHeaderType.Custom, null, ["1"], http3StaticTableIndex: H3StaticTable.UpgradeInsecureRequests1);
        ...
        public static readonly KnownHeader Vary = new("Vary", HttpHeaderType.Response | HttpHeaderType.NonTrailing, GenericHeaderParser.TokenListParser, ["*"], H2StaticTable.Vary, H3StaticTable.VaryAcceptEncoding);
        ...
        public static readonly KnownHeader XCache = new("X-Cache");
        public static readonly KnownHeader XContentDuration = new("X-Content-Duration");
        public static readonly KnownHeader XContentTypeOptions = new("X-Content-Type-Options", HttpHeaderType.Custom, null, ["nosniff"], http3StaticTableIndex: H3StaticTable.XContentTypeOptionsNoSniff);
        public static readonly KnownHeader XFrameOptions = new("X-Frame-Options", HttpHeaderType.Custom, null, ["DENY", "SAMEORIGIN"], http3StaticTableIndex: H3StaticTable.XFrameOptionsDeny);
        ...
        public static readonly KnownHeader XXssProtection = new("X-XSS-Protection", HttpHeaderType.Custom, null, ["0", "1", "1; mode=block"]);
