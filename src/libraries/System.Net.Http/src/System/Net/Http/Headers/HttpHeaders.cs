    ...
    public abstract class HttpHeaders : IEnumerable<KeyValuePair<string, IEnumerable<string>>>
    {
        ...
        internal bool TryAddWithoutValidation(HeaderDescriptor descriptor, string? value)
        {
            ...
            if (_headerStore.TryGetValue(descriptor, out object? currentValue))
            {
                ...
                else
                {
                    ...
                    _headerStore[descriptor] = info = new HeaderStoreItemInfo() { RawValue = currentValue, OriginalRawValue = currentValue };
                    AddValue(info, value, StoreLocation.Raw);
                }
            }
            else
            {
                ...
                _headerStore.Add(descriptor, _forceHeaderStoreItems ? new HeaderStoreItemInfo { RawValue = value, OriginalRawValue = value } : (object)value);
            }
            ...
            foreach (KeyValuePair<HeaderDescriptor, object> header in sourceHeadersStore)
            {
                ...
                if (!_headerStore.ContainsKey(header.Key))
                {
                    ...
                    else
                    {
                        ...
                        _headerStore.Add(header.Key, _forceHeaderStoreItems ? new HeaderStoreItemInfo { RawValue = sourceValue, OriginalRawValue = sourceValue } : sourceValue);
                    }
                }
            }
        }
            ...
            else
            {
                ...
                if (found)
                {
                    ...
                    else
                    {
                        ...
                        _headerStore![descriptor] = result = new HeaderStoreItemInfo { RawValue = value, OriginalRawValue = value };
                    }
                }
            }
        ...
        private bool TryGetAndParseHeaderInfo(HeaderDescriptor key, [NotNullWhen(true)] out HeaderStoreItemInfo? info)
        {
            if (TryGetHeaderValue(key, out object? value))
            {
                ...
                {
                    Debug.Assert(value is string);
                    _headerStore![key] = info = new HeaderStoreItemInfo() { RawValue = value, OriginalRawValue = value };
                }
        ...
        private static void AddValue(HeaderStoreItemInfo info, object? value, StoreLocation location)
        {
            ...
            switch (location)
            {
                case StoreLocation.Raw:
                    ...
                    currentStoreValue = info.OriginalRawValue;
                    AddValueToStoreValue<string>(value, ref currentStoreValue);
                    info.OriginalRawValue = currentStoreValue;
                    break;
        ...
        private static string[] GetValuesAsStrings(HeaderDescriptor descriptor, object value, object? exclude = null)
        {
            ...
            return GetValuesAsStrings(descriptor, info, exclude);
        }

        internal static string[] GetValuesAsStrings(HeaderDescriptor descriptor, HeaderStoreItemInfo info, object? exclude = null)
        {
    ...
    public readonly struct HttpHeadersNonValidated : IEnumerable<KeyValuePair<string, HeaderStringValues>>
    {
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<string, HeaderStringValues>>
        {
            ...
            public bool MoveNext()
            {
                ...
                static HeaderStringValues ToStringValues(HeaderDescriptor descriptor, object value)
                {
                    if (value is HttpHeaders.HeaderStoreItemInfo info)
                    {
                    ...
                    Debug.Assert(value is string);
                    return new HeaderStringValues((string)value);
                }
            }
    ...
    public readonly struct HeaderStringValues : IEnumerable<string>
    {
        ...
        public struct Enumerator : IEnumerator<string>
        {
            ...
            public bool MoveNext()
            {
                ...
                Debug.Assert(_values.Current != null);
