...
namespace System.Net.Http
{
    public partial class HttpClientHandler : HttpMessageHandler
    {
        ...
        [DynamicDependency("get_UseCookies", "System.Net.Http.NSUrlSessionHandler", "Xamarin.iOS")]
        private bool GetUseCookies() => (bool)InvokeNativeHandlerMethod("get_UseCookies");

        [DynamicDependency("set_UseCookies", "System.Net.Http.NSUrlSessionHandler", "Xamarin.iOS")]
        private void SetUseCookies(bool value) => InvokeNativeHandlerMethod("set_UseCookies", value);

        [DynamicDependency("get_CookieContainer", "System.Net.Http.NSUrlSessionHandler", "Xamarin.iOS")]
        private CookieContainer GetCookieContainer() => (CookieContainer)InvokeNativeHandlerMethod("get_CookieContainer");

        [DynamicDependency("set_CookieContainer", "System.Net.Http.NSUrlSessionHandler", "Xamarin.iOS")]
        private void SetCookieContainer(CookieContainer value) => InvokeNativeHandlerMethod("set_CookieContainer", value);

        [DynamicDependency("get_AllowAutoRedirect", "System.Net.Http.NSUrlSessionHandler", "Xamarin.iOS")]
