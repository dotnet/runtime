...
namespace System.Net.Http.Tests
{
    public class HeaderUtilitiesTest
    {
        ...
        {
            ObjectCollection<NameValueHeaderValue> x = new UnvalidatedObjectCollection<NameValueHeaderValue>();
            ObjectCollection<NameValueHeaderValue> y = new UnvalidatedObjectCollection<NameValueHeaderValue>();
