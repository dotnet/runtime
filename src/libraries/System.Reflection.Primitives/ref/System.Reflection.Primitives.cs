...
namespace System.Reflection.Emit
{
    public enum FlowControl
    {
        ...
        Meta = 4,
        Next = 5,
        [System.ObsoleteAttribute("FlowControl.Phi has been deprecated and is no longer supported.")]
        Phi = 6,
        Return = 7,
        Throw = 8,
    }
    ...
    {
        [System.ObsoleteAttribute("OpCodeType.Annotation has been deprecated and is no longer supported.")]
        Annotation = 0,
        Macro = 1,
        Nternal = 2,
        Objmodel = 3,
    ...
    public enum OperandType
    {
        ...
        InlineMethod = 4,
        InlineNone = 5,
        [System.ObsoleteAttribute("OperandType.InlinePhi has been deprecated and is no longer supported.")]
        InlinePhi = 6,
        InlineR = 7,
        InlineSig = 9,
        InlineString = 10,
