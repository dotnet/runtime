    ...
    public partial class FileSystemWatcher
    {
        ...
        private void StartRaisingEvents()
        {
            ...
            try
            {
                ...
                // Assign to _cancellation immediately so the catch block can dispose it on any failure path.
                ...
                var runner = new RunningInstance(
                    ...
                    IncludeSubdirectories, NotifyFilter, _cancellation.Token);
                    ...
                    while (!_cancellationToken.IsCancellationRequested)
                    {
                        unsafe
                        {
                            ...
                            if (result == -1)
                            {
                                ...
                                {
                                    // The portfs handle is no longer valid, which can happen during shutdown
                                    // if it has already been disposed. Terminate quietly.
        ...
        private sealed class DirectorySnapshot
        {
            ...
            internal static DirectorySnapshot Create(string path)
            {
                                           ...
                                           ex is UnauthorizedAccessException)
                {
                    ...
                    // Return the partial snapshot after sorting below.
                }
                catch (IOException ex)
                {
