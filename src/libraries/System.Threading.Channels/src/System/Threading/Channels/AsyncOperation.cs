...
namespace System.Threading.Channels
{
    ...
    internal abstract partial class AsyncOperation
    {
        ...
        public bool UnregisterCancellation()
        {
            if (CancellationToken.CanBeCanceled)
            {
                _cancellationRegistration.Dispose(); // Dispose rather than Unregister is important to know work has quiesced
        ...
        /// </remarks>
        private protected bool TryReserveCompletionIfCancelable() =>
