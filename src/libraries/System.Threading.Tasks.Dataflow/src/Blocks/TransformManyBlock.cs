...
namespace System.Threading.Tasks.Dataflow
{
    ...
    public sealed partial class TransformManyBlock<TInput, TOutput> : IPropagatorBlock<TInput, TOutput>, IReceivableSourceBlock<TOutput>, IDebuggerDisplay
    {
        ...
        public TransformManyBlock(Func<TInput, IEnumerable<TOutput>> transform, ExecutionDataflowBlockOptions dataflowBlockOptions)
        {
            ...
            Initialize(messageId => ProcessMessage(transform, messageId), dataflowBlockOptions, ref _source!, ref _target!, ref _reorderingBuffer, async: false);
        }
            ...
            bool async)
        {
            ...
            target = new TargetCore<TInput>(this, processMessageAction,
                _reorderingBuffer, dataflowBlockOptions, async ? TargetCoreOptions.UsesAsyncCompletion : TargetCoreOptions.None);
