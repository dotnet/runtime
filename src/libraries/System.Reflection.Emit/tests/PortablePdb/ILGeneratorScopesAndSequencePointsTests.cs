...
namespace System.Reflection.Emit.Tests
{
    ...
    public class ILGeneratorScopesAndSequencePointsTests
    {
        ...
        public void SetLocalSymInfo_UsingNamespace_Validations()
        {
            ...
            ILGenerator il1 = tb.DefineMethod("SumMethod", MethodAttributes.Public | MethodAttributes.Static).GetILGenerator();
        ...
        public void LocalsNamespacesWithinNestedScopes()
        {
            ...
            LocalBuilder local3 = il1.DeclareLocal(typeof(AssemblyName));
            local3.SetLocalSymInfo("myAssembly");
            il1.Emit(OpCodes.Ldloc_1);
            il1.Emit(OpCodes.Newobj, typeof(AssemblyName).GetConstructor([typeof(string)]));
            il1.Emit(OpCodes.Stloc_2);
            il1.BeginScope();
            LocalBuilder local4 = il1.DeclareLocal(typeof(int));
            local4.SetLocalSymInfo("myInt2");
            LocalBuilder local5 = il1.DeclareLocal(typeof(int));
            local5.SetLocalSymInfo("myInt3");
            il1.Emit(OpCodes.Ldc_I4_2);
            il1.Emit(OpCodes.Stloc_3);
            il1.Emit(OpCodes.Ldc_I4_5);
            il1.Emit(OpCodes.Stloc_S, 4);
            il1.Emit(OpCodes.Ldloc_S, 4);
            il1.Emit(OpCodes.Ldloc_3);
            il1.Emit(OpCodes.Add);
            il1.Emit(OpCodes.Stloc_0);
            il1.EndScope();
            il1.UsingNamespace("System.Reflection.Emit");
            il1.EndScope();
            il1.Emit(OpCodes.Ldloc_0);
            il1.Emit(OpCodes.Ret);
            tb.CreateType();
        ...
        public void DefineDocument_MarkSequencePoint_Validations()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>("startLine", () => il.MarkSequencePoint(mb.DefineDocument("MySourceFile.cs"), 0x20000001, 1, 1, 1));
            Assert.Throws<ArgumentOutOfRangeException>("startColumn", () => il.MarkSequencePoint(mb.DefineDocument("MySourceFile.cs"), 1, 0x10001, 1, 1));
            Assert.Throws<ArgumentOutOfRangeException>("endLine", () => il.MarkSequencePoint(mb.DefineDocument("MySourceFile.cs"), 1, 1, 0x20000001, 1));
            Assert.Throws<ArgumentOutOfRangeException>("endColumn", () => il.MarkSequencePoint(mb.DefineDocument("MySourceFile.cs"), 1, 1, 1, 0x10001));
            Assert.Throws<ArgumentOutOfRangeException>("endColumn", () => il.MarkSequencePoint(mb.DefineDocument("MySourceFile.cs"), 1, 1, 1, 1));
