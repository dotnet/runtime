...
namespace System.Security.Cryptography.Xml.Tests
{
    public class Signature_ArbitraryElements
    {
        ...
        public static void CorrectAttributes()
        {
            ...
            Helpers.VerifyCryptoExceptionOnLoad(xml, loadXmlThrows: !SignatureSupport.SupportsRsaSha1Signatures, validSignature: false);
        }
        ...
        public static void DifferentSignatureXMLNS()
        {
            ...
            Helpers.VerifyCryptoExceptionOnLoad(xml, loadXmlThrows: !SignatureSupport.SupportsRsaSha1Signatures, false);
        }
