...
";
                ...
                sign.CheckSignature(new HMACSHA1("secret"u8));
            }
...
";
            ...
            CheckErratum(sign, new HMACSHA1("no clue"u8), "1");
            CheckErratum(sign, new HMACSHA1(""u8), "2");
            CheckErratum(sign, new HMACSHA1("oops"u8), "3");
            CheckErratum(sign, new HMACSHA1("secret"u8), "4");
        }
        ...
        public void VerifyHMAC_SmallerThanMinimumLength()
        {
            ...
            SignedXml sign = GetSignedXml(xml);
            CheckErratum(sign, new HMACSHA1("secret"u8), "72");
        }
        ...
        public void VerifyHMAC_MinimumLength()
        {
            ...
            SignedXml sign = GetSignedXml(xml);
            Assert.True(sign.CheckSignature(new HMACSHA1("secret"u8)));
        }
        ...
        public void VerifyHMAC_SmallerHalfLength()
        {
            ...
            SignedXml sign = GetSignedXml(xml);
            CheckErratum(sign, new HMACSHA256("secret"u8), "80");
        }
        ...
        public void VerifyHMAC_HalfLength()
        {
            ...
            SignedXml sign = GetSignedXml(xml);
            Assert.True(sign.CheckSignature(new HMACSHA256("secret"u8)));
        }
...
";
            SignedXml sign = GetSignedXml(xml);
            Assert.Throws<CryptographicException>(() => sign.CheckSignature(new HMACSHA1("no clue"u8)));
        }
...
";
            SignedXml sign = GetSignedXml(xml);
            Assert.Throws<FormatException>(() => sign.CheckSignature(new HMACSHA1("no clue"u8)));
        }
