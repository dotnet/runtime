...
<test>some text node</test>
        ...
        public void CheckSignatureHandlesEnvelopedSignatureWithRootXpointerReference(string caseName, bool isValid)
        {
            ...
            xmlDoc.LoadXml(EnvelopedSignatureWithRootXpointerReference[caseName]);
