            ...
            get
            {
                ...
                if (e != null)
                {
                    ...
                    do
                    {
                        ...
                        if (a != null)
                        {
                            ReadOnlySpan<char> whitespaceChars = new char[] { ' ', '\t', '\n', '\r' };
                            ReadOnlySpan<char> trimmed = a.Value.AsSpan().Trim(whitespaceChars);

                            if (trimmed.SequenceEqual("preserve"))
                            {
                                return XmlSpace.Preserve;
                            }

                            if (trimmed.SequenceEqual("default"))
                            {
