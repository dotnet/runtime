...
public class Program
{
	...
	public static XmlReader CreateXmlReader()
	{
		using (var stringwriter = new System.IO.StringWriter())
		{
			...
			serializer.Serialize(stringwriter, new MyClass() { Element = new XElement("MyElement") });
	...
	// with slight human modifications to remove the serialization logic.
