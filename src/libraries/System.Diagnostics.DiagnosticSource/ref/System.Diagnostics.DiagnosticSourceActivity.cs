...
namespace System.Diagnostics.Metrics
{
    public sealed class Counter<T> : Instrument<T> where T : struct
    {
        ...
        public void Add(T delta, /*params*/ ReadOnlySpan<System.Collections.Generic.KeyValuePair<string, object?>> tags) { throw null; }
    ...
    public sealed class Histogram<T> : Instrument<T> where T : struct
    {
        ...
        public void Record(T value, /*params*/ ReadOnlySpan<System.Collections.Generic.KeyValuePair<string, object?>> tags) { throw null; }
    ...
    public readonly struct Measurement<T> where T : struct
    {
        ...
        public Measurement(T value, /*params*/ ReadOnlySpan<System.Collections.Generic.KeyValuePair<string, object?>> tags) { throw null; }
