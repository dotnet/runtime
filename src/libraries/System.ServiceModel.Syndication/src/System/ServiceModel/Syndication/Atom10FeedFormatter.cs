...
namespace System.ServiceModel.Syndication
{
    ...
    public class Atom10FeedFormatter : SyndicationFeedFormatter, IXmlSerializable
    {
        ...
        private void ReadLink(XmlReader reader, SyndicationLink link, Uri baseUri)
        {
            ...
            link.Title = title;
            link.Uri = (val is not null) ? UriFromString(val, UriKind.RelativeOrAbsolute, Atom10Constants.LinkTag, Atom10Constants.Atom10Namespace, reader) : null;
        }
