...
{
    public partial class SyndicationFeedFormatterTests
    {
        [Fact]
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("feedToWrite", () => new Formatter(null));
        }

        [Fact]
        public void CreateCategory_Item_ReturnsExpected()
        {
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("item", () => Formatter.CreateCategoryEntryPoint((SyndicationItem)null));
        }
        ...
        [Fact]
        public void CreateCategory_Feed_ReturnsExpected()
        {
            var feed = new SyndicationFeed();
            SyndicationCategory category = Formatter.CreateCategoryEntryPoint(feed);
            Assert.Empty(category.AttributeExtensions);
            Assert.Empty(category.ElementExtensions);
            Assert.Null(category.Label);
            Assert.Null(category.Name);
        ...
        [Fact]
        public void CreateCategory_NullFeed_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.CreateCategoryEntryPoint((SyndicationFeed)null));
        }

        [Fact]
        public void CreateCategory_FeedReturnsNull_ThrowsInvalidOperationException()
        {
            var feed = new NullSyndicationFeed();
            Assert.Throws<InvalidOperationException>(() => Formatter.CreateCategoryEntryPoint(feed));
        }

        [Fact]
        public void CreateItem_Feed_ReturnsExpected()
        {
            var feed = new SyndicationFeed();
            SyndicationItem item = Formatter.CreateItemEntryPoint(feed);
        ...
        [Fact]
        public void CreateItem_NullFeed_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.CreateItemEntryPoint((SyndicationFeed)null));
        }

        [Fact]
        public void CreateItem_FeedReturnsNull_ThrowsInvalidOperationException()
        {
            var feed = new NullSyndicationFeed();
            Assert.Throws<InvalidOperationException>(() => Formatter.CreateItemEntryPoint(feed));
        }

        [Fact]
        public void CreateLink_Item_ReturnsExpected()
        {
            var item = new SyndicationItem();
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("item", () => Formatter.CreateLinkEntryPoint((SyndicationItem)null));
        }
        ...
        [Fact]
        public void CreateLink_Feed_ReturnsExpected()
        {
            var feed = new SyndicationFeed();
            SyndicationLink link = Formatter.CreateLinkEntryPoint(feed);
            Assert.Empty(link.AttributeExtensions);
            Assert.Null(link.BaseUri);
            Assert.Empty(link.ElementExtensions);
            Assert.Equal(0, link.Length);
        ...
        [Fact]
        public void CreateLink_NullFeed_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.CreateLinkEntryPoint((SyndicationFeed)null));
        }

        [Fact]
        public void CreateLink_FeedReturnsNull_ThrowsInvalidOperationException()
        {
            var feed = new NullSyndicationFeed();
            Assert.Throws<InvalidOperationException>(() => Formatter.CreateLinkEntryPoint(feed));
        }

        [Fact]
        public void CreatePerson_Item_ReturnsExpected()
        {
            var item = new SyndicationItem();
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("item", () => Formatter.CreatePersonEntryPoint((SyndicationItem)null));
        }
        ...
        [Fact]
        public void CreatePerson_Feed_ReturnsExpected()
        {
            var feed = new SyndicationFeed();
            SyndicationPerson person = Formatter.CreatePersonEntryPoint(feed);
            Assert.Empty(person.AttributeExtensions);
            Assert.Empty(person.ElementExtensions);
            Assert.Null(person.Email);
            Assert.Null(person.Name);
        ...
        [Fact]
        public void CreatePerson_NullFeed_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.CreatePersonEntryPoint((SyndicationFeed)null));
        }

        [Fact]
        public void CreatePerson_FeedReturnsNull_ThrowsInvalidOperationException()
        {
            var feed = new NullSyndicationFeed();
            Assert.Throws<InvalidOperationException>(() => Formatter.CreatePersonEntryPoint(feed));
        }
        ...
        [Fact]
        public void LoadElementExtensions_Feed_Success()
        {
            var settings = new XmlReaderSettings { ConformanceLevel = ConformanceLevel.Fragment };
            ...
            {
                var feed = new SyndicationFeed();
                Formatter.LoadElementExtensionsEntryPoint(reader, feed, int.MaxValue);

                Assert.Equal(2, feed.ElementExtensions.Count);
                Assert.Equal(10, feed.ElementExtensions[0].GetObject<ExtensionObject>(new XmlSerializer(typeof(ExtensionObject))).Value);
                Assert.Equal("ExtensionObject", feed.ElementExtensions[0].OuterName);
                Assert.Empty(feed.ElementExtensions[0].OuterNamespace);
                Assert.Equal("ExtensionObject", feed.ElementExtensions[1].OuterName);
                Assert.Equal("http://www.w3.org/TR/html4/", feed.ElementExtensions[1].OuterNamespace);
            }
        }

        [Fact]
        public void LoadElementExtensions_NullFeed_ThrowsArgumentNullException()
        {
            XmlReader reader = new XElement("Name").CreateReader();
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.LoadElementExtensionsEntryPoint(reader, (SyndicationFeed)null, int.MaxValue));
        }
        ...
        public void LoadElementExtensions_NullReader_ThrowsArgumentNullException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("readerOverUnparsedExtensions", () => Formatter.LoadElementExtensionsEntryPoint(null, new SyndicationFeed(), int.MaxValue));
        ...
        public void LoadElementExtensions_NegativeMaxExtensionSize_ThrowsArgumentOutOfRangeException()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("maxExtensionSize", () => Formatter.LoadElementExtensionsEntryPoint(reader, new SyndicationFeed(), -1));
        ...
        {
            var formatter = new Formatter();
            Assert.Equal("System.ServiceModel.Syndication.Tests.SyndicationFeedFormatterTests+Formatter, SyndicationVersion=Version", formatter.ToString());
        }
        ...
        public static IEnumerable<object[]> TryParseAttribute_TestData()
        {
            ...
            yield return new object[] { "name", "namespace", "value", "version", false };
        ...
        [Theory]
        [MemberData(nameof(TryParseAttribute_TestData))]
        public void TryParseAttribute_Feed_ReturnsExpected(string name, string ns, string value, string version, bool expected)
        {
            Assert.Equal(expected, Formatter.TryParseAttributeEntryPoint(name, ns, value, new SyndicationFeed(), version));
        }

        [Fact]
        public void TryParseAttribute_NullFeed_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.TryParseAttributeEntryPoint("name", "namespace", "value", (SyndicationFeed)null, "version"));
        }
        ...
        [Theory]
        [MemberData(nameof(TryParseElement_TestData))]
        public void TryParseElement_Feed_Success(XmlReader reader, string version)
        {
            Assert.False(Formatter.TryParseElementEntryPoint(reader, new SyndicationFeed(), version));
        }

        [Fact]
        public void TryParseElement_NullFeed_ThrowsArgumentNullException()
        {
            XmlReader reader = new XElement("Name").CreateReader();
            AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.TryParseElementEntryPoint(reader, (SyndicationFeed)null, "version"));
        }
        ...
        [Fact]
        public void TryParseElement_NullItem_ThrowsArgumentNullException()
        {
            XmlReader reader = new XElement("Name").CreateReader();
        ...
        [Theory]
        [MemberData(nameof(Version_TestData))]
        public void WriteAttributeExtensions_Feed_Success(string version)
        {
            var feed = new SyndicationFeed();
            CompareHelper.AssertEqualWriteOutput("", writer => Formatter.WriteAttributeExtensionsEntryPoint(writer, feed, version));
            ...
            CompareHelper.AssertEqualWriteOutput(@"name1=""value"" d0p1:name2="""" name3=""""", writer => Formatter.WriteAttributeExtensionsEntryPoint(writer, feed, version));
        }

        [Fact]
        public void WriteAttributeExtensions_NullFeed_ThrowsArgumentNullException()
        {
            using (var stringWriter = new StringWriter())
            using (XmlWriter writer = XmlWriter.Create(stringWriter))
            {
                AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.WriteAttributeExtensionsEntryPoint(writer, (SyndicationFeed)null, "version"));
            }
        }
...
@"<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>10</Value>
</SyndicationFeedFormatterTests.ExtensionObject>
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
</SyndicationFeedFormatterTests.ExtensionObject>", writer => formatter.WriteElementExtensionsEntryPoint(writer, category, version));
        }
        ...
        {
            var feed = new SyndicationFeed();
            CompareHelper.AssertEqualWriteOutput("", writer => Formatter.WriteElementExtensionsEntryPoint(writer, feed, version));
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
</SyndicationFeedFormatterTests.ExtensionObject>", writer => Formatter.WriteElementExtensionsEntryPoint(writer, feed, version));
        }

        [Fact]
        public void WriteElementExtensions_NullFeed_ThrowsArgumentNullException()
        {
            using (var stringWriter = new StringWriter())
            using (XmlWriter writer = XmlWriter.Create(stringWriter))
            {
                AssertExtensions.Throws<ArgumentNullException>("feed", () => Formatter.WriteElementExtensionsEntryPoint(writer, (SyndicationFeed)null, "version"));
            }
        }

        [Theory]
        [MemberData(nameof(Version_TestData))]
        public void WriteElementExtensions_Feed_Success(string version)
        {
            var item = new SyndicationItem();
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
</SyndicationFeedFormatterTests.ExtensionObject>", writer => Formatter.WriteElementExtensionsEntryPoint(writer, item, version));
        }
        ...
        public void WriteElementExtensions_NullItem_ThrowsArgumentNullException()
        {
            ...
            using (XmlWriter writer = XmlWriter.Create(stringWriter))
            {
                AssertExtensions.Throws<ArgumentNullException>("item", () => Formatter.WriteElementExtensionsEntryPoint(writer, (SyndicationItem)null, "version"));
            }
        }
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
</SyndicationFeedFormatterTests.ExtensionObject>", writer => formatter.WriteElementExtensionsEntryPoint(writer, link, version));
        }
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
</SyndicationFeedFormatterTests.ExtensionObject>", writer => formatter.WriteElementExtensionsEntryPoint(writer, person, version));
        }
        ...
        public class NullSyndicationFeed : SyndicationFeed
        {
            protected override SyndicationCategory CreateCategory() => null;

            protected override SyndicationItem CreateItem() => null;
        ...
        public class Formatter : SyndicationFeedFormatter
        {
            ...
            public static SyndicationCategory CreateCategoryEntryPoint(SyndicationFeed feed) => CreateCategory(feed);

            public static SyndicationCategory CreateCategoryEntryPoint(SyndicationItem item) => CreateCategory(item);

            public static SyndicationItem CreateItemEntryPoint(SyndicationFeed feed) => CreateItem(feed);

            public static SyndicationLink CreateLinkEntryPoint(SyndicationFeed feed) => CreateLink(feed);

            public static SyndicationLink CreateLinkEntryPoint(SyndicationItem item) => CreateLink(item);

            public static SyndicationPerson CreatePersonEntryPoint(SyndicationFeed feed) => CreatePerson(feed);
            ...
            public static void LoadElementExtensionsEntryPoint(XmlReader reader, SyndicationFeed feed, int maxExtensionSize) => LoadElementExtensions(reader, feed, maxExtensionSize);
            ...
            public static bool TryParseAttributeEntryPoint(string name, string ns, string value, SyndicationFeed feed, string version)
            {
            ...
            public static bool TryParseElementEntryPoint(XmlReader reader, SyndicationFeed feed, string version)
            {
            ...
            public static void WriteAttributeExtensionsEntryPoint(XmlWriter writer, SyndicationFeed feed, string version)
            {
            ...
            public static void WriteElementExtensionsEntryPoint(XmlWriter writer, SyndicationFeed feed, string version)
            {
            ...
            protected override SyndicationFeed CreateFeedInstance() => throw new NotImplementedException();
        }
