...
namespace System.ComponentModel.Composition.Hosting
{
    ...
    {
        /// <summary>
        /// Creates a new instance of the <see cref="FilteredCatalog"/> that contains all the parts from the original filtered catalog and all their dependencies.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="FilteredCatalog"/> that contains all the parts from the original filtered catalog and all their dependencies that
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="FilteredCatalog"/> that contains all the parts from the original filtered catalog and all their dependents.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="FilteredCatalog"/> that contains all the parts from the original filtered catalog and all their dependents that
        /// can be reached via imports that match the specified filter.
        /// </summary>
        /// <param name="importFilter">The import filter.</param>
        /// <returns></returns>
