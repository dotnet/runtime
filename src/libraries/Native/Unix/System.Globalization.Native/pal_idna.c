    ...
    uint32_t flags, const uint16_t* lpSrc, int32_t cwSrcLength, uint16_t* lpDst, int32_t cwDstLength)
{
    ...
    int32_t asciiStrLen = uidna_nameToASCII(pIdna, (UChar*)lpSrc, cwSrcLength, tmpDst, cwDstLength, &info, &err);
    ...
    uint32_t flags, const uint16_t* lpSrc, int32_t cwSrcLength, uint16_t* lpDst, int32_t cwDstLength)
{
    ...
    UChar *tmpDst = (UChar*)lpDst;
    int32_t unicodeStrLen = uidna_nameToUnicode(pIdna, (UChar*)lpSrc, cwSrcLength, tmpDst, cwDstLength, &info, &err);
