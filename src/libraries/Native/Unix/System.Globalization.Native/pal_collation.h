...
EXTERN_C DLLEXPORT ResultCode GlobalizationNative_GetSortHandle(const char* lpLocaleName, SortHandle** ppSortHandle);

EXTERN_C DLLEXPORT void GlobalizationNative_CloseSortHandle(SortHandle* pSortHandle);
