...
static gss_OID_desc gss_mech_spnego_OID_desc = {.length = MINIPAL_STRLEN(gss_spnego_oid_value),
...
static gss_OID_desc gss_mech_ntlm_OID_desc = {.length = MINIPAL_STRLEN(gss_ntlm_oid_value),
