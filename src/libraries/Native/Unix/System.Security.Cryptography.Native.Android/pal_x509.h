...
// Basic properties
PALEXPORT int64_t AndroidCryptoNative_GetX509NotAfter(jobject /*X509Certificate*/ cert);
PALEXPORT int64_t AndroidCryptoNative_GetX509NotBefore(jobject /*X509Certificate*/ cert);
PALEXPORT int32_t AndroidCryptoNative_GetX509PublicKeyAlgorithm(jobject /*X509Certificate*/ cert, char *buf, int32_t len);
PALEXPORT int32_t AndroidCryptoNative_GetX509PublicKeyBytes(jobject /*X509Certificate*/ cert, uint8_t *pBuf, int32_t cBuf);
PALEXPORT int32_t AndroidCryptoNative_GetX509SignatureAlgorithm(jobject /*X509Certificate*/ cert, char *buf, int32_t len);
