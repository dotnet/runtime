...
namespace System.Runtime.Loader.Tests
{
    public partial class AssemblyLoadContextTest
    {
        ...
        public static void MissingTransitiveDependency_ExceptionMessageContainsRequestingAssembly()
        {
            ...
            // for the missing Leaf assembly. The exception message should include the immediate requesting
            // assembly (Mid) so users can diagnose dependency loading issues.
