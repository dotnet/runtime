...
namespace System.Runtime.Loader.Tests
{
    public class TpaLoadFailureTest
    {
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsCoreCLR), nameof(PlatformDetection.HasAssemblyFiles), nameof(PlatformDetection.IsNotAppleMobile))]
