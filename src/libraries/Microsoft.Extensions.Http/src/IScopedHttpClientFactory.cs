...
namespace System.Net.Http
{
    ...
    /// configuration for a given logical name with respect to an existing DI scope.
    /// </summary>
    /// <remarks>
    /// A default <see cref="IScopedHttpClientFactory"/> can be registered in an <see cref="IServiceCollection"/>
    /// by calling <see cref="HttpClientFactoryServiceCollectionExtensions.AddHttpClient(IServiceCollection)"/>.
    /// The default <see cref="IScopedHttpClientFactory"/> will be registered in the service collection as a scoped service.
    /// To use a configuration with a default <see cref="IScopedHttpClientFactory"/>, it should have
    ...
    public interface IScopedHttpClientFactory
    {
        ...
        /// <see cref="IScopedHttpClientFactory"/> tracks and disposes resources used by the <see cref="HttpClient"/>.
        /// </para>
        /// <para>
