...
namespace System.Linq
{
    ...
    public static class Queryable
    {
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>If the type of <paramref name="source" /> implements <see cref="System.Linq.IQueryable{T}" />, <see cref="System.Linq.Queryable.AsQueryable(System.Collections.IEnumerable)" /> returns it directly. Otherwise, it returns an <see cref="System.Linq.IQueryable{T}" /> that executes queries by calling the equivalent query operator methods in <see cref="System.Linq.Enumerable" /> instead of those in <see cref="System.Linq.Queryable" />.
        /// This method assumes that <paramref name="source" /> implements <see cref="System.Collections.Generic.IEnumerable{T}" /> for some `T`. At runtime, the result is of type <see cref="System.Linq.IQueryable{T}" /> for the same `T`. This method is useful in dynamic scenarios when you do not statically know the type of `T`.</remarks>
        [RequiresUnreferencedCode(InMemoryQueryableExtensionMethodsRequiresUnreferencedCode)]
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Where{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Where{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Where{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Where{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Where{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the elements from <paramref name="source" /> that satisfy the condition specified by <paramref name="predicate" />. The index of each source element is provided as the second argument to <paramref name="predicate" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The `OfType` method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling `OfType` itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling `OfType` depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it filters out any elements in <paramref name="source" /> that are not of type <typeparamref name="TResult" />.</remarks>
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Cast{T}(System.Linq.IQueryable)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Cast{T}(System.Linq.IQueryable)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Cast{T}(System.Linq.IQueryable)" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it converts the values in <paramref name="source" /> to type <typeparamref name="TResult" />.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Select{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Select{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Select{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="selector" /> on each element of <paramref name="source" /> to project it into a different form.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="selector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Select{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Select{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Select{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,T2}})" /> depend on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="selector" /> on each element of <paramref name="source" /> to project it into a different form.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="selector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SelectMany{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2}}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2}}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2}}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="selector" /> on each element of <paramref name="source" /> to project it into an enumerable form. It then concatenates the enumerable results into a single, one-dimensional sequence.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="selector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SelectMany{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,System.Collections.Generic.IEnumerable{T2}}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,System.Collections.Generic.IEnumerable{T2}}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,System.Collections.Generic.IEnumerable{T2}}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="selector" /> on each element of <paramref name="source" /> to project it into an enumerable form. Each enumerable result incorporates the index of the source element. It then concatenates the enumerable results into a single, one-dimensional sequence.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SelectMany{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,System.Collections.Generic.IEnumerable{T2}}},System.Linq.Expressions.Expression{System.Func{T1,T2,T3}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,System.Collections.Generic.IEnumerable{T2}}},System.Linq.Expressions.Expression{System.Func{T1,T2,T3}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,int,System.Collections.Generic.IEnumerable{T2}}},System.Linq.Expressions.Expression{System.Func{T1,T2,T3}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="collectionSelector" /> on each element of <paramref name="source" /> to project it into an enumerable form. Each enumerable result incorporates the source element's index. Then the function represented by <paramref name="resultSelector" /> is invoked on each element in each intermediate sequence. The resulting values are concatenated into a single, one-dimensional sequence.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="collectionSelector" /> or <paramref name="resultSelector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SelectMany{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2}}},System.Linq.Expressions.Expression{System.Func{T1,T2,T3}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SelectMany{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2}}},System.Linq.Expressions.Expression{System.Func{T1,T2,T3}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="outer" /> or <paramref name="inner" /> or <paramref name="outerKeySelector" /> or <paramref name="innerKeySelector" /> or <paramref name="resultSelector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupJoin{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Collections.Generic.IEnumerable{T2},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,T3}},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2},T4}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupJoin{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Collections.Generic.IEnumerable{T2},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,T3}},System.Linq.Expressions.Expression{System.Func{T1,System.Collections.Generic.IEnumerable{T2},T4}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="outer" /> parameter.
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.OrderBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.OrderBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter. The result of calling <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> is cast to type <see cref="System.Linq.IOrderedQueryable{T}" /> and returned.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.OrderBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it sorts the elements of <paramref name="source" /> based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.OrderBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.OrderBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter. The result of calling <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> is cast to type <see cref="System.Linq.IOrderedQueryable{T}" /> and returned.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.OrderBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it sorts the elements of <paramref name="source" /> based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />. The <paramref name="comparer" /> parameter is used to compare keys.</remarks>
        [DynamicDependency("OrderBy`2", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="keySelector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.OrderByDescending{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.OrderByDescending{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter. The result of calling <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> is cast to type <see cref="System.Linq.IOrderedQueryable{T}" /> and returned.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.OrderByDescending{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it sorts the elements of <paramref name="source" /> in descending order, based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="keySelector" /> or <paramref name="comparer" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.OrderByDescending{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.OrderByDescending{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter. The result of calling <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> is cast to type <see cref="System.Linq.IOrderedQueryable{T}" /> and returned.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.OrderByDescending{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it sorts the elements of <paramref name="source" /> in descending order, based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />. The <paramref name="comparer" /> parameter is used to compare keys.</remarks>
        ...
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.ThenBy{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it performs a secondary sort of the elements of <paramref name="source" /> based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />. All previously established sort orders are preserved. The <paramref name="comparer" /> parameter is used to compare key values.</remarks>
        [DynamicDependency("ThenBy`2", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="keySelector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.ThenByDescending{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.ThenByDescending{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter. The result of calling <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> is cast to type <see cref="System.Linq.IOrderedQueryable{T}" /> and returned.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.ThenByDescending{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it performs a secondary sort of the elements of <paramref name="source" /> in descending order, based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />. All previously established sort orders are preserved.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.ThenBy{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.ThenBy{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter. The result of calling <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> is cast to type <see cref="System.Linq.IOrderedQueryable{T}" /> and returned.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.ThenBy{T1,T2}(System.Linq.IOrderedQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it performs a secondary sort of the elements of <paramref name="source" /> in descending order, based on the key obtained by invoking <paramref name="keySelector" /> on each element of <paramref name="source" />. All previously established sort orders are preserved. The <paramref name="comparer" /> parameter is used to compare key values.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Take{T}(System.Linq.IQueryable{T},int)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Take{T}(System.Linq.IQueryable{T},int)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Take{T}(System.Linq.IQueryable{T},int)" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it takes the first <paramref name="count" /> elements from the start of <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.TakeWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.TakeWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.TakeWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it applies <paramref name="predicate" /> to each element in <paramref name="source" /> until it finds an element for which <paramref name="predicate" /> returns <see langword="false" />. It returns all the elements up until that point.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.TakeWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.TakeWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.TakeWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it applies <paramref name="predicate" /> to each element in <paramref name="source" /> until it finds an element for which <paramref name="predicate" /> returns <see langword="false" />. It returns all the elements up until that point. The index of each source element is provided as the second argument to <paramref name="predicate" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Skip{T}(System.Linq.IQueryable{T},int)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Skip{T}(System.Linq.IQueryable{T},int)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Skip{T}(System.Linq.IQueryable{T},int)" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it skips the first <paramref name="count" /> elements in <paramref name="source" /> and returns the remaining elements.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SkipWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SkipWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SkipWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it applies <paramref name="predicate" /> to each element in <paramref name="source" /> until it finds an element for which <paramref name="predicate" /> returns false. That element and all the remaining elements are returned.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SkipWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SkipWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SkipWhile{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it applies <paramref name="predicate" /> to each element in <paramref name="source" /> until it finds an element for which <paramref name="predicate" /> returns false. That element and all the remaining elements are returned. The index of each source element is provided as the second argument to <paramref name="predicate" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="keySelector" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it groups the elements of <paramref name="source" /> by a key value that is obtained by invoking <paramref name="keySelector" /> on each element.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="keySelector" /> or <paramref name="comparer" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IEqualityComparer{T2})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IEqualityComparer{T2})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Collections.Generic.IEqualityComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it groups the elements of <paramref name="source" /> by a key value. The key value is obtained by invoking <paramref name="keySelector" /> on each element, and key values are compared by using <paramref name="comparer" />.</remarks>
        [DynamicDependency("GroupBy`2", typeof(Enumerable))]
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it groups the elements of <paramref name="source" /> by key values that are obtained by invoking <paramref name="keySelector" /> on each element. The <paramref name="elementSelector" /> parameter is used to project the elements of each group, and the <paramref name="resultSelector" /> parameter is used to obtain a result value from each group and its key.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it groups the elements of <paramref name="source" /> by a key value that is obtained by invoking <paramref name="keySelector" /> on each element. The <paramref name="resultSelector" /> parameter is used to obtain a result value from each group and its key.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3}},System.Collections.Generic.IEqualityComparer{T2})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3}},System.Collections.Generic.IEqualityComparer{T2})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3}},System.Collections.Generic.IEqualityComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it groups the elements of <paramref name="source" /> by key values that are obtained by invoking <paramref name="keySelector" /> on each element. The <paramref name="comparer" /> parameter is used to compare keys and the <paramref name="resultSelector" /> parameter is used to obtain a result value from each group and its key.</remarks>
        [DynamicDependency("GroupBy`3", typeof(Enumerable))]
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4}},System.Collections.Generic.IEqualityComparer{T2})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4}},System.Collections.Generic.IEqualityComparer{T2})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.GroupBy{T1,T2,T3,T4}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}},System.Linq.Expressions.Expression{System.Func{T1,T3}},System.Linq.Expressions.Expression{System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4}},System.Collections.Generic.IEqualityComparer{T2})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it groups the elements of <paramref name="source" /> by key values that are obtained by invoking <paramref name="keySelector" /> on each element. The <paramref name="comparer" /> parameter is used to compare key values. The <paramref name="elementSelector" /> parameter is used to project the elements of each group, and the <paramref name="resultSelector" /> parameter is used to obtain a result value from each group and its key.</remarks>
        [DynamicDependency("GroupBy`4", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Distinct{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Distinct{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Distinct{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns an unordered sequence of the unique items in <paramref name="source" />.</remarks>
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Distinct{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEqualityComparer{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Distinct{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEqualityComparer{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Distinct{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEqualityComparer{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns an unordered sequence of the unique items in <paramref name="source" /> by using <paramref name="comparer" /> to compare values.</remarks>
        [DynamicDependency("Distinct`1", typeof(Enumerable))]
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Concat{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Concat{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Concat{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that the elements in <paramref name="source2" /> are concatenated to those of <paramref name="source1" /> to create a new sequence.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="O:System.Linq.Queryable.Zip" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="O:System.Linq.Queryable.Zip" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The method merges each element of the first sequence with an element that has the same index in the second sequence. If the sequences do not have the same number of elements, the method merges sequences until it reaches the end of one of them. For example, if one sequence has three elements and the other one has four, the resulting sequence will have only three elements.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Union{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Union{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Union{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that the set union of the elements in <paramref name="source1" /> and <paramref name="source2" /> is returned.</remarks>
        ...
        /// <returns>An <see cref="System.Linq.IQueryable{T}" /> that contains the elements from both input sequences, excluding duplicates.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Union{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Union{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Union{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that the set union of the elements in <paramref name="source1" /> and <paramref name="source2" /> is returned. The <paramref name="comparer" /> parameter is used to compare values.</remarks>
        [DynamicDependency("Union`1", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Intersect{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Intersect{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Intersect{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that all the elements in <paramref name="source1" /> that are also in <paramref name="source2" /> are returned.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Except{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Except{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the<paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Except{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> depends on the implementation of the type of  the <paramref name="source1" /> parameter. The expected behavior is that all the elements in <paramref name="source1" /> are returned except for those that are also in <paramref name="source2" />.</remarks>
        ...
        /// <returns>An <see cref="System.Linq.IQueryable{T}" /> that contains the set difference of the two sequences.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Except{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Except{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the<paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Except{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that all the elements in <paramref name="source1" /> are returned except for those that are also in <paramref name="source2" />, and <paramref name="comparer" /> is used to compare values.</remarks>
        [DynamicDependency("Except`1", typeof(Enumerable))]
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.First{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.First{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.First{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the first element in <paramref name="source" />.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.First{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.First{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.FirstOrDefault{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.FirstOrDefault{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.FirstOrDefault{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the first element in <paramref name="source" />, or a default value if <paramref name="source" /> is empty.
        /// The <see cref="O:System.Linq.Queryable.FirstOrDefault" /> method does not provide a way to specify the default value to return if <paramref name="source" /> is empty. If you want to specify a default value other than `default(TSource)`, use the <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T},T)" /> method as described in the Example section.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.FirstOrDefault{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.FirstOrDefault{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.FirstOrDefault{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the first element in <paramref name="source" /> that satisfies the condition in <paramref name="predicate" />, or a default value if no element satisfies the condition.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <exception cref="System.InvalidOperationException">The source sequence is empty.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Last{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Last{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Last{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the last element in <paramref name="source" />.</remarks>
        ...
        /// The source sequence is empty.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Last{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Last{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.LastOrDefault{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.LastOrDefault{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.LastOrDefault{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the last element in <paramref name="source" />, or a default value if <paramref name="source" /> is empty.
        /// The <see cref="O:System.Linq.Queryable.LastOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T},T)" /> method as described in the Example section.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.LastOrDefault{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.LastOrDefault{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.LastOrDefault{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the last element in <paramref name="source" /> that satisfies the condition specified by <paramref name="predicate" />. It returns a default value if there is no such element in <paramref name="source" />.</remarks>
        ...
        /// -or-
        /// The source sequence is empty.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Single{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Single{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Single{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the only element in <paramref name="source" />.</remarks>
        ...
        /// The source sequence is empty.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Single{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Single{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.SingleOrDefault{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SingleOrDefault{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SingleOrDefault{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the only element in <paramref name="source" />, or a default value if <paramref name="source" /> is empty.
        /// The <see cref="O:System.Linq.Queryable.SingleOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T},T)" /> method as described in the Example section.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.SingleOrDefault{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SingleOrDefault{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SingleOrDefault{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the only element in <paramref name="source" /> that satisfies the condition specified by <paramref name="predicate" />, or a default value if no such element exists.</remarks>
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.ElementAt{T}(System.Linq.IQueryable{T},int)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.ElementAt{T}(System.Linq.IQueryable{T},int)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.ElementAt{T}(System.Linq.IQueryable{T},int)" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the item at position <paramref name="index" /> in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.ElementAtOrDefault{T}(System.Linq.IQueryable{T},int)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.ElementAtOrDefault{T}(System.Linq.IQueryable{T},int)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.ElementAtOrDefault{T}(System.Linq.IQueryable{T},int)" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the item at position <paramref name="index" /> in <paramref name="source" />, or `default(TSource)` if <paramref name="index" /> is outside the bounds of <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns <paramref name="source" /> if it is not empty. Otherwise, it returns an <see cref="System.Linq.IQueryable{T}" /> that contains `default(TSource)`.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T},T)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T},T)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.DefaultIfEmpty{T}(System.Linq.IQueryable{T},T)" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns <paramref name="source" /> if it is not empty. Otherwise, it returns an <see cref="System.Linq.IQueryable{T}" /> that contains <paramref name="defaultValue" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Contains{T}(System.Linq.IQueryable{T},T)" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Contains{T}(System.Linq.IQueryable{T},T)" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <returns><see langword="true" /> if the input sequence contains an element that has the specified value; otherwise, <see langword="false" />.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Contains{T}(System.Linq.IQueryable{T},T,System.Collections.Generic.IEqualityComparer{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Contains{T}(System.Linq.IQueryable{T},T,System.Collections.Generic.IEqualityComparer{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Contains{T}(System.Linq.IQueryable{T},T,System.Collections.Generic.IEqualityComparer{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it determines if <paramref name="source" /> contains <paramref name="item" /> by using <paramref name="comparer" /> to compare values.</remarks>
        [DynamicDependency("Contains`1", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Reverse{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Reverse{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.CreateQuery{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Reverse{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it reverses the order of the elements in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.SequenceEqual{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SequenceEqual{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SequenceEqual{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that it determines if the two source sequences are equal.</remarks>
        ...
        /// <returns><see langword="true" /> if the two source sequences are of equal length and their corresponding elements compare equal; otherwise, <see langword="false" />.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source1" /> or <paramref name="source2" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.SequenceEqual{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.SequenceEqual{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source1" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.SequenceEqual{T}(System.Linq.IQueryable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> depends on the implementation of the type of the <paramref name="source1" /> parameter. The expected behavior is that it determines if the two source sequences are equal by using <paramref name="comparer" /> to compare elements.</remarks>
        [DynamicDependency("SequenceEqual`1", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Any{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Any{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Any{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it determines if <paramref name="source" /> contains any elements.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Any{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Any{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.All{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.All{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.All{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> depends on the implementation of the <paramref name="source" /> parameter's type. The expected behavior is that it determines if all the elements in <paramref name="source" /> satisfy the condition in <paramref name="predicate" />.</remarks>
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Count{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Count{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Count{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it counts the number of items in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.OverflowException">The number of elements in <paramref name="source" /> is larger than <see cref="int.MaxValue" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Count{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Count{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.LongCount{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.LongCount{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.LongCount{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it counts the number of items in <paramref name="source" /> and returns an <see cref="long" />.</remarks>
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.LongCount{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.LongCount{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.LongCount{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,bool}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it counts the number of items in <paramref name="source" /> that satisfy the condition specified by <paramref name="predicate" /> and returns an <see cref="long" />.</remarks>
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Min{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Min{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Min{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the minimum value in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Min{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Min{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Min{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="selector" /> on each element in <paramref name="source" /> and returns the minimum value.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Max{T}(System.Linq.IQueryable{T})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Max{T}(System.Linq.IQueryable{T})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Max{T}(System.Linq.IQueryable{T})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the maximum value in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Max{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Max{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Max{T1,T2}(System.Linq.IQueryable{T1},System.Linq.Expressions.Expression{System.Func{T1,T2}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it invokes <paramref name="selector" /> on each element in <paramref name="source" /> and returns the maximum value.</remarks>
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{int})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{int})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{int})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <exception cref="System.OverflowException">The sum is larger than <see cref="int.MaxValue" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{int}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{int}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{int}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        [DynamicDependency("Sum", typeof(Enumerable))]
        public static int? Sum(this IQueryable<int?> source)
        {
            if (source == null)
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{long})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{long})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{long})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        [DynamicDependency("Sum", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <exception cref="System.OverflowException">The sum is larger than <see cref="long.MaxValue" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{long}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{long}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{long}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        [DynamicDependency("Sum", typeof(Enumerable))]
        public static long? Sum(this IQueryable<long?> source)
        {
            if (source == null)
        ...
        /// <returns>The sum of the values in the sequence.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{float})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{float})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{float})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        ...
        /// <returns>The sum of the values in the sequence.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{float}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{float}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{float}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        ...
        /// <returns>The sum of the values in the sequence.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{double})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{double})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{double})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        [DynamicDependency("Sum", typeof(Enumerable))]
        ...
        /// <returns>The sum of the values in the sequence.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{double}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{double}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{decimal})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{decimal})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{decimal})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        [DynamicDependency("Sum", typeof(Enumerable))]
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <exception cref="System.OverflowException">The sum is larger than <see cref="decimal.MaxValue" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{decimal}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{decimal}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Nullable{decimal}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it returns the sum of the values in <paramref name="source" />.</remarks>
        [DynamicDependency("Sum", typeof(Enumerable))]
        public static decimal? Sum(this IQueryable<decimal?> source)
        {
            if (source == null)
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Average(System.Linq.IQueryable{int})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Average(System.Linq.IQueryable{int})" /> itself. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Average(System.Linq.IQueryable{int})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it calculates the average of the values in <paramref name="source" />.</remarks>
        ...
        /// <returns>The average of the sequence of values, or <see langword="null" /> if the source sequence is empty or contains only <see langword="null" /> values.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Queryable.Average(System.Linq.IQueryable{System.Nullable{long}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Average(System.Linq.IQueryable{System.Nullable{long}})" /> itself. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Average(System.Linq.IQueryable{System.Nullable{long}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it calculates the average of the values in <paramref name="source" />.</remarks>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Average{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Average{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Average{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,int}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that it calculates the average of the values in <paramref name="source" /> after invoking <paramref name="selector" /> on each value.</remarks>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Aggregate{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,T,T}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Aggregate{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,T,T}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Aggregate{T}(System.Linq.IQueryable{T},System.Linq.Expressions.Expression{System.Func{T,T,T}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that the specified function, <paramref name="func" />, is applied to each value in the source sequence and the accumulated value is returned. The first value in <paramref name="source" /> is used as the seed value for the accumulated value, which corresponds to the first parameter in <paramref name="func" />.
        /// To simplify common aggregation operations, the set of standard query operators also includes two counting methods, <see cref="O:System.Linq.Queryable.Count" /> and <see cref="O:System.Linq.Queryable.LongCount" />, and four numeric aggregation methods, namely <see cref="O:System.Linq.Queryable.Max" />, <see cref="O:System.Linq.Queryable.Min" />, <see cref="O:System.Linq.Queryable.Sum" />, and <see cref="O:System.Linq.Queryable.Average" />.</remarks>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="func" /> is <see langword="null" />.</exception>
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Aggregate{T1,T2}(System.Linq.IQueryable{T1},T2,System.Linq.Expressions.Expression{System.Func{T2,T1,T2}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Aggregate{T1,T2}(System.Linq.IQueryable{T1},T2,System.Linq.Expressions.Expression{System.Func{T2,T1,T2}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        ...
        /// <remarks>This method has at least one parameter of type <see cref="System.Linq.Expressions.Expression{T}" /> whose type argument is one of the <see cref="System.Func{T1,T2}" /> types. For these parameters, you can pass in a lambda expression and it will be compiled to an <see cref="System.Linq.Expressions.Expression{T}" />.
        /// The <see cref="System.Linq.Queryable.Aggregate{T1,T2,T3}(System.Linq.IQueryable{T1},T2,System.Linq.Expressions.Expression{System.Func{T2,T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,T3}})" /> method generates a <see cref="System.Linq.Expressions.MethodCallExpression" /> that represents calling <see cref="System.Linq.Queryable.Aggregate{T1,T2,T3}(System.Linq.IQueryable{T1},T2,System.Linq.Expressions.Expression{System.Func{T2,T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,T3}})" /> itself as a constructed generic method. It then passes the <see cref="System.Linq.Expressions.MethodCallExpression" /> to the <see cref="System.Linq.IQueryProvider.Execute{T}(System.Linq.Expressions.Expression)" /> method of the <see cref="System.Linq.IQueryProvider" /> represented by the <see cref="O:System.Linq.IQueryable.Provider" /> property of the <paramref name="source" /> parameter.
        /// The query behavior that occurs as a result of executing an expression tree that represents calling <see cref="System.Linq.Queryable.Aggregate{T1,T2,T3}(System.Linq.IQueryable{T1},T2,System.Linq.Expressions.Expression{System.Func{T2,T1,T2}},System.Linq.Expressions.Expression{System.Func{T2,T3}})" /> depends on the implementation of the type of the <paramref name="source" /> parameter. The expected behavior is that the specified function, <paramref name="func" />, is applied to each value in the source sequence and the accumulated value is returned. The <paramref name="seed" /> parameter is used as the seed value for the accumulated value, which corresponds to the first parameter in <paramref name="func" />. The final accumulated value is passed to <paramref name="selector" /> to obtain the result value.
        /// To simplify common aggregation operations, the set of standard query operators also includes two counting methods, <see cref="O:System.Linq.Queryable.Count" /> and <see cref="O:System.Linq.Queryable.LongCount" />, and four numeric aggregation methods, namely <see cref="O:System.Linq.Queryable.Max" />, <see cref="O:System.Linq.Queryable.Min" />, <see cref="O:System.Linq.Queryable.Sum" />, and <see cref="O:System.Linq.Queryable.Average" />.</remarks>
