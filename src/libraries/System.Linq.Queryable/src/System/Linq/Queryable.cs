...
namespace System.Linq
{
    public static class Queryable
    {
        ...
        public static IQueryable<TResult> Join<TOuter, TInner, TKey, TResult>(this IQueryable<TOuter> outer!!, IEnumerable<TInner> inner!!, Expression<Func<TOuter, TKey>> outerKeySelector!!, Expression<Func<TInner, TKey>> innerKeySelector!!, Expression<Func<TOuter, TInner, TResult>> resultSelector!!) => outer.Provider.CreateQuery<TResult>(
                Expression.Call(
                    null,
        ...
        public static IOrderedQueryable<TSource> OrderBy<TSource, TKey>(this IQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        [DynamicDependency("OrderBy`2", typeof(Enumerable))]
        public static IOrderedQueryable<TSource> OrderBy<TSource, TKey>(this IQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!, IComparer<TKey>? comparer) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        public static IOrderedQueryable<TSource> OrderByDescending<TSource, TKey>(this IQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        [DynamicDependency("OrderByDescending`2", typeof(Enumerable))]
        public static IOrderedQueryable<TSource> OrderByDescending<TSource, TKey>(this IQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!, IComparer<TKey>? comparer) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        public static IOrderedQueryable<TSource> ThenBy<TSource, TKey>(this IOrderedQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        [DynamicDependency("ThenBy`2", typeof(Enumerable))]
        public static IOrderedQueryable<TSource> ThenBy<TSource, TKey>(this IOrderedQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!, IComparer<TKey>? comparer) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        public static IOrderedQueryable<TSource> ThenByDescending<TSource, TKey>(this IOrderedQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        [DynamicDependency("ThenByDescending`2", typeof(Enumerable))]
        public static IOrderedQueryable<TSource> ThenByDescending<TSource, TKey>(this IOrderedQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!, IComparer<TKey>? comparer) => (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        public static IQueryable<IGrouping<TKey, TSource>> GroupBy<TSource, TKey>(this IQueryable<TSource> source!!, Expression<Func<TSource, TKey>> keySelector!!) =>
            source.Provider.CreateQuery<IGrouping<TKey, TSource>>(
                Expression.Call(
                    null,
        ...
        public static IQueryable<TSource> Concat<TSource>(this IQueryable<TSource> source1!!, IEnumerable<TSource> source2!!) =>
            source1.Provider.CreateQuery<TSource>(
                Expression.Call(
                    null,
        ...
        public static IQueryable<(TFirst First, TSecond Second)> Zip<TFirst, TSecond>(this IQueryable<TFirst> source1!!, IEnumerable<TSecond> source2!!) =>
            source1.Provider.CreateQuery<(TFirst, TSecond)>(
                Expression.Call(
                    null,
        ...
        public static IQueryable<TResult> Zip<TFirst, TSecond, TResult>(this IQueryable<TFirst> source1!!, IEnumerable<TSecond> source2!!, Expression<Func<TFirst, TSecond, TResult>> resultSelector!!) =>
            source1.Provider.CreateQuery<TResult>(
                Expression.Call(
                    null,
        ...
        public static IQueryable<(TFirst First, TSecond Second, TThird Third)> Zip<TFirst, TSecond, TThird>(this IQueryable<TFirst> source1!!, IEnumerable<TSecond> source2!!, IEnumerable<TThird> source3!!) =>
            source1.Provider.CreateQuery<(TFirst, TSecond, TThird)>(
                Expression.Call(
                    null,
        ...
        public static decimal Sum(this IQueryable<decimal> source!!) =>
            source.Provider.Execute<decimal>(
                Expression.Call(
                    null,
        ...
        public static TAccumulate Aggregate<TSource, TAccumulate>(this IQueryable<TSource> source!!, TAccumulate seed, Expression<Func<TAccumulate, TSource, TAccumulate>> func!!) =>
            source.Provider.Execute<TAccumulate>(
                Expression.Call(
                    null,
