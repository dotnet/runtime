...
namespace System.CodeDom.Compiler.Tests
{
    public class CompilerResultsTests
    {
        ...
        {
            var results = new CompilerResults(null) { PathToAssembly = (PlatformDetection.IsBrowser ? "/" : string.Empty) + AssemblyPathHelper.GetAssemblyLocation(typeof(CompilerResultsTests).Assembly) };
