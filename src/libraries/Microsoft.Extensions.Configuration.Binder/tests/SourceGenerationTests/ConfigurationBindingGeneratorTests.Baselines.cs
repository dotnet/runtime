...
public class Program
{
    ...
    public class MyClass2 { }
        ...
        public async Task Bind(LanguageVersion langVersion) =>
            await VerifyAgainstBaselineUsingFile("Bind.generated.txt", BindCallSampleCode, langVersion);
        ...
        public async Task Bind_Instance()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Bind_Instance.generated.txt", source);
        }
        ...
        public async Task Bind_Instance_BinderOptions()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Bind_Instance_BinderOptions.generated.txt", source);
        }
        ...
        public async Task Bind_Key_Instance()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Bind_Key_Instance.generated.txt", source);
        }
...
public class Program
{
    ...
    public class MyClass4
    {
        public int MyInt { get; set; }
            ...
            await VerifyAgainstBaselineUsingFile("Get.generated.txt", source);
        }
        ...
        public async Task Get_T()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Get_T.generated.txt", source);
        }
        ...
        public async Task Get_T_BinderOptions()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Get_T_BinderOptions.generated.txt", source);
        }
        ...
        public async Task Get_TypeOf()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Get_TypeOf.generated.txt", source);
        }
        ...
        public async Task Get_TypeOf_BinderOptions()
        {
            ...
            await VerifyAgainstBaselineUsingFile("Get_TypeOf_BinderOptions.generated.txt", source);
        }
...
public class Program
{
	...
	public class MyClass
	{
		...
		public Dictionary<string, string> MyDictionary { get; set; }
            ...
            await VerifyAgainstBaselineUsingFile("GetValue.generated.txt", source);
        }
        ...
        public async Task GetValue_T_Key()
        {
            ...
            await VerifyAgainstBaselineUsingFile("GetValue_T_Key.generated.txt", source);
        }
        ...
        public async Task GetValue_T_Key_DefaultValue()
        {
            ...
            await VerifyAgainstBaselineUsingFile("GetValue_T_Key_DefaultValue.generated.txt", source);
        }
        ...
        public async Task GetValue_TypeOf_Key()
        {
            ...
            await VerifyAgainstBaselineUsingFile("GetValue_TypeOf_Key.generated.txt", source);
        }
        ...
        public async Task GetValue_TypeOf_Key_DefaultValue()
        {
            ...
            await VerifyAgainstBaselineUsingFile("GetValue_TypeOf_Key_DefaultValue.generated.txt", source);
        }
...
public class Program
{
    ...
    public class MyClass2
    {
        public int MyInt { get; set; }
            ...
            await VerifyAgainstBaselineUsingFile("Configure.generated.txt", source);
        }
...
public class Program
{
    ...
    public class MyClass2
    {
        ...
        [Fact]
        public async Task PrimitivesGen()
        {
            string source = """
                using System;
                using System.Globalization;
