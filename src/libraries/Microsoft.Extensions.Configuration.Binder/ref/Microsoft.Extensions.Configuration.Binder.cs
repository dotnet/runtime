...
namespace Microsoft.Extensions.Configuration
{
    ...
    public static partial class ConfigurationBinder
    {
        ...
        [System.Diagnostics.CodeAnalysis.RequiresUnreferencedCodeAttribute("In case the type is Generic, the trimmer cannot statically analyze the generic type arguments so their members may be trimmed.")]
