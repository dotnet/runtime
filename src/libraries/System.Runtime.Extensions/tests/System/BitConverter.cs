...
namespace System.Tests
{
    public static class BitConverterTests
    {
        ...
        {
            Int128 input = new Int128(0x0123456789abcdef, 0x0123456789abcdef);
            byte[] expected = { 0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01, 0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01 };
        ...
        {
            UInt128 input = new UInt128(0x0123456789abcdef, 0x0123456789abcdef);
            byte[] expected = { 0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01, 0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01 };
