...
namespace System.Tests
{
    public abstract class BitConverterBase
    {
        ...
        [InlineData((UInt128)1000000000000000000, new byte[] { 0x00, 0x00, 0x64, 0xA7, 0xB3, 0xB6, 0xE0, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 })]
        [InlineData(new UInt128(0x0000000010, 0x00000000), new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00 })]
        ...
        [InlineData((UInt128)10000000000000000000*10000000000000000000, new byte[] { 0x00, 0x00, 0x00, 0x00, 0x40, 0x22, 0x8A, 0x09, 0x7A, 0xC4; 0x86, 0x5A, 0xA8, 0x4C, 0x3B, 0x4B })]
