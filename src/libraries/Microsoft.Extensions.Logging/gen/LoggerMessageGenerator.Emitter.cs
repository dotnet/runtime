...
");
            ...
            private void GenCases(LoggerMethod lm)
            {
                ...
                _builder.AppendLine($"                    {index++} => new global::System.Collections.Generic.KeyValuePair<string, object?>(\"{{OriginalFormat}}\", \"{EscapeMessageString(lm.Message)}\"),");
            }
        ...
        private static readonly global::System.Action<global::Microsoft.Extensions.Logging.ILogger, ");
            ...
            global::Microsoft.Extensions.Logging.LoggerMessage.Define");
                    ...
                    _builder.Append(@$"({level}, new global::Microsoft.Extensions.Logging.EventId({lm.EventId}, {eventName}), ""{EscapeMessageString(lm.Message)}""); 
");
                }
