...
namespace System.Numerics.Tests
{
    public class Matrix4x4RightHandChangedBasisTests : Matrix4x4LeftHandTests
    {
        ...
        {
            return SwapHandednessMatrix * Matrix4x4.CreateLookAt(
        ...
        {
            return SwapHandednessMatrix * Matrix4x4.CreateLookTo(
                SwapHandedness(cameraPosition),
        ...
        {
            return SwapHandednessMatrix * Matrix4x4.CreateViewport(x, y, width, height, -minDepth, -maxDepth) * SwapHandednessMatrix;
        }
        ...
        {
            return SwapHandednessMatrix * Matrix4x4.CreateBillboard(
        ...
        {
            return SwapHandednessMatrix * Matrix4x4.CreateConstrainedBillboard(
                SwapHandedness(objectPosition),
                SwapHandedness(cameraPosition),
