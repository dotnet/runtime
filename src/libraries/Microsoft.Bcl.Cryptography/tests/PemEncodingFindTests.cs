...
";
        ...
        private protected abstract void AssertNoPemFound(ReadOnlySpan<char> input);

        private protected abstract PemFields FindPem(ReadOnlySpan<char> input);
    }

    public class PemEncodingFindThrowingTests : PemEncodingFindTests
    {
        private protected override PemFields FindPem(ReadOnlySpan<char> input) => PemEncoding.Find(input);

        private protected override void AssertNoPemFound(ReadOnlySpan<char> input)
        {
    ...
    {
        private protected override PemFields FindPem(ReadOnlySpan<char> input)
        {
