...
//        //TODO: Test this source generator
//        private void CallToLower(StringBuilder? sourceGeneratorCode = null, string? convertToLower = null)
//        {
...
//$@"{convertToLower!} = char.ToLowerInvariant({convertToLower!});
//");
//                }
//            }
//            else
...
//            Label returnFalse = default;
//            Label finishedLengthCheck = default;
//            if (!_code.RightToLeft)
//            {
//                if (sourceGeneratorCode == null)
//                {
//                    returnFalse = DefineLabel();
//                    finishedLengthCheck = DefineLabel();
//                    Ldloc(_runtextposLocal);
...
//            // TODO: Transpile all this IL to C#
...
//                                if (!_code.RightToLeft)
//                                {
//                                    // TODO: Test. Test the if condition and statements inside the if before the return false
//                                    sourceGeneratorCode.Append(
//$@"if (runtextpos > this.runtextbeg)
//{{
...
//                    //                        sourceGeneratorCode.Append(
//                    //$@"
//                    //runtextpos += {_boyerMoorePrefix.Pattern.Length - 1};
//                    //");
//                    //                    }
//                    //                    else
//                    //                    {
//                    //                        sourceGeneratorCode.Append(
//                    //$@"
//                    //runtextpos -= {_boyerMoorePrefix.Pattern.Length};
//                    //");
//                    //                    }
//                }
...
//                Label lStart = default;
//                Label lDefaultAdvance = default;
//                Label lAdvance = default;
//                if (sourceGeneratorCode == null)
//                {
//                    lStart = DefineLabel();
//                    Br(lStart);
...
//                    if (!_code.RightToLeft)
//                    {
//                        // TODO: Not super sure about the assignment to this.runtextpos here
//                        sourceGeneratorCode.Append(
...
//                    sourceGeneratorCode.Append(
//$@"
//int ch = runtext[runtextpos];
//");
//                    if (_boyerMoorePrefix.CaseInsensitive)
//                    {
//                        CallToLower(sourceGeneratorCode);
//                    }
//                }

//                Label lPartialMatch = default;
//                if (sourceGeneratorCode == null)
//                {
//                    using (RentedLocalBuilder chLocal = RentInt32Local())
//                    {
//                        lPartialMatch = DefineLabel();
...
//{{
//");
//                    // TODO; defaultAdvance is not defined yet. Might be worth it to just write out what defaultAdvance is doing explicitly
//                    sourceGeneratorCode.Append(
//$@"
//ch -= {_boyerMoorePrefix.LowASCII};
//if (ch > ({_boyerMoorePrefix.HighASCII - _boyerMoorePrefix.LowASCII}))
//{{
//");
//                    if (_code.RightToLeft)
//                    {
...
//                    // goto advance;
//                    int negativeRangeSG = _boyerMoorePrefix.HighASCII - _boyerMoorePrefix.LowASCII + 1;
//                    if (negativeRangeSG > 1)
//                    {
//                        // Create a string to store the lookup table we use to find the offset.
//                        Debug.Assert(_boyerMoorePrefix.Pattern.Length <= char.MaxValue, "RegexBoyerMoore should have limited the size allowed.");
//                        string negativeLookup = string.Create(negativeRangeSG, (thisRef: this, beforefirst), (span, state) =>
//                        {
//                            // Store the offsets into the string.  RightToLeft has negative offsets, so to support it with chars (unsigned), we negate
//                            // the values to be stored in the string, and then at run time after looking up the offset in the string, negate it again.
//                            for (int i = 0; i < span.Length; i++)
...
//                        // TODO: This is a bug. offset isn't declared yet
//                        sourceGeneratorCode.Append(
//$@"
//offset = {negativeLookup}[ch];
//");
//                        if (_code.RightToLeft)
//                        {
//                            sourceGeneratorCode.Append(@"offset = -offset;");
//                        }
//                    }
//                    else
//                    {
...
//                if (sourceGeneratorCode != null)
//                {
//                    // Close the (ch!=match) if condition
//                    sourceGeneratorCode.Append(
//$@"}}
//else
//{{
...
//                        if (_boyerMoorePrefix.CaseInsensitive && ParticipatesInCaseConversion(_boyerMoorePrefix.Pattern[charindex]))
//                        {
//                            CallToLower(sourceGeneratorCode, "temp");
//                        }
//                        if (prevLabelOffset == _boyerMoorePrefix.Positive[charindex])
//                        {
//                            sourceGeneratorCode.Append(
//$@"
//    if (temp != {_boyerMoorePrefix.Pattern[charindex]})
//    {{
//        runtextpos = runtextpos + 1;
//    }}
//");
//                        }
//                    }
