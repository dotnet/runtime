...
namespace System.Text.RegularExpressions
{
    ...
    public abstract partial class RegexRunner
    {
        ...
        protected bool IsBoundary(System.ReadOnlySpan<char> inputSpan, int index) { throw null; } // -> This is just temporary on the prototype. Method will be emitted by the generator engines
        protected bool IsECMABoundary(int index, int startpos, int endpos) { throw null; }
        protected bool IsECMABoundary(System.ReadOnlySpan<char> inputSpan, int index) { throw null; } // -> This is just temporary on the prototype. Method will be emitted by the generator engines
