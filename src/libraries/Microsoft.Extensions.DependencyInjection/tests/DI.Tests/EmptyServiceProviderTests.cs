...
public class EmptyServiceProviderTests
{
    ...
    {
        IServiceProvider real = CreateRealProvider();
        var realIsService = (IServiceProviderIsService)real.GetRequiredService(typeof(IServiceProviderIsService));
    ...
    {
        IKeyedServiceProvider real = CreateRealProvider();
        var realIsKeyedService = (IServiceProviderIsKeyedService)real.GetRequiredService(typeof(IServiceProviderIsKeyedService));
