...
namespace System.Net.Quic.Implementations.MsQuic.Internal
{
    internal static class MsQuicParameterHelpers
    {
        internal static unsafe IPEndPoint GetIPEndPointParam(MsQuicApi api, MsQuicSafeHandle nativeObject, uint param)
        {
            ...
            {
                ThrowIfFailure(api.ApiTable->GetParam(nativeObject.QuicHandle, param, &valueLen, paddress), "GetIPEndPointParam failed.");
            }
        ...
        internal static unsafe void SetIPEndPointParam(MsQuicApi api, MsQuicSafeHandle nativeObject, uint param, IPEndPoint value)
        {
            ...
            fixed (byte* paddress = &MemoryMarshal.GetReference(address))
            {
                ThrowIfFailure(api.ApiTable->SetParam(nativeObject.QuicHandle, param, (uint)address.Length, paddress), "Could not set IPEndPoint");
            }
        }
        ...
        internal static unsafe ushort GetUShortParam(MsQuicApi api, MsQuicSafeHandle nativeObject, uint param)
        {
            ...
            ThrowIfFailure(api.ApiTable->GetParam(nativeObject.QuicHandle, param, &valueLen, (byte*)&value), "GetUShortParam failed");
        ...
        {
            ThrowIfFailure(api.ApiTable->SetParam(nativeObject.QuicHandle, param, sizeof(ushort), (byte*)&value), "Could not set ushort");
        }
        ...
        internal static unsafe ulong GetULongParam(MsQuicApi api, MsQuicSafeHandle nativeObject, uint param)
        {
            ...
            ThrowIfFailure(api.ApiTable->GetParam(nativeObject.QuicHandle, param, &valueLen, (byte*)&value), "GetULongParam failed");
        ...
        {
            ThrowIfFailure(api.ApiTable->SetParam(nativeObject.QuicHandle, param, sizeof(ulong), (byte*)&value), "Could not set ulong");
        }
    }
}
