    ...
    internal sealed class MsQuicStream : QuicStreamProvider
    {
        ...
        internal override int Read(Span<byte> buffer)
        {
            ...
            try
            {
                ...
                Task<int> t = ReadAsync(new Memory<byte>(rentedBuffer, 0, buffer.Length), cts != null ? cts.Token : default).AsTask();
        ...
        internal override void Write(ReadOnlySpan<byte> buffer)
        {
            ...
            try
            {
                Task t = WriteAsync(buffer.ToArray(), cts != null ? cts.Token : default).AsTask();
                ((IAsyncResult)t).AsyncWaitHandle.WaitOne();
