...
namespace System.Net.Quic.Tests
{
    ...
    public sealed class QuicListenerTests : QuicTestBase
    {
        ...
        [InlineData(15, 100)]
        [InlineData(10, 1_000)]
        [ActiveIssue("https://github.com/dotnet/runtime/issues/82769", typeof(PlatformDetection), nameof(PlatformDetection.IsArmOrArm64Process), nameof(PlatformDetection.IsInContainer))]
