...
namespace System.Data
{
    ...
    internal sealed class XmlTreeGen
    {
        ...
        {
            return props is not null && props.Count != 0;
        }
        ...
        internal void WriteSchemaRoot(XmlDocument xd, XmlElement rootSchema, string targetNamespace)
        {
            ...
            */
            ...
            if ((_ds is not null) && (HaveExtendedProperties(_ds)))
            {
        ...
        internal void SetupAutoGenerated(DataTable dt)
        {
            ...
            foreach (Constraint cs in dt.Constraints)
            {
                ...
                if (null != fk)
                {
                    ...
                    {
                        if (_autogenerated[fk.Columns[0]] is not null)
                            _autogenerated[fk.Columns[0]] = null;
                        if (_autogenerated[fk.RelatedColumnsReference[0]] is not null)
                        ...
                        if (_autogenerated[_constraint] is not null)
                            _autogenerated[_constraint] = null;
                        if (_autogenerated[_constraint.Key.ColumnsReference[0]] is not null)
                ...
                else
                {
                    ...
                    {
                        if (_autogenerated[unique.Key.ColumnsReference[0]] is not null)
        ...
        internal void SchemaTree(XmlDocument xd, XmlWriter xmlWriter, DataSet? ds, DataTable? dt, bool writeHierarchy)
        {
            ...
            bool genSecondary = _filePath is not null; //null non-file based streams.
            ...
            top = ((ds is not null) ? ds.TopLevelTables(true) : CreateToplevelTables());
            ...
            for (int i = 0; i < top.Length; i++)
            {
                ...
                if (((_ds is not null) && (_ds.Namespace == top[i].Namespace)) || string.IsNullOrEmpty(top[i].Namespace) || (_schFormat == SchemaFormat.Remoting))
                {
                    bool fNestedInDataset = top[i]._fNestedInDataset;

                    if (((_ds is not null) && (_ds.Namespace.Length != 0)) && string.IsNullOrEmpty(top[i].Namespace))
                    {
            ...
            if (ds is not null && _tables.Count > 0)
            ...
            for (int i = 0; i < rels.Length; ++i)
            {
                ...
                if (!rel.Nested || fFlat)
                {
                    if (rel.ChildKeyConstraint is null)
                    {
                        if (nodeAnn is null)
                        {
                        ...
                        Debug.Assert(nodeApp is not null, "Need to create <application..> node first.");
            ...
            if (_schFormat != SchemaFormat.Remoting && _schFormat != SchemaFormat.RemotingSkipSchema)
            {
                ...
                {
                    if (ns == ((_ds is not null) ? _ds.Namespace : _dt.Namespace) || string.IsNullOrEmpty(ns))
                    {
                        continue;
                    }
                ...
                foreach (string ns in _namespaces.Keys)
                {
                    ...
                    try
                    {
                        ...
                        foreach (string imp_ns in _namespaces.Keys)
                        {
                            ...
                            if (_schFormat != SchemaFormat.WebService && !isMultipleNamespaceAndStreamingWriter)
                            {
                                if (imp_ns == ((_ds is not null) ? _ds.Namespace : _dt.Namespace))
        ...
        {
            Debug.Assert(ds is null || dt is null);
            Debug.Assert(_dsElement is not null);

            DataSet? dataSet = (ds is not null) ? ds : dt!.DataSet;
        ...
        internal void SetPath(XmlWriter xw)
        {
            ...
            fs = (sw is not null) ? sw.BaseStream as FileStream : null;
        ...
        internal XmlElement HandleRelation(DataRelation rel, XmlDocument dc)
        {
            ...
            if ((_ds is null) || (_ds.Tables.InternalIndexOf(rel.ParentKey.Table.TableName) == -3))
                root.SetAttribute(Keywords.MSD_PARENTTABLENS, Keywords.MSDNS, rel.ParentKey.Table.Namespace);

            if ((_ds is null) || (_ds.Tables.InternalIndexOf(rel.ChildKey.Table.TableName) == -3))
        ...
        {
            for (XmlNode? n = schema.FirstChild; n is not null; n = n.NextSibling)
            {
                if (n is XmlElement)
                {
        ...
        internal void HandleColumnType(DataColumn col, XmlDocument dc, XmlElement root, XmlElement schema)
        {
                ...
                while (stNode is not null)
                {
                    ...
                    if (name is not null && name.Length != 0)
                    {
                        ...
                        string nSpace = (_schFormat != SchemaFormat.Remoting) ? stNode.Namespace :
                                                   (col.Table!.DataSet is not null ? col.Table.DataSet.Namespace : col.Table.Namespace);
                        ...
                        if (stNode.BaseSimpleType is not null && stNode.BaseSimpleType.Namespace is not null && stNode.BaseSimpleType.Namespace.Length > 0)
            ...
            else if (col.XmlDataType is not null && col.XmlDataType.Length != 0 && XSDSchema.IsXsdType(col.XmlDataType))
            {
        ...
        internal XmlElement HandleColumn(DataColumn col, XmlDocument dc, XmlElement schema, bool fWriteOrdinal)
        {
            ...
            else
            {
                if ((col.Namespace != (col.Table!.TypeName.IsEmpty ? col.Table.Namespace : col.Table.TypeName.Namespace)) && (col.Namespace.Length != 0))
                {
                    ...
                    if (FindTypeNode(schNode, col.EncodedColumnName) is null)
        ...
        internal void AppendChildWithoutRef(XmlElement node, string Namespace, XmlElement el, string refString)
        {
            ...
            if (FindTypeNode(schNode, el.GetAttribute(Keywords.NAME)) is null)
        ...
        internal XmlElement? FindTypeNode(XmlElement node, string strType)
        {
            ...
            for (XmlNode? n = node.FirstChild; n is not null; n = n.NextSibling)
            {
                if (!(n is XmlElement))
                    continue;
        ...
        {
            if (_schFormat != SchemaFormat.Remoting)
                return _autogenerated[o] is not null;
            return false;
        }
        ...
        internal XmlElement HandleTable(DataTable table, XmlDocument dc, XmlElement schema, bool genNested)
        {
            ...
            if (((table.DataSet is null) || (_ds is not null && table.Namespace != _ds.Namespace)) && (_schFormat == SchemaFormat.Remoting))
            ...
            if (table.Namespace.Length == 0)
            {
                ...
                while (string.IsNullOrEmpty(tgNamespace))
                {
                    ...
                    if (nestedParentRelations.Length == 0)
                    {
                        tgNamespace = (_ds is not null) ? _ds.Namespace : "";
                        break;
                    }
            ...
            if ((table._repeatableElement) && (realCount == 1))
            {
                ...
                if (_typeName is null || _typeName.Length == 0)
                {
            ...
            if (!table.TypeName.IsEmpty && _schFormat != SchemaFormat.Remoting)
            {
                ...
                if (FindTypeNode(typeSchema, table.TypeName.Name) is null)
            ...
            if ((table.XmlText is null) && (genNested))
            {
                DataRelationCollection childRelations = table.ChildRelations;
                ...
                for (int j = 0; j < childRelations.Count; j++)
                {
                    ...
                    if (childRelations[j].ChildKeyConstraint is not null)
            ...
            string xpathprefix = (_ds is not null) ? (_ds.Namespace.Length != 0 ? Keywords.MSTNS_PREFIX : string.Empty) : string.Empty;
            if (_schFormat != SchemaFormat.Remoting)
            {
            ...
            for (int i = 0; i < constraints.Count; i++)
            {
                ...
                if (constraints[i] is UniqueConstraint)
                {
                    ...
                    if ((_ds is null) || (_ds.Tables.InternalIndexOf(table.TableName) == -3))
                ...
                else if (constraints[i] is ForeignKeyConstraint && genNested)
                {
                    ...
                    if ((_ds is null) || (_ds.Tables.InternalIndexOf(foreign.RelatedTable.TableName) == -3)) // if there is a conflicting name/namespace only
    ...
    internal sealed class XmlDataTreeWriter
    {
        ...
        {
            Debug.Assert(_ds is not null || _dt is not null);

            _xmlw = DataTextWriter.CreateWriter(xw);
            _isDiffgram = true;
            _rowsOrder = rowsOrder;

            string prefix = (_ds is not null) ? ((_ds.Namespace.Length == 0) ? "" : _ds.Prefix) : ((_dt!.Namespace.Length == 0) ? "" : _dt.Prefix);

            if (_ds is null || _ds.DataSetName is null || _ds.DataSetName.Length == 0)
                _xmlw.WriteStartElement(prefix, Keywords.DOCUMENTELEMENT, (_dt!.Namespace is null) ? "" : _dt.Namespace);
            else
        ...
        internal void Save(XmlWriter xw, bool writeSchema)
        {
            ...
            if (!writeSchema && _ds is not null && _ds._fTopLevelTable && countTopTable == 1)
            {
            ...
            if (fWriteDSElement)
            {
                ...
                {
                    if (_ds.DataSetName is null || _ds.DataSetName.Length == 0)
                ...
                for (int i = 0; i < _dTables.Count; i++)
                {
                    if (((DataTable)_dTables[i]!)._xmlText is not null)
                    {
        ...
        {
            Debug.Assert(_xmlw is not null);
