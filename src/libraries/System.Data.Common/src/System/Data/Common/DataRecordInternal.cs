...
namespace System.Data.Common
{
    internal sealed class DataRecordInternal : DbDataRecord, ICustomTypeDescriptor
    {
        ...
        {
            Debug.Assert(schemaInfo is not null, "invalid attempt to instantiate DataRecordInternal with null schema information");
            Debug.Assert(values is not null, "invalid attempt to instantiate DataRecordInternal with null value[]");
        ...
        {
            object o = _values[i];
            return (o is null || Convert.IsDBNull(o));
        }
