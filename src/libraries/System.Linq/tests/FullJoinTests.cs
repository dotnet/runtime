...
namespace System.Linq.Tests
{
    public class FullJoinTests : EnumerableTests
    {
        ...
        public void NullComparer()
        {
            ...
            Assert.Equal(expected, outer.FullJoin(inner, e => e.name, e => e.name, createJoinRec, null));
        }
        ...
        public void CustomComparer()
        {
            ...
            Assert.Equal(expected, outer.FullJoin(inner, e => e.name, e => e.name, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outer", () => outer.FullJoin(inner, e => e.name, e => e.name, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void InnerNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("inner", () => outer.FullJoin(inner, e => e.name, e => e.name, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void OuterKeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outerKeySelector", () => outer.FullJoin(inner, null, e => e.name, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void InnerKeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("innerKeySelector", () => outer.FullJoin(inner, e => e.name, null, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void ResultSelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () => outer.FullJoin(inner, e => e.name, e => e.name, (Func<CustomerRec, AnagramRec, JoinRec>)null, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outer", () => outer.FullJoin(inner, e => e.name, e => e.name, createJoinRec));
        }
        ...
        public void InnerNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("inner", () => outer.FullJoin(inner, e => e.name, e => e.name, createJoinRec));
        }
        ...
        public void OuterKeySelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outerKeySelector", () => outer.FullJoin(inner, null, e => e.name, createJoinRec));
        }
        ...
        public void InnerKeySelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("innerKeySelector", () => outer.FullJoin(inner, e => e.name, null, createJoinRec));
        }
        ...
        public void ResultSelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () => outer.FullJoin(inner, e => e.name, e => e.name, (Func<CustomerRec, AnagramRec, JoinRec>)null));
        }

        [Fact]
        public void TupleOverloadMatchesResultSelector()
        {
            int[] outer = [1, 2, 3];
            int[] inner = [2, 3, 4];

            var result = outer.FullJoin(inner, o => o, i => i).ToArray();

            Assert.Equal(4, result.Length);
            Assert.Equal((1, 0), result[0]);
            Assert.Equal((2, 2), result[1]);
            Assert.Equal((3, 3), result[2]);
            Assert.Equal((0, 4), result[3]);
        }
        ...
        public void TupleOverloadWithComparer()
        {
            ...
            var result = outer.FullJoin(inner, o => o, i => i, StringComparer.OrdinalIgnoreCase).ToArray();

            Assert.Equal(3, result.Length);
            Assert.Equal(("a", "A"), result[0]);
            Assert.Equal(("B", null), result[1]);
            Assert.Equal((null, "c"), result[2]);
        }

        [Fact]
        public void ForcedToEnumeratorDoesntEnumerate()
        {
            var iterator = NumberRangeGuaranteedNotCollectionType(0, 3).FullJoin(Enumerable.Empty<int>(), i => i, i => i, (o, i) => i);
