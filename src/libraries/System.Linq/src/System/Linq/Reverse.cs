...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// Unlike <see cref="O:System.Linq.Enumerable.OrderBy" />, this sorting method does not consider the actual values themselves in determining the order. Rather, it just returns the elements in the reverse order from which they are produced by the underlying source.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="O:System.Linq.Enumerable.Reverse" /> to reverse the order of elements in an array.
