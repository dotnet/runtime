...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <para>Unlike <see cref="O:Enumerable.OrderBy" />, this sorting method does not consider the actual values themselves in determining the order. Rather, it just returns the elements in the reverse order from which they are produced by the underlying source.</para>
        /// </remarks>
