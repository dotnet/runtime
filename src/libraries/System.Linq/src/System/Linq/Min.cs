...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{int})" /> method uses the <see cref="int" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{System.Nullable{int}})" /> method uses the <see cref="int" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        ...
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <example>The following code example demonstrates how to use <see cref="Min(IEnumerable{System.Nullable{int}})" /> to determine the minimum value in a sequence.
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{long})" /> method uses the <see cref="long" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{System.Nullable{long}})" /> method uses the <see cref="long" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>If the source sequence is empty or contains only values that are <see langword="null" />, this function returns <see langword="null" />.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{float})" /> method uses the <see cref="float" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{System.Nullable{float}})" /> method uses the <see cref="float" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>If the source sequence is empty or contains only values that are <see langword="null" />, this function returns <see langword="null" />.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{double})" /> method uses the <see cref="double" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <example>The following code example demonstrates how to use <see cref="Min(IEnumerable{double})" /> to determine the minimum value in a sequence.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{System.Nullable{double}})" /> method uses the <see cref="double" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>If the source sequence is empty or contains only values that are <see langword="null" />, this function returns <see langword="null" />.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{decimal})" /> method uses the <see cref="decimal" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>
        /// <para>The <see cref="Min(IEnumerable{System.Nullable{decimal}})" /> method uses the <see cref="decimal" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        /// <para>If the source sequence is empty or contains only values that are <see langword="null" />, this function returns <see langword="null" />.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/aggregate-clause">Aggregate Clause (Visual Basic)</related>
        ...
        /// <remarks>
        /// <para>If type <typeparamref name="TSource" /> implements <see cref="System.IComparable{T}" />, this method uses that implementation to compare values. Otherwise, if type <typeparamref name="TSource" /> implements <see cref="System.IComparable" />, that implementation is used to compare values.</para>
        /// <para>If <typeparamref name="TSource" /> is a reference type and the source sequence is empty or contains only values that are <see langword="null" />, this function returns <see langword="null" />.</para>
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <example>The following code example demonstrates how to use <see cref="Min{T}(IEnumerable{T})" /> to determine the minimum value in a sequence of <see cref="System.IComparable{T}" /> objects.
        ...
        /// <exception cref="System.InvalidOperationException"><paramref name="source" /> contains no elements.</exception>
        /// <remarks>
        /// <para>The <see cref="Min{T}(IEnumerable{T},Func{T,int})" /> method uses the <see cref="int" /> implementation of <see cref="System.IComparable{T}" /> to compare values.</para>
        ...
        /// <para>In Visual Basic query expression syntax, an `Aggregate Into Min()` clause translates to an invocation of <see cref="O:Enumerable.Min" />.</para>
        /// </remarks>
        /// <example>The following code example demonstrates how to use <see cref="Min{T}(IEnumerable{T},Func{T,int})" /> to determine the minimum value in a sequence of projected values.
