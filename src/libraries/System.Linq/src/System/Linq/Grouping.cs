...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <param name="source">An <see cref="System.Collections.Generic.IEnumerable{T}" /> whose elements to group.</param>
        /// <param name="keySelector">A function to extract the key for each element.</param>
        /// <returns>An <c>IEnumerable&lt;IGrouping&lt;TKey, TSource&gt;&gt;</c> in C# or <c>IEnumerable(Of IGrouping(Of TKey, TSource))</c> in Visual Basic where each <see cref="System.Linq.IGrouping{T1,T2}" /> object contains a sequence of objects and a key.</returns>
        ...
        /// ]]></format>
        /// The <see cref="System.Linq.Enumerable.GroupBy{T1,T2}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2})" /> method returns a collection of <see cref="System.Linq.IGrouping{T1,T2}" /> objects, one for each distinct key that was encountered. An <see cref="System.Linq.IGrouping{T1,T2}" /> is an <see cref="System.Collections.Generic.IEnumerable{T}" /> that also has a key associated with its elements.
        /// The <see cref="System.Linq.IGrouping{T1,T2}" /> objects are yielded in an order based on the order of the elements in <paramref name="source" /> that produced the first key of each <see cref="System.Linq.IGrouping{T1,T2}" />. Elements in a grouping are yielded in the order they appear in <paramref name="source" />.
        /// The default equality comparer <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" /> is used to compare keys.
        /// In query expression syntax, a `group by` (Visual C#) or `Group By Into` (Visual Basic) clause translates to an invocation of <see cref="O:System.Linq.Enumerable.GroupBy" />. For more information and usage examples, see [group clause](/dotnet/csharp/language-reference/keywords/group-clause) and [Group By Clause](/dotnet/visual-basic/language-reference/queries/group-by-clause).</remarks>
        ...
        /// <returns>An <c>IEnumerable&lt;IGrouping&lt;TKey, TSource&gt;&gt;</c> in C# or <c>IEnumerable(Of IGrouping(Of TKey, TSource))</c> in Visual Basic where each <see cref="System.Linq.IGrouping{T1,T2}" /> object contains a collection of objects and a key.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="keySelector" /> is <see langword="null" />.</exception>
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// <format type="text/markdown"><![CDATA[
        /// > [!NOTE]
        ...
        /// > - <xref:System.Linq.Enumerable.GroupBy%60%604%28System.Collections.Generic.IEnumerable%7B%60%600%7D%2CSystem.Func%7B%60%600%2C%60%601%7D%2CSystem.Func%7B%60%600%2C%60%602%7D%2CSystem.Func%7B%60%601%2CSystem.Collections.Generic.IEnumerable%7B%60%602%7D%2C%60%603%7D%29>
        /// ]]></format>
        /// The <see cref="System.Linq.Enumerable.GroupBy{T1,T2}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Collections.Generic.IEqualityComparer{T2})" /> method returns a collection of <see cref="System.Linq.IGrouping{T1,T2}" /> objects, one for each distinct key that was encountered. An <see cref="System.Linq.IGrouping{T1,T2}" /> is an <see cref="System.Collections.Generic.IEnumerable{T}" /> that also has a key associated with its elements.
        /// The <see cref="System.Linq.IGrouping{T1,T2}" /> objects are yielded in an order based on the order of the elements in <paramref name="source" /> that produced the first key of each <see cref="System.Linq.IGrouping{T1,T2}" />. Elements in a grouping are yielded in the order they appear in <paramref name="source" />.
        /// If <paramref name="comparer" /> is <see langword="null" />, the default equality comparer <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" /> is used to compare keys.
        ...
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <typeparam name="TElement">The type of the elements in the <see cref="System.Linq.IGrouping{T1,T2}" />.</typeparam>
        /// <param name="source">An <see cref="System.Collections.Generic.IEnumerable{T}" /> whose elements to group.</param>
        /// <param name="keySelector">A function to extract the key for each element.</param>
        /// <param name="elementSelector">A function to map each source element to an element in the <see cref="System.Linq.IGrouping{T1,T2}" />.</param>
        /// <returns>An <c>IEnumerable&lt;IGrouping&lt;TKey, TElement&gt;&gt;</c> in C# or <c>IEnumerable(Of IGrouping(Of TKey, TElement))</c> in Visual Basic where each <see cref="System.Linq.IGrouping{T1,T2}" /> object contains a collection of objects of type <typeparamref name="TElement" /> and a key.</returns>
        ...
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// The <see cref="System.Linq.Enumerable.GroupBy{T1,T2,T3}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Func{T1,T3})" /> method returns a collection of <see cref="System.Linq.IGrouping{T1,T2}" /> objects, one for each distinct key that was encountered. An <see cref="System.Linq.IGrouping{T1,T2}" /> is an <see cref="System.Collections.Generic.IEnumerable{T}" /> that also has a key associated with its elements.
        /// The <see cref="System.Linq.IGrouping{T1,T2}" /> objects are yielded in an order based on the order of the elements in <paramref name="source" /> that produced the first key of each <see cref="System.Linq.IGrouping{T1,T2}" />. Elements in a grouping are yielded in the order that the elements that produced them appear in <paramref name="source" />.
        ...
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.GroupBy{T1,T2,T3}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Func{T1,T3})" /> to group the elements of a sequence.
        ...
        /// In query expression syntax, a `group by` (Visual C#) or `Group By Into` (Visual Basic) clause translates to an invocation of <see cref="O:System.Linq.Enumerable.GroupBy" />. The translation of the query expression in the following example is equivalent to the query in the example above.
        ...
        /// > [!NOTE]
        /// >  In a Visual C# or Visual Basic query expression, the element and key selection expressions occur in the reverse order from their argument positions in a call to the <see cref="System.Linq.Enumerable.GroupBy{T1,T2,T3}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Func{T1,T3})" /> method.</example>
        /// <related type="Article" href="/dotnet/csharp/language-reference/keywords/group-clause">group clause (C# Reference)</related>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/group-by-clause">Group By Clause (Visual Basic)</related>
        ...
        /// > - <xref:System.Linq.Enumerable.GroupBy%60%604%28System.Collections.Generic.IEnumerable%7B%60%600%7D%2CSystem.Func%7B%60%600%2C%60%601%7D%2CSystem.Func%7B%60%600%2C%60%602%7D%2CSystem.Func%7B%60%601%2CSystem.Collections.Generic.IEnumerable%7B%60%602%7D%2C%60%603%7D%29>
        /// ]]></format>
        /// The <see cref="System.Linq.Enumerable.GroupBy{T1,T2,T3}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Func{T1,T3},System.Collections.Generic.IEqualityComparer{T2})" /> method returns a collection of <see cref="System.Linq.IGrouping{T1,T2}" /> objects, one for each distinct key that was encountered. An <see cref="System.Linq.IGrouping{T1,T2}" /> is an <see cref="System.Collections.Generic.IEnumerable{T}" /> that also has a key associated with its elements.
        /// The <see cref="System.Linq.IGrouping{T1,T2}" /> objects are yielded in an order based on the order of the elements in <paramref name="source" /> that produced the first key of each <see cref="System.Linq.IGrouping{T1,T2}" />. Elements in a grouping are yielded in the order that the elements that produced them appear in <paramref name="source" />.
        /// If <paramref name="comparer" /> is <see langword="null" />, the default equality comparer <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" /> is used to compare keys.
        /// If two keys are considered equal according to <paramref name="comparer" />, the first key is chosen as the key for that grouping.
        /// In query expression syntax, a `group by` (Visual C#) or `Group By Into` (Visual Basic) clause translates to an invocation of <see cref="O:System.Linq.Enumerable.GroupBy" />. For more information and usage examples, see [group clause](/dotnet/csharp/language-reference/keywords/group-clause) and [Group By Clause](/dotnet/visual-basic/language-reference/queries/group-by-clause).</remarks>
        ...
        /// <remarks>In query expression syntax, a `group by` (Visual C#) or `Group By Into` (Visual Basic) clause translates to an invocation of <see cref="O:System.Linq.Enumerable.GroupBy" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.GroupBy{T1,T2,T3}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Func{T2,System.Collections.Generic.IEnumerable{T1},T3})" /> to group the elements of a sequence and project a sequence of results of type <typeparamref name="TResult" />.
        ...
        /// <returns>A collection of elements of type <typeparamref name="TResult" /> where each element represents a projection over a group and its key.</returns>
        /// <remarks>In query expression syntax, a `group by` (Visual C#) or `Group By Into` (Visual Basic) clause translates to an invocation of <see cref="O:System.Linq.Enumerable.GroupBy" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.GroupBy{T1,T2,T3,T4}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2},System.Func{T1,T3},System.Func{T2,System.Collections.Generic.IEnumerable{T3},T4})" /> to group the projected elements of a sequence and then project a sequence of results of type <typeparamref name="TResult" />.
        ...
        /// <param name="keySelector">A function to extract the key for each element.</param>
        /// <param name="resultSelector">A function to create a result value from each group.</param>
        /// <param name="comparer">An <see cref="System.Collections.Generic.IEqualityComparer{T}" /> to compare keys with.</param>
        /// <returns>A collection of elements of type <typeparamref name="TResult" /> where each element represents a projection over a group and its key.</returns>
        /// <related type="Article" href="/dotnet/csharp/language-reference/keywords/group-clause">group clause (C# Reference)</related>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/group-by-clause">Group By Clause (Visual Basic)</related>
    ...
    /// <typeparam name="TKey">The type of the key of the <see cref="System.Linq.IGrouping{T1,T2}" />.</typeparam>
    /// <typeparam name="TElement">The type of the values in the <see cref="System.Linq.IGrouping{T1,T2}" />.</typeparam>
    /// <remarks>An <see cref="System.Linq.IGrouping{T1,T2}" /> is an <see cref="System.Collections.Generic.IEnumerable{T}" /> that additionally has a key. The key represents the attribute that is common to each value in the <see cref="System.Linq.IGrouping{T1,T2}" />.
    /// The values of an <see cref="System.Linq.IGrouping{T1,T2}" /> are accessed much as the elements of an <see cref="System.Collections.Generic.IEnumerable{T}" /> are accessed. For example, you can access the values by using a `foreach` in Visual C# or `For Each` in Visual Basic loop to iterate through the <see cref="System.Linq.IGrouping{T1,T2}" /> object. The Example section contains a code example that shows you how to access both the key and the values of an <see cref="System.Linq.IGrouping{T1,T2}" /> object.
    /// The <see cref="System.Linq.IGrouping{T1,T2}" /> type is used by the <see cref="O:System.Linq.Enumerable.GroupBy" /> standard query operator methods, which return a sequence of elements of type <see cref="System.Linq.IGrouping{T1,T2}" />.</remarks>
    /// <example>The following example demonstrates how to work with an <see cref="System.Linq.IGrouping{T1,T2}" /> object.
    /// In this example, <see cref="System.Linq.Enumerable.GroupBy{T1,T2}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2})" /> is called on the array of <see cref="System.Reflection.MemberInfo" /> objects returned by <see cref="O:System.Type.GetMembers" />. <see cref="System.Linq.Enumerable.GroupBy{T1,T2}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2})" /> groups the objects based on the value of their <see cref="O:System.Reflection.MemberInfo.MemberType" /> property. Each unique value for <see cref="O:System.Reflection.MemberInfo.MemberType" /> in the array of <see cref="System.Reflection.MemberInfo" /> objects becomes a key for a new <see cref="System.Linq.IGrouping{T1,T2}" /> object, and the <see cref="System.Reflection.MemberInfo" /> objects that have that key form the <see cref="System.Linq.IGrouping{T1,T2}" /> object's sequence of values.
    /// Finally, the <see cref="O:System.Linq.Enumerable.First" /> method is called on the sequence of <see cref="System.Linq.IGrouping{T1,T2}" /> objects to obtain just the first <see cref="System.Linq.IGrouping{T1,T2}" /> object.
    /// The example then outputs the key of the <see cref="System.Linq.IGrouping{T1,T2}" /> object and the <see cref="O:System.Reflection.MemberInfo.Name" /> property of each value in the <see cref="System.Linq.IGrouping{T1,T2}" /> object's sequence of values. Notice that to access an <see cref="System.Linq.IGrouping{T1,T2}" /> object's sequence of values, you simply use the <see cref="System.Linq.IGrouping{T1,T2}" /> variable itself.
    ...
    {
        /// <summary>Gets the key of the <see cref="System.Linq.IGrouping{T1,T2}" />.</summary>
        /// <value>The key of the <see cref="System.Linq.IGrouping{T1,T2}" />.</value>
        /// <remarks>The key of an <see cref="System.Linq.IGrouping{T1,T2}" /> represents the attribute that is common to each value in the <see cref="System.Linq.IGrouping{T1,T2}" />.</remarks>
        /// <example>The following example demonstrates how to use the <see cref="O:System.Linq.IGrouping{T1,T2}.Key" /> property to label each <see cref="System.Linq.IGrouping{T1,T2}" /> object in a sequence of <see cref="System.Linq.IGrouping{T1,T2}" /> objects. The <see cref="System.Linq.Enumerable.GroupBy{T1,T2}(System.Collections.Generic.IEnumerable{T1},System.Func{T1,T2})" /> method is used to obtain a sequence of <see cref="System.Linq.IGrouping{T1,T2}" /> objects. The `foreach` in Visual C# or `For Each` in Visual Basic loop then iterates through each <see cref="System.Linq.IGrouping{T1,T2}" /> object, outputting its key and the number of values it contains.
