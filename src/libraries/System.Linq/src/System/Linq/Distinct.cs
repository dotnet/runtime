...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// The <see cref="System.Linq.Enumerable.Distinct{T}(System.Collections.Generic.IEnumerable{T})" /> method returns an unordered sequence that contains no duplicate values. It uses the default equality comparer, <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" />, to compare values.
        /// In Visual Basic query expression syntax, a `Distinct` clause translates to an invocation of <see cref="O:System.Linq.Enumerable.Distinct" />.
        ...
        /// For an example that uses <see cref="System.Collections.Generic.IEqualityComparer{T}" /> to define a custom comparer, see <see cref="System.Linq.Enumerable.Distinct{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.Distinct{T}(System.Collections.Generic.IEnumerable{T})" /> to return distinct elements from a sequence of integers.
        ...
        /// After you implement this interface, you can use a sequence of `Product` objects in the <see cref="System.Linq.Enumerable.Distinct{T}(System.Collections.Generic.IEnumerable{T})" /> method, as shown in the following example:
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// The <see cref="System.Linq.Enumerable.Distinct{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method returns an unordered sequence that contains no duplicate values. If <paramref name="comparer" /> is <see langword="null" />, the default equality comparer, <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" />, is used to compare values.</remarks>
        /// <example>The following example shows how to implement an equality comparer that can be used in the <see cref="O:System.Linq.Enumerable.Distinct" /> method.
        ...
        /// After you implement this comparer, you can use a sequence of `Product` objects in the <see cref="O:System.Linq.Enumerable.Distinct" /> method, as shown in the following example:
