...
namespace System.Linq
{
    ...
    {
        /// <summary>Returns the input typed as <see cref="System.Collections.Generic.IEnumerable{T}" />.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">The sequence to type as <see cref="System.Collections.Generic.IEnumerable{T}" />.</param>
        /// <returns>The input sequence typed as <see cref="System.Collections.Generic.IEnumerable{T}" />.</returns>
        /// <remarks>The <see cref="System.Linq.Enumerable.AsEnumerable{T}(System.Collections.Generic.IEnumerable{T})" /> method has no effect other than to change the compile-time type of <paramref name="source" /> from a type that implements <see cref="System.Collections.Generic.IEnumerable{T}" /> to <see cref="System.Collections.Generic.IEnumerable{T}" /> itself.
        /// <see cref="System.Linq.Enumerable.AsEnumerable{T}(System.Collections.Generic.IEnumerable{T})" /> can be used to choose between query implementations when a sequence implements <see cref="System.Collections.Generic.IEnumerable{T}" /> but also has a different set of public query methods available. For example, given a generic class `Table` that implements <see cref="System.Collections.Generic.IEnumerable{T}" /> and has its own methods such as `Where`, `Select`, and `SelectMany`, a call to `Where` would invoke the public `Where` method of `Table`. A `Table` type that represents a database table could have a `Where` method that takes the predicate argument as an expression tree and converts the tree to SQL for remote execution. If remote execution is not desired, for example because the predicate invokes a local method, the <see cref="O:System.Linq.Enumerable.AsEnumerable" /> method can be used to hide the custom methods and instead make the standard query operators available.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.AsEnumerable{T}(System.Collections.Generic.IEnumerable{T})" /> to hide a type's custom `Where` method when the standard query operator implementation is desired.
