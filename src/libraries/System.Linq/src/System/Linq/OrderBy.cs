...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// Two methods are defined to extend the type <see cref="IOrderedEnumerable{T}" />, which is the return type of this method. These two methods, namely `ThenBy` and `ThenByDescending`, enable you to specify additional sort criteria to sort a sequence. `ThenBy` and `ThenByDescending` also return an <see cref="IOrderedEnumerable{T}" />, which means any number of consecutive calls to `ThenBy` or `ThenByDescending` can be made.
        ...
        /// ]]></format>
        /// This method compares keys by using the default comparer <see cref="O:Comparer{T}.Default" />.
        /// This method performs a stable sort; that is, if the keys of two elements are equal, the order of the elements is preserved. In contrast, an unstable sort does not preserve the order of elements that have the same key.
        /// In query expression syntax, an `orderby` (Visual C#) or `Order By` (Visual Basic) clause translates to an invocation of <see cref="O:Enumerable.OrderBy" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="OrderBy{T1,T2}(IEnumerable{T1},Func{T1,T2})" /> to sort the elements of a sequence.
        ...
        /// <altmember cref="OrderByDescending{T1,T2}(IEnumerable{T1},Func{T1,T2})"/>
        /// <altmember cref="OrderByDescending{T1,T2}(IEnumerable{T1},Func{T1,T2},IComparer{T2})"/>
        ...
        /// >  Because <xref:System.Linq.IOrderedEnumerable%601> inherits from <xref:System.Collections.Generic.IEnumerable%601>, you can call <xref:System.Linq.Enumerable.OrderBy%2A> or <xref:System.Linq.Enumerable.OrderByDescending%2A> on the results of a call to <xref:System.Linq.Enumerable.OrderBy%2A>, <xref:System.Linq.Enumerable.OrderByDescending%2A>, <xref:System.Linq.Enumerable.ThenBy%2A> or <xref:System.Linq.Enumerable.ThenByDescending%2A>. Doing this introduces a new primary ordering that ignores the previously established ordering.
        /// ]]></format>
        /// If <paramref name="comparer" /> is <see langword="null" />, the default comparer <see cref="O:Comparer{T}.Default" /> is used to compare keys.
        ...
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// To order a sequence by the values of the elements themselves, specify the identity function (`x => x` in Visual C# or `Function(x) x` in Visual Basic) for <paramref name="keySelector" />.
        /// For an example of this method, see <see cref="OrderByDescending{T1,T2}(IEnumerable{T1},Func{T1,T2},IComparer{T2})" />.
        /// Two methods are defined to extend the type <see cref="IOrderedEnumerable{T}" />, which is the return type of this method. These two methods, namely `ThenBy` and `ThenByDescending`, enable you to specify additional sort criteria to sort a sequence. `ThenBy` and `ThenByDescending` also return an <see cref="IOrderedEnumerable{T}" />, which means any number of consecutive calls to `ThenBy` or `ThenByDescending` can be made.
        /// <format type="text/markdown"><![CDATA[
        /// > [!NOTE]
        /// >  Because <xref:System.Linq.IOrderedEnumerable%601> inherits from <xref:System.Collections.Generic.IEnumerable%601>, you can call <xref:System.Linq.Enumerable.OrderBy%2A> or <xref:System.Linq.Enumerable.OrderByDescending%2A> on the results of a call to <xref:System.Linq.Enumerable.OrderBy%2A>, <xref:System.Linq.Enumerable.OrderByDescending%2A>, <xref:System.Linq.Enumerable.ThenBy%2A> or <xref:System.Linq.Enumerable.ThenByDescending%2A>. Doing this introduces a new primary ordering that ignores the previously established ordering.
        ...
        /// This method compares keys by using the default comparer <see cref="O:Comparer{T}.Default" />.
        /// This method performs a stable sort; that is, if the keys of two elements are equal, the order of the elements is preserved. In contrast, an unstable sort does not preserve the order of elements that have the same key.
        /// In query expression syntax, an `orderby descending` (Visual C#) or `Order By Descending` (Visual Basic) clause translates to an invocation of <see cref="O:Enumerable.OrderByDescending" />.</remarks>
        /// <altmember cref="OrderBy{T1,T2}(IEnumerable{T1},Func{T1,T2})"/>
        /// <altmember cref="OrderBy{T1,T2}(IEnumerable{T1},Func{T1,T2},IComparer{T2})"/>
        /// <related type="Article" href="/dotnet/csharp/language-reference/keywords/orderby-clause">orderby clause (C# Reference)</related>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/order-by-clause">Order By Clause (Visual Basic)</related>
        ...
        /// If <paramref name="comparer" /> is <see langword="null" />, the default comparer <see cref="O:Comparer{T}.Default" /> is used to compare keys.
        /// This method performs a stable sort; that is, if the keys of two elements are equal, the order of the elements is preserved. In contrast, an unstable sort does not preserve the order of elements that have the same key.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="OrderByDescending{T1,T2}(IEnumerable{T1},Func{T1,T2},IComparer{T2})" /> to sort the elements of a sequence in descending order by using a transform function and a custom comparer.
        ...
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// To order a sequence by the values of the elements themselves, specify the identity function (`x => x` in Visual C# or `Function(x) x` in Visual Basic) for <paramref name="keySelector" />.
        /// <see cref="O:Enumerable.ThenBy" /> and <see cref="O:Enumerable.ThenByDescending" /> are defined to extend the type <see cref="IOrderedEnumerable{T}" />, which is also the return type of these methods. This design enables you to specify multiple sort criteria by applying any number of <see cref="O:Enumerable.ThenBy" /> or <see cref="O:Enumerable.ThenByDescending" /> methods.
        /// <format type="text/markdown"><![CDATA[
        /// > [!NOTE]
        /// >  Because <xref:System.Linq.IOrderedEnumerable%601> inherits from <xref:System.Collections.Generic.IEnumerable%601>, you can call <xref:System.Linq.Enumerable.OrderBy%2A> or <xref:System.Linq.Enumerable.OrderByDescending%2A> on the results of a call to <xref:System.Linq.Enumerable.OrderBy%2A>, <xref:System.Linq.Enumerable.OrderByDescending%2A>, <xref:System.Linq.Enumerable.ThenBy%2A> or <xref:System.Linq.Enumerable.ThenByDescending%2A>. Doing this introduces a new primary ordering that ignores the previously established ordering.
        /// ]]></format>
        /// This method compares keys by using the default comparer <see cref="O:Comparer{T}.Default" />.
        /// This method performs a stable sort; that is, if the keys of two elements are equal, the order of the elements is preserved. In contrast, an unstable sort does not preserve the order of elements that have the same key.
        /// In query expression syntax, an `orderby [first criterion], [second criterion]` (Visual C#) or `Order By [first criterion], [second criterion]` (Visual Basic) clause translates to an invocation of <see cref="O:Enumerable.ThenBy" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="ThenBy{T1,T2}(IOrderedEnumerable{T1},Func{T1,T2})" /> to perform a secondary ordering of the elements in a sequence.
        ...
        /// >  Because <xref:System.Linq.IOrderedEnumerable%601> inherits from <xref:System.Collections.Generic.IEnumerable%601>, you can call <xref:System.Linq.Enumerable.OrderBy%2A> or <xref:System.Linq.Enumerable.OrderByDescending%2A> on the results of a call to <xref:System.Linq.Enumerable.OrderBy%2A>, <xref:System.Linq.Enumerable.OrderByDescending%2A>, <xref:System.Linq.Enumerable.ThenBy%2A> or <xref:System.Linq.Enumerable.ThenByDescending%2A>. Doing this introduces a new primary ordering that ignores the previously established ordering.
        /// ]]></format>
        /// This sorting method compares keys by using the default comparer <see cref="O:Comparer{T}.Default" />.
        /// This method performs a stable sort; that is, if the keys of two elements are equal, the order of the elements is preserved. In contrast, an unstable sort does not preserve the order of elements that have the same key.
        /// In Visual C# query expression syntax, an `orderby [first criterion], [second criterion] descending` clause translates to an invocation of <see cref="O:Enumerable.ThenByDescending" />.
        /// In Visual Basic query expression syntax, an `Order By [first criterion], [second criterion] Descending` clause translates to an invocation of <see cref="O:Enumerable.ThenByDescending" />.</remarks>
        /// <related type="Article" href="/dotnet/csharp/language-reference/keywords/orderby-clause">orderby clause (C# Reference)</related>
        /// <related type="Article" href="/dotnet/visual-basic/language-reference/queries/order-by-clause">Order By Clause (Visual Basic)</related>
        ...
        /// If <paramref name="comparer" /> is <see langword="null" />, the default comparer <see cref="O:Comparer{T}.Default" /> is used to compare keys.
        /// This method performs a stable sort; that is, if the keys of two elements are equal, the order of the elements is preserved. In contrast, an unstable sort does not preserve the order of elements that have the same key.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="ThenByDescending{T1,T2}(IOrderedEnumerable{T1},Func{T1,T2},IComparer{T2})" /> to perform a secondary ordering of the elements in a sequence in descending order by using a custom comparer.
    ...
    {
        /// <summary>Performs a subsequent ordering on the elements of an <see cref="IOrderedEnumerable{T}" /> according to a key.</summary>
        /// <typeparam name="TKey">The type of the key produced by <paramref name="keySelector" />.</typeparam>
        /// <param name="keySelector">The <see cref="Func{T1,T2}" /> used to extract the key for each element.</param>
        ...
        /// <returns>An <see cref="IOrderedEnumerable{T}" /> whose elements are sorted according to a key.</returns>
        /// <remarks>The functionality provided by this method is like that provided by <see cref="O:Enumerable.ThenBy" /> or <see cref="O:Enumerable.ThenByDescending" />, depending on whether <paramref name="descending" /> is <see langword="true" /> or <see langword="false" />. They both perform a subordinate ordering of an already sorted sequence of type <see cref="IOrderedEnumerable{T}" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="O:IOrderedEnumerable{T}.CreateOrderedEnumerable" /> to perform a secondary ordering on an <see cref="IOrderedEnumerable{T}" />.
