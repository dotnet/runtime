...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// The <see cref="Concat{T}(IEnumerable{T},IEnumerable{T})" /> method differs from the <see cref="O:Enumerable.Union" /> method because the <see cref="Concat{T}(IEnumerable{T},IEnumerable{T})" /> method returns all the original elements in the input sequences. The <see cref="O:Enumerable.Union" /> method returns only unique elements.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="Concat{T}(IEnumerable{T},IEnumerable{T})" /> to concatenate two sequences.
        ...
        /// An alternative way of concatenating two sequences is to construct a collection, for example an array, of sequences and then apply the <see cref="O:Enumerable.SelectMany" /> method, passing it the identity selector function. The following example demonstrates this use of <see cref="O:Enumerable.SelectMany" />.
