...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <remarks>The <see cref="Single{T}(IEnumerable{T})" /> method throws an exception if the input sequence is empty. To instead return <see langword="null" /> when the input sequence is empty, use <see cref="O:Enumerable.SingleOrDefault" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="Single{T}(IEnumerable{T})" /> to select the only element of an array.
        ...
        /// The following code example demonstrates that <see cref="Single{T}(IEnumerable{T})" /> throws an exception when the sequence does not contain exactly one element.
        ...
        /// <remarks>The <see cref="Single{T}(IEnumerable{T},Func{T,bool})" /> method throws an exception if the input sequence contains no matching element. To instead return <see langword="null" /> when no matching element is found, use <see cref="O:Enumerable.SingleOrDefault" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="Single{T}(IEnumerable{T},Func{T,bool})" /> to select the only element of an array that satisfies a condition.
        ...
        /// The following code example demonstrates that <see cref="Single{T}(IEnumerable{T},Func{T,bool})" /> throws an exception when the sequence does not contain exactly one element that satisfies the condition.
        ...
        /// <para>The <see cref="O:Enumerable.SingleOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="DefaultIfEmpty{T}(IEnumerable{T},T)" /> method as described in the Example section.</para>
        /// </remarks>
        /// <example>The following code example demonstrates how to use <see cref="SingleOrDefault{T}(IEnumerable{T})" /> to select the only element of an array.
        ...
        /// The following code example demonstrates that <see cref="SingleOrDefault{T}(IEnumerable{T})" /> returns a default value when the sequence is empty.
        ...
        /// <example>The following code example demonstrates how to use <see cref="SingleOrDefault{T}(IEnumerable{T},Func{T,bool})" /> to select the only element of an array that satisfies a condition.
        ...
        /// The following code example demonstrates that <see cref="SingleOrDefault{T}(IEnumerable{T},Func{T,bool})" /> returns a default value when the sequence contains no elements that satisfy the condition.
