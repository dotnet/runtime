...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// The <see cref="O:Enumerable.SingleOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="DefaultIfEmpty{T}(IEnumerable{T},T)" /> method as described in the Example section.</remarks>
