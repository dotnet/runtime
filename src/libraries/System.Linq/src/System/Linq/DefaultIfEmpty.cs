...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <returns>An <see cref="System.Collections.Generic.IEnumerable{T}" /> object that contains the default value for the <typeparamref name="TSource" /> type if <paramref name="source" /> is empty; otherwise, <paramref name="source" />.</returns>
        ...
        /// This method can be used to produce a left outer join when it is combined with the <see cref="O:System.Linq.Enumerable.GroupJoin" />) method.</remarks>
        /// <example>The following code examples demonstrate how to use <see cref="System.Linq.Enumerable.DefaultIfEmpty{T}(System.Collections.Generic.IEnumerable{T})" /> to provide a default value in case the source sequence is empty.
        ...
        /// <returns>An <see cref="System.Collections.Generic.IEnumerable{T}" /> that contains <paramref name="defaultValue" /> if <paramref name="source" /> is empty; otherwise, <paramref name="source" />.</returns>
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// This method can be used to produce a left outer join when it is combined with the <see cref="O:System.Linq.Enumerable.GroupJoin" />) method.</remarks>
        /// <example>The following code example demonstrates how to use the <see cref="System.Linq.Enumerable.DefaultIfEmpty{T}(System.Collections.Generic.IEnumerable{T},T)" /> method and specify a default value. The first sequence is not empty and the second sequence is empty.
