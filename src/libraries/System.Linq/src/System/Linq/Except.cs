...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <param name="first">An <see cref="System.Collections.Generic.IEnumerable{T}" /> whose elements that are not also in <paramref name="second" /> will be returned.</param>
        /// <param name="second">An <see cref="System.Collections.Generic.IEnumerable{T}" /> whose elements that also occur in the first sequence will cause those elements to be removed from the returned sequence.</param>
        ...
        /// <returns>A sequence that contains the set difference of the elements of two sequences.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="first" /> or <paramref name="second" /> is <see langword="null" />.</exception>
        /// <remarks>If <paramref name="comparer" /> is <see langword="null" />, the default equality comparer, <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" />, is used to compare values.</remarks>
        /// <example>If you want to compare sequences of objects of some custom data type, you have to implement the <see cref="System.Collections.Generic.IEqualityComparer{T}" /> generic interface in a helper class. The following code example shows how to implement this interface in a custom data type and provide <see cref="O:object.GetHashCode" /> and <see cref="O:object.Equals" /> methods.
        /// The following example shows how to implement an equality comparer that can be used in the <see cref="O:System.Linq.Enumerable.Except" /> method.
        ...
        /// After you implement this comparer, you can use sequences of `Product` objects in the <see cref="O:System.Linq.Enumerable.Except" /> method, as shown in the following example:
