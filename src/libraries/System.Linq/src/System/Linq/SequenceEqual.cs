...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <param name="first">An <see cref="System.Collections.Generic.IEnumerable{T}" /> to compare to <paramref name="second" />.</param>
        /// <param name="second">An <see cref="System.Collections.Generic.IEnumerable{T}" /> to compare to the first sequence.</param>
        ...
        /// <remarks>The <see cref="SequenceEqual{TSource}(IEnumerable{TSource}, IEnumerable{TSource})" /> method enumerates the two source sequences in parallel and compares corresponding elements by using the default equality comparer for <typeparamref name="TSource" />, <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" />.
        ...
        /// If you want to compare the actual data of the objects in the sequences instead of just comparing their references, you have to implement the <see cref="System.Collections.Generic.IEqualityComparer{T}" /> generic interface in your class. The following code example shows how to implement this interface in a helper class and provide <see cref="O:object.GetHashCode" /> and <see cref="O:object.Equals" /> methods.
        ...
        /// <summary>Determines whether two sequences are equal by comparing their elements by using a specified <see cref="System.Collections.Generic.IEqualityComparer{T}" />.</summary>
        /// <typeparam name="TSource">The type of the elements of the input sequences.</typeparam>
        /// <param name="first">An <see cref="System.Collections.Generic.IEnumerable{T}" /> to compare to <paramref name="second" />.</param>
        /// <param name="second">An <see cref="System.Collections.Generic.IEnumerable{T}" /> to compare to the first sequence.</param>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="first" /> or <paramref name="second" /> is <see langword="null" />.</exception>
        /// <remarks>The <see cref="System.Linq.Enumerable.SequenceEqual{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method enumerates the two source sequences in parallel and compares corresponding elements by using the specified <see cref="System.Collections.Generic.IEqualityComparer{T}" />. If <paramref name="comparer" /> is <see langword="null" />, the default equality comparer, <see cref="O:System.Collections.Generic.EqualityComparer{T}.Default" />, is used to compare elements.</remarks>
        /// <example>The following example shows how to implement an equality comparer that can be used in the <see cref="System.Linq.Enumerable.SequenceEqual{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method.
        ...
        /// After you implement this comparer, you can use sequences of `Product` objects in the <see cref="System.Linq.Enumerable.SequenceEqual{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEqualityComparer{T})" /> method, as shown in the following example:
