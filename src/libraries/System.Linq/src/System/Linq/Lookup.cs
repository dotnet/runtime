...
namespace System.Linq
{
    ...
    {
        /// <summary>Creates a <see cref="Lookup{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to a specified key selector function.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <param name="source">The <see cref="IEnumerable{T}" /> to create a <see cref="Lookup{T1,T2}" /> from.</param>
        ...
        /// <summary>Creates a <see cref="Lookup{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to a specified key selector function and key comparer.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <param name="source">The <see cref="IEnumerable{T}" /> to create a <see cref="Lookup{T1,T2}" /> from.</param>
        /// <param name="keySelector">A function to extract a key from each element.</param>
        ...
        /// <summary>Creates a <see cref="Lookup{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to specified key selector and element selector functions.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        ...
        /// <summary>Creates a <see cref="Lookup{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to a specified key selector function, a comparer and an element selector function.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <typeparam name="TElement">The type of the value returned by <paramref name="elementSelector" />.</typeparam>
        /// <param name="source">The <see cref="IEnumerable{T}" /> to create a <see cref="Lookup{T1,T2}" /> from.</param>
    ...
    /// <altmember cref="Lookup{T1,T2}"/>
    public interface ILookup<TKey, TElement> : IEnumerable<IGrouping<TKey, TElement>>
    {
        /// <summary>Gets the number of key/value collection pairs in the <see cref="ILookup{T1,T2}" />.</summary>
        /// <value>The number of key/value collection pairs in the <see cref="ILookup{T1,T2}" />.</value>
        int Count { get; }

        IEnumerable<TElement> this[TKey key] { get; }

        /// <summary>Determines whether a specified key exists in the <see cref="ILookup{T1,T2}" />.</summary>
        /// <param name="key">The key to search for in the <see cref="ILookup{T1,T2}" />.</param>
        /// <returns><see langword="true" /> if <paramref name="key" /> is in the <see cref="ILookup{T1,T2}" />; otherwise, <see langword="false" />.</returns>
        bool Contains(TKey key);
    }

    /// <summary>Represents a collection of keys each mapped to one or more values.</summary>
    /// <typeparam name="TKey">The type of the keys in the <see cref="Lookup{T1,T2}" />.</typeparam>
    /// <typeparam name="TElement">The type of the elements of each <see cref="IEnumerable{T}" /> value in the <see cref="Lookup{T1,T2}" />.</typeparam>
    /// <remarks>A <see cref="Lookup{T1,T2}" /> resembles a <see cref="Dictionary{T1,T2}" />. The difference is that a <see cref="Dictionary{T1,T2}" /> maps keys to single values, whereas a <see cref="Lookup{T1,T2}" /> maps keys to collections of values.
    /// You can create an instance of a <see cref="Lookup{T1,T2}" /> by calling <see cref="O:Enumerable.ToLookup" /> on an object that implements <see cref="IEnumerable{T}" />.
    ...
    /// ]]></format></remarks>
    /// <example>The following example creates a <see cref="Lookup{T1,T2}" /> from a collection of objects. It then enumerates the <see cref="Lookup{T1,T2}" /> and outputs each key and each value in the key's associated collection of values. It also demonstrates how to use the properties <see cref="O:Lookup{T1,T2}.Count" /> and <see cref="O:Lookup{T1,T2}.Item" /> and the methods <see cref="O:Lookup{T1,T2}.Contains" /> and <see cref="O:Lookup{T1,T2}.GetEnumerator" />.
    ...
    public partial class Lookup<TKey, TElement> : ILookup<TKey, TElement>
    {
        ...
        /// <summary>Gets the number of key/value collection pairs in the <see cref="Lookup{T1,T2}" />.</summary>
        /// <value>The number of key/value collection pairs in the <see cref="Lookup{T1,T2}" />.</value>
        /// <remarks>The value of the <see cref="O:Lookup{T1,T2}.Count" /> property does not change because items cannot be added to or removed from a <see cref="Lookup{T1,T2}" /> object after it has been created.</remarks>
        /// <example>The following example demonstrates how to use <see cref="O:Lookup{T1,T2}.Count" /> to determine the number of key/value collection pairs in a <see cref="Lookup{T1,T2}" />. This code example is part of a larger example provided for the <see cref="Lookup{T1,T2}" /> class.
        ...
        /// <summary>Determines whether a specified key is in the <see cref="Lookup{T1,T2}" />.</summary>
        /// <param name="key">The key to find in the <see cref="Lookup{T1,T2}" />.</param>
        /// <returns><see langword="true" /> if <paramref name="key" /> is in the <see cref="Lookup{T1,T2}" />; otherwise, <see langword="false" />.</returns>
        /// <remarks></remarks>
        /// <example>The following example demonstrates how to use <see cref="O:Lookup{T1,T2}.Contains" /> to determine whether a <see cref="Lookup{T1,T2}" /> contains a specified key. This code example is part of a larger example provided for the <see cref="Lookup{T1,T2}" /> class.
        ...
        /// <summary>Returns a generic enumerator that iterates through the <see cref="Lookup{T1,T2}" />.</summary>
        /// <returns>An enumerator for the <see cref="Lookup{T1,T2}" />.</returns>
        /// <remarks></remarks>
        /// <example>The following example demonstrates how to use <see cref="O:Lookup{T1,T2}.GetEnumerator" /> to iterate through the keys and values of a <see cref="Lookup{T1,T2}" />. This code example is part of a larger example provided for the <see cref="Lookup{T1,T2}" /> class.
        ...
        /// <returns>A collection that contains one value for each key/value collection pair in the <see cref="Lookup{T1,T2}" />.</returns>
        ...
        /// <summary>Returns an enumerator that iterates through the <see cref="Lookup{T1,T2}" />. This class cannot be inherited.</summary>
        /// <returns>An enumerator for the <see cref="Lookup{T1,T2}" />.</returns>
        /// <remarks>This member is an explicit interface member implementation. It can be used only when the <see cref="Lookup{T1,T2}" /> instance is cast to an <see cref="System.Collections.IEnumerable" /> interface.</remarks>
