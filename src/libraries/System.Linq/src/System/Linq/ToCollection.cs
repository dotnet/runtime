...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <summary>Creates a <see cref="Dictionary{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to a specified key selector function.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <param name="source">An <see cref="IEnumerable{T}" /> to create a <see cref="Dictionary{T1,T2}" /> from.</param>
        /// <param name="keySelector">A function to extract a key from each element.</param>
        /// <returns>A <see cref="Dictionary{T1,T2}" /> that contains keys and values. The values within each group are in the same order as in <paramref name="source" />.</returns>
        ...
        /// <remarks>The <see cref="ToDictionary{T1,T2}(IEnumerable{T1},Func{T1,T2})" /> method uses the default equality comparer <see cref="O:EqualityComparer{T}.Default" /> to compare keys.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="ToDictionary{T1,T2}(IEnumerable{T1},Func{T1,T2})" /> to create a <see cref="Dictionary{T1,T2}" /> by using a key selector.
        ...
        /// <summary>Creates a <see cref="Dictionary{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to a specified key selector function and key comparer.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        ...
        /// <paramref name="keySelector" /> produces a key that is <see langword="null" />.</exception>
        /// <exception cref="System.ArgumentException"><paramref name="keySelector" /> produces duplicate keys for two elements.</exception>
        /// <remarks>If <paramref name="comparer" /> is <see langword="null" />, the default equality comparer <see cref="O:EqualityComparer{T}.Default" /> is used to compare keys.</remarks>
        ...
        /// <summary>Creates a <see cref="Dictionary{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to specified key selector and element selector functions.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        ...
        /// <returns>A <see cref="Dictionary{T1,T2}" /> that contains values of type <typeparamref name="TElement" /> selected from the input sequence.</returns>
        ...
        /// <paramref name="keySelector" /> produces a key that is <see langword="null" />.</exception>
        /// <exception cref="System.ArgumentException"><paramref name="keySelector" /> produces duplicate keys for two elements.</exception>
        /// <remarks>The <see cref="ToDictionary{T1,T2,T3}(IEnumerable{T1},Func{T1,T2},Func{T1,T3})" /> method uses the default equality comparer <see cref="O:EqualityComparer{T}.Default" /> to compare keys.</remarks>
        ...
        /// <summary>Creates a <see cref="Dictionary{T1,T2}" /> from an <see cref="IEnumerable{T}" /> according to a specified key selector function, a comparer, and an element selector function.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <typeparam name="TElement">The type of the value returned by <paramref name="elementSelector" />.</typeparam>
        /// <param name="source">An <see cref="IEnumerable{T}" /> to create a <see cref="Dictionary{T1,T2}" /> from.</param>
        ...
        /// <summary>Creates a <see cref="HashSet{T}" /> from an <see cref="IEnumerable{T}" /> using the <paramref name="comparer" /> to compare keys.</summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">An <see cref="IEnumerable{T}" /> to create a <see cref="HashSet{T}" /> from.</param>
        /// <param name="comparer">An <see cref="IEqualityComparer{T}" /> to compare keys.</param>
        /// <returns>A <see cref="HashSet{T}" /> that contains values of type <typeparamref name="TSource" /> selected from the input sequence.</returns>
