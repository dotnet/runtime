...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <para>The <see cref="O:Enumerable.FirstOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="DefaultIfEmpty{T}(IEnumerable{T},T)" /> method as described in the Example section.</para>
        /// </remarks>
