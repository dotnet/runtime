...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <remarks>The <see cref="System.Linq.Enumerable.First{T}(System.Collections.Generic.IEnumerable{T})" /> method throws an exception if <paramref name="source" /> contains no elements. To instead return a default value when the source sequence is empty, use the <see cref="O:System.Linq.Enumerable.FirstOrDefault" /> method.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.First{T}(System.Collections.Generic.IEnumerable{T})" /> to return the first element of an array.
        ...
        /// <remarks>The <see cref="System.Linq.Enumerable.First{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> method throws an exception if no matching element is found in <paramref name="source" />. To instead return a default value when no matching element is found, use the <see cref="O:System.Linq.Enumerable.FirstOrDefault" /> method.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.First{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> to return the first element of an array that satisfies a condition.
        ...
        /// The <see cref="O:System.Linq.Enumerable.FirstOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="System.Linq.Enumerable.DefaultIfEmpty{T}(System.Collections.Generic.IEnumerable{T},T)" /> method as described in the Example section.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.FirstOrDefault{T}(System.Collections.Generic.IEnumerable{T})" /> on an empty array.
        ...
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.FirstOrDefault{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> by passing in a predicate. In the second call to the method, there is no element in the array that satisfies the condition.
