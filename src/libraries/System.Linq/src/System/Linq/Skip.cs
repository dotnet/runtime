...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <para>If <paramref name="source" /> contains fewer than <paramref name="count" /> elements, an empty <see cref="IEnumerable{T}" /> is returned. If <paramref name="count" /> is less than or equal to zero, all elements of <paramref name="source" /> are yielded.</para>
        ...
        /// <para>In Visual Basic query expression syntax, a `Skip` clause translates to an invocation of <see cref="O:Enumerable.Skip" />.</para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>The <see cref="SkipWhile{T}(IEnumerable{T},Func{T,bool})" /> method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.</para>
        /// <para>This method tests each element of <paramref name="source" /> by using <paramref name="predicate" /> and skips the element if the result is <see langword="true" />. After the predicate function returns <see langword="false" /> for an element, that element and the remaining elements in <paramref name="source" /> are yielded and there are no more invocations of <paramref name="predicate" />.</para>
        /// <para>If <paramref name="predicate" /> returns <see langword="true" /> for all elements in the sequence, an empty <see cref="IEnumerable{T}" /> is returned.</para>
        ...
        /// <para>In Visual Basic query expression syntax, a `Skip While` clause translates to an invocation of <see cref="O:Enumerable.SkipWhile" />.</para>
        /// </remarks>
