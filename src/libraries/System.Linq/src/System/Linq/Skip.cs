...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// If <paramref name="source" /> contains fewer than <paramref name="count" /> elements, an empty <see cref="System.Collections.Generic.IEnumerable{T}" /> is returned. If <paramref name="count" /> is less than or equal to zero, all elements of <paramref name="source" /> are yielded.
        ...
        /// In Visual Basic query expression syntax, a `Skip` clause translates to an invocation of <see cref="O:System.Linq.Enumerable.Skip" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="O:System.Linq.Enumerable.Skip" /> to skip a specified number of elements in a sorted array and return the remaining elements.
        ...
        /// <returns>An <see cref="System.Collections.Generic.IEnumerable{T}" /> that contains the elements from the input sequence starting at the first element in the linear series that does not pass the test specified by <paramref name="predicate" />.</returns>
        ...
        /// <remarks>The <see cref="System.Linq.Enumerable.SkipWhile{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        ...
        /// If <paramref name="predicate" /> returns <see langword="true" /> for all elements in the sequence, an empty <see cref="System.Collections.Generic.IEnumerable{T}" /> is returned.
        ...
        /// In Visual Basic query expression syntax, a `Skip While` clause translates to an invocation of <see cref="O:System.Linq.Enumerable.SkipWhile" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.SkipWhile{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> to skip elements of an array as long as a condition is true.
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.</exception>
        /// <remarks>This method is implemented by using deferred execution. The immediate return value is an object that stores all the information that is required to perform the action. The query represented by this method is not executed until the object is enumerated either by calling its `GetEnumerator` method directly or by using `foreach` in Visual C# or `For Each` in Visual Basic.
        /// The <see cref="System.Linq.Enumerable.SkipWhile{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,int,bool})" /> method tests each element of <paramref name="source" /> by using <paramref name="predicate" /> and skips the element if the result is <see langword="true" />. After the predicate function returns <see langword="false" /> for an element, that element and the remaining elements in <paramref name="source" /> are yielded and there are no more invocations of <paramref name="predicate" />.
        /// If <paramref name="predicate" /> returns <see langword="true" /> for all elements in the sequence, an empty <see cref="System.Collections.Generic.IEnumerable{T}" /> is returned.
        ...
        /// The <see cref="O:System.Linq.Enumerable.TakeWhile" /> and <see cref="O:System.Linq.Enumerable.SkipWhile" /> methods are functional complements. Given a sequence `coll` and a pure function `p`, concatenating the results of `coll.TakeWhile(p)` and `coll.SkipWhile(p)` yields the same sequence as `coll`.
        /// In Visual Basic query expression syntax, a `Skip While` clause translates to an invocation of <see cref="O:System.Linq.Enumerable.SkipWhile" />.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.SkipWhile{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,int,bool})" /> to skip elements of an array as long as a condition that depends on the element's index is true.
