...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <remarks>The <see cref="System.Linq.Enumerable.Last{T}(System.Collections.Generic.IEnumerable{T})" /> method throws an exception if <paramref name="source" /> contains no elements. To instead return a default value when the source sequence is empty, use the <see cref="O:System.Linq.Enumerable.LastOrDefault" /> method.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.Last{T}(System.Collections.Generic.IEnumerable{T})" /> to return the last element of an array.
        ...
        /// <remarks>The <see cref="System.Linq.Enumerable.Last{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> method throws an exception if no matching element is found in <paramref name="source" />. To instead return a default value when no matching element is found, use the <see cref="O:System.Linq.Enumerable.LastOrDefault" /> method.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.Last{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> to return the last element of an array that satisfies a condition.
        ...
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">An <see cref="System.Collections.Generic.IEnumerable{T}" /> to return the last element of.</param>
        /// <returns><see langword="default" />(<typeparamref name="TSource" />) if the source sequence is empty; otherwise, the last element in the <see cref="System.Collections.Generic.IEnumerable{T}" />.</returns>
        /// <exception cref="System.ArgumentNullException"><paramref name="source" /> is <see langword="null" />.</exception>
        /// <remarks>The default value for reference and nullable types is <see langword="null" />.
        /// The <see cref="O:System.Linq.Enumerable.LastOrDefault" /> method does not provide a way to specify a default value. If you want to specify a default value other than `default(TSource)`, use the <see cref="System.Linq.Enumerable.DefaultIfEmpty{T}(System.Collections.Generic.IEnumerable{T},T)" /> method as described in the Example section.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.LastOrDefault{T}(System.Collections.Generic.IEnumerable{T})" /> on an empty array.
        ...
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.LastOrDefault{T}(System.Collections.Generic.IEnumerable{T},System.Func{T,bool})" /> by passing in a predicate. In the second call to the method, there is no element in the sequence that satisfies the condition.
