...
namespace System.Linq
{
    ...
    public static partial class Enumerable
    {
        ...
        /// <returns>An <see cref="System.Collections.Generic.IEnumerable{T}" /> that has elements of type <typeparamref name="TResult" /> that are obtained by performing an inner join on two sequences.</returns>
        ...
        /// A join refers to the operation of correlating the elements of two sources of information based on a common key. <see cref="O:System.Linq.Enumerable.Join" /> brings the two information sources and the keys by which they are matched together in one method call. This differs from the use of `SelectMany`, which requires more than one method call to perform the same operation.
        /// <see cref="O:System.Linq.Enumerable.Join" /> preserves the order of the elements of <paramref name="outer" />, and for each of these elements, the order of the matching elements of <paramref name="inner" />.
        /// In query expression syntax, a `join` (Visual C#) or `Join` (Visual Basic) clause translates to an invocation of <see cref="O:System.Linq.Enumerable.Join" />.
        /// In relational database terms, the <see cref="O:System.Linq.Enumerable.Join" /> method implements an inner equijoin. 'Inner' means that only elements that have a match in the other sequence are included in the results. An 'equijoin' is a join in which the keys are compared for equality. A left outer join operation has no dedicated standard query operator, but can be performed by using the <see cref="O:System.Linq.Enumerable.GroupJoin" /> method. See <a href="https://msdn.microsoft.com/library/442d176d-028c-4beb-8d22-407d4ef89107">Join Operations</a>.</remarks>
        /// <example>The following code example demonstrates how to use <see cref="System.Linq.Enumerable.Join{T1,T2,T3,T4}(System.Collections.Generic.IEnumerable{T1},System.Collections.Generic.IEnumerable{T2},System.Func{T1,T3},System.Func{T2,T3},System.Func{T1,T2,T4})" /> to perform an inner join of two sequences based on a common key.
