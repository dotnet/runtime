...
namespace ComInterfaceGenerator.Unit.Tests
{
    public class CompileFails
    {
        ...
        public static IEnumerable<object[]> InvalidUnmanagedToManagedCodeSnippetsToCompile(GeneratorKind generator)
        {
            ...
            {
                // /0/Test0.cs(13,48): error SYSLIB1051: The type 'Microsoft.Win32.SafeHandles.SafeFileHandle' is not supported by source-generated P/Invokes. The generated source will not handle marshalling of the return value of method 'Method'.
                VerifyComInterfaceGenerator.Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupported).WithLocation(0).WithArguments("Microsoft.Win32.SafeHandles.SafeFileHandle", "Method"),
                // /0/Test0.cs(13,98): error SYSLIB1051: The type 'Microsoft.Win32.SafeHandles.SafeFileHandle' is not supported by source-generated P/Invokes. The generated source will not handle marshalling of parameter 'value'.
                VerifyComInterfaceGenerator.Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupported).WithLocation(1).WithArguments("Microsoft.Win32.SafeHandles.SafeFileHandle", "value"),
                ...
                VerifyComInterfaceGenerator.Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupported).WithLocation(2).WithArguments("Microsoft.Win32.SafeHandles.SafeFileHandle", "inValue"),
                ...
                VerifyComInterfaceGenerator.Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupported).WithLocation(3).WithArguments("Microsoft.Win32.SafeHandles.SafeFileHandle", "refValue"),
                ...
                VerifyComInterfaceGenerator.Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupported).WithLocation(4).WithArguments("Microsoft.Win32.SafeHandles.SafeFileHandle", "outValue"),
            } };
