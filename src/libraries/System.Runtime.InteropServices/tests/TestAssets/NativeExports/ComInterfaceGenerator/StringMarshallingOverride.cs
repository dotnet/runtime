...
namespace NativeExports.ComInterfaceGenerator
{
    public unsafe partial class StringMarshallingOverride
    {
		...
		partial class Implementation : IStringMarshallingOverride
		{
			string _data = "Your string: ";

			string IStringMarshallingOverride.StringMarshallingUtf8(string input)
			{
				return _data + input;
			}

			string IStringMarshallingOverride.MarshalAsLPWString(string input)
			{
				return _data + input;
			}

			string IStringMarshallingOverride.MarshalUsingUtf16(string input)
			{
				return _data + input;
			}
