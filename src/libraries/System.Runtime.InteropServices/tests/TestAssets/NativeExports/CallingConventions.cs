...
namespace NativeExports
{
    class CallingConventions
    {
        ...
        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = "add_integers_cdecl")]
        public static long AddLongsCdecl(long i, long j, long k, long l, long m, long n, long o, long p, long q)
        {
            return i + j + k + l + m + n + o + p + q;
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)], EntryPoint = "add_integers_stdcall")]
