...
namespace Microsoft.Interop
{
    internal static class VtableIndexStubGeneratorHelpers
    {
        ...
        private static IMarshallingGeneratorFactory CreateGeneratorFactory(EnvironmentFlags env, MarshalDirection direction)
        {
            ...
            generatorFactory = new CharMarshallingGeneratorFactory(generatorFactory, useBlittableMarshallerForUtf16: env.HasFlag(EnvironmentFlags.DisableRuntimeMarshalling), TypeNames.VirtualMethodIndexAttribute_ShortName);
