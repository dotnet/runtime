            ...
            static unsafe bool IsStrictlyBlittableWorker(ITypeSymbol t, ImmutableHashSet<ITypeSymbol> seenTypes, Compilation compilation)
            {
                ...
                else if (t.IsValueType)
                {
                        ...
                        || sourceAssembly.Compilation != compilation)
                    {
                        ...
                        if (t.MetadataName is TypeNames.System_Runtime_InteropServices_CLong // CLong is an interop intrinsic type for the C long type
                        ...
                        {
                            if (t.MetadataName == TypeNames.System_Guid) // .NET has established that Guid is blittable and matches the shape of the Win32 GUID type exactly and always will.
                            {
                                return true;
                            }
                        }
