...
namespace Microsoft.Interop.Analyzers
{
    public struct DiagnosticReporter
    {
        ...
        public static DiagnosticReporter CreateForLocation(Location location, Action<Diagnostic> reportDiagnostic) => new((descriptor, properties, args) => reportDiagnostic(location.CreateDiagnostic(descriptor, properties, args).ToDiagnostic()));
