...
namespace System.Runtime.InteropServices.ObjectiveC
{
    ...
    {
        public IntPtr Isa;
        public unsafe static T GetInstance<T>(Instance* instancePtr) where T : class => throw null;
    }
    ...
    {
        private int _dummyPrimitive;
        public unsafe static T GetDelegate<T>(BlockLiteral* block) where T : Delegate => throw null;
    }
    ...
    public abstract class Wrappers
    {
        ...
        public object GetOrCreateObjectForInstance(IntPtr instance, Type typeAssociation, CreateObjectFlags flags) => throw null;

        protected abstract ObjectiveCBase CreateObject(IntPtr instance, Type typeAssociation, CreateObjectFlags flags);

        protected unsafe virtual delegate* unmanaged[Cdecl]<IntPtr, int> GetReferenceCallback(bool isManagedRegistration) => throw null;

        public IntPtr GetInstanceFromObject(ObjectiveCBase obj) => throw null;
        ...
        public static void GetLifetimeMethods(
            ...
            out IntPtr deallocImpl) => throw null;

        public BlockLiteral CreateBlockForDelegate(Delegate instance, CreateBlockFlags flags) => throw null;
        ...
        public Delegate GetOrCreateDelegateForBlock(IntPtr block, CreateDelegateFlags flags, CreateDelegate createDelegate) => throw null;
