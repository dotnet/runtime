...
#nullable disable
                ...
                var jsStackTrace = (string)jsException.GetObjectProperty("stack");
...
#nullable restore
        ...
        {
            var other = obj as JSException;
            if (other == null) return false;
            return other.jsException == jsException;
        }
        ...
        public override int GetHashCode()
        {
            return jsException == null
                ? base.GetHashCode()
                : base.GetHashCode() * jsException.JSHandle;
        }
