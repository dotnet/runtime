...
namespace System.Formats.Tar.Tests
{
    ...
    public class TarWriter_WriteEntry_Ustar_Tests : TarWriter_WriteEntry_Base
    {
        ...
        public async Task WriteEntry_Null_Throws(bool async)
        {
            ...
            TarWriter writer = await CreateTarWriter(archiveStream, async, TarEntryFormat.Ustar, leaveOpen: false);
            try
            {
                if (async)
                {
        ...
        {
            using MemoryStream archiveStream = new MemoryStream();
            TarWriter writer = await CreateTarWriter(archiveStream, async, TarEntryFormat.Ustar, leaveOpen: true);
            try
            {
            ...
            try
            {
                UstarTarEntry regularFile = await GetNextEntry(reader, async) as UstarTarEntry;
        ...
        public async Task WriteHardLink(bool async)
        {
            ...
            try
            {
                UstarTarEntry hardLink = await GetNextEntry(reader, async) as UstarTarEntry;
                VerifyHardLink(hardLink);
            }
            finally
            {
        ...
        public async Task WriteSymbolicLink(bool async)
        {
            ...
            try
            {
                UstarTarEntry symbolicLink = await GetNextEntry(reader, async) as UstarTarEntry;
                VerifySymbolicLink(symbolicLink);
            }
            finally
            {
        ...
        public async Task WriteDirectory(bool async)
        {
            ...
            try
            {
                UstarTarEntry directory = await GetNextEntry(reader, async) as UstarTarEntry;
                VerifyDirectory(directory);
            }
            finally
            {
        ...
        public async Task WriteCharacterDevice(bool async)
        {
            ...
            try
            {
                UstarTarEntry charDevice = await GetNextEntry(reader, async) as UstarTarEntry;
                VerifyCharacterDevice(charDevice);
            }
            finally
            {
        ...
        public async Task WriteBlockDevice(bool async)
        {
            ...
            try
            {
                UstarTarEntry blockDevice = await GetNextEntry(reader, async) as UstarTarEntry;
                VerifyBlockDevice(blockDevice);
            }
            finally
            {
        ...
        public async Task WriteFifo(bool async)
        {
            ...
            try
            {
                UstarTarEntry fifo = await GetNextEntry(reader, async) as UstarTarEntry;
                VerifyFifo(fifo);
            }
            finally
            {
