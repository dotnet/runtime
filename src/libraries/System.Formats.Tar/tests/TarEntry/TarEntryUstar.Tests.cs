...
namespace System.Formats.Tar.Tests
{
    public class UstarTarEntry_Tests : TarTestsBase
    {
        ...
        public void Constructor_ConversionFromV7()
        {
            ...
            UstarTarEntry convertedV7 = new UstarTarEntry(v7);

            Assert.Equal(TarEntryFormat.Ustar, convertedV7.Format);
        ...
        public void Constructor_ConversionFromPax()
        {
            ...
            UstarTarEntry convertedPax = new UstarTarEntry(pax);

            Assert.Equal(TarEntryFormat.Ustar, convertedPax.Format);
        ...
        public void Constructor_ConversionFromGnu()
        {
            ...
            UstarTarEntry convertedGnu = new UstarTarEntry(gnu);

            Assert.Equal(TarEntryFormat.Ustar, convertedGnu.Format);
