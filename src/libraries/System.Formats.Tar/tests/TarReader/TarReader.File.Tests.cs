...
namespace System.Formats.Tar.Tests
{
    public class TarReader_File_Tests : TarTestsBase
    {
        ...
        public void Read_Archive_File(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_RegularFile(file, format, "file.txt", $"Hello {testCaseName}");
        ...
        public void Read_Archive_File_HardLink(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_RegularFile(hardLink, format, "hardlink.txt", $"Hello {testCaseName}");
        ...
        public void Read_Archive_File_SymbolicLink(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_SymbolicLink(symbolicLink, "link.txt", "file.txt");
        ...
        public void Read_Archive_Folder_File(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_Directory(directory, "folder/");

            TarEntry file = reader.GetNextEntry();
            Verify_Archive_RegularFile(file, format, "folder/file.txt", $"Hello {testCaseName}");
        ...
        public void Read_Archive_Folder_File_Utf8(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_Directory(directory, "földër/");

            TarEntry file = reader.GetNextEntry();
            Verify_Archive_RegularFile(file, format, "földër/áöñ.txt", $"Hello {testCaseName}");
        ...
        public void Read_Archive_Folder_Subfolder_File(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_Directory(parent, "parent/");

            TarEntry child = reader.GetNextEntry();
            Verify_Archive_Directory(child, "parent/child/");

            TarEntry file = reader.GetNextEntry();
            Verify_Archive_RegularFile(file, format, "parent/child/file.txt", $"Hello {testCaseName}");
        ...
        public void Read_Archive_FolderSymbolicLink_Folder_Subfolder_File(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_SymbolicLink(childlink, "childlink", "parent/child");
        ...
        public void Read_Archive_LongPath_Splitable_Under255(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_Directory(directory, "00000000001111111111222222222233333333334444444444555555555566666666667777777777888888888899999999/");

            TarEntry file = reader.GetNextEntry();
            Verify_Archive_RegularFile(file, format, $"00000000001111111111222222222233333333334444444444555555555566666666667777777777888888888899999999/00000000001111111111222222222233333333334444444444555555555566666666667777777777888888888899999.txt", $"Hello {testCaseName}");
        ...
        public void Read_Archive_File_LongSymbolicLink(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_Directory(directory, "");

            TarEntry file = reader.GetNextEntry();
            Verify_Archive_RegularFile(file, format, ".txt", $"Hello {testCaseName}");

            TarEntry symbolicLink = reader.GetNextEntry();
            Verify_Archive_SymbolicLink(symbolicLink, "link.txt", ".txt");
        ...
        public void Read_Archive_LongFileName_Over100_Under255(TarFormat format, TestTarFormat testFormat)
        {
            ...
            Verify_Archive_RegularFile(file, format, "000000000011111111112222222222333333333344444444445555555555666666666677777777778888888888999999999900000000001111111111222222222233333333334444444444.txt", $"Hello {testCaseName}");
        ...
        private void Verify_Archive_RegularFile(TarEntry file, TarFormat format, string expectedFileName, string expectedContents)
        {
            Assert.NotNull(file);
            ...
            if (file is PaxTarEntry pax)
            {
                // TODO: Check ext attrs
            }
            else if (file is GnuTarEntry gnu)
            {
        ...
        private void Verify_Archive_SymbolicLink(TarEntry symbolicLink, string expectedFileName, string expectedTargetName)
        {
