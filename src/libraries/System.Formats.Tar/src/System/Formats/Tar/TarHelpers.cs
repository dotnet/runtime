...
namespace System.Formats.Tar
{
    ...
    internal static class TarHelpers
    {
        ...
        // Throws if the specified entry type is not supported for writing in the specified format.
        internal static void VerifyEntryTypeIsSupported(TarEntryType entryType, TarFormat archiveFormat)
        {
