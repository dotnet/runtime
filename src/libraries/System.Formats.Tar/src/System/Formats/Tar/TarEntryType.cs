...
namespace System.Formats.Tar
{
    ...
    public enum TarEntryType : byte
    {
        ...
        /// <para>This entry type is specific to the <see cref="TarEntryFormat.Pax"/> format, represents metadata that affects all subsequent entries, and can be used via the <see cref="PaxGlobalExtendedAttributesTarEntry"/> class.</para>
        /// </summary>
