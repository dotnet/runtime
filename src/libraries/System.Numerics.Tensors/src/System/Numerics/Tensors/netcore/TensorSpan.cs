...
namespace System.Numerics.Tensors
{
    ...
    public readonly ref struct TensorSpan<T>
    {
        ...
        public ref struct DimensionCollection
        {
            ...
            internal DimensionCollection(TensorSpan<T> tensor)
            {
                if (tensor == null)
                {
            ...
            public void Add(TensorSpan<T> item) => ThrowHelper.ThrowNotSupportedDimensionCollectionException();
            ...
            /// <returns></returns>
            public bool Contains(TensorSpan<T> item)
            {
            ...
            public bool Remove(TensorSpan<T> item)
            {
                ThrowHelper.ThrowNotSupportedDimensionCollectionException();
                return false;
            }
            ...
            public ref struct Enumerator
            {
                ...
                public ReadOnlyTensorSpan<T> Current
                {
                    get
                    {
                        TensorSpan<T> toReturn = _tensor.Slice(_curRanges);
                        return new TensorSpan<T>(ref toReturn._reference, toReturn.Lengths.Slice(_dimension), toReturn.Strides.Slice(_dimension), toReturn._shape._memoryLength);
                    }
                }
            }
        }
