    ...
    public static partial class TensorPrimitives
    {
        ...
        private readonly struct SinOperatorSingle : IUnaryOperator<float, float>
        {
            ...
            public static Vector128<float> Invoke(Vector128<float> x)
            {
                ...
                Vector128<float> dn = FusedMultiplyAddOperator<float>.Invoke(uxMasked, Vector128.Create(1 / float.Pi), almHuge);
            ...
            public static Vector256<float> Invoke(Vector256<float> x)
            {
                ...
                Vector256<float> dn = FusedMultiplyAddOperator<float>.Invoke(uxMasked, Vector256.Create(1 / float.Pi), almHuge);
            ...
            public static Vector512<float> Invoke(Vector512<float> x)
            {
                ...
                Vector512<float> dn = FusedMultiplyAddOperator<float>.Invoke(uxMasked, Vector512.Create(1 / float.Pi), almHuge);
        ...
        private readonly struct SinOperatorDouble : IUnaryOperator<double, double>
        {
            ...
            public static Vector128<double> Invoke(Vector128<double> x)
            {
                ...
                Vector128<double> dn = FusedMultiplyAddOperator<double>.Invoke(uxMasked, Vector128.Create(1 / double.Pi), almHuge);
                ...
                f = FusedMultiplyAddOperator<double>.Invoke(dn, Vector128.Create(-Pi_Tail1), f);
                ...
                Vector128<double> a1 = FusedMultiplyAddOperator<double>.Invoke(Vector128.Create(C2), f2, Vector128.Create(C0));
                Vector128<double> a2 = FusedMultiplyAddOperator<double>.Invoke(Vector128.Create(C6), f2, Vector128.Create(C4));
                Vector128<double> a3 = FusedMultiplyAddOperator<double>.Invoke(Vector128.Create(C10), f2, Vector128.Create(C8));
                Vector128<double> a4 = FusedMultiplyAddOperator<double>.Invoke(Vector128.Create(C14), f2, Vector128.Create(C12));
            ...
            public static Vector256<double> Invoke(Vector256<double> x)
            {
                ...
                Vector256<double> dn = FusedMultiplyAddOperator<double>.Invoke(uxMasked, Vector256.Create(1 / double.Pi), almHuge);
                ...
                f = FusedMultiplyAddOperator<double>.Invoke(dn, Vector256.Create(-Pi_Tail1), f);
                ...
                Vector256<double> a1 = FusedMultiplyAddOperator<double>.Invoke(Vector256.Create(C2), f2, Vector256.Create(C0));
                Vector256<double> a2 = FusedMultiplyAddOperator<double>.Invoke(Vector256.Create(C6), f2, Vector256.Create(C4));
                Vector256<double> a3 = FusedMultiplyAddOperator<double>.Invoke(Vector256.Create(C10), f2, Vector256.Create(C8));
                Vector256<double> a4 = FusedMultiplyAddOperator<double>.Invoke(Vector256.Create(C14), f2, Vector256.Create(C12));
            ...
            public static Vector512<double> Invoke(Vector512<double> x)
            {
                ...
                Vector512<double> dn = FusedMultiplyAddOperator<double>.Invoke(uxMasked, Vector512.Create(1 / double.Pi), almHuge);
                ...
                f = FusedMultiplyAddOperator<double>.Invoke(dn, Vector512.Create(-Pi_Tail1), f);
                ...
                Vector512<double> a1 = FusedMultiplyAddOperator<double>.Invoke(Vector512.Create(C2), f2, Vector512.Create(C0));
                Vector512<double> a2 = FusedMultiplyAddOperator<double>.Invoke(Vector512.Create(C6), f2, Vector512.Create(C4));
                Vector512<double> a3 = FusedMultiplyAddOperator<double>.Invoke(Vector512.Create(C10), f2, Vector512.Create(C8));
                Vector512<double> a4 = FusedMultiplyAddOperator<double>.Invoke(Vector512.Create(C14), f2, Vector512.Create(C12));
