...
namespace System.Numerics.Tensors
{
    ...
    public static partial class Tensor
    {
        ...
        /// <param name="lengths"><see cref="ReadOnlySpan{T}"/> with the new dimensions.</param>
        public static TensorSpan<T> Reshape<T>(scoped in TensorSpan<T> tensor, scoped ReadOnlySpan<nint> lengths)
        {
            if (tensor.Lengths.SequenceEqual(lengths))
                return tensor;
        ...
        /// <param name="tensor"><see cref="TensorSpan{T}"/> you want to reshape.</param>
        /// <param name="lengths"><see cref="ReadOnlySpan{T}"/> with the new dimensions.</param>
        public static ReadOnlyTensorSpan<T> Reshape<T>(scoped in ReadOnlyTensorSpan<T> tensor, scoped ReadOnlySpan<nint> lengths)
        {
            if (tensor.Lengths.SequenceEqual(lengths))
                return tensor;
        ...
        public static TensorSpan<T> Squeeze<T>(scoped in TensorSpan<T> tensor)
        {
            return SqueezeDimension(tensor, -1);
        }
        ...
        /// <param name="dimension">The dimension to remove.</param>
        public static TensorSpan<T> SqueezeDimension<T>(scoped in TensorSpan<T> tensor, int dimension)
        {
            if (dimension >= tensor.Rank || dimension < -1)
                ThrowHelper.ThrowArgument_AxisLargerThanRank();
        ...
        public static ReadOnlyTensorSpan<T> Squeeze<T>(scoped in ReadOnlyTensorSpan<T> tensor)
        {
            return SqueezeDimension(tensor, -1);
        }
        ...
        /// <param name="dimension">The dimension to remove.</param>
        public static ReadOnlyTensorSpan<T> SqueezeDimension<T>(scoped in ReadOnlyTensorSpan<T> tensor, int dimension)
        {
            if (dimension >= tensor.Rank || dimension < -1)
                ThrowHelper.ThrowArgument_AxisLargerThanRank();
        ...
        /// <param name="dimension">The index of the dimension to add.</param>
        public static TensorSpan<T> Unsqueeze<T>(scoped in TensorSpan<T> tensor, int dimension)
        {
            if (dimension > tensor.Lengths.Length)
                ThrowHelper.ThrowArgument_AxisLargerThanRank();
            if (dimension < 0)
        ...
        /// <param name="dimension">The index of the dimension to add.</param>
        public static ReadOnlyTensorSpan<T> Unsqueeze<T>(scoped in ReadOnlyTensorSpan<T> tensor, int dimension)
        {
            if (dimension > tensor.Lengths.Length)
                ThrowHelper.ThrowArgument_AxisLargerThanRank();
            if (dimension < 0)
