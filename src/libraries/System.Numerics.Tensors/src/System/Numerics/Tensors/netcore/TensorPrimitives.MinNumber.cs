        ...
        internal readonly struct MinNumberOperator<T> : IAggregationOperator<T> where T : INumber<T>
        {
            ...
            public static Vector128<T> Invoke(Vector128<T> x, Vector128<T> y)
            {
                if (AdvSimd.IsSupported)
                {
                    ...
                    if (typeof(T) == typeof(float)) return AdvSimd.MinNumber(x.AsSingle(), y.AsSingle()).As<float, T>();
                }

                if (AdvSimd.Arm64.IsSupported)
                {
                    if (typeof(T) == typeof(double)) return AdvSimd.Arm64.MinNumber(x.AsDouble(), y.AsDouble()).As<double, T>();
                }
                ...
                if (typeof(T) == typeof(float))
                {
                    return
                        Vector128.ConditionalSelect(Vector128.Equals(x, y),
                            Vector128.ConditionalSelect(IsNegative(x.AsSingle()).As<float, T>(), x, y),
                            Vector128.ConditionalSelect(Vector128.Equals(y.AsSingle(), y.AsSingle()).As<float, T>(), Vector128.Min(x, y), x));
                }
                ...
                if (typeof(T) == typeof(double))
                {
                    return
                        Vector128.ConditionalSelect(Vector128.Equals(x, y),
                            Vector128.ConditionalSelect(IsNegative(x.AsDouble()).As<double, T>(), x, y),
                            Vector128.ConditionalSelect(Vector128.Equals(y.AsDouble(), y.AsDouble()).As<double, T>(), Vector128.Min(x, y), x));
                }
            ...
            public static Vector256<T> Invoke(Vector256<T> x, Vector256<T> y)
            {
                if (typeof(T) == typeof(float))
                {
                    return
                        Vector256.ConditionalSelect(Vector256.Equals(x, y),
                            Vector256.ConditionalSelect(IsNegative(x.AsSingle()).As<float, T>(), x, y),
                            Vector256.ConditionalSelect(Vector256.Equals(y.AsSingle(), y.AsSingle()).As<float, T>(), Vector256.Min(x, y), x));
                }
                ...
                if (typeof(T) == typeof(double))
                {
                    return
                        Vector256.ConditionalSelect(Vector256.Equals(x, y),
                            Vector256.ConditionalSelect(IsNegative(x.AsDouble()).As<double, T>(), x, y),
                            Vector256.ConditionalSelect(Vector256.Equals(y.AsDouble(), y.AsDouble()).As<double, T>(), Vector256.Min(x, y), x));
                }
            ...
            public static Vector512<T> Invoke(Vector512<T> x, Vector512<T> y)
            {
                if (typeof(T) == typeof(float))
                {
                    return
                        Vector512.ConditionalSelect(Vector512.Equals(x, y),
                            Vector512.ConditionalSelect(IsNegative(x.AsSingle()).As<float, T>(), x, y),
                            Vector512.ConditionalSelect(Vector512.Equals(y.AsSingle(), y.AsSingle()).As<float, T>(), Vector512.Min(x, y), x));
                }
                ...
                if (typeof(T) == typeof(double))
                {
                    return
                        Vector512.ConditionalSelect(Vector512.Equals(x, y),
                            Vector512.ConditionalSelect(IsNegative(x.AsDouble()).As<double, T>(), x, y),
                            Vector512.ConditionalSelect(Vector512.Equals(y.AsDouble(), y.AsDouble()).As<double, T>(), Vector512.Min(x, y), x));
                }
