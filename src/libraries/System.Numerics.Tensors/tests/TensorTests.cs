...
namespace System.Numerics.Tensors.Tests
{
    public class TensorTests
    {
        ...
        public static void TensorSequenceEqualTests()
        {
            ...
            Assert.Equal([3], equal.Shape.ToArray());
            Assert.True(equal[0]);
            Assert.True(equal[1]);
            Assert.True(equal[2]);
            ...
            Assert.Equal([1, 3], equal.Shape.ToArray());
            ...
            Assert.Equal([1, 1, 3], equal.Shape.ToArray());
            ...
            Assert.Equal([3, 3], equal.Shape.ToArray());
            Assert.True(equal[0, 0]);
        ...
        public static void TensorMultiplyTests()
        {
            ...
            Assert.Equal([3,3], t2.Shape.ToArray());
        ...
        public static void TensorBroadcastTests()
        {
            ...
            Assert.Equal([1, 3, 1, 2, 1], t1.Shape.ToArray());
            ...
            Assert.Equal([1, 3, 2, 1, 1], t1.Shape.ToArray());
            ...
            var t3 = t2.Slice(0..1, ..);
            Assert.Equal([1, 3], t3.Shape.ToArray());
        ...
        public static void TensorResizeTests()
        {
            ...
            Assert.Equal([1], t1.Shape.ToArray());
            Assert.Equal(0, t1[0]);

            t1 = Tensor.Resize(t0, [1, 1]);
            Assert.Equal([1, 1], t1.Shape.ToArray());
            Assert.Equal(0, t1[0, 0]);

            t1 = Tensor.Resize(t0, [6]);
            Assert.Equal([6], t1.Shape.ToArray());
            Assert.Equal(0, t1[0]);
            Assert.Equal(1, t1[1]);
            Assert.Equal(2, t1[2]);
            Assert.Equal(3, t1[3]);
            ...
            Assert.Equal([10], t1.Shape.ToArray());
            Assert.Equal(0, t1[0]);
            Assert.Equal(1, t1[1]);
            Assert.Equal(2, t1[2]);
            Assert.Equal(3, t1[3]);
            ...
            Assert.Equal([2, 5], t1.Shape.ToArray());
            Assert.Equal(0, t1[0, 0]);
        ...
        public static void TensorSplitTests()
        {
            ...
            Assert.Equal([1, 2, 2], t1[0].Shape.ToArray());
            Assert.Equal([1, 2, 2], t1[1].Shape.ToArray());
            ...
            Assert.Equal([2, 1, 2], t1[0].Shape.ToArray());
            Assert.Equal([2, 1, 2], t1[1].Shape.ToArray());
            Assert.Equal(0, t1[0][0, 0, 0]);
            Assert.Equal(1, t1[0][0, 0, 1]);
            ...
            Assert.Equal([2, 2, 1], t1[0].Shape.ToArray());
            Assert.Equal([2, 2, 1], t1[1].Shape.ToArray());
            Assert.Equal(0, t1[0][0, 0, 0]);
            Assert.Equal(2, t1[0][0, 1, 0]);
            Assert.Equal(4, t1[0][1, 0, 0]);
        ...
        public static void TensorStackTests()
        {
            ...
            Assert.Equal(2, resultTensor.Shape[0]);
            Assert.Equal(2, resultTensor.Shape[1]);
            Assert.Equal(5, resultTensor.Shape[2]);
            ...
            Assert.Equal(3, resultTensor.Rank);
            Assert.Equal(2, resultTensor.Shape[0]);
            Assert.Equal(5, resultTensor.Shape[1]);
            Assert.Equal(2, resultTensor.Shape[2]);
        ...
        public static void TensorConcatenateTests()
        {
            ...
            Assert.Equal(4, resultTensor.Shape[0]);
            Assert.Equal(2, resultTensor.Shape[1]);
            ...
            Assert.Equal(2, resultTensor.Rank);
            Assert.Equal(2, resultTensor.Shape[0]);
            Assert.Equal(4, resultTensor.Shape[1]);
            Assert.Equal(0, resultTensor[0, 0]);
            Assert.Equal(1, resultTensor[0, 1]);
            ...
            Assert.Equal(8, resultTensor.Shape[0]);
            ...
            Assert.Equal(2, resultTensor.Rank);
            Assert.Equal(6, resultTensor.Shape[0]);
            Assert.Equal(2, resultTensor.Shape[1]);
            Assert.Equal(0, resultTensor[0, 0]);
            Assert.Equal(1, resultTensor[0, 1]);
            Assert.Equal(2, resultTensor[1, 0]);
            ...
            Assert.Equal(1, resultTensor.Rank);
            Assert.Equal(12, resultTensor.Shape[0]);
            Assert.Equal(0, resultTensor[0]);
            Assert.Equal(1, resultTensor[1]);
            Assert.Equal(2, resultTensor[2]);
            Assert.Equal(3, resultTensor[3]);
            ...
            Assert.Equal(2, resultTensor.Rank);
            Assert.Equal(2, resultTensor.Shape[0]);
            Assert.Equal(6, resultTensor.Shape[1]);
            Assert.Equal(0, resultTensor[0, 0]);
            Assert.Equal(1, resultTensor[0, 1]);
            Assert.Equal(0, resultTensor[0, 2]);
            Assert.Equal(1, resultTensor[0, 3]);
            ...
            Assert.Equal(1, resultTensor.Rank);
            Assert.Equal(32, resultTensor.Shape[0]);
            ...
            Assert.Equal(3, resultTensor.Rank);
            Assert.Equal(2, resultTensor.Shape[0]);
            Assert.Equal(8, resultTensor.Shape[1]);
            Assert.Equal(2, resultTensor.Shape[2]);
            Assert.Equal(result, resultTensor.ToArray());
            ...
            for(int i  = 0; i < result.Length; i++)
            {
                ...
                Helpers.AdjustIndices(resultTensor.Rank - 1, 1, ref indices, resultTensor.Shape);
            }
            ...
            Assert.Equal(2, resultTensor.Shape[0]);
            Assert.Equal(2, resultTensor.Shape[1]);
            Assert.Equal(8, resultTensor.Shape[2]);
            Assert.Equal(result, resultTensor.ToArray());
        ...
        public static void TensorTransposeTests()
        {
            ...
            Assert.Equal(3, t1.Shape[0]);
            Assert.Equal(2, t1.Shape[1]);
            Assert.Equal(0, t1[0, 0]);
            ...
            Assert.Equal(2, t1.Shape[0]);
            Assert.Equal(3, t1.Shape[1]);
            Assert.Equal(2, t1.Shape[2]);
            Assert.Equal(0, t1[0, 0, 0]);
            Assert.Equal(6, t1[0, 0, 1]);
