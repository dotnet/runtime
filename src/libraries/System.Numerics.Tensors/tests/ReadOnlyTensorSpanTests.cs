...
namespace System.Numerics.Tensors.Tests
{
    public class ReadOnlyTensorSpanTests
    {
        ...
        [Fact]
        public static void ReadOnlyTensorSpanDimensionsTest()
        {
            scoped Span<int> values = [1, 2, 3, 4, 5, 6];
            scoped Span<int> ints = new int[3];
            var tensor = new ReadOnlyTensorSpan<int>(new int[] { 1, 2, 3, 4, 5, 6 }, new nint[] { 2, 3 }, default);
            ...
            ints = new int[4];
            tensor = new ReadOnlyTensorSpan<int>(new int[] { 1, 2, 3, 4, 5, 6, 7, 8 }, new nint[] { 2, 2, 2 }, default);
            ...
            {
                ReadOnlyTensorSpan<int> tensor = new ReadOnlyTensorSpan<int>(new int[] { 1, 2, 3, 4, 5, 6, 7, 8 }, new nint[] { 2, 2, 2 }, default);
