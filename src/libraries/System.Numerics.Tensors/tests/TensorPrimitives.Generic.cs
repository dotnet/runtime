...
namespace System.Numerics.Tensors.Tests
{
        ...
        where T : unmanaged, IFloatingPointIeee754<T>, IMinMaxValue<T>
    {
        ...
        public static IEnumerable<object[]> SpanDestinationFunctionsToTest()
        {
            ...
            yield return Create(TensorPrimitives.Acosh, T.Acosh, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.AcosPi, T.AcosPi, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.Acos, T.Acos, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.Asinh, T.Asinh, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.AsinPi, T.AsinPi, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.Asin, T.Asin, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.Atanh, T.Atanh, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.AtanPi, T.AtanPi, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.Atan, T.Atan, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-7, floatTolerance: 1e-5f));
...
#pragma warning restore xUnit1026
        ...
        {
            yield return Create(TensorPrimitives.Atan2, T.Atan2, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-9, floatTolerance: 1e-5f));
            yield return Create(TensorPrimitives.Atan2Pi, T.Atan2Pi, Helpers.DetermineTolerance<T>(doubleTolerance: 1e-9, floatTolerance: 1e-5f));
