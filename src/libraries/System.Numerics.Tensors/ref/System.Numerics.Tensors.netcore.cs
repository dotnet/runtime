...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
    ...
    public static partial class Tensor
    {
        ...
        public static System.Numerics.Tensors.Tensor<T> CreateAndFillGaussianNormalDistribution<T>(System.Random random, scoped System.ReadOnlySpan<nint> lengths) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.Tensor<T> CreateAndFillGaussianNormalDistribution<T>(scoped System.ReadOnlySpan<nint> lengths) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.Tensor<T> CreateAndFillUniformDistribution<T>(System.Random random, scoped System.ReadOnlySpan<nint> lengths) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.Tensor<T> CreateAndFillUniformDistribution<T>(scoped System.ReadOnlySpan<nint> lengths) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T> Create<T>(System.Collections.Generic.IEnumerable<T> enumerable, bool pinned = false) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Create<T>(System.Collections.Generic.IEnumerable<T> enumerable, scoped System.ReadOnlySpan<nint> lengths, bool pinned = false) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Create<T>(System.Collections.Generic.IEnumerable<T> enumerable, scoped System.ReadOnlySpan<nint> lengths, scoped System.ReadOnlySpan<nint> strides, bool pinned = false) { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T> PermuteDimensions<T>(this System.Numerics.Tensors.Tensor<T> tensor, scoped System.ReadOnlySpan<int> dimensions) { throw null; }
        ...
        public static System.Numerics.Tensors.ReadOnlyTensorSpan<T> Reshape<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> tensor, scoped System.ReadOnlySpan<nint> lengths) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Reshape<T>(scoped in System.Numerics.Tensors.TensorSpan<T> tensor, scoped System.ReadOnlySpan<nint> lengths) { throw null; }
        ...
        public static System.Numerics.Tensors.ReadOnlyTensorSpan<T> SqueezeDimension<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> tensor, int dimension) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SqueezeDimension<T>(scoped in System.Numerics.Tensors.TensorSpan<T> tensor, int dimension) { throw null; }
        ...
        public static System.Numerics.Tensors.ReadOnlyTensorSpan<T> Squeeze<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> tensor) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Squeeze<T>(scoped in System.Numerics.Tensors.TensorSpan<T> tensor) { throw null; }
        ...
        public static string ToString<T>(this in System.Numerics.Tensors.ReadOnlyTensorSpan<T> tensor, scoped System.ReadOnlySpan<nint> maximumLengths) { throw null; }
        public static string ToString<T>(this in System.Numerics.Tensors.TensorSpan<T> tensor, scoped System.ReadOnlySpan<nint> maximumLengths) { throw null; }
        public static string ToString<T>(this System.Numerics.Tensors.Tensor<T> tensor, scoped System.ReadOnlySpan<nint> maximumLengths) { throw null; }
        ...
        public static System.Numerics.Tensors.ReadOnlyTensorSpan<T> Unsqueeze<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> tensor, int dimension) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Unsqueeze<T>(scoped in System.Numerics.Tensors.TensorSpan<T> tensor, int dimension) { throw null; }
...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
        ...
        public static implicit operator System.Numerics.Tensors.ReadOnlyTensorSpan<T> (System.Numerics.Tensors.TensorSpan<T> tensor) { throw null; }
