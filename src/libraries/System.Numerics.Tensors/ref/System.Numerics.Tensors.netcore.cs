...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
    ...
    {
        public static System.Numerics.Tensors.TensorSpan<T> AbsInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.INumberBase<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Abs<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.INumberBase<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AcoshInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Acosh<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AcosInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AcosPiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AcosPi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Acos<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AddInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IAdditionOperators<T, T, T>, System.Numerics.IAdditiveIdentity<T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AddInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, T val) where T : System.Numerics.IAdditionOperators<T, T, T>, System.Numerics.IAdditiveIdentity<T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Add<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, T val, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IAdditionOperators<T, T, T>, System.Numerics.IAdditiveIdentity<T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AsinhInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Asinh<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AsinInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AsinPiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AsinPi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Asin<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Atan2InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IFloatingPointIeee754<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Atan2PiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IFloatingPointIeee754<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Atan2Pi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPointIeee754<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Atan2<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPointIeee754<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AtanhInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Atanh<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> AtanInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AtanPiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> AtanPi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Atan<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> BitwiseAndInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> BitwiseAnd<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> BitwiseOrInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> BitwiseOr<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Broadcast<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Broadcast<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Broadcast<T>(System.Numerics.Tensors.Tensor<T> left, System.Numerics.Tensors.Tensor<T> right) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Broadcast<T>(System.Numerics.Tensors.Tensor<T> input, System.ReadOnlySpan<nint> shape) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> CbrtInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IRootFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Cbrt<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IRootFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> CeilingInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Ceiling<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T> Concatenate<T>(System.ReadOnlySpan<System.Numerics.Tensors.Tensor<T>> tensors, int axis = 0) { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> CopySignInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> sign) where T : System.Numerics.INumber<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> CopySignInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, T sign) where T : System.Numerics.INumber<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> CopySign<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> sign, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.INumber<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> CopySign<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, T sign, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.INumber<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> CoshInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Cosh<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> CosineSimilarity<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IRootFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> CosInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> CosPiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> CosPi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Cos<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T> CreateFromEnumerable<T>(System.Collections.Generic.IEnumerable<T> data) { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> DegreesToRadiansInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> DegreesToRadians<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> DivideInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IDivisionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> DivideInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, T val) where T : System.Numerics.IDivisionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> DivideInPlace<T>(T val, in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IDivisionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Divide<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IDivisionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Divide<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, T val, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IDivisionOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Divide<T>(T val, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IDivisionOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Exp10InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Exp10M1InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Exp10M1<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Exp10<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Exp2InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Exp2M1InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Exp2M1<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Exp2<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> ExpInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> ExpM1InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> ExpM1<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Exp<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T> FilteredUpdate<T>(System.Numerics.Tensors.Tensor<T> tensor, System.Numerics.Tensors.Tensor<bool> filter, System.Numerics.Tensors.Tensor<T> values) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> FilteredUpdate<T>(System.Numerics.Tensors.Tensor<T> tensor, System.Numerics.Tensors.Tensor<bool> filter, T value) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> FloorInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Floor<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> HypotInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IRootFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Hypot<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IRootFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Ieee754RemainderInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IFloatingPointIeee754<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<int> ILogB<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<int> destination) where T : System.Numerics.IFloatingPointIeee754<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> LeadingZeroCountInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IBinaryInteger<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> LeadingZeroCount<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBinaryInteger<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Log10InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Log10P1InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Log10P1<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Log10<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Log2InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Log2P1InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Log2P1<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Log2<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> LogInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> LogP1InPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> LogP1<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Log<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ILogarithmicFunctions<T> { throw null; }
        ...
        public static T Mean<T>(System.Numerics.Tensors.Tensor<T> input) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> MultiplyInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IMultiplyOperators<T, T, T>, System.Numerics.IMultiplicativeIdentity<T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> MultiplyInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, T val) where T : System.Numerics.IMultiplyOperators<T, T, T>, System.Numerics.IMultiplicativeIdentity<T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Multiply<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IMultiplyOperators<T, T, T>, System.Numerics.IMultiplicativeIdentity<T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Multiply<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, T val, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IMultiplyOperators<T, T, T>, System.Numerics.IMultiplicativeIdentity<T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> NegateInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IUnaryNegationOperators<T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Negate<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IUnaryNegationOperators<T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> OnesComplementInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> OnesComplement<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T> Permute<T>(System.Numerics.Tensors.Tensor<T> input, params scoped System.ReadOnlySpan<int> axis) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> PopCountInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IBinaryInteger<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> PopCount<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBinaryInteger<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> PowInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IPowerFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Pow<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IPowerFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> RadiansToDegreesInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> RadiansToDegrees<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> ReciprocalInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Reciprocal<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Resize<T>(scoped in System.Numerics.Tensors.TensorSpan<T> input, System.ReadOnlySpan<nint> shape) { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> ReverseInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, nint axis = -1) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Reverse<T>(in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, nint axis = -1) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Reverse<T>(System.Numerics.Tensors.Tensor<T> input, nint axis = -1) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> RoundInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Round<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<bool> SequenceEqual<T>(System.Numerics.Tensors.Tensor<T> left, System.Numerics.Tensors.Tensor<T> right) where T : System.Numerics.IEqualityOperators<T, T, bool> { throw null; }
        public static System.Numerics.Tensors.Tensor<T> SetSlice<T>(this System.Numerics.Tensors.Tensor<T> tensor, System.Numerics.Tensors.Tensor<T> values, params scoped System.ReadOnlySpan<System.Buffers.NRange> ranges) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SigmoidInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Sigmoid<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> SinhInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Sinh<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> SinInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SinPiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SinPi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Sin<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> SoftMaxInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SoftMax<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IExponentialFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.Tensor<T>[] Split<T>(System.Numerics.Tensors.Tensor<T> input, nint numSplits, nint axis) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SqrtInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IRootFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Sqrt<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IRootFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Squeeze<T>(in System.Numerics.Tensors.TensorSpan<T> input, int axis = -1) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Squeeze<T>(System.Numerics.Tensors.Tensor<T> input, int axis = -1) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Stack<T>(System.Numerics.Tensors.Tensor<T>[] input, int axis = 0) { throw null; }
        ...
        public static T StdDev<T>(System.Numerics.Tensors.Tensor<T> input) where T : System.Numerics.IFloatingPoint<T>, System.Numerics.IPowerFunctions<T>, System.Numerics.IAdditionOperators<T, T, T>, System.Numerics.IAdditiveIdentity<T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SubtractInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.ISubtractionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SubtractInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input, T val) where T : System.Numerics.ISubtractionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> SubtractInPlace<T>(T val, in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ISubtractionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Subtract<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ISubtractionOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Subtract<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, T val, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ISubtractionOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Subtract<T>(T val, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ISubtractionOperators<T, T, T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> TanhInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Tanh<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IHyperbolicFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> TanInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> TanPiInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> TanPi<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> Tan<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.ITrigonometricFunctions<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> TrailingZeroCountInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IBinaryInteger<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> TrailingZeroCount<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBinaryInteger<T> { throw null; }
        ...
        public static System.Numerics.Tensors.TensorSpan<T> TruncateInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> input) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Truncate<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> input, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IFloatingPoint<T> { throw null; }
        ...
        public static bool TryBroadcastTo<T>(System.Numerics.Tensors.Tensor<T> left, System.Numerics.Tensors.Tensor<T> right, out System.Numerics.Tensors.Tensor<T> destination) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> TryBroadcastTo<T>(System.Numerics.Tensors.Tensor<T> input, System.ReadOnlySpan<nint> shape) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Unsqueeze<T>(in System.Numerics.Tensors.TensorSpan<T> input, int axis) { throw null; }
        public static System.Numerics.Tensors.Tensor<T> Unsqueeze<T>(System.Numerics.Tensors.Tensor<T> input, int axis) { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> XorInPlace<T>(in System.Numerics.Tensors.TensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
        public static System.Numerics.Tensors.TensorSpan<T> Xor<T>(scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> left, scoped in System.Numerics.Tensors.ReadOnlyTensorSpan<T> right, in System.Numerics.Tensors.TensorSpan<T> destination) where T : System.Numerics.IBitwiseOperators<T, T, T> { throw null; }
