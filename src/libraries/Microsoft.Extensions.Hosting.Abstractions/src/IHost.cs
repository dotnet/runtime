...
namespace Microsoft.Extensions.Hosting
{
    ...
    {
        /// <summary>
        /// Gets the services configured for the program (for example, using <see cref="HostBuilder.ConfigureServices(System.Action{HostBuilderContext, Microsoft.Extensions.DependencyInjectionIServiceCollection})" />).
        /// </summary>
