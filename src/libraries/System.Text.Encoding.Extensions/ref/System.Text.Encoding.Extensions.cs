...
namespace System.Text
{
    ...
    {
        [System.ObsoleteAttribute("The UTF-7 encoding is insecure and should not be used. Consider using UTF-8 instead.", DiagnosticId = "BCL0001", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
        public UTF7Encoding() { }
        [System.ObsoleteAttribute("The UTF-7 encoding is insecure and should not be used. Consider using UTF-8 instead.", DiagnosticId = "BCL0001", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
