...
namespace System.Net
{
    ...
    internal interface ISSPIInterface
    {
        ...
        int AcquireCredentialsHandle(string moduleName, Interop.SspiCli.CredentialUse usage, ref Interop.SspiCli.SCH_CREDENTIALS authdata, out SafeFreeCredentials outCredential);
