...
internal static partial class Interop
{
    internal static partial class Globalization
    {
        ...
        internal static partial ResultCode GetCalendarInfo(string localeName, CalendarId calendarId, CalendarDataType calendarDataType, char* result, int resultCapacity);
