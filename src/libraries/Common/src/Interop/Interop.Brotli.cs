...
internal static partial class Interop
{
    internal static partial class Brotli
    {
        ...
        [LibraryImport(Libraries.CompressionNative)]
        internal static partial int BrotliDecoderDecompressStream(
            SafeBrotliDecoderHandle state, ref nuint availableIn, byte** nextIn,
            ref nuint availableOut, byte** nextOut, out nuint totalOut);

        [LibraryImport(Libraries.CompressionNative)]
        internal static partial BOOL BrotliDecoderDecompress(nuint availableInput, byte* inBytes, nuint* availableOutput, byte* outBytes);
        ...
        [LibraryImport(Libraries.CompressionNative)]
        internal static partial BOOL BrotliEncoderCompressStream(
        ...
        [LibraryImport(Libraries.CompressionNative)]
        internal static partial BOOL BrotliEncoderCompress(int quality, int window, int v, nuint availableInput, byte* inBytes, nuint* availableOutput, byte* outBytes);
    }
}
