...
internal static partial class Interop
{
    internal static partial class Sys
    {
        ...
        internal static partial void GetNonCryptographicallySecureRandomBytes(byte* buffer, int length);

        [LibraryImport(Interop.Libraries.SystemNative, EntryPoint = "SystemNative_GetCryptographicallySecureRandomBytes")]
        internal static partial int GetCryptographicallySecureRandomBytes(byte* buffer, int length);
    }
