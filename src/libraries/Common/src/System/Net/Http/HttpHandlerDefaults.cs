...
namespace System.Net.Http
{
    ...
    internal static partial class HttpHandlerDefaults
    {
        ...
        public static TimeSpan DefaultResponseDrainTimeout => TimeSpan.FromTicks(TimeSpan.TicksPerSecond * 2);
        ...
        public static TimeSpan DefaultPooledConnectionIdleTimeout => TimeSpan.FromTicks(TimeSpan.TicksPerMinute * 2);
        public static TimeSpan DefaultExpect100ContinueTimeout => TimeSpan.FromTicks(TimeSpan.TicksPerSecond * 1);
