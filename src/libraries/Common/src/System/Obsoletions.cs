...
namespace System
{
    internal static class Obsoletions
    {
        ...
        internal const string EncryptionPolicyMessage = "EncryptionPolicy.NoEncryption and AllowEncryption circumvent security and should not be used in production code.";
