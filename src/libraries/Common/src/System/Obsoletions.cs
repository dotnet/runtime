...
namespace System
{
    internal static class Obsoletions
    {
        ...
        internal const string SystemEventsEventsThreadShutdownMessage = "Callbacks are not guaranteed to run before process exits. Use AppDomain.ProcessExit instead.";
