...
namespace System.Security.Cryptography.X509Certificates.Asn1
{
    ...
    internal partial struct NameConstraintsAsn
    {
        ...
        internal static void Decode(ref ValueAsnReader reader, ReadOnlyMemory<byte> rebind, out NameConstraintsAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, rebind, out decoded);
        }

        internal static void Decode(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out NameConstraintsAsn decoded)
        {
            try
            {
        ...
        private static void DecodeCore(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out NameConstraintsAsn decoded)
        {
            decoded = default;
    ...
    {
        internal ReadOnlySpan<byte> PermittedSubtrees;
        internal bool HasPermittedSubtrees;
        internal ReadOnlySpan<byte> ExcludedSubtrees;
        internal bool HasExcludedSubtrees;

        internal static void Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueNameConstraintsAsn decoded)
        {
            Decode(Asn1Tag.Sequence, encoded, ruleSet, out decoded);
        }

        internal static void Decode(Asn1Tag expectedTag, ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueNameConstraintsAsn decoded)
        {
            try
            {
        ...
        internal static void Decode(scoped ref ValueAsnReader reader, out ValueNameConstraintsAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, out decoded);
        }

        internal static void Decode(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueNameConstraintsAsn decoded)
        {
            try
            {
                DecodeCore(ref reader, expectedTag, out decoded);
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueNameConstraintsAsn decoded)
        {
            decoded = default;
            ValueAsnReader sequenceReader = reader.ReadSequence(expectedTag);
            ...
            if (sequenceReader.HasData && sequenceReader.PeekTag().HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 0)))
            {
                decoded.PermittedSubtrees = sequenceReader.ReadEncodedValue();
                decoded.HasPermittedSubtrees = true;
            }


            if (sequenceReader.HasData && sequenceReader.PeekTag().HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 1)))
            {
                decoded.ExcludedSubtrees = sequenceReader.ReadEncodedValue();
                decoded.HasExcludedSubtrees = true;
            }
