...
namespace System.Security.Cryptography.Asn1.Pkcs7
{
    ...
    internal partial struct SignedDataAsn
    {
        ...
        internal static void Decode(ref ValueAsnReader reader, ReadOnlyMemory<byte> rebind, out SignedDataAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, rebind, out decoded);
        }

        internal static void Decode(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out SignedDataAsn decoded)
        {
            try
            {
        ...
        private static void DecodeCore(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out SignedDataAsn decoded)
        {
            decoded = default;
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal ref partial struct ValueSignedDataAsn
    {
        internal int Version;
        internal ReadOnlySpan<byte> DigestAlgorithms;
        internal ReadOnlySpan<byte> EncapContentInfo;
        internal ReadOnlySpan<byte> CertificateSet;
        internal bool HasCertificateSet;
        internal ReadOnlySpan<byte> Crls;
        internal bool HasCrls;
        internal ReadOnlySpan<byte> SignerInfos;

        internal static void Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueSignedDataAsn decoded)
        {
            Decode(Asn1Tag.Sequence, encoded, ruleSet, out decoded);
        }

        internal static void Decode(Asn1Tag expectedTag, ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueSignedDataAsn decoded)
        {
            try
            {
        ...
        internal static void Decode(scoped ref ValueAsnReader reader, out ValueSignedDataAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, out decoded);
        }

        internal static void Decode(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueSignedDataAsn decoded)
        {
            try
            {
                DecodeCore(ref reader, expectedTag, out decoded);
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueSignedDataAsn decoded)
        {
            decoded = default;
            ValueAsnReader sequenceReader = reader.ReadSequence(expectedTag);
            ...
            decoded.DigestAlgorithms = sequenceReader.ReadEncodedValue();
            decoded.EncapContentInfo = sequenceReader.ReadEncodedValue();
            ...
            if (sequenceReader.HasData && sequenceReader.PeekTag().HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 1)))
            {
                decoded.Crls = sequenceReader.ReadEncodedValue();
                decoded.HasCrls = true;
            }

            decoded.SignerInfos = sequenceReader.ReadEncodedValue();
