...
namespace System.Security.Cryptography.Asn1.Pkcs7
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal ref partial struct ValueSignerIdentifierAsn
    {
        ...
        internal static void Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueSignerIdentifierAsn decoded)
        {
            try
            {
        ...
        internal static void Decode(scoped ref ValueAsnReader reader, out ValueSignerIdentifierAsn decoded)
        {
            try
            {
                DecodeCore(ref reader, out decoded);
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, out ValueSignerIdentifierAsn decoded)
        {
            decoded = default;
            Asn1Tag tag = reader.PeekTag();
            ReadOnlySpan<byte> tmpSpan;
