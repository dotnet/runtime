...
namespace System.Security.Cryptography.Asn1.Pkcs7
{
    ...
    internal partial struct SignerInfoAsn
    {
        ...
        internal static void Decode(ref ValueAsnReader reader, ReadOnlyMemory<byte> rebind, out SignerInfoAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, rebind, out decoded);
        }

        internal static void Decode(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out SignerInfoAsn decoded)
        {
            try
            {
        ...
        private static void DecodeCore(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out SignerInfoAsn decoded)
        {
            decoded = default;
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal ref partial struct ValueSignerInfoAsn
    {
        internal int Version;
        internal ReadOnlySpan<byte> Sid;
        internal ReadOnlySpan<byte> DigestAlgorithm;
        internal ReadOnlySpan<byte> SignedAttributes;
        internal bool HasSignedAttributes;
        internal ReadOnlySpan<byte> SignatureAlgorithm;
        internal ReadOnlySpan<byte> SignatureValue;
        internal ReadOnlySpan<byte> UnsignedAttributes;
        internal bool HasUnsignedAttributes;

        internal static void Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueSignerInfoAsn decoded)
        {
            Decode(Asn1Tag.Sequence, encoded, ruleSet, out decoded);
        }

        internal static void Decode(Asn1Tag expectedTag, ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueSignerInfoAsn decoded)
        {
            try
            {
        ...
        internal static void Decode(scoped ref ValueAsnReader reader, out ValueSignerInfoAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, out decoded);
        }

        internal static void Decode(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueSignerInfoAsn decoded)
        {
            try
            {
                DecodeCore(ref reader, expectedTag, out decoded);
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueSignerInfoAsn decoded)
        {
            decoded = default;
            ValueAsnReader sequenceReader = reader.ReadSequence(expectedTag);
            ReadOnlySpan<byte> tmpSpan;
            ...
            decoded.Sid = sequenceReader.ReadEncodedValue();
            decoded.DigestAlgorithm = sequenceReader.ReadEncodedValue();
            ...
            if (sequenceReader.HasData && sequenceReader.PeekTag().HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 0)))
            {
                ...
                decoded.HasSignedAttributes = true;
            }
            ...
            if (sequenceReader.HasData && sequenceReader.PeekTag().HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 1)))
            {
                decoded.UnsignedAttributes = sequenceReader.ReadEncodedValue();
                decoded.HasUnsignedAttributes = true;
            }
