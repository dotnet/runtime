...
namespace System.Security.Cryptography.Asn1
{
    ...
    internal partial struct PBES2Params
    {
        ...
        internal static void Decode(ref ValueAsnReader reader, ReadOnlyMemory<byte> rebind, out PBES2Params decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, rebind, out decoded);
        }

        internal static void Decode(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out PBES2Params decoded)
        {
            try
            {
        ...
        private static void DecodeCore(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out PBES2Params decoded)
        {
            decoded = default;
    ...
    {
        internal ReadOnlySpan<byte> KeyDerivationFunc;
        internal ReadOnlySpan<byte> EncryptionScheme;
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValuePBES2Params decoded)
        {
            ...
            decoded.KeyDerivationFunc = sequenceReader.ReadEncodedValue();
            decoded.EncryptionScheme = sequenceReader.ReadEncodedValue();
