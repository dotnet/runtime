...
namespace System.Drawing
{
    internal static class KnownColorTable
    {
        ...
        public static readonly uint[,] s_colorTable = new uint[knownColorCount, 2]
        {
            ...
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ActiveBorder },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ActiveCaption },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ActiveCaptionText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.AppWorkspace },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.Control },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ControlDark },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ControlDarkDark },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ControlLight },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ControlLightLight },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ControlText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.Desktop },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.GrayText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.Highlight },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.HighlightText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.HotTrack },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.InactiveBorder },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.InactiveCaption },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.InactiveCaptionText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.Info },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.InfoText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.Menu },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.MenuText },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ScrollBar },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.Window },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.WindowFrame },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.WindowText },
#else
            ...
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ButtonFace },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ButtonHighlight },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.ButtonShadow },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.GradientActiveCaption },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.GradientInactiveCaption },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.MenuBar },
            { (uint)KnownColorCategory.System, (uint)Interop.User32.Win32SystemColors.MenuHighlight },
#else
