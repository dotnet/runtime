...
namespace System.Data.Common
{
    ...
    {
        // NOTE: Initializing a Task in SQL CLR requires the "UNSAFE" permission set (https://learn.microsoft.com/en-us/dotnet/framework/performance/sql-server-programming-and-host-protection-attributes)
