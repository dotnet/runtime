...
namespace System.Net.Http.Unit.Tests.HPack
{
    ...
    {
        private readonly HeaderField _header1 = new HeaderField(staticTableIndex: null, "header-1"u8, "value1"u8);
        private readonly HeaderField _header2 = new HeaderField(staticTableIndex: null, "header-02"u8, "value_2"u8);
