...
namespace System.Security.Cryptography.Tests
{
    ...
    public class MLDsaNistTestCase
    {
        ...
        public MLDsaNistTestCase(int nistTestCaseId, MLDsaAlgorithm algorithm, bool shouldPass, string publicKeyHex, string secretKeyHex, string muHex, string signatureHex)
        {
            NistTestCaseId = nistTestCaseId;
            Algorithm = algorithm;
            ShouldPass = shouldPass;
