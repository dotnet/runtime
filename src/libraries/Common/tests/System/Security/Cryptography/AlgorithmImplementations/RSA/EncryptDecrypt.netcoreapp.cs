...
namespace System.Security.Cryptography.Rsa.Tests
{
    ...
    public sealed class EncryptDecrypt_Span<TProvider> : EncryptDecrypt<TProvider> where TProvider : IRSAProvider, new()
    {
    ...
    [SkipOnPlatform(TestPlatforms.Browser, "Not supported on Browser")]
    public sealed class EncryptDecrypt_AllocatingSpan<TProvider> : EncryptDecrypt<TProvider> where TProvider : IRSAProvider, new()
    {
        protected override byte[] Encrypt(RSA rsa, byte[] data, RSAEncryptionPadding padding) =>
    ...
    [SkipOnPlatform(TestPlatforms.Browser, "Not supported on Browser")]
    public sealed class EncryptDecrypt_TrySpan<TProvider> : EncryptDecrypt<TProvider> where TProvider : IRSAProvider, new()
    {
        protected override byte[] Encrypt(RSA rsa, byte[] data, RSAEncryptionPadding padding) =>
