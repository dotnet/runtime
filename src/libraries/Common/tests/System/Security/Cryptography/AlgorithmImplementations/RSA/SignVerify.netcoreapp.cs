...
{
    public sealed class SignVerify_AllocatingSpan<TProvider> : SignVerify<TProvider> where TProvider : IRSAProvider, new()
    {
    ...
    public sealed class SignVerify_Span<TProvider> : SignVerify<TProvider> where TProvider : IRSAProvider, new()
    {
        protected override byte[] SignData(RSA rsa, byte[] data, HashAlgorithmName hashAlgorithm, RSASignaturePadding padding) =>
    ...
    public sealed class SignVerify_TrySpan<TProvider> : SignVerify<TProvider> where TProvider : IRSAProvider, new()
    {
        protected override byte[] SignData(RSA rsa, byte[] data, HashAlgorithmName hashAlgorithm, RSASignaturePadding padding) =>
