...
namespace System.Security.Cryptography.Rsa.Tests
{
    ...
    public abstract class SignVerify
    {
        ...
        public static IEnumerable<object[]> HashAlgorithmNames
        {
            get
            {
                yield return new object[] { HashAlgorithmName.SHA256.Name, (RSAProvider _) => true };
                yield return new object[] { HashAlgorithmName.SHA384.Name, (RSAProvider _) => true };
                yield return new object[] { HashAlgorithmName.SHA512.Name, (RSAProvider _) => true };
