...
namespace System.Security.Cryptography.Rsa.Tests
{
    ...
    public abstract class SignVerify
    {
        ...
        [ConditionalFact(typeof(RSAFactory), nameof(RSAFactory.SupportsMismatchedParameterSizes))]
        public void ExpectSignature_SHA256_2048_ParameterSizeMismatch()
        {
            // signature created in openssl with
            // echo -n Hello | openssl dgst -sha256 -sign diffpq.pem | xxd -i -c 8
            byte[] expectedSignature = new byte[]
            {
                ,
            };

            ExpectSignature(expectedSignature, TestData.HelloBytes, "SHA256", TestData.RSA2048PrimesDifferentLength);
        }
