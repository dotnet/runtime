...
namespace System.Security.Cryptography.Rsa.Tests
{
    ...
    internal class TestData
    {
        ...
        // D and Modulus have their high bits set so they both encode to 1024-bit values.
        public static readonly RSAParameters RSA1024FullPrivateExponent = new RSAParameters
        {
            Modulus = new byte[]
            {
                ,
            },
            Exponent = new byte[] { 0x01, 0x00, 0x01 },
            D = new byte[]
            {
                ,
            },
            P = new byte[]
            {
                0xF0, 0x6E, 0x78, 0xFC, 0xDE, 0xAC, 0x1D, 0x43,
                0x48, 0xCA, 0x44, 0x95, 0x76, 0x8B, 0xD9, 0xCE,
                0x02, 0x19, 0x57, 0x2D, 0xDB, 0x16, 0xA2, 0x10,
                0xFC, 0x8C, 0x3A, 0x02, 0xA0, 0x4B, 0xF0, 0xFD,
                0x7A, 0x31, 0x2A, 0x7F, 0x84, 0x1F, 0x43, 0x3C,
                0xE2, 0xC7, 0x1A, 0xDE, 0x8C, 0xF0, 0x67, 0xB1,
                0xBE, 0xCB, 0xFB, 0xDA, 0x45, 0xCD, 0x8C, 0x72,
                0xC3, 0x98, 0xEE, 0x62, 0x28, 0xFF, 0xD5, 0x8F,
            },
            DP = new byte[]
            {
                0x5E, 0x30, 0x49, 0x01, 0x77, 0x12, 0x22, 0x1C,
                0x9B, 0xC5, 0x71, 0x7C, 0xC4, 0x06, 0x21, 0x7B,
                0x4C, 0xE3, 0x34, 0x7D, 0xE8, 0x58, 0x43, 0x81,
                0x38, 0x0E, 0x8F, 0x23, 0x3C, 0x3C, 0xC3, 0xD9,
                0xE9, 0x26, 0x9D, 0xA9, 0x7A, 0xCE, 0xEC, 0x7E,
                0x4B, 0xB1, 0x08, 0x5B, 0xAB, 0x06, 0xFA, 0xF8,
                0x6C, 0xF0, 0x68, 0x67, 0xA7, 0xF4, 0xD0, 0x52,
                0x9D, 0x41, 0xAA, 0x11, 0x96, 0x52, 0x33, 0x0D,
            },
            Q = new byte[]
            {
                0xDC, 0x52, 0x26, 0xFC, 0xFF, 0x3B, 0xAF, 0xDA,
                0x8B, 0x20, 0xF8, 0x53, 0xF6, 0x52, 0xEB, 0x12,
                0x6D, 0x1E, 0xD4, 0xE8, 0x0E, 0xB4, 0x76, 0xB6,
                0xF0, 0x24, 0x4F, 0xFC, 0x58, 0x3C, 0xFC, 0x5D,
                0x6A, 0xFE, 0xC7, 0xC4, 0x71, 0xD1, 0x18, 0xE9,
                0x1F, 0x12, 0x58, 0x84, 0x96, 0x5F, 0x13, 0x64,
                0xB3, 0x1B, 0x98, 0x5A, 0x33, 0x28, 0x5E, 0xF1,
                0xDA, 0xB7, 0xEE, 0x78, 0xFF, 0x2B, 0x3A, 0x7B,
            },
            DQ = new byte[]
            {
                0x33, 0x9A, 0x72, 0x53, 0x53, 0x9C, 0xB1, 0x45,
                0xA8, 0xCC, 0xA2, 0x1D, 0x58, 0x56, 0x77, 0x84,
                0xAB, 0x56, 0x4B, 0x5B, 0xC7, 0x05, 0xF1, 0xC0,
                0x4B, 0x62, 0xD5, 0xF1, 0x2E, 0xE1, 0xA9, 0xE2,
                0x5F, 0x8B, 0x29, 0x53, 0x13, 0xAD, 0x7B, 0xFE,
                0x2E, 0x2E, 0xE7, 0xD8, 0xB6, 0x37, 0xB2, 0x9D,
                0x25, 0x6E, 0x53, 0x32, 0xDD, 0x44, 0x99, 0x68,
                0x60, 0x68, 0x30, 0x4C, 0xDA, 0xC7, 0x4F, 0x3D,
            },
            InverseQ = new byte[]
            {
                0x72, 0xB6, 0xC4, 0xE9, 0xD1, 0xA1, 0xAB, 0x8A,
                0x7D, 0x55, 0x42, 0x5B, 0x17, 0x93, 0x3C, 0xD6,
                0x50, 0x21, 0x70, 0x0E, 0xBF, 0xB8, 0x08, 0xA7,
                0x18, 0x10, 0x3A, 0x9A, 0xEB, 0xA1, 0x4C, 0xE6,
                0x0B, 0x91, 0xAA, 0xC3, 0xEF, 0x2B, 0x54, 0x44,
                0xC7, 0x81, 0x0F, 0x71, 0x20, 0xA4, 0x84, 0x5A,
                0xAD, 0x37, 0xBF, 0x6A, 0x6C, 0x6E, 0x17, 0x2F,
                0x8F, 0x86, 0x25, 0x24, 0x07, 0xCB, 0xF2, 0xAD,
            },
        };
