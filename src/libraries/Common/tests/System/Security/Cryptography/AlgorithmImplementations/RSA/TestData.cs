...
namespace System.Security.Cryptography.Rsa.Tests
{
    ...
    internal class TestData
    {
        ...
        public static readonly RSAParameters RSA2048PrimesDifferentLength = new RSAParameters
        {
            Modulus = new byte[]
            {
                ,
            },
            Exponent = new byte[] { 0x01, 0x00, 0x01 },
            D = new byte[]
            {
                ,
            },
            P = new byte[]
            {
                ,
            },
            DP = new byte[]
            {
                ,
            },
            Q = new byte[]
            {
                ,
            },
            DQ = new byte[]
            {
                ,
            },
            InverseQ = new byte[]
            {
                ,
            }
        };
