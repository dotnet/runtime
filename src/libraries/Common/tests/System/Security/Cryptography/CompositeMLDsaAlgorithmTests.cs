...
namespace System.Security.Cryptography.Tests
{
    public static class CompositeMLDsaAlgorithmTests
    {
        ...
        public static void AlgorithmsHaveExpectedParameters()
        {
            ...
            Assert.True(algorithm.MaxSignatureSizeInBytes > MLDsaAlgorithm.MLDsa44.SignatureSizeInBytes);
            ...
            Assert.True(algorithm.MaxSignatureSizeInBytes > MLDsaAlgorithm.MLDsa65.SignatureSizeInBytes);
            ...
            Assert.True(algorithm.MaxSignatureSizeInBytes > MLDsaAlgorithm.MLDsa87.SignatureSizeInBytes);
