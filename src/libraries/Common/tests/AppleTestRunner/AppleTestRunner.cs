...
public class SimpleTestRunner : iOSApplicationEntryPoint, IDevice
{
    ...
    public static extern void mono_ios_append_output ([MarshalAs(UnmanagedType.LPUTF8Str)] string value);

    [DllImport("__Internal")]
    public static extern void mono_ios_set_summary ([MarshalAs(UnmanagedType.LPUTF8Str)] string value);
