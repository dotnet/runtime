...
namespace System.Net.Security
{
    ...
    {
        RequireEncryption = 0,
        [System.ObsoleteAttribute("EncryptionPolicy.NoEncryption and AllowEncryption circumvent security and should not be used in production code.", DiagnosticId = "SYSLIB0040", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
        AllowNoEncryption = 1,
        [System.ObsoleteAttribute("EncryptionPolicy.NoEncryption and AllowEncryption circumvent security and should not be used in production code.", DiagnosticId = "SYSLIB0040", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
        NoEncryption = 2,
    }
