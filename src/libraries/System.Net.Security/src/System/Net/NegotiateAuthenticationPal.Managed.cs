...
namespace System.Net
{
    internal abstract partial class NegotiateAuthenticationPal
    {
        public static NegotiateAuthenticationPal Create(NegotiateAuthenticationClientOptions clientOptions)
        {
            try
            {
                return new ManagedNegotiateAuthenticationPal(clientOptions);
            }
        ...
        internal sealed class ManagedNegotiateAuthenticationPal : NegotiateAuthenticationPal
        {
            // Input parameters
            ...
            public override string Package => _isSpNego ? NegotiationInfoClass.Negotiate : NegotiationInfoClass.NTLM;
            ...
            public ManagedNegotiateAuthenticationPal(NegotiateAuthenticationClientOptions clientOptions)
            {
                if (clientOptions.Package == NegotiationInfoClass.NTLM)
                {
                    _isSpNego = false;
                }
                else if (clientOptions.Package == NegotiationInfoClass.Negotiate)
                {
                    _isSpNego = true;
                }
                else
            ...
            private unsafe byte[]? ProcessSpNegoChallenge(ReadOnlySpan<byte> challenge, out NegotiateAuthenticationStatusCode statusCode)
            {
