...
"
        ...
        {{{serializationLogic}
            ...
            private string GenerateForType(TypeGenerationSpec typeMetadata, string metadataInitSource, string? additionalSource = null)
            {
                ...
                return @$"{GetJsonContextDeclarationSource()}
{{
    ...
    {{
        ...
        {{
            ...
            private string GetRootJsonContextImplementation()
            {
                ...
                sb.Append(@$"{GetJsonContextDeclarationSource()}
{{
    {GetLogicForDefaultSerializerOptionsInit()}
    ...
    {{
        ...
        return null;
            ...
            PropertyNamingPolicy = {JsonNamingPolicyTypeRef}.CamelCase"
                ...
                return $@"private static {JsonSerializerOptionsTypeRef} {DefaultOptionsStaticVarName} {{ get; }} = new {JsonSerializerOptionsTypeRef}()
        {{
...
{{");
    ...
    private static {JsonEncodedTextTypeRef} {propName}PropName = {JsonEncodedTextTypeRef}.Encode(""{propName}"");");
            ...
            private string GetJsonContextDeclarationSource() => $"internal partial class {_currentContext.ContextType.Name} : {JsonSerializerContextTypeRef}";
