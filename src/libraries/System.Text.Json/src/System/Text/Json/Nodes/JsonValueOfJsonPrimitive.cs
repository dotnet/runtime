    ...
    internal static class JsonValueOfJsonPrimitive
    {
        internal static JsonValue CreatePrimitiveValue<T>(ref Utf8JsonReader reader, JsonNodeOptions options)
        {
            switch (reader.TokenType)
            {
                ...
                case JsonTokenType.String
                    when typeof(T) == typeof(JsonValuePrimitive<string>):
                ...
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<int>):
                    return JsonValue.Create(reader.GetInt32(), options);
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<long>):
                    return JsonValue.Create(reader.GetInt64(), options);
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<sbyte>):
                    return JsonValue.Create(reader.GetSByte(), options);
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<short>):
                    return JsonValue.Create(reader.GetInt16(), options);
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<uint>):
                    return JsonValue.Create(reader.GetUInt32(), options);
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<ulong>):
                    return JsonValue.Create(reader.GetUInt64(), options);
                case JsonTokenType.Number
                    when typeof(T) == typeof(JsonValuePrimitive<ushort>):
                    return JsonValue.Create(reader.GetUInt16(), options);
                case JsonTokenType.Number:
