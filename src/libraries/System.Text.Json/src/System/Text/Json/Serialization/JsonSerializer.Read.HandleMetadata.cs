...
namespace System.Text.Json
{
    ...
    {
        internal static readonly byte[] s_idPropertyName = "$id"u8;
        internal static readonly byte[] s_refPropertyName = "$ref"u8;
        internal static readonly byte[] s_valuesPropertyName = "$values"u8;
