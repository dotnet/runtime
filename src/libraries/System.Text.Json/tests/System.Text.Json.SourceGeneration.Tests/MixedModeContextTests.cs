...
namespace System.Text.Json.SourceGeneration.Tests
{
    ...
    [JsonSerializable(typeof(ContextTests.ClassWithEnumAndNullable), GenerationMode = JsonSourceGenerationMode.MetadataAndSerialization)]
    internal partial class MixedModeContext : JsonSerializerContext, ITestContext
    {
    }

    public sealed class MixedModeContextTests : ContextTests
    {
