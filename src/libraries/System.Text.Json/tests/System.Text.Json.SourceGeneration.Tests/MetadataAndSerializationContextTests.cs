...
namespace System.Text.Json.SourceGeneration.Tests
{
    ...
    [JsonSerializable(typeof(ContextTests.MyNestedClass))]
    [JsonSerializable(typeof(ContextTests.MyNestedClass.MyNestedNestedClass))]
    [JsonSerializable(typeof(object[]))]
    [JsonSerializable(typeof(string))]
    [JsonSerializable(typeof(ContextTests.ClassWithEnumAndNullable))]
    internal partial class MetadataAndSerializationContext : JsonSerializerContext, ITestContext
    {
    }

    public sealed class MetadataAndSerializationContextTests : ContextTests
    {
