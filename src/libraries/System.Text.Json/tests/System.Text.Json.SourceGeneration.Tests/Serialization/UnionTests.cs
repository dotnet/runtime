...
#pragma warning disable SYSLIB1227
        ...
        [JsonSerializable(typeof(HierarchyNullableUnion))]
        [JsonSerializable(typeof(NullableCaseUnion))]
        [JsonSerializable(typeof(NoNullableCaseUnion))]
        [JsonSerializable(typeof(NoNullableCaseUnionContainer))]
        [JsonSerializable(typeof(IntOrBool))]
        [JsonSerializable(typeof(IntOrBoolContainer))]
        [JsonSerializable(typeof(ValueTypeNullablePairUnion))]
        [JsonSerializable(typeof(SingleNullableValueTypeUnion))]
        ...
        [JsonSerializable(typeof(StrictIntOrString))]
        [JsonSerializable(typeof(StringEncodedInt))]
        [JsonSerializable(typeof(PlainIntUnion))]
        [JsonSerializable(typeof(UnionNumberHandlingContainer))]
        [JsonSerializable(typeof(StrictUnionNumberHandlingContainer))]
