...
namespace System.Text.Json.Tests
{
    public partial class Utf8JsonWriterTests
    {
        ...
        public void GrowBeyondBufferSize(bool formatted, bool skipValidation)
        {
            ...
            byte[] utf8String = "this is a string long enough to overflow the buffer and cause an exception to be thrown."u8;
        ...
        private static async Task WriteLargeToStreamHelper(Stream stream, JsonWriterOptions options)
        {
            ...
            byte[] utf8String = "some string 1234"u8;
        ...
        public void InvalidJsonMismatch(bool formatted, bool skipValidation)
        {
            ...
            using (var jsonUtf8 = new Utf8JsonWriter(output, options))
            {
                if (skipValidation)
                {
                    ...
                    jsonUtf8.WritePropertyName("test name"u8);
                }
                else
                {
                    ...
                    Assert.Throws<InvalidOperationException>(() => jsonUtf8.WritePropertyName("test name"u8));
                }
            }
        ...
        public void WriteHelloWorld(bool formatted, bool skipValidation)
        {
            ...
            byte[] utf8PropertyName = "message"u8;
            byte[] utf8Value = "Hello, World!"u8;
