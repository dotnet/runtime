...
{
    public partial class Net90GeneratedContext : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
    {
        /// <inheritdoc/>
        ...
        {
            if (type == typeof(global::System.Collections.Generic.Dictionary<string, global::System.Text.Json.Tests.SourceGenRegressionTests.Net90.HighLowTemps>))
            {
            ...
            if (type == typeof(global::System.Text.Json.Tests.SourceGenRegressionTests.Net90.ClassWithCustomConverter))
            {
                return Create_ClassWithCustomConverter(options);
            }
            if (type == typeof(global::System.Text.Json.Tests.SourceGenRegressionTests.Net90.HighLowTemps))
            {
                return Create_HighLowTemps(options);
            }
            if (type == typeof(global::System.Text.Json.Tests.SourceGenRegressionTests.Net90.MyLinkedList))
            {
                return Create_MyLinkedList(options);
            }
            if (type == typeof(global::System.Text.Json.Tests.SourceGenRegressionTests.Net90.WeatherForecastWithPOCOs))
            {
