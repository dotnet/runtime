...
namespace System.Text.Json.Serialization.Tests
{
    public static class NamingPolicyUnitTests
    {
        ...
        [InlineData("hi!!this_is_text.time_to_test.", "Hi!! This is text. Time to test.")]
        [InlineData("building", "BUILDING")]
        [InlineData("building_property", "BUILDING Property")]
        [InlineData("building_property", "Building Property")]
        [InlineData("building_property", "BUILDING PROPERTY")]
        [InlineData("url", "URL")]
        ...
        [InlineData("sn-ak-ec-as-e", "SnAkEcAsE")]
        [InlineData("sn-a__k-ec-as-e", "SnA__kEcAsE")]
        [InlineData("sn-a__k-ec-as-e", "SnA__ kEcAsE")]
        [InlineData("already_snake_case_", "already_snake_case_ ")]
        ...
        [InlineData("SnAkEcAsE", "SnAkEcAsE")]
        [InlineData("SnA__KEcAsE", "SnA__kEcAsE")]
        [InlineData("SnA__KEcAsE", "SnA__ kEcAsE")]
        [InlineData("Already_Snake_Case_", "already_snake_case_ ")]
        [InlineData("IsJsonProperty", "IsJSONProperty")]
        [InlineData("Shouting_Case", "SHOUTING_CASE")]
        [InlineData("9999-12-31T23:59:59.9999999Z", "9999-12-31T23:59:59.9999999Z")]
        [InlineData("Hi!!ThisIsText.TimeToTest.", "Hi!! This is text. Time to test.")]
        [InlineData("Building", "BUILDING")]
