...
namespace System.Text.Json.Serialization.Tests
{
    public partial class PipeTests
    {
        ...
        {
            Pipe pipe = new Pipe();
            await pipe.Writer.WriteAsync(SimpleTestClass.s_data);
            ...
            SimpleTestClass obj = await Serializer.DeserializeWrapper<SimpleTestClass>(pipe.Reader, options);
            obj.Verify();
        ...
        public async Task ReadPrimitivesAsync()
        {
            ...
            int i = await Serializer.DeserializeWrapper<int>(pipe.Reader, options);
            Assert.Equal(1, i);
        }
        ...
        {
            Pipe pipe = new Pipe();
            await pipe.Writer.WriteAsync(" 1\t// Comment\r\n/* Multi\r\nLine */"u8.ToArray());
            pipe.Writer.Complete();
        ...
        {
            Pipe pipe = new Pipe();
            await pipe.Writer.WriteAsync("null"u8.ToArray());
            pipe.Writer.Complete();

            IList<object> referenceTypeCollection = await Serializer.DeserializeWrapper<IList<object>>(pipe.Reader);
        ...
        public async Task ReadValueTypeCollectionPassingNullValueAsync()
        {
            ...
            IList<int> valueTypeCollection = await Serializer.DeserializeWrapper<IList<int>>(pipe.Reader);
        ...
        public async Task TestBOMWithSingleJsonValue(byte[] utf8BomAndValueArray, JsonSerializerOptions options, ulong expected)
        {
            ulong value;
            Pipe pipe = new Pipe();
            await pipe.Writer.WriteAsync(utf8BomAndValueArray);
            pipe.Writer.Complete();

            value = await Serializer.DeserializeWrapper<ulong>(pipe.Reader, options);
        ...
        public async Task TestBOMWithNoJsonValue()
        {
            ...
            await Assert.ThrowsAsync<JsonException>(
                async () => await Serializer.DeserializeWrapper<byte>(pipe.Reader));
        ...
        public async Task ReadPrimitiveWithWhitespaceAndThenInvalid(int bufferSize)
        {
            ...
            JsonException ex = await Assert.ThrowsAsync<JsonException>(async () => await Serializer.DeserializeWrapper<int>(pipe.Reader, options));
            ReadResult result = await pipe.Reader.ReadAsync();
        ...
        public async Task ReadObjectWithWhitespaceAndThenInvalid(int bufferSize)
        {
            ...
            JsonException ex = await Assert.ThrowsAsync<JsonException>(async () => await Serializer.DeserializeWrapper<SimpleTestClass>(pipe.Reader, options));
            ReadResult result = await pipe.Reader.ReadAsync();
            Assert.Equal(1, result.Buffer.Length);
