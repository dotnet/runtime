...
namespace System.Text.Json.Serialization.Tests
{
    public static partial class DefaultJsonTypeInfoResolverTests
    {
        ...
        [Fact]
        public static void RequiredAttributesGetDetectedAndFailDeserializationWhenValuesNotPresent()
        {
            JsonTypeInfo typeInfo = JsonSerializerOptions.Default.GetTypeInfo(typeof(ClassWithRequiredCustomAttributes));
            ...
            var deserialized = JsonSerializer.Deserialize<ClassWithRequiredCustomAttributes>(json);
            Assert.Null(deserialized.NonRequired);
            Assert.Null(deserialized.RequiredA);
            Assert.Null(deserialized.RequiredB);

            JsonException exception = Assert.Throws<JsonException>(() => JsonSerializer.Deserialize<ClassWithRequiredCustomAttributes>("{}"));
            ...
            exception = Assert.Throws<JsonException>(() => JsonSerializer.Deserialize<ClassWithRequiredCustomAttributes>("""{"NonRequired":"foo"}"""));
            Assert.DoesNotContain(nameof(ClassWithRequiredCustomAttributes.NonRequired), exception.Message);
            Assert.Contains(nameof(ClassWithRequiredCustomAttributes.RequiredA), exception.Message);
            Assert.Contains(nameof(ClassWithRequiredCustomAttributes.RequiredB), exception.Message);


            exception = Assert.Throws<JsonException>(() => JsonSerializer.Deserialize<ClassWithRequiredCustomAttributes>("""{"NonRequired":"foo", "RequiredB":"bar"}"""));
            Assert.DoesNotContain(nameof(ClassWithRequiredCustomAttributes.NonRequired), exception.Message);
            Assert.Contains(nameof(ClassWithRequiredCustomAttributes.RequiredA), exception.Message);
            Assert.DoesNotContain(nameof(ClassWithRequiredCustomAttributes.RequiredB), exception.Message);

            exception = Assert.Throws<JsonException>(() => JsonSerializer.Deserialize<ClassWithRequiredCustomAttributes>("""{"NonRequired":"foo", "RequiredA":null}"""));
            Assert.DoesNotContain(nameof(ClassWithRequiredCustomAttributes.NonRequired), exception.Message);
        ...
        [Fact]
        public static void RequiredMemberCanBeModifiedToNonRequired()
        {
            JsonSerializerOptions options = new()
            {
                TypeInfoResolver = new DefaultJsonTypeInfoResolver()
        ...
        [Fact]
        public static void NonRequiredMemberCanBeModifiedToRequired()
        {
            JsonSerializerOptions options = new()
            {
                TypeInfoResolver = new DefaultJsonTypeInfoResolver()
        ...
        [Fact]
        public static void RequiredExtensionDataPropertyThrows()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => JsonSerializer.Deserialize<ClassWithRequiredCustomAttributeAndDataExtensionProperty>("""{"Data":{}}"""));
        }

        [Fact]
        public static void RequiredExtensionDataPropertyCanBeFixedToNotBeRequiredWithResolver()
        {
            JsonSerializerOptions options = new()
            {
                TypeInfoResolver = new DefaultJsonTypeInfoResolver()
        ...
        [Fact]
        public static void RequiredExtensionDataPropertyCanBeFixedToNotBeExtensionDataWithResolver()
        {
            JsonSerializerOptions options = new()
            {
                TypeInfoResolver = new DefaultJsonTypeInfoResolver()
        ...
        [Fact]
        public static void RequiredReadOnlyPropertyThrows()
        {
            ClassWithRequiredCustomAttributeAndReadOnlyProperty obj = new();
            Assert.Throws<InvalidOperationException>(() => JsonSerializer.Serialize(obj));
            Assert.Throws<InvalidOperationException>(() => JsonSerializer.Deserialize<ClassWithRequiredCustomAttributeAndReadOnlyProperty>("""{"Data":{}}"""));
        }

        [Fact]
        public static void RequiredReadOnlyPropertyCanBeFixedToNotBeRequiredWithResolver()
        {
            JsonSerializerOptions options = new()
            {
                TypeInfoResolver = new DefaultJsonTypeInfoResolver()
        ...
        [Fact]
        public static void RequiredReadOnlyPropertyCanBeFixedToBeWritableWithResolver()
        {
            JsonSerializerOptions options = new()
            {
                TypeInfoResolver = new DefaultJsonTypeInfoResolver()
