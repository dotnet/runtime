    ...
    public abstract partial class ConstructorTests
    {
        ...
        public async Task MultipleProperties_Cannot_BindTo_TheSame_ConstructorParameter()
        {
            InvalidOperationException ex = await Assert.ThrowsAsync<InvalidOperationException>(
                () => Serializer.DeserializeAsync<Point_MultipleMembers_BindTo_OneConstructorParameter>("{}"));
            ...
            ex = await Assert.ThrowsAsync<InvalidOperationException>(
                () => Serializer.DeserializeAsync<Point_MultipleMembers_BindTo_OneConstructorParameter_Variant>("{}"));
        ...
        {
            InvalidOperationException ex = await Assert.ThrowsAsync<InvalidOperationException>(
                () => Serializer.DeserializeAsync<Point_Without_Members>("{}"));
            ...
            ex = await Assert.ThrowsAsync<InvalidOperationException>(
                () => Serializer.DeserializeAsync<Point_With_MismatchedMembers>("{}"));
            exStr = ex.ToString();
            Assert.Contains("(Int32, Int32)", exStr);
            Assert.Contains("System.Text.Json.Serialization.Tests.Point_With_MismatchedMembers", exStr);

            ex = await Assert.ThrowsAsync<InvalidOperationException>(
                () => Serializer.DeserializeAsync<WrapperFor_Point_With_MismatchedMembers>(@"{""MyInt"":1,""MyPoint"":{}}"));
            exStr = ex.ToString();
            Assert.Contains("(Int32, Int32)", exStr);
            Assert.Contains("System.Text.Json.Serialization.Tests.Point_With_MismatchedMembers", exStr);
        }
        ...
        public async Task LeadingReferenceMetadataNotSupported()
        {
            ...
            var employee = await Serializer.DeserializeAsync<Employee>(json);
            ...
            NotSupportedException ex = await Assert.ThrowsAsync<NotSupportedException>(
                () => Serializer.DeserializeAsync<Employee>(json, options));
        ...
        public async Task RandomReferenceMetadataNotSupported()
        {
            ...
            NotSupportedException ex = await Assert.ThrowsAsync<NotSupportedException>(() => Serializer.DeserializeAsync<Employee>(json, options));
            string exStr = ex.ToString();
            Assert.Contains("System.Text.Json.Serialization.Tests.ConstructorTests+Employee", exStr);
        ...
        {
            InvalidOperationException ex = await Assert.ThrowsAsync<InvalidOperationException>(() => Serializer.DeserializeAsync<Class_ExtData_CtorParam>("{}"));
            string exStr = ex.ToString();
        ...
        public async Task DeserializePathForObjectFails()
        {
            ...
            // Baseline.
            obj = await Serializer.DeserializeAsync<ClassWithUnicodePropertyName>(GoodJson);
            Assert.Equal(1, obj.Property\u04671);

            obj = await Serializer.DeserializeAsync<ClassWithUnicodePropertyName>(GoodJsonEscaped);
            Assert.Equal(1, obj.Property\u04671);

            JsonException e;

            // Exception.
            e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<ClassWithUnicodePropertyName>(BadJson));
            Assert.Equal(Expected, e.Path);

            e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<ClassWithUnicodePropertyName>(BadJsonEscaped));
            Assert.Equal(Expected, e.Path);
        }
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<RootClass>(@"{""Child"":{""MyInt"":bad]}"));
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<RootClass>(@"{""Child"":{""MyIntArray"":[1, bad]}"));
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<RootClass>(@"{""Child"":{""MyDictionary"":{""Key"": bad]"));
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<RootClass>(@"{""Child"":{""MyDictionary"":{""Key1"":{""Children"":[{""MyDictionary"":{""K.e.y"":"""));
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<RootClass>(@"{""Child"":{""Children"":[{}, {""MyDictionary"":{""K.e.y"": {""MyInt"":bad"));
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<Parameterized_ClassWithUnicodeProperty>("{\"A\u0467\":bad}"));
        ...
        {
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<Parameterized_ClassWithExtensionProperty>(@"{""MyNestedClass"":{""UnknownProperty"":bad}}"));
        ...
        public async Task CaseInsensitiveFails()
        {
            ...
            {
                var obj = await Serializer.DeserializeAsync<ClassWithConstructor_SimpleAndComplexParameters>(@"{""mydecimal"":1}", options);
            ...
            e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeAsync<ClassWithConstructor_SimpleAndComplexParameters>(@"{""mydecimal"":bad}", options));
        ...
        public async Task ClassWithUnsupportedCollectionTypes()
        {
            ...
            e = await Assert.ThrowsAsync<NotSupportedException>(() => Serializer.DeserializeAsync<ClassWithInvalidArray>(@"{""UnsupportedArray"":[]}"));
            ...
            e = await Assert.ThrowsAsync<NotSupportedException>(() => Serializer.DeserializeAsync<ClassWithInvalidDictionary>(@"{""UnsupportedDictionary"":{}}"));
            Assert.Contains("System.Int32[,]", e.ToString());
