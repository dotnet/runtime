...
namespace System.Globalization.Tests
{
    public class DateTimeFormatInfoLongTimePattern
    {
        ...
        public static IEnumerable<object[]> LongTimePattern_Get_TestData_HybridGlobalization()
        {
            ...
            yield return new object[] { new CultureInfo("bg-BG").DateTimeFormat, "H:mm:ss" }; // H:mm:ss ч. ToDo: this can be a bug as well
            ...
            yield return new object[] { new CultureInfo("es-419").DateTimeFormat, "h:mm:ss tt" }; // HH:mm:ss
            yield return new object[] { new CultureInfo("es-ES").DateTimeFormat, "H:mm:ss" };
            yield return new object[] { new CultureInfo("es-MX").DateTimeFormat, "h:mm:ss tt" }; // H:mm:ss
