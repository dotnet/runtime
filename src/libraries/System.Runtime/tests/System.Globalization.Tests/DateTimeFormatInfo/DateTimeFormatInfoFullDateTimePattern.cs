...
namespace System.Globalization.Tests
{
    public class DateTimeFormatInfoFullDateTimePattern
    {
        ...
        public static IEnumerable<object[]> FullDateTimePattern_Get_TestData_HybridGlobalization()
        {
            ...
            yield return new object[] { new CultureInfo("bg-BG").DateTimeFormat, "dddd, d MMMM yyyy г. H:mm:ss" }; // dddd, d MMMM yyyy 'г'. H:mm:ss
            ...
            yield return new object[] { new CultureInfo("ca-AD").DateTimeFormat, "dddd, d de MMMM del yyyy H:mm:ss" }; // dddd, d MMMM 'de' yyyy H:mm:ss
            yield return new object[] { new CultureInfo("ca-ES").DateTimeFormat, "dddd, d de MMMM del yyyy H:mm:ss" }; // dddd, d MMMM 'de' yyyy H:mm:ss
            ...
            yield return new object[] { new CultureInfo("es-419").DateTimeFormat, "dddd, d de MMMM de yyyy h:mm:ss tt" }; // dddd, d 'de' MMMM 'de' yyyy HH:mm:ss
            ...
            yield return new object[] { new CultureInfo("es-MX").DateTimeFormat, "dddd, d de MMMM de yyyy h:mm:ss tt" }; // dddd, d 'de' MMMM 'de' yyyy H:mm:ss
