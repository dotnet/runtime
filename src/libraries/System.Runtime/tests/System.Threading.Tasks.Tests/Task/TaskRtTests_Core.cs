...
namespace System.Threading.Tasks.Tests
{
    public static class TaskRtTests_Core
    {
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsThreadingSupported), nameof(PlatformDetection.IsWindows), nameof(PlatformDetection.Is64BitProcess))]
