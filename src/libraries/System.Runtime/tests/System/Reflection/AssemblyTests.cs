...
namespace System.Reflection.Tests
{
    public class AssemblyTests
    {
        ...
        [Theory]
        [MemberData(nameof(GetSatelliteAssembly_CultureInfo_TestData))]
        public void GetSatelliteAssembly_InvokeCultureInfoCustom_ThrowsNotImplementedException(CultureInfo culture)
        {
            var assembly = new CustomAssembly();
            assembly.GetSatelliteAssemblyAction = (cultureParam, versionParam) => typeof(int).Assembly;
            Assert.Throws<NotImplementedException>(() => assembly.GetSatelliteAssembly(culture));
        }
