...
namespace System.Reflection.Tests
{
    ...
    {
        public static Module Module => typeof(RuntimeModuleTests).Module;
        ...
        [Theory]
        [InlineData(typeof(RuntimeModuleTests))]
        ...
        public static IEnumerable<object[]> BadResolveTypes =>
            ...
            {
                new object[] { 1234 },
                new object[] { typeof(RuntimeModuleTests).GetMethod("ResolveType").MetadataToken },
            }
            .Union(NullTokens);
        ...
        public static IEnumerable<object[]> BadResolveMethods =>
            ...
            {
                new object[] { 1234 },
                new object[] { typeof(RuntimeModuleTests).MetadataToken },
                new object[] { typeof(RuntimeModuleTests).MetadataToken + 1000 },
            }
            .Union(NullTokens);
