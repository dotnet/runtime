...
namespace System.Reflection.Tests
{
    public class TypeDelegatorTests
    {
        ...
        {
            Assert.True(new TypeDelegator(typeof(delegate* unmanaged<void>)).IsClass);
            Assert.True(new TypeDelegator(typeof(delegate* unmanaged<void>)).IsFunctionPointer);
            Assert.True(new TypeDelegator(typeof(delegate* unmanaged<void>)).IsUnmanagedFunctionPointer);
            Assert.NotNull(new TypeDelegator(typeof(delegate* unmanaged<void>)).GetFunctionPointerCallingConventions());
            Assert.NotNull(new TypeDelegator(typeof(delegate* unmanaged<void>)).GetFunctionPointerParameterInfos());
            Assert.NotNull(new TypeDelegator(typeof(delegate* unmanaged<void>)).GetFunctionPointerReturnParameter());
        }
