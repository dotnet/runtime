...
namespace System.Tests
{
    ...
    public static class StringSplitTests
    {
        ...
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jklm" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jklm" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jklm", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jklm" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def" })]
        [InlineData("abc,def,ghi,jklm", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jklm" })]
        [InlineData("abc,def,ghi,jkl", ',', M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl,abc,def" })]
        [InlineData("abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jklm" })]
        [InlineData("abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc,def,ghi,jkl" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc_def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc_def,ghi,jkl,abc,def", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl,abc,def" })]
        [InlineData("abc_def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jklm" })]
        [InlineData("abc_def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def,ghi,jkl" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jkl,abc,def,ghi", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jkl,abc,def,ghi" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jklm" })]
        [InlineData("abc_def_ghi,jkl,abc,def,ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def,ghi,jkl" })]
        [InlineData("abc_def_ghi,jkl,abc,def", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl,abc,def" })]
        [InlineData("abc_def_ghi,jklm", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jklm" })]
        [InlineData("abc_def_ghi,jkl", '_', M, StringSplitOptions.None, new[] { "abc", "def", "ghi,jkl" })]
        ...
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jkl,abc,def,ghi_jkl,abc,def,ghi_jkl,abc,def_ghi_jkl,abc_def,ghi,jkl_abc,def,ghi,jkl_abc,def,ghi_jkl_abc,def,ghi_jkl", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jkl,abc,def,ghi_jkl,abc,def,ghi_jkl,abc,def_ghi_jkl,abc_def,ghi,jkl_abc,def,ghi,jkl_abc,def,ghi_jklm", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jklm" })]
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jkl,abc,def,ghi_jkl,abc,def,ghi_jkl,abc,def_ghi_jkl", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jkl,abc,def,ghi_jkl,abc,def,ghi_jklm", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jklm" })]
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jkl,abc,def,ghi", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi" })]
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jklm", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jklm" })]
        [InlineData("abc_def,ghi_jkl,abc,def_ghi,jkl", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc_def,ghi_jkl,abc,def", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def" })]
        [InlineData("abc_def,ghi_jklm", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jklm" })]
        [InlineData("abc_def,ghi_jkl", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", new char[] { ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", new char[] { '_', ',' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", new char[] { ',', '_', '.' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", new char[] { '_', '.', ',' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl,abc,def,ghi,jkl", new char[] { '.', ',', '_' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
        [InlineData("abc_def,ghi.jkl,abc,def.ghi,jkl,abc.def,ghi_jkl.abc,def,ghi.jkl,abc,def.ghi_jkl,abc.def,ghi,jkl.abc,def,ghi.jkl_abc,def.ghi_jkl_abc.def,ghi_jkl", new char[] { ',', '_', '.' }, M, StringSplitOptions.None, new[] { "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl", "abc", "def", "ghi", "jkl" })]
