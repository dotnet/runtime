    ...
    public class UIntPtrTests_GenericMath
    {
        ...
        public static void DivRemTest()
        {
            if (Environment.Is64BitProcess)
            {
                unchecked
                {
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000000, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x0000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000001, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x0000000000000001, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000002, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x3FFFFFFFFFFFFFFF, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x3FFFFFFFFFFFFFFF, (nuint)0x0000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x4000000000000000, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000000, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x4000000000000000, (nuint)0x0000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000001, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002));
                    Assert.Equal(((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002));

                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x0000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x0000000000000002), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x7FFFFFFFFFFFFFFE), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x7FFFFFFFFFFFFFFF), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x8000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000000, (nuint)0x8000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000001, (nuint)0x0000000000000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE));
                    Assert.Equal(((nuint)0x0000000000000001, (nuint)0x0000000000000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE));

                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000000, 0));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000001, 0));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFF, 0));
                }
            }
            else
            {
                Assert.Equal(((nuint)0x00000000, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000000, (nuint)0x00000002));
                Assert.Equal(((nuint)0x00000000, (nuint)0x00000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000001, (nuint)0x00000002));
                Assert.Equal(((nuint)0x00000001, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000002, (nuint)0x00000002));
                Assert.Equal(((nuint)0x3FFFFFFF, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFE, (nuint)0x00000002));
                Assert.Equal(((nuint)0x3FFFFFFF, (nuint)0x00000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFF, (nuint)0x00000002));
                Assert.Equal(((nuint)0x40000000, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000000, (nuint)0x00000002));
                Assert.Equal(((nuint)0x40000000, (nuint)0x00000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000001, (nuint)0x00000002));
                Assert.Equal(((nuint)0x7FFFFFFF, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFE, (nuint)0x00000002));
                Assert.Equal(((nuint)0x7FFFFFFF, (nuint)0x00000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFF, (nuint)0x00000002));

                Assert.Equal(((nuint)0x00000000, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000000, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000000, (nuint)0x00000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000001, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000000, (nuint)0x00000002), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000002, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000000, (nuint)0x7FFFFFFE), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000000, (nuint)0x7FFFFFFF), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000000, (nuint)0x80000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000000, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000000, (nuint)0x80000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000001, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000001, (nuint)0x00000000), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE));
                Assert.Equal(((nuint)0x00000001, (nuint)0x00000001), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE));

                Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000000, 0));
                Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000001, 0));
                Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFF, 0));
            }
        }
        ...
        public static void DivRemModeTest()
        {
            if (Environment.Is64BitProcess)
            {
                unchecked
                {
                    ...
                    {
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x0000000000000000, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000000, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x0000000000000001, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000001, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x0000000000000002, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000002, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x8000000000000000, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000000, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x8000000000000001, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000001, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode));

                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode));

                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000000, 0, mode));
                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x0000000000000001, 0, mode));
                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFFFFFFFFFF, 0, mode));
                    }
                }
            }
            else
            {
                foreach (var mode in (DivisionRounding[])Enum.GetValues(typeof(DivisionRounding)))
                {
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x00000000, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000000, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x00000001, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000001, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x00000002, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000002, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFE, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFE, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFF, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFF, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x80000000, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000000, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x80000001, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000001, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFE, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFE, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFF, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFF, (nuint)0x00000002, mode));

                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x00000000, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000000, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x00000001, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000001, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x00000002, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000002, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x80000000, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000000, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0x80000001, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0x80000001, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivRemExpected((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE, mode));

                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000000, 0, mode));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0x00000001, 0, mode));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.DivRem((nuint)0xFFFFFFFF, 0, mode));
                }
            }
        }
        ...
        public static void DivideModeTest()
        {
            if (Environment.Is64BitProcess)
            {
                unchecked
                {
                    foreach (var mode in (DivisionRounding[])Enum.GetValues(typeof(DivisionRounding)))
                    {
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x0000000000000000, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000000, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x0000000000000001, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000001, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x0000000000000002, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000002, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x8000000000000000, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x8000000000000000, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x8000000000000001, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x8000000000000001, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode));

                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode));

                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000000, 0, mode));
                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Divide((nuint)0x0000000000000001, 0, mode));
                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFFFFFFFFFF, 0, mode));
                    }
                }
            }
            else
            {
                foreach (var mode in (DivisionRounding[])Enum.GetValues(typeof(DivisionRounding)))
                {
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x00000000, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x00000000, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x00000001, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x00000001, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x00000002, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x00000002, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFE, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFE, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFF, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFF, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x80000000, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x80000000, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x80000001, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x80000001, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFE, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFE, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFF, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFF, (nuint)0x00000002, mode));

                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x00000000, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x00000000, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x00000001, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x00000001, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x00000002, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x00000002, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x80000000, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x80000000, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0x80000001, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0x80000001, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.DivideExpected((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE, mode));

                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Divide((nuint)0x00000000, 0, mode));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Divide((nuint)0x00000001, 0, mode));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Divide((nuint)0xFFFFFFFF, 0, mode));
                }
            }
        }
        ...
        public static void RemainderModeTest()
        {
            if (Environment.Is64BitProcess)
            {
                unchecked
                {
                    foreach (var mode in (DivisionRounding[])Enum.GetValues(typeof(DivisionRounding)))
                    {
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x0000000000000000, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000000, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x0000000000000001, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000001, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x0000000000000002, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000002, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x8000000000000000, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x8000000000000000, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x8000000000000001, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x8000000000000001, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0x0000000000000002, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0x0000000000000002, mode));

                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000002, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x8000000000000000, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x8000000000000001, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFFFFFFFFFE, (nuint)0xFFFFFFFFFFFFFFFE, mode));
                        Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFFFFFFFFFF, (nuint)0xFFFFFFFFFFFFFFFE, mode));

                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000000, 0, mode));
                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Remainder((nuint)0x0000000000000001, 0, mode));
                        Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFFFFFFFFFF, 0, mode));
                    }
                }
            }
            else
            {
                foreach (var mode in (DivisionRounding[])Enum.GetValues(typeof(DivisionRounding)))
                {
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x00000000, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000000, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x00000001, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000001, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x00000002, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000002, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFE, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFE, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFF, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFF, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x80000000, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x80000000, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x80000001, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x80000001, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFE, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFE, (nuint)0x00000002, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFF, (nuint)0x00000002, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFF, (nuint)0x00000002, mode));

                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x00000000, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000000, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x00000001, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000001, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x00000002, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000002, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFE, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x7FFFFFFF, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x80000000, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x80000000, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0x80000001, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0x80000001, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFE, (nuint)0xFFFFFFFE, mode));
                    Assert.Equal(BinaryIntegerHelper<nuint>.RemainderExpected((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE, mode), BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFF, (nuint)0xFFFFFFFE, mode));

                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000000, 0, mode));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Remainder((nuint)0x00000001, 0, mode));
                    Assert.Throws<DivideByZeroException>(() => BinaryIntegerHelper<nuint>.Remainder((nuint)0xFFFFFFFF, 0, mode));
                }
            }
        }
        ...
        public static void TryReadBigEndianByteTest()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_007F, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_00FF, result);
        }
        ...
        public static void TryReadBigEndianInt16Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0100, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_7FFF, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianInt32Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0100_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x7FFF_FFFF, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianInt64Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
                Assert.Equal(unchecked((nuint)0x0100_0000_0000_0000), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
                Assert.Equal(unchecked((nuint)0x7FFF_FFFF_FFFF_FFFF), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianInt96Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianInt128Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianSByteTest()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_007F, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianUInt16Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0100, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_7FFF, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_8000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_FF7F, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_FFFF, result);
        }
        ...
        public static void TryReadBigEndianUInt32Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0100_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x7FFF_FFFF, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x8000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0xFFFF_FF7F, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0xFFFF_FFFF, result);
        }
        ...
        public static void TryReadBigEndianUInt64Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0x0100_0000_0000_0000), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0x7FFF_FFFF_FFFF_FFFF), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0x8000_0000_0000_0000), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0xFFFF_FFFF_FFFF_FF7F), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0xFFFF_FFFF_FFFF_FFFF), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }
        }
        ...
        public static void TryReadBigEndianUInt96Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadBigEndianUInt128Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadBigEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianByteTest()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_007F, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_00FF, result);
        }
        ...
        public static void TryReadLittleEndianInt16Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0100, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_7FFF, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianInt32Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0100_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x7FFF_FFFF, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianInt64Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
                Assert.Equal(unchecked((nuint)0x0100_0000_0000_0000), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
                Assert.Equal(unchecked((nuint)0x7FFF_FFFF_FFFF_FFFF), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianInt96Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianInt128Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianSByteTest()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_007F, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80 }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF }, isUnsigned: false, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianUInt16Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0100, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_8000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_FF7F, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_7FFF, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_FFFF, result);
        }
        ...
        public static void TryReadLittleEndianUInt32Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0100_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x8000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0xFFFF_FF7F, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x7FFF_FFFF, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0xFFFF_FFFF, result);
        }
        ...
        public static void TryReadLittleEndianUInt64Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0x0100_0000_0000_0000), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0x8000_0000_0000_0000), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0xFFFF_FFFF_FFFF_FF7F), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            if (Environment.Is64BitProcess)
            {
                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0x7FFF_FFFF_FFFF_FFFF), result);

                Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal(unchecked((nuint)0xFFFF_FFFF_FFFF_FFFF), result);
            }
            else
            {
                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);

                Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
                Assert.Equal((nuint)0x0000_0000, result);
            }
        }
        ...
        public static void TryReadLittleEndianUInt96Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void TryReadLittleEndianUInt128Test()
        {
            ...
            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0001, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.True(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0080, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);

            Assert.False(BinaryIntegerHelper<nuint>.TryReadLittleEndian(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, isUnsigned: true, out result));
            Assert.Equal((nuint)0x0000_0000, result);
        }
        ...
        public static void WriteBigEndianTest()
        {
            ...
            Assert.Equal(size, BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, destination));
            Assert.Equal<byte>(Environment.Is64BitProcess ? [0x00, 0x00, 0x00, 0x00, 0x12, 0x34, 0x56, 0x78, 0x00] : [0x12, 0x34, 0x56, 0x78, 0x00], destination);

            destination = new byte[size + 1];
            Assert.Equal(size, BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, destination, 1));
            Assert.Equal<byte>(Environment.Is64BitProcess ? [0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x34, 0x56, 0x78] : [0x00, 0x12, 0x34, 0x56, 0x78], destination);

            destination = new byte[size + 1];
            Assert.Equal(size, BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, destination.AsSpan(1)));
            Assert.Equal<byte>(Environment.Is64BitProcess ? [0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x34, 0x56, 0x78] : [0x00, 0x12, 0x34, 0x56, 0x78], destination);

            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, (byte[])null!));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, new byte[size - 1]));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, new byte[size + 1], 2));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, Span<byte>.Empty));
            Assert.Throws<ArgumentOutOfRangeException>(() => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, new byte[size + 1], size + 2));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, (byte[])null!, 0));
            Assert.Throws<ArgumentOutOfRangeException>(() => BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, (byte[])null!, 1));
        }
        ...
        public static void WriteLittleEndianTest()
        {
            ...
            byte[] destination = new byte[size + 1];
            Assert.Equal(size, BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, destination));
            Assert.Equal<byte>(Environment.Is64BitProcess ? [0x78, 0x56, 0x34, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00] : [0x78, 0x56, 0x34, 0x12, 0x00], destination);

            destination = new byte[size + 1];
            Assert.Equal(size, BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, destination, 1));
            Assert.Equal<byte>(Environment.Is64BitProcess ? [0x00, 0x78, 0x56, 0x34, 0x12, 0x00, 0x00, 0x00, 0x00] : [0x00, 0x78, 0x56, 0x34, 0x12], destination);

            destination = new byte[size + 1];
            Assert.Equal(size, BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, destination.AsSpan(1)));
            Assert.Equal<byte>(Environment.Is64BitProcess ? [0x00, 0x78, 0x56, 0x34, 0x12, 0x00, 0x00, 0x00, 0x00] : [0x00, 0x78, 0x56, 0x34, 0x12], destination);

            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, (byte[])null!));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, new byte[size - 1]));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, new byte[size + 1], 2));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, Span<byte>.Empty));
            Assert.Throws<ArgumentOutOfRangeException>(() => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, new byte[size + 1], size + 2));
            AssertExtensions.Throws<ArgumentException>("destination", () => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, (byte[])null!, 0));
            Assert.Throws<ArgumentOutOfRangeException>(() => BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, (byte[])null!, 1));
        }

        [Fact]
        public static void WriteEndianDoesNotAllocateTest()
        {
            byte[] destination = new byte[nuint.Size];
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, destination);
                BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, destination, 0);
                BinaryIntegerHelper<nuint>.WriteBigEndian((nuint)0x12345678, destination.AsSpan());
                BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, destination);
                BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, destination, 0);
                BinaryIntegerHelper<nuint>.WriteLittleEndian((nuint)0x12345678, destination.AsSpan());
        ...
        public static void op_DivisionTest()
        {
            if (Environment.Is64BitProcess)
            {
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_Division(unchecked((nuint)0x0000000000000000), (nuint)0));
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_Division(unchecked((nuint)0xFFFFFFFFFFFFFFFF), (nuint)0));
            }
            else
            {
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_Division((nuint)0x00000000, (nuint)0));
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_Division((nuint)0x00000001, (nuint)0));
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_Division((nuint)0xFFFFFFFF, (nuint)0));
            }
        }
        ...
        public static void op_CheckedDivisionTest()
        {
            if (Environment.Is64BitProcess)
            {
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_CheckedDivision(unchecked((nuint)0x0000000000000000), (nuint)0));
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_CheckedDivision(unchecked((nuint)0xFFFFFFFFFFFFFFFF), (nuint)0));
            }
            else
            {
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_CheckedDivision((nuint)0x00000000, (nuint)0));
                ...
                Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<nuint, nuint, nuint>.op_CheckedDivision((nuint)0xFFFFFFFF, (nuint)0));
            }
        }
