...
namespace System.Reflection.Tests
{
    public class ModuleTests
    {
        ...
        [Fact]
        [ActiveIssue("https://github.com/dotnet/runtime/issues/123011", typeof(PlatformDetection), nameof(PlatformDetection.IsBrowser), nameof(PlatformDetection.IsCoreCLR), nameof(PlatformDetection.IsNativeAot))]
