...
namespace System.Tests
{
    public class TimeSpanTests
    {
        ...
        public static void FromMinutes_Invalid()
        {
            ...
            long maxMinutesLong = long.MaxValue / 60000000;
            ...
            Assert.Throws<OverflowException>(() => TimeSpan.FromMinutes(maxMinutesLong));
            Assert.Throws<OverflowException>(() => TimeSpan.FromMinutes(maxMinutesLong - 1, 60));
