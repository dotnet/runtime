...
namespace System.Runtime.Tests
{
    public class JitInfoTests
    {
        ...
        {
            // example ref emit dynamic method from https://learn.microsoft.com/en-us/dotnet/framework/reflection-and-codedom/how-to-define-and-execute-dynamic-methods
