...
namespace System.Tests
{
    public partial class HalfTests
    {
        ...
        public static IEnumerable<object[]> Parse_Valid_TestData()
        {
            ...
            yield return new object[] { "0x1.0p-24", NumberStyles.HexFloat, invariantFormat, (float)Half.Epsilon };
            yield return new object[] { "0x1.ffcp15", NumberStyles.HexFloat, invariantFormat, (float)Half.MaxValue };
            yield return new object[] { "  0x1.0p0  ", NumberStyles.HexFloat, invariantFormat, 1.0f };
        }
        ...
        public static IEnumerable<object[]> ToString_TestData_NotNetFramework()
        {
            ...
            yield return new object[] { (float)Half.Epsilon, "X", invariantFormat, "0x1p-24" };
            yield return new object[] { (float)Half.MaxValue, "X", invariantFormat, "0x1.ffcp+15" };
            yield return new object[] { (float)Half.MinValue, "X", invariantFormat, "-0x1.ffcp+15" };
        }
