...
namespace System.Tests
{
    public class Int128Tests
    {
        ...
        public static IEnumerable<object[]> BigMul_TestData()
        {
            ...
            yield return new object[] { (Int128)(-1), (Int128)(-1), "0000000000000000800000000000000000000000000000000000000000000001" };
            yield return new object[] { (Int128)(-1), Int128.MinValue, "0000000000000000800000000000000000000000000000008000000000000000" };
            yield return new object[] { (Int128)1, Int128.MinValue, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF8000000000000000" };
