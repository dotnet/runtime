...
namespace System.Tests
{
    public class Int128Tests_GenericMath
    {
        ...
        {
            Assert.Equal(new Int128(0x80000000_00000000, 0),
                BinaryIntegerHelper<Int128>.ReverseBits(new Int128(0, 0x00000000_00000001)));
            Assert.Equal(new Int128(
                ...
                BinaryIntegerHelper<Int128>.ReverseBits(new Int128(
            ...
            Assert.Equal(new Int128(0xF7B3D591_E6A2C480, 0x084C2A6E_195D3B7F),
                BinaryIntegerHelper<Int128>.ReverseBits(new Int128(0xFEDCBA98_76543210, 0x01234567_89ABCDEF)));
            Assert.Equal(new Int128(0x80402010_08040201, 0x08040201_80402010),
                BinaryIntegerHelper<Int128>.ReverseBits(new Int128(0x08040201_80402010, 0x80402010_08040201)));
            Assert.Equal(new Int128(0xAAAAAAAA_AAAAAAAA, 0x55555555_55555555),
                BinaryIntegerHelper<Int128>.ReverseBits(new Int128(0xAAAAAAAA_AAAAAAAA, 0x55555555_55555555)));
        }
        ...
        public static void TryWriteBigEndianTest()
        {
            ...
            Assert.Equal<byte>([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], destination);

            Assert.True(BinaryIntegerHelper<Int128>.TryWriteBigEndian(One, destination, out bytesWritten));
            Assert.Equal(16, bytesWritten);
            Assert.Equal<byte>([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01], destination);

            Assert.True(BinaryIntegerHelper<Int128>.TryWriteBigEndian(MaxValue, destination, out bytesWritten));
            Assert.Equal(16, bytesWritten);
            Assert.Equal<byte>([0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], destination);

            Assert.True(BinaryIntegerHelper<Int128>.TryWriteBigEndian(MinValue, destination, out bytesWritten));
            Assert.Equal(16, bytesWritten);
            Assert.Equal<byte>([0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], destination);
        ...
        public static void TryWriteLittleEndianTest()
        {
            ...
            Assert.Equal(16, bytesWritten);
            Assert.Equal<byte>([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], destination);

            Assert.True(BinaryIntegerHelper<Int128>.TryWriteLittleEndian(MaxValue, destination, out bytesWritten));
            Assert.Equal(16, bytesWritten);
            Assert.Equal<byte>([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F], destination);

            Assert.True(BinaryIntegerHelper<Int128>.TryWriteLittleEndian(MinValue, destination, out bytesWritten));
            Assert.Equal(16, bytesWritten);
            Assert.Equal<byte>([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80], destination);
        ...
        public static void op_DivisionTest()
        {
            ...
            Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<Int128, Int128, Int128>.op_Division(Zero, 0));
            Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<Int128, Int128, Int128>.op_Division(One, 0));
            Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<Int128, Int128, Int128>.op_Division(MaxValue, 0));
        }
        ...
        public static void op_CheckedDivisionTest()
        {
            ...
            Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<Int128, Int128, Int128>.op_CheckedDivision(Zero, 0));
            Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<Int128, Int128, Int128>.op_CheckedDivision(One, 0));
            Assert.Throws<DivideByZeroException>(() => DivisionOperatorsHelper<Int128, Int128, Int128>.op_CheckedDivision(MaxValue, 0));
        }
