...
namespace System.Tests
{
    public class UInt32Tests
    {
        ...
        public static void Parse_AllowTrailingInvalidCharacters(string value, NumberStyles style, IFormatProvider provider, uint expectedValue, int expectedCharsConsumed)
        {
            uint result;
            int charsConsumed;
