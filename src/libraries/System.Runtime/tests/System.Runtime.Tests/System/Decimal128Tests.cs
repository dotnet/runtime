...
namespace System.Tests
{
    public class Decimal128Tests
    {
        ...
        public static IEnumerable<object[]> op_Addition_TestData()
        {
            ...
            yield return new object[] { new UInt128(0x7800000000000000, 0x0000000000000000), new UInt128(0xF800000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // +Inf + -Inf -> NaN
            yield return new object[] { new UInt128(0xF800000000000000, 0x0000000000000000), new UInt128(0x7800000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // -Inf + +Inf -> NaN
            ...
            yield return new object[] { new UInt128(0x7800000000000000, 0x000000000000000F), new UInt128(0xF800000000000000, 0x0000000000000003), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // non-canonical +Inf + non-canonical -Inf -> NaN
        ...
        public static IEnumerable<object[]> op_Multiply_TestData()
        {
            ...
            yield return new object[] { new UInt128(0x7800000000000000, 0x0000000000000000), new UInt128(0x3040000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // +Inf * +0 -> NaN
            yield return new object[] { new UInt128(0x3040000000000000, 0x0000000000000000), new UInt128(0x7800000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // +0 * +Inf -> NaN
            yield return new object[] { new UInt128(0xF800000000000000, 0x0000000000000000), new UInt128(0x3040000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // -Inf * +0 -> NaN
            yield return new object[] { new UInt128(0x7800000000000000, 0x0000000000000000), new UInt128(0xB040000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // +Inf * -0 -> NaN
            yield return new object[] { new UInt128(0x7800000000000000, 0x0000000000000000), new UInt128(0x3040000000000000, 0x0000000000000001), new UInt128(0x7800000000000000, 0x0000000000000000) }; // +Inf * 1 -> +Inf
        ...
        public static IEnumerable<object[]> op_Division_TestData()
        {
            ...
            yield return new object[] { new UInt128(0x3040000000000000, 0x0000000000000000), new UInt128(0x3040000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // +0 / +0 -> NaN
            yield return new object[] { new UInt128(0xB040000000000000, 0x0000000000000000), new UInt128(0xB040000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // -0 / -0 -> NaN
            yield return new object[] { new UInt128(0x3040000000000000, 0x0000000000000000), new UInt128(0xB040000000000000, 0x0000000000000000), new UInt128(0xFC00000000000000, 0x0000000000000000) }; // +0 / -0 -> NaN
