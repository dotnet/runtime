...
namespace System.Runtime.CompilerServices
{
    ...
    [System.ObsoleteAttribute("SuppressIldasmAttribute has no effect in .NET 6.0+ applications.", DiagnosticId = "SYSLIB0016", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
