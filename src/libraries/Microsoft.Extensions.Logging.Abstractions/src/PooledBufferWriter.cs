...
{
    // TODO: I assume we want to share this source better
    // Copied from src\libraries\Common\src\System\Text\Json\PooledByteBufferWriter.cs
    // Minor edits were applied to make it compile here
...
namespace System
{
    internal static partial class ThrowHelper
    {
        ...
        {
            throw new OutOfMemoryException(SR.Format(/*SR.BufferMaximumSizeExceeded*/ "PLACEHOLDER", capacity));
        }
    }
}
