...
namespace Microsoft.Extensions.Logging.Generators.Tests.TestClasses
{
    internal static partial class MessageTestExtensions
    {
        ...
        //
        // This is handled fine by the logger generator and generates a warning. Unfortunately, the above warning suppression is
        // not being observed by the C# compiler at the moment, so having this here causes build warnings.
