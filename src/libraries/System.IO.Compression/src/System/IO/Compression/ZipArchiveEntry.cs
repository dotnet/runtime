...
namespace System.IO.Compression
{
    ...
    public partial class ZipArchiveEntry
    {
        ...
        /// <remarks>The <see cref="System.IO.Compression.ZipArchiveEntry.FullName" /> property contains the relative path, including the subdirectory hierarchy, of an entry in a zip archive. (In contrast, the <see cref="System.IO.Compression.ZipArchiveEntry.Name" /> property contains only the name of the entry and does not include the subdirectory hierarchy.) For example, if you create two entries in a zip archive by using the <see langword="System.IO.Compression.ZipFileExtensions.CreateEntryFromFile" /> method and provide `NewEntry.txt` as the name for the first entry and `AddedFolder\\NewEntry.txt` for the second entry, both entries will have `NewEntry.txt` in the <see cref="System.IO.Compression.ZipArchiveEntry.Name" /> property. The first entry will also have `NewEntry.txt` in the <see cref="System.IO.Compression.ZipArchiveEntry.FullName" /> property, but the second entry will have `AddedFolder\\NewEntry.txt` in the <see cref="System.IO.Compression.ZipArchiveEntry.FullName" /> property.
        ...
        /// <remarks>When you create a new entry from an existing file by calling the <see langword="System.IO.Compression.ZipFileExtensions.CreateEntryFromFile" /> method, the <see cref="System.IO.Compression.ZipArchiveEntry.LastWriteTime" /> property for the entry is automatically set to the last time the file was modified. When you create a new entry programmatically by calling the <see cref="O:System.IO.Compression.ZipArchive.CreateEntry" /> method, the <see cref="System.IO.Compression.ZipArchiveEntry.LastWriteTime" /> property for the entry is automatically set to the time of execution. If you modify the entry, you must explicitly set the <see cref="System.IO.Compression.ZipArchiveEntry.LastWriteTime" /> property if you want the value to reflect the time of the latest change.
        ...
        /// <remarks>The <see cref="System.IO.Compression.ZipArchiveEntry.Name" /> property contains the portion of the <see cref="System.IO.Compression.ZipArchiveEntry.FullName" /> property that follows the final directory separator character (\\), and does not include the subdirectory hierarchy. For example, if you create two entries in a zip archive by using the <see langword="System.IO.Compression.ZipFileExtensions.CreateEntryFromFile" /> method and provide `NewEntry.txt` as the name for the first entry and `AddedFolder\\NewEntry.txt` for the second entry, both entries will have `NewEntry.txt` in the <see cref="System.IO.Compression.ZipArchiveEntry.Name" /> property. The first entry will also have `NewEntry.txt` in the <see cref="System.IO.Compression.ZipArchiveEntry.FullName" /> property, but the second entry will have `AddedFolder\\NewEntry.txt` in the <see cref="System.IO.Compression.ZipArchiveEntry.FullName" /> property.</remarks>
        /// <example>The following example shows how to retrieve entries from a zip archive and evaluate the properties of the entries. It uses the <see cref="System.IO.Compression.ZipArchiveEntry.Name" /> property to display the name of the entry, and the <see cref="System.IO.Compression.ZipArchiveEntry.Length" /> and <see cref="System.IO.Compression.ZipArchiveEntry.CompressedLength" /> properties to calculate how much the file was compressed.
        /// <format type="text/markdown"><![CDATA[
        /// [!code-csharp[System.IO.Compression.ZipArchiveEntry#1](~/samples/snippets/csharp/VS_Snippets_CLR_System/system.io.compression.ziparchiveentry/cs/program1.cs#1)]
        /// [!code-vb[System.IO.Compression.ZipArchiveEntry#1](~/samples/snippets/visualbasic/VS_Snippets_CLR_System/system.io.compression.ziparchiveentry/vb/program1.vb#1)]
