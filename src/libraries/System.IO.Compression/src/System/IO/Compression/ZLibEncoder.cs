...
namespace System.IO.Compression
{
    ...
    public sealed class ZLibEncoder : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZLibEncoder"/> class using the specified quality.
        /// </summary>
        ...
        {
            // compressBound() returns the upper bound for zlib-wrapped deflate, which already accounts
