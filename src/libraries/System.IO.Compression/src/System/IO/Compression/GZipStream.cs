...
namespace System.IO.Compression
{
    ...
    public class GZipStream : Stream
    {
        ...
        /// This constructor overload uses the compression mode <see cref="System.IO.Compression.CompressionMode.Compress" />. To set the compression mode to another value, use the <see cref="System.IO.Compression.GZipStream.GZipStream(System.IO.Stream,System.IO.Compression.CompressionMode)" /> or <see cref="System.IO.Compression.GZipStream.GZipStream(System.IO.Stream,System.IO.Compression.CompressionMode,bool)" /> overload.</remarks>
        ...
        /// <example>The following example shows how to compress and decompress bytes by using the <see cref="O:System.IO.Compression.GZipStream.Read" /> and <see cref="O:System.IO.Compression.GZipStream.Write" /> methods.
        /// <format type="text/markdown"><![CDATA[
        ...
        /// <remarks>Use the <see cref="System.IO.Compression.GZipStream.CanRead" /> property to determine whether the current instance supports reading. Use the <see cref="O:System.IO.Compression.GZipStream.ReadAsync" /> method to read asynchronously from the current stream.
        ...
        /// <remarks>Starting with the .NET Framework 4.5, you can perform asynchronous write operations by using the <see cref="O:System.IO.Stream.WriteAsync" /> method. The <see cref="System.IO.Compression.GZipStream.BeginWrite" /> method is still available in .NET Framework 4.5 to support legacy code; however, you can implement asynchronous I/O operations more easily by using the new async methods. For more information, see <a href="https://docs.microsoft.com/en-us/dotnet/standard/io/asynchronous-file-i-o">Asynchronous File I/O</a>.
        ...
        /// <remarks>Starting with the .NET Framework 4.5, you can perform asynchronous write operations by using the <see cref="O:System.IO.Stream.WriteAsync" /> method. The <see cref="System.IO.Compression.GZipStream.EndWrite" /> method is still available in .NET Framework 4.5 to support legacy code; however, you can implement asynchronous I/O operations more easily by using the new async methods. For more information, see <a href="https://docs.microsoft.com/en-us/dotnet/standard/io/asynchronous-file-i-o">Asynchronous File I/O</a>.
        ...
        /// <remarks>Use the <see cref="System.IO.Compression.GZipStream.CanWrite" /> property to determine whether the current instance supports writing. Use the <see cref="O:System.IO.Compression.GZipStream.WriteAsync" /> method to write asynchronously to the current stream.
        ...
        /// <param name="offset">The byte offset in <paramref name="buffer" /> at which to begin writing data from the GZip stream.</param>
        /// <param name="count">The maximum number of bytes to read.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is <see cref="System.Threading.CancellationToken.None" />.</param>
        /// <returns>A task that represents the asynchronous read operation, which wraps the total number of bytes read into the <paramref name="buffer" />. The result value can be less than the number of bytes requested if the number of bytes currently available is less than the requested number, or it can be 0 (zero) if the end of the GZip stream has been reached.</returns>
        ...
        /// <param name="buffer">The buffer that contains the data to compress.</param>
        /// <param name="offset">The zero-based byte offset in <paramref name="buffer" /> from which to begin copying bytes to the GZip stream.</param>
        /// <param name="count">The maximum number of bytes to write.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is <see cref="System.Threading.CancellationToken.None" />.</param>
