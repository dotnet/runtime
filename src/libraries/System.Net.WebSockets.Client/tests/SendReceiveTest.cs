...
namespace System.Net.WebSockets.Client.Tests
{
    ...
    public abstract class SendReceiveTest : ClientWebSocketTestBase
    {
        ...
        {
            // TODO remove condition when this test is updated to use inherited test classes
            if (this is NoInvokerMemorySendReceiveRemoteTest || this is NoInvokerArraySegmentSendReceiveRemoteTest)
            {
        ...
        public async Task SendReceive_Concurrent_Success()
        {
