...
namespace System.Net
{
    ...
    internal static class CookieExtensions
    {
        ...
        public static string ToServerString(this Cookie cookie)
        {
            ...
            Debug.Assert(s_toServerStringFunc is not null, "Reflection failed for Cookie.ToServerString().");
        ...
        public static Cookie Clone(this Cookie cookie)
        {
            ...
            Debug.Assert(s_cloneFunc is not null, "Reflection failed for Cookie.Clone().");
        ...
        public static bool IsRfc2965Variant(this Cookie cookie)
        {
            ...
            Debug.Assert(s_getVariantFunc is not null, "Reflection failed for Cookie.Variant.");
    ...
    internal static class CookieCollectionExtensions
    {
        ...
        public static int InternalAdd(this CookieCollection cookieCollection, Cookie cookie, bool isStrict)
        {
            ...
            Debug.Assert(s_internalAddFunc is not null, "Reflection failed for CookieCollection.InternalAdd().");
