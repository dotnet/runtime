            ...
            if (IsolationLevel.Unspecified != isolevel)
            {
                ...
                switch (isolevel)
                {
                    ...
                    case IsolationLevel.Snapshot:
                        ...
                        // VSDD 414121: Snapshot isolation level must be set through SQL_COPT_SS_TXN_ISOLATION (https://learn.microsoft.com/en-us/sql/relational-databases/native-client-odbc-api/sqlsetconnectattr#sqlcoptsstxnisolation)
