...
namespace System.Data.Odbc
{
    internal sealed class OdbcConnectionFactory : DbConnectionFactory
    {
        ...
        protected override DbConnectionOptions CreateConnectionOptions(string connectionString, DbConnectionOptions? previous)
        {
            ...
            OdbcConnectionString result = new OdbcConnectionString(connectionString, (previous is not null));
            return result;
        }
        ...
        protected override DbMetaDataFactory CreateMetaDataFactory(DbConnectionInternal internalConnection, out bool cacheMetaDataFactory)
        {
            ...
            Debug.Assert(odbcOuterConnection is not null, "outer connection may not be null.");
