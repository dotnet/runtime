...
namespace System.IO.Packaging
{
    ...
    /// of these clases.
    /// </remarks>
    internal sealed partial class InterleavedZipPartStream : Stream
    {
        /// <summary>
        ...
        internal InterleavedZipPartStream(ZipPackagePart owningPart, ZipStreamManager zipStreamManager, FileMode mode, FileAccess access)
        ...
        /// </summary>
        internal InterleavedZipPartStream(string partName, ZipStreamManager zipStreamManager, List<PieceInfo> sortedPieceInfoList,
            FileMode mode, FileAccess access)
        {
            ...
            _dir = new PieceDirectory(sortedPieceInfoList, zipStreamManager, mode, access);
