    ...
    internal partial class InterleavedZipPartStream
    {
        ...
        private sealed class PieceDirectory
        {
            ...
            private sealed class PieceStreamInfo : IComparable<PieceStreamInfo>
            {
                ...
                private readonly long _startOffset; // The start offset of a piece in the part.
            ...
            /// </summary>
            internal PieceDirectory(List<PieceInfo> sortedPieceInfoList, ZipStreamManager zipStreamManager, FileMode mode, FileAccess access)
            {
                ...
                _pieceStreamInfoList.Add(
                    new PieceStreamInfo(
                    zipStreamManager.Open(sortedPieceInfoList[0].ZipArchiveEntry, mode, access),
                    0 /*startOffset*/));
            ...
            private void UpdatePhysicalEndIfNecessary()
            {
                ...
                ZipArchiveEntry newLastPieceInfo = _zipArchive.CreateEntry(newLastPieceFileName);
                ...
                if (lastPiece == 0)
                {
                    Stream pieceStream = _zipStreamManager.Open(newLastPieceInfo, _fileMode, _fileAccess);
                    _indexOfLastPieceStreamInfoAccessed = 0;
            ...
            /// </remarks>
            private readonly List<PieceInfo> _sortedPieceInfoList;
