...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public abstract class ValidationAttribute : Attribute
    {
        ...
        /// </summary>
        /// <remarks>
        ///     <see cref="FormatErrorMessage" /> calls this method after selecting the attribute's error message.
        ...
        /// </remarks>
        /// <param name="messageString">The message template to format.</param>
        /// <param name="name">The user-visible name to include in the formatted message.</param>
        /// <returns>The formatted validation message.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="messageString" /> is <see langword="null" />.</exception>
        /// <exception cref="FormatException"><paramref name="messageString" /> is not a valid composite format string.</exception>
        public virtual string FormatMessage([StringSyntax(StringSyntaxAttribute.CompositeFormat)] string messageString, string name)
        {
            ArgumentNullException.ThrowIfNull(messageString);

            return string.Format(CultureInfo.CurrentCulture, messageString, name);
        }
