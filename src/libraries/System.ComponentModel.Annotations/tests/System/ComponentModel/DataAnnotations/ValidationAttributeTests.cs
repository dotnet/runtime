...
namespace System.ComponentModel.DataAnnotations.Tests
{
    public class ValidationAttributeTests
    {
        ...
        public static void FormatMessage_ReturnsExpected(string messageString, string name, string expected)
        {
            var attribute = new ValidationAttributeNoOverrides();
            Assert.Equal(expected, attribute.FormatMessage(messageString, name));
        }
        ...
        public static void FormatMessage_NullMessageString_ThrowsArgumentNullException(ValidationAttribute attribute)
        {
        ...
        {
            public override string FormatMessage(string messageString, string name) => $"{messageString}|{name}";
        }
