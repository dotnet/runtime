...
namespace System.ComponentModel.DataAnnotations.Tests
{
    public class RangeAttributeTests : ValidationAttributeTestBase
    {
        ...
        public static void FormatMessage_UsesSuppliedFormatAndConvertedBounds()
        {
            ...
            {
                DescriptionMessageResourceName = nameof(DescriptionMessageResources.RangeDescription),
            ...
            Assert.Equal("resource name:01:03", attribute.FormatDescriptionMessage("name"));
