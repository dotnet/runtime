...
namespace System.Reflection.Metadata.Tests
{
    public class MetadataReaderTests
    {
        ...
        public unsafe void InvalidFindMscorlibAssemblyRefNoProjection()
        {
            ...
            int mscorlibIndex = IndexOf(peImage, "mscorlib"u8, headers.MetadataStartOffset);
        ...
        public unsafe void InvalidStreamHeaderLengths()
        {
            ...
            // find CLR
            int clrIndex = IndexOf(peImage, "CLR"u8, headers.MetadataStartOffset);
        ...
        public void GetString_WinRTPrefixed_Projected()
        {
            ...
            Assert.Equal("Class1"u8, strReader.ReadBytes("Class1".Length));
            ...
            Assert.Equal("<WinRT>Class1"u8, strReader.ReadBytes("<WinRT>Class1".Length));
            Assert.Equal(0, strReader.RemainingBytes);
        }
        ...
        public void GetString_WinRTPrefixed_NotProjected()
        {
            ...
            var strReader = reader.GetBlobReader(winrtDef.Name);
            Assert.Equal("<CLR>Class1"u8, strReader.ReadBytes("<CLR>Class1".Length));
            Assert.Equal(0, strReader.RemainingBytes);
        ...
        public void GetString_DotTerminated()
        {
            ...
            Assert.Equal("System.Runtime.CompilerServices"u8, strReader.ReadBytes("System.Runtime.CompilerServices".Length));
            Assert.Equal(0, strReader.RemainingBytes);
            ...
            Assert.Equal("System"u8, strReader.ReadBytes("System".Length));
            Assert.Equal(0, strReader.RemainingBytes);
        }
