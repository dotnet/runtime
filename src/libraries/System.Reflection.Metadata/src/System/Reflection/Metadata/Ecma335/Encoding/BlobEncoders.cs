...
namespace System.Reflection.Metadata.Ecma335
{
    ...
    public readonly struct BlobEncoder
    {
        ...
        {
            if (fixedArguments is null) Throw.ArgumentNull(nameof(fixedArguments));
            if (namedArguments is null) Throw.ArgumentNull(nameof(namedArguments));
    ...
    public readonly struct MethodSignatureEncoder
    {
        ...
        {
            if (returnType is null) Throw.ArgumentNull(nameof(returnType));
            if (parameters is null) Throw.ArgumentNull(nameof(parameters));
    ...
    public readonly struct LiteralEncoder
    {
        ...
        {
            if (arrayType is null) Throw.ArgumentNull(nameof(arrayType));
            if (vector is null) Throw.ArgumentNull(nameof(vector));
        ...
        {
            if (type is null) Throw.ArgumentNull(nameof(type));
            if (scalar is null) Throw.ArgumentNull(nameof(scalar));
    ...
    public readonly struct ScalarEncoder
    {
        ...
        public void Constant(object? value)
        {
            ...
            if (str is not null || value is null)
            {
                String(str);
            }
            else
        ...
        {
            if (serializedTypeName is not null && serializedTypeName.Length == 0)
            {
    ...
    public readonly struct NameEncoder
    {
        ...
        {
            if (name is null) Throw.ArgumentNull(nameof(name));
    ...
    public readonly struct NamedArgumentsEncoder
    {
        ...
        public void AddArgument(bool isField, Action<NamedArgumentTypeEncoder> type, Action<NameEncoder> name, Action<LiteralEncoder> literal)
        {
            if (type is null) Throw.ArgumentNull(nameof(type));
            if (name is null) Throw.ArgumentNull(nameof(name));
            if (literal is null) Throw.ArgumentNull(nameof(literal));
    ...
    public readonly struct CustomAttributeElementTypeEncoder
    {
        ...
        {
            if (enumTypeName is null) Throw.ArgumentNull(nameof(enumTypeName));
    ...
    public readonly struct SignatureTypeEncoder
    {
        ...
        {
            if (elementType is null) Throw.ArgumentNull(nameof(elementType));
            if (arrayShape is null) Throw.ArgumentNull(nameof(arrayShape));
