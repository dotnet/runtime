...
namespace System.Net.Http.Json.Functional.Tests
{
    public class HttpClientJsonExtensionsTests
    {
        ...
        public void TestHttpClientIsNullAsync()
        {
            ...
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.GetFromJsonAsync(uriString, typeof(Person)));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.GetFromJsonAsync(uri, typeof(Person)));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.GetFromJsonAsync<Person>(uriString));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.GetFromJsonAsync<Person>(uri));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.GetFromJsonAsync(uriString, typeof(Person), JsonContext.Default));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.GetFromJsonAsync(uri, typeof(Person), JsonContext.Default));
            ...
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.PostAsJsonAsync(uriString, null, JsonContext.Default.Person));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.PostAsJsonAsync(uri, null, JsonContext.Default.Person));

            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.PutAsJsonAsync<Person>(uriString, null));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.PutAsJsonAsync<Person>(uri, null));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.PutAsJsonAsync(uriString, null, JsonContext.Default.Person));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(clientParamName, () => client.PutAsJsonAsync(uri, null, JsonContext.Default.Person));
        }
        ...
        public void TestTypeMetadataIsNull()
        {
            ...
            AssertExtensions.ThrowsAsync<ArgumentNullException>(contextParamName, () => client.GetFromJsonAsync(uriString, typeof(Person), JsonContext.Default));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(contextParamName, () => client.GetFromJsonAsync(uri, typeof(Person), JsonContext.Default));
            ...
            AssertExtensions.ThrowsAsync<ArgumentNullException>(jsonTypeInfoParamName, () => client.PutAsJsonAsync(uriString, null, JsonContext.Default.Person));
            AssertExtensions.ThrowsAsync<ArgumentNullException>(jsonTypeInfoParamName, () => client.PutAsJsonAsync(uri, null, JsonContext.Default.Person));
        }
