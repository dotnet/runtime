...
namespace System.IO.Compression
{
    public static partial class ZipFile
    {
        ...
        /// <summary>
        /// Extracts all of the files in the specified password-protected archive to a directory on the file system.
        /// The specified directory must not exist. This method will create all subdirectories and the specified directory.
        /// If there is an error while extracting the archive, the archive will remain partially extracted. Each entry will
        /// be extracted such that the extracted file has the same relative path to the destinationDirectoryName as the entry
        /// has to the archive. The path is permitted to specify relative or absolute path information. Relative path information
        ...
        private static void ExtractToDirectory(string sourceArchiveFileName, string destinationDirectoryName, Encoding? entryNameEncoding, bool overwriteFiles, ReadOnlySpan<char> password)
        {
            ArgumentNullException.ThrowIfNull(sourceArchiveFileName);
        ...
        /// -or-
        /// An archive entry was compressed by using a compression method that is not supported.</exception>
        private static void ExtractToDirectory(Stream source, string destinationDirectoryName, Encoding? entryNameEncoding, bool overwriteFiles, ReadOnlySpan<char> password)
        {
            ArgumentNullException.ThrowIfNull(source);
            if (!source.CanRead)
            {
        ...
        /// <summary>
        /// Extracts all of the files in the specified archive to a directory on the file system using the specified options.
        /// </summary>
        /// <param name="sourceArchiveFileName">The path to the archive on the file system that is to be extracted.</param>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sourceArchiveFileName"/>, <paramref name="destinationDirectoryName"/>, or <paramref name="options"/> is <see langword="null"/>.</exception>
        public static void ExtractToDirectory(string sourceArchiveFileName, string destinationDirectoryName, ZipExtractionOptions options)
        {
            ...
            ExtractToDirectory(sourceArchiveFileName, destinationDirectoryName, options.EntryNameEncoding, options.OverwriteFiles, options.Password.Span);
        }

        /// <summary>
        /// Extracts all of the files in the specified stream to a directory on the file system using the specified options.
        /// </summary>
        /// <param name="source">The stream containing the archive to extract.</param>
        /// <param name="destinationDirectoryName">The path to the directory in which to place the extracted files.</param>
        /// <param name="options">The extraction options including password, encoding, and overwrite behavior.</param>
        ...
        public static void ExtractToDirectory(Stream source, string destinationDirectoryName, ZipExtractionOptions options)
        {
            ...
            ExtractToDirectory(source, destinationDirectoryName, options.EntryNameEncoding, options.OverwriteFiles, options.Password.Span);
        }
    }
}
