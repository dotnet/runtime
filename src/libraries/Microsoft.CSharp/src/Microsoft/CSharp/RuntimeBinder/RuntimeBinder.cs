            ...
            out DynamicMetaObject deferredBinding)
        {
            ...
            if (callPayload != null)
            {
                ...
                if (swt != null && swt.Sym.getKind() != SYMKIND.SK_MethodSymbol)
                {
                    ...
                    CSharpGetMemberBinder getMember = new CSharpGetMemberBinder(callPayload.Name, false, callPayload.CallingContext, new CSharpArgumentInfo[] { callPayload.GetArgumentInfo(0) }).TryGetExisting(callPayload.CallingContext);
                    ...
                    CSharpInvokeBinder invoke = new CSharpInvokeBinder(callPayload.Flags, callPayload.CallingContext, argInfos).TryGetExisting(callPayload.CallingContext);
