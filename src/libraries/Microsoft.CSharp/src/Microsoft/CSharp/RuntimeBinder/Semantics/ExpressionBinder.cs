...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    internal readonly partial struct ExpressionBinder
    {
                ...
                else if (paramCount != 0)
                {
                    ...
                    if (argument is ExprNamedArgumentSpecification named)
                    {
                            ...
                            mp.isParamArray && index == mp.Params.Count - 1)
                        {
                            ...
                            ExprArrayInit arrayInit = ExprFactory.CreateArrayInit(arrayType, null, null, s_dimSizes);
        ...
        FIXUPPARAMLIST:
            ...
            // Use an EK_ARRINIT even in the empty case so empty param arrays in attributes work.
            ExprArrayInit exprArrayInit = ExprFactory.CreateArrayInit(substitutedArrayType, null, null, s_dimSizes);
        ...
        private static readonly int[] s_dimSizes = new[] { 0 };
