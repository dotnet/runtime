...
namespace System.Security.Cryptography.Cose.Tests
{
    public class CoseTestHelpers
    {
        ...
        internal const string SHA256 = KnownHashAlgorithms.SHA256;
        internal const string SHA384 = KnownHashAlgorithms.SHA384;
        internal const string SHA512 = KnownHashAlgorithms.SHA512;

        public enum ECDsaAlgorithm
        {
            ES256 = KnownCoseAlgorithms.ES256,
            ES384 = KnownCoseAlgorithms.ES384,
            ES512 = KnownCoseAlgorithms.ES512,
        }

        internal enum RSAAlgorithm
        {
            PS256 = KnownCoseAlgorithms.PS256,
            PS384 = KnownCoseAlgorithms.PS384,
            PS512 = KnownCoseAlgorithms.PS512,
        }
        ...
        {
            var rsaParameters = includePrivateKey ?
                new RSAParameters
                {
