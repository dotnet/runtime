...
namespace System.Security.Cryptography.Cose
{
    internal abstract class ToBeSignedBuilder : IDisposable
    {
        ...
        internal static ToBeSignedBuilder Create(KeyType keyType, HashAlgorithmName hashAlgorithmName)
            => keyType switch
            {
                KeyType.MLDsa => new PureDataToBeSignedBuilder(),
                _ => new HashToBeSignedBuilder(hashAlgorithmName),
            };
