...
namespace System.Composition
{
    ...
    public static class CompositionContextExtensions
    {
        ...
        {
            if (exportProvider is null) throw new ArgumentNullException(nameof(exportProvider));
            if (objectWithLooseImports is null) throw new ArgumentNullException(nameof(objectWithLooseImports));
