...
namespace Microsoft.NETCore.Platforms.BuildTasks.Tests
{
    public class GenerateRuntimeGraphTests
    {
        ...
        public void CanAddArchitectureAndVersionToExistingGroups()
        {
            ...
            var expectedAdditions = new[]
            {
                new RuntimeDescription("osx.13-powerpc", new[] { "osx.13", "osx.12.0-powerpc" }),
                new RuntimeDescription("osx.13-arm64", new[] { "osx.13", "osx.12.0-arm64" }),
                new RuntimeDescription("osx.13-x64", new[] { "osx.13", "osx.11.2-x64" }),
                new RuntimeDescription("osx.13", new[] { "osx.13.0" }),
                // our RID model doesn't give priority to architecture, so the new architecture is applied to all past versions
                new RuntimeDescription("osx.12.0-powerpc", new[] { "osx.12.0", "osx.11.0-powerpc" }),
