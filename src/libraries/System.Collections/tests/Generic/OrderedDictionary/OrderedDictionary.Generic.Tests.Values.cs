...
namespace System.Collections.Tests
{
    public class OrderedDictionary_Generic_Tests_Values : ICollection_Generic_Tests<string>
    {
        ...
        protected override ICollection<string> GenericICollectionFactory() => new OrderedDictionary<string, string>().Values;
    ...
    public class OrderedDictionary_Generic_Tests_Values_AsICollection : ICollection_NonGeneric_Tests
    {
        ...
        protected override ICollection NonGenericICollectionFactory() => new OrderedDictionary<string, string>().Values;

        protected override ICollection NonGenericICollectionFactory(int count)
        {
            OrderedDictionary<string, string> list = new OrderedDictionary<string, string>();
            int seed = 13453;
            for (int i = 0; i < count; i++)
            {
