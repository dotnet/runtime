        ...
        protected static IEnumerable<TestCase> TestCaseDefinitions { get; } =
            new[]
            {
                ...
                new TestCase(
                    ...
                    "39A34F41"),
                // Test a multiple of 64 bytes for x86/64 optimizations
                new TestCase(
                    "Lorem ipsum 128",
                    ...
                    "931A6737"),
                // Test a multiple of 64 bytes + 16 bytes for x86/64 optimizations
                new TestCase(
                    "Lorem ipsum 144",
                    ...
                    "2B719549"),
                // Test data that is > 64 bytes but not a multiple of 16 for x86/64 optimizations
                new TestCase(
                    "Lorem ipsum 1001",
