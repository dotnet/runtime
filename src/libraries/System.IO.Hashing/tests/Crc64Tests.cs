...
namespace System.IO.Hashing.Tests
{
    public class Crc64Tests : NonCryptoHashTestDriver
    {
        ...
        public void ParameterSetIsRequired()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("parameterSet", () => new Crc64((Crc64ParameterSet)null!));
            AssertExtensions.Throws<ArgumentNullException>("parameterSet", () => Crc64.Hash((Crc64ParameterSet)null!, array));
            AssertExtensions.Throws<ArgumentNullException>("parameterSet", () => Crc64.Hash((Crc64ParameterSet)null!, array.AsSpan()));
            AssertExtensions.Throws<ArgumentNullException>("parameterSet", () => Crc64.Hash((Crc64ParameterSet)null!, array, array));
            AssertExtensions.Throws<ArgumentNullException>("parameterSet", () => Crc64.HashToUInt64((Crc64ParameterSet)null!, array));

            int integer = 823;
            AssertExtensions.Throws<ArgumentNullException>("parameterSet", () => Crc64.TryHash((Crc64ParameterSet)null!, array, array, out integer));
