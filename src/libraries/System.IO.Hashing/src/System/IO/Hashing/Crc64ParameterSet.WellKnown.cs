...
namespace System.IO.Hashing
{
    public partial class Crc64ParameterSet
    {
        ...
        private sealed class Ecma182ParameterSet : ForwardCrc64
        {
            // Pre-computed lookup table for the ECMA-182 polynomial, which is 0x42F0E1EBA9EA3693.
            // See GenerateLookupTable in Crc64ParameterSet.Table.cs for how this was generated.
            ...
            public Ecma182ParameterSet()
                : base(0x42F0E1EBA9EA3693, 0x0000000000000000, 0x0000000000000000)
            {
            }

            protected override ulong UpdateScalar(ulong crc, ReadOnlySpan<byte> source)
            {
