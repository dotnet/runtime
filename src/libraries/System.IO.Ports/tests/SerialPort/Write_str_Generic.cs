...
namespace System.IO.Ports.Tests
{
    public class Write_str_Generic : PortsTest
    {
        ...
        [ConditionalFact(typeof(Write_str_Generic), nameof(HasOneSerialPort))]
        ...
        [KnownFailure]
        [ConditionalFact(typeof(Write_str_Generic), nameof(HasNullModem))]
        public void Timeout()
        {
        ...
        [ConditionalFact(typeof(Write_str_Generic), nameof(HasOneSerialPort), nameof(HasHardwareFlowControl))]
        ...
        [ConditionalFact(typeof(Write_str_Generic), nameof(HasNullModem), nameof(HasHardwareFlowControl))]
