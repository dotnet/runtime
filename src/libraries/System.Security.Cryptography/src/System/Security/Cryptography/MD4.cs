...
namespace System.Security.Cryptography
{
    internal abstract class MD4 : HashAlgorithm
    {
        ...
        public static new MD4 Create() => new Implementation();

        [RequiresUnreferencedCode(CryptoConfig.CreateFromNameUnreferencedCodeMessage)]
        public static new MD4? Create(string algName) => (MD4?)CryptoConfig.CreateFromName(algName);

        private sealed class Implementation : MD4
        {
            private uint[] state;
            private byte[] buffer;
            private uint[] count;
            ...
            protected sealed override void HashCore(ReadOnlySpan<byte> source) => throw new NotImplementedException();
            ...
            protected sealed override bool TryHashFinal(Span<byte> destination, out int bytesWritten) => throw new NotImplementedException();
