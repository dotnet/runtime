...
namespace System.Security.Cryptography.X509Certificates.Asn1
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal ref partial struct ValueTimeAsn
    {
        internal DateTimeOffset? UtcTime;
        internal DateTimeOffset? GeneralTime;

        internal static void Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueTimeAsn decoded)
        {
            try
            {
        ...
        internal static void Decode(scoped ref ValueAsnReader reader, out ValueTimeAsn decoded)
        {
            try
            {
                DecodeCore(ref reader, out decoded);
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, out ValueTimeAsn decoded)
        {
            decoded = default;
            Asn1Tag tag = reader.PeekTag();
