...
namespace System.Security.Cryptography.X509Certificates.Asn1
{
    ...
    internal partial struct DistributionPointAsn
    {
        ...
        internal static void Decode(ref ValueAsnReader reader, ReadOnlyMemory<byte> rebind, out DistributionPointAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, rebind, out decoded);
        }

        internal static void Decode(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out DistributionPointAsn decoded)
        {
            try
            {
        ...
        private static void DecodeCore(ref ValueAsnReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out DistributionPointAsn decoded)
        {
            decoded = default;
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal ref partial struct ValueDistributionPointAsn
    {
        internal ReadOnlySpan<byte> DistributionPoint;
        internal bool HasDistributionPoint;
        internal System.Security.Cryptography.X509Certificates.Asn1.ReasonFlagsAsn? Reasons;
        internal ReadOnlySpan<byte> CRLIssuer;
        internal bool HasCRLIssuer;

        internal static void Decode(ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueDistributionPointAsn decoded)
        {
            Decode(Asn1Tag.Sequence, encoded, ruleSet, out decoded);
        }

        internal static void Decode(Asn1Tag expectedTag, ReadOnlySpan<byte> encoded, AsnEncodingRules ruleSet, out ValueDistributionPointAsn decoded)
        {
            try
            {
        ...
        internal static void Decode(scoped ref ValueAsnReader reader, out ValueDistributionPointAsn decoded)
        {
            Decode(ref reader, Asn1Tag.Sequence, out decoded);
        }

        internal static void Decode(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueDistributionPointAsn decoded)
        {
            try
            {
                DecodeCore(ref reader, expectedTag, out decoded);
        ...
        private static void DecodeCore(scoped ref ValueAsnReader reader, Asn1Tag expectedTag, out ValueDistributionPointAsn decoded)
        {
            decoded = default;
            ValueAsnReader sequenceReader = reader.ReadSequence(expectedTag);
            ValueAsnReader explicitReader;
            ...
            {
                explicitReader = sequenceReader.ReadSequence(new Asn1Tag(TagClass.ContextSpecific, 0));
                decoded.DistributionPoint = explicitReader.ReadEncodedValue();
                decoded.HasDistributionPoint = true;
                explicitReader.ThrowIfNotEmpty();
            }
            ...
            if (sequenceReader.HasData && sequenceReader.PeekTag().HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 2)))
            {
                decoded.CRLIssuer = sequenceReader.ReadEncodedValue();
                decoded.HasCRLIssuer = true;
            }
