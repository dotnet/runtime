...
namespace System.Security.Cryptography
{
    internal abstract class HpkeManagedKemAdapter : IDisposable
    {
        ...
        internal abstract void Decapsulate(ReadOnlySpan<byte> encapsulatedSecret, Span<byte> sharedSecret);
        internal abstract void ImportDecapsulationKey(ReadOnlySpan<byte> decapsulationKey);
