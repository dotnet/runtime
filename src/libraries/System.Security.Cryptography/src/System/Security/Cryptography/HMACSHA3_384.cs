...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    public class HMACSHA3_384 : HMAC, IHMACShared
    {
        ...
        static string IHMACShared.HashAlgorithmName => HashAlgorithmNames.SHA3_384;
        ...
        {
            CheckSha3Support();
            return HMACShared<HMACSHA3_384>.Verify(key, source, hash);
        }
        ...
        {
            CheckSha3Support();
            return HMACShared<HMACSHA3_384>.VerifyAsync(key, source, hash, cancellationToken);
        }
