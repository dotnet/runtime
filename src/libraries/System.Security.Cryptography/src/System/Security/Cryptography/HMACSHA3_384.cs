...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    public class HMACSHA3_384 : HMAC, IHMACStatic
    {
        ...
        {
            CheckSha3Support();
            return HMACStatic<HMACSHA3_384>.Verify(key, source, hash);
        }
        ...
        {
            CheckSha3Support();
            return HMACStatic<HMACSHA3_384>.VerifyAsync(key, source, hash, cancellationToken);
        }
