...
namespace System.Security.Cryptography
{
    ...
    public sealed class KmacXof256 : IDisposable
    {
        ...
        {
            static string IKmacStatic.HashAlgorithmName => HashAlgorithmNames.KMAC256;
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref="KmacXof256" /> class.
        /// </summary>
        ...
        /// </value>
        public static bool IsSupported { get; } = HashProviderDispenser.KmacSupported(HashAlgorithmNames.KMAC256);
        ...
        /// <summary>
        /// Computes the hash of data using the KMACXOF256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        ...
        /// <summary>
        /// Computes the hash of a stream using the KMACXOF256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
            ...
            byte[]? customizationString = null)
        {
            ...
            CheckPlatformSupport();
            return LiteHashProvider.KmacStream(HashAlgorithmNames.KMAC256, key, customizationString, outputLength, source, xof: true);
        }
            ...
            ReadOnlySpan<byte> customizationString = default)
        {
            ...
            CheckStreamCanRead(source);
            CheckPlatformSupport();
            LiteHashProvider.KmacStream(HashAlgorithmNames.KMAC256, key, customizationString, source, xof: true, destination);
        }

        /// <summary>
        /// Asynchronously computes the hash of a stream using the KMACXOF256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        /// <param name="source">The stream to hash.</param>
        /// <param name="outputLength">The size of the hash to produce.</param>
        ...
        /// <summary>
        ///   Verifies the hash of data using the KMACXOF256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        /// <param name="source">The data to hash.</param>
        ...
        /// <summary>
        ///   Verifies the hash of a stream using the KMACXOF256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        /// <param name="source">The stream to hash.</param>
        /// <param name="hash">The hash to compare against.</param>
        ...
        /// <summary>
        ///   Asynchronously verifies the hash of a stream using the KMACXOF256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        /// <param name="source">The stream to hash.</param>
        /// <param name="hash">The hash to compare against.</param>
