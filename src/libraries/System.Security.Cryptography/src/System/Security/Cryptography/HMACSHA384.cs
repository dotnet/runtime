...
namespace System.Security.Cryptography
{
    ...
    public class HMACSHA384 : HMAC, IHMACShared
    {
        /// <summary>
        ...
        static string IHMACShared.HashAlgorithmName => HashAlgorithmNames.SHA384;
        ...
        {
            return HMACShared<HMACSHA384>.Verify(key, source, hash);
        }
        ...
        public static ValueTask<bool> VerifyAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            return HMACShared<HMACSHA384>.VerifyAsync(key, source, hash, cancellationToken);
        }
