...
namespace System.Security.Cryptography
{
    ...
    public sealed class Kmac256 : IDisposable
    {
        ...
        private Kmac256(ConcurrentSafeKmac kmacProvider)
        {
        ...
        /// <summary>
        ///   Creates a new instance of <see cref="Kmac256" /> with the existing appended data preserved.
        /// </summary>
        ...
        {
            CheckDisposed();
            return new Kmac256(_kmacProvider.Clone());
        }
        ...
        /// <summary>
        ///   Release all resources used by the current instance of the <see cref="Kmac256" /> class.
        /// </summary>
        public void Dispose()
        {
            if (_disposed)
            ...
            byte[]? customizationString = null)
        {
            ...
            CheckPlatformSupport();
            return LiteHashProvider.KmacStream(HashAlgorithmNames.KMAC256, key, customizationString, outputLength, source, xof: false);
        }
            ...
            ReadOnlySpan<byte> customizationString = default)
        {
            ...
            CheckStreamCanRead(source);
            CheckPlatformSupport();
            LiteHashProvider.KmacStream(HashAlgorithmNames.KMAC256, key, customizationString, source, xof: false, destination);
        }
        ...
        /// <summary>
        ///   Verifies the hash of data using the KMAC256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        /// <param name="source">The data to hash.</param>
        ...
        /// <summary>
        ///   Asynchronously verifies the hash of a stream using the KMAC256 algorithm.
        /// </summary>
        /// <param name="key">The KMAC key.</param>
        /// <param name="source">The stream to hash.</param>
        /// <param name="hash">The hash to compare against.</param>
