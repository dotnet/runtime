...
namespace System.Security.Cryptography
{
    ...
    public abstract class SHA1 : HashAlgorithm
    {
        ...
        public static int HashData(Stream source, Span<byte> destination)
        {
            ...
            return LiteHashProvider.HashStream(HashAlgorithmNames.SHA1, HashSizeBytes, source, destination);
        }
        ...
        public static byte[] HashData(Stream source)
        {
            ...
            return LiteHashProvider.HashStream(HashAlgorithmNames.SHA1, HashSizeBytes, source);
        }
        ...
        public static ValueTask<byte[]> HashDataAsync(Stream source, CancellationToken cancellationToken = default)
        {
            ...
            return LiteHashProvider.HashStreamAsync(HashAlgorithmNames.SHA1, HashSizeBytes, source, cancellationToken);
        }
