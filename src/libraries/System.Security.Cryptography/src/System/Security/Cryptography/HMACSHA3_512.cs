...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    public class HMACSHA3_512 : HMAC, IHMACStatic
    {
        ...
        {
            CheckSha3Support();
            return HMACStatic<HMACSHA3_512>.Verify(key, source, hash);
        }
        ...
        {
            CheckSha3Support();
            return HMACStatic<HMACSHA3_512>.VerifyAsync(key, source, hash, cancellationToken);
        }
