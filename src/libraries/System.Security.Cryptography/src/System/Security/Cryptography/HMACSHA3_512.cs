...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    public class HMACSHA3_512 : HMAC, IHMACShared
    {
        ...
        static string IHMACShared.HashAlgorithmName => HashAlgorithmNames.SHA3_512;
        ...
        {
            CheckSha3Support();
            return HMACShared<HMACSHA3_512>.Verify(key, source, hash);
        }
        ...
        {
            CheckSha3Support();
            return HMACShared<HMACSHA3_512>.VerifyAsync(key, source, hash, cancellationToken);
        }
