...
namespace System.Security.Cryptography.Tests
{
    ...
    {
        internal static void InvalidFormatterArguments(AsymmetricSignatureFormatter formatter)
        {
        ...
        internal static void InvalidDeformatterArguments(AsymmetricSignatureDeformatter deformatter)
        {
