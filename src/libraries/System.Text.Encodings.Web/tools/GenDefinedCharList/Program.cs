...
namespace GenDefinedCharList
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            builder.AppendLine("// IF YOU NEED TO UPDATE UNICODE VERSION FOLLOW THE GUIDE AT src\coreclr\System.Private.CoreLib\Tools\GenUnicodeProp\Updating-Unicode-Versions.md");
            builder.AppendLine();
