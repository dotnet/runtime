...
*Note: For full instructions on how to update the Unicode version consumed by the whole repo (as opposed to just System.Text.Encondings.Web) please follow the steps on [this guide](../../../coreclr/System.Private.CoreLib/Tools/GenUnicodeProp/Updating-Unicode-Versions.md) instead.*
