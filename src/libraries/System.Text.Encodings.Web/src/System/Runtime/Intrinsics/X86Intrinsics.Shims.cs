...
namespace System.Runtime.Intrinsics
{
    ...
    {
        public static Vector128<sbyte> Create(sbyte value) => throw new PlatformNotSupportedException();
        public static unsafe Vector128<byte> Create(byte e0, byte e1, byte e2, byte e3, byte e4, byte e5, byte e6, byte e7, byte e8, byte e9, byte e10, byte e11, byte e12, byte e13, byte e14, byte e15) => throw new PlatformNotSupportedException();
        ...
        where T : struct
    {
        ...
        internal Vector128<ushort> AsInt32() => throw new PlatformNotSupportedException();

        internal Vector128<sbyte> AsSByte() => throw new PlatformNotSupportedException();
    }
}
...
namespace System.Runtime.Intrinsics.X86
{
    ...
    internal abstract class Ssse3
    {
        ...
        public const bool IsSupported = false;
        internal static Vector128<sbyte> Shuffle(Vector128<sbyte> left, Vector128<sbyte> right) => throw new PlatformNotSupportedException();
    }
}
