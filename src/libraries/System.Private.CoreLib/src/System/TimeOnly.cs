...
namespace System
{
          ...
          IUtf8SpanFormattable
    {
        ...
        bool IUtf8SpanFormattable.TryFormat(Span<byte> destination, out int bytesWritten, [StringSyntax(StringSyntaxAttribute.TimeOnlyFormat)] ReadOnlySpan<char> format, IFormatProvider? provider) =>
            TryFormatCore(destination, out bytesWritten, format, provider);
