...
namespace System
{
          ...
          IBinaryIntegerParseAndFormatInfo<ushort>
    {
        ...
        static bool INumberBase<ushort>.TryParse([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, out ushort result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
        ...
        static bool INumberBase<ushort>.TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, out ushort result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
        ...
        static bool INumberBase<ushort>.TryParse(ReadOnlySpan<byte> utf8Text, NumberStyles style, IFormatProvider? provider, out ushort result, out int bytesConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
