...
namespace System
{
          ...
          IUnsignedNumber<UInt128>
    {
        ...
        static bool IBinaryInteger<UInt128>.TryReadBigEndian(Span<byte> source, bool isUnsigned, out UInt128 value)
        {
            ...
            if (source.Length != 0)
            {
                ...
                if ((source.Length > Size) && (source[..^Size].IndexOfAnyExcept((byte)0x00) != -1))
                {
        ...
        static bool IBinaryInteger<UInt128>.TryReadLittleEndian(Span<byte> source, bool isUnsigned, out UInt128 value)
        {
            UInt128 result = default;
