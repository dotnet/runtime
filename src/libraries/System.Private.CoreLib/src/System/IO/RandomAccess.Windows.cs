    ...
    public static partial class RandomAccess
    {
        ...
        internal static unsafe int ReadAtOffset(SafeFileHandle handle, Span<byte> buffer, long fileOffset)
        {
            ...
            fixed (byte* pinned = &MemoryMarshal.GetReference(buffer))
            {
                ...
                {
                    // https://learn.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-readfile#synchronization-and-file-position:
        ...
        // From https://learn.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-readfilescatter:
        ...
        private static unsafe NativeOverlapped* GetNativeOverlappedForAsyncHandle(SafeFileHandle handle, long fileOffset, CallbackResetEvent resetEvent)
        {
            ...
            // From https://learn.microsoft.com/en-us/windows/win32/api/ioapiset/nf-ioapiset-getoverlappedresult:
        ...
        // From https://learn.microsoft.com/en-us/windows/win32/fileio/file-buffering:
