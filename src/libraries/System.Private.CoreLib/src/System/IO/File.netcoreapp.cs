...
namespace System.IO
{
    public static partial class File
    {
        ...
        /// -or-
        /// The file was too large (when <paramref name="preallocationSize" /> was provided and <paramref name="path" /> was pointing to a regular file).
        /// -or-
        /// <paramref name="path" /> is invalid (points to a device or is too long).</exception>
