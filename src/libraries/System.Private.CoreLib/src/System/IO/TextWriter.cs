...
namespace System.IO
{
    ...
    public abstract partial class TextWriter : MarshalByRefObject, IDisposable, IAsyncDisposable
    {
        ...
        internal sealed class SyncTextWriter : TextWriter, IDisposable
        {
            ...
            [MethodImpl(MethodImplOptions.Synchronized)]
            public override void Write([StringSyntax(StringSyntaxAttribute.CompositeFormat)] string format, scoped ReadOnlySpan<object?> arg) => _out.Write(format, arg);
            ...
            [MethodImpl(MethodImplOptions.Synchronized)]
            public override void WriteLine([StringSyntax(StringSyntaxAttribute.CompositeFormat)] string format, scoped ReadOnlySpan<object?> arg) => _out.WriteLine(format, arg);
