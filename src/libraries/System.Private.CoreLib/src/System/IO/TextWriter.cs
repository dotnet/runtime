...
namespace System.IO
{
    ...
    public abstract partial class TextWriter : MarshalByRefObject, IDisposable, IAsyncDisposable
    {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="writers"/> is <see langword="null"/>.</exception>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// <see cref="Encoding"/> will return the corresponding object from first writer in <paramref name="writers"/>.
        /// </para>
        /// </remarks>
