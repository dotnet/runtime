...
#endif
{
    ...
    public static class FileSystemName
    {
        ...
        /// <remarks>The syntax of the <paramref name="expression" /> parameter is based on the syntax used by <see cref="System.IO.FileSystemWatcher" />, which is based on [RtlIsNameInExpression](/windows/win32/devnotes/rtlisnameinexpression), which defines the rules for matching DOS wildcards (`'*'`, `'?'`, `'<'`, `'>'`, `'"'`).
        /// Matching will not correspond to Win32 behavior unless you transform the expression using <see cref="System.IO.Enumeration.FileSystemName.TranslateWin32Expression(string)" />.</remarks>
