...
namespace System
{
          ...
          IUtf8SpanFormattable
    {
        ...
        bool IUtf8SpanFormattable.TryFormat(Span<byte> destination, out int bytesWritten, [StringSyntax(StringSyntaxAttribute.DateTimeFormat)] ReadOnlySpan<char> format, IFormatProvider? provider) =>
            DateTimeFormat.TryFormat(this, destination, out bytesWritten, format, provider);
