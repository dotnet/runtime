...
#nullable restore
        ...
        /// <returns><paramref name="x" /> if it has the greater magnitude than <paramref name="y" />; otherwise, <paramref name="y" />.</returns>
        ...
        /// <param name="x">The value to compare with <paramref name="y" />.</param>
        /// <param name="y">The value to compare with <paramref name="x" />.</param>
        /// <returns><paramref name="x" /> if it has the lesser magnitude than <paramref name="y" />; otherwise, <paramref name="y" />.</returns>
