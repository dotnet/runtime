    ...
    internal static partial class Utf8Utility
    {
        ...
        private static nuint GetIndexOfFirstNonWhiteSpaceChar(ref byte utf8Data, nuint length)
        {
            ...
            while (i < length)
            {
                ...
                if ((sbyte)Unsafe.AddByteOffset(ref utf8Data, (IntPtr)i) > (sbyte)0x20) //TODO: remove IntPtr cast
                {
                    break;
                }

                uint possibleAsciiByte = Unsafe.AddByteOffset(ref utf8Data, (IntPtr)i); //TODO: remove IntPtr cast
