...
namespace System
{
          ...
          IBinaryIntegerParseAndFormatInfo<char>
    {
        ...
        ** This method throws if a low surrogate is seen without preceding a high-surrogate.
        ...
        public static bool TryParsePartial([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, out char result, out int charsConsumed)
        {
        ...
        public static bool TryParsePartial(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, out char result, out int charsConsumed)
        {
            if (TryParse(s, out result))
            {
                charsConsumed = 1;
        ...
        public static bool TryParsePartial(ReadOnlySpan<byte> utf8Text, NumberStyles style, IFormatProvider? provider, out char result, out int bytesConsumed)
        {
