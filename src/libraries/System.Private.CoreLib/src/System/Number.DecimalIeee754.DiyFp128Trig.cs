...
internal static partial class Number
{
    ...
    private static ReadOnlySpan<DiyFp128FixedCoefficient> TrigSinCoefficients => DiyFp128FixedCoefficients(
    [
        0x000000039E634562, 0x0000000000000000,
        0x000009F9DCE17A1D, 0x0000000000000000,
        0x001761B4083A3075, 0x0000000000000000,
        0x2E371DEDB1D75408, 0x0000000000000000,
        0xD26D1A05013C755B, 0x000000000000004B,
        0x1DC0C2B528320429, 0x000000000000654B,
        0x9CCEE07C4701FACD, 0x00000000006B9FCF,
        0xA1B425F28DFBF381, 0x000000005849184E,
        0x89C71FCE8FC76DB3, 0x00000035CC8ACFEA,
        0x338FAAC1C88E2826, 0x0000171DE3A556C7,
        0x8068068068067E8F, 0x0006806806806806,
        0x1111111111111106, 0x0111111111111111,
        0x5555555555555555, 0x1555555555555555,
        0x0000000000000000, 0x8000000000000000,
    ]);

    private static ReadOnlySpan<DiyFp128FixedCoefficient> TrigCosCoefficients => DiyFp128FixedCoefficients(
    [
        0x00000061A9FB87E2, 0x0000000000000000,
        0x0000F96669688C7C, 0x0000000000000000,
        0x0219C72C77C1DE0C, 0x0000000000000000,
        0xCA85747F51903A09, 0x0000000000000003,
        0x9E18EE5EEB393833, 0x00000000000005A0,
        0xF9CCEE079837094C, 0x000000000006B9FC,
        0x301F274823772903, 0x00000000064E5D2A,
        0x3625ED5134A72FA4, 0x000000047BB63BFE,
        0xEB8E5DE02D6A41E7, 0x0000024FC9F6EF13,
        0xD00D00D00CFBFFE1, 0x0000D00D00D00D00,
        0x82D82D82D82D4910, 0x002D82D82D82D82D,
        0x55555555555553EB, 0x0555555555555555,
        0xFFFFFFFFFFFFFFFC, 0x3FFFFFFFFFFFFFFF,
        0x0000000000000000, 0x8000000000000000,
    ]);

    private static ReadOnlySpan<DiyFp128FixedCoefficient> TrigTanNumeratorCoefficients => DiyFp128FixedCoefficients(
    [
        0x0000000000000000, 0x0000000000000000,
        0x02E36384AB86D966, 0x00000000004583DC,
        0xFE661C77C57437CF, 0x00000001DF2FB0D7,
        0xE5F9C2190062EE42, 0x0000036F46CAE26E,
        0x9C878717E15A162F, 0x000269DCA6FA2240,
        0xC5B462FFE65127B0, 0x00B209C04C0B8A2C,
        0xA273C25867F59A68, 0x12F6C9C3D7A587C9,
        0x0000000000000000, 0x8000000000000000,
    ]);

    private static ReadOnlySpan<DiyFp128FixedCoefficient> TrigTanDenominatorCoefficients => DiyFp128FixedCoefficients(
    [
        0x196C967ACBFC02D6, 0x000000000000A9BA,
        0xD03D3831CF5F2FE6, 0x000000000E1AE92D,
        0x40A36A10FD241F97, 0x0000002E4C98A51D,
        0xB12A527E72E00402, 0x0000338085B96B4F,
        0xF5E92D642C15CBC5, 0x001739C356378673,
        0x7902CB9A86202DFC, 0x042C1F7EBBBFDF42,
        0x4D1E6D0312A04513, 0x3DA1746E82503274,
        0x0000000000000000, 0x8000000000000000,
    ]);
