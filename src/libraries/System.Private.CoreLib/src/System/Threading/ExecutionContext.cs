...
#pragma warning restore CA1825, IDE0300
        ...
        {
            Debug.Assert(!Thread.IsMultiThreadedPlatform || Thread.CurrentThread.IsThreadPoolThread); // there are no dedicated threadpool threads on runtimes where we can't start threads
