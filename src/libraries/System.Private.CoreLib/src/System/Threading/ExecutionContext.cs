...
namespace System.Threading
{
    ...
    public sealed class ExecutionContext : IDisposable, ISerializable
    {
        ...
        internal static void RunInternal(ExecutionContext? executionContext, ContextCallback callback, object? state)
        {
            ...
            if (previousExecutionCtx0 is not null && previousExecutionCtx0.m_isDefault)
            {
        ...
        internal static void RunForThreadPoolUnsafe<TState>(ExecutionContext executionContext, Action<TState> callback, in TState state)
        {
            ...
            CheckThreadPoolAndContextsAreDefault();
            Debug.Assert(executionContext is not null && !executionContext.m_isDefault, "ExecutionContext argument is Default.");
