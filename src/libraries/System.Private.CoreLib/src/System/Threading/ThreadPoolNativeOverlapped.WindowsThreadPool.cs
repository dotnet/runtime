...
namespace System.Threading
{
    ...
    {
        private static unsafe Win32ThreadPoolNativeOverlapped* AllocateCore(IOCompletionCallback callback, object state, object pinData, PreAllocatedOverlapped preAllocated, bool flowExecutionControl)
        {
        ...
        private static unsafe void FreeCore(Win32ThreadPoolNativeOverlapped* overlapped)
        {
            // Reset all data.
        ...
        private static unsafe NativeOverlapped* ToNativeOverlappedCore(Win32ThreadPoolNativeOverlapped* overlapped)
        {
            return (NativeOverlapped*)overlapped;
        }

        private static unsafe Win32ThreadPoolNativeOverlapped* FromNativeOverlappedCore(NativeOverlapped* overlapped)
        {
            return (Win32ThreadPoolNativeOverlapped*)overlapped;
        }

        private static unsafe void CompleteWithCallbackCore(uint errorCode, uint bytesWritten, Win32ThreadPoolNativeOverlapped* overlapped)
        {
        ...
        private bool IsUserObjectCore(byte[]? buffer) => ReferenceEquals(Data._pinnedData, buffer);
    }
}
