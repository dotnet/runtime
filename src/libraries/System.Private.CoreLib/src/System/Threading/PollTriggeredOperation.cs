...
namespace System.Threading
{
    ...
    public abstract class PollTriggeredOperation : IThreadPoolWorkItem
    {
        ...
        /// Async nodes are inline when the owner's <see cref="PollableHandle.InlineCompletions"/> is set.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>The operation may be reused for another operation when <paramref name="result"/> is <see cref="PollOperationOnCompletedResult.Completed"/>.</remarks>
