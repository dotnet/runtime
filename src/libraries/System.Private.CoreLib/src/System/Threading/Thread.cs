...
namespace System.Threading
{
    public sealed partial class Thread : CriticalFinalizerObject
    {
        ...
        [Obsolete("Thread.GetCompressedStack is no longer supported. Use the System.Threading.CompressedStack class")]
        public CompressedStack GetCompressedStack()
        {
            throw new InvalidOperationException(SR.Thread_GetSetCompressedStack_NotSupported);
        }

        [Obsolete("Thread.SetCompressedStack is no longer supported. Use the System.Threading.CompressedStack class")]
