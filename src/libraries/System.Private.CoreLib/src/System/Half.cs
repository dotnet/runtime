...
namespace System
{
          ...
          IMinMaxValue<Half>
    {
        ...
        /// <summary>Implicitly converts a half-precision floating-point value to its nearest representable <see cref="NFloat" /> value.</summary>
        /// <param name="value">The value to convert.</param>
        /// <returns><paramref name="value" /> converted to its nearest representable <see cref="NFloat" /> value.</returns>
        ...
        /// <param name="value">The value which is used to create the instance of <see cref="Half" />.</param>
        /// <returns>An instance of <see cref="Half" /> created from <paramref name="value" />.</returns>
        /// <exception cref="NotSupportedException"><typeparamref name="TOther" /> is not supported.</exception>
        /// <exception cref="OverflowException"><paramref name="value" /> is not representable by <see cref="Half" />.</exception>
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            else if (!NumberBase<Half>.TryConvertFromChecked(value, out result) && !TOther.TryConvertToChecked(value, out result))
            {
        ...
        /// <typeparam name="TOther">The type of <paramref name="value" />.</typeparam>
        /// <param name="value">The value which is used to create the instance of <see cref="Half" />.</param>
        /// <returns>An instance of <see cref="Half" /> created from <paramref name="value" />, saturating if <paramref name="value" /> falls outside the representable range of <see cref="Half" />.</returns>
        /// <exception cref="NotSupportedException"><typeparamref name="TOther" /> is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            else if (!NumberBase<Half>.TryConvertFromSaturating(value, out result) && !TOther.TryConvertToSaturating(value, out result))
            {
                ThrowHelper.ThrowNotSupportedException();
            }
        ...
        /// <typeparam name="TOther">The type of <paramref name="value" />.</typeparam>
        /// <param name="value">The value which is used to create the instance of <see cref="Half" />.</param>
        /// <returns>An instance of <see cref="Half" /> created from <paramref name="value" />, truncating if <paramref name="value" /> falls outside the representable range of <see cref="Half" />.</returns>
        /// <exception cref="NotSupportedException"><typeparamref name="TOther" /> is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            else if (!NumberBase<Half>.TryConvertFromTruncating(value, out result) && !TOther.TryConvertToTruncating(value, out result))
            {
                ThrowHelper.ThrowNotSupportedException();
            }
