...
namespace System
{
    internal static partial class LocalAppContextSwitches
    {
        ...
        private static int s_disableSelfDescribingEventFiltering;
        public static bool DisableSelfDescribingEventFiltering
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => GetCachedSwitchValue("Switch.System.Diagnostics.EventListener.DisableSelfDescribingEventFiltering", ref s_disableSelfDescribingEventFiltering);
        }
