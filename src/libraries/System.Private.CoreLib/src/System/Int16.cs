...
namespace System
{
          ...
          ISignedNumber<short>
    {
        ...
        static bool IBinaryInteger<short>.TryReadBigEndian(Span<byte> source, bool isUnsigned, out short value)
        {
            ...
            if (source.Length != 0)
            {
                ...
                {
                    if (source[..^sizeof(short)].IndexOfAnyExcept((byte)sign) != -1)
                    {
        ...
        static bool IBinaryInteger<short>.TryReadLittleEndian(Span<byte> source, bool isUnsigned, out short value)
        {
            short result = default;
