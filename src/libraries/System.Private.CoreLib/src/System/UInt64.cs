...
namespace System
{
          ...
          IBinaryIntegerParseAndFormatInfo<ulong>
    {
        ...
        static bool INumberBase<ulong>.TryParse([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, out ulong result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
        ...
        static bool INumberBase<ulong>.TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, out ulong result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
        ...
        static bool INumberBase<ulong>.TryParse(ReadOnlySpan<byte> utf8Text, NumberStyles style, IFormatProvider? provider, out ulong result, out int bytesConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
