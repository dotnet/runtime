...
namespace System
{
          ...
          IBinaryIntegerParseAndFormatInfo<ulong>
    {
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, out ulong result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
        ...
        public static bool TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, out ulong result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
        ...
        public static bool TryParse(ReadOnlySpan<byte> utf8Text, NumberStyles style, IFormatProvider? provider, out ulong result, out int bytesConsumed)
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
