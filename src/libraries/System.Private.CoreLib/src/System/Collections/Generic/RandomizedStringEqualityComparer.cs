...
namespace System.Collections.Generic
{
    ...
    internal class RandomizedStringEqualityComparer : EqualityComparer<string?>, IInternalStringEqualityComparer
    {
        ...
        internal static RandomizedStringEqualityComparer Create(IEqualityComparer<string?> underlyingComparer, bool ignoreCase)
        {
            if (!ignoreCase)
            {
                return new RandomizedStringEqualityComparer(underlyingComparer);
            }
            else
            {
                return new RandomizedOrdinalIgnoreCaseComparer(underlyingComparer);
            }
        }
