...
namespace System
{
    ...
    public abstract partial class Array : ICloneable, IList, IStructuralComparable, IStructuralEquatable
    {
        ...
        int IStructuralComparable.CompareTo(object? other, IComparer comparer)
        {
            ...
            if (o is null || this.Length != o.Length)
            {
...
#pragma warning restore CA1825
        ...
        public static void Sort(Array keys, Array? items, int index, int length, IComparer? comparer)
        {
            if (keys is null)
                ThrowHelper.ThrowArgumentNullException(ExceptionArgument.keys);
            if (keys.Rank != 1 || (items is not null && items.Rank != 1))
                ThrowHelper.ThrowRankException(ExceptionResource.Rank_MultiDimNotSupported);
            int keysLowerBound = keys.GetLowerBound(0);
            if (items is not null && keysLowerBound != items.GetLowerBound(0))
            ...
            if (keys.Length - (index - keysLowerBound) < length || (items is not null && (index - keysLowerBound) > items.Length - length))
                ThrowHelper.ThrowArgumentException(ExceptionResource.Argument_InvalidOffLen);
            ...
            if (keys is object[] objKeys)
            {
                ...
                if (items is null || objItems is not null)
                {
            ...
            if (comparer == Comparer.Default)
            {
                ...
                if (items is null || items.GetCorElementTypeOfElementType() == et)
                {
        ...
        public static void Sort<TKey, TValue>(TKey[] keys, TValue[]? items, int index, int length, System.Collections.Generic.IComparer<TKey>? comparer)
        {
            ...
            if (length < 0)
                ThrowHelper.ThrowLengthArgumentOutOfRange_ArgumentOutOfRange_NeedNonNegNum();
            if (keys.Length - index < length || (items is not null && index > items.Length - length))
                ThrowHelper.ThrowArgumentException(ExceptionResource.Argument_InvalidOffLen);
