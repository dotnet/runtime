...
namespace System.Reflection
{
    ...
    internal sealed unsafe partial class MethodBaseInvoker
    {
...
#else
                _allocator = _declaringType!.GetOrCreateCacheEntry<RuntimeType.CreateUninitializedCache>();
#endif
            }
        }
        ...
        private MethodBaseInvoker(MethodBaseInvoker other)
        {
            ...
            {
                _invokeFunc = CreateIlInvokeFunc(backwardsCompat: true, _method, callCtorAsMethod: true, _strategy);
            }
        }
        ...
        internal object? InvokeWithNoArgs(object? obj, BindingFlags invokeAttr)
        {
            ...
            try
            {
                if (ShouldAllocate)
                {
                    ...
                    ((InvokeFunc_Obj0Args)_invokeFunc)(_functionPointer, obj);
                    return obj;
                }

#if MONO
                // Mono may call this method when invoking a constructor with no arguments.
            ...
            CultureInfo? culture)
        {
            ...
            try
            {
                ...
                {
                    return ((InvokeFunc_Obj1Arg)_invokeFunc)!(_functionPointer, obj, arg);
                }

                // The interpreted path needs to use the byref strategies.
            ...
            CultureInfo? culture)
        {
            ...
            try
            {
                if (ShouldAllocate)
                {
                    Debug.Assert(obj is null);
                    obj = CreateUninitializedObject();
                    ((InvokeFunc_Obj1Arg)_invokeFunc)!(_functionPointer, obj, arg1);
                }
                else
                {
                    obj = ((InvokeFunc_Obj1Arg)_invokeFunc)!(_functionPointer, obj, arg1);
                }
            }
            catch (Exception e) when ((invokeAttr & BindingFlags.DoNotWrapExceptions) == 0)
            {
            ...
            CultureInfo? culture)
        {
            ...
            try
            {
                if (ShouldAllocate)
                {
                    Debug.Assert(obj is null);
                    obj = CreateUninitializedObject();
                    ((InvokeFunc_Obj4Args)_invokeFunc)(_functionPointer, obj, copyOfArgs[0], copyOfArgs[1], copyOfArgs[2], copyOfArgs[3]);
                }
                else
                {
                    obj = ((InvokeFunc_Obj4Args)_invokeFunc)(_functionPointer, obj, copyOfArgs[0], copyOfArgs[1], copyOfArgs[2], copyOfArgs[3]);
                }
            }
            catch (Exception e) when ((invokeAttr & BindingFlags.DoNotWrapExceptions) == 0)
            {
            ...
            try
            {
                ...
                try
                {
                    if (ShouldAllocate)
                    {
                        Debug.Assert(obj is null);
                        obj = CreateUninitializedObject();
                        ((InvokeFunc_ObjSpanArgs)_invokeFunc)(_functionPointer, obj, copyOfArgs);
                        returnValue = obj;
                    }
                    else
                    {
                        returnValue = ((InvokeFunc_ObjSpanArgs)_invokeFunc)(_functionPointer, obj, copyOfArgs);
                    }
                }
                catch (Exception e) when ((invokeAttr & BindingFlags.DoNotWrapExceptions) == 0)
                {
            ...
            CultureInfo? culture)
        {
            ...
            try
            {
                if (ShouldAllocate)
                {
                    Debug.Assert(obj is null);
                    obj = CreateUninitializedObject();
                    ((InvokeFunc_RefArgs)_invokeFunc)(_functionPointer, obj, pByRefFixedStorage);
                    returnValue = obj;
                }
                else
                {
                    returnValue = ((InvokeFunc_RefArgs)_invokeFunc)(_functionPointer, obj, pByRefFixedStorage);
                }
            }
            catch (Exception e) when ((invokeAttr & BindingFlags.DoNotWrapExceptions) == 0)
            {
            ...
            try
            {
                ...
                try
                {
                    if (ShouldAllocate)
                    {
                        Debug.Assert(obj is null);
                        obj = CreateUninitializedObject();
                        ((InvokeFunc_RefArgs)_invokeFunc)(_functionPointer, obj, pByRefStorage);
                        returnValue = obj;
                    }
                    else
                    {
                        returnValue = ((InvokeFunc_RefArgs)_invokeFunc)(_functionPointer, obj, pByRefStorage);
                    }
                }
                catch (Exception e) when ((invokeAttr & BindingFlags.DoNotWrapExceptions) == 0)
                {
