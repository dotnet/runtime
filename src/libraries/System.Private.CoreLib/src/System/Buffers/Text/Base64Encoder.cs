    ...
    public static partial class Base64
    {
        ...
        internal readonly struct Base64EncoderByte : IBase64Encoder<byte>
        {
            ...
            public unsafe void EncodeOneOptionallyPadTwo(byte* oneByte, byte* dest, ref byte encodingMap)
            {
                ...
                uint result = Base64Helper.ConstructResult(i0, i1, EncodingPad, EncodingPad);
            ...
            public unsafe void EncodeTwoOptionallyPadOne(byte* twoBytes, byte* dest, ref byte encodingMap)
            {
                ...
                uint result = Base64Helper.ConstructResult(i0, i1, i2, EncodingPad);
                Unsafe.WriteUnaligned(dest, result);
            }
            ...
            {
                Base64Helper.AssertWrite<Vector512<sbyte>>(dest, destStart, destLength);
                str.Store(dest);
            }
            ...
            {
                Base64Helper.AssertWrite<Vector256<sbyte>>(dest, destStart, destLength);
            ...
            {
                Base64Helper.AssertWrite<Vector128<sbyte>>(dest, destStart, destLength);
                str.Store(dest);
            }
            ...
            {
                Base64Helper.AssertWrite<Vector128<byte>>(dest, destStart, destLength);
            ...
            {
                uint result = Base64Helper.Encode(threeBytes, ref encodingMap);
