                ...
                case 'G':
                    {
                        ...
                        Span<byte> digitsBuffer = stackalloc byte[Number.DecimalNumberBufferLength];
                        Number.NumberBuffer number = new Number.NumberBuffer(Number.NumberBufferKind.Decimal, digitsBuffer);
