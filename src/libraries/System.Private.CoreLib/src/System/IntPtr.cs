...
#if TARGET_64BIT
                    result = (nint)BinaryPrimitives.ReadInt64BigEndian(source.Slice(source.Length - sizeof(nint_t)));
#else
                    result = BinaryPrimitives.ReadInt32BigEndian(source.Slice(source.Length - sizeof(nint_t)));
#endif
                }
                else
                {
