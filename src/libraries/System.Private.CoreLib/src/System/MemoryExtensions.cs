...
namespace System
{
    ...
    public static partial class MemoryExtensions
    {
        ...
        public static Span<T> AsSpan<T>(this T[]? array, int start)
        {
            ...
            return new Span<T>(ref Unsafe.Add(ref MemoryMarshal.GetRawArrayData(array), start), array.Length - start);
        }
        ...
        public static Span<T> AsSpan<T>(this T[]? array, Index startIndex)
        {
            ...
            return new Span<T>(ref Unsafe.Add(ref MemoryMarshal.GetRawArrayData(array), actualIndex), array.Length - actualIndex);
        }
        ...
        public static Span<T> AsSpan<T>(this T[]? array, Range range)
        {
            ...
            return new Span<T>(ref Unsafe.Add(ref MemoryMarshal.GetRawArrayData(array), start), length);
        }
