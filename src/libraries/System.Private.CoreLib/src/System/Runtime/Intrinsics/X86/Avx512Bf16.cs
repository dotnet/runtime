...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Avx512Bf16 : Avx512F
    {
        ...
        public new abstract class VL : Avx512F.VL
        {
            ...
            /// <summary>
            ///   <para>__m128 _mm_dpbf16_ps (__m128 src, __m128bh a, __m128bh b)</para>
            ///   <para>  VDPBF16PS xmm1, xmm2, xmm3/m128</para>
            /// </summary>
            public static Vector128<float> MultiplyWideningAndAdd(Vector128<float> addend, Vector128<BFloat16> left, Vector128<BFloat16> right) => MultiplyWideningAndAdd(addend, left, right);

            /// <summary>
            ///   <para>__m256 _mm256_dpbf16_ps (__m256 src, __m256bh a, __m256bh b)</para>
            ///   <para>  VDPBF16PS ymm1, ymm2, ymm3/m256</para>
            /// </summary>
            public static Vector256<float> MultiplyWideningAndAdd(Vector256<float> addend, Vector256<BFloat16> left, Vector256<BFloat16> right) => MultiplyWideningAndAdd(addend, left, right);

            /// <summary>
            ///   <para>__m128bh _mm_cvtne2ps_pbh (__m128 a, __m128 b)</para>
            ///   <para>  VCVTNE2PS2BF16 xmm1, xmm2, xmm3/m128</para>
            /// </summary>
            public static Vector128<BFloat16> ConvertToBFloat16(Vector128<float> lower, Vector128<float> upper) => ConvertToBFloat16(lower, upper);

            /// <summary>
            ///   <para>__m256bh _mm256_cvtne2ps_pbh (__m256 a, __m256 b)</para>
            ///   <para>  VCVTNE2PS2BF16 ymm1, ymm2, ymm3/m256</para>
            /// </summary>
            public static Vector256<BFloat16> ConvertToBFloat16(Vector256<float> lower, Vector256<float> upper) => ConvertToBFloat16(lower, upper);
