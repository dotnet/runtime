...
{
    /// <summary>This class provides access to X86 SSE hardware instructions via intrinsics.</summary>
    [CLSCompliant(false)]
    public abstract class Sse : X86Base
    {
        ...
        /// <summary>This class provides access to the x86 SSE hardware instructions, that are only available to 64-bit processes, via intrinsics.</summary>
