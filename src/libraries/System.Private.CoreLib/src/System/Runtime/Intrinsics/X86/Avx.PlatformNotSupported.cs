...
{
    /// <summary>This class provides access to X86 AVX hardware instructions via intrinsics.</summary>
    [CLSCompliant(false)]
    public abstract class Avx : Sse42
    {
        ...
        /// <summary>This class provides access to the x86 AVX hardware instructions, that are only available to 64-bit processes, via intrinsics.</summary>
