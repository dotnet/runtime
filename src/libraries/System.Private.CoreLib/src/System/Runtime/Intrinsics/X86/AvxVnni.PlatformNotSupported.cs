...
{
    /// <summary>This class provides access to the x86 AVXVNNI hardware instructions via intrinsics.</summary>
    [CLSCompliant(false)]
    public abstract class AvxVnni : Avx2
    {
        ...
        /// <summary>This class provides access to the x86 AVXVNNI hardware instructions, that are only available to 64-bit processes, via intrinsics.</summary>
