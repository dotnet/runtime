...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Sse41 : Ssse3
    {
        ...
        ///   PINSRQ xmm, reg/m64, imm8
        /// </summary>
        public static Vector128<nint> Insert(Vector128<nint> value, nint data, byte index) { throw new PlatformNotSupportedException(); }
        ...
        ///   PINSRQ xmm, reg/m64, imm8
        /// </summary>
        public static Vector128<nuint> Insert(Vector128<nuint> value, nuint data, byte index) { throw new PlatformNotSupportedException(); }
