...
{
    /// <summary>This class provides access to X86 BMI2 hardware instructions via intrinsics.</summary>
    [Intrinsic]
    [CLSCompliant(false)]
    public abstract class Bmi2 : X86Base
    {
        ...
        /// <summary>This class provides access to the x86 BMI2 hardware instructions, that are only available to 64-bit processes, via intrinsics.</summary>
        [Intrinsic]
