...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Bmi2 : X86Base
    {
        ...
        ///   BZHI r64a, reg/m32, r64b
        /// </summary>
        public static nuint ZeroHighBits(nuint value, nuint index) => ZeroHighBits(value, index);
        ...
        /// The above native signature does not directly correspond to the managed signature.
        /// </summary>
        public static nuint MultiplyNoFlags(nuint left, nuint right) => MultiplyNoFlags(left, right);
        ...
        /// The above native signature does not directly correspond to the managed signature.
        /// </summary>
        public static unsafe nuint MultiplyNoFlags(nuint left, nuint right, nuint* low) => MultiplyNoFlags(left, right, low);
        ...
        ///   PDEP r64a, r64b, reg/m64
        /// </summary>
        public static nuint ParallelBitDeposit(nuint value, nuint mask) => ParallelBitDeposit(value, mask);
        ...
        ///   PEXT r64a, r64b, reg/m64
        /// </summary>
        public static nuint ParallelBitExtract(nuint value, nuint mask) => ParallelBitExtract(value, mask);
    }
}
