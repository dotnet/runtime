...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Gfni : Sse41
    {
        ...
        public abstract class V256
        {
            ...
            /// </summary>
            public static Vector256<byte> GaloisFieldAffineTransformInverse(Vector256<byte> x, Vector256<byte> a, [ConstantExpected] byte b) => throw new PlatformNotSupportedException();
            /// <summary>
            ...
            /// </summary>
            public static Vector256<byte> GaloisFieldAffineTransform(Vector256<byte> x, Vector256<byte> a, [ConstantExpected] byte b) => throw new PlatformNotSupportedException();
            /// <summary>
            ...
            /// </summary>
            public static Vector256<byte> GaloisFieldMultiply(Vector256<byte> left, Vector256<byte> right) => throw new PlatformNotSupportedException();
        }
        ...
        public abstract class V512
        {
            ...
            /// </summary>
            public static Vector512<byte> GaloisFieldAffineTransformInverse(Vector512<byte> x, Vector512<byte> a, [ConstantExpected] byte b) => throw new PlatformNotSupportedException();
            /// <summary>
            ...
            /// </summary>
            public static Vector512<byte> GaloisFieldAffineTransform(Vector512<byte> x, Vector512<byte> a, [ConstantExpected] byte b) => throw new PlatformNotSupportedException();
            /// <summary>
            ...
            /// </summary>
            public static Vector512<byte> GaloisFieldMultiply(Vector512<byte> left, Vector512<byte> right) => throw new PlatformNotSupportedException();
        }
        ...
        /// </summary>
        public static Vector128<byte> GaloisFieldAffineTransformInverse(Vector128<byte> x, Vector128<byte> a, [ConstantExpected] byte b) => throw new PlatformNotSupportedException();
        /// <summary>
        ...
        /// </summary>
        public static Vector128<byte> GaloisFieldAffineTransform(Vector128<byte> x, Vector128<byte> a, [ConstantExpected] byte b) => throw new PlatformNotSupportedException();
        /// <summary>
        ...
        /// </summary>
        public static Vector128<byte> GaloisFieldMultiply(Vector128<byte> left, Vector128<byte> right) => throw new PlatformNotSupportedException();
    }
}
