...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Ssse3 : Sse3
    {
        ...
        /// This intrinsic generates PALIGNR that operates over bytes rather than elements of the vectors.
        /// </summary>
        public static Vector128<nint> AlignRight(Vector128<nint> left, Vector128<nint> right, byte mask) => AlignRight(left, right, mask);
        ...
        /// This intrinsic generates PALIGNR that operates over bytes rather than elements of the vectors.
        /// </summary>
        public static Vector128<nuint> AlignRight(Vector128<nuint> left, Vector128<nuint> right, byte mask) => AlignRight(left, right, mask);
