...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Sse2 : Sse
    {
        ...
        ///   PAND xmm, xmm/m128
        /// </summary>
        public static Vector128<nint> And(Vector128<nint> left, Vector128<nint> right) => Add(left, right);
        ...
        ///   PAND xmm, xmm/m128
        /// </summary>
        public static Vector128<nuint> And(Vector128<nuint> left, Vector128<nuint> right) => Add(left, right);
        ...
        ///   MOVQ reg/m64, xmm
        /// </summary>
        public static nint ConvertToNInt(Vector128<nint> value) => ConvertToNInt(value);
        ...
        ///   MOVQ reg/m64, xmm
        /// </summary>
        public static nuint ConvertToNUInt(Vector128<nuint> value) => ConvertToNUInt(value);
        ...
        ///   MOVQ xmm, reg/m64
        /// </summary>
        public static Vector128<nint> ConvertScalarToVector128NInt(nint value) => ConvertScalarToVector128NInt(value);
        ...
        ///   MOVQ xmm, reg/m64
        /// </summary>
        public static Vector128<nuint> ConvertScalarToVector128NUInt(nuint value) => ConvertScalarToVector128NUInt(value);
        ...
        ///   MOVDQA xmm, m128
        /// </summary>
        public static unsafe Vector128<nint> LoadAlignedVector128(nint* address) => LoadAlignedVector128(address);

        /// <summary>
        /// __m128i _mm_load_si128 (__m128i const* mem_address)
        ///   MOVDQA xmm, m128
        /// </summary>
        public static unsafe Vector128<nuint> LoadAlignedVector128(nuint* address) => LoadAlignedVector128(address);
        ...
        ///   MOVQ xmm, xmm
        /// </summary>
        public static Vector128<nint> MoveScalar(Vector128<nint> value) => MoveScalar(value);

        /// <summary>
        /// __m128i _mm_move_epi64 (__m128i a)
        ///   MOVQ xmm, xmm
        /// </summary>
        public static Vector128<nuint> MoveScalar(Vector128<nuint> value) => MoveScalar(value);
        ...
        ///   PSLLQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nint> ShiftLeftLogical(Vector128<nint> value, Vector128<nint> count) => ShiftLeftLogical(value, count);

        /// <summary>
        /// __m128i _mm_sll_epi64 (__m128i a, __m128i count)
        ///   PSLLQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nuint> ShiftLeftLogical(Vector128<nuint> value, Vector128<nuint> count) => ShiftLeftLogical(value, count);
        ...
        ///   PSLLDQ xmm, imm8
        /// </summary>
        public static Vector128<nint> ShiftLeftLogical128BitLane(Vector128<nint> value, byte numBytes) => ShiftLeftLogical128BitLane(value, numBytes);

        /// <summary>
        /// __m128i _mm_bslli_si128 (__m128i a, int imm8)
        ///   PSLLDQ xmm, imm8
        /// </summary>
        public static Vector128<nuint> ShiftLeftLogical128BitLane(Vector128<nuint> value, byte numBytes) => ShiftLeftLogical128BitLane(value, numBytes);
        ...
        ///   PSRLQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nint> ShiftRightLogical(Vector128<nint> value, Vector128<nint> count) => ShiftRightLogical(value, count);

        /// <summary>
        /// __m128i _mm_srl_epi64 (__m128i a, __m128i count)
        ///   PSRLQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nuint> ShiftRightLogical(Vector128<nuint> value, Vector128<nuint> count) => ShiftRightLogical(value, count);
        ...
        ///   PSRLQ xmm, imm8
        /// </summary>
        public static Vector128<nint> ShiftRightLogical(Vector128<nint> value, byte count) => ShiftRightLogical(value, count);

        /// <summary>
        /// __m128i _mm_srli_epi64 (__m128i a,  int immediate)
        ///   PSRLQ xmm, imm8
        /// </summary>
        public static Vector128<nuint> ShiftRightLogical(Vector128<nuint> value, byte count) => ShiftRightLogical(value, count);
        ...
        ///   PSRLDQ xmm, imm8
        /// </summary>
        public static Vector128<nint> ShiftRightLogical128BitLane(Vector128<nint> value, byte numBytes) => ShiftRightLogical128BitLane(value, numBytes);

        /// <summary>
        /// __m128i _mm_bsrli_si128 (__m128i a, int imm8)
        ///   PSRLDQ xmm, imm8
        /// </summary>
        public static Vector128<nuint> ShiftRightLogical128BitLane(Vector128<nuint> value, byte numBytes) => ShiftRightLogical128BitLane(value, numBytes);
        ...
        ///   MOVD m32, xmm
        /// </summary>
        public static unsafe void StoreScalar(nint* address, Vector128<nint> source) => StoreScalar(address, source);

        /// <summary>
        /// void _mm_storel_epi64 (__m128i* mem_addr, __m128i a)
        ///   MOVQ m64, xmm
        /// </summary>
        public static unsafe void StoreScalar(nuint* address, Vector128<nuint> source) => StoreScalar(address, source);
        ...
        ///   MOVDQA m128, xmm
        /// </summary>
        public static unsafe void StoreAligned(nint* address, Vector128<nint> source) => StoreAligned(address, source);

        /// <summary>
        /// void _mm_store_si128 (__m128i* mem_addr, __m128i a)
        ///   MOVDQA m128, xmm
        /// </summary>
        public static unsafe void StoreAligned(nuint* address, Vector128<nuint> source) => StoreAligned(address, source);
        ...
        ///   MOVNTDQ m128, xmm
        /// </summary>
        public static unsafe void StoreAlignedNonTemporal(nint* address, Vector128<nint> source) => StoreAlignedNonTemporal(address, source);

        /// <summary>
        /// void _mm_stream_si128 (__m128i* mem_addr, __m128i a)
        ///   MOVNTDQ m128, xmm
        /// </summary>
        public static unsafe void StoreAlignedNonTemporal(nuint* address, Vector128<nuint> source) => StoreAlignedNonTemporal(address, source);
        ...
        ///   MOVNTI m64, r64
        /// </summary>
        public static unsafe void StoreNonTemporal(nint* address, nint value) => StoreNonTemporal(address, value);
        ...
        ///   MOVNTI m64, r64
        /// </summary>
        public static unsafe void StoreNonTemporal(nuint* address, nuint value) => StoreNonTemporal(address, value);
        ...
        ///   PUNPCKHQDQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nint> UnpackHigh(Vector128<nint> left, Vector128<nint> right) => UnpackHigh(left, right);
        ...
        ///   PUNPCKHQDQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nuint> UnpackHigh(Vector128<nuint> left, Vector128<nuint> right) => UnpackHigh(left, right);
        ...
        ///   PUNPCKLQDQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nint> UnpackLow(Vector128<nint> left, Vector128<nint> right) => UnpackLow(left, right);
        ...
        ///   PUNPCKLQDQ xmm, xmm/m128
        /// </summary>
        public static Vector128<nuint> UnpackLow(Vector128<nuint> left, Vector128<nuint> right) => UnpackLow(left, right);
