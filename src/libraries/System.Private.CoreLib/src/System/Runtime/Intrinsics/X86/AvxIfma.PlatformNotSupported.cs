...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class AvxIfma : Avx2
    {
        ...
        /// </summary>
        public static Vector128<ulong> MultiplyAdd52Low(Vector128<ulong> addend, Vector128<ulong> left, Vector128<ulong> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        ///   <para>__m256i _mm256_madd52lo_epu64 (__m256i a, __m256i b, __m256i c)</para>
        ///   <para>VPMADD52LUQ ymm, ymm, ymm/m256</para>
        /// </summary>
        public static Vector256<ulong> MultiplyAdd52Low(Vector256<ulong> addend, Vector256<ulong> left, Vector256<ulong> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        ///   <para>__m128i _mm_madd52hi_epu64 (__m128i a, __m128i b, __m128i c)</para>
        ///   <para>VPMADD52HUQ xmm, xmm, xmm/m128</para>
        /// </summary>
        public static Vector128<ulong> MultiplyAdd52High(Vector128<ulong> addend, Vector128<ulong> left, Vector128<ulong> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        ///   <para>__m256i _mm256_madd52hi_epu64 (__m256i a, __m256i b, __m256i c)</para>
        ///   <para>VPMADD52HUQ ymm, ymm, ymm/m256</para>
        /// </summary>
        public static Vector256<ulong> MultiplyAdd52High(Vector256<ulong> addend, Vector256<ulong> left, Vector256<ulong> right) { throw new PlatformNotSupportedException(); }
        ...
        public abstract class V512
        {
            ...
            /// </summary>
            public static Vector512<ulong> MultiplyAdd52Low(Vector512<ulong> addend, Vector512<ulong> left, Vector512<ulong> right) { throw new PlatformNotSupportedException(); }

            /// <summary>
            ///   <para>__m512i _mm512_madd52hi_epu64 (__m512i a, __m512i b, __m512i c)</para>
            ///   <para>VPMADD52HUQ zmm, zmm, zmm/m512</para>
            /// </summary>
            public static Vector512<ulong> MultiplyAdd52High(Vector512<ulong> addend, Vector512<ulong> left, Vector512<ulong> right) { throw new PlatformNotSupportedException(); }
        }
    }
}
