...
{
    /// <summary>This class provides access to X86 SSE2 hardware instructions via intrinsics.</summary>
    [CLSCompliant(false)]
    public abstract class Sse2 : Sse
    {
        ...
        /// <summary>This class provides access to the x86 SSE2 hardware instructions, that are only available to 64-bit processes, via intrinsics.</summary>
