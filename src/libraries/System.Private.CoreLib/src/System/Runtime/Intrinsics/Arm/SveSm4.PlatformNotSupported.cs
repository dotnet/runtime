...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class SveSm4 : ArmBase
    {
        ...
        /// </summary>
        public static Vector<uint> Encode(Vector<uint> value, Vector<uint> roundKeys) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector<uint> KeyUpdate(Vector<uint> value, Vector<uint> constant) { throw new PlatformNotSupportedException(); }
