...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class SveSm4 : ArmBase
    {
        ...
        /// </summary>
        public static Vector<uint> Encode(Vector<uint> value, Vector<uint> roundKeys) => Encode(value, roundKeys);
        ...
        /// </summary>
        public static Vector<uint> KeyUpdate(Vector<uint> value, Vector<uint> constant) => KeyUpdate(value, constant);
