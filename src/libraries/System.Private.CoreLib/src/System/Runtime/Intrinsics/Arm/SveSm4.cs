...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class SveSm4 : ArmBase
    {
        ...
        /// </summary>
        public static unsafe Vector<uint> Encode(Vector<uint> left, Vector<uint> right) => Encode(left, right);
        ...
        /// </summary>
        public static unsafe Vector<uint> KeyUpdate(Vector<uint> left, Vector<uint> right) => KeyUpdate(left, right);
