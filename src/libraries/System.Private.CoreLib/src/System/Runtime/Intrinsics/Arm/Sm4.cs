...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class Sm4 : ArmBase
    {
        ...
        ///   SM4E Vd.4S,Vn.4S
        /// </summary>
        public static unsafe Vector128<uint> Encode(Vector128<uint> a, Vector128<uint> b) => Encode(a, b);
        ...
        /// </summary>
        public static unsafe Vector128<uint> KeyUpdate(Vector128<uint> a, Vector128<uint> b) => KeyUpdate(a, b);
