...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class Sm4 : ArmBase
    {
        ...
        ///   SM4E Vd.4S,Vn.4S
        /// </summary>
        public static Vector128<uint> Encode(Vector128<uint> value, Vector128<uint> roundKeys) => Encode(value, roundKeys);
        ...
        /// </summary>
        public static Vector128<uint> KeyUpdate(Vector128<uint> value, Vector128<uint> constant) => KeyUpdate(value, constant);
