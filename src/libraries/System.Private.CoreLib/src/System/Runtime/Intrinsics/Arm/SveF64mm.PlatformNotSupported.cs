...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class SveF64mm : AdvSimd
    {
        ...
        /// </summary>
        public static unsafe Vector<sbyte> LoadVector256AndReplicateToVector(Vector<sbyte> mask, const sbyte *base) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static unsafe Vector<short> LoadVector256AndReplicateToVector(Vector<short> mask, const short *base) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static unsafe Vector<int> LoadVector256AndReplicateToVector(Vector<int> mask, const int *base) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static unsafe Vector<long> LoadVector256AndReplicateToVector(Vector<long> mask, const long *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROB Zresult.B, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<byte> LoadVector256AndReplicateToVector(Vector<byte> mask, const byte *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROH Zresult.H, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<ushort> LoadVector256AndReplicateToVector(Vector<ushort> mask, const ushort *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROW Zresult.S, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<uint> LoadVector256AndReplicateToVector(Vector<uint> mask, const uint *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROD Zresult.D, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<ulong> LoadVector256AndReplicateToVector(Vector<ulong> mask, const ulong *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROH Zresult.H, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<bfloat16> LoadVector256AndReplicateToVector(Vector<bfloat16> mask, const bfloat16 *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROH Zresult.H, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<half> LoadVector256AndReplicateToVector(Vector<half> mask, const half *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROW Zresult.S, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<float> LoadVector256AndReplicateToVector(Vector<float> mask, const float *base) { throw new PlatformNotSupportedException(); }
        ...
        ///   LD1ROD Zresult.D, Pg/Z, [Xbase, #0]
        /// </summary>
        public static unsafe Vector<double> LoadVector256AndReplicateToVector(Vector<double> mask, const double *base) { throw new PlatformNotSupportedException(); }
