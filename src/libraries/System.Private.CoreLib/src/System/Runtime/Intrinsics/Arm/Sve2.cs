...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class Sve2 : AdvSimd
    {
        ...
        /// </summary>
        public static unsafe Vector<sbyte> AbsoluteDifferenceAdd(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<short> AbsoluteDifferenceAdd(Vector<short> op1, Vector<short> op2, Vector<short> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<int> AbsoluteDifferenceAdd(Vector<int> op1, Vector<int> op2, Vector<int> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<long> AbsoluteDifferenceAdd(Vector<long> op1, Vector<long> op2, Vector<long> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<byte> AbsoluteDifferenceAdd(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<ushort> AbsoluteDifferenceAdd(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<uint> AbsoluteDifferenceAdd(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<ulong> AbsoluteDifferenceAdd(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => AbsoluteDifferenceAdd(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<short> AbsoluteDifferenceAddWideningLower(Vector<short> op1, Vector<sbyte> op2, Vector<sbyte> op3) => AbsoluteDifferenceAddWideningLower(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<int> AbsoluteDifferenceAddWideningLower(Vector<int> op1, Vector<short> op2, Vector<short> op3) => AbsoluteDifferenceAddWideningLower(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<long> AbsoluteDifferenceAddWideningLower(Vector<long> op1, Vector<int> op2, Vector<int> op3) => AbsoluteDifferenceAddWideningLower(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<ushort> AbsoluteDifferenceAddWideningLower(Vector<ushort> op1, Vector<byte> op2, Vector<byte> op3) => AbsoluteDifferenceAddWideningLower(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<uint> AbsoluteDifferenceAddWideningLower(Vector<uint> op1, Vector<ushort> op2, Vector<ushort> op3) => AbsoluteDifferenceAddWideningLower(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<ulong> AbsoluteDifferenceAddWideningLower(Vector<ulong> op1, Vector<uint> op2, Vector<uint> op3) => AbsoluteDifferenceAddWideningLower(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<short> AbsoluteDifferenceAddWideningUpper(Vector<short> op1, Vector<sbyte> op2, Vector<sbyte> op3) => AbsoluteDifferenceAddWideningUpper(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<int> AbsoluteDifferenceAddWideningUpper(Vector<int> op1, Vector<short> op2, Vector<short> op3) => AbsoluteDifferenceAddWideningUpper(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<long> AbsoluteDifferenceAddWideningUpper(Vector<long> op1, Vector<int> op2, Vector<int> op3) => AbsoluteDifferenceAddWideningUpper(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<ushort> AbsoluteDifferenceAddWideningUpper(Vector<ushort> op1, Vector<byte> op2, Vector<byte> op3) => AbsoluteDifferenceAddWideningUpper(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<uint> AbsoluteDifferenceAddWideningUpper(Vector<uint> op1, Vector<ushort> op2, Vector<ushort> op3) => AbsoluteDifferenceAddWideningUpper(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<ulong> AbsoluteDifferenceAddWideningUpper(Vector<ulong> op1, Vector<uint> op2, Vector<uint> op3) => AbsoluteDifferenceAddWideningUpper(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> AddRotateComplex(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> AddRotateComplex(Vector<short> op1, Vector<short> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> AddRotateComplex(Vector<int> op1, Vector<int> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<long> AddRotateComplex(Vector<long> op1, Vector<long> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CADD Zresult.B, Zresult.B, Zop2.B, #imm_rotation
        /// </summary>
        public static unsafe Vector<byte> AddRotateComplex(Vector<byte> op1, Vector<byte> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CADD Zresult.H, Zresult.H, Zop2.H, #imm_rotation
        /// </summary>
        public static unsafe Vector<ushort> AddRotateComplex(Vector<ushort> op1, Vector<ushort> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CADD Zresult.S, Zresult.S, Zop2.S, #imm_rotation
        /// </summary>
        public static unsafe Vector<uint> AddRotateComplex(Vector<uint> op1, Vector<uint> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CADD Zresult.D, Zresult.D, Zop2.D, #imm_rotation
        /// </summary>
        public static unsafe Vector<ulong> AddRotateComplex(Vector<ulong> op1, Vector<ulong> op2, ulong imm_rotation) => AddRotateComplex(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> BitwiseClearXor(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<short> BitwiseClearXor(Vector<short> op1, Vector<short> op2, Vector<short> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<int> BitwiseClearXor(Vector<int> op1, Vector<int> op2, Vector<int> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<long> BitwiseClearXor(Vector<long> op1, Vector<long> op2, Vector<long> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<byte> BitwiseClearXor(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ushort> BitwiseClearXor(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<uint> BitwiseClearXor(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BCAX Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ulong> BitwiseClearXor(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => BitwiseClearXor(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> BitwiseSelect(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<short> BitwiseSelect(Vector<short> op1, Vector<short> op2, Vector<short> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<int> BitwiseSelect(Vector<int> op1, Vector<int> op2, Vector<int> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<long> BitwiseSelect(Vector<long> op1, Vector<long> op2, Vector<long> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<byte> BitwiseSelect(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ushort> BitwiseSelect(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<uint> BitwiseSelect(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => BitwiseSelect(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ulong> BitwiseSelect(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => BitwiseSelect(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> BitwiseSelectFirstInverted(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<short> BitwiseSelectFirstInverted(Vector<short> op1, Vector<short> op2, Vector<short> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<int> BitwiseSelectFirstInverted(Vector<int> op1, Vector<int> op2, Vector<int> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<long> BitwiseSelectFirstInverted(Vector<long> op1, Vector<long> op2, Vector<long> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<byte> BitwiseSelectFirstInverted(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ushort> BitwiseSelectFirstInverted(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<uint> BitwiseSelectFirstInverted(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL1N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ulong> BitwiseSelectFirstInverted(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => BitwiseSelectFirstInverted(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> BitwiseSelectInverted(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<short> BitwiseSelectInverted(Vector<short> op1, Vector<short> op2, Vector<short> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<int> BitwiseSelectInverted(Vector<int> op1, Vector<int> op2, Vector<int> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<long> BitwiseSelectInverted(Vector<long> op1, Vector<long> op2, Vector<long> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<byte> BitwiseSelectInverted(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ushort> BitwiseSelectInverted(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<uint> BitwiseSelectInverted(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; NBSL Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ulong> BitwiseSelectInverted(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => BitwiseSelectInverted(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> BitwiseSelectSecondInverted(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<short> BitwiseSelectSecondInverted(Vector<short> op1, Vector<short> op2, Vector<short> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<int> BitwiseSelectSecondInverted(Vector<int> op1, Vector<int> op2, Vector<int> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<long> BitwiseSelectSecondInverted(Vector<long> op1, Vector<long> op2, Vector<long> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<byte> BitwiseSelectSecondInverted(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ushort> BitwiseSelectSecondInverted(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<uint> BitwiseSelectSecondInverted(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; BSL2N Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ulong> BitwiseSelectSecondInverted(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => BitwiseSelectSecondInverted(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> CreateWhileReadAfterWriteMask(const sbyte left, const sbyte right) => CreateWhileReadAfterWriteMask(sbyte, sbyte);

        /// <summary>
        /// svbool_t svwhilerw[_s16](const int16_t *op1, const int16_t *op2)
        ///   WHILERW Presult.H, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<short> CreateWhileReadAfterWriteMask(const short left, const short right) => CreateWhileReadAfterWriteMask(short, short);

        /// <summary>
        /// svbool_t svwhilerw[_s32](const int32_t *op1, const int32_t *op2)
        ///   WHILERW Presult.S, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<int> CreateWhileReadAfterWriteMask(const int left, const int right) => CreateWhileReadAfterWriteMask(int, int);

        /// <summary>
        /// svbool_t svwhilerw[_s64](const int64_t *op1, const int64_t *op2)
        ///   WHILERW Presult.D, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<long> CreateWhileReadAfterWriteMask(const long left, const long right) => CreateWhileReadAfterWriteMask(long, long);

        /// <summary>
        /// svbool_t svwhilerw[_u8](const uint8_t *op1, const uint8_t *op2)
        ///   WHILERW Presult.B, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<byte> CreateWhileReadAfterWriteMask(const byte left, const byte right) => CreateWhileReadAfterWriteMask(byte, byte);

        /// <summary>
        /// svbool_t svwhilerw[_u16](const uint16_t *op1, const uint16_t *op2)
        ///   WHILERW Presult.H, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<ushort> CreateWhileReadAfterWriteMask(const ushort left, const ushort right) => CreateWhileReadAfterWriteMask(ushort, ushort);

        /// <summary>
        /// svbool_t svwhilerw[_u32](const uint32_t *op1, const uint32_t *op2)
        ///   WHILERW Presult.S, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<uint> CreateWhileReadAfterWriteMask(const uint left, const uint right) => CreateWhileReadAfterWriteMask(uint, uint);

        /// <summary>
        /// svbool_t svwhilerw[_u64](const uint64_t *op1, const uint64_t *op2)
        ///   WHILERW Presult.D, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<ulong> CreateWhileReadAfterWriteMask(const ulong left, const ulong right) => CreateWhileReadAfterWriteMask(ulong, ulong);

        /// <summary>
        /// svbool_t svwhilerw[_f32](const float32_t *op1, const float32_t *op2)
        ///   WHILERW Presult.S, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<float> CreateWhileReadAfterWriteMask(const float left, const float right) => CreateWhileReadAfterWriteMask(float, float);

        /// <summary>
        /// svbool_t svwhilerw[_f64](const float64_t *op1, const float64_t *op2)
        ///   WHILERW Presult.D, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<double> CreateWhileReadAfterWriteMask(const double left, const double right) => CreateWhileReadAfterWriteMask(double, double);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> CreateWhileWriteAfterReadMask(const sbyte left, const sbyte right) => CreateWhileWriteAfterReadMask(sbyte, sbyte);

        /// <summary>
        /// svbool_t svwhilewr[_s16](const int16_t *op1, const int16_t *op2)
        ///   WHILEWR Presult.H, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<short> CreateWhileWriteAfterReadMask(const short left, const short right) => CreateWhileWriteAfterReadMask(short, short);

        /// <summary>
        /// svbool_t svwhilewr[_s32](const int32_t *op1, const int32_t *op2)
        ///   WHILEWR Presult.S, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<int> CreateWhileWriteAfterReadMask(const int left, const int right) => CreateWhileWriteAfterReadMask(int, int);

        /// <summary>
        /// svbool_t svwhilewr[_s64](const int64_t *op1, const int64_t *op2)
        ///   WHILEWR Presult.D, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<long> CreateWhileWriteAfterReadMask(const long left, const long right) => CreateWhileWriteAfterReadMask(long, long);

        /// <summary>
        /// svbool_t svwhilewr[_u8](const uint8_t *op1, const uint8_t *op2)
        ///   WHILEWR Presult.B, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<byte> CreateWhileWriteAfterReadMask(const byte left, const byte right) => CreateWhileWriteAfterReadMask(byte, byte);

        /// <summary>
        /// svbool_t svwhilewr[_u16](const uint16_t *op1, const uint16_t *op2)
        ///   WHILEWR Presult.H, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<ushort> CreateWhileWriteAfterReadMask(const ushort left, const ushort right) => CreateWhileWriteAfterReadMask(ushort, ushort);

        /// <summary>
        /// svbool_t svwhilewr[_u32](const uint32_t *op1, const uint32_t *op2)
        ///   WHILEWR Presult.S, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<uint> CreateWhileWriteAfterReadMask(const uint left, const uint right) => CreateWhileWriteAfterReadMask(uint, uint);

        /// <summary>
        /// svbool_t svwhilewr[_u64](const uint64_t *op1, const uint64_t *op2)
        ///   WHILEWR Presult.D, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<ulong> CreateWhileWriteAfterReadMask(const ulong left, const ulong right) => CreateWhileWriteAfterReadMask(ulong, ulong);

        /// <summary>
        /// svbool_t svwhilewr[_f32](const float32_t *op1, const float32_t *op2)
        ///   WHILEWR Presult.S, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<float> CreateWhileWriteAfterReadMask(const float left, const float right) => CreateWhileWriteAfterReadMask(float, float);

        /// <summary>
        /// svbool_t svwhilewr[_f64](const float64_t *op1, const float64_t *op2)
        ///   WHILEWR Presult.D, Xop1, Xop2
        /// </summary>
        public static unsafe Vector<double> CreateWhileWriteAfterReadMask(const double left, const double right) => CreateWhileWriteAfterReadMask(double, double);
        ...
        /// </summary>
        public static unsafe Vector<int> DotProductComplex(Vector<int> op1, Vector<sbyte> op2, Vector<sbyte> op3, ulong imm_rotation) => DotProductComplex(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> DotProductComplex(Vector<int> op1, Vector<sbyte> op2, Vector<sbyte> op3, ulong imm_index, ulong imm_rotation) => DotProductComplex(op1, op2, op3, imm_index, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<long> DotProductComplex(Vector<long> op1, Vector<short> op2, Vector<short> op3, ulong imm_rotation) => DotProductComplex(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<long> DotProductComplex(Vector<long> op1, Vector<short> op2, Vector<short> op3, ulong imm_index, ulong imm_rotation) => DotProductComplex(op1, op2, op3, imm_index, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorByteSignExtendNonTemporal(Vector<int> mask, Vector<uint> bases) => GatherVectorByteSignExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorByteSignExtendNonTemporal(Vector<int> mask, const sbyte *base, Vector<uint> offsets) => GatherVectorByteSignExtendNonTemporal(mask, sbyte, offsets);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorByteSignExtendNonTemporal(Vector<int> mask, Vector<uint> bases, long offset) => GatherVectorByteSignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1sb_gather[_u64base]_s64(svbool_t pg, svuint64_t bases)
        ///   LDNT1SB Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteSignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorByteSignExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteSignExtendNonTemporal(Vector<long> mask, const sbyte *base, Vector<long> offsets) => GatherVectorByteSignExtendNonTemporal(mask, sbyte, offsets);

        /// <summary>
        /// svint64_t svldnt1sb_gather_[u64]offset_s64(svbool_t pg, const int8_t *base, svuint64_t offsets)
        ///   LDNT1SB Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteSignExtendNonTemporal(Vector<long> mask, const sbyte *base, Vector<ulong> offsets) => GatherVectorByteSignExtendNonTemporal(mask, sbyte, offsets);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteSignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorByteSignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint32_t svldnt1sb_gather[_u32base]_u32(svbool_t pg, svuint32_t bases)
        ///   LDNT1SB Zresult.S, Pg/Z, [Zbases.S, XZR]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorByteSignExtendNonTemporal(Vector<uint> mask, Vector<uint> bases) => GatherVectorByteSignExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint32_t svldnt1sb_gather_[u32]offset_u32(svbool_t pg, const int8_t *base, svuint32_t offsets)
        ///   LDNT1SB Zresult.S, Pg/Z, [Zoffsets.S, Xbase]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorByteSignExtendNonTemporal(Vector<uint> mask, const sbyte *base, Vector<uint> offsets) => GatherVectorByteSignExtendNonTemporal(mask, sbyte, offsets);

        /// <summary>
        /// svuint32_t svldnt1sb_gather[_u32base]_offset_u32(svbool_t pg, svuint32_t bases, int64_t offset)
        ///   LDNT1SB Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorByteSignExtendNonTemporal(Vector<uint> mask, Vector<uint> bases, long offset) => GatherVectorByteSignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1sb_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1SB Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteSignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorByteSignExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1sb_gather_[s64]offset_u64(svbool_t pg, const int8_t *base, svint64_t offsets)
        ///   LDNT1SB Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteSignExtendNonTemporal(Vector<ulong> mask, const sbyte *base, Vector<long> offsets) => GatherVectorByteSignExtendNonTemporal(mask, sbyte, offsets);

        /// <summary>
        /// svuint64_t svldnt1sb_gather_[u64]offset_u64(svbool_t pg, const int8_t *base, svuint64_t offsets)
        ///   LDNT1SB Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteSignExtendNonTemporal(Vector<ulong> mask, const sbyte *base, Vector<ulong> offsets) => GatherVectorByteSignExtendNonTemporal(mask, sbyte, offsets);

        /// <summary>
        /// svuint64_t svldnt1sb_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1SB Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteSignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorByteSignExtendNonTemporal(mask, bases, offset);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorByteZeroExtendNonTemporal(Vector<int> mask, Vector<uint> bases) => GatherVectorByteZeroExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorByteZeroExtendNonTemporal(Vector<int> mask, const byte *base, Vector<uint> offsets) => GatherVectorByteZeroExtendNonTemporal(mask, byte, offsets);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorByteZeroExtendNonTemporal(Vector<int> mask, Vector<uint> bases, long offset) => GatherVectorByteZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1ub_gather[_u64base]_s64(svbool_t pg, svuint64_t bases)
        ///   LDNT1B Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorByteZeroExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteZeroExtendNonTemporal(Vector<long> mask, const byte *base, Vector<long> offsets) => GatherVectorByteZeroExtendNonTemporal(mask, byte, offsets);

        /// <summary>
        /// svint64_t svldnt1ub_gather_[u64]offset_s64(svbool_t pg, const uint8_t *base, svuint64_t offsets)
        ///   LDNT1B Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteZeroExtendNonTemporal(Vector<long> mask, const byte *base, Vector<ulong> offsets) => GatherVectorByteZeroExtendNonTemporal(mask, byte, offsets);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorByteZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorByteZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint32_t svldnt1ub_gather[_u32base]_u32(svbool_t pg, svuint32_t bases)
        ///   LDNT1B Zresult.S, Pg/Z, [Zbases.S, XZR]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorByteZeroExtendNonTemporal(Vector<uint> mask, Vector<uint> bases) => GatherVectorByteZeroExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint32_t svldnt1ub_gather_[u32]offset_u32(svbool_t pg, const uint8_t *base, svuint32_t offsets)
        ///   LDNT1B Zresult.S, Pg/Z, [Zoffsets.S, Xbase]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorByteZeroExtendNonTemporal(Vector<uint> mask, const byte *base, Vector<uint> offsets) => GatherVectorByteZeroExtendNonTemporal(mask, byte, offsets);

        /// <summary>
        /// svuint32_t svldnt1ub_gather[_u32base]_offset_u32(svbool_t pg, svuint32_t bases, int64_t offset)
        ///   LDNT1B Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorByteZeroExtendNonTemporal(Vector<uint> mask, Vector<uint> bases, long offset) => GatherVectorByteZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1ub_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1B Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorByteZeroExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1ub_gather_[s64]offset_u64(svbool_t pg, const uint8_t *base, svint64_t offsets)
        ///   LDNT1B Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteZeroExtendNonTemporal(Vector<ulong> mask, const byte *base, Vector<long> offsets) => GatherVectorByteZeroExtendNonTemporal(mask, byte, offsets);

        /// <summary>
        /// svuint64_t svldnt1ub_gather_[u64]offset_u64(svbool_t pg, const uint8_t *base, svuint64_t offsets)
        ///   LDNT1B Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteZeroExtendNonTemporal(Vector<ulong> mask, const byte *base, Vector<ulong> offsets) => GatherVectorByteZeroExtendNonTemporal(mask, byte, offsets);

        /// <summary>
        /// svuint64_t svldnt1ub_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1B Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorByteZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorByteZeroExtendNonTemporal(mask, bases, offset);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16SignExtendNonTemporal(Vector<int> mask, Vector<uint> bases) => GatherVectorInt16SignExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16SignExtendNonTemporal(Vector<int> mask, const short *base, Vector<uint> offsets) => GatherVectorInt16SignExtendNonTemporal(mask, short, offsets);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16SignExtendNonTemporal(Vector<int> mask, Vector<uint> bases, long offset) => GatherVectorInt16SignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint32_t svldnt1sh_gather[_u32base]_index_s32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1SH Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16SignExtendNonTemporal(Vector<int> mask, Vector<uint> bases, long index) => GatherVectorInt16SignExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svint64_t svldnt1sh_gather[_u64base]_s64(svbool_t pg, svuint64_t bases)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorInt16SignExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, const short *base, Vector<long> offsets) => GatherVectorInt16SignExtendNonTemporal(mask, short, offsets);

        /// <summary>
        /// svint64_t svldnt1sh_gather_[u64]offset_s64(svbool_t pg, const int16_t *base, svuint64_t offsets)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, const short *base, Vector<ulong> offsets) => GatherVectorInt16SignExtendNonTemporal(mask, short, offsets);

        /// <summary>
        /// svint64_t svldnt1sh_gather_[s64]index_s64(svbool_t pg, const int16_t *base, svint64_t indices)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, const short *base, Vector<long> indices) => GatherVectorInt16SignExtendNonTemporal(mask, short, indices);

        /// <summary>
        /// svint64_t svldnt1sh_gather_[u64]index_s64(svbool_t pg, const int16_t *base, svuint64_t indices)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, const short *base, Vector<ulong> indices) => GatherVectorInt16SignExtendNonTemporal(mask, short, indices);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorInt16SignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1sh_gather[_u64base]_index_s64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16SignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long index) => GatherVectorInt16SignExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint32_t svldnt1sh_gather[_u32base]_u32(svbool_t pg, svuint32_t bases)
        ///   LDNT1SH Zresult.S, Pg/Z, [Zbases.S, XZR]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16SignExtendNonTemporal(Vector<uint> mask, Vector<uint> bases) => GatherVectorInt16SignExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint32_t svldnt1sh_gather_[u32]offset_u32(svbool_t pg, const int16_t *base, svuint32_t offsets)
        ///   LDNT1SH Zresult.S, Pg/Z, [Zoffsets.S, Xbase]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16SignExtendNonTemporal(Vector<uint> mask, const short *base, Vector<uint> offsets) => GatherVectorInt16SignExtendNonTemporal(mask, short, offsets);

        /// <summary>
        /// svuint32_t svldnt1sh_gather[_u32base]_offset_u32(svbool_t pg, svuint32_t bases, int64_t offset)
        ///   LDNT1SH Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16SignExtendNonTemporal(Vector<uint> mask, Vector<uint> bases, long offset) => GatherVectorInt16SignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint32_t svldnt1sh_gather[_u32base]_index_u32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1SH Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16SignExtendNonTemporal(Vector<uint> mask, Vector<uint> bases, long index) => GatherVectorInt16SignExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint64_t svldnt1sh_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorInt16SignExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1sh_gather_[s64]offset_u64(svbool_t pg, const int16_t *base, svint64_t offsets)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, const short *base, Vector<long> offsets) => GatherVectorInt16SignExtendNonTemporal(mask, short, offsets);

        /// <summary>
        /// svuint64_t svldnt1sh_gather_[u64]offset_u64(svbool_t pg, const int16_t *base, svuint64_t offsets)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, const short *base, Vector<ulong> offsets) => GatherVectorInt16SignExtendNonTemporal(mask, short, offsets);

        /// <summary>
        /// svuint64_t svldnt1sh_gather_[s64]index_u64(svbool_t pg, const int16_t *base, svint64_t indices)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, const short *base, Vector<long> indices) => GatherVectorInt16SignExtendNonTemporal(mask, short, indices);

        /// <summary>
        /// svuint64_t svldnt1sh_gather_[u64]index_u64(svbool_t pg, const int16_t *base, svuint64_t indices)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, const short *base, Vector<ulong> indices) => GatherVectorInt16SignExtendNonTemporal(mask, short, indices);

        /// <summary>
        /// svuint64_t svldnt1sh_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorInt16SignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1sh_gather[_u64base]_index_u64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1SH Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16SignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long index) => GatherVectorInt16SignExtendNonTemporal(mask, bases, index);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16ZeroExtendNonTemporal(Vector<int> mask, Vector<uint> bases) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16ZeroExtendNonTemporal(Vector<int> mask, const ushort *base, Vector<uint> offsets) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, offsets);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16ZeroExtendNonTemporal(Vector<int> mask, Vector<uint> bases, long offset) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint32_t svldnt1uh_gather[_u32base]_index_s32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1H Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<int> GatherVectorInt16ZeroExtendNonTemporal(Vector<int> mask, Vector<uint> bases, long index) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svint64_t svldnt1uh_gather[_u64base]_s64(svbool_t pg, svuint64_t bases)
        ///   LDNT1H Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, const ushort *base, Vector<long> offsets) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, offsets);

        /// <summary>
        /// svint64_t svldnt1uh_gather_[u64]offset_s64(svbool_t pg, const uint16_t *base, svuint64_t offsets)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, const ushort *base, Vector<ulong> offsets) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, offsets);

        /// <summary>
        /// svint64_t svldnt1uh_gather_[s64]index_s64(svbool_t pg, const uint16_t *base, svint64_t indices)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, const ushort *base, Vector<long> indices) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, indices);

        /// <summary>
        /// svint64_t svldnt1uh_gather_[u64]index_s64(svbool_t pg, const uint16_t *base, svuint64_t indices)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, const ushort *base, Vector<ulong> indices) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, indices);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1uh_gather[_u64base]_index_s64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1H Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt16ZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long index) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint32_t svldnt1uh_gather[_u32base]_u32(svbool_t pg, svuint32_t bases)
        ///   LDNT1H Zresult.S, Pg/Z, [Zbases.S, XZR]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16ZeroExtendNonTemporal(Vector<uint> mask, Vector<uint> bases) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint32_t svldnt1uh_gather_[u32]offset_u32(svbool_t pg, const uint16_t *base, svuint32_t offsets)
        ///   LDNT1H Zresult.S, Pg/Z, [Zoffsets.S, Xbase]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16ZeroExtendNonTemporal(Vector<uint> mask, const ushort *base, Vector<uint> offsets) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, offsets);

        /// <summary>
        /// svuint32_t svldnt1uh_gather[_u32base]_offset_u32(svbool_t pg, svuint32_t bases, int64_t offset)
        ///   LDNT1H Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16ZeroExtendNonTemporal(Vector<uint> mask, Vector<uint> bases, long offset) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint32_t svldnt1uh_gather[_u32base]_index_u32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1H Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorInt16ZeroExtendNonTemporal(Vector<uint> mask, Vector<uint> bases, long index) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint64_t svldnt1uh_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1H Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1uh_gather_[s64]offset_u64(svbool_t pg, const uint16_t *base, svint64_t offsets)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, const ushort *base, Vector<long> offsets) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, offsets);

        /// <summary>
        /// svuint64_t svldnt1uh_gather_[u64]offset_u64(svbool_t pg, const uint16_t *base, svuint64_t offsets)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, const ushort *base, Vector<ulong> offsets) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, offsets);

        /// <summary>
        /// svuint64_t svldnt1uh_gather_[s64]index_u64(svbool_t pg, const uint16_t *base, svint64_t indices)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, const ushort *base, Vector<long> indices) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, indices);

        /// <summary>
        /// svuint64_t svldnt1uh_gather_[u64]index_u64(svbool_t pg, const uint16_t *base, svuint64_t indices)
        ///   LDNT1H Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, const ushort *base, Vector<ulong> indices) => GatherVectorInt16ZeroExtendNonTemporal(mask, ushort, indices);

        /// <summary>
        /// svuint64_t svldnt1uh_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1H Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1uh_gather[_u64base]_index_u64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1H Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt16ZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long index) => GatherVectorInt16ZeroExtendNonTemporal(mask, bases, index);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorInt32SignExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, const int *base, Vector<long> offsets) => GatherVectorInt32SignExtendNonTemporal(mask, int, offsets);

        /// <summary>
        /// svint64_t svldnt1sw_gather_[u64]offset_s64(svbool_t pg, const int32_t *base, svuint64_t offsets)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, const int *base, Vector<ulong> offsets) => GatherVectorInt32SignExtendNonTemporal(mask, int, offsets);

        /// <summary>
        /// svint64_t svldnt1sw_gather_[s64]index_s64(svbool_t pg, const int32_t *base, svint64_t indices)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, const int *base, Vector<long> indices) => GatherVectorInt32SignExtendNonTemporal(mask, int, indices);

        /// <summary>
        /// svint64_t svldnt1sw_gather_[u64]index_s64(svbool_t pg, const int32_t *base, svuint64_t indices)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, const int *base, Vector<ulong> indices) => GatherVectorInt32SignExtendNonTemporal(mask, int, indices);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorInt32SignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1sw_gather[_u64base]_index_s64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32SignExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long index) => GatherVectorInt32SignExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint64_t svldnt1sw_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorInt32SignExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1sw_gather_[s64]offset_u64(svbool_t pg, const int32_t *base, svint64_t offsets)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, const int *base, Vector<long> offsets) => GatherVectorInt32SignExtendNonTemporal(mask, int, offsets);

        /// <summary>
        /// svuint64_t svldnt1sw_gather_[u64]offset_u64(svbool_t pg, const int32_t *base, svuint64_t offsets)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, const int *base, Vector<ulong> offsets) => GatherVectorInt32SignExtendNonTemporal(mask, int, offsets);

        /// <summary>
        /// svuint64_t svldnt1sw_gather_[s64]index_u64(svbool_t pg, const int32_t *base, svint64_t indices)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, const int *base, Vector<long> indices) => GatherVectorInt32SignExtendNonTemporal(mask, int, indices);

        /// <summary>
        /// svuint64_t svldnt1sw_gather_[u64]index_u64(svbool_t pg, const int32_t *base, svuint64_t indices)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, const int *base, Vector<ulong> indices) => GatherVectorInt32SignExtendNonTemporal(mask, int, indices);

        /// <summary>
        /// svuint64_t svldnt1sw_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorInt32SignExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1sw_gather[_u64base]_index_u64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1SW Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32SignExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long index) => GatherVectorInt32SignExtendNonTemporal(mask, bases, index);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorInt32ZeroExtendNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, const uint *base, Vector<long> offsets) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, offsets);

        /// <summary>
        /// svint64_t svldnt1uw_gather_[u64]offset_s64(svbool_t pg, const uint32_t *base, svuint64_t offsets)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, const uint *base, Vector<ulong> offsets) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, offsets);

        /// <summary>
        /// svint64_t svldnt1uw_gather_[s64]index_s64(svbool_t pg, const uint32_t *base, svint64_t indices)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, const uint *base, Vector<long> indices) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, indices);

        /// <summary>
        /// svint64_t svldnt1uw_gather_[u64]index_s64(svbool_t pg, const uint32_t *base, svuint64_t indices)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, const uint *base, Vector<ulong> indices) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, indices);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorInt32ZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1uw_gather[_u64base]_index_s64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1W Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<long> GatherVectorInt32ZeroExtendNonTemporal(Vector<long> mask, Vector<ulong> bases, long index) => GatherVectorInt32ZeroExtendNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint64_t svldnt1uw_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1W Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorInt32ZeroExtendNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1uw_gather_[s64]offset_u64(svbool_t pg, const uint32_t *base, svint64_t offsets)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, const uint *base, Vector<long> offsets) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, offsets);

        /// <summary>
        /// svuint64_t svldnt1uw_gather_[u64]offset_u64(svbool_t pg, const uint32_t *base, svuint64_t offsets)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, const uint *base, Vector<ulong> offsets) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, offsets);

        /// <summary>
        /// svuint64_t svldnt1uw_gather_[s64]index_u64(svbool_t pg, const uint32_t *base, svint64_t indices)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, const uint *base, Vector<long> indices) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, indices);

        /// <summary>
        /// svuint64_t svldnt1uw_gather_[u64]index_u64(svbool_t pg, const uint32_t *base, svuint64_t indices)
        ///   LDNT1W Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, const uint *base, Vector<ulong> indices) => GatherVectorInt32ZeroExtendNonTemporal(mask, uint, indices);

        /// <summary>
        /// svuint64_t svldnt1uw_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1W Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorInt32ZeroExtendNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1uw_gather[_u64base]_index_u64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1W Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorInt32ZeroExtendNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long index) => GatherVectorInt32ZeroExtendNonTemporal(mask, bases, index);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorNonTemporal(Vector<int> mask, Vector<uint> bases) => GatherVectorNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorNonTemporal(Vector<int> mask, const int *base, Vector<uint> offsets) => GatherVectorNonTemporal(mask, int, offsets);
        ...
        /// </summary>
        public static unsafe Vector<int> GatherVectorNonTemporal(Vector<int> mask, Vector<uint> bases, long offset) => GatherVectorNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint32_t svldnt1_gather[_u32base]_index_s32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<int> GatherVectorNonTemporal(Vector<int> mask, Vector<uint> bases, long index) => GatherVectorNonTemporal(mask, bases, index);

        /// <summary>
        /// svint64_t svldnt1_gather[_u64base]_s64(svbool_t pg, svuint64_t bases)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, Vector<ulong> bases) => GatherVectorNonTemporal(mask, bases);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, const long *base, Vector<long> offsets) => GatherVectorNonTemporal(mask, long, offsets);

        /// <summary>
        /// svint64_t svldnt1_gather_[u64]offset[_s64](svbool_t pg, const int64_t *base, svuint64_t offsets)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, const long *base, Vector<ulong> offsets) => GatherVectorNonTemporal(mask, long, offsets);

        /// <summary>
        /// svint64_t svldnt1_gather_[s64]index[_s64](svbool_t pg, const int64_t *base, svint64_t indices)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, const long *base, Vector<long> indices) => GatherVectorNonTemporal(mask, long, indices);

        /// <summary>
        /// svint64_t svldnt1_gather_[u64]index[_s64](svbool_t pg, const int64_t *base, svuint64_t indices)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, const long *base, Vector<ulong> indices) => GatherVectorNonTemporal(mask, long, indices);
        ...
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset) => GatherVectorNonTemporal(mask, bases, offset);

        /// <summary>
        /// svint64_t svldnt1_gather[_u64base]_index_s64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<long> GatherVectorNonTemporal(Vector<long> mask, Vector<ulong> bases, long index) => GatherVectorNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint32_t svldnt1_gather[_u32base]_u32(svbool_t pg, svuint32_t bases)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, XZR]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorNonTemporal(Vector<uint> mask, Vector<uint> bases) => GatherVectorNonTemporal(mask, bases);

        /// <summary>
        /// svuint32_t svldnt1_gather_[u32]offset[_u32](svbool_t pg, const uint32_t *base, svuint32_t offsets)
        ///   LDNT1W Zresult.S, Pg/Z, [Zoffsets.S, Xbase]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorNonTemporal(Vector<uint> mask, const uint *base, Vector<uint> offsets) => GatherVectorNonTemporal(mask, uint, offsets);

        /// <summary>
        /// svuint32_t svldnt1_gather[_u32base]_offset_u32(svbool_t pg, svuint32_t bases, int64_t offset)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorNonTemporal(Vector<uint> mask, Vector<uint> bases, long offset) => GatherVectorNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint32_t svldnt1_gather[_u32base]_index_u32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<uint> GatherVectorNonTemporal(Vector<uint> mask, Vector<uint> bases, long index) => GatherVectorNonTemporal(mask, bases, index);

        /// <summary>
        /// svuint64_t svldnt1_gather[_u64base]_u64(svbool_t pg, svuint64_t bases)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, Vector<ulong> bases) => GatherVectorNonTemporal(mask, bases);

        /// <summary>
        /// svuint64_t svldnt1_gather_[s64]offset[_u64](svbool_t pg, const uint64_t *base, svint64_t offsets)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, const ulong *base, Vector<long> offsets) => GatherVectorNonTemporal(mask, ulong, offsets);

        /// <summary>
        /// svuint64_t svldnt1_gather_[u64]offset[_u64](svbool_t pg, const uint64_t *base, svuint64_t offsets)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, const ulong *base, Vector<ulong> offsets) => GatherVectorNonTemporal(mask, ulong, offsets);

        /// <summary>
        /// svuint64_t svldnt1_gather_[s64]index[_u64](svbool_t pg, const uint64_t *base, svint64_t indices)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, const ulong *base, Vector<long> indices) => GatherVectorNonTemporal(mask, ulong, indices);

        /// <summary>
        /// svuint64_t svldnt1_gather_[u64]index[_u64](svbool_t pg, const uint64_t *base, svuint64_t indices)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, const ulong *base, Vector<ulong> indices) => GatherVectorNonTemporal(mask, ulong, indices);

        /// <summary>
        /// svuint64_t svldnt1_gather[_u64base]_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset) => GatherVectorNonTemporal(mask, bases, offset);

        /// <summary>
        /// svuint64_t svldnt1_gather[_u64base]_index_u64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<ulong> GatherVectorNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long index) => GatherVectorNonTemporal(mask, bases, index);

        /// <summary>
        /// svfloat32_t svldnt1_gather[_u32base]_f32(svbool_t pg, svuint32_t bases)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, XZR]
        /// </summary>
        public static unsafe Vector<float> GatherVectorNonTemporal(Vector<float> mask, Vector<uint> bases) => GatherVectorNonTemporal(mask, bases);

        /// <summary>
        /// svfloat32_t svldnt1_gather_[u32]offset[_f32](svbool_t pg, const float32_t *base, svuint32_t offsets)
        ///   LDNT1W Zresult.S, Pg/Z, [Zoffsets.S, Xbase]
        /// </summary>
        public static unsafe Vector<float> GatherVectorNonTemporal(Vector<float> mask, const float *base, Vector<uint> offsets) => GatherVectorNonTemporal(mask, float, offsets);

        /// <summary>
        /// svfloat32_t svldnt1_gather[_u32base]_offset_f32(svbool_t pg, svuint32_t bases, int64_t offset)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<float> GatherVectorNonTemporal(Vector<float> mask, Vector<uint> bases, long offset) => GatherVectorNonTemporal(mask, bases, offset);

        /// <summary>
        /// svfloat32_t svldnt1_gather[_u32base]_index_f32(svbool_t pg, svuint32_t bases, int64_t index)
        ///   LDNT1W Zresult.S, Pg/Z, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe Vector<float> GatherVectorNonTemporal(Vector<float> mask, Vector<uint> bases, long index) => GatherVectorNonTemporal(mask, bases, index);

        /// <summary>
        /// svfloat64_t svldnt1_gather_[s64]offset[_f64](svbool_t pg, const float64_t *base, svint64_t offsets)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, const double *base, Vector<long> offsets) => GatherVectorNonTemporal(mask, double, offsets);

        /// <summary>
        /// svfloat64_t svldnt1_gather_[s64]index[_f64](svbool_t pg, const float64_t *base, svint64_t indices)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, const double *base, Vector<long> indices) => GatherVectorNonTemporal(mask, double, indices);

        /// <summary>
        /// svfloat64_t svldnt1_gather[_u64base]_f64(svbool_t pg, svuint64_t bases)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, XZR]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, Vector<ulong> bases) => GatherVectorNonTemporal(mask, bases);

        /// <summary>
        /// svfloat64_t svldnt1_gather_[u64]offset[_f64](svbool_t pg, const float64_t *base, svuint64_t offsets)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, const double *base, Vector<ulong> offsets) => GatherVectorNonTemporal(mask, double, offsets);

        /// <summary>
        /// svfloat64_t svldnt1_gather_[u64]index[_f64](svbool_t pg, const float64_t *base, svuint64_t indices)
        ///   LDNT1D Zresult.D, Pg/Z, [Zoffsets.D, Xbase]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, const double *base, Vector<ulong> indices) => GatherVectorNonTemporal(mask, double, indices);

        /// <summary>
        /// svfloat64_t svldnt1_gather[_u64base]_offset_f64(svbool_t pg, svuint64_t bases, int64_t offset)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, Vector<ulong> bases, long offset) => GatherVectorNonTemporal(mask, bases, offset);

        /// <summary>
        /// svfloat64_t svldnt1_gather[_u64base]_index_f64(svbool_t pg, svuint64_t bases, int64_t index)
        ///   LDNT1D Zresult.D, Pg/Z, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe Vector<double> GatherVectorNonTemporal(Vector<double> mask, Vector<ulong> bases, long index) => GatherVectorNonTemporal(mask, bases, index);
        ...
        /// </summary>
        public static unsafe Vector<short> Multiply(Vector<short> left, Vector<short> right, ulong index) => Multiply(left, right, index);

        /// <summary>
        /// svint32_t svmul_lane[_s32](svint32_t op1, svint32_t op2, uint64_t imm_index)
        ///   MUL Zresult.S, Zop1.S, Zop2.S[imm_index]
        /// </summary>
        public static unsafe Vector<int> Multiply(Vector<int> left, Vector<int> right, ulong index) => Multiply(left, right, index);

        /// <summary>
        /// svint64_t svmul_lane[_s64](svint64_t op1, svint64_t op2, uint64_t imm_index)
        ///   MUL Zresult.D, Zop1.D, Zop2.D[imm_index]
        /// </summary>
        public static unsafe Vector<long> Multiply(Vector<long> left, Vector<long> right, ulong index) => Multiply(left, right, index);

        /// <summary>
        /// svuint16_t svmul_lane[_u16](svuint16_t op1, svuint16_t op2, uint64_t imm_index)
        ///   MUL Zresult.H, Zop1.H, Zop2.H[imm_index]
        /// </summary>
        public static unsafe Vector<ushort> Multiply(Vector<ushort> left, Vector<ushort> right, ulong index) => Multiply(left, right, index);

        /// <summary>
        /// svuint32_t svmul_lane[_u32](svuint32_t op1, svuint32_t op2, uint64_t imm_index)
        ///   MUL Zresult.S, Zop1.S, Zop2.S[imm_index]
        /// </summary>
        public static unsafe Vector<uint> Multiply(Vector<uint> left, Vector<uint> right, ulong index) => Multiply(left, right, index);

        /// <summary>
        /// svuint64_t svmul_lane[_u64](svuint64_t op1, svuint64_t op2, uint64_t imm_index)
        ///   MUL Zresult.D, Zop1.D, Zop2.D[imm_index]
        /// </summary>
        public static unsafe Vector<ulong> Multiply(Vector<ulong> left, Vector<ulong> right, ulong index) => Multiply(left, right, index);
        ...
        /// </summary>
        public static unsafe Vector<short> MultiplyAdd(Vector<short> addend, Vector<short> left, Vector<short> right, ulong imm_index) => MultiplyAdd(addend, left, right, imm_index);
        ...
        /// </summary>
        public static unsafe Vector<int> MultiplyAdd(Vector<int> addend, Vector<int> left, Vector<int> right, ulong imm_index) => MultiplyAdd(addend, left, right, imm_index);
        ...
        /// </summary>
        public static unsafe Vector<long> MultiplyAdd(Vector<long> addend, Vector<long> left, Vector<long> right, ulong imm_index) => MultiplyAdd(addend, left, right, imm_index);
        ...
        ///   MOVPRFX Zresult, Zop1; MLA Zresult.H, Zop2.H, Zop3.H[imm_index]
        /// </summary>
        public static unsafe Vector<ushort> MultiplyAdd(Vector<ushort> addend, Vector<ushort> left, Vector<ushort> right, ulong imm_index) => MultiplyAdd(addend, left, right, imm_index);
        ...
        ///   MOVPRFX Zresult, Zop1; MLA Zresult.S, Zop2.S, Zop3.S[imm_index]
        /// </summary>
        public static unsafe Vector<uint> MultiplyAdd(Vector<uint> addend, Vector<uint> left, Vector<uint> right, ulong imm_index) => MultiplyAdd(addend, left, right, imm_index);
        ...
        ///   MOVPRFX Zresult, Zop1; MLA Zresult.D, Zop2.D, Zop3.D[imm_index]
        /// </summary>
        public static unsafe Vector<ulong> MultiplyAdd(Vector<ulong> addend, Vector<ulong> left, Vector<ulong> right, ulong imm_index) => MultiplyAdd(addend, left, right, imm_index);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> MultiplyAddRotateComplex(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> MultiplyAddRotateComplex(Vector<short> op1, Vector<short> op2, Vector<short> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> MultiplyAddRotateComplex(Vector<short> op1, Vector<short> op2, Vector<short> op3, ulong imm_index, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_index, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> MultiplyAddRotateComplex(Vector<int> op1, Vector<int> op2, Vector<int> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> MultiplyAddRotateComplex(Vector<int> op1, Vector<int> op2, Vector<int> op3, ulong imm_index, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_index, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<long> MultiplyAddRotateComplex(Vector<long> op1, Vector<long> op2, Vector<long> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CMLA Zresult.B, Zop2.B, Zop3.B, #imm_rotation
        /// </summary>
        public static unsafe Vector<byte> MultiplyAddRotateComplex(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CMLA Zresult.H, Zop2.H, Zop3.H, #imm_rotation
        /// </summary>
        public static unsafe Vector<ushort> MultiplyAddRotateComplex(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CMLA Zresult.H, Zop2.H, Zop3.H[imm_index], #imm_rotation
        /// </summary>
        public static unsafe Vector<ushort> MultiplyAddRotateComplex(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3, ulong imm_index, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_index, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CMLA Zresult.S, Zop2.S, Zop3.S, #imm_rotation
        /// </summary>
        public static unsafe Vector<uint> MultiplyAddRotateComplex(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CMLA Zresult.S, Zop2.S, Zop3.S[imm_index], #imm_rotation
        /// </summary>
        public static unsafe Vector<uint> MultiplyAddRotateComplex(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3, ulong imm_index, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_index, imm_rotation);
        ...
        ///   MOVPRFX Zresult, Zop1; CMLA Zresult.D, Zop2.D, Zop3.D, #imm_rotation
        /// </summary>
        public static unsafe Vector<ulong> MultiplyAddRotateComplex(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3, ulong imm_rotation) => MultiplyAddRotateComplex(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> MultiplySubtract(Vector<short> minuend, Vector<short> left, Vector<short> right, ulong imm_index) => MultiplySubtract(minuend, left, right, imm_index);
        ...
        /// </summary>
        public static unsafe Vector<int> MultiplySubtract(Vector<int> minuend, Vector<int> left, Vector<int> right, ulong imm_index) => MultiplySubtract(minuend, left, right, imm_index);
        ...
        /// </summary>
        public static unsafe Vector<long> MultiplySubtract(Vector<long> minuend, Vector<long> left, Vector<long> right, ulong imm_index) => MultiplySubtract(minuend, left, right, imm_index);
        ...
        ///   MOVPRFX Zresult, Zop1; MLS Zresult.H, Zop2.H, Zop3.H[imm_index]
        /// </summary>
        public static unsafe Vector<ushort> MultiplySubtract(Vector<ushort> minuend, Vector<ushort> left, Vector<ushort> right, ulong imm_index) => MultiplySubtract(minuend, left, right, imm_index);
        ...
        ///   MOVPRFX Zresult, Zop1; MLS Zresult.S, Zop2.S, Zop3.S[imm_index]
        /// </summary>
        public static unsafe Vector<uint> MultiplySubtract(Vector<uint> minuend, Vector<uint> left, Vector<uint> right, ulong imm_index) => MultiplySubtract(minuend, left, right, imm_index);
        ...
        ///   MOVPRFX Zresult, Zop1; MLS Zresult.D, Zop2.D, Zop3.D[imm_index]
        /// </summary>
        public static unsafe Vector<ulong> MultiplySubtract(Vector<ulong> minuend, Vector<ulong> left, Vector<ulong> right, ulong imm_index) => MultiplySubtract(minuend, left, right, imm_index);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> RoundingShiftLeft(Vector<sbyte> left, Vector<sbyte> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<short> RoundingShiftLeft(Vector<short> left, Vector<short> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<int> RoundingShiftLeft(Vector<int> left, Vector<int> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<long> RoundingShiftLeft(Vector<long> left, Vector<long> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<byte> RoundingShiftLeft(Vector<byte> left, Vector<sbyte> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<ushort> RoundingShiftLeft(Vector<ushort> left, Vector<short> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<uint> RoundingShiftLeft(Vector<uint> left, Vector<int> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<ulong> RoundingShiftLeft(Vector<ulong> left, Vector<long> right) => RoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> RoundingShiftRight(Vector<sbyte> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<short> RoundingShiftRight(Vector<short> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<int> RoundingShiftRight(Vector<int> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<long> RoundingShiftRight(Vector<long> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<byte> RoundingShiftRight(Vector<byte> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<ushort> RoundingShiftRight(Vector<ushort> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<uint> RoundingShiftRight(Vector<uint> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<ulong> RoundingShiftRight(Vector<ulong> op1, ulong imm2) => RoundingShiftRight(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> RoundingShiftRightAndAccumulate(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<short> RoundingShiftRightAndAccumulate(Vector<short> op1, Vector<short> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<int> RoundingShiftRightAndAccumulate(Vector<int> op1, Vector<int> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<long> RoundingShiftRightAndAccumulate(Vector<long> op1, Vector<long> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<byte> RoundingShiftRightAndAccumulate(Vector<byte> op1, Vector<byte> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<ushort> RoundingShiftRightAndAccumulate(Vector<ushort> op1, Vector<ushort> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<uint> RoundingShiftRightAndAccumulate(Vector<uint> op1, Vector<uint> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<ulong> RoundingShiftRightAndAccumulate(Vector<ulong> op1, Vector<ulong> op2, ulong imm3) => RoundingShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> RoundingShiftRightNarrowingLower(Vector<short> op1, ulong imm2) => RoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint16_t svrshrnb[_n_s32](svint32_t op1, uint64_t imm2)
        ///   RSHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> RoundingShiftRightNarrowingLower(Vector<int> op1, ulong imm2) => RoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint32_t svrshrnb[_n_s64](svint64_t op1, uint64_t imm2)
        ///   RSHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> RoundingShiftRightNarrowingLower(Vector<long> op1, ulong imm2) => RoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint8_t svrshrnb[_n_u16](svuint16_t op1, uint64_t imm2)
        ///   RSHRNB Zresult.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> RoundingShiftRightNarrowingLower(Vector<ushort> op1, ulong imm2) => RoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint16_t svrshrnb[_n_u32](svuint32_t op1, uint64_t imm2)
        ///   RSHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> RoundingShiftRightNarrowingLower(Vector<uint> op1, ulong imm2) => RoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint32_t svrshrnb[_n_u64](svuint64_t op1, uint64_t imm2)
        ///   RSHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> RoundingShiftRightNarrowingLower(Vector<ulong> op1, ulong imm2) => RoundingShiftRightNarrowingLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> RoundingShiftRightNarrowingUpper(Vector<sbyte> even, Vector<short> op1, ulong imm2) => RoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint16_t svrshrnt[_n_s32](svint16_t even, svint32_t op1, uint64_t imm2)
        ///   RSHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> RoundingShiftRightNarrowingUpper(Vector<short> even, Vector<int> op1, ulong imm2) => RoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint32_t svrshrnt[_n_s64](svint32_t even, svint64_t op1, uint64_t imm2)
        ///   RSHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> RoundingShiftRightNarrowingUpper(Vector<int> even, Vector<long> op1, ulong imm2) => RoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint8_t svrshrnt[_n_u16](svuint8_t even, svuint16_t op1, uint64_t imm2)
        ///   RSHRNT Ztied.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> RoundingShiftRightNarrowingUpper(Vector<byte> even, Vector<ushort> op1, ulong imm2) => RoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint16_t svrshrnt[_n_u32](svuint16_t even, svuint32_t op1, uint64_t imm2)
        ///   RSHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> RoundingShiftRightNarrowingUpper(Vector<ushort> even, Vector<uint> op1, ulong imm2) => RoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint32_t svrshrnt[_n_u64](svuint32_t even, svuint64_t op1, uint64_t imm2)
        ///   RSHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> RoundingShiftRightNarrowingUpper(Vector<uint> even, Vector<ulong> op1, ulong imm2) => RoundingShiftRightNarrowingUpper(even, op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingComplexAddRotate(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm_rotation) => SaturatingComplexAddRotate(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> SaturatingComplexAddRotate(Vector<short> op1, Vector<short> op2, ulong imm_rotation) => SaturatingComplexAddRotate(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> SaturatingComplexAddRotate(Vector<int> op1, Vector<int> op2, ulong imm_rotation) => SaturatingComplexAddRotate(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<long> SaturatingComplexAddRotate(Vector<long> op1, Vector<long> op2, ulong imm_rotation) => SaturatingComplexAddRotate(op1, op2, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingRoundingDoublingComplexMultiplyAddHighRotate(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3, ulong imm_rotation) => SaturatingRoundingDoublingComplexMultiplyAddHighRotate(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> SaturatingRoundingDoublingComplexMultiplyAddHighRotate(Vector<short> op1, Vector<short> op2, Vector<short> op3, ulong imm_rotation) => SaturatingRoundingDoublingComplexMultiplyAddHighRotate(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<short> SaturatingRoundingDoublingComplexMultiplyAddHighRotate(Vector<short> op1, Vector<short> op2, Vector<short> op3, ulong imm_index, ulong imm_rotation) => SaturatingRoundingDoublingComplexMultiplyAddHighRotate(op1, op2, op3, imm_index, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> SaturatingRoundingDoublingComplexMultiplyAddHighRotate(Vector<int> op1, Vector<int> op2, Vector<int> op3, ulong imm_rotation) => SaturatingRoundingDoublingComplexMultiplyAddHighRotate(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<int> SaturatingRoundingDoublingComplexMultiplyAddHighRotate(Vector<int> op1, Vector<int> op2, Vector<int> op3, ulong imm_index, ulong imm_rotation) => SaturatingRoundingDoublingComplexMultiplyAddHighRotate(op1, op2, op3, imm_index, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<long> SaturatingRoundingDoublingComplexMultiplyAddHighRotate(Vector<long> op1, Vector<long> op2, Vector<long> op3, ulong imm_rotation) => SaturatingRoundingDoublingComplexMultiplyAddHighRotate(op1, op2, op3, imm_rotation);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingRoundingShiftLeft(Vector<sbyte> left, Vector<sbyte> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<short> SaturatingRoundingShiftLeft(Vector<short> left, Vector<short> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<int> SaturatingRoundingShiftLeft(Vector<int> left, Vector<int> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<long> SaturatingRoundingShiftLeft(Vector<long> left, Vector<long> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingRoundingShiftLeft(Vector<byte> left, Vector<sbyte> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<ushort> SaturatingRoundingShiftLeft(Vector<ushort> left, Vector<short> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<uint> SaturatingRoundingShiftLeft(Vector<uint> left, Vector<int> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<ulong> SaturatingRoundingShiftLeft(Vector<ulong> left, Vector<long> right) => SaturatingRoundingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingRoundingShiftRightNarrowingLower(Vector<short> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint16_t svqrshrnb[_n_s32](svint32_t op1, uint64_t imm2)
        ///   SQRSHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> SaturatingRoundingShiftRightNarrowingLower(Vector<int> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint32_t svqrshrnb[_n_s64](svint64_t op1, uint64_t imm2)
        ///   SQRSHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> SaturatingRoundingShiftRightNarrowingLower(Vector<long> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint8_t svqrshrnb[_n_u16](svuint16_t op1, uint64_t imm2)
        ///   UQRSHRNB Zresult.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> SaturatingRoundingShiftRightNarrowingLower(Vector<ushort> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint16_t svqrshrnb[_n_u32](svuint32_t op1, uint64_t imm2)
        ///   UQRSHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingRoundingShiftRightNarrowingLower(Vector<uint> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint32_t svqrshrnb[_n_u64](svuint64_t op1, uint64_t imm2)
        ///   UQRSHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingRoundingShiftRightNarrowingLower(Vector<ulong> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingRoundingShiftRightNarrowingUpper(Vector<sbyte> even, Vector<short> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint16_t svqrshrnt[_n_s32](svint16_t even, svint32_t op1, uint64_t imm2)
        ///   SQRSHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> SaturatingRoundingShiftRightNarrowingUpper(Vector<short> even, Vector<int> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint32_t svqrshrnt[_n_s64](svint32_t even, svint64_t op1, uint64_t imm2)
        ///   SQRSHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> SaturatingRoundingShiftRightNarrowingUpper(Vector<int> even, Vector<long> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint8_t svqrshrnt[_n_u16](svuint8_t even, svuint16_t op1, uint64_t imm2)
        ///   UQRSHRNT Ztied.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> SaturatingRoundingShiftRightNarrowingUpper(Vector<byte> even, Vector<ushort> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint16_t svqrshrnt[_n_u32](svuint16_t even, svuint32_t op1, uint64_t imm2)
        ///   UQRSHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingRoundingShiftRightNarrowingUpper(Vector<ushort> even, Vector<uint> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint32_t svqrshrnt[_n_u64](svuint32_t even, svuint64_t op1, uint64_t imm2)
        ///   UQRSHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingRoundingShiftRightNarrowingUpper(Vector<uint> even, Vector<ulong> op1, ulong imm2) => SaturatingRoundingShiftRightNarrowingUpper(even, op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingRoundingShiftRightUnsignedNarrowingLower(Vector<short> op1, ulong imm2) => SaturatingRoundingShiftRightUnsignedNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint16_t svqrshrunb[_n_s32](svint32_t op1, uint64_t imm2)
        ///   SQRSHRUNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingRoundingShiftRightUnsignedNarrowingLower(Vector<int> op1, ulong imm2) => SaturatingRoundingShiftRightUnsignedNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint32_t svqrshrunb[_n_s64](svint64_t op1, uint64_t imm2)
        ///   SQRSHRUNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingRoundingShiftRightUnsignedNarrowingLower(Vector<long> op1, ulong imm2) => SaturatingRoundingShiftRightUnsignedNarrowingLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingRoundingShiftRightUnsignedNarrowingUpper(Vector<byte> even, Vector<short> op1, ulong imm2) => SaturatingRoundingShiftRightUnsignedNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint16_t svqrshrunt[_n_s32](svuint16_t even, svint32_t op1, uint64_t imm2)
        ///   SQRSHRUNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingRoundingShiftRightUnsignedNarrowingUpper(Vector<ushort> even, Vector<int> op1, ulong imm2) => SaturatingRoundingShiftRightUnsignedNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint32_t svqrshrunt[_n_s64](svuint32_t even, svint64_t op1, uint64_t imm2)
        ///   SQRSHRUNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingRoundingShiftRightUnsignedNarrowingUpper(Vector<uint> even, Vector<long> op1, ulong imm2) => SaturatingRoundingShiftRightUnsignedNarrowingUpper(even, op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingShiftLeft(Vector<sbyte> left, Vector<sbyte> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<short> SaturatingShiftLeft(Vector<short> left, Vector<short> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<int> SaturatingShiftLeft(Vector<int> left, Vector<int> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<long> SaturatingShiftLeft(Vector<long> left, Vector<long> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingShiftLeft(Vector<byte> left, Vector<sbyte> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<ushort> SaturatingShiftLeft(Vector<ushort> left, Vector<short> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<uint> SaturatingShiftLeft(Vector<uint> left, Vector<int> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<ulong> SaturatingShiftLeft(Vector<ulong> left, Vector<long> right) => SaturatingShiftLeft(left, right);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingShiftLeftUnsigned(Vector<sbyte> op1, ulong imm2) => SaturatingShiftLeftUnsigned(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<ushort> SaturatingShiftLeftUnsigned(Vector<short> op1, ulong imm2) => SaturatingShiftLeftUnsigned(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<uint> SaturatingShiftLeftUnsigned(Vector<int> op1, ulong imm2) => SaturatingShiftLeftUnsigned(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<ulong> SaturatingShiftLeftUnsigned(Vector<long> op1, ulong imm2) => SaturatingShiftLeftUnsigned(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingShiftRightNarrowingLower(Vector<short> op1, ulong imm2) => SaturatingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint16_t svqshrnb[_n_s32](svint32_t op1, uint64_t imm2)
        ///   SQSHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> SaturatingShiftRightNarrowingLower(Vector<int> op1, ulong imm2) => SaturatingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint32_t svqshrnb[_n_s64](svint64_t op1, uint64_t imm2)
        ///   SQSHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> SaturatingShiftRightNarrowingLower(Vector<long> op1, ulong imm2) => SaturatingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint8_t svqshrnb[_n_u16](svuint16_t op1, uint64_t imm2)
        ///   UQSHRNB Zresult.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> SaturatingShiftRightNarrowingLower(Vector<ushort> op1, ulong imm2) => SaturatingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint16_t svqshrnb[_n_u32](svuint32_t op1, uint64_t imm2)
        ///   UQSHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingShiftRightNarrowingLower(Vector<uint> op1, ulong imm2) => SaturatingShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint32_t svqshrnb[_n_u64](svuint64_t op1, uint64_t imm2)
        ///   UQSHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingShiftRightNarrowingLower(Vector<ulong> op1, ulong imm2) => SaturatingShiftRightNarrowingLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> SaturatingShiftRightNarrowingUpper(Vector<sbyte> even, Vector<short> op1, ulong imm2) => SaturatingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint16_t svqshrnt[_n_s32](svint16_t even, svint32_t op1, uint64_t imm2)
        ///   SQSHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> SaturatingShiftRightNarrowingUpper(Vector<short> even, Vector<int> op1, ulong imm2) => SaturatingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint32_t svqshrnt[_n_s64](svint32_t even, svint64_t op1, uint64_t imm2)
        ///   SQSHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> SaturatingShiftRightNarrowingUpper(Vector<int> even, Vector<long> op1, ulong imm2) => SaturatingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint8_t svqshrnt[_n_u16](svuint8_t even, svuint16_t op1, uint64_t imm2)
        ///   UQSHRNT Ztied.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> SaturatingShiftRightNarrowingUpper(Vector<byte> even, Vector<ushort> op1, ulong imm2) => SaturatingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint16_t svqshrnt[_n_u32](svuint16_t even, svuint32_t op1, uint64_t imm2)
        ///   UQSHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingShiftRightNarrowingUpper(Vector<ushort> even, Vector<uint> op1, ulong imm2) => SaturatingShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint32_t svqshrnt[_n_u64](svuint32_t even, svuint64_t op1, uint64_t imm2)
        ///   UQSHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingShiftRightNarrowingUpper(Vector<uint> even, Vector<ulong> op1, ulong imm2) => SaturatingShiftRightNarrowingUpper(even, op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingShiftRightUnsignedNarrowingLower(Vector<short> op1, ulong imm2) => SaturatingShiftRightUnsignedNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint16_t svqshrunb[_n_s32](svint32_t op1, uint64_t imm2)
        ///   SQSHRUNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingShiftRightUnsignedNarrowingLower(Vector<int> op1, ulong imm2) => SaturatingShiftRightUnsignedNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint32_t svqshrunb[_n_s64](svint64_t op1, uint64_t imm2)
        ///   SQSHRUNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingShiftRightUnsignedNarrowingLower(Vector<long> op1, ulong imm2) => SaturatingShiftRightUnsignedNarrowingLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<byte> SaturatingShiftRightUnsignedNarrowingUpper(Vector<byte> even, Vector<short> op1, ulong imm2) => SaturatingShiftRightUnsignedNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint16_t svqshrunt[_n_s32](svuint16_t even, svint32_t op1, uint64_t imm2)
        ///   SQSHRUNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> SaturatingShiftRightUnsignedNarrowingUpper(Vector<ushort> even, Vector<int> op1, ulong imm2) => SaturatingShiftRightUnsignedNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint32_t svqshrunt[_n_s64](svuint32_t even, svint64_t op1, uint64_t imm2)
        ///   SQSHRUNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> SaturatingShiftRightUnsignedNarrowingUpper(Vector<uint> even, Vector<long> op1, ulong imm2) => SaturatingShiftRightUnsignedNarrowingUpper(even, op1, imm2);
        ...
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<int> mask, Vector<uint> bases, Vector<int> data) => ScatterNonTemporal(mask, bases, data);
        ...
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<int> mask, Vector<uint> bases, long offset, Vector<int> data) => ScatterNonTemporal(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1_scatter[_u32base]_index[_s32](svbool_t pg, svuint32_t bases, int64_t index, svint32_t data)
        ///   STNT1W Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<int> mask, Vector<uint> bases, long index, Vector<int> data) => ScatterNonTemporal(mask, bases, index, data);

        /// <summary>
        /// void svstnt1_scatter[_u64base_s64](svbool_t pg, svuint64_t bases, svint64_t data)
        ///   STNT1D Zdata.D, Pg, [Zbases.D, XZR]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<long> mask, Vector<ulong> bases, Vector<long> data) => ScatterNonTemporal(mask, bases, data);
        ...
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<long> mask, Vector<ulong> bases, long offset, Vector<long> data) => ScatterNonTemporal(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1_scatter[_u64base]_index[_s64](svbool_t pg, svuint64_t bases, int64_t index, svint64_t data)
        ///   STNT1D Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<long> mask, Vector<ulong> bases, long index, Vector<long> data) => ScatterNonTemporal(mask, bases, index, data);

        /// <summary>
        /// void svstnt1_scatter[_u32base_u32](svbool_t pg, svuint32_t bases, svuint32_t data)
        ///   STNT1W Zdata.S, Pg, [Zbases.S, XZR]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<uint> mask, Vector<uint> bases, Vector<uint> data) => ScatterNonTemporal(mask, bases, data);
        ...
        ///   STNT1W Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<uint> mask, Vector<uint> bases, long offset, Vector<uint> data) => ScatterNonTemporal(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1_scatter[_u32base]_index[_u32](svbool_t pg, svuint32_t bases, int64_t index, svuint32_t data)
        ///   STNT1W Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<uint> mask, Vector<uint> bases, long index, Vector<uint> data) => ScatterNonTemporal(mask, bases, index, data);

        /// <summary>
        /// void svstnt1_scatter[_u64base_u64](svbool_t pg, svuint64_t bases, svuint64_t data)
        ///   STNT1D Zdata.D, Pg, [Zbases.D, XZR]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<ulong> mask, Vector<ulong> bases, Vector<ulong> data) => ScatterNonTemporal(mask, bases, data);
        ...
        ///   STNT1D Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long offset, Vector<ulong> data) => ScatterNonTemporal(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1_scatter[_u64base]_index[_u64](svbool_t pg, svuint64_t bases, int64_t index, svuint64_t data)
        ///   STNT1D Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<ulong> mask, Vector<ulong> bases, long index, Vector<ulong> data) => ScatterNonTemporal(mask, bases, index, data);

        /// <summary>
        /// void svstnt1_scatter[_u32base_f32](svbool_t pg, svuint32_t bases, svfloat32_t data)
        ///   STNT1W Zdata.S, Pg, [Zbases.S, XZR]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<float> mask, Vector<uint> bases, Vector<float> data) => ScatterNonTemporal(mask, bases, data);
        ...
        ///   STNT1W Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<float> mask, Vector<uint> bases, long offset, Vector<float> data) => ScatterNonTemporal(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1_scatter[_u32base]_index[_f32](svbool_t pg, svuint32_t bases, int64_t index, svfloat32_t data)
        ///   STNT1W Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<float> mask, Vector<uint> bases, long index, Vector<float> data) => ScatterNonTemporal(mask, bases, index, data);
        ...
        ///   STNT1D Zdata.D, Pg, [Zbases.D, XZR]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<double> mask, Vector<ulong> bases, Vector<double> data) => ScatterNonTemporal(mask, bases, data);
        ...
        ///   STNT1D Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<double> mask, Vector<ulong> bases, long offset, Vector<double> data) => ScatterNonTemporal(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1_scatter[_u64base]_index[_f64](svbool_t pg, svuint64_t bases, int64_t index, svfloat64_t data)
        ///   STNT1D Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterNonTemporal(Vector<double> mask, Vector<ulong> bases, long index, Vector<double> data) => ScatterNonTemporal(mask, bases, index, data);
        ...
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<int> mask, Vector<uint> bases, long offset, Vector<int> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1h_scatter[_u32base]_index[_s32](svbool_t pg, svuint32_t bases, int64_t index, svint32_t data)
        ///   STNT1H Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<int> mask, Vector<uint> bases, long index, Vector<int> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, index, data);
        ...
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<long> mask, Vector<ulong> bases, long offset, Vector<long> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1h_scatter[_u64base]_index[_s64](svbool_t pg, svuint64_t bases, int64_t index, svint64_t data)
        ///   STNT1H Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<long> mask, Vector<ulong> bases, long index, Vector<long> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, index, data);

        /// <summary>
        /// void svstnt1h_scatter[_u32base]_offset[_u32](svbool_t pg, svuint32_t bases, int64_t offset, svuint32_t data)
        ///   STNT1H Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<uint> mask, Vector<uint> bases, long offset, Vector<uint> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1h_scatter[_u32base]_index[_u32](svbool_t pg, svuint32_t bases, int64_t index, svuint32_t data)
        ///   STNT1H Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<uint> mask, Vector<uint> bases, long index, Vector<uint> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, index, data);

        /// <summary>
        /// void svstnt1h_scatter[_u64base]_offset[_u64](svbool_t pg, svuint64_t bases, int64_t offset, svuint64_t data)
        ///   STNT1H Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<ulong> mask, Vector<ulong> bases, long offset, Vector<ulong> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1h_scatter[_u64base]_index[_u64](svbool_t pg, svuint64_t bases, int64_t index, svuint64_t data)
        ///   STNT1H Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate16NonTemporalUInt16(Vector<ulong> mask, Vector<ulong> bases, long index, Vector<ulong> data) => ScatterTruncate16NonTemporalUInt16(mask, bases, index, data);
        ...
        /// </summary>
        public static unsafe void ScatterTruncate32NonTemporalUInt32(Vector<long> mask, Vector<ulong> bases, long offset, Vector<long> data) => ScatterTruncate32NonTemporalUInt32(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1w_scatter[_u64base]_index[_s64](svbool_t pg, svuint64_t bases, int64_t index, svint64_t data)
        ///   STNT1W Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate32NonTemporalUInt32(Vector<long> mask, Vector<ulong> bases, long index, Vector<long> data) => ScatterTruncate32NonTemporalUInt32(mask, bases, index, data);

        /// <summary>
        /// void svstnt1w_scatter[_u64base]_offset[_u64](svbool_t pg, svuint64_t bases, int64_t offset, svuint64_t data)
        ///   STNT1W Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate32NonTemporalUInt32(Vector<ulong> mask, Vector<ulong> bases, long offset, Vector<ulong> data) => ScatterTruncate32NonTemporalUInt32(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1w_scatter[_u64base]_index[_u64](svbool_t pg, svuint64_t bases, int64_t index, svuint64_t data)
        ///   STNT1W Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate32NonTemporalUInt32(Vector<ulong> mask, Vector<ulong> bases, long index, Vector<ulong> data) => ScatterTruncate32NonTemporalUInt32(mask, bases, index, data);
        ...
        /// </summary>
        public static unsafe void ScatterTruncate8NonTemporalByte(Vector<int> mask, Vector<uint> bases, long offset, Vector<int> data) => ScatterTruncate8NonTemporalByte(mask, bases, offset, data);
        ...
        /// </summary>
        public static unsafe void ScatterTruncate8NonTemporalByte(Vector<long> mask, Vector<ulong> bases, long offset, Vector<long> data) => ScatterTruncate8NonTemporalByte(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1b_scatter[_u32base]_offset[_u32](svbool_t pg, svuint32_t bases, int64_t offset, svuint32_t data)
        ///   STNT1B Zdata.S, Pg, [Zbases.S, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate8NonTemporalByte(Vector<uint> mask, Vector<uint> bases, long offset, Vector<uint> data) => ScatterTruncate8NonTemporalByte(mask, bases, offset, data);

        /// <summary>
        /// void svstnt1b_scatter[_u64base]_offset[_u64](svbool_t pg, svuint64_t bases, int64_t offset, svuint64_t data)
        ///   STNT1B Zdata.D, Pg, [Zbases.D, Xoffset]
        /// </summary>
        public static unsafe void ScatterTruncate8NonTemporalByte(Vector<ulong> mask, Vector<ulong> bases, long offset, Vector<ulong> data) => ScatterTruncate8NonTemporalByte(mask, bases, offset, data);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> ShiftLeftAndInsert(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svint16_t svsli[_n_s16](svint16_t op1, svint16_t op2, uint64_t imm3)
        ///   SLI Ztied1.H, Zop2.H, #imm3
        /// </summary>
        public static unsafe Vector<short> ShiftLeftAndInsert(Vector<short> op1, Vector<short> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svint32_t svsli[_n_s32](svint32_t op1, svint32_t op2, uint64_t imm3)
        ///   SLI Ztied1.S, Zop2.S, #imm3
        /// </summary>
        public static unsafe Vector<int> ShiftLeftAndInsert(Vector<int> op1, Vector<int> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svint64_t svsli[_n_s64](svint64_t op1, svint64_t op2, uint64_t imm3)
        ///   SLI Ztied1.D, Zop2.D, #imm3
        /// </summary>
        public static unsafe Vector<long> ShiftLeftAndInsert(Vector<long> op1, Vector<long> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint8_t svsli[_n_u8](svuint8_t op1, svuint8_t op2, uint64_t imm3)
        ///   SLI Ztied1.B, Zop2.B, #imm3
        /// </summary>
        public static unsafe Vector<byte> ShiftLeftAndInsert(Vector<byte> op1, Vector<byte> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint16_t svsli[_n_u16](svuint16_t op1, svuint16_t op2, uint64_t imm3)
        ///   SLI Ztied1.H, Zop2.H, #imm3
        /// </summary>
        public static unsafe Vector<ushort> ShiftLeftAndInsert(Vector<ushort> op1, Vector<ushort> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint32_t svsli[_n_u32](svuint32_t op1, svuint32_t op2, uint64_t imm3)
        ///   SLI Ztied1.S, Zop2.S, #imm3
        /// </summary>
        public static unsafe Vector<uint> ShiftLeftAndInsert(Vector<uint> op1, Vector<uint> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint64_t svsli[_n_u64](svuint64_t op1, svuint64_t op2, uint64_t imm3)
        ///   SLI Ztied1.D, Zop2.D, #imm3
        /// </summary>
        public static unsafe Vector<ulong> ShiftLeftAndInsert(Vector<ulong> op1, Vector<ulong> op2, ulong imm3) => ShiftLeftAndInsert(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<short> ShiftLeftWideningLower(Vector<sbyte> op1, ulong imm2) => ShiftLeftWideningLower(op1, imm2);

        /// <summary>
        /// svint32_t svshllb[_n_s32](svint16_t op1, uint64_t imm2)
        ///   SSHLLB Zresult.S, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<int> ShiftLeftWideningLower(Vector<short> op1, ulong imm2) => ShiftLeftWideningLower(op1, imm2);

        /// <summary>
        /// svint64_t svshllb[_n_s64](svint32_t op1, uint64_t imm2)
        ///   SSHLLB Zresult.D, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<long> ShiftLeftWideningLower(Vector<int> op1, ulong imm2) => ShiftLeftWideningLower(op1, imm2);

        /// <summary>
        /// svuint16_t svshllb[_n_u16](svuint8_t op1, uint64_t imm2)
        ///   USHLLB Zresult.H, Zop1.B, #imm2
        /// </summary>
        public static unsafe Vector<ushort> ShiftLeftWideningLower(Vector<byte> op1, ulong imm2) => ShiftLeftWideningLower(op1, imm2);

        /// <summary>
        /// svuint32_t svshllb[_n_u32](svuint16_t op1, uint64_t imm2)
        ///   USHLLB Zresult.S, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<uint> ShiftLeftWideningLower(Vector<ushort> op1, ulong imm2) => ShiftLeftWideningLower(op1, imm2);

        /// <summary>
        /// svuint64_t svshllb[_n_u64](svuint32_t op1, uint64_t imm2)
        ///   USHLLB Zresult.D, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ulong> ShiftLeftWideningLower(Vector<uint> op1, ulong imm2) => ShiftLeftWideningLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<short> ShiftLeftWideningUpper(Vector<sbyte> op1, ulong imm2) => ShiftLeftWideningUpper(op1, imm2);

        /// <summary>
        /// svint32_t svshllt[_n_s32](svint16_t op1, uint64_t imm2)
        ///   SSHLLT Zresult.S, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<int> ShiftLeftWideningUpper(Vector<short> op1, ulong imm2) => ShiftLeftWideningUpper(op1, imm2);

        /// <summary>
        /// svint64_t svshllt[_n_s64](svint32_t op1, uint64_t imm2)
        ///   SSHLLT Zresult.D, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<long> ShiftLeftWideningUpper(Vector<int> op1, ulong imm2) => ShiftLeftWideningUpper(op1, imm2);

        /// <summary>
        /// svuint16_t svshllt[_n_u16](svuint8_t op1, uint64_t imm2)
        ///   USHLLT Zresult.H, Zop1.B, #imm2
        /// </summary>
        public static unsafe Vector<ushort> ShiftLeftWideningUpper(Vector<byte> op1, ulong imm2) => ShiftLeftWideningUpper(op1, imm2);

        /// <summary>
        /// svuint32_t svshllt[_n_u32](svuint16_t op1, uint64_t imm2)
        ///   USHLLT Zresult.S, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<uint> ShiftLeftWideningUpper(Vector<ushort> op1, ulong imm2) => ShiftLeftWideningUpper(op1, imm2);

        /// <summary>
        /// svuint64_t svshllt[_n_u64](svuint32_t op1, uint64_t imm2)
        ///   USHLLT Zresult.D, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ulong> ShiftLeftWideningUpper(Vector<uint> op1, ulong imm2) => ShiftLeftWideningUpper(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> ShiftRightAndAccumulate(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<short> ShiftRightAndAccumulate(Vector<short> op1, Vector<short> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<int> ShiftRightAndAccumulate(Vector<int> op1, Vector<int> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<long> ShiftRightAndAccumulate(Vector<long> op1, Vector<long> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<byte> ShiftRightAndAccumulate(Vector<byte> op1, Vector<byte> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<ushort> ShiftRightAndAccumulate(Vector<ushort> op1, Vector<ushort> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<uint> ShiftRightAndAccumulate(Vector<uint> op1, Vector<uint> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<ulong> ShiftRightAndAccumulate(Vector<ulong> op1, Vector<ulong> op2, ulong imm3) => ShiftRightAndAccumulate(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> ShiftRightAndInsert(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svint16_t svsri[_n_s16](svint16_t op1, svint16_t op2, uint64_t imm3)
        ///   SRI Ztied1.H, Zop2.H, #imm3
        /// </summary>
        public static unsafe Vector<short> ShiftRightAndInsert(Vector<short> op1, Vector<short> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svint32_t svsri[_n_s32](svint32_t op1, svint32_t op2, uint64_t imm3)
        ///   SRI Ztied1.S, Zop2.S, #imm3
        /// </summary>
        public static unsafe Vector<int> ShiftRightAndInsert(Vector<int> op1, Vector<int> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svint64_t svsri[_n_s64](svint64_t op1, svint64_t op2, uint64_t imm3)
        ///   SRI Ztied1.D, Zop2.D, #imm3
        /// </summary>
        public static unsafe Vector<long> ShiftRightAndInsert(Vector<long> op1, Vector<long> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint8_t svsri[_n_u8](svuint8_t op1, svuint8_t op2, uint64_t imm3)
        ///   SRI Ztied1.B, Zop2.B, #imm3
        /// </summary>
        public static unsafe Vector<byte> ShiftRightAndInsert(Vector<byte> op1, Vector<byte> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint16_t svsri[_n_u16](svuint16_t op1, svuint16_t op2, uint64_t imm3)
        ///   SRI Ztied1.H, Zop2.H, #imm3
        /// </summary>
        public static unsafe Vector<ushort> ShiftRightAndInsert(Vector<ushort> op1, Vector<ushort> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint32_t svsri[_n_u32](svuint32_t op1, svuint32_t op2, uint64_t imm3)
        ///   SRI Ztied1.S, Zop2.S, #imm3
        /// </summary>
        public static unsafe Vector<uint> ShiftRightAndInsert(Vector<uint> op1, Vector<uint> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);

        /// <summary>
        /// svuint64_t svsri[_n_u64](svuint64_t op1, svuint64_t op2, uint64_t imm3)
        ///   SRI Ztied1.D, Zop2.D, #imm3
        /// </summary>
        public static unsafe Vector<ulong> ShiftRightAndInsert(Vector<ulong> op1, Vector<ulong> op2, ulong imm3) => ShiftRightAndInsert(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> ShiftRightNarrowingLower(Vector<short> op1, ulong imm2) => ShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint16_t svshrnb[_n_s32](svint32_t op1, uint64_t imm2)
        ///   SHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> ShiftRightNarrowingLower(Vector<int> op1, ulong imm2) => ShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svint32_t svshrnb[_n_s64](svint64_t op1, uint64_t imm2)
        ///   SHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> ShiftRightNarrowingLower(Vector<long> op1, ulong imm2) => ShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint8_t svshrnb[_n_u16](svuint16_t op1, uint64_t imm2)
        ///   SHRNB Zresult.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> ShiftRightNarrowingLower(Vector<ushort> op1, ulong imm2) => ShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint16_t svshrnb[_n_u32](svuint32_t op1, uint64_t imm2)
        ///   SHRNB Zresult.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> ShiftRightNarrowingLower(Vector<uint> op1, ulong imm2) => ShiftRightNarrowingLower(op1, imm2);

        /// <summary>
        /// svuint32_t svshrnb[_n_u64](svuint64_t op1, uint64_t imm2)
        ///   SHRNB Zresult.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> ShiftRightNarrowingLower(Vector<ulong> op1, ulong imm2) => ShiftRightNarrowingLower(op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> ShiftRightNarrowingUpper(Vector<sbyte> even, Vector<short> op1, ulong imm2) => ShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint16_t svshrnt[_n_s32](svint16_t even, svint32_t op1, uint64_t imm2)
        ///   SHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<short> ShiftRightNarrowingUpper(Vector<short> even, Vector<int> op1, ulong imm2) => ShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svint32_t svshrnt[_n_s64](svint32_t even, svint64_t op1, uint64_t imm2)
        ///   SHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<int> ShiftRightNarrowingUpper(Vector<int> even, Vector<long> op1, ulong imm2) => ShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint8_t svshrnt[_n_u16](svuint8_t even, svuint16_t op1, uint64_t imm2)
        ///   SHRNT Ztied.B, Zop1.H, #imm2
        /// </summary>
        public static unsafe Vector<byte> ShiftRightNarrowingUpper(Vector<byte> even, Vector<ushort> op1, ulong imm2) => ShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint16_t svshrnt[_n_u32](svuint16_t even, svuint32_t op1, uint64_t imm2)
        ///   SHRNT Ztied.H, Zop1.S, #imm2
        /// </summary>
        public static unsafe Vector<ushort> ShiftRightNarrowingUpper(Vector<ushort> even, Vector<uint> op1, ulong imm2) => ShiftRightNarrowingUpper(even, op1, imm2);

        /// <summary>
        /// svuint32_t svshrnt[_n_u64](svuint32_t even, svuint64_t op1, uint64_t imm2)
        ///   SHRNT Ztied.S, Zop1.D, #imm2
        /// </summary>
        public static unsafe Vector<uint> ShiftRightNarrowingUpper(Vector<uint> even, Vector<ulong> op1, ulong imm2) => ShiftRightNarrowingUpper(even, op1, imm2);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> Xor(Vector<sbyte> op1, Vector<sbyte> op2, Vector<sbyte> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<short> Xor(Vector<short> op1, Vector<short> op2, Vector<short> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<int> Xor(Vector<int> op1, Vector<int> op2, Vector<int> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<long> Xor(Vector<long> op1, Vector<long> op2, Vector<long> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<byte> Xor(Vector<byte> op1, Vector<byte> op2, Vector<byte> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ushort> Xor(Vector<ushort> op1, Vector<ushort> op2, Vector<ushort> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<uint> Xor(Vector<uint> op1, Vector<uint> op2, Vector<uint> op3) => Xor(op1, op2, op3);
        ...
        ///   MOVPRFX Zresult, Zop1; EOR3 Zresult.D, Zresult.D, Zop2.D, Zop3.D
        /// </summary>
        public static unsafe Vector<ulong> Xor(Vector<ulong> op1, Vector<ulong> op2, Vector<ulong> op3) => Xor(op1, op2, op3);
        ...
        /// </summary>
        public static unsafe Vector<sbyte> XorRotateRight(Vector<sbyte> op1, Vector<sbyte> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<short> XorRotateRight(Vector<short> op1, Vector<short> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<int> XorRotateRight(Vector<int> op1, Vector<int> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        /// </summary>
        public static unsafe Vector<long> XorRotateRight(Vector<long> op1, Vector<long> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        ///   MOVPRFX Zresult, Zop1; XAR Zresult.B, Zresult.B, Zop2.B, #imm3
        /// </summary>
        public static unsafe Vector<byte> XorRotateRight(Vector<byte> op1, Vector<byte> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        ///   MOVPRFX Zresult, Zop1; XAR Zresult.H, Zresult.H, Zop2.H, #imm3
        /// </summary>
        public static unsafe Vector<ushort> XorRotateRight(Vector<ushort> op1, Vector<ushort> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        ///   MOVPRFX Zresult, Zop1; XAR Zresult.S, Zresult.S, Zop2.S, #imm3
        /// </summary>
        public static unsafe Vector<uint> XorRotateRight(Vector<uint> op1, Vector<uint> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
        ...
        ///   MOVPRFX Zresult, Zop1; XAR Zresult.D, Zresult.D, Zop2.D, #imm3
        /// </summary>
        public static unsafe Vector<ulong> XorRotateRight(Vector<ulong> op1, Vector<ulong> op2, ulong imm3) => XorRotateRight(op1, op2, imm3);
