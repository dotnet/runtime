...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class AdvSimd : ArmBase
    {
        ...
        /// </summary>
        public static Vector64<short> ShiftRightArithmeticRounded(Vector64<short> value, [ConstantExpected(Min = 1, Max = (byte)(8))] byte count) => ShiftRightArithmeticRounded(value, count);
        ...
        /// </summary>
        public static Vector128<short> ShiftRightArithmeticRoundedAdd(Vector128<short> addend, Vector128<short> value, [ConstantExpected(Min = 1, Max = (byte)(8))] byte count) => ShiftRightArithmeticRoundedAdd(addend, value, count);
