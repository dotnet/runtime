...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class AdvSimd : ArmBase
    {
        ...
        public new abstract class Arm64 : ArmBase.Arm64
        {
            ...
            /// </summary>
            public static Vector128<byte> VectorTableLookupExtension(Vector128<byte> defaultValues, (Vector128<byte>, Vector128<byte>) table, Vector128<byte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

            /// <summary>
            ///  int8x16_t vqtbx2q_s8(int8x16x2_t t, uint8x16_t idx)
            ///   A64: TBX Vd.16B, {Vn.16B, Vn+1.16B}, Vm.16B
            /// </summary>
            public static Vector128<sbyte> VectorTableLookupExtension(Vector128<sbyte> defaultValues, (Vector128<sbyte>, Vector128<sbyte>) table, Vector128<sbyte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

            /// <summary>
            ///  uint8x16_t vqtbx3q_u8(uint8x16x3_t t, uint8x16_t idx)
            ///   A64: TBX Vd.16B, {Vn.16B, Vn+1.16B, Vn+2.16B}, Vm.16B
            /// </summary>
            public static Vector128<byte> VectorTableLookupExtension(Vector128<byte> defaultValues, (Vector128<byte>, Vector128<byte>, Vector128<byte>) table, Vector128<byte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

            /// <summary>
            ///  int8x16_t vqtbx3q_s8(int8x16x3_t t, uint8x16_t idx)
            ///   A64: TBX Vd.16B, {Vn.16B, Vn+1.16B, Vn+2.16B}, Vm.16B
            /// </summary>
            public static Vector128<sbyte> VectorTableLookupExtension(Vector128<sbyte> defaultValues, (Vector128<sbyte>, Vector128<sbyte>, Vector128<sbyte>) table, Vector128<sbyte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

            /// <summary>
            ///  uint8x16_t vqtbx4q_u8(uint8x16x4_t t, uint8x16_t idx)
            ///   A64: TBX Vd.16B, {Vn.16B, Vn+1.16B, Vn+2.16B, Vn+3.16B}, Vm.16B
            /// </summary>
            public static Vector128<byte> VectorTableLookupExtension(Vector128<byte> defaultValues, (Vector128<byte>, Vector128<byte>, Vector128<byte>, Vector128<byte>) table, Vector128<byte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

            /// <summary>
            ///  int8x16_t vqtbx4q_s8(int8x16x4_t t, uint8x16_t idx)
            ///   A64: TBX Vd.16B, {Vn.16B, Vn+1.16B, Vn+2.16B, Vn+3.16B}, Vm.16B
            /// </summary>
            public static Vector128<sbyte> VectorTableLookupExtension(Vector128<sbyte> defaultValues, (Vector128<sbyte>, Vector128<sbyte>, Vector128<sbyte>, Vector128<sbyte>) table, Vector128<sbyte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);
        ...
        /// </summary>
        public static Vector64<byte> VectorTableLookupExtension(Vector64<byte> defaultValues, (Vector128<byte>, Vector128<byte>) table, Vector64<byte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

        /// <summary>
        ///  int8x8_t vqtbx2q_u8(int8x16x2_t t, uint8x8_t idx)
        ///   A64: TBX Vd.8B, {Vn.16B, Vn+1.16B}, Vm.8B
        /// </summary>
        public static Vector64<sbyte> VectorTableLookupExtension(Vector64<sbyte> defaultValues, (Vector128<sbyte>, Vector128<sbyte>) table, Vector64<sbyte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

        /// <summary>
        ///  uint8x8_t vqtbx3q_u8(uint8x16x3_t t, uint8x8_t idx)
        ///   A64: TBX Vd.8B, {Vn.16B, Vn+1.16B, Vn+2.16B}, Vm.8B
        /// </summary>
        public static Vector64<byte> VectorTableLookupExtension(Vector64<byte> defaultValues, (Vector128<byte>, Vector128<byte>, Vector128<byte>) table, Vector64<byte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

        /// <summary>
        ///  int8x8_t vqtbx3q_u8(int8x16x3_t t, uint8x8_t idx)
        ///   A64: TBX Vd.8B, {Vn.16B, Vn+1.16B, Vn+2.16B}, Vm.8B
        /// </summary>
        public static Vector64<sbyte> VectorTableLookupExtension(Vector64<sbyte> defaultValues, (Vector128<sbyte>, Vector128<sbyte>, Vector128<sbyte>) table, Vector64<sbyte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

        /// <summary>
        ///  uint8x8_t vqtbx4q_u8(uint8x16x4_t t, uint8x8_t idx)
        ///   A64: TBX Vd.8B, {Vn.16B, Vn+1.16B, Vn+2.16B, Vn+3.16B}, Vm.8B
        /// </summary>
        public static Vector64<byte> VectorTableLookupExtension(Vector64<byte> defaultValues, (Vector128<byte>, Vector128<byte>, Vector128<byte>, Vector128<byte>) table, Vector64<byte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);

        /// <summary>
        ///  int8x8_t vqtbx4q_u8(int8x16x4_t t, uint8x8_t idx)
        ///   A64: TBX Vd.8B, {Vn.16B, Vn+1.16B, Vn+2.16B, Vn+3.16B}, Vm.8B
        /// </summary>
        public static Vector64<sbyte> VectorTableLookupExtension(Vector64<sbyte> defaultValues, (Vector128<sbyte>, Vector128<sbyte>, Vector128<sbyte>, Vector128<sbyte>) table, Vector64<sbyte> byteIndexes) => VectorTableLookupExtension(table, byteIndexes);
