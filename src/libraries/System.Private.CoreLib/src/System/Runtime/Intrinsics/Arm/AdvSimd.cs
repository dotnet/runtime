...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class AdvSimd : ArmBase
    {
        ...
        /// </summary>
        public static double Extract(Vector64<double> vector, byte index) => Extract(vector, index);
        ...
        /// </summary>
        public static long Extract(Vector64<long> vector, byte index) => Extract(vector, index);
        ...
        ///   A64: UMOV Xd, Vn.D[lane]
        /// </summary>
        public static ulong Extract(Vector64<ulong> vector, byte index) => Extract(vector, index);
