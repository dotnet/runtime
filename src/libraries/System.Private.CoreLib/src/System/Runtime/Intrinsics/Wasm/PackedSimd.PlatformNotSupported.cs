...
namespace System.Runtime.Intrinsics.Wasm
{
    ...
    public abstract class PackedSimd
    {
        ...
        public static Vector128<sbyte> Shuffle(Vector128<sbyte> lower, Vector128<sbyte> upper, [ConstantExpected] Vector128<sbyte> indices) { throw new PlatformNotSupportedException(); }
        public static Vector128<byte>  Shuffle(Vector128<byte>  lower, Vector128<byte>  upper, [ConstantExpected] Vector128<byte>  indices) { throw new PlatformNotSupportedException(); }
