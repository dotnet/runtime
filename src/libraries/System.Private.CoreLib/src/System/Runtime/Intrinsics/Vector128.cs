...
namespace System.Runtime.Intrinsics
{
    ...
    public static partial class Vector128
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int CountMatches<T>(Vector128<T> vector) => BitOperations.PopCount(vector.ExtractMostSignificantBits());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int IndexOfLastMatch<T>(Vector128<T> vector) => 31 - BitOperations.LeadingZeroCount(vector.ExtractMostSignificantBits());
