...
namespace System.Runtime.Intrinsics
{
    ...
    public static class Vector64
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int CountMatches<T>(Vector64<T> vector) => BitOperations.PopCount(vector.ExtractMostSignificantBits());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int IndexOfLastMatch<T>(Vector64<T> vector) => 31 - BitOperations.LeadingZeroCount(vector.ExtractMostSignificantBits());
