...
namespace System.Runtime.Intrinsics.LoongArch
{
    ...
    public abstract class Lasx : Lsx
    {
        ...
        /// </summary>
        public static Vector256<sbyte> AddOddEvenElementsWidening(Vector256<sbyte> left, Vector256<sbyte> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint16x16_t xvhaddw_hu_bu(uint3x32_t a, uint3x32_t b)
        ///   LASX: XVHADDW.HU.BU Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<byte> AddOddEvenElementsWidening(Vector256<byte> left, Vector256<byte> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// int32x8_t xvhaddw_w_h(int16x16_t a, int16x16_t b)
        ///   LASX: XVHADDW.W.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<short> AddOddEvenElementsWidening(Vector256<short> left, Vector256<short> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint32x8_t xvhaddw_wu_hu(uint16x16_t a, uint16x16_t b)
        ///   LASX: XVHADDW.WU.HU Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<ushort> AddOddEvenElementsWidening(Vector256<ushort> left, Vector256<ushort> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// int64x4_t xvhaddw_d_w(int32x8_t a, int32x8_t b)
        ///   LASX: XVHADDW.D.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<int> AddOddEvenElementsWidening(Vector256<int> left, Vector256<int> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint64x4_t xvhaddw_du_wu(uint32x8_t a, uint32x8_t b)
        ///   LASX: XVHADDW.DU.WU Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<uint> AddOddEvenElementsWidening(Vector256<uint> left, Vector256<uint> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// int128x2_t xvhaddw_q_d(int64x4_t a, int64x4_t b)  TODO: long --> longlong 128bits.
        ///   LASX: XVHADDW.Q.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> AddOddEvenElementsWidening(Vector256<long> left, Vector256<long> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint128x2_t xvhaddw_qu_du(uint64x4_t a, uint64x4_t b)
        ///   LASX: XVHADDW.QU.DU Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> AddOddEvenElementsWidening(Vector256<ulong> left, Vector256<ulong> right) => AddOddEvenElementsWidening(left, right);

        /// <summary>
        /// int16x16_t xvaddwev_h_b(int8x32_t a, int8x32_t b)
        ///   LASX: XVADDWEV.H.B Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<short> AddEvenElementsWidening(Vector256<sbyte> left, Vector256<sbyte> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// uint16x16_t xvaddwev_h_bu(uint8x32_t a, uint8x32_t b)
        ///   LASX: XVADDWEV.H.BU Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<ushort> AddEvenElementsWidening(Vector256<byte> left, Vector256<byte> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int32x8_t xvaddwev_w_h(int16x16_t a, int16x16_t b)
        ///   LASX: XVADDWEV.W.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<int> AddEvenElementsWidening(Vector256<short> left, Vector256<short> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// uint32x8_t xvaddwev_w_hu(uint16x16_t a, uint16x16_t b)
        ///   LASX: XVADDWEV.W.HU Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<uint> AddEvenElementsWidening(Vector256<ushort> left, Vector256<ushort> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int64x4_t xvaddwev_d_w(int32x8_t a, int32x8_t b)
        ///   LASX: XVADDWEV.D.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<long> AddEvenElementsWidening(Vector256<int> left, Vector256<int> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// uint64x4_t xvaddwev_d_wu(uint32x8_t a, uint32x8_t b)
        ///   LASX: XVADDWEV.D.WU Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<ulong> AddEvenElementsWidening(Vector256<uint> left, Vector256<uint> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int128x2_t xvaddwev_q_d(int64x4_t a, int64x4_t b)  TODO: long --> longlong 128bits.
        ///   LASX: XVADDWEV.Q.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> AddEvenElementsWidening(Vector256<long> left, Vector256<long> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// uint128x2_t xvaddwev_q_du(uint64x4_t a, uint64x4_t b)
        ///   LASX: XVADDWEV.Q.DU Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> AddEvenElementsWidening(Vector256<ulong> left, Vector256<ulong> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int16x16_t xvaddwod_h_b(int8x32_t a, int8x32_t b)
        ///   LASX: XVADDWOD.H.B Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<short> AddOddElementsWidening(Vector256<sbyte> left, Vector256<sbyte> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// uint16x16_t xvaddwod_h_bu(uint8x32_t a, uint8x32_t b)
        ///   LASX: XVADDWOD.H.BU Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<ushort> AddOddElementsWidening(Vector256<byte> left, Vector256<byte> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int32x8_t xvaddwod_w_h(int16x16_t a, int16x16_t b)
        ///   LASX: XVADDWOD.W.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<int> AddOddElementsWidening(Vector256<short> left, Vector256<short> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// uint32x8_t xvaddwod_w_hu(uint16x16_t a, uint16x16_t b)
        ///   LASX: XVADDWOD.W.HU Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<uint> AddOddElementsWidening(Vector256<ushort> left, Vector256<ushort> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int64x4_t xvaddwod_d_w(int32x8_t a, int32x8_t b)
        ///   LASX: XVADDWOD.D.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<long> AddOddElementsWidening(Vector256<int> left, Vector256<int> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// uint64x4_t xvaddwod_d_wu(uint32x8_t a, uint32x8_t b)
        ///   LASX: XVADDWOD.D.WU Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<ulong> AddOddElementsWidening(Vector256<uint> left, Vector256<uint> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int128x2_t xvaddwod_q_d(int64x4_t a, int64x4_t b)  TODO: long --> longlong 128bits.
        ///   LASX: XVADDWOD.Q.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> AddOddElementsWidening(Vector256<long> left, Vector256<long> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// uint128x2_t xvaddwod_q_du(uint64x4_t a, uint64x4_t b)
        ///   LASX: XVADDWOD.Q.DU Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> AddOddElementsWidening(Vector256<ulong> left, Vector256<ulong> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int16x16_t xvaddwev_h_bu_b(int8x32_t a, int8x32_t b)
        ///   LASX: XVADDWEV.H.BU.B Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<short> AddEvenElementsWidening(Vector256<byte> left, Vector256<sbyte> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int32x8_t xvaddwev_w_hu_h(int16x16_t a, int16x16_t b)
        ///   LASX: XVADDWEV.W.HU.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<int> AddEvenElementsWidening(Vector256<ushort> left, Vector256<short> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int64x4_t xvaddwev_d_wu_w(int32x8_t a, int32x8_t b)
        ///   LASX: XVADDWEV.D.WU.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<long> AddEvenElementsWidening(Vector256<uint> left, Vector256<int> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int128x2_t xvaddwev_q_du_d(int64x4_t a, int64x4_t b)  TODO: long --> longlong 128bits.
        ///   LASX: XVADDWEV.Q.DU.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> AddEvenElementsWidening(Vector256<ulong> left, Vector256<long> right) => AddEvenElementsWidening(left, right);

        /// <summary>
        /// int16x16_t xvaddwod_h_bu_b(int8x32_t a, int8x32_t b)
        ///   LASX: XVADDWOD.H.BU.B Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<short> AddOddElementsWidening(Vector256<byte> left, Vector256<sbyte> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int32x8_t xvaddwod_w_hu_h(int16x16_t a, int16x16_t b)
        ///   LASX: XVADDWOD.W.HU.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<int> AddOddElementsWidening(Vector256<ushort> left, Vector256<short> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int64x4_t xvaddwod_d_wu_w(int32x8_t a, int32x8_t b)
        ///   LASX: XVADDWOD.D.WU.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<long> AddOddElementsWidening(Vector256<uint> left, Vector256<int> right) => AddOddElementsWidening(left, right);

        /// <summary>
        /// int128x2_t xvaddwod_q_du_d(int64x4_t a, int64x4_t b)  TODO: long --> longlong 128bits.
        ///   LASX: XVADDWOD.Q.DU.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> AddOddElementsWidening(Vector256<ulong> left, Vector256<long> right) => AddOddElementsWidening(left, right);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.H.B Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector128<long> AddHorizontalElements(Vector256<sbyte> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.HU.BU Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector128<ulong> AddHorizontalElements(Vector256<byte> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.W.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector128<long> AddHorizontalElements(Vector256<short> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.WU.HU Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector128<ulong> AddHorizontalElements(Vector256<ushort> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.D.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector128<long> AddHorizontalElements(Vector256<int> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.DU.WU Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector128<long> AddHorizontalElements(Vector256<uint> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.Q.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector128<long> AddHorizontalElements(Vector256<long> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: XVHADDW.QU.DU Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector128<ulong> AddHorizontalElements(Vector256<ulong> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: sum_all_float_elements witin vector.
        /// </summary>
        public static Vector64<float> AddHorizontalElements(Vector256<float> value) => AddHorizontalElements(value);

        /// <summary>
        ///   NOTE: this is implemented by multi instructions.
        ///   LASX: sum_all_double_elements witin vector.
        /// </summary>
        public static Vector64<double> AddHorizontalElements(Vector256<double> value) => AddHorizontalElements(value);
        ...
        /// </summary>
        public static Vector256<sbyte> SubtractOddEvenElementsWidening(Vector256<sbyte> left, Vector256<sbyte> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint16x16_t xvhsubw_hu_bu(uint3x32_t a, uint3x32_t b)
        ///   LASX: XVHSUBW.HU.BU Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<byte> SubtractOddEvenElementsWidening(Vector256<byte> left, Vector256<byte> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// int32x8_t xvhsubw_w_h(int16x16_t a, int16x16_t b)
        ///   LASX: XVHSUBW.W.H Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<short> SubtractOddEvenElementsWidening(Vector256<short> left, Vector256<short> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint32x8_t xvhsubw_wu_hu(uint16x16_t a, uint16x16_t b)
        ///   LASX: XVHSUBW.WU.HU Xd.8W, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<ushort> SubtractOddEvenElementsWidening(Vector256<ushort> left, Vector256<ushort> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// int64x4_t xvhsubw_d_w(int32x8_t a, int32x8_t b)
        ///   LASX: XVHSUBW.D.W Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<int> SubtractOddEvenElementsWidening(Vector256<int> left, Vector256<int> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint64x4_t xvhsubw_du_wu(uint32x8_t a, uint32x8_t b)
        ///   LASX: XVHSUBW.DU.WU Xd.4D, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<uint> SubtractOddEvenElementsWidening(Vector256<uint> left, Vector256<uint> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// int128x2_t xvhsubw_q_d(int64x4_t a, int64x4_t b)  TODO: long --> longlong 128bits.
        ///   LASX: XVHSUBW.Q.D Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> SubtractOddEvenElementsWidening(Vector256<long> left, Vector256<long> right) => SubtractOddEvenElementsWidening(left, right);

        /// <summary>
        /// uint128x2_t xvhsubw_qu_du(uint64x4_t a, uint64x4_t b)
        ///   LASX: XVHSUBW.QU.DU Xd.2Q, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> SubtractOddEvenElementsWidening(Vector256<ulong> left, Vector256<ulong> right) => SubtractOddEvenElementsWidening(left, right);
        ...
        /// </summary>
        public static Vector256<float> FusedMultiplyAdd(Vector256<float> left, Vector256<float> right, Vector256<float> addend) => FusedMultiplyAdd(left, right, addend);

        /// <summary>
        /// float64x4_t xvfmadd_d(float64x4_t a, float64x4_t b, float64x4_t c)
        ///   LASX: XVFMADD.D Xd.4D, Xj.4D, Xk.4D, Xa.4D
        /// </summary>
        public static Vector256<double> FusedMultiplyAdd(Vector256<double> left, Vector256<double> right, Vector256<double> addend) => FusedMultiplyAdd(left, right, addend);

        /// <summary>
        /// float32x8_t xvfnmadd_s(float32x8_t a, float32x8_t b, float32x8_t c)
        ///   LASX: XVFNMADD.S Xd.8S, Xj.8S, Xk.8S, Xa.8S
        /// </summary>
        public static Vector256<float> FusedMultiplyAddNegated(Vector256<float> left, Vector256<float> right, Vector256<float> addend) => FusedMultiplyAddNegated(left, right, addend);

        /// <summary>
        /// float64x4_t xvfnmadd_d(float64x4_t a, float64x4_t b, float64x4_t c)
        ///   LASX: XVFNMADD.D Xd.4D, Xj.4D, Xk.4D, Xa.4D
        /// </summary>
        public static Vector256<double> FusedMultiplyAddNegated(Vector256<double> left, Vector256<double> right, Vector256<double> addend) => FusedMultiplyAddNegated(left, right, addend);
        ...
        /// </summary>
        public static Vector256<long> MultiplyAdd(Vector256<long> addend, Vector256<long> left, Vector256<long> right) => MultiplyAdd(addend, left, right);

        /// <summary>
        /// uint64x4_t xvmadd_d(uint64x4_t a, uint64x4_t b, uint64x4_t c)
        ///   LASX: XVMADD.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> MultiplyAdd(Vector256<ulong> addend, Vector256<ulong> left, Vector256<ulong> right) => MultiplyAdd(addend, left, right);

        /// <summary>
        /// float32x8_t xvfmsub_s(float32x8_t a, float32x8_t b, float32x8_t c)
        ///   LASX: XVFMSUB.S Xd.8S, Xj.8S, Xk.8S, Xa.8S
        /// </summary>
        public static Vector256<float> FusedMultiplySubtract(Vector256<float> left, Vector256<float> right, Vector256<float> minuend) => FusedMultiplySubtract(left, right, minuend);

        /// <summary>
        /// float64x4_t xvfmsub_d(float64x4_t a, float64x4_t b, float64x4_t c)
        ///   LASX: XVFMSUB.D Xd.4D, Xj.4D, Xk.4D, Xa.4D
        /// </summary>
        public static Vector256<double> FusedMultiplySubtract(Vector256<double> left, Vector256<double> right, Vector256<double> minuend) => FusedMultiplySubtract(left, right, minuend);

        /// <summary>
        /// float32x8_t xvfnmsub_s(float32x8_t a, float32x8_t b, float32x8_t c)
        ///   LASX: XVFNMSUB.S Xd.8S, Xj.8S, Xk.8S, Xa.8S
        /// </summary>
        public static Vector256<float> FusedMultiplySubtractNegated(Vector256<float> left, Vector256<float> right, Vector256<float> minuend) => FusedMultiplySubtractNegated(left, right, minuend);

        /// <summary>
        /// float64x4_t xvfnmsub_d(float64x4_t a, float64x4_t b, float64x4_t c)
        ///   LASX: XVFNMSUB.D Xd.4D, Xj.4D, Xk.4D, Xa.4D
        /// </summary>
        public static Vector256<double> FusedMultiplySubtractNegated(Vector256<double> left, Vector256<double> right, Vector256<double> minuend) => FusedMultiplySubtractNegated(left, right, minuend);
        ...
        /// </summary>
        public static Vector256<long> MultiplySubtract(Vector256<long> addend, Vector256<long> left, Vector256<long> right) => MultiplySubtract(addend, left, right);

        /// <summary>
        /// uint64x4_t xvmsub_d(uint64x4_t a, uint64x4_t b, uint64x4_t c)
        ///   LASX: XVMSUB.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> MultiplySubtract(Vector256<ulong> addend, Vector256<ulong> left, Vector256<ulong> right) => MultiplySubtract(addend, left, right);
        ...
        /// </summary>
        public static Vector256<sbyte> CompareNotEqualZeroEach128(Vector256<sbyte> value) => CompareNotEqualZeroEach128(value);

        /// <summary>
        ///  uint8x32_t xvmsknz_b(uint8x32_t value)
        ///   LASX: XVMSKNZ.B Vd.32B, Vj.32B
        /// </summary>
        public static Vector256<byte> CompareNotEqualZeroEach128(Vector256<byte> value) => CompareNotEqualZeroEach128(value);

        /// <summary>
        /// int8x32_t xvseqi_b(int8x32_t a, int8_t si5)
        ///   LASX: XVSEQI.B Xd.32B, Xj.32B, si5
        /// </summary>
        public static Vector256<sbyte> CompareEqual(Vector256<sbyte> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareEqual(value, si5);

        /// <summary>
        /// int16x16_t xvseqi_h(int16x16_t a, int8_t si5)
        ///   LASX: XVSEQI.H Xd.16H, Xj.16H, si5
        /// </summary>
        public static Vector256<short> CompareEqual(Vector256<short> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareEqual(value, si5);

        /// <summary>
        /// int32x8_t xvseqi_w(int32x8_t a, int8_t si5)
        ///   LASX: XVSEQI.W Xd.8W, Xj.8W, si5
        /// </summary>
        public static Vector256<int> CompareEqual(Vector256<int> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareEqual(value, si5);

        /// <summary>
        /// int64x4_t xvseqi_d(int64x4_t a, int8_t si5)
        ///   LASX: XVSEQI.D Xd.4D, Xj.4D, si5
        /// </summary>
        public static Vector256<long> CompareEqual(Vector256<long> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareEqual(value, si5);
        ...
        /// </summary>
        public static Vector256<sbyte> CompareLessThanZeroEach128(Vector256<sbyte> value) => CompareLessThanZeroEach128(value);

        /// <summary>
        ///  int16x16_t xvmskltz_h(int16x16_t value)
        ///   LASX: XVMSKLTZ.H Xd.16H, Xj.16H
        /// </summary>
        public static Vector256<short> CompareLessThanZeroEach128(Vector256<short> value) => CompareLessThanZeroEach128(value);

        /// <summary>
        ///  int32x8_t xvmskltz_w(int32x8_t value)
        ///   LASX: XVMSKLTZ.W Xd.8W, Xj.8W
        /// </summary>
        public static Vector256<int> CompareLessThanZeroEach128(Vector256<int> value) => CompareLessThanZeroEach128(value);

        /// <summary>
        ///  int64x4_t xvmskltz_d(int64x4_t value)
        ///   LASX: XVMSKLTZ.D Xd.4D, Xj.4D
        /// </summary>
        public static Vector256<long> CompareLessThanZeroEach128(Vector256<long> value) => CompareLessThanZeroEach128(value);

        /// <summary>
        /// int8x32_t xvslti_b(int8x32_t a, int8_t si5)
        ///   LASX: XVSLTI.Bd.32B, Xj.32B, si5
        /// </summary>
        public static Vector256<sbyte> CompareLessThan(Vector256<sbyte> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThan(value, si5);

        /// <summary>
        /// int16x16_t xvslti_h(int16x16_t a, int8_t si5)
        ///   LASX: XVSLTI.H Xd.16H, Xj.16H, si5
        /// </summary>
        public static Vector256<short> CompareLessThan(Vector256<short> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThan(value, si5);

        /// <summary>
        /// int32x8_t xvslti_w(int32x8_t a, int8_t si5)
        ///   LASX: XVSLTI.W Xd.8W, Xj.8W, si5
        /// </summary>
        public static Vector256<int> CompareLessThan(Vector256<int> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThan(value, si5);

        /// <summary>
        /// int64x4_t xvslti_d(int64x4_t a, int8_t si5)
        ///   LASX: XVSLTI.D Xd.4D, Xj.4D, si5
        /// </summary>
        public static Vector256<long> CompareLessThan(Vector256<long> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThan(value, si5);
        ...
        /// </summary>
        public static Vector256<sbyte> CompareLessThanOrEqual(Vector256<sbyte> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThanOrEqual(value, si5);

        /// <summary>
        /// int16x16_t xvslei_h(int16x16_t a, int8_t si5)
        ///   LASX: XVSLEI.H Xd.16H, Xj.16H, si5
        /// </summary>
        public static Vector256<short> CompareLessThanOrEqual(Vector256<short> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThanOrEqual(value, si5);

        /// <summary>
        /// int32x8_t xvslei_w(int32x8_t a, int8_t si5)
        ///   LASX: XVSLEI.W Xd.8W, Xj.8W, si5
        /// </summary>
        public static Vector256<int> CompareLessThanOrEqual(Vector256<int> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThanOrEqual(value, si5);

        /// <summary>
        /// int64x4_t xvslei_d(int64x4_t a, int8_t si5)
        ///   LASX: XVSLEI.D Xd.4D, Xj.4D, si5
        /// </summary>
        public static Vector256<long> CompareLessThanOrEqual(Vector256<long> value, [ConstantExpected(Min = -16, Max = (byte)(15))] sbyte si5) => CompareLessThanOrEqual(value, si5);
        ...
        /// </summary>
        public static Vector256<byte> CompareLessThanOrEqual(Vector256<byte> value, [ConstantExpected(Max = (byte)(31))] byte ui5) => CompareLessThanOrEqual(value, ui5);

        /// <summary>
        /// uint16x16_t xvslei_hu(uint16x16_t a, uint8_t ui5)
        ///   LASX: XVSLEI.HU Xd.16H, Xj.16H, ui5
        /// </summary>
        public static Vector256<ushort> CompareLessThanOrEqual(Vector256<ushort> value, [ConstantExpected(Max = (byte)(31))] byte ui5) => CompareLessThanOrEqual(value, ui5);

        /// <summary>
        /// uint32x8_t xvslei_wu(uint32x8_t a, uint8_t ui5)
        ///   LASX: XVSLEI.WU Xd.8W, Xj.8W, ui5
        /// </summary>
        public static Vector256<uint> CompareLessThanOrEqual(Vector256<uint> value, [ConstantExpected(Max = (byte)(31))] byte ui5) => CompareLessThanOrEqual(value, ui5);

        /// <summary>
        /// uint64x4_t xvslei_du(uint64x4_t a, uint8_t ui5)
        ///   LASX: XVSLEI.DU Xd.4D, Xj.4D, ui5
        /// </summary>
        public static Vector256<ulong> CompareLessThanOrEqual(Vector256<ulong> value, [ConstantExpected(Max = (byte)(31))] byte ui5) => CompareLessThanOrEqual(value, ui5);
        ...
        /// </summary>
        public static Vector256<int> CompareLessThanOrEqual(Vector256<float> left, Vector256<float> right) => CompareLessThanOrEqual(left, right);

        /// <summary>
        /// uint64x4_t xvfcmp_cle_d(float64x4_t a, float64x4_t b)
        ///   LASX: XVFCMP.CLE.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> CompareLessThanOrEqual(Vector256<double> left, Vector256<double> right) => CompareLessThanOrEqual(left, right);
        ...
        /// </summary>
        public static Vector256<sbyte> CompareGreaterThanOrEqualZeroEach128(Vector256<sbyte> value) => CompareGreaterThanOrEqualZeroEach128(value);
        ...
        /// </summary>
        public static Vector256<sbyte> Max(Vector256<sbyte> value, const sbyte si5) => Max(value, si5);

        /// <summary>
        /// uint8x32_t xvmaxi_bu(uint8x32_t a, int8_t si5)
        ///   LASX: XVMAXI.BU Xd.32B, Xj.32B, ui5
        /// </summary>
        public static Vector256<byte> Max(Vector256<byte> value, const byte ui5) => Max(value, ui5);

        /// <summary>
        /// int16x16_t xvmaxi_h(int16x16_t a, int8_t si5)
        ///   LASX: XVMAXI.H Xd.16H, Xj.16H, si5
        /// </summary>
        public static Vector256<short> Max(Vector256<short> value, const sbyte si5) => Max(value, si5);

        /// <summary>
        /// uint16x16_t xvmaxi_hu(uint16x16_t a, int8_t si5)
        ///   LASX: XVMAXI.HU Xd.16H, Xj.16H, ui5
        /// </summary>
        public static Vector256<ushort> Max(Vector256<ushort> value, const byte ui5) => Max(value, ui5);

        /// <summary>
        /// int32x8_t xvmaxi_w(int32x8_t a, int8_t si5)
        ///   LASX: XVMAXI.W Xd.8W, Xj.8W, si5
        /// </summary>
        public static Vector256<int> Max(Vector256<int> value, const sbyte si5) => Max(value, si5);

        /// <summary>
        /// uint32x8_t xvmaxi_wu(uint32x8_t a, int8_t si5)
        ///   LASX: XVMAXI.WU Xd.8W, Xj.8W, ui5
        /// </summary>
        public static Vector256<uint> Max(Vector256<uint> value, const byte ui5) => Max(value, ui5);

        /// <summary>
        /// int64x4_t xvmaxi_d(int64x4_t a, int8_t si5)
        ///   LASX: XVMAXI.D Xd.4D, Xj.4D, si5
        /// </summary>
        public static Vector256<long> Max(Vector256<long> value, const sbyte si5) => Max(value, si5);

        /// <summary>
        /// uint64x4_t xvmaxi_du(uint64x4_t a, int8_t si5)
        ///   LASX: XVMAXI.DU Xd.4D, Xj.4D, ui5
        /// </summary>
        public static Vector256<ulong> Max(Vector256<ulong> value, const byte ui5) => Max(value, ui5);
        ...
        /// </summary>
        public static Vector256<float> MaxFloatAbsolute(Vector256<float> left, Vector256<float> right) => MaxFloatAbsolute(left, right);

        /// <summary>
        /// float64x4_t xvfmaxa_d(float64x4_t a, float64x4_t b)
        ///   LASX: XVFMAXA.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<double> MaxFloatAbsolute(Vector256<double> left, Vector256<double> right) => MaxFloatAbsolute(left, right);

        /// <summary>
        /// int8x32_t xvmini_b(int8x32_t a, int8_t si5)
        ///   LASX: XVMINI.B Xd.32B, Xj.32B, si5
        /// </summary>
        public static Vector256<sbyte> Min(Vector256<sbyte> value, const sbyte si5) => Min(value, si5);

        /// <summary>
        /// uint8x32_t xvmini_bu(uint8x32_t a, int8_t si5)
        ///   LASX: XVMINI.BU Xd.32B, Xj.32B, ui5
        /// </summary>
        public static Vector256<byte> Min(Vector256<byte> value, const byte ui5) => Min(value, ui5);

        /// <summary>
        /// int16x16_t xvmini_h(int16x16_t a, int8_t si5)
        ///   LASX: XVMINI.H Xd.16H, Xj.16H, si5
        /// </summary>
        public static Vector256<short> Min(Vector256<short> value, const sbyte si5) => Min(value, si5);

        /// <summary>
        /// uint16x16_t xvmini_hu(uint16x16_t a, int8_t si5)
        ///   LASX: XVMINI.HU Xd.16H, Xj.16H, ui5
        /// </summary>
        public static Vector256<ushort> Min(Vector256<ushort> value, const byte ui5) => Min(value, ui5);

        /// <summary>
        /// int32x8_t xvmini_w(int32x8_t a, int8_t si5)
        ///   LASX: XVMINI.W Xd.8W, Xj.8W, si5
        /// </summary>
        public static Vector256<int> Min(Vector256<int> value, const sbyte si5) => Min(value, si5);

        /// <summary>
        /// uint32x8_t xvmini_wu(uint32x8_t a, int8_t si5)
        ///   LASX: XVMINI.WU Xd.8W, Xj.8W, ui5
        /// </summary>
        public static Vector256<uint> Min(Vector256<uint> value, const byte ui5) => Min(value, ui5);

        /// <summary>
        /// int64x4_t xvmini_d(int64x4_t a, int8_t si5)
        ///   LASX: XVMINI.D Xd.4D, Xj.4D, si5
        /// </summary>
        public static Vector256<long> Min(Vector256<long> value, const sbyte si5) => Min(value, si5);

        /// <summary>
        /// uint64x4_t xvmini_du(uint64x4_t a, int8_t si5)
        ///   LASX: XVMINI.DU Xd.4D, Xj.4D, ui5
        /// </summary>
        public static Vector256<ulong> Min(Vector256<ulong> value, const byte ui5) => Min(value, ui5);
        ...
        /// </summary>
        public static Vector256<float> MinFloatAbsolute(Vector256<float> left, Vector256<float> right) => MinFloatAbsolute(left, right);

        /// <summary>
        /// float64x4_t xvfmina_d(float64x4_t a, float64x4_t b)
        ///   LASX: XVFMINA.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<double> MinFloatAbsolute(Vector256<double> left, Vector256<double> right) => MinFloatAbsolute(left, right);
        ...
        /// </summary>
        public static unsafe Vector256<sbyte> LoadElementReplicateVector(sbyte* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// uint8x32_t xvldrepl_b(uint8_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.B Xd.32B, Rj, si12
        /// </summary>
        public static unsafe Vector256<byte> LoadElementReplicateVector(byte* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// int16x16_t xvldrepl_h(int16_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.H Xd.16H, Rj, si11
        /// </summary>
        public static unsafe Vector256<short> LoadElementReplicateVector(short* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// uint16x16_t xvldrepl_h(uint16_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.H Xd.16H, Rj, si11
        /// </summary>
        public static unsafe Vector256<ushort> LoadElementReplicateVector(ushort* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// int32x8_t xvldrepl_w(int32_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.W Xd.8W, Rj, si10
        /// </summary>
        public static unsafe Vector256<int> LoadElementReplicateVector(int* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// uint32x8_t xvldrepl_w(uint32_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.W Xd.8W, Rj, si10
        /// </summary>
        public static unsafe Vector256<uint> LoadElementReplicateVector(uint* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// int64x4_t xvldrepl_d(int64_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.D Xd.4D, Rj, si9
        /// </summary>
        public static unsafe Vector256<long> LoadElementReplicateVector(long* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// uint64x4_t xvldrepl_d(uint64_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.D Xd.4D, Rj, si9
        /// </summary>
        public static unsafe Vector256<ulong> LoadElementReplicateVector(ulong* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// float32x8_t vld(float32_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.W Xd.4S, Rj, si10
        /// </summary>
        public static unsafe Vector256<float> LoadElementReplicateVector(float* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);

        /// <summary>
        /// float64x4_t xvldrepl_d(float64_t const * ptr, const short si12)
        ///   LASX: XVLDREPL.D Xd.4D, Rj, si9
        /// </summary>
        public static unsafe Vector256<double> LoadElementReplicateVector(double* address, [ConstantExpected(Min = -2048, Max = 2047)] short si12) => LoadElementReplicateVector(address, si12);
 ...
 const      /// void xvstelm_d(int64x4_t val, int64_t* addr, const short si11, const byte idx) // Note: si11 is 8byte aligned.
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftLeftLogicalByByteEach128(Vector256<sbyte> value, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftLeftLogicalByByteEach128(value, shift);

        /// <summary>
        /// uint8x32_t xvbsll_v(uint8x32_t a, const int shift)
        ///   LASX: XVBSLL.V Xd.32B, Xj.32B, ui4
        /// </summary>
        public static Vector256<byte> ShiftLeftLogicalByByteEach128(Vector256<byte> value, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftLeftLogicalByByteEach128(value, shift);
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightLogicalByByteEach128(Vector256<sbyte> value, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalByByteEach128(value, shift);

        /// <summary>
        /// uint8x32_t xvbsrl_v(uint8x32_t a, const int shift)
        ///   LASX: XVBSRL.V Xd.32B, Xj.32B, ui4
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalByByteEach128(Vector256<byte> value, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalByByteEach128(value, shift);
        ...
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<ushort> left, Vector256<ushort> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// int8x32_t xvsrlrni_b_h(int16x16_t left, int16x16_t right, const int n)
        ///   LASX: XVSRLRNI.B.H Xd, Xj, ui4
        /// </summary>
        public static Vector256<sbyte> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// int16x16_t xvsrlrni_h_w(int32x8_t left, int32x8_t right, const int n)
        ///   LASX: XVSRLRNI.H.W Xd, Xj, ui5
        /// </summary>
        public static Vector256<short> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvsrlrni_h_w(uint32x8_t left, uint32x8_t right, const int n)
        ///   LASX: XVSRLRNI.H.W Xd, Xj, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<uint> left, Vector256<uint> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// int32x8_t xvsrlrni_w_d(int64x4_t left, int64x4_t right, const int n)
        ///   LASX: XVSRLRNI.W.D Xd, Xj, ui6
        /// </summary>
        public static Vector256<int> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvsrlrni_w_d(uint64x4_t left, uint64x4_t right, const int n)
        ///   LASX: XVSRLRNI.W.D Xd, Xj, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<ulong> left, Vector256<ulong> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);

        ///// <summary>
        ///// int64x4_t xvsrlrni_d_q(int128x2_t left, int128x2_t right, const int n)
        /////   LASX: XVSRLRNI.D.Q Xd, Xj, ui7
        ///// </summary>
        //public static Vector256<long> ShiftRightLogicalRoundedNarrowingLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightLogicalRoundedNarrowingLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightArithmeticRoundedNarrowingLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightArithmeticRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// int16x16_t xvsrarni_h_w(int32x8_t left, int32x8_t right, const int n)
        ///   LASX: XVSRARNI.H.W Xd, Xj, ui5
        /// </summary>
        public static Vector256<short> ShiftRightArithmeticRoundedNarrowingLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightArithmeticRoundedNarrowingLowerEach128(left, right, shift);

        /// <summary>
        /// int32x8_t xvsrarni_w_d(int64x4_t left, int64x4_t right, const int n)
        ///   LASX: XVSRARNI.W.D Xd, Xj, ui6
        /// </summary>
        public static Vector256<int> ShiftRightArithmeticRoundedNarrowingLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightArithmeticRoundedNarrowingLowerEach128(left, right, shift);

        ///// <summary>
        ///// int64x4_t xvsrarni_d_q(int128x2_t left, int128x2_t right, const int n)
        /////   LASX: XVSRARNI.D.Q Xd, Xj, ui7
        ///// </summary>
        //public static Vector256<long> ShiftRightArithmeticRoundedNarrowingLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightArithmeticRoundedNarrowingLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrlni_b_h(uint16x16_t left, uint16x16_t right, const byte n)
        ///   LASX: XVSSRLNI.B.H Xd.32B, Xj.16H, ui4
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<ushort> left, Vector256<ushort> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int16x16_t xvssrlni_h_w(int32x8_t left, int32x8_t right, const byte n)
        ///   LASX: XVSSRLNI.H.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<short> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrlni_h_w(uint32x8_t left, uint32x8_t right, const byte n)
        ///   LASX: XVSSRLNI.H.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<uint> left, Vector256<uint> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int32x8_t xvssrlni_w_d(int64x4_t left, int64x4_t right, const byte n)
        ///   LASX: XVSSRLNI.W.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<int> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrlni_w_d(uint64x4_t left, uint64x4_t right, const byte n)
        ///   LASX: XVSSRLNI.W.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<ulong> left, Vector256<ulong> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);

        ///// <summary>
        ///// int64x4_t xvssrlni_d_q(int128x2_t left, int128x2_t right, const byte n)
        /////   LASX: XVSSRLNI.D.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<long> ShiftRightLogicalNarrowingSaturateLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightLogicalNarrowingSaturateLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(Vector256<ushort> left, Vector256<ushort> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrlni_hu_w(uint32x8_t left, uint32x8_t right, const byte n)
        ///   LASX: XVSSRLNI.HU.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(Vector256<uint> left, Vector256<uint> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrlni_wu_d(uint64x4_t left, uint64x4_t right, const byte n)
        ///   LASX: XVSSRLNI.WU.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(Vector256<ulong> left, Vector256<ulong> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        ///// <summary>
        ///// uint64x4_t xvssrlni_du_q(uint128x2_t left, uint128x2_t right, const byte n)
        /////   LASX: XVSSRLNI.DU.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<ulong> ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(Vector256<ulonglong> left, Vector256<ulonglong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightLogicalNarrowingSaturateUnsignedLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightArithmeticNarrowingSaturateLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightArithmeticNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int16x16_t xvssran_h_w(int32x8_t left, int32x8_t right, const byte n)
        ///   LASX: XVSSRANI.H.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<short> ShiftRightArithmeticNarrowingSaturateLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightArithmeticNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int32x8_t xvssran_w_d(int64x4_t left, int64x4_t right, const byte n)
        ///   LASX: XVSSRANI.W.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<int> ShiftRightArithmeticNarrowingSaturateLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightArithmeticNarrowingSaturateLowerEach128(left, right, shift);

        ///// <summary>
        ///// int64x4_t xvssran_d_q(int128x2_t left, int128x2_t right, const byte n)
        /////   LASX: XVSSRANI.D.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<long> ShiftRightArithmeticNarrowingSaturateLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightArithmeticNarrowingSaturateLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<byte> ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrani_hu_w(int32x8_t left, int32x8_t right, const byte n)
        ///   LASX: XVSSRANI.HU.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrani_wu_d(int64x4_t left, int64x4_t right, const byte n)
        ///   LASX: XVSSRANI.WU.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        ///// <summary>
        ///// uint64x4_t xvssrani_du_q(int128x2_t left, int128x2_t right, const byte n)
        /////   LASX: XVSSRANI.DU.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<ulong> ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightArithmeticNarrowingSaturateUnsignedLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrlrni_b_h(uint16x16_t left, uint16x16_t right, const byte n)
        ///   LASX: XVSSRLRNI.B.H Xd.32B, Xj.16H, ui4
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<ushort> left, Vector256<ushort> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int16x16_t xvssrlrni_h_w(int32x8_t left, int32x8_t right, const byte n)
        ///   LASX: XVSSRLRNI.H.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<short> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrlrni_h_w(uint32x8_t left, uint32x8_t right, const byte n)
        ///   LASX: XVSSRLRNI.H.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<uint> left, Vector256<uint> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int32x8_t xvssrlrni_w_d(int64x4_t left, int64x4_t right, const byte n)
        ///   LASX: XVSSRLRNI.W.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<int> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrlrni_w_d(uint64x4_t left, uint64x4_t right, const byte n)
        ///   LASX: XVSSRLRNI.W.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<ulong> left, Vector256<ulong> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);

        ///// <summary>
        ///// int64x4_t xvssrlrni_d_q(int128x2_t left, int128x2_t right, const byte n)
        /////   LASX: XVSSRLRNI.D.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<long> ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<ushort> left, Vector256<ushort> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrlrni_hu_w(uint32x8_t left, uint32x8_t right, const byte n)
        ///   LASX: XVSSRLRNI.HU.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<uint> left, Vector256<uint> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrlrni_wu_d(uint64x4_t left, uint64x4_t right, const byte n)
        ///   LASX: XVSSRLRNI.WU.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<ulong> left, Vector256<ulong> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        ///// <summary>
        ///// uint64x4_t xvssrlrni_du_q(uint128x2_t left, uint128x2_t right, const byte n)
        /////   LASX: XVSSRLRNI.DU.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<ulong> ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<ulonglong> left, Vector256<ulonglong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightLogicalRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int16x16_t xvssrarn_h_w(int32x8_t left, int32x8_t right, const byte n)
        ///   LASX: XVSSRARNI.H.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<short> ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(left, right, shift);

        /// <summary>
        /// int32x8_t xvssrarn_w_d(int64x4_t left, int64x4_t right, const byte n)
        ///   LASX: XVSSRARNI.W.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<int> ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(left, right, shift);

        ///// <summary>
        ///// int64x4_t xvssrarn_d_q(int128x2_t left, int128x2_t right, const byte n)
        /////   LASX: XVSSRARNI.D.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<long> ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<byte> ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<short> left, Vector256<short> right, [ConstantExpected(Max = (byte)(15))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint16x16_t xvssrarni_hu_w(int32x8_t left, int32x8_t right, const byte n)
        ///   LASX: XVSSRARNI.HU.W Xd.16H, Xj.8W, ui5
        /// </summary>
        public static Vector256<ushort> ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<int> left, Vector256<int> right, [ConstantExpected(Max = (byte)(31))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        /// <summary>
        /// uint32x8_t xvssrarni_wu_d(int64x4_t left, int64x4_t right, const byte n)
        ///   LASX: XVSSRARNI.WU.D Xd.8W, Xj.4D, ui6
        /// </summary>
        public static Vector256<uint> ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<long> left, Vector256<long> right, [ConstantExpected(Max = (byte)(63))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);

        ///// <summary>
        ///// uint64x4_t xvssrarni_du_q(int128x2_t left, int128x2_t right, const byte n)
        /////   LASX: XVSSRARNI.DU.Q Xd.4D, Xj.2Q, ui7
        ///// </summary>
        //public static Vector256<ulong> ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(Vector256<longlong> left, Vector256<longlong> right, [ConstantExpected(Max = (byte)(127))] byte shift) => ShiftRightArithmeticRoundedNarrowingSaturateUnsignedLowerEach128(left, right, shift);
        ...
        /// </summary>
        public static Vector256<int> VectorShuffle(Vector256<int> vector, Vector256<int> indexs) => VectorShuffle(vector, indexs);

        /// <summary>
        ///  uint32x8_t xvperm_w(uint32x8_t vec, uint32x8_t idx)
        ///   LASX: XVPERM.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<uint> VectorShuffle(Vector256<uint> vector, Vector256<uint> indexs) => VectorShuffleEach128(vector, indexs);

        /// <summary>
        ///  int64x4_t xvpermi_w(int64x4_t vec, uint8_t idx)
        ///   LASX: XVPERMI.D Xd.4D, Xj.4D, ui8
        /// </summary>
        public static Vector256<long> VectorShuffle(Vector256<long> vector, const byte indexs) => VectorShuffle(vector, indexs);

        /// <summary>
        ///  uint64x4_t xvpermi_w(uint64x4_t vec, uint8_t idx)
        ///   LASX: XVPERMI.D Xd.4D, Xj.4D, ui8
        /// </summary>
        public static Vector256<ulong> VectorShuffle(Vector256<ulong> vector, const byte indexs) => VectorShuffleEach128(vector, indexs);
        ...
        /// </summary>
        public static Vector256<long> VectorShuffle(Vector256<long> vector0, Vector256<long> vector1, const byte indexs) => VectorShuffle(vector0, vector1, indexs);

        ///// <summary>
        /////  uint8x32_t xvshuf_b(uint8x32_t vec, uint8x32_t idx)
        /////   LASX: XVSHUF.B Xd.32B, Xj.32B, Xk.32B, Xa.32B
        ///// </summary>
        //public static Vector256<byte> VectorShuffleEach128(Vector256<byte> vector, Vector256<byte> indexs) => VectorShuffleEach128(vector, indexs);

        ///// <summary>
        /////  int8x32_t xvshuf_b(int8x32_t vec, int8x32_t idx)
        /////   LASX: XVSHUF.B Xd.32B, Xj.32B, Xk.32B, Xa.32B
        ///// </summary>
        //public static Vector256<sbyte> VectorShuffleEach128(Vector256<sbyte> vector, Vector256<sbyte> indexs) => VectorShuffleEach128(vector, indexs);

        /// <summary>
        ///  uint8x32_t xvshuf_b(uint8x32_t vec0, uint8x32_t vec1, uint8x32_t idx)
        ///   LASX: XVSHUF.B Xd.32B, Xj.32B, Xk.32B, Xa.32B
        /// </summary>
        public static Vector256<byte> VectorShuffleEach128(Vector256<byte> vector0, Vector256<byte> vector1, Vector256<byte> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  int8x32_t xvshuf_b(int8x32_t vec0, int8x32_t vec1, int8x32_t idx)
        ///   LASX: XVSHUF.B Xd.32B, Xj.32B, Xk.32B, Xa.32B
        /// </summary>
        public static Vector256<sbyte> VectorShuffleEach128(Vector256<sbyte> vector0, Vector256<sbyte> vector1, Vector256<sbyte> indexs) => VectorShuffleEach128(vector0, vector1, indexs);
        ...
        ///// </summary>
        //public static Vector256<short> VectorShuffleEach128(Vector256<short> vector, Vector256<short> indexs) => VectorShuffleEach128(vector, indexs);

        ///// <summary>
        /////  uint16x16_t xvshuf_h(uint16x16_t vec, uint16x16_t idx)
        /////   LASX: XVSHUF.H Xd.16H, Xj.16H, Xk.16H                                //NOTE: Xd is both input and output while input as index.
        ///// </summary>
        //public static Vector256<ushort> VectorShuffleEach128(Vector256<ushort> vector, Vector256<ushort> indexs) => VectorShuffleEach128(vector, indexs);

        /// <summary>
        ///  int16x16_t xvshuf_h(int16x16_t vec0, int16x16_t vec1, int16x16_t idx)
        ///   LASX: XVSHUF.H Xd.16H, Xj.16H, Xk.16H                                //NOTE: Xd is both input and output while input as index.
        /// </summary>
        public static Vector256<short> VectorShuffleEach128(Vector256<short> vector0, Vector256<short> vector1, Vector256<short> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  uint16x16_t xvshuf_h(uint16x16_t vecj, uint16x16_t veck, uint16x16_t idx)
        ///   LASX: XVSHUF.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<ushort> VectorShuffleEach128(Vector256<ushort> vector0, Vector256<ushort> vector1, Vector256<ushort> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  int32x8_t xvpermi_w(int32x8_t vec, uint8_t idx)
        ///   LASX: XVPERMI.W Xd.8W, Xj.8W, ui8
        /// </summary>
        public static Vector256<int> VectorShuffleEach128(Vector256<int> vector, const byte indexs) => VectorShuffleEach128(vector, indexs);

        /// <summary>
        ///  uint32x8_t xvpermi_w(uint32x8_t vec, uint8_t idx)
        ///   LASX: XVPERMI.W Xd.8W, Xj.8W, ui8
        /// </summary>
        public static Vector256<uint> VectorShuffleEach128(Vector256<uint> vector, const byte indexs) => VectorShuffleEach128Each128(vector, indexs);

        /// <summary>
        ///  int32x8_t xvshuf_w(int32x8_t vec0, int32x8_t vec1, int32x8_t idx)
        ///   LASX: XVSHUF.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<int> VectorShuffleEach128(Vector256<int> vector0, Vector256<int> vector1, Vector256<int> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  uint32x8_t xvshuf_w(uint32x8_t vecj, uint32x8_t veck, uint32x8_t idx)
        ///   LASX: XVSHUF.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<uint> VectorShuffleEach128(Vector256<uint> vector0, Vector256<uint> vector1, Vector256<uint> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  int64x4_t xvshuf_d(int64x4_t vec0, int64x4_t vec1, int64x4_t idx)
        ///   LASX: XVSHUF.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> VectorShuffleEach128(Vector256<long> vector0, Vector256<long> vector1, Vector256<long> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  uint64x4_t xvshuf_d(uint64x4_t vecj, uint64x4_t veck, uint64x4_t idx)
        ///   LASX: XVSHUF.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> VectorShuffleEach128(Vector256<ulong> vector0, Vector256<ulong> vector1, Vector256<ulong> indexs) => VectorShuffleEach128(vector0, vector1, indexs);

        /// <summary>
        ///  int8x32_t xvshuf4i_b(int8x32_t vec, uint8_t idx)
        ///   LASX: XVSHUF4I.B Xd.32B, Xj.32B, ui8
        /// </summary>
        public static Vector256<sbyte> VectorShuffleBy4Elements(Vector256<sbyte> vector, byte indexs) => VectorShuffleBy4Elements(vector, indexs);

        /// <summary>
        ///  uint8x32_t xvshuf4i_b(uint8x32_t vec, uint8_t idx)
        ///   LASX: XVSHUF4I.B Xd.32B, Xj.32B, ui8
        /// </summary>
        public static Vector256<byte> VectorShuffleBy4Elements(Vector256<byte> vector, byte indexs) => VectorShuffleBy4Elements(vector, indexs);

        /// <summary>
        ///  int16x16_t xvshuf4i_h(int16x16_t vec, uint8_t idx)
        ///   LASX: XVSHUF4I.H Xd.16H, Xj.16H, ui8
        /// </summary>
        public static Vector256<short> VectorShuffleBy4Elements(Vector256<short> vector, byte indexs) => VectorShuffleBy4Elements(vector, indexs);

        /// <summary>
        ///  uint16x16_t xvshuf4i_h(uint16x16_t vec, uint8_t idx)
        ///   LASX: XVSHUF4I.H Xd.16H, Xj.16H, ui8
        /// </summary>
        public static Vector256<ushort> VectorShuffleBy4Elements(Vector256<ushort> vector, byte indexs) => VectorShuffleBy4Elements(vector, indexs);

        /// <summary>
        ///  int32x8_t xvshuf4i_w(int32x8_t vec, uint8_t idx)
        ///   LASX: XVSHUF4I.W Xd.8W, Xj.8W, ui8
        /// </summary>
        public static Vector256<int> VectorShuffleBy4Elements(Vector256<int> vector, byte indexs) => VectorShuffleBy4Elements(vector, indexs);

        /// <summary>
        ///  uint32x8_t xvshuf4i_w(uint32x8_t vec, uint8_t idx)
        ///   LASX: XVSHUF4I.W Xd.8W, Xj.8W, ui8
        /// </summary>
        public static Vector256<uint> VectorShuffleBy4Elements(Vector256<uint> vector, byte indexs) => VectorShuffleBy4Elements(vector, indexs);

        /// <summary>
        ///  int64x4_t xvshuf4i_d(int64x4_t vec0, uint64x4_t vec1, uint8_t idx)
        ///   LASX: XVSHUF4I.D Xd.4D, Xj.4D, ui4
        /// </summary>
        public static Vector256<long> VectorShuffleBy4Elements(Vector256<long> vector0, Vector256<long> vector1, byte indexs) => VectorShuffleBy4Elements(vector0, vector1, indexs);

        /// <summary>
        ///  uint64x4_t xvshuf4i_d(uint64x4_t vec0, uint64x4_t vec1, uint8_t idx)
        ///   LASX: XVSHUF4I.D Xd.4D, Xj.4D, ui4
        /// </summary>
        public static Vector256<ulong> VectorShuffleBy4Elements(Vector256<ulong> vector0, Vector256<ulong> vector1, byte indexs) => VectorShuffleBy4Elements(vector0, vector1, indexs);

        /// <summary>
        ///  int8x32_t xvilvl_b(int8x32_t vec0, int8x32_t vec1)
        ///   LASX: XVILVL.B Xd.32B, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<sbyte> VectorElementsFusionLowerEach128(Vector256<sbyte> left, Vector256<sbyte> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  uint8x32_t xvilvl_b(uint8x32_t vec0, uint8x32_t vec1)
        ///   LASX: XVILVL.B Xd.32B, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<byte> VectorElementsFusionLowerEach128(Vector256<byte> left, Vector256<byte> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  int16x16_t xvilvl_h(int16x16_t vec0, int16x16_t vec1)
        ///   LASX: XVILVL.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<short> VectorElementsFusionLowerEach128(Vector256<short> left, Vector256<short> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  uint16x16_t xvilvl_h(uint16x16_t vec0, uint16x16_t vec1)
        ///   LASX: XVILVL.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<ushort> VectorElementsFusionLowerEach128(Vector256<ushort> left, Vector256<ushort> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  int32x8_t xvilvl_w(int32x8_t vec0, int32x8_t vec1)
        ///   LASX: XVILVL.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<int> VectorElementsFusionLowerEach128(Vector256<int> left, Vector256<int> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  uint32x8_t xvilvl_w(uint32x8_t vec0, uint32x8_t vec1)
        ///   LASX: XVILVL.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<uint> VectorElementsFusionLowerEach128(Vector256<uint> left, Vector256<uint> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  int64x4_t xvilvl_d(int64x4_t vec0, int64x4_t vec1)
        ///   LASX: XVILVL.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> VectorElementsFusionLowerEach128(Vector256<long> left, Vector256<long> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  uint64x4_t xvilvl_d(uint64x4_t vec0, uint64x4_t vec1)
        ///   LASX: XVILVL.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<ulong> VectorElementsFusionLowerEach128(Vector256<ulong> left, Vector256<ulong> right) => VectorElementsFusionLowerEach128(left, right);

        /// <summary>
        ///  int8x32_t xvilvh_b(int8x32_t vec0, int8x32_t vec1)
        ///   LASX: XVILVH.B Xd.32B, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<sbyte> VectorElementsFusionHightEach128(Vector256<sbyte> left, Vector256<sbyte> right) => VectorElementsFusionHightEach128(left, right);

        /// <summary>
        ///  uint8x32_t xvilvh_b(uint8x32_t vec0, uint8x32_t vec1)
        ///   LASX: XVILVH.B Xd.32B, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<byte> VectorElementsFusionHightEach128(Vector256<byte> left, Vector256<byte> right) => VectorElementsFusionHightEach128(left, right);

        /// <summary>
        ///  int16x16_t xvilvh_h(int16x16_t vec0, int16x16_t vec1)
        ///   LASX: XVILVH.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<short> VectorElementsFusionHightEach128(Vector256<short> left, Vector256<short> right) => VectorElementsFusionHightEach128(left, right);

        /// <summary>
        ///  uint16x16_t xvilvh_h(uint16x16_t vec0, uint16x16_t vec1)
        ///   LASX: XVILVH.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<ushort> VectorElementsFusionHightEach128(Vector256<ushort> left, Vector256<ushort> right) => VectorElementsFusionHightEach128(left, right);

        /// <summary>
        ///  int32x8_t xvilvh_w(int32x8_t vec0, int32x8_t vec1)
        ///   LASX: XVILVH.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<int> VectorElementsFusionHightEach128(Vector256<int> left, Vector256<int> right) => VectorElementsFusionHightEach128(left, right);

        /// <summary>
        ///  uint32x8_t xvilvh_w(uint32x8_t vec0, uint32x8_t vec1)
        ///   LASX: XVILVH.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector256<uint> VectorElementsFusionHightEach128(Vector256<uint> left, Vector256<uint> right) => VectorElementsFusionHightEach128(left, right);

        /// <summary>
        ///  int64x4_t xvilvh_d(int64x4_t vec0, int64x4_t vec1)
        ///   LASX: XVILVH.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<long> VectorElementsFusionHightEach128(Vector256<long> left, Vector256<long> right) => VectorElementsFusionHightEach128(left, right);
        ...
        /// </summary>
        public static Vector256<byte> VectorElementReplicateEach128(Vector256<byte> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);

        /// <summary>
        ///  int8x32_t xvrepl128vei(int8x32_t vector, uint8_t idx)
        ///   LASX: XVREPL128VEI_B Xd.32B, Xj.32B, ui4
        /// </summary>
        public static Vector256<sbyte> VectorElementReplicateEach128(Vector256<sbyte> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);

        /// <summary>
        ///  int16x16_t xvrepl128vei(int16x16_t vector, uint8_t idx)
        ///   LASX: XVREPL128VEI_H Xd.16H, Xj.16H, ui3
        /// </summary>
        public static Vector256<short> VectorElementReplicateEach128(Vector256<short> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);

        /// <summary>
        ///  uint16x16_t xvrepl128vei(uint16x16_t vector, uint8_t idx)
        ///   LASX: XVREPL128VEI_H Xd.16H, Xj.16H, ui3
        /// </summary>
        public static Vector256<ushort> VectorElementReplicateEach128(Vector256<ushort> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);

        /// <summary>
        ///  int32x8_t xvrepl128vei(int32x8_t vector, uint8_t idx)
        ///   LASX: XVREPL128VEII_W Xd.8W, Xj.8W, ui2
        /// </summary>
        public static Vector256<int> VectorElementReplicateEach128(Vector256<int> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);

        /// <summary>
        ///  uint32x8_t xvrepl128vei(uint32x8_t vector, uint8_t idx)
        ///   LASX: XVREPL128VEII_W Xd.8W, Xj.8W, ui2
        /// </summary>
        public static Vector256<uint> VectorElementReplicateEach128(Vector256<uint> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);

        /// <summary>
        ///  int64x4_t xvrepl128vei(int64x4_t vector, uint8_t idx)
        ///   LASX: XVREPL128VEII_D Xd.4D, Xj.4D, ui1
        /// </summary>
        public static Vector256<long> VectorElementReplicateEach128(Vector256<long> vector, const byte elementIndexe) => VectorElementReplicateEach128(vector, elementIndexe);
        ...
        /// </summary>
        public static Vector258<sbyte> VectorElementNegatedBySign(Vector258<sbyte> sign, Vector258<sbyte> data) => VectorElementNegatedBySign(sign, data);

        /// <summary>
        ///  int16x16_t xvsigncov_h(int16x16_t sign, int16x16_t data)
        ///   LASX: XVSIGNCOV.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector258<short> VectorElementNegatedBySign(Vector258<short> sign, Vector258<short> data) => VectorElementNegatedBySign(sign, data);

        /// <summary>
        ///  int32x8_t xvsigncov_w(int32x8_t sign, int32x8_t data)
        ///   LASX: XVSIGNCOV.W Xd.8W, Xj.8W, Xk.8W
        /// </summary>
        public static Vector258<int> VectorElementNegatedBySign(Vector258<int> sign, Vector258<int> data) => VectorElementNegatedBySign(sign, data);

        /// <summary>
        ///  int64x4_t xvsigncov_d(int64x4_t sign, int64x4_t data)
        ///   LASX: XVSIGNCOV.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector258<long> VectorElementNegatedBySign(Vector258<long> sign, Vector258<long> data) => VectorElementNegatedBySign(sign, data);
        ...
        /// </summary>
        public static Vector256<sbyte> IndexOfFirstNegativeElementEach128(Vector256<sbyte> value, Vector256<sbyte> save) => IndexOfFirstNegativeElementEach128(value, save);

        /// <summary>
        /// int16x16_t xvfrstp_h(int16x16_t value, int16x16_t save)
        ///   LASX: XVFRSTP.H Xd.16H, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<short> IndexOfFirstNegativeElementEach128(Vector256<short> value, Vector256<short> save) => IndexOfFirstNegativeElementEach128(value, save);

        /// <summary>
        /// int8x32_t xvfrstpi_b(int8x32_t value, uint8_t save)
        ///   LASX: XVFRSTPI.B Xd.32B, Xj.32B, ui4
        /// </summary>
        public static Vector256<sbyte> IndexOfFirstNegativeElementEach128(Vector256<sbyte> value, const byte save) => IndexOfFirstNegativeElementEach128(value, save);

        /// <summary>
        /// int16x16_t xvfrstpi_h(int16x16_t value, uint8_t save)
        ///   LASX: XVFRSTPI.H Xd.16H, Xj.16H, ui3
        /// </summary>
        public static Vector256<short> IndexOfFirstNegativeElementEach128(Vector256<short> value, const byte save) => IndexOfFirstNegativeElementEach128(value, save);

        /// <summary>
        /// int8x32_t xvsat_b(int8x32_t value, uint8_t ui3)
        ///   LASX: XVSAT.B Xd.32B, Xj.32B, ui3
        /// </summary>
        public static Vector256<sbyte> VectorSaturate(Vector256<sbyte> value, [ConstantExpected(Max = (byte)(7))] byte bits) => VectorSaturate(value, bits);

        /// <summary>
        /// int16x16_t xvsat_h(int16x16_t value, uint8_t ui4)
        ///   LASX: XVSAT.H Xd.16H, Xj.16H, ui4
        /// </summary>
        public static Vector256<short> VectorSaturate(Vector256<short> value, [ConstantExpected(Max = (byte)(15))] byte bits) => VectorSaturate(value, bits);

        /// <summary>
        /// int32x8_t xvsat_w(int32x8_t value, uint8_t ui5)
        ///   LASX: XVSAT.W Xd.8W, Xj.8W, ui5
        /// </summary>
        public static Vector256<int> VectorSaturate(Vector256<int> value, [ConstantExpected(Max = (byte)(31))] byte bits) => VectorSaturate(value, bits);

        /// <summary>
        /// int64x4_t xvsat_d(int64x4_t value, uint8_t ui6)
        ///   LASX: XVSAT.D Xd.4D, Xj.4D, ui6
        /// </summary>
        public static Vector256<long> VectorSaturate(Vector256<long> value, [ConstantExpected(Max = (byte)(63))] byte bits) => VectorSaturate(value, bits);

        /// <summary>
        /// uint8x32_t xvsat_bu(uint8x32_t value, uint8_t ui3)
        ///   LASX: XVSAT.BU Xd.32B, Xj.32B, ui3
        /// </summary>
        public static Vector256<byte> VectorSaturateUnsigned(Vector256<byte> value, [ConstantExpected(Max = (byte)(7))] byte bits) => VectorSaturateUnsigned(value, bits);

        /// <summary>
        /// uint16x16_t xvsat_hu(uint16x16_t value, uint8_t ui4)
        ///   LASX: XVSAT.HU Xd.16H, Xj.16H, ui4
        /// </summary>
        public static Vector256<ushort> VectorSaturateUnsigned(Vector256<ushort> value, [ConstantExpected(Max = (byte)(15))] byte bits) => VectorSaturateUnsigned(value, bits);

        /// <summary>
        /// uint32x8_t xvsat_wu(uint32x8_t value, uint8_t ui5)
        ///   LASX: XVSAT.WU Xd.8W, Xj.8W, ui5
        /// </summary>
        public static Vector256<uint> VectorSaturateUnsigned(Vector256<uint> value, [ConstantExpected(Max = (byte)(31))] byte bits) => VectorSaturateUnsigned(value, bits);

        /// <summary>
        /// uint64x4_t xvsat_du(uint64x4_t value, uint8_t ui6)
        ///   LASX: XVSAT.DU Xd.4D, Xj.4D, ui6
        /// </summary>
        public static Vector256<ulong> VectorSaturateUnsigned(Vector256<ulong> value, [ConstantExpected(Max = (byte)(63))] byte bits) => VectorSaturateUnsigned(value, bits);

        /// <summary>
        /// int32x8_t vfclass_s(float32x8_t a)
        ///   LASX: XVFCLASS.S Vd.8S, Vj.8S
        /// </summary>
        public static Vector256<int> FloatClass(Vector256<float> value) => FloatClass(value);

        /// <summary>
        /// int64x4_t vfclass_d(float64x4_t a)
        ///   LASX: XVFCLASS.D Vd.4D, Vj.4D
        /// </summary>
        public static Vector256<long> FloatClass(Vector256<double> value) => FloatClass(value);
    }
}
