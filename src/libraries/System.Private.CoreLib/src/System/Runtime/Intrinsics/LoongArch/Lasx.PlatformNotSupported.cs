...
namespace System.Runtime.Intrinsics.LoongArch64
{
    ...
    abstract class LA_LASX : LA_LSX
    {
        ...
        /// </summary>
        public static Vector256<float> FusedMultiplyAdd(Vector256<float> addend, Vector256<float> left, Vector256<float> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// float64x4_t xvfmadd_d_f64 (float64x4_t a, float64x4_t b, float64x4_t c)
        ///   LASX: XVFMADD.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<double> FusedMultiplyAdd(Vector256<double> addend, Vector256<double> left, Vector256<double> right) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<sbyte> AddSaturate(Vector256<sbyte> left, Vector256<byte> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint8x32_t TODO_u8 (uint8x32_t a, int8x32_t b)
        ///   LASX: TODO Xd.32B, Xj.32B
        /// </summary>
        public static Vector256<byte> AddSaturate(Vector256<byte> left, Vector256<sbyte> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int16x16_t TODO_s16 (int16x16_t a, uint16x16_t b)
        ///   LASX: TODO Xd.16H, Xj.16H
        /// </summary>
        public static Vector256<short> AddSaturate(Vector256<short> left, Vector256<ushort> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t TODO_u16 (uint16x16_t a, int16x16_t b)
        ///   LASX: TODO Xd.16H, Xj.16H
        /// </summary>
        public static Vector256<ushort> AddSaturate(Vector256<ushort> left, Vector256<short> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int32x8_t TODO_s32 (int32x8_t a, uint32x8_t b)
        ///   LASX: TODO Xd.8S, Xj.8S
        /// </summary>
        public static Vector256<int> AddSaturate(Vector256<int> left, Vector256<uint> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t TODO_u32 (uint32x8_t a, int32x8_t b)
        ///   LASX: TODO Xd.8S, Xj.8S
        /// </summary>
        public static Vector256<uint> AddSaturate(Vector256<uint> left, Vector256<int> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int64x4_t TODO_s64 (int64x4_t a, uint64x4_t b)
        ///   LASX: TODO Xd.4D, Xj.4D
        /// </summary>
        public static Vector256<long> AddSaturate(Vector256<long> left, Vector256<ulong> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t TODO_u64 (uint64x4_t a, int64x4_t b)
        ///   LASX: TODO Xd.4D, Xj.4D
        /// </summary>
        public static Vector256<ulong> AddSaturate(Vector256<ulong> left, Vector256<long> right) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<float> FusedMultiplySubtract(Vector256<float> minuend, Vector256<float> left, Vector256<float> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// float64x4_t xvfmsub_d_f64 (float64x4_t a, float64x4_t b, float64x4_t c)
        ///   LASX: XVFMSUB.D Xd.4D, Xj.4D, Xk.4D
        /// </summary>
        public static Vector256<double> FusedMultiplySubtract(Vector256<double> minuend, Vector256<double> left, Vector256<double> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int16x16_t xvmulwod_h_b_s8 (int8x32_t a, int8x32_t b)
        ///   LASX: XVMULWOD.H.B Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<short> MultiplyWideningUpper(Vector256<sbyte> left, Vector256<sbyte> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t xvmulwod_h_bu_u8 (uint8x32_t a, uint8x32_t b)
        ///   LASX: XVMULWOD.H.BU Xd.16H, Xj.32B, Xk.32B
        /// </summary>
        public static Vector256<ushort> MultiplyWideningUpper(Vector256<byte> left, Vector256<byte> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int32x8_t xvmulwod_w_h_s16 (int16x16_t a, int16x16_t b)
        ///   LASX: XVMULWOD.W.H Xd.8S, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<int> MultiplyWideningUpper(Vector256<short> left, Vector256<short> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t xvmulwod_w_hu_u16 (uint16x16_t a, uint16x16_t b)
        ///   LASX: XVMULWOD.W.HU Xd.8S, Xj.16H, Xk.16H
        /// </summary>
        public static Vector256<uint> MultiplyWideningUpper(Vector256<ushort> left, Vector256<ushort> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int64x4_t xvmulwod_d_w_s32 (int32x8_t a, int32x8_t b)
        ///   LASX: XVMULWOD.D.W Xd.4D, Xj.8S, Xk.8S
        /// </summary>
        public static Vector256<long> MultiplyWideningUpper(Vector256<int> left, Vector256<int> right) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t xvmulwod_d_wu_u32 (uint32x8_t a, uint32x8_t b)
        ///   LASX: XVMULWOD.D.WU Xd.4D, Xj.8S, Xk.8S
        /// </summary>
        public static Vector256<ulong> MultiplyWideningUpper(Vector256<uint> left, Vector256<uint> right) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<short> SignExtendWideningUpper(Vector256<sbyte> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int32x8_t xvexth_w_h_s16 (int16x16_t a)
        ///   LASX: XVEXTH.W.H Xd.8S, Xj.16H
        /// </summary>
        public static Vector256<int> SignExtendWideningUpper(Vector256<short> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int64x4_t xvexth_d_w_s32 (int32x8_t a)
        ///   LASX: XVEXTH.D.W Xd.4D, Xj.8S
        /// </summary>
        public static Vector256<long> SignExtendWideningUpper(Vector256<int> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t xvexth_HU_BU_u8 (uint8x32_t a)
        ///   LASX: XVEXTH.HU.BU Xd.16H, Xj.32B
        /// </summary>
        public static Vector256<short> ZeroExtendWideningUpper(Vector256<sbyte> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t xvexth_HU_BU_u8 (uint8x32_t a)
        ///   LASX: XVEXTH.HU.BU Xd.16H, Xj.32B
        /// </summary>
        public static Vector256<ushort> ZeroExtendWideningUpper(Vector256<byte> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t xvexth_WU_HU_u16 (uint16x16_t a)
        ///   LASX: XVEXTH.WU.HU Xd.8S, Xj.16H
        /// </summary>
        public static Vector256<int> ZeroExtendWideningUpper(Vector256<short> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t xvexth_WU_HU_u16 (uint16x16_t a)
        ///   LASX: XVEXTH.WU.HU Xd.8S, Xj.16H
        /// </summary>
        public static Vector256<uint> ZeroExtendWideningUpper(Vector256<ushort> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t xvexth_DU_WU_u32 (uint32x8_t a)
        ///   LASX: XVEXTH.DU.WU Xd.4D, Xj.8S
        /// </summary>
        public static Vector256<long> ZeroExtendWideningUpper(Vector256<int> value) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t xvexth_DU_WU_u32 (uint32x8_t a)
        ///   LASX: XVEXTH.DU.WU Xd.4D, Xj.8S
        /// </summary>
        public static Vector256<ulong> ZeroExtendWideningUpper(Vector256<uint> value) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftLeftLogical(Vector256<sbyte> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint8x32_t xvslli_b_u8 (uint8x32_t a, const int n)
        ///   LASX: XVSLLI.B Xd.32B, Xj.32B, #n
        /// </summary>
        public static Vector256<byte> ShiftLeftLogical(Vector256<byte> value, byte count) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightLogical(Vector256<sbyte> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint8x32_t xvsrli_b_u8 (uint8x32_t a, const int n)
        ///   LASX: XVSRLI.B Xd.32B, Xj.32B, #n
        /// </summary>
        public static Vector256<byte> ShiftRightLogical(Vector256<byte> value, byte count) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<sbyte> ShiftRightLogicalRounded(Vector256<sbyte> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint8x32_t xvsrlri_b_u8 (uint8x32_t a, const int n)
        ///   LASX: XVSRLRI.B Xd.32B, Xj.32B, #n
        /// </summary>
        public static Vector256<byte> ShiftRightLogicalRounded(Vector256<byte> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t xvsrlri_h_u16 (uint16x16_t a, const int n)
        ///   LASX: XVSRLRI.H Xd.16H, Xj.16H, #n
        /// </summary>
        public static Vector256<short> ShiftRightLogicalRounded(Vector256<short> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t xvsrlri_h_u16 (uint16x16_t a, const int n)
        ///   LASX: XVSRLRI.H Xd.16H, Xj.16H, #n
        /// </summary>
        public static Vector256<ushort> ShiftRightLogicalRounded(Vector256<ushort> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t xvsrlri_w_u32 (uint32x8_t a, const int n)
        ///   LASX: XVSRLRI.W Xd.8S, Xj.8S, #n
        /// </summary>
        public static Vector256<int> ShiftRightLogicalRounded(Vector256<int> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t xvsrlri_w_u32 (uint32x8_t a, const int n)
        ///   LASX: XVSRLRI.W Xd.8S, Xj.8S, #n
        /// </summary>
        public static Vector256<uint> ShiftRightLogicalRounded(Vector256<uint> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t xvsrlri_d_u64 (uint64x4_t a, const int n)
        ///   LASX: XVSRLRI.D Xd.4D, Xj.4D, #n
        /// </summary>
        public static Vector256<long> ShiftRightLogicalRounded(Vector256<long> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t xvsrlri_d_u64 (uint64x4_t a, const int n)
        ///   LASX: XVSRLRI.D Xd.4D, Xj.4D, #n
        /// </summary>
        public static Vector256<ulong> ShiftRightLogicalRounded(Vector256<ulong> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int8x32_t xvsrai_b_s8 (int8x32_t a, const int n)
        ///   LASX: XVSRAI.B Xd.32B, Xj.32B, #n
        /// </summary>
        public static Vector256<sbyte> ShiftRightArithmetic(Vector256<sbyte> value, byte count) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<long> ShiftRightArithmetic(Vector256<long> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int8x32_t xvsrari_b_s8 (int8x32_t a, const int n)
        ///   LASX: XVSRARI.B Xd.32B, Xj.32B, #n
        /// </summary>
        public static Vector256<sbyte> ShiftRightArithmeticRounded(Vector256<sbyte> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int16x16_t xvsrari_h_s16 (int16x16_t a, const int n)
        ///   LASX: XVSRARI.H Xd.16H, Xj.16H, #n
        /// </summary>
        public static Vector256<short> ShiftRightArithmeticRounded(Vector256<short> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int32x8_t xvsrari_w_s32 (int32x8_t a, const int n)
        ///   LASX: XVSRARI.W Xd.8S, Xj.8S, #n
        /// </summary>
        public static Vector256<int> ShiftRightArithmeticRounded(Vector256<int> value, byte count) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int64x4_t xvsrari_d_s64 (int64x4_t a, const int n)
        ///   LASX: XVSRARI.D Xd.4D, Xj.4D, #n
        /// </summary>
        public static Vector256<long> ShiftRightArithmeticRounded(Vector256<long> value, byte count) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector256<sbyte> Insert(Vector256<sbyte> vector, byte index, sbyte data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint8x32_t TODO_u8 (uint8_t a, uint8x32_t v, const int imm)
        ///   LASX: TODO Xd.B[imm], Rj, imm
        /// </summary>
        public static Vector256<byte> Insert(Vector256<byte> vector, byte index, byte data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int16x16_t TODO_s16 (int16_t a, int16x16_t v, const int imm)
        ///   LASX: TODO Xd.H[imm], Rj, imm
        /// </summary>
        public static Vector256<short> Insert(Vector256<short> vector, byte index, short data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint16x16_t TODO_u16 (uint16_t a, uint16x16_t v, const int imm)
        ///   LASX: TODO Xd.H[imm], Rj, imm
        /// </summary>
        public static Vector256<ushort> Insert(Vector256<ushort> vector, byte index, ushort data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int32x8_t xvinsgr2vr_w_s32 (int32_t a, int32x8_t v, const int imm)
        ///   LASX: XVINSGR2VR.W Xd.S[imm], Rj, imm
        /// </summary>
        public static Vector256<int> Insert(Vector256<int> vector, byte index, int data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint32x8_t xvinsgr2vr_w_u32 (uint32_t a, uint32x8_t v, const int imm)
        ///   LASX: XVINSGR2VR.W Xd.S[imm], Rj, imm
        /// </summary>
        public static Vector256<uint> Insert(Vector256<uint> vector, byte index, uint data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// int64x4_t xvinsgr2vr_d_s64 (int64_t a, int64x4_t v, const int imm)
        ///   LASX: XVINSGR2VR.D Xd.D[imm], Rj, imm
        /// </summary>
        public static Vector256<long> Insert(Vector256<long> vector, byte index, long data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// uint64x4_t xvinsgr2vr_d_u64 (uint64_t a, uint64x4_t v, const int imm)
        ///   LASX: XVINSGR2VR.D Xd.D[imm], Rj, imm
        /// </summary>
        public static Vector256<ulong> Insert(Vector256<ulong> vector, byte index, ulong data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// float32x8_t xvinsve0_w_f32 (float32_t a, float32x8_t v, const int imm)
        ///   LASX: XVINSVE0.W Xd.S[imm], Xj.S[0], imm
        /// </summary>
        public static Vector256<float> Insert(Vector256<float> vector, byte index, float data) { throw new PlatformNotSupportedException(); }

        /// <summary>
        /// float64x4_t xvinsve0_d_f64 (float64_t a, float64x4_t v, const int imm)
        ///   LASX: XVINSVE0.D Xd.D[imm], Xj.D[0], imm
        /// </summary>
        public static Vector256<double> Insert(Vector256<double> vector, byte index, double data) { throw new PlatformNotSupportedException(); }
