...
namespace System.Runtime.InteropServices
{
    ...
    /// a wrapper refers to the same native object as the original. Derived types that support cloning should
    /// construct a new instance instead of using <see cref="object.MemberwiseClone"/>.
    /// </para>
    /// </remarks>
    ...
    public abstract class ComObjectBase
    {
        ...
        /// </remarks>
        internal ComWrappers.NativeObjectWrapper? _nativeObjectWrapper; // [cDAC] [ComWrappers] : Contract depends on this exact name

        /// <summary>
        /// Initializes a new instance of the <see cref="ComObjectBase"/> class.
        /// </summary>
