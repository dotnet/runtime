...
namespace System.Runtime.InteropServices
{
          ...
          IMinMaxValue<NFloat>
    {
        ...
        /// <param name="value">The value which is used to create the instance of <see cref="NFloat" />.</param>
        /// <returns>An instance of <see cref="NFloat" /> created from <paramref name="value" />.</returns>
        /// <exception cref="NotSupportedException"><typeparamref name="TOther" /> is not supported.</exception>
        /// <exception cref="OverflowException"><paramref name="value" /> is not representable by <see cref="NFloat" />.</exception>
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            else if (!NumberBase<NFloat>.TryConvertFromChecked(value, out result) && !TOther.TryConvertToChecked(value, out result))
            {
        ...
        /// <typeparam name="TOther">The type of <paramref name="value" />.</typeparam>
        /// <param name="value">The value which is used to create the instance of <see cref="NFloat" />.</param>
        /// <returns>An instance of <see cref="NFloat" /> created from <paramref name="value" />, saturating if <paramref name="value" /> falls outside the representable range of <see cref="NFloat" />.</returns>
        /// <exception cref="NotSupportedException"><typeparamref name="TOther" /> is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            else if (!NumberBase<NFloat>.TryConvertFromSaturating(value, out result) && !TOther.TryConvertToSaturating(value, out result))
            {
                ThrowHelper.ThrowNotSupportedException();
            }
        ...
        /// <typeparam name="TOther">The type of <paramref name="value" />.</typeparam>
        /// <param name="value">The value which is used to create the instance of <see cref="NFloat" />.</param>
        /// <returns>An instance of <see cref="NFloat" /> created from <paramref name="value" />, truncating if <paramref name="value" /> falls outside the representable range of <see cref="NFloat" />.</returns>
        /// <exception cref="NotSupportedException"><typeparamref name="TOther" /> is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            else if (!NumberBase<NFloat>.TryConvertFromTruncating(value, out result) && !TOther.TryConvertToTruncating(value, out result))
            {
                ThrowHelper.ThrowNotSupportedException();
            }
        ...
        static bool INumberBase<NFloat>.TryConvertFromChecked<TOther>(TOther value, out NFloat result)
        {
            ...
            //
            // That is, `ConvertFrom` for `NFloat` will handle the other unsigned types and
