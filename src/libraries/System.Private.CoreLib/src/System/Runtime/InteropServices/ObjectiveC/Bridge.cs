...
namespace System.Runtime.InteropServices.ObjectiveC
{
    ...
    public static class Bridge
    {
            ...
            delegate* unmanaged<IntPtr, void> trackedObjectEnteredFinalization)
        {
            ...
            if (!TryInitializeReferenceTracker(beginEndCallback, isReferencedCallback, trackedObjectEnteredFinalization))
            ...
            out IntPtr scratchMemory)
        {
            ...
            IntPtr refCountHandle = CreateReferenceTrackingHandleInternal(
                ...
                initialReferencedState ? 1 : 0,
                scratchMemorySizeInBytes,
                out scratchMemory);
