...
namespace System.Runtime.InteropServices
{
    ...
    public static partial class MemoryMarshal
    {
        ...
        /// </summary>
        public static ref T GetReference<T>(scoped Span<T> span) => ref Unsafe.AsRef<T>(in span._reference);
        ...
        /// would have been stored. Such a reference may or may not be null. It can be used for pinning but must never be dereferenced.
        /// </summary>
        public static ref T GetReference<T>(scoped ReadOnlySpan<T> span) => ref Unsafe.AsRef<T>(in span._reference);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(scoped Span<T> span) => ref (span.Length != 0) ? ref Unsafe.AsRef<T>(in span._reference) : ref Unsafe.AsRef<T>((void*)1);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(scoped ReadOnlySpan<T> span) => ref (span.Length != 0) ? ref Unsafe.AsRef<T>(in span._reference) : ref Unsafe.AsRef<T>((void*)1);
