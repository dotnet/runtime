...
namespace System.Runtime.InteropServices
{
    ...
    public static partial class MemoryMarshal
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(Span<T> span) => ref (!span.IsEmpty) ? ref span._pointer.Value : ref Unsafe.AsRef<T>((void*)1);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(ReadOnlySpan<T> span) => ref (!span.IsEmpty) ? ref span._pointer.Value : ref Unsafe.AsRef<T>((void*)1);
