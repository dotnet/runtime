          ...
          IBinaryIntegerParseAndFormatInfo<long>
    {
        ...
        public static long ReverseBits(long value)
        {
            if (Gfni.IsSupported)
            {
                ...
                return BinaryPrimitives.ReverseEndianness(vec.AsInt64().ToScalar());
            }
            ...
            {
                value = ((value & unchecked((long)0xF0F0F0F0F0F0F0F0)) >>> 4) | ((value & 0x0F0F0F0F0F0F0F0F) << 4);
                value = ((value & unchecked((long)0xCCCCCCCCCCCCCCCC)) >>> 2) | ((value & 0x3333333333333333) << 2);
                value = ((value & unchecked((long)0xAAAAAAAAAAAAAAAA)) >>> 1) | ((value & 0x5555555555555555) << 1);
