...
namespace System.Xml.Schema
{
    ...
    internal abstract class XmlBaseConverter : XmlValueConverter
    {
        ...
        protected XmlBaseConverter(XmlSchemaType schemaType)
        {
            ...
            Debug.Assert(schemaType is not null && datatype is not null, "schemaType or schemaType.Datatype may not be null");

            while (schemaType is not null && !(schemaType is XmlSchemaSimpleType))
            {
    ...
    internal class XmlUntypedConverter : XmlListConverter
    {
        ...
        protected override object ChangeListType(object value, Type destinationType, IXmlNamespaceResolver? nsResolver)
        {
            ...
            if ((this.atomicConverter is null) || (!_allowListToList && sourceType != StringType && destinationType != StringType))
            {
    ...
    internal class XmlListConverter : XmlBaseConverter
    {
        ...
        public static XmlValueConverter Create(XmlValueConverter atomicConverter)
        {
            ...
            Debug.Assert(!(atomicConverter is XmlListConverter) || ((XmlListConverter)atomicConverter).atomicConverter is null,
        ...
        private T[] ToArray<T>(object list, IXmlNamespaceResolver? nsResolver)
        {
            ...
            Debug.Assert(enumSrc is not null, "Value passed to ToArray must implement IEnumerable");
