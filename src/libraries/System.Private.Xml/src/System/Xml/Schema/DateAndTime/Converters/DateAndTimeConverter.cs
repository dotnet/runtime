...
namespace System.Xml.Schema.DateAndTime.Converters
{
    internal static class DateAndTimeConverter
    {
        ...
        public static bool TryParse(string text, out DateInfo parsedValue)
        {
            ...
            if (TryParseAsDate(text, XsdDateAndTimeFlags.Date, start, out DateAndTimeInfo rawParsedValue))
            {
            ...
            out DateAndTimeInfo parsedValue)
        {
            ...
            if (Test(kinds, XsdDateAndTimeFlags.Date) && TryParseDate(text, start, out date))
            {
        ...
        private static bool TryParseAsDateTime(
            ...
            out DateAndTimeInfo parsedValue)
        {
            const XsdDateAndTimeFlags dateTimeVariants = XsdDateAndTimeFlags.DateTime
