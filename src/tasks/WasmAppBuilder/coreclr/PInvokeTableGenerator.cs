...
internal sealed class PInvokeTableGenerator
{
    ...
    private void EmitNativeToInterp(StreamWriter w, List<PInvokeCallback> callbacks)
    {
        ...
        w.Write(
            ...
            // Generated by coreclr callhelpers generator
            //
            // Type stubs (MethodDesc, PCODE, ReverseThunkMapEntry, etc.) are provided via the
            // compat header pre-included by BrowserWasmApp.CoreCLR.targets, so this file does
            // not include <callhelpers.hpp> directly.
