...
internal sealed class InterpToNativeGenerator
{
    ...
    private static void Emit(StreamWriter w, IEnumerable<string> cookies)
    {
        ...
        //
        // Type stubs (StringToWasmSigThunk, INTERP_STACK_SLOT_SIZE, TERMINATE_R2R_STACK_WALK,
        // MethodDesc, PCODE, etc.) are provided via the compat header pre-included by
        // BrowserWasmApp.CoreCLR.targets, so this file does not include <callhelpers.hpp> or
        // <minipal/utils.h> directly.
