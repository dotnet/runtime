...
internal static unsafe partial class MonoDroidExports
{
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = "Java_net_dot_MonoRunner_setEnv")]
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = "Java_net_dot_MonoRunner_initRuntime")]
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = "Java_net_dot_MonoRunner_execEntryPoint")]
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = "Java_net_dot_MonoRunner_freeNativeResources")]
