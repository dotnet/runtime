...
Invoke-WebRequest -Uri $WasiSdkUrl -OutFile ./wasi-sdk-$WasiSdkVersion.0.m-mingw.tar.gz
tar --strip-components=1 -xzf ./wasi-sdk-$WasiSdkVersion.0.m-mingw.tar.gz -C $WasiSdkPath
