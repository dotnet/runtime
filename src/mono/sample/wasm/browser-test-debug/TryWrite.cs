...
{
    static public class TryWriteTests
    {
        public static char[] _largeBuffer = new char[4096];
        ...
        //[InlineData(-1, -1)]
        //[InlineData(-16, 1)]
        static public void LengthAndHoleArguments_Valid(int literalLength, int formattedCount)
        {
            bool shouldAppend;
        ...
        static public void AppendLiteral()
        {
        ...
        static public void AppendFormatted_ReadOnlySpanChar()
        {
            var expected = new StringBuilder();
            MemoryExtensions.TryWriteInterpolatedStringHandler actual = new MemoryExtensions.TryWriteInterpolatedStringHandler(0, 0, _largeBuffer, out _);
        ...
        static public void AppendFormatted_String()
        {
            var expected = new StringBuilder();
            MemoryExtensions.TryWriteInterpolatedStringHandler actual = new MemoryExtensions.TryWriteInterpolatedStringHandler(0, 0, _largeBuffer, out _);
        ...
        static public void AppendFormatted_String_ICustomFormatter()
        {
        ...
        static public void AppendFormatted_ReferenceTypes()
        {
            var expected = new StringBuilder();
            MemoryExtensions.TryWriteInterpolatedStringHandler actual = new MemoryExtensions.TryWriteInterpolatedStringHandler(0, 0, _largeBuffer, out _);
        ...
        static public void AppendFormatted_ReferenceTypes_CreateProviderFlowed()
        {
            Console.WriteLine("Starting test AppendFormatted_ReferenceTypes_CreateProviderFlowed");
        ...
        static public void AppendFormatted_ReferenceTypes_ICustomFormatter()
        {
            var provider = new ConcatFormatter();
        ...
        static public void AppendFormatted_ValueTypes()
        {
            void Test<T>(T t)
            {
                var expected = new StringBuilder();
        ...
        static public void AppendFormatted_ValueTypes_CreateProviderFlowed()
        {
            void Test<T>(T t)
            {
        ...
        static public void AppendFormatted_ValueTypes_ICustomFormatter()
        {
            var provider = new ConcatFormatter();
        ...
        static public void AppendFormatted_EmptyBuffer_ZeroLengthWritesSuccessful()
        {
        ...
        //[InlineData(0)]
        //[InlineData(100)]
        static public void AppendFormatted_BufferTooSmall(int bufferLength)
        {
        ...
        static public void AppendFormatted_BufferTooSmall_CustomFormatter()
        {
            var buffer = new char[100];
