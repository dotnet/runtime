...
namespace Sample
{
    class ExceptionsTask : BenchTask
    {
        ...
        class TryCatch : ExcMeasurement
        {
            ...
            {
                if (doThrow)
                    throw new Exception ("Reached DoThrow and thrown");
            }
        }
        ...
        class TryCatchThrow : ExcMeasurement
        {
            ...
            {
                if (doThrow)
                    throw new System.Exception("Reached DoThrow and thrown");
            }
        }
        ...
        class TryCatchFilterThrowApplies : ExcMeasurement
        {
            ...
            public override void RunStep()
            {
                ...
                catch (Exception e) when (e.Message == "Reached DoThrow and thrown")
                {
                }
            }
