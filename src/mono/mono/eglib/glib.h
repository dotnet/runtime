...
__CAST_STYPE_TO_STYPE(glong, gint32, INT32_MIN, INT32_MAX)
...
#define GLONG_TO_INT32(v)        G_CAST_TYPE_TO_TYPE(glong, gint32, v)
...
g_async_safe_vfprintf (int handle, gchar const *format, va_list args)
{
	...
	int ret = GSSIZE_TO_INT (g_write (handle, print_buff, (guint32) strlen (print_buff)));
