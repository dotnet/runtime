...
MINI_OP(OP_RBIT32, "rbit32", IREG, IREG, NONE)
MINI_OP(OP_RBIT64, "rbit64", LREG, LREG, NONE)

// ARM64 prefix in order to distinct with SSE42 CRC
MINI_OP(OP_ARM64_CRC32C, "aarch64_crc32c", IREG, IREG, IREG)
MINI_OP(OP_ARM64_CRC32CX, "aarch64_crc32cd", IREG, IREG, LREG)
MINI_OP(OP_ARM64_CRC32, "aarch64_crc32", IREG, IREG, IREG)
MINI_OP(OP_ARM64_CRC32X, "aarch64_crc32d", IREG, IREG, LREG)
#endif // TARGET_ARM64
