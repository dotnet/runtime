...
/* SX: an LLVM scalar that will be wrapped in a vector */
MINI_OP(OP_XOP_SX_X, "xop_sx_x", XREG, XREG, NONE)
...
MINI_OP(OP_ARM64_ZERO_UPPER, "arm64_zero_upper", XREG, XREG, NONE)
...
MINI_OP(OP_ARM64_UQSHRN, "arm64_uqshrn", XREG, XREG, IREG)
MINI_OP3(OP_ARM64_SHRN2, "arm64_shrn2", XREG, XREG, XREG, IREG)
MINI_OP3(OP_ARM64_UQSHRN2, "arm64_uqshrn2", XREG, XREG, XREG, IREG)
...
MINI_OP(OP_ARM64_RSHRN, "arm64_rshrn", XREG, XREG, IREG)
MINI_OP(OP_ARM64_SQRSHRN, "arm64_sqrshrn", XREG, XREG, IREG)
MINI_OP(OP_ARM64_SQRSHRUN, "arm64_sqrshrun", XREG, XREG, IREG)
MINI_OP(OP_ARM64_SQSHRN, "arm64_sqshrn", XREG, XREG, IREG)
MINI_OP(OP_ARM64_SQSHRUN, "arm64_sqshrun", XREG, XREG, IREG)
MINI_OP(OP_ARM64_UQRSHRN, "arm64_uqrshrn", XREG, XREG, IREG)
MINI_OP3(OP_ARM64_RSHRN2, "arm64_rshrn2", XREG, XREG, XREG, IREG)
MINI_OP3(OP_ARM64_SQRSHRN2, "arm64_sqrshrn2", XREG, XREG, XREG, IREG)
MINI_OP3(OP_ARM64_SQRSHRUN2, "arm64_sqrshrun2", XREG, XREG, XREG, IREG)
MINI_OP3(OP_ARM64_SQSHRN2, "arm64_sqshrn2", XREG, XREG, XREG, IREG)
MINI_OP3(OP_ARM64_SQSHRUN2, "arm64_sqshrun2", XREG, XREG, XREG, IREG)
MINI_OP3(OP_ARM64_UQRSHRN2, "arm64_uqrshrn2", XREG, XREG, XREG, IREG)
...
MINI_OP3(OP_ARM64_SQRDMULH_SEL, "arm64_sqrdmulh_sel", XREG, XREG, XREG, IREG)
MINI_OP(OP_ARM64_SQRDMULH_SCALAR, "arm64_sqrdmulh_scalar", XREG, XREG, XREG)

MINI_OP(OP_ARM64_SQDMULL, "arm64_sqdmull", XREG, XREG, XREG)
MINI_OP(OP_ARM64_SQDMULL_SCALAR, "arm64_sqdmull", XREG, XREG, XREG)
MINI_OP(OP_ARM64_SQDMULL2, "arm64_sqdmull2", XREG, XREG, XREG)
MINI_OP(OP_ARM64_SQDMULL2_SCALAR, "arm64_sqdmull2", XREG, XREG, XREG)
MINI_OP3(OP_ARM64_SQDMLSL, "arm64_sqdmlsl", XREG, XREG, XREG, XREG)
MINI_OP3(OP_ARM64_SQDMLSL_SCALAR, "arm64_sqdmlsl", XREG, XREG, XREG, XREG)
...
MINI_OP3(OP_ARM64_SQDMLSL2_SCALAR, "arm64_sqdmlsl2_scalar", XREG, XREG, XREG, XREG)
MINI_OP3(OP_ARM64_SQDMLAL2, "arm64_sqdmlal2", XREG, XREG, XREG, XREG)
MINI_OP3(OP_ARM64_SQDMLAL2_SCALAR, "arm64_sqdmlal2_scalar", XREG, XREG, XREG, XREG)

MINI_OP3(OP_ARM64_FMSUB, "arm64_fmsub_scalar", XREG, XREG, XREG, XREG)
...
MINI_OP3(OP_ARM64_FMADD, "arm64_fmadd_scalar", XREG, XREG, XREG, XREG)
