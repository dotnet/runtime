...
MINI_OP(OP_AARCH64_CRC32C, "aarch64_crc32c", IREG, IREG, IREG)
MINI_OP(OP_AARCH64_CRC32CX, "aarch64_crc32cd", IREG, IREG, LREG)
MINI_OP(OP_AARCH64_CRC32, "aarch64_crc32", IREG, IREG, IREG)
MINI_OP(OP_AARCH64_CRC32X, "aarch64_crc32d", IREG, IREG, LREG)
#endif // TARGET_ARM64
