...
mono_arch_has_unwind_info (gconstpointer addr)
{
	...
	/* 
	 * Check for the register saving statements manually. Since this is
	 * an optimization, we don't have to recognize all possible instruction
	 * sequences generated by compilers.
	 */
	code = addr;
	/* Generated by gcc-3.3 */
	if ((code [0] == 0x55) &&
		(code [1] == 0x89) &&
		(code [2] == 0xe5) &&
		(code [3] == 0x57) &&
