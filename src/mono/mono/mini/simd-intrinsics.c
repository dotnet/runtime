	...
	gboolean is_64bit)
{
	...
	if (feature == MONO_CPU_X86_AVX512) {
		...
		case SN_Multiply: {
			return emit_simd_ins_for_sig (cfg, klass, OP_ZBINOP, arg0_type == MONO_TYPE_R8 || arg0_type == MONO_TYPE_R4 ? OP_FMUL : OP_IMUL, arg0_type, fsig, args);
		}
		case SN_AddRound: {
		...
		case SN_Store: {
			return emit_simd_ins_for_sig (cfg, klass, OP_AVX512_STORE, 1 /*alignment*/, arg0_type, fsig, args);
		}
		default:
			return NULL;
		}
