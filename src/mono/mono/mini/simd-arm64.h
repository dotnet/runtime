...
SIMD_OP  (128, OP_XUNOP,    OP_CEIL,    WTDS,    _UNDEF,    _UNDEF,            _UNDEF,          _UNDEF,            arm_neon_frintp,  arm_neon_frintp)
SIMD_OP  (128, OP_XUNOP,    OP_FLOOR,    WTDS,    _UNDEF,    _UNDEF,            _UNDEF,          _UNDEF,            arm_neon_frintm,  arm_neon_frintm)
