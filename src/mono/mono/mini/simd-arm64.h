...
SIMD_OP  (128, OP_XUNOP,       OP_CVT_FP_SI,         WTDS,               _UNDEF,           _UNDEF,           arm_neon_fcvtns, arm_neon_fcvtns,   _UNDEF,           _UNDEF)
SIMD_OP  (128, OP_XUNOP,       OP_CVT_FP_UI,         WTDS,               _UNDEF,           _UNDEF,           arm_neon_fcvtnu, arm_neon_fcvtnu,   _UNDEF,           _UNDEF)
