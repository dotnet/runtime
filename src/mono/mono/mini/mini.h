...
MonoUnwindOp*     mono_create_unwind_op (size_t when, guint8 tag, guint16 reg, int val);
void              mono_emit_unwind_op (MonoCompile *cfg, size_t when, guint8 tag, guint16 reg, int val);
