...
INTRINS(WASM_RELAXED_SWIZZLE, wasm_relaxed_swizzle, Wasm)
INTRINS(WASM_RELAXED_TRUNC_SIGNED, wasm_relaxed_trunc_signed, Wasm)
INTRINS(WASM_RELAXED_TRUNC_UNSIGNED, wasm_relaxed_trunc_unsigned, Wasm)
INTRINS(WASM_RELAXED_TRUNC_SIGNED_ZERO, wasm_relaxed_trunc_signed_zero, Wasm)
INTRINS(WASM_RELAXED_TRUNC_UNSIGNED_ZERO, wasm_relaxed_trunc_unsigned_zero, Wasm)
INTRINS_OVR_TAG(WASM_RELAXED_MADD, wasm_relaxed_madd, Wasm, V128 | R4 | R8)
INTRINS_OVR_TAG(WASM_RELAXED_NMADD, wasm_relaxed_nmadd, Wasm, V128 | R4 | R8)
INTRINS_OVR_TAG(WASM_RELAXED_LANESELECT, wasm_relaxed_laneselect, Wasm, V128 | I1 | I2 | I4 | I8)
INTRINS_OVR_TAG(WASM_RELAXED_MIN, wasm_relaxed_min, Wasm, V128 | R4 | R8)
INTRINS_OVR_TAG(WASM_RELAXED_MAX, wasm_relaxed_max, Wasm, V128 | R4 | R8)
INTRINS(WASM_RELAXED_Q15MULR_SIGNED, wasm_relaxed_q15mulr_signed, Wasm)
INTRINS(WASM_RELAXED_DOT_I8X16_I7X16_SIGNED, wasm_relaxed_dot_i8x16_i7x16_signed, Wasm)
INTRINS(WASM_RELAXED_DOT_I8X16_I7X16_ADD_SIGNED, wasm_relaxed_dot_i8x16_i7x16_add_signed, Wasm)
