...
#define MATH_BINOP(mathfunc) \
	...
	ip += 4;
		...
		MINT_IN_CASE(MINT_ASIN) MATH_UNOP(netintrinsics_asin); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_ASINH) MATH_UNOP(asinh); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_ACOS) MATH_UNOP(netintrinsics_acos); MINT_IN_BREAK;
		...
		MINT_IN_CASE(MINT_EXP) MATH_UNOP(netintrinsics_exp); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_FLOOR) MATH_UNOP(floor); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_LOG) MATH_UNOP(netintrinsics_log); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_LOG2) MATH_UNOP(log2); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_LOG10) MATH_UNOP(netintrinsics_log10); MINT_IN_BREAK;
		...
		MINT_IN_CASE(MINT_ATAN2) MATH_BINOP(netintrinsics_atan2); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_POW) MATH_BINOP(netintrinsics_pow); MINT_IN_BREAK;
...
#define MATH_BINOPF(mathfunc) \
	...
	ip += 4;
		MINT_IN_CASE(MINT_ASINF) MATH_UNOPF(netintrinsics_asinf); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_ASINHF) MATH_UNOPF(asinhf); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_ACOSF) MATH_UNOPF(netintrinsics_acosf); MINT_IN_BREAK;
		...
		MINT_IN_CASE(MINT_EXPF) MATH_UNOPF(netintrinsics_expf); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_FLOORF) MATH_UNOPF(floorf); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_LOGF) MATH_UNOPF(netintrinsics_logf); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_LOG2F) MATH_UNOPF(log2f); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_LOG10F) MATH_UNOPF(netintrinsics_log10f); MINT_IN_BREAK;
		...
		MINT_IN_CASE(MINT_ATAN2F) MATH_BINOPF(netintrinsics_atan2f); MINT_IN_BREAK;
		MINT_IN_CASE(MINT_POWF) MATH_BINOPF(netintrinsics_powf); MINT_IN_BREAK;
