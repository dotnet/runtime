...
#define JITERP_COUNTER_TRACE_CANDIDATES 0
#define JITERP_COUNTER_TRACES_COMPILED 1
#define JITERP_COUNTER_ENTRY_WRAPPERS_COMPILED 2
#define JITERP_COUNTER_JIT_CALLS_COMPILED 3
#define JITERP_COUNTER_DIRECT_JIT_CALLS_COMPILED 4
#define JITERP_COUNTER_FAILURES 5
#define JITERP_COUNTER_BYTES_GENERATED 6
#define JITERP_COUNTER_NULL_CHECKS_ELIMINATED 7
#define JITERP_COUNTER_NULL_CHECKS_FUSED 8
#define JITERP_COUNTER_BACK_BRANCHES_EMITTED 9
#define JITERP_COUNTER_BACK_BRANCHES_NOT_EMITTED 10
#define JITERP_COUNTER_ELAPSED_GENERATION 11
#define JITERP_COUNTER_ELAPSED_COMPILATION 12
#define JITERP_COUNTER_MAX JITERP_COUNTER_ELAPSED_COMPILATION
