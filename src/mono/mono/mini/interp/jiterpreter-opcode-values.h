...
OP(MINT_LDOBJ_VT, HIGH)
OP(MINT_STOBJ_VT, HIGH)
OP(MINT_STOBJ_VT_NOREF, HIGH)
OP(MINT_CPOBJ_VT_NOREF, HIGH)
OP(MINT_GETCHR, HIGH)
...
OP(MINT_INITLOCAL, HIGH)
OP(MINT_INITLOCALS, HIGH)
OP(MINT_LOCALLOC, HIGH)
OP(MINT_INITOBJ, HIGH)
...
OP(MINT_NEWOBJ_VT_INLINED, HIGH)
OP(MINT_CPBLK, HIGH)
