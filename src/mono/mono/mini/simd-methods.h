...
METHOD(Load2xVector128)
METHOD(Load3xVector128)
METHOD(Load4xVector128)
METHOD(Load2xVector128AndUnzip)
METHOD(Load3xVector128AndUnzip)
METHOD(Load4xVector128AndUnzip)
...
METHOD(LoadVector64)
METHOD(Load2xVector64)
METHOD(Load3xVector64)
METHOD(Load4xVector64)
METHOD(Load2xVector64AndUnzip)
METHOD(Load3xVector64AndUnzip)
METHOD(Load4xVector64AndUnzip)
METHOD(MaxAcross)
METHOD(MaxNumber)
