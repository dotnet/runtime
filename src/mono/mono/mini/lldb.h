...
void mono_lldb_remove_method (MonoMethod *method, MonoJitDynamicMethodInfo *info);

void mono_lldb_save_specific_trampoline_info (gpointer arg1, MonoTrampolineType tramp_type, gpointer code, guint32 code_len);
