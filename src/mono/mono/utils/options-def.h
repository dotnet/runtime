...
DEFINE_INT(jiterpreter_trace_monitoring_period, "jiterpreter-trace-monitoring-period", 5000, "Monitor jitted traces for this many calls to determine whether to keep them")
// traces that only offset ip by less than this on average will be rejected
DEFINE_INT(jiterpreter_trace_average_distance_threshold, "jiterpreter-trace-average-distance-threshold", 40, "Traces with an average distance less than this will be discarded")
