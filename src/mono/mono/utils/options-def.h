...
DEFINE_INT(jiterpreter_trace_average_opcodes_threshold, "jiterpreter-trace-average-opcodes-threshold", 7, "Traces with an average distance less than this will be discarded")
