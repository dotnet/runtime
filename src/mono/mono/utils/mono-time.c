...
#if !defined (TARGET_WASM) && ((defined(HAVE_CLOCK_MONOTONIC_COARSE) || defined(HAVE_CLOCK_MONOTONIC)) && !(defined(TARGET_IOS) || defined(TARGET_DARWIN) || defined(TARGET_WATCHOS) || defined(TARGET_TVOS)))
	clockid_t clockType =
