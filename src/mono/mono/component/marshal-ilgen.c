				...
				MarshalAction action)
{
	...
	if (spec->data.custom_data.image)
		mtype = cb_to_mono->reflection_type_from_name_checked (spec->data.custom_data.custom_name, alc, spec->data.custom_data.image, FALSE, FALSE, error);
	else
		mtype = cb_to_mono->reflection_type_from_name_checked (spec->data.custom_data.custom_name, alc, m->image, FALSE, FALSE, error);
