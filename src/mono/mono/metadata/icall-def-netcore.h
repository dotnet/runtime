...
HANDLES(SYSGLOB_4, "CloseSortHandle", ves_icall_System_GlobalizationNative_CloseSortHandle, void, 1, (gpointer))
HANDLES(SYSGLOB_5, "CompareString",ves_icall_System_GlobalizationNative_CompareString, gint32, 6, (gpointer, guint16_ref, gint32, guint16_ref, gint32, gint32))
HANDLES(SYSGLOB_6, "CompareStringOrdinalIgnoreCase", ves_icall_System_GlobalizationNative_CompareStringOrdinalIgnoreCase, gint32, 4, (guint16_ref, gint32, guint16_ref, gint32))
HANDLES(SYSGLOB_7, "EndsWith", ves_icall_System_GlobalizationNative_EndsWith, gint32, 6, (gpointer, guint16_ref, gint32, guint16_ref, gint32, gint32))
HANDLES(SYSGLOB_8, "EnumCalendarInfo", ves_icall_System_GlobalizationNative_EnumCalendarInfo, gint32, 5, (MonoDelegate, MonoString, guint16, gint32, gpointer))
HANDLES(SYSGLOB_9, "GetCalendarInfo", ves_icall_System_GlobalizationNative_GetCalendarInfo, gint32, 5, (MonoString, guint16, gint32, guint16_ref, gint32))
HANDLES(SYSGLOB_10, "GetCalendars", ves_icall_System_GlobalizationNative_GetCalendars, gint32, 3, (MonoString, MonoArray, gint32))
HANDLES(SYSGLOB_11, "GetDefaultLocaleName", ves_icall_System_GlobalizationNative_GetDefaultLocaleName, gint32, 2, (guint16_ref, guint32))
HANDLES(SYSGLOB_12, "GetICUVersion", ves_icall_System_GlobalizationNative_GetICUVersion, gint32, 0, ())
HANDLES(SYSGLOB_13, "GetJapaneseEraStartDate", ves_icall_System_GlobalizationNative_GetJapaneseEraStartDate, gint32, 4, (gint32, gint32_ref, gint32_ref, gint32_ref))
HANDLES(SYSGLOB_14, "GetLatestJapaneseEra", ves_icall_System_GlobalizationNative_GetLatestJapaneseEra, gint32, 0, ())
HANDLES(SYSGLOB_15, "GetLocaleInfoGroupingSizes", ves_icall_System_GlobalizationNative_GetLocaleInfoGroupingSizes, MonoBoolean, 4, (MonoString, gint32, gint32_ref, gint32_ref))
HANDLES(SYSGLOB_16, "GetLocaleInfoInt", ves_icall_System_GlobalizationNative_GetLocaleInfoInt, MonoBoolean, 3, (MonoString, guint32, guint32_ref))
HANDLES(SYSGLOB_17, "GetLocaleInfoString", ves_icall_System_GlobalizationNative_GetLocaleInfoString, MonoBoolean, 4, (MonoString, guint32, guint16_ref, guint32))
HANDLES(SYSGLOB_18, "GetLocaleName", ves_icall_System_GlobalizationNative_GetLocaleName, MonoBoolean, 3, (MonoString, guint16_ref, guint32))
HANDLES(SYSGLOB_19, "GetLocaleTimeFormat", ves_icall_System_GlobalizationNative_GetLocaleTimeFormat, MonoBoolean, 4, (MonoString, guint32, guint16_ref, guint32))
HANDLES(SYSGLOB_20, "GetLocales", ves_icall_System_GlobalizationNative_GetLocales, gint32, 2, (MonoArray, gint32))
HANDLES(SYSGLOB_21, "GetSortHandle", ves_icall_System_GlobalizationNative_GetSortHandle, gint32, 2, (MonoString, gpointer_ptr))
HANDLES(SYSGLOB_22, "GetSortKey", ves_icall_System_GlobalizationNative_GetSortKey, gint32, 6, (gpointer, guint16_ref, guint32, guint8_ref, guint32, guint32))
HANDLES(SYSGLOB_23, "GetSortVersion", ves_icall_System_GlobalizationNative_GetSortVersion, gint32, 1, (gpointer))
HANDLES(SYSGLOB_24, "GetTimeZoneDisplayName", ves_icall_System_GlobalizationNative_GetTimeZoneDisplayName, gint32, 5, (MonoString, MonoString, gint32, guint16_ref, gint32))
HANDLES(SYSGLOB_25, "IndexOf", ves_icall_System_GlobalizationNative_IndexOf, gint32, 7, (gpointer, guint16_ref, gint32, guint16_ref, gint32, gint32, gint32_ref))
