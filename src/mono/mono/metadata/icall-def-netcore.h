...
NOHANDLES(ICALL(GC_0b, "GetGenerationSize", ves_icall_System_GC_GetGenerationSize))
NOHANDLES(ICALL(GC_0c, "GetLastGCPercentTimeInGC", ves_icall_System_GC_GetLastGCPercentTimeInGC))
NOHANDLES(ICALL(GC_0d, "GetMaxGeneration", ves_icall_System_GC_GetMaxGeneration))
...
NOHANDLES(ICALL(ASSEM_1, "GetAssemblyCount", ves_icall_System_Reflection_AssemblyName_GetAssemblyCount))
