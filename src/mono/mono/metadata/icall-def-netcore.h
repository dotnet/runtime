...
HANDLES(RTH_17a, "internal_from_name", ves_icall_System_RuntimeTypeHandle_internal_from_name, void, 6, (char_ptr, MonoStackCrawlMark_ptr, MonoQCallAssemblyHandle, MonoObjectHandleOnStack, MonoBoolean, MonoBoolean))
