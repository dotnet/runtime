...
NOHANDLES(ICALL(MARSHAL_32, "GetLastSystemError", ves_icall_System_Runtime_InteropServices_Marshal_GetLastSystemError))
...
NOHANDLES(ICALL(MARSHAL_33, "SetLastSystemError", ves_icall_System_Runtime_InteropServices_Marshal_SetLastSystemError))
