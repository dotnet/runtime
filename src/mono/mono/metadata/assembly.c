...
static gboolean
has_reference_assembly_attribute_iterator (MonoImage *image, guint32 typeref_scope_token, const char *nspace, const char *name, guint32 method_token, MonoCustomAttrEntry *attr, gpointer user_data)
{
