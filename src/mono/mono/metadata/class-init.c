...
mono_class_create_generic_inst (MonoGenericClass *gclass)
{
	...
	if (mono_is_corlib_image (gklass->image) &&
		(!strcmp (gklass->name, "Vector`1") || !strcmp (gklass->name, "Vector64`1") || !strcmp (gklass->name, "Vector128`1") || !strcmp (gklass->name, "Vector256`1") || !strcmp(gklass->name, "Vector512`1"))) {
