...
NOHANDLES(ICALL(BUFFER_2, "MemmoveNative", ves_icall_System_Runtime_RuntimeImports_Memmove))
NOHANDLES(ICALL(BUFFER_3, "ZeroMemoryNative", ves_icall_System_Runtime_RuntimeImports_ZeroMemory))
