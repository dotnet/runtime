...
ICALL(VOLATILE_3, "Read(double&)", ves_icall_System_Threading_Thread_VolatileRead8)
...
ICALL(VOLATILE_9, "Read(single&)", ves_icall_System_Threading_Thread_VolatileRead4)
...
ICALL(VOLATILE_16, "Write(double&,double)", ves_icall_System_Threading_Thread_VolatileWrite8)
...
ICALL(VOLATILE_22, "Write(single&,single)", ves_icall_System_Threading_Thread_VolatileWrite4)
