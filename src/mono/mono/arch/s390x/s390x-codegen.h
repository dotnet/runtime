...
{								\
	...
	s390_emit32(c, ((s1) << 28 | (((p1) & 0xfffff) << 8) | 	\
			(opc & 0xff)));				\
} while (0)
...
#define s390_locghinle(c, r1, i)	s390_locghi(c, r1, i, 3)
...
#define s390_locgrnle(c, r1, r2)	s390_locgr(c, r1, 3, r2)
...
#define s390_vflcdb(c, v1, v2)          S390_VRRa(c, 0xe7cc, v1, v2, 3, 0, 0)
#define s390_vflcsb(c, v1, v2)          S390_VRRa(c, 0xe7cc, v1, v2, 2, 0, 0)
...
#define s390_vgbm(c, v, i)              S390_VRIa(c, 0xe744, v, i, 0)
...
#define s390_vl(c, v, d, x, b)          S390_VRX(c, 0xe706, v, x, b, d, 0)
...
#define s390_vst(c, v, d, x, b)         S390_VRX(c,0xe70e, v, x, b, d, 0)
...
#define s390_vuplh(c, v1, v2)           S390_VRRa(c, 0xe7d6, v1, v2, 1, 0, 0)
