...
#define arm_neon_3d_opcode(p, q, u, size, opcode, rd, rn, rm) arm_neon_opcode_3reg ((p), (q), 0b01011110001000000000010000000000 | (u) << 29 | (size) << 22 | (opcode) << 12, (rd), (rn), (rm))

#define arm_neon_sqadd(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b00001, (rd), (rn), (rm))
...
#define arm_neon_sqsub(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b00101, (rd), (rn), (rm))
...
#define arm_neon_cmgt(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b00110, (rd), (rn), (rm))
...
#define arm_neon_cmge(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b00111, (rd), (rn), (rm))
...
#define arm_neon_sshl(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b01000, (rd), (rn), (rm))
...
#define arm_neon_sqshl(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b01001, (rd), (rn), (rm))
...
#define arm_neon_srshl(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b01010, (rd), (rn), (rm))
...
#define arm_neon_sqrshl(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b01011, (rd), (rn), (rm))
...
#define arm_neon_add(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b10000, (rd), (rn), (rm))
...
#define arm_neon_cmtst(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b10001, (rd), (rn), (rm))
...
#define arm_neon_sqdmulh(p, q, rd, rn, rm) arm_neon_3d_opcode ((p), (q), 0b0, 0b10110, (rd), (rn), (rm))
...
#define arm_neon_fmulx(p, q, size, rd, rn, rm) arm_neon_3d_opcode ((p), (q), (size), 0b11011, (rd), (rn), (rm))
...
#define arm_neon_frsqrte_2d(p, rd, rn, rm) arm_neon_fmulx ((p), 0b1, 0b1, (rd), (rn), (rm))
