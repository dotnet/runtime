...
export const _use_finalization_registry =
...
export function get_js_owned_object_by_gc_handle(gc_handle: GCHandle): any {
    if (!gc_handle) {
...
export function get_cs_owned_object_by_js_handle(
    js_handle: JSHandle,
    ...
    return corebindings._get_cs_owned_object_by_js_handle(
        js_handle,
...
export function mono_wasm_get_js_handle(js_obj: any): JSHandle {
    ...
    const js_handle = _js_handle_free_list.length
