...
export class WebAssemblyConfigLoader {
    static async initAsync(bootConfigResult: BootConfigResult, startOptions: Partial<WebAssemblyStartOptions>): Promise<void> {
        // TODO MF: Hook getApplicationEnvironment
        ...
        const anyConfig = Module.config as any;
        if (anyConfig.onAppConfigLoaded) {
            anyConfig.onAppConfigLoaded(configFiles);
        }

        // TODO MF: Hook getConfig
