...
export function export_mono_api(): MONOType {
    return {
        ...
        "mono_wasm_load_runtime": mono_wasm_load_runtime,
...
export function export_internal_api(): any {
    return {
        "stringToMonoStringIntern": stringToMonoStringIntern, // MarshalTests.cs
        "mono_method_resolve": mono_method_resolve, //MarshalTests.cs
    };
}
