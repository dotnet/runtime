...
extern void mono_wasm_invoke_imported_function(int fn_handle, void *data);
...
void core_initialize_internals ()
{
	...
	mono_add_internal_call ("Interop/Runtime::InvokeImportedFunction", mono_wasm_invoke_imported_function);
