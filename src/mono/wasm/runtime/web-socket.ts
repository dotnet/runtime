...
import { copy_string_buffer_as_necessary, utf8ToStringRelaxed, encodeUTF8 } from "./strings";
...
function _mono_wasm_web_socket_send_buffering(ws: WebSocketExtension, buffer_view: Uint8Array, message_type: number, end_of_message: boolean): Uint8Array | string | null {
    ...
    if (end_of_message) {
        ...
        if (message_type === 0) {
            ...
            const bytes = copy_string_buffer_as_necessary(buffer, 0 as any, offset as any);
