...
export function init_managed_exports(): void {
    ...
    const capture_proxy_context = MonoWasmThreads ? get_method("CaptureProxyContext") : undefined;
    mono_assert(!MonoWasmThreads || capture_proxy_context, "Can't find CaptureProxyContext method");
    ...
    if (MonoWasmThreads && capture_proxy_context) {
        runtimeHelpers.javaScriptExports.capture_proxy_context = () => invoke_method_raw(capture_proxy_context);
    }
