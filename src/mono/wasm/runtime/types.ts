...
export interface MonoMethod extends MonoObject {
    __brand: "MonoMethod";
}
...
export function coerceNull<T extends ManagedPointer | NativePointer>(
    ptr: T | null | undefined
): T {
...
export type MonoConfig = {
    ...
    assets: (
        | AssetEntry
        | AssemblyEntry
        | SatelliteAssemblyEntry
        | VfsEntry
        | IcuData
    )[]; // a list of assets to load along with the runtime. each asset is a dictionary-style Object with the following properties:
