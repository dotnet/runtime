...
export function setU8 (offset: _MemOffset, value: number) {
    Module.HEAPU8[<any>offset] = value;
}

export function setU16 (offset: _MemOffset, value: number) {
    Module.HEAPU16[<any>offset >>> 1] = value;
}

export function setU32 (offset: _MemOffset, value: number) {
    Module.HEAPU32[<any>offset >>> 2] = value;
}

export function setI8 (offset: _MemOffset, value: number) {
    Module.HEAP8[<any>offset] = value;
}

export function setI16 (offset: _MemOffset, value: number) {
    Module.HEAP16[<any>offset >>> 1] = value;
}

export function setI32 (offset: _MemOffset, value: number) {
...
export function setF64 (offset: _MemOffset, value: number) {
    Module.HEAPF64[<any>offset >>> 3] = value;
}


export function getU8 (offset: _MemOffset) {
    return Module.HEAPU8[<any>offset];
}

export function getU16 (offset: _MemOffset) {
    return Module.HEAPU16[<any>offset >>> 1];
}

export function getU32 (offset: _MemOffset) {
    return Module.HEAPU32[<any>offset >>> 2];
}

export function getI8 (offset: _MemOffset) {
    return Module.HEAP8[<any>offset];
}

export function getI16 (offset: _MemOffset) {
    return Module.HEAP16[<any>offset >>> 1];
}

export function getI32 (offset: _MemOffset) {
...
export function getF32 (offset: _MemOffset) {
    return Module.HEAPF32[<any>offset >>> 2];
}

export function getF64 (offset: _MemOffset) {
