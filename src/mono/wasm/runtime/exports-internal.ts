...
export function export_internal(): any {
    return {
        ...
        "mono_wasm_stringify_as_error_with_stack": mono_wasm_stringify_as_error_with_stack,

        // used in debugger DevToolsHelper.cs
        "mono_wasm_get_loaded_files": mono_wasm_get_loaded_files,
        "mono_wasm_send_dbg_command_with_parms": mono_wasm_send_dbg_command_with_parms,
        ...
        "get_typeof_property": get_typeof_property,
        "get_global_this": get_global_this,
        "get_dotnet_instance": () => exportedRuntimeAPI,
        "dynamic_import": dynamic_import,

        // BrowserWebSocket
        "mono_wasm_cancel_promise": mono_wasm_cancel_promise,
        "ws_wasm_create": ws_wasm_create,
        "ws_wasm_open": ws_wasm_open,
        "ws_wasm_send": ws_wasm_send,
        "ws_wasm_receive": ws_wasm_receive,
        "ws_wasm_close": ws_wasm_close,
        "ws_wasm_abort": ws_wasm_abort,

        // BrowserHttpHandler
        "http_wasm_supports_streaming_response": http_wasm_supports_streaming_response,
        "http_wasm_create_abort_controler": http_wasm_create_abort_controler,
        "http_wasm_abort_request": http_wasm_abort_request,
        "http_wasm_abort_response": http_wasm_abort_response,
        "http_wasm_fetch": http_wasm_fetch,
        "http_wasm_fetch_bytes": http_wasm_fetch_bytes,
        "http_wasm_get_response_header_names": http_wasm_get_response_header_names,
        "http_wasm_get_response_header_values": http_wasm_get_response_header_values,
        "http_wasm_get_response_bytes": http_wasm_get_response_bytes,
        "http_wasm_get_response_length": http_wasm_get_response_length,
        "http_wasm_get_streamed_response_bytes": http_wasm_get_streamed_response_bytes,

        // jiterpreter
        "jiterpreter_dump_stats": jiterpreter_dump_stats,
        "jiterpreter_apply_options": applyOptions,
        "jiterpreter_get_options": getOptions,

        // Blazor GC Lock support
        "mono_wasm_gc_lock": mono_wasm_gc_lock,
        "mono_wasm_gc_unlock": mono_wasm_gc_unlock,
    };
}
