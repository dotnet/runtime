...
extern uint32_t mono_wasm_invoke_js_function_impl (
...
mono_wasm_invoke_js_function (
	...
	if (result == 0) {
		result = mono_wasm_invoke_js_function_impl (
...
void mono_initialize_internals ()
{
	...
	// New public API
	mono_add_internal_call ("System.Runtime.InteropServices.JavaScript.JavaScriptMarshalImpl::InvokeJSFunction", mono_wasm_invoke_js_function);
