...
namespace DebuggerTests
{
    ...
    public class PointerTests : DebuggerTests
    {
        ...
        public static TheoryData<string, string, string, int, string, bool> PointersTestData =>
            ...
            { { $"invoke_exported_method ('debugger-test', 'DebuggerTests.PointerTests.LocalPointers');", "DebuggerTests.PointerTests", "LocalPointers", 32, "DebuggerTests.PointerTests.LocalPointers", false },
                { $"invoke_exported_method ('debugger-test', 'DebuggerTests.PointerTests.LocalPointers');", "DebuggerTests.PointerTests", "LocalPointers", 32, "DebuggerTests.PointerTests.LocalPointers", true },
                { $"invoke_exported_method_async ('debugger-test', 'DebuggerTests.PointerTests.LocalPointersAsync');", "DebuggerTests.PointerTests", "LocalPointersAsync", 32, "DebuggerTests.PointerTests.LocalPointersAsync", false },
                { $"invoke_exported_method_async ('debugger-test', 'DebuggerTests.PointerTests.LocalPointersAsync');", "DebuggerTests.PointerTests", "LocalPointersAsync", 32, "DebuggerTests.PointerTests.LocalPointersAsync", true }
            };
        ...
        public static TheoryData<string, string, string, int, string, bool> PointersAsMethodArgsTestData =>
            new TheoryData<string, string, string, int, string, bool>
            { { $"invoke_exported_method ('debugger-test', 'DebuggerTests.PointerTests.LocalPointers');", "DebuggerTests.PointerTests", "PointersAsArgsTest", 2, "DebuggerTests.PointerTests.PointersAsArgsTest", false },
                { $"invoke_exported_method ('debugger-test', 'DebuggerTests.PointerTests.LocalPointers');", "DebuggerTests.PointerTests", "PointersAsArgsTest", 2, "DebuggerTests.PointerTests.PointersAsArgsTest", true },
            };
        ...
        [ConditionalTheory(nameof(RunningOnChrome))]
        [InlineData("invoke_exported_method ('debugger-test', 'Math.UseComplex', 0, 0);", "Math", "UseComplex", 3, "Math.UseComplex", false)]
        [InlineData("invoke_exported_method ('debugger-test', 'Math.UseComplex', 0, 0);", "Math", "UseComplex", 3, "Math.UseComplex", true)]
