...
console.log("Arguments: " + allRuntimeArguments);
let profilers = [];
let setenv = {};
let runtime_args = [];
let enable_gc = true;
let working_dir = '/';
while (allRuntimeArguments && allRuntimeArguments.length > 0) {
