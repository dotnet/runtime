...
namespace Wasm.Build.Tests
{
    public class InvariantGlobalizationTests : TestMainJsTestBase
    {
        ...
        // public void AOT_InvariantGlobalization(ProjectInfo buildArgs, bool? invariantGlobalization, RunHost host, string id)
        ...
        // [Theory]
        // [MemberData(nameof(InvariantGlobalizationTestData), parameters: new object[] { /*aot*/ false, RunHost.All })]
        // public void RelinkingWithoutAOT(ProjectInfo buildArgs, bool? invariantGlobalization, RunHost host, string id)
        //     => TestInvariantGlobalization(buildArgs, invariantGlobalization, host, id,
        //                                     extraProperties: "<WasmBuildNative>true</WasmBuildNative>",
        //                                     dotnetWasmFromRuntimePack: false);

        // private void TestInvariantGlobalization(ProjectInfo buildArgs, bool? invariantGlobalization,
