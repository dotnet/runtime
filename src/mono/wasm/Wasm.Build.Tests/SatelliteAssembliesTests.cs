...
namespace Wasm.Build.Tests
{
    public class SatelliteAssembliesTests : TestMainJsTestBase
    {
        ...
        // public void ResourcesFromMainAssembly(ProjectInfo buildArgs,
        //                                       bool nativeRelink,
        //                                       string? argCulture,
        //                                       RunHost host,
        //                                       string id)
        ...
        //     bool dotnetWasmFromRuntimePack = !nativeRelink && !buildArgs.AOT && buildArgs.Configuration != "Release";
        ...
        // [MemberData(nameof(SatelliteAssemblyTestData), parameters: new object[] { /*aot*/ false, /*relinking*/ true,  RunHost.All })]
        // [MemberData(nameof(SatelliteAssemblyTestData), parameters: new object[] { /*aot*/ true,  /*relinking*/ false, RunHost.All })]
        // public void ResourcesFromProjectReference(ProjectInfo buildArgs,
        //                                           bool nativeRelink,
        //                                           string? argCulture,
        //                                           RunHost host,
        //                                           string id)
...
//         public void CheckThatSatelliteAssembliesAreNotAOTed(ProjectInfo buildArgs, string id)
//         {
...
//             @$"<ProjectInfo Sdk=""Microsoft.NET.Sdk"">
//               <PropertyGroup>
