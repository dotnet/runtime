...
namespace Wasm.Build.Tests
{
    public abstract class BuildTestBase : IClassFixture<SharedBuildPerTestClassFixture>, IDisposable
    {
        ...
        public static bool IsMultiThreadingRuntimeAvailableForDefaultTargetFramework => s_buildEnv.IsMultiThreadingRuntimeAvailableForDefaultTargetFramework;
        ...
        static BuildTestBase()
        {
            try
            {
                ...
                Console.WriteLine ($"============== Multi-threading runtime pack {(IsMultiThreadingRuntimeAvailableForDefaultTargetFramework ? "available" : "not available")} ==============");
                Console.WriteLine($"==============================================================================================");
                Console.WriteLine("");
            }
            catch (Exception ex)
