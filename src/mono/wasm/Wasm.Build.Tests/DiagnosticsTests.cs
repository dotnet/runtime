...
public class DiagnosticsTests : WasmTemplateTestsBase
{
    ...
    public async Task RunSimpleAppWithLogProfiler()
    {
        ...
        BuildProject(info, config, new BuildOptions(ExtraMSBuildArgs: extraArgs, AssertAppBundle: false, WasmEnablePerformanceTracing: true), isNativeBuild: true);
    ...
    public async Task RunSimpleAppWithBrowserProfiler()
    {
        ...
        BuildProject(info, config, new BuildOptions(AssertAppBundle: false, WasmEnablePerformanceTracing: true), isNativeBuild: true);
