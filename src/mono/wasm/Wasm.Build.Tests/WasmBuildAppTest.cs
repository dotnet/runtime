...
namespace Wasm.Build.Tests
{
    public class WasmBuildAppTest : WasmBuildAppBase
    {
        ...
        // public void TopLevelMain(ProjectInfo buildArgs, RunHost host, string id)
        //     => TestMain("top_level",
        ...
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ true, RunHost.All })]
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ false, RunHost.All })]
        // public void AsyncMain(ProjectInfo buildArgs, RunHost host, string id)
        //     => TestMain("async_main", @"
        //     using System;
        ...
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ true, RunHost.All })]
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ false, RunHost.All })]
        // public void NonAsyncMain(ProjectInfo buildArgs, RunHost host, string id)
        ...
        // [Theory]
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ false, RunHost.All })]
        // public void ExceptionFromMain(ProjectInfo buildArgs, RunHost host, string id)
        ...
        // [Theory]
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ true, RunHost.All })]
        // public void Bug49588_RegressionTest_AOT(ProjectInfo buildArgs, RunHost host, string id)
        //     => TestMain("bug49588_aot", s_bug49588_ProgramCS, buildArgs, host, id);

        // [Theory]
        // [MemberData(nameof(MainMethodTestData), parameters: new object[] { /*aot*/ false, RunHost.All })]
        // public void Bug49588_RegressionTest_NativeRelinking(ProjectInfo buildArgs, RunHost host, string id)
        ...
        // [Theory]
        // [BuildAndRun]
        // public void PropertiesFromRuntimeConfigJson(ProjectInfo buildArgs, RunHost host, string id)
        // {
        //     buildArgs = buildArgs with { ProjectName = $"runtime_config_{buildArgs.Configuration}_{buildArgs.AOT}" };
        ...
        // [Theory]
        // [BuildAndRun]
        // public void PropertiesFromCsproj(ProjectInfo buildArgs, RunHost host, string id)
        // {
        //     buildArgs = buildArgs with { ProjectName = $"runtime_config_csproj_{buildArgs.Configuration}_{buildArgs.AOT}" };
