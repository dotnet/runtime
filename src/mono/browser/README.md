...
(See https://learn.microsoft.com/en-us/dotnet/core/testing/selective-unit-tests?pivots=xunit for filter options)
...
For details about using `dotnet new` see the dotnet tool [documentation](https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-new).
