...
function deep_merge_resources (target: ResourceGroups, source: ResourceGroups): ResourceGroups {
    ...
    if (providedResources.jsModuleDiag !== undefined) {
        providedResources.jsModuleDiag = { ...(target.jsModuleDiag || {}), ...(providedResources.jsModuleDiag || {}) };
    }
