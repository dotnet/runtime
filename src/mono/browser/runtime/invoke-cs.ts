...
import { bind_assembly_exports, invoke_async_jsexport2, invoke_sync_jsexport2 } from "./managed-exports";
import { mono_log_debug } from "./logging";

export function mono_wasm_bind_cs_function (method: CSFnHandle, assemblyName: string, namespaceName: string, shortClassName: string, methodName: string, signatureHash: number, signature: JSFunctionSignature): void {
...
function bind_fn_0V (closure: BindingClosure) {
    ...
    return function bound_fn_0V () {
        ...
        try {
            ...
            // call C# side
            invoke_sync_jsexport2(method, args);
        } finally {
...
function bind_fn_1RA (closure: BindingClosure) {
    ...
    return function bind_fn_1RA (arg1: any) {
        ...
        try {
            ...
            // call C# side
            invoke_async_jsexport2(runtimeHelpers.managedThreadTID, method, args, size);
