...
export function commandCounters () {
    return commandCollectTracing2({
        circularBufferMB: 256,
        format: 1,
        ...
        providers: [
            ...
            },
            {
                ...
                arguments: "SessionId=SHARED;Metrics=System.Runtime;RefreshInterval=1;MaxTimeSeries=1000;MaxHistograms=10;ClientId=c98f989b-369c-41af-bc8e-7ab261fba16c"
            }
        ]
    });
}

export function commandSampleProfiler () {
    return commandCollectTracing2({
        circularBufferMB: 256,
        format: 1,
        requestRundown: true,
