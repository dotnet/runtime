...
export function commandCounters (intervalSec:number, providers?:string[]) {
    const customProviders:ProviderV2[] = providers ? providers.map(provider_name => ({
        provider_name,
        keywords: [0, Keywords.None],
        logLevel: 4,
