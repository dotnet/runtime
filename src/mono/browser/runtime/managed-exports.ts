...
export async function call_entry_point(entry_point: MonoMethod, program_args?: string[]): Promise<number> {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.CallEntrypoint, args);
...
export function load_satellite_assembly(dll: Uint8Array): void {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.LoadSatelliteAssembly, args);
    } finally {
        Module.stackRestore(sp);
    }
}
...
export function load_lazy_assembly(dll: Uint8Array, pdb: Uint8Array | null): void {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.LoadLazyAssembly, args);
    } finally {
        Module.stackRestore(sp);
    }
}
...
export function release_js_owned_object_by_gc_handle(gc_handle: GCHandle) {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.ReleaseJSOwnedObjectByGCHandle, args);
    } finally {
        Module.stackRestore(sp);
    }
}
...
export function complete_task(holder_gc_handle: GCHandle, isCanceling: boolean, error?: any, data?: any, res_converter?: MarshalerToCs) {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.CompleteTask, args);
    } finally {
        Module.stackRestore(sp);
    }
}
...
export function call_delegate(callback_gc_handle: GCHandle, arg1_js: any, arg2_js: any, arg3_js: any, res_converter?: MarshalerToJs, arg1_converter?: MarshalerToCs, arg2_converter?: MarshalerToCs, arg3_converter?: MarshalerToCs) {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.CallDelegate, args);
...
export function get_managed_stack_trace(exception_gc_handle: GCHandle) {
    ...
    try {
        ...
        invoke_method_and_handle_exception(managedExports.GetManagedStackTrace, args);
        const res = get_arg(args, 1);
