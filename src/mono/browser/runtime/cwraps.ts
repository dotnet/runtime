...
const fn_signatures: SigLine[] = [
    ...
    [() => !runtimeHelpers.emscriptenBuildOptions.enablePerformanceTracing && !runtimeHelpers.emscriptenBuildOptions.enableDevToolsProfiler, "mono_jiterp_prof_enter", "void", ["number", "number"]],
    [() => !runtimeHelpers.emscriptenBuildOptions.enablePerformanceTracing && !runtimeHelpers.emscriptenBuildOptions.enableDevToolsProfiler, "mono_jiterp_prof_samplepoint", "void", ["number", "number"]],
    [() => !runtimeHelpers.emscriptenBuildOptions.enablePerformanceTracing && !runtimeHelpers.emscriptenBuildOptions.enableDevToolsProfiler, "mono_jiterp_prof_leave", "void", ["number", "number"]],
