...
const threading_cwraps: SigLine[] = WasmEnableThreads ? [
    ...
    [false, "mono_wasm_invoke_jsexport_async_post", "void", ["pointer", "pointer", "pointer"]],
    [false, "mono_wasm_invoke_jsexport_sync_send", "void", ["pointer", "pointer", "pointer"]],
    [false, "mono_wasm_invoke_jsexport_sync", "void", ["pointer", "pointer"]],
    [true, "mono_wasm_create_deputy_thread", "pointer", []],
    [true, "mono_wasm_create_io_thread", "pointer", []],
    ...
    [true, "mono_threads_wasm_sync_run_in_target_thread_done", "void", ["pointer"]],
] : [];
...
const fn_signatures: SigLine[] = [
    ...
    [true, "mono_wasm_send_dbg_command", "bool", ["number", "number", "number", "pointer", "number"]],
    ...
    [true, "mono_wasm_load_icu_data", "number", ["pointer"]],
    [false, "mono_wasm_add_assembly", "number", ["string", "pointer", "number"]],
    [true, "mono_wasm_add_satellite_assembly", "void", ["string", "string", "pointer", "number"]],
    ...
    [true, "mono_wasm_string_from_utf16_ref", "void", ["pointer", "number", "pointer"]],
    [true, "mono_wasm_intern_string_ref", "void", ["pointer"]],

    [false, "mono_wasm_exit", "void", ["number"]],
    [true, "mono_wasm_getenv", "pointer", ["string"]],
    [true, "mono_wasm_set_main_args", "void", ["number", "pointer"]],
    ...
    [true, "mono_wasm_get_f32_unaligned", "number", ["pointer"]],
    [true, "mono_wasm_get_f64_unaligned", "number", ["pointer"]],
    [true, "mono_wasm_read_as_bool_or_null_unsafe", "number", ["pointer"]],
    ...
    [true, "mono_jiterp_encode_leb52", "number", ["pointer", "number", "number"]],
    [true, "mono_jiterp_encode_leb64_ref", "number", ["pointer", "pointer", "number"]],
    [true, "mono_jiterp_encode_leb_signed_boundary", "number", ["pointer", "number", "number"]],
    [true, "mono_jiterp_write_number_unaligned", "void", ["pointer", "number", "number"]],
    [true, "mono_jiterp_type_is_byref", "number", ["pointer"]],
    ...
    [true, "mono_jiterp_get_signature_has_this", "number", ["pointer"]],
    [true, "mono_jiterp_get_signature_return_type", "pointer", ["pointer"]],
    [true, "mono_jiterp_get_signature_param_count", "number", ["pointer"]],
    [true, "mono_jiterp_get_signature_params", "pointer", ["pointer"]],
    [true, "mono_jiterp_type_to_ldind", "number", ["pointer"]],
    [true, "mono_jiterp_type_to_stind", "number", ["pointer"]],
    [true, "mono_jiterp_imethod_to_ftnptr", "pointer", ["pointer"]],
    [true, "mono_jiterp_debug_count", "number", []],
    [true, "mono_jiterp_get_trace_hit_count", "number", ["number"]],
    [true, "mono_jiterp_get_polling_required_address", "pointer", []],
    [true, "mono_jiterp_get_rejected_trace_count", "number", []],
    [true, "mono_jiterp_boost_back_branch_target", "void", ["number"]],
    [true, "mono_jiterp_is_imethod_var_address_taken", "number", ["pointer", "number"]],
    ...
    [true, "mono_jiterp_tlqueue_next", "pointer", ["number"]],
    [true, "mono_jiterp_tlqueue_add", "number", ["number", "pointer"]],
    [true, "mono_jiterp_tlqueue_clear", "void", ["number"]],
    [true, "mono_jiterp_begin_catch", "void", ["number"]],
    [true, "mono_jiterp_end_catch", "void", []],
    [true, "mono_interp_pgo_load_table", "number", ["pointer", "number"]],
    [true, "mono_interp_pgo_save_table", "number", ["pointer", "number"]],
    [() => !runtimeHelpers.emscriptenBuildOptions.enablePerfTracing && !runtimeHelpers.emscriptenBuildOptions.enableBrowserProfiler, "mono_jiterp_prof_enter", "void", ["pointer", "pointer"]],
    [() => !runtimeHelpers.emscriptenBuildOptions.enablePerfTracing && !runtimeHelpers.emscriptenBuildOptions.enableBrowserProfiler, "mono_jiterp_prof_samplepoint", "void", ["pointer", "pointer"]],
    [() => !runtimeHelpers.emscriptenBuildOptions.enablePerfTracing && !runtimeHelpers.emscriptenBuildOptions.enableBrowserProfiler, "mono_jiterp_prof_leave", "void", ["pointer", "pointer"]],
