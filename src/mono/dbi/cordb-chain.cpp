...
HRESULT __stdcall CordbChainEnum::QueryInterface(REFIID id, void **pInterface) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChainEnum - QueryInterface - NOT IMPLEMENTED\n"));
  return E_NOTIMPL;
}
...
HRESULT STDMETHODCALLTYPE CordbChainEnum::GetCount(ULONG *pcelt) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChainEnum - GetCount - NOT IMPLEMENTED\n"));
...
HRESULT STDMETHODCALLTYPE CordbChain::GetStackRange(CORDB_ADDRESS *pStart,
                                                    CORDB_ADDRESS *pEnd) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChain - GetStackRange - NOT IMPLEMENTED\n"));
  return E_NOTIMPL;
}
...
HRESULT STDMETHODCALLTYPE CordbChain::GetPrevious(ICorDebugChain **ppChain) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChain - GetPrevious - NOT IMPLEMENTED\n"));
  return E_NOTIMPL;
}
...
CordbChain::EnumerateFrames(ICorDebugFrameEnum **ppFrames) {
  CordbFrameEnum *pFrame = new CordbFrameEnum(conn, m_pThread);
  pFrame->AddRef();
  *ppFrames = static_cast<ICorDebugFrameEnum *>(pFrame);
  LOG((LF_CORDB, LL_INFO1000000,
       "CordbChain - EnumerateFrames - IMPLEMENTED\n"));
  return S_OK;
}

HRESULT STDMETHODCALLTYPE CordbChain::GetActiveFrame(ICorDebugFrame **ppFrame) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChain - GetActiveFrame - NOT IMPLEMENTED\n"));
  return E_NOTIMPL;
}

HRESULT STDMETHODCALLTYPE
CordbChain::GetRegisterSet(ICorDebugRegisterSet **ppRegisters) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChain - GetRegisterSet - NOT IMPLEMENTED\n"));
  return E_NOTIMPL;
}
...
HRESULT STDMETHODCALLTYPE CordbChain::QueryInterface(
    REFIID id, _COM_Outptr_ void __RPC_FAR *__RPC_FAR *pInterface) {
  LOG((LF_CORDB, LL_INFO100000,
       "CordbChain - QueryInterface - NOT IMPLEMENTED\n"));
  return E_NOTIMPL;
}
