...
{
    internal sealed class MachDynamicLinkEditSymbolTable : MachLoadCommand
    {
        private readonly Stream stream;
        private readonly MachObjectFile objectFile;
        internal DynamicSymbolTableCommandHeader Header;

        internal MachDynamicLinkEditSymbolTable(MachObjectFile objectFile, Stream stream)
        {
        ...
        internal MachDynamicLinkEditSymbolTable(MachObjectFile objectFile, Stream stream, MachSymbolTable symbolTable)
