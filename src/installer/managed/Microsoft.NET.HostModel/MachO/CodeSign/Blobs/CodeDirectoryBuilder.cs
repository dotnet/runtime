...
namespace Microsoft.NET.HostModel.MachO.CodeSign.Blobs
{
    internal sealed class CodeDirectoryBuilder
    {
        ...
        internal CodeDirectoryBuilder(MachObjectFile executable, string identifier)
        {
        ...
        internal void SetSpecialSlotData(CodeDirectorySpecialSlot slot, byte[] data)
        {
        ...
        internal HashType HashType { get; set; } = HashType.SHA256;

        internal ExecutableSegmentFlags ExecutableSegmentFlags { get; set; }

        internal CodeDirectoryFlags Flags { get; set; }
        ...
        internal long Size(CodeDirectoryVersion version)
        {
        ...
        internal byte[] Build(Stream machOStream)
        {
