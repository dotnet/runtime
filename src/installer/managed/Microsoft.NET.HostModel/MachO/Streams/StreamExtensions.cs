...
namespace Microsoft.NET.HostModel.MachO.Streams
{
    ...
    {
        internal static Stream Slice(this Stream stream, long offset, long size)
        {
            return new SliceStream(stream, offset, size);
        }

        internal static void ReadFully(this Stream stream, Span<byte> buffer)
        {
        ...
        internal static void WritePadding(this Stream stream, long paddingSize, byte paddingByte = 0)
        {
