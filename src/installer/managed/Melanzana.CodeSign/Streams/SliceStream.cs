...
#if NETSTANDARD2_0
using ArgumentOutOfRangeException = Melanzana.ThrowHelpers.ArgumentOutOfRangeException;
using ObjectDisposedException = Melanzana.ThrowHelpers.ObjectDisposedException;
#endif
