...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.DependencyResolution
{
    ...
    public class ServiceableAssets : IClassFixture<ServiceableAssets.SharedTestState>
    {
        ...
        public void RuntimeAssemblies()
        {
            ...
            var serviceableLib = new LibraryAsset("ServiceableLib", $"lib/{TestContext.Tfm}/ServiceableLib.dll");
            var nonServiceableLib = new LibraryAsset("NonServiceableLib", $"lib/{TestContext.Tfm}/NonServiceableLib.dll");

            app.PopulateFrameworkDependent(Constants.MicrosoftNETCoreApp, TestContext.MicrosoftNETCoreAppVersion, b =>
            {
        ...
        public void NativeLibraries()
        {
            ...
            {
                b.WithPackage(serviceableLib.Name, serviceableLib.Version, lib => lib
                    .WithNativeLibraryGroup(TestContext.BuildRID, nativeGroup => nativeGroup
