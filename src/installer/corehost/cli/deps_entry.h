...
struct deps_entry_t
{
    ...
    bool to_dir_path(const pal::string_t& base, bool look_in_bundle, bool is_servicing, pal::string_t* str, bool& found_in_bundle) const;
    ...
    bool to_full_path(const pal::string_t& root, bool is_servicing, pal::string_t* str) const;
