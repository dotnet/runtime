...
namespace Profiler.Tests
{
    ...
    class GCSkipObjectsAllocatedByClassCallbackTests
    {
        static readonly Guid GCSkipObjectsAllocatedByClassCallbackProfilerGuid = new Guid("0FC54C4F-6BD3-494D-A11A-B32DE3FBCB76");
        ...
        public static int Main(string[] args)
        {
            ...
            return ProfilerTestRunner.Run(profileePath: System.Reflection.Assembly.GetExecutingAssembly().Location,
                                          testName: "GCTests",
                                          profilerClsid: GCSkipObjectsAllocatedByClassCallbackProfilerGuid);
        }
    }
}
