...
public struct GenInt : GenOuter<int>.IGen<int>
{	
	int Fld1;
...
public struct GenDouble: GenOuter<int>.IGen<double>
{	
	double Fld1;
...
public struct GenString : GenOuter<int>.IGen<String>
{	
	string Fld1;
...
public struct GenObject : GenOuter<int>.IGen<object>
{	
	object Fld1;
...
public struct GenGuid : GenOuter<int>.IGen<Guid>
{	
	Guid Fld1;
...
public struct GenConstructedReference : GenOuter<int>.IGen<RefX1<int>>
{	
	RefX1<int> Fld1;
...
public struct GenConstructedValue: GenOuter<int>.IGen<ValX1<string>>
{	
	ValX1<string> Fld1;
...
public struct Gen1DIntArray : GenOuter<int>.IGen<int[]>
{	
	int[] Fld1;
...
public struct Gen2DStringArray : GenOuter<int>.IGen<string[,]>
{	
	string[,] Fld1;
...
public struct GenJaggedObjectArray : GenOuter<int>.IGen<object[][]>
{	
	object[][] Fld1;
