...
{
	public abstract void _Init(T fld1);
	public abstract bool InstVerify(System.Type t1);
}
	
public class GenInt : GenSub<int>
{	
	int Fld1;

	public override void _Init(int fld1)
	{
		Fld1 = fld1;
	}
...
public class GenDouble:  GenSub<double>
{	
	double Fld1;

	public override void _Init(double fld1)
	{
		Fld1 = fld1;
	}
...
public class GenString :  GenSub<String>
{	
	string Fld1;

	public override void _Init(string fld1)
	{
		Fld1 = fld1;
	}
...
public class GenObject :  GenSub<object>
{	
	object Fld1;

	public override void _Init(object fld1)
	{
		Fld1 = fld1;
	}
...
public class GenGuid :  GenSub<Guid>
{	
	Guid Fld1;

	public override void _Init(Guid fld1)
	{
		Fld1 = fld1;
	}
...
public class GenConstructedReference :  GenSub<RefX1<int>>
{	
	RefX1<int> Fld1;
...
public class GenConstructedValue:  GenSub<ValX1<string>>
{	
	ValX1<string> Fld1;

	public override void _Init(ValX1<string> fld1)
	{
		Fld1 = fld1;
	}
...
public class Gen1DIntArray :  GenSub<int[]>
{	
	int[] Fld1;
...
public class Gen2DStringArray :  GenSub<string[,]>
{	
	string[,] Fld1;
...
public class GenJaggedObjectArray : GenSub<object[][]>
{	
	object[][] Fld1;
