...
@@public
export const loader_classloader_TypeInitialization_CircularCctors_circularCctorFourThreads = CoreClr.coreclr_test({
...
@@public
export const loader_classloader_TypeInitialization_CircularCctors_circularCctorThreeThreads02 = CoreClr.coreclr_test({
...
@@public
export const loader_classloader_TypeInitialization_CircularCctors_circularCctorTwoThreadsThreeCC = CoreClr.coreclr_test({
