...
public class Gen<T>
{
	public void ExceptionTest(bool throwException)
	{
		...
		try
		{
			...
			Test_try_catch_finally_struct03.Eval(!throwException);
		}
		...
		catch
		{
			...
			Test_try_catch_finally_struct03.Eval(false);
		}
		finally
		{
			set = true;
			Test_try_catch_finally_struct03.Eval(true);
		}
		Test_try_catch_finally_struct03.Eval(set);
	}
}

public class Test_try_catch_finally_struct03
{
