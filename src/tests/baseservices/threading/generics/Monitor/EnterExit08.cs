...
struct Gen<T> 
{
	public static void EnterExitTest<U>()
	{
		...
		TestHelper myHelper = new TestHelper(Test_EnterExit08.nThreads);
		TestHelper myHelper2 = new TestHelper(Test_EnterExit08.nThreads);
		...
		for(int i=0;i<Test_EnterExit08.nThreads;i++)
		{
		...
		Test_EnterExit08.Eval(!(myHelper.Error || myHelper2.Error));
	}
	
}

public class Test_EnterExit08
{
