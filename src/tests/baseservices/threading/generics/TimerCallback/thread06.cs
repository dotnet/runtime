...
class Gen<T> 
{
	...
	{		
		...
		Test_thread06.Eval(typeof(U)!=p.GetType());
		if (Test_thread06.Xcounter>=Test_thread06.nThreads)
		{
	...
	public static void ThreadPoolTest<U>()
	{
		...
		Timer timer = new Timer(tcb,evt,Test_thread06.delay,Test_thread06.period);
	
		evt.WaitOne();
		timer.Dispose();
		Test_thread06.Eval(Test_thread06.Xcounter>=Test_thread06.nThreads);
