...
public unsafe class PInvokes_AutoLayout
{
    ...
    public static void StructWithAutoLayoutField()
    {
        short s = 42;
        bool b = true;
        Assert.Throws<TypeLoadException>(() => DisabledRuntimeMarshallingNative.CallWithAutoLayoutStruct(new SequentialWithAutoLayoutField()));
    }
    ...
    public static void StructWithNestedAutoLayoutField()
    {
        short s = 42;
        bool b = true;
        Assert.Throws<TypeLoadException>(() => DisabledRuntimeMarshallingNative.CallWithAutoLayoutStruct(new SequentialWithAutoLayoutNestedField()));
    }
}
