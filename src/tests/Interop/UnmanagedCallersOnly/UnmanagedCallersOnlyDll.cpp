...
#ifdef _WIN32
typedef int (__fastcall *CALLBACKPROC_FASTCALL)(int n);
#endif // _WIN32
...
#ifdef _WIN32
extern "C" DLL_EXPORT int STDMETHODCALLTYPE CallManagedProc_Fastcall(CALLBACKPROC_FASTCALL pCallbackProc, int n)
{
    return pCallbackProc(n);
}
#endif // _WIN32
