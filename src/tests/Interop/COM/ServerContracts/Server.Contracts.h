...
struct __declspec(uuid("AA0540BD-56C8-399B-B653-B787A33827F3"))
IClassDefaultInterfaceExposedToCom : IDispatch
{
    // _Object members from IClassX
    virtual HRESULT STDMETHODCALLTYPE ToString(_Out_ _Ret_ BSTR* pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE Equals(_In_ IUnknown* other, _Out_ _Ret_ VARIANT_BOOL* pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetHashCode(_Out_ _Ret_ int* pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetType(_Out_ _Ret_ IUnknown* pRetVal) = 0;

    // ExposedToCom members
    virtual HRESULT STDMETHODCALLTYPE MyMethod(_Out_ _Ret_ int* pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE MyAsyncMethod(_Out_ _Ret_ IUnknown** pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE MyAsyncMethod2(_Out_ _Ret_ IUnknown** pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE MyFloatMethod(_Out_ _Ret_ float* pRetVal) = 0;
};


struct __declspec(uuid("1BE53E57-C3E4-3A1D-A751-F12207A0F8A8"))
IInterfaceExposedToCom : IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE AsyncMethodOnInterface(_Out_ _Ret_ IUnknown** pRetVal) = 0;
    virtual HRESULT STDMETHODCALLTYPE FloatMethodOnInterface(_Out_ _Ret_ float* pRetVal) = 0;
};
