...
class TypeTestFolding
{
    ...
    static bool False16() => typeof(delegate*<int>) == typeof(UIntPtr);
    static bool False17() 
    {
        var t0 = typeof(delegate*<int>);
        SideEffect();
    ...
    {
        delegate*<bool>[] trueFuncs  = new delegate*<bool>[] { &True0, &True1, &True2, &True3, &True4, &True5, &True6, &True7 };
        delegate*<bool>[] falseFuncs = new delegate*<bool>[] { &False0, &False1, &False2, &False3, &False4, &False5, 
                                                               ...
                                                               &False12, &False13, &False14, &False15, &False16, &False17 };
