...
namespace JIT.opt.ValueNumbering
{
    ...
    {
        // Test case from the issue: Index.IsFromEnd returns value unchanged
        // The double NOT (~~i.Value) would have been generated by the compiler
        // for certain patterns, but we're testing the optimization directly here
