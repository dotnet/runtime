...
public class ComparisonTestAnd2Chains
{
    ...
    public static void Lt_byte_2_consume(byte a1, byte a2) {
        ...
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #11, nc, ge
        //ARM64-FULL-LINE-NEXT: csel {{w[0-9]+}}, {{w[0-9]+}}, {{w[0-9]+}}, ge
    ...
    public static void Gt_int_2_consume(int a1, int a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #10
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #13, 0, le
        //ARM64-FULL-LINE-NEXT: csel {{w[0-9]+}}, {{w[0-9]+}}, {{w[0-9]+}}, le
    ...
    public static void Ge_long_2_consume(long a1, long a2) {
        ...
        //ARM64-FULL-LINE-NEXT: ccmp {{x[0-9]+}}, #14, z, lt
        //ARM64-FULL-LINE-NEXT: csel {{x[0-9]+}}, {{x[0-9]+}}, {{x[0-9]+}}, lt
    ...
    public static void Eq_ushort_2_consume(ushort a1, ushort a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #10
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #15, z, ne
    ...
    public static void Ne_uint_2_consume(uint a1, uint a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #10
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #16, 0, eq
    ...
    public static void Le_else_byte_2_consume(byte a1, byte a2)
    {
        ...
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #22, nzc, gt
        //ARM64-FULL-LINE-NEXT: csel {{w[0-9]+}}, {{w[0-9]+}}, {{w[0-9]+}}, gt
    ...
    public static void Gt_else_short_2_consume(short a1, short a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #11
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #23, 0, le
        //ARM64-FULL-LINE-NEXT: csel {{w[0-9]+}}, {{w[0-9]+}}, {{w[0-9]+}}, le
    ...
    public static void Ge_else_int_2_consume(int a1, int a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #11
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #24, z, lt
        //ARM64-FULL-LINE-NEXT: csel {{w[0-9]+}}, {{w[0-9]+}}, {{w[0-9]+}}, lt
    ...
    public static void Eq_else_long_2_consume(long a1, long a2) {
        ...
        //ARM64-FULL-LINE-NEXT: ccmp {{x[0-9]+}}, #25, z, ne
        //ARM64-FULL-LINE-NEXT: csel {{x[0-9]+}}, {{x[0-9]+}}, {{x[0-9]+}}, ne
    ...
    public static void Ne_else_ushort_2_consume(ushort a1, ushort a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #11
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #26, 0, eq
        //ARM64-FULL-LINE-NEXT: csel {{w[0-9]+}}, {{w[0-9]+}}, {{w[0-9]+}}, eq
    ...
    public static void Lt_else_uint_2_consume(uint a1, uint a2) {
        //ARM64-FULL-LINE: cmp {{w[0-9]+}}, #11
        //ARM64-FULL-LINE-NEXT: ccmp {{w[0-9]+}}, #27, 0, hs
