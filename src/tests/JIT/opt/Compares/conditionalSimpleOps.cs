...
public class ConditionalSimpleOpTest
{
    ...
    [Theory]
    [InlineData(72, 0x7FFF_FFFF_FFFF_FFF3ul)]
    [InlineData(32, 0xFFFF_FFFF_FFFF_FFE7ul)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [Theory]
    [InlineData(72, 0x7FFF_FFF3)]
    [InlineData(32, 0xFFFF_FFE7)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static void shift_right_logic_long_truncate(byte op1, long expected)
    {
    ...
    [Theory]
    [InlineData(72, 0xFFFF_FFFF_8000_0000ul)]
    [InlineData(32, 0ul)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static void pow2_or_zero_ulong(byte op1, ulong expected)
    {
