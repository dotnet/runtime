...
public class StrideTest
{
    ...
    [ActiveIssue("Allocates large contiguous array that is not consistently available on Apple mobile", typeof(PlatformDetection), nameof(PlatformDetection.IsAppleMobile))]
    [Fact]
