...
@@public
export const jIT_jit64_regress_vsw_524070_test2_524070 = CoreClr.coreclr_test({
    name: "test2_524070",
    srcs: ["test2.cs"],
    debugType: "pdbonly",
    optimize: true,
...
@@public
export const jIT_jit64_regress_vsw_524070_test1_524070 = CoreClr.coreclr_test({
    name: "test1_524070",
    srcs: ["test1.cs"],
    debugType: "pdbonly",
    optimize: true,
