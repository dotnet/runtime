...
@@public
export const jIT_Methodical_int64_superlong_superlong_il_r = CoreClr.il_coreclr_test({
    name: "superlong_il_r",
...
@@public
export const jIT_Methodical_int64_superlong_superlong_il_d = CoreClr.il_coreclr_test({
    name: "superlong_il_d",
