...
namespace JitTest_Generics_Parameters_static_passing_struct01;
...
public struct Gen<T>
{
    ...
    public static void PassAsParameter(T t1, T t2)
    {
        ...
        Test_static_passing_struct01.Eval(t1.Equals(PassAsIn(temp)));
        Test_static_passing_struct01.Eval(t1.Equals(PassAsRef(ref temp, t2)));
        Test_static_passing_struct01.Eval(t2.Equals(temp));
        temp = t1;
