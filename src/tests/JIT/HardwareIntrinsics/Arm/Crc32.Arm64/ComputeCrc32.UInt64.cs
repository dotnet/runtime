...
namespace JIT.HardwareIntrinsics.Arm._Crc32.Arm64
{
    ...
    {
        [Fact]
        public static void ComputeCrc32_UInt64()
        {
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32_UInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32.Arm64).GetMethod(nameof(Crc32.Arm64.ComputeCrc32), new Type[] { typeof(UInt32), typeof(UInt64) })
        ...
        private void ValidateResult(UInt32 left, UInt64 right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            uint expectedResult = 0xEFAAAB74; isUnexpectedResult = (expectedResult != result);

            if (isUnexpectedResult)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Crc32.Arm64)}.{nameof(Crc32.Arm64.ComputeCrc32)}<UInt32>(UInt32, UInt64): ComputeCrc32 failed:");
