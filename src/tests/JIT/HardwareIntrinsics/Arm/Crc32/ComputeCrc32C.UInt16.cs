...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ComputeCrc32C_UInt16()
        {
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32C_UInt16
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarBinaryOpTest__ComputeCrc32C_UInt16 testClass)
            {
        ...
        static ScalarBinaryOpTest__ComputeCrc32C_UInt16()
        {
            _clsVar1 = 0xFFFFFFFF;
            _clsVar2 = 0x2019;
        }

        public ScalarBinaryOpTest__ComputeCrc32C_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32).GetMethod(nameof(Crc32.ComputeCrc32C), new Type[] { typeof(UInt32), typeof(UInt16) })
        ...
        private void ValidateResult(UInt32 left, UInt16 right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            uint expectedResult = 0x9F50ACBD; isUnexpectedResult = (expectedResult != result);

            if (isUnexpectedResult)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Crc32)}.{nameof(Crc32.ComputeCrc32C)}<UInt32>(UInt32, UInt16): ComputeCrc32C failed:");
