...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32C_UInt32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarBinaryOpTest__ComputeCrc32C_UInt32 testClass)
            {
        ...
        static ScalarBinaryOpTest__ComputeCrc32C_UInt32()
        {
            _clsVar1 = 0xFFFFFFFF;
            _clsVar2 = 0x20191113;
        }

        public ScalarBinaryOpTest__ComputeCrc32C_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32).GetMethod(nameof(Crc32.ComputeCrc32C), new Type[] { typeof(UInt32), typeof(UInt32) })
        ...
        private void ValidateResult(UInt32 left, UInt32 right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            uint expectedResult = 0x78F34758; isUnexpectedResult = (expectedResult != result);

            if (isUnexpectedResult)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Crc32)}.{nameof(Crc32.ComputeCrc32C)}<UInt32>(UInt32, UInt32): ComputeCrc32C failed:");
