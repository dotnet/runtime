...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingZeroCount_Vector128_UInt32()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingZeroCount_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__LeadingZeroCount_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__LeadingZeroCount_Vector128_UInt32 testClass)
            {
        ...
        static SimpleUnaryOpTest__LeadingZeroCount_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleUnaryOpTest__LeadingZeroCount_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.LeadingZeroCount), new Type[] { typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingZeroCount)}<UInt32>(Vector128<UInt32>): {method} failed:");
