...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundAwayFromZero_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single testClass)
            {
        ...
        static SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.RoundAwayFromZero), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.RoundAwayFromZero(firstOp[i])) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundAwayFromZero)}<Single>(Vector64<Single>): {method} failed:");
