...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_UInt16_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector64<UInt16>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero testClass)
            {
                fixed (Vector64<UInt16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.CompareEqual(
                        AdvSimd.LoadVector64((UInt16*)(pFld1)),
                        Vector64<UInt16>.Zero
                    );
        ...
        static ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero()
        {
            Succeeded = true;
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector64<UInt16>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector64_UInt16_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector64<UInt16>.Zero);
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<UInt16>(Vector64<UInt16>): {method} failed:");
