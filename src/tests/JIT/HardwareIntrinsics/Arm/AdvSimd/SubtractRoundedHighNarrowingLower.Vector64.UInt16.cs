...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractRoundedHighNarrowingLower_Vector64_UInt16()
        {
            var test = new SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_UInt16 testClass)
            {
                fixed (Vector128<UInt32>* pFld1 = &_fld1)
                fixed (Vector128<UInt32>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.SubtractRoundedHighNarrowingLower(
        ...
        public SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractRoundedHighNarrowingLower), new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<UInt32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SubtractRoundedHighNarrowingLower(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_UInt16();
            var result = AdvSimd.SubtractRoundedHighNarrowingLower(test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractRoundedHighNarrowingLower)}<UInt16>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
