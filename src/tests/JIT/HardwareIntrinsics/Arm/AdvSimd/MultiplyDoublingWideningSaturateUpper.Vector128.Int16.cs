...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateUpper_Vector128_Int16()
        {
            var test = new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16 testClass)
            {
                var result = AdvSimd.MultiplyDoublingWideningSaturateUpper(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16 testClass)
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)
                fixed (Vector128<Int16>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.MultiplyDoublingWideningSaturateUpper(
        ...
        static SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningSaturateUpper), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<Int16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateUpper(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpper_Vector128_Int16();
            var result = AdvSimd.MultiplyDoublingWideningSaturateUpper(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningSaturateUpper(left, right, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateUpper)}<Int32>(Vector128<Int16>, Vector128<Int16>): {method} failed:");
