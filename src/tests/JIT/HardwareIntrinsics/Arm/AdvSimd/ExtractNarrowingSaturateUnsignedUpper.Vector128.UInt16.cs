...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper), new Type[] { typeof(Vector64<UInt16>), typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Vector64<UInt16> op1, Vector128<Int32> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] left, Int32[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper)}<UInt16>(Vector64<UInt16>, Vector128<Int32>): {method} failed:");
