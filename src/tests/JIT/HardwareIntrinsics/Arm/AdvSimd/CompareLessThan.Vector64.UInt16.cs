...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThan_Vector64_UInt16()
        {
            var test = new SimpleBinaryOpTest__CompareLessThan_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThan_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThan_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThan_Vector64_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareLessThan_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__CompareLessThan_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareLessThan), new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareLessThan)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
