...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Ceiling_Vector64_Single()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__Ceiling_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Ceiling_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Ceiling_Vector64_Single testClass)
            {
        ...
        static SimpleUnaryOpTest__Ceiling_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__Ceiling_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Ceiling), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.Ceiling(firstOp[i])) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Ceiling)}<Single>(Vector64<Single>): {method} failed:");
