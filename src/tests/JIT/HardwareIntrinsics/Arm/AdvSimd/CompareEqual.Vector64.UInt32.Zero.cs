...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_UInt32_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector64<UInt32>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero testClass)
            {
                fixed (Vector64<UInt32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.CompareEqual(
                        AdvSimd.LoadVector64((UInt32*)(pFld1)),
                        Vector64<UInt32>.Zero
                    );
        ...
        static ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareEqual), new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector64<UInt32>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector64_UInt32_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector64<UInt32>.Zero);
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<UInt32>(Vector64<UInt32>): {method} failed:");
