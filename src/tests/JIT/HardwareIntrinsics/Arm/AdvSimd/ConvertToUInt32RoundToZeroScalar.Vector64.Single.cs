...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt32RoundToZeroScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single testClass)
            {
                var result = AdvSimd.ConvertToUInt32RoundToZeroScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single testClass)
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.ConvertToUInt32RoundToZeroScalar(
        ...
        static SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToUInt32RoundToZeroScalar), new Type[] { typeof(Vector64<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToZeroScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt32RoundToZeroScalar_Vector64_Single();
            var result = AdvSimd.ConvertToUInt32RoundToZeroScalar(test._fld1);
        ...
        private void ValidateResult(Single[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.ConvertToUInt32RoundToZero(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToZeroScalar)}<UInt32>(Vector64<Single>): {method} failed:");
