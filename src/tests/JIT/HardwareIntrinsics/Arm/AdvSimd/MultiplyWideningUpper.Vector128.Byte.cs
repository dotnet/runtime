...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpper_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Byte testClass)
            {
                var result = AdvSimd.MultiplyWideningUpper(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Byte testClass)
            {
                fixed (Vector128<Byte>* pFld1 = &_fld1)
                fixed (Vector128<Byte>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.MultiplyWideningUpper(
        ...
        static SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningUpper), new Type[] { typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyWideningUpper(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Byte();
            var result = AdvSimd.MultiplyWideningUpper(test._fld1, test._fld2);
        ...
        private void ValidateResult(Byte[] left, Byte[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyWideningUpper(left, right, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpper)}<UInt16>(Vector128<Byte>, Vector128<Byte>): {method} failed:");
