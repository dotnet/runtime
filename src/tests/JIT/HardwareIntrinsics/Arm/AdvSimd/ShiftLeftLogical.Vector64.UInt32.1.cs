...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogical_Vector64_UInt32_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogical_Vector64_UInt32_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftLeftLogical_Vector64_UInt32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftLeftLogical_Vector64_UInt32_1 testClass)
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogical_Vector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public ImmUnaryOpTest__ShiftLeftLogical_Vector64_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftLeftLogical), new Type[] { typeof(Vector64<UInt32>), typeof(byte) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogical)}<UInt32>(Vector64<UInt32>, 1): {method} failed:");
