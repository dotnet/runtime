...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar)}<Int32>(Vector64<Single>): {method} failed:");
