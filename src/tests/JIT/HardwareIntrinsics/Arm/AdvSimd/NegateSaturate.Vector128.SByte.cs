...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void NegateSaturate_Vector128_SByte()
        {
            var test = new SimpleUnaryOpTest__NegateSaturate_Vector128_SByte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturate_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__NegateSaturate_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__NegateSaturate_Vector128_SByte testClass)
            {
        ...
        static SimpleUnaryOpTest__NegateSaturate_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = SByte.MinValue; }
        ...
        public SimpleUnaryOpTest__NegateSaturate_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.NegateSaturate), new Type[] { typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(SByte[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.NegateSaturate)}<SByte>(Vector128<SByte>): {method} failed:");
