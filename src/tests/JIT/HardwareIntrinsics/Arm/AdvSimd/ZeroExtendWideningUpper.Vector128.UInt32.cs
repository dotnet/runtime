...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZeroExtendWideningUpper_Vector128_UInt32()
        {
            var test = new SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_UInt32 testClass)
            {
        ...
        static SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ZeroExtendWideningUpper), new Type[] { typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningUpper)}<UInt64>(Vector128<UInt32>): {method} failed:");
