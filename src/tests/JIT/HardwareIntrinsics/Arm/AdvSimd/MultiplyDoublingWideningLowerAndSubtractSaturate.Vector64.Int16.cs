...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16()
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16 testClass)
            {
                var result = AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate), new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int16();
            var result = AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Int32[] firstOp, Int16[] secondOp, Int16[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningAndSubtractSaturate(firstOp[i], secondOp[i], thirdOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate)}<Int32>(Vector128<Int32>, Vector64<Int16>, Vector64<Int16>): {method} failed:");
