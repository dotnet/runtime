...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifference_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16
    {
        private struct DataTable
        {
            ...
            public DataTable(Int16[] inArray1, Int16[] inArray2, UInt16[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifference), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifference)}<UInt16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
