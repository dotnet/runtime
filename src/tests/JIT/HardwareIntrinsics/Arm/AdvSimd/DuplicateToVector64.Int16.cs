...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_Int16()
        {
            var test = new DuplicateUnaryOpTest__DuplicateToVector64_Int16();
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector64_Int16 testClass)
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector64_Int16()
        {
            _clsVar = TestLibrary.Generator.GetInt16();
        }

        public DuplicateUnaryOpTest__DuplicateToVector64_Int16()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Int16 data, Int16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<Int16>(Int16): DuplicateToVector64 failed:");
