...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector128_UInt64_1()
        {
            var test = new ExtractVectorTest__ExtractVector128_UInt64_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_UInt64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector128_UInt64_1 testClass)
            {
                var result = AdvSimd.ExtractVector128(_fld1, _fld2, ElementIndex);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ExtractVectorTest__ExtractVector128_UInt64_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector128_UInt64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public ExtractVectorTest__ExtractVector128_UInt64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractVector128), new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<UInt64>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ExtractVector128(op1, op2, ElementIndex);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ExtractVectorTest__ExtractVector128_UInt64_1();
            var result = AdvSimd.ExtractVector128(test._fld1, test._fld2, ElementIndex);
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] secondOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>, 1): {method} failed:");
