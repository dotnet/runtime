...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningLowerAndSubtract_Vector64_SByte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_SByte testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningLowerAndSubtract), new Type[] { typeof(Vector128<Int16>), typeof(Vector64<SByte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(Int16[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndSubtract)}<Int16>(Vector128<Int16>, Vector64<SByte>, Vector64<SByte>): {method} failed:");
