...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingLower_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte()
        {
            Succeeded = true;
