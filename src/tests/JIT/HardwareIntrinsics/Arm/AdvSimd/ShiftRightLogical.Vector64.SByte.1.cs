...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogical_Vector64_SByte_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogical_Vector64_SByte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightLogical_Vector64_SByte_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftRightLogical_Vector64_SByte_1 testClass)
            {
        ...
        public ImmUnaryOpTest__ShiftRightLogical_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightLogical), new Type[] { typeof(Vector64<SByte>), typeof(byte) })
        ...
        private void ValidateResult(SByte[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogical)}<SByte>(Vector64<SByte>, 1): {method} failed:");
