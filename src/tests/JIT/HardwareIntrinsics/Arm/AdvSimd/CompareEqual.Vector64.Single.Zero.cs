...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_Single_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector64_Single_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector64_Single_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector64_Single_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector64<Single>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector64_Single_Zero testClass)
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.CompareEqual(
                        AdvSimd.LoadVector64((Single*)(pFld1)),
                        Vector64<Single>.Zero
                    );
        ...
        static ZeroUnOpTest__CompareEqual_Vector64_Single_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector64_Single_Zero()
        {
            Succeeded = true;
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector64<Single>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector64_Single_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector64<Single>.Zero);
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<Single>(Vector64<Single>): {method} failed:");
