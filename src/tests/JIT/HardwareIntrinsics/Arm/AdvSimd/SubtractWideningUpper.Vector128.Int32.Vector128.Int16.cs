...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningUpper_Vector128_Int32_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningUpper), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Vector128<Int32> op1, Vector128<Int16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<Int32>(Vector128<Int32>, Vector128<Int16>): {method} failed:");
