...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Abs_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__Abs_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Abs_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Abs_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Abs_Vector64_Single testClass)
            {
        ...
        static SimpleUnaryOpTest__Abs_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = -TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__Abs_Vector64_Single()
        {
            Succeeded = true;
