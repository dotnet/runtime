...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void DuplicateToVector128_Single()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector128_Single testClass)
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector128_Single()
        {
            _clsVar = TestLibrary.Generator.GetSingle();
        }

        public DuplicateUnaryOpTest__DuplicateToVector128_Single()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Single data, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Single>(Single): DuplicateToVector128 failed:");
