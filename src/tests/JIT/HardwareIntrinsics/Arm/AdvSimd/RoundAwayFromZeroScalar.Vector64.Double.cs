...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundAwayFromZeroScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double testClass)
            {
                var result = AdvSimd.RoundAwayFromZeroScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double testClass)
            {
                fixed (Vector64<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.RoundAwayFromZeroScalar(
        ...
        static SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.RoundAwayFromZeroScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.RoundAwayFromZeroScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double();
            var result = AdvSimd.RoundAwayFromZeroScalar(test._fld1);
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.RoundAwayFromZero(firstOp[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundAwayFromZeroScalar)}<Double>(Vector64<Double>): {method} failed:");
