...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_Byte_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector64<Byte>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero testClass)
            {
        ...
        static ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareEqual), new Type[] { typeof(Vector64<Byte>), typeof(Vector64<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector64<Byte>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector64_Byte_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector64<Byte>.Zero);
        ...
        private void ValidateResult(Byte[] firstOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<Byte>(Vector64<Byte>): {method} failed:");
