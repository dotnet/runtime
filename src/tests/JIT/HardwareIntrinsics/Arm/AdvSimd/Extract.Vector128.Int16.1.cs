...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector128_Int16_1()
        {
            var test = new ExtractTest__Extract_Vector128_Int16_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector128_Int16_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector128_Int16_1 testClass)
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Extract(AdvSimd.LoadVector128((Int16*)pFld1), ElementIndex);
        ...
        static ExtractTest__Extract_Vector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ExtractTest__Extract_Vector128_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector128<Int16>), typeof(byte) })
                                     .Invoke(null, new object[] {
                                        Unsafe.Read<Vector128<Int16>>(_dataTable.inArray1Ptr),
                                        ElementIndex
                                     });

            ValidateResult(_dataTable.inArray1Ptr, (Int16)result);
        }
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector128((Int16*)pClsVar1), ElementIndex);
        ...
        private void ValidateResult(Vector128<Int16> op1, Int16 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(void* op1, Int16 result, [CallerMemberName] string method = "")
        {
            Int16[] inArray1 = new Int16[Op1ElementCount];
        ...
        private void ValidateResult(Int16[] firstOp, Int16 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector128<Int16>, 1): {method} failed:");
