...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningLower_Vector128_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddWideningLower_Vector128_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddWideningLower_Vector128_Int64 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddWideningLower_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleBinaryOpTest__AddWideningLower_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddWideningLower), new Type[] { typeof(Vector128<Int64>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int64[] left, Int32[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<Int64>(Vector128<Int64>, Vector64<Int32>): {method} failed:");
