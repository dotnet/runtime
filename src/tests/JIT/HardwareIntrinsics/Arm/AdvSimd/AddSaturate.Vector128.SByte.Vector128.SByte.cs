...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void AddSaturate_Vector128_SByte_Vector128_SByte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_SByte testClass)
            {
