...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddHighNarrowingLower_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddHighNarrowingLower), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingLower)}<Int16>(Vector128<Int32>, Vector128<Int32>): {method} failed:");
