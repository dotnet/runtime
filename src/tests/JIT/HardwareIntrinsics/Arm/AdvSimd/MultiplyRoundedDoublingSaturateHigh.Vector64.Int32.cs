...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingSaturateHigh_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32 testClass)
            {
                var result = AdvSimd.MultiplyRoundedDoublingSaturateHigh(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32 testClass)
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)
                fixed (Vector64<Int32>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.MultiplyRoundedDoublingSaturateHigh(
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyRoundedDoublingSaturateHigh), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyRoundedDoublingSaturateHigh(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector64_Int32();
            var result = AdvSimd.MultiplyRoundedDoublingSaturateHigh(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyRoundedDoublingSaturateHigh(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingSaturateHigh)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
