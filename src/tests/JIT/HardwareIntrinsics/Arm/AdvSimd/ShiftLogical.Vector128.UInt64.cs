...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogical_Vector128_UInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogical_Vector128_UInt64
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt64[] inArray1, Int64[] inArray2, UInt64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ShiftLogical_Vector128_UInt64 testClass)
            {
                var result = AdvSimd.ShiftLogical(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ShiftLogical_Vector128_UInt64 testClass)
            {
                fixed (Vector128<UInt64>* pFld1 = &_fld1)
                fixed (Vector128<Int64>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.ShiftLogical(
        ...
        static SimpleBinaryOpTest__ShiftLogical_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__ShiftLogical_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftLogical), new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<Int64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLogical(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftLogical_Vector128_UInt64();
            var result = AdvSimd.ShiftLogical(test._fld1, test._fld2);
        ...
        private void ValidateResult(Vector128<UInt64> op1, Vector128<Int64> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, Int64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;

            for (var i = 0; i < RetElementCount; i++)
            {
                if (Helpers.ShiftLogical(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogical)}<UInt64>(Vector128<UInt64>, Vector128<Int64>): {method} failed:");
