...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingle_Vector64_Int32()
        {
            var test = new SimpleUnaryOpTest__ConvertToSingle_Vector64_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToSingle_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToSingle_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToSingle_Vector64_Int32 testClass)
            {
        ...
        static SimpleUnaryOpTest__ConvertToSingle_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleUnaryOpTest__ConvertToSingle_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToSingle), new Type[] { typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToSingle)}<Single>(Vector64<Int32>): {method} failed:");
