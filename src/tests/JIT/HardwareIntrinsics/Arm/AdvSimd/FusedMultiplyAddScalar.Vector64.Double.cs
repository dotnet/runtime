...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedMultiplyAddScalar_Vector64_Double()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double testClass)
            {
                var result = AdvSimd.FusedMultiplyAddScalar(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double testClass)
            {
        ...
        static SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.FusedMultiplyAddScalar), new Type[] { typeof(Vector64<Double>), typeof(Vector64<Double>), typeof(Vector64<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.FusedMultiplyAddScalar(op1, op2, op3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double();
            var result = AdvSimd.FusedMultiplyAddScalar(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Double[] firstOp, Double[] secondOp, Double[] thirdOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.FusedMultiplyAdd(firstOp[0], secondOp[0], thirdOp[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplyAddScalar)}<Double>(Vector64<Double>, Vector64<Double>, Vector64<Double>): {method} failed:");
