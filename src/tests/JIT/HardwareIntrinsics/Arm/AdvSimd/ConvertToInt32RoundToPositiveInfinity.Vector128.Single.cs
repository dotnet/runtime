...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void ConvertToInt32RoundToPositiveInfinity_Vector128_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinity_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinity_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinity_Vector128_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinity_Vector128_Single testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToInt32RoundToPositiveInfinity), new Type[] { typeof(Vector128<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToPositiveInfinity)}<Int32>(Vector128<Single>): {method} failed:");
