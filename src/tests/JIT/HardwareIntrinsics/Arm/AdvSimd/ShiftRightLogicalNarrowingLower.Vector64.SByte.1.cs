...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalNarrowingLower_Vector64_SByte_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1 testClass)
            {
                var result = AdvSimd.ShiftRightLogicalNarrowingLower(_fld, 1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1 testClass)
            {
                fixed (Vector128<Int16>* pFld = &_fld)
                {
                    var result = AdvSimd.ShiftRightLogicalNarrowingLower(
        ...
        static ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightLogicalNarrowingLower), new Type[] { typeof(Vector128<Int16>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalNarrowingLower(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_SByte_1();
            var result = AdvSimd.ShiftRightLogicalNarrowingLower(test._fld, 1);
        ...
        private void ValidateResult(Int16[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.ShiftRightLogicalNarrowing(firstOp[i], Imm) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalNarrowingLower)}<SByte>(Vector128<Int16>, 1): {method} failed:");
