...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractHighNarrowingUpper_Vector128_UInt16()
        {
            var test = new SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt16 testClass)
            {
        ...
        static SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractHighNarrowingUpper), new Type[] { typeof(Vector64<UInt16>), typeof(Vector128<UInt32>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt32[] secondOp, UInt32[] thirdOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractHighNarrowingUpper)}<UInt16>(Vector64<UInt16>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
