...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh), new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int32>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32();
            var result = AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh)}<Int32>(Vector128<Int32>, Vector64<Int32>): {method} failed:");
