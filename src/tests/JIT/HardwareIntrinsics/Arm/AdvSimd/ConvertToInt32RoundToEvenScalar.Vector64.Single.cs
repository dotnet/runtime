...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt32RoundToEvenScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single testClass)
            {
                var result = AdvSimd.ConvertToInt32RoundToEvenScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single testClass)
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.ConvertToInt32RoundToEvenScalar(
        ...
        static SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToInt32RoundToEvenScalar), new Type[] { typeof(Vector64<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToEvenScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single();
            var result = AdvSimd.ConvertToInt32RoundToEvenScalar(test._fld1);
        ...
        private void ValidateResult(Single[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.ConvertToInt32RoundToEven(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToEvenScalar)}<Int32>(Vector64<Single>): {method} failed:");
