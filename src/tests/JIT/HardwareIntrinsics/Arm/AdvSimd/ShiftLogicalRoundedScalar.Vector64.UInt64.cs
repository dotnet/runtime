...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedScalar_Vector64_UInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_UInt64 testClass)
            {
                var result = AdvSimd.ShiftLogicalRoundedScalar(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_UInt64 testClass)
            {
                fixed (Vector64<UInt64>* pFld1 = &_fld1)
                fixed (Vector64<Int64>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.ShiftLogicalRoundedScalar(
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftLogicalRoundedScalar), new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<Int64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLogicalRoundedScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_UInt64();
            var result = AdvSimd.ShiftLogicalRoundedScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Vector64<UInt64> op1, Vector64<Int64> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, Int64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.ShiftLogicalRounded(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRoundedScalar)}<UInt64>(Vector64<UInt64>, Vector64<Int64>): {method} failed:");
