...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractSaturate_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__SubtractSaturate_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractSaturate_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractSaturate_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractSaturate_Vector128_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractSaturate_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__SubtractSaturate_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractSaturate), new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractSaturate)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:");
