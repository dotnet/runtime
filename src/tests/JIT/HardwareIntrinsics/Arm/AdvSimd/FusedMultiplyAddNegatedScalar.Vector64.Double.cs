...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedMultiplyAddNegatedScalar_Vector64_Double()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Double testClass)
            {
        ...
        static SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.FusedMultiplyAddNegatedScalar), new Type[] { typeof(Vector64<Double>), typeof(Vector64<Double>), typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Double[] secondOp, Double[] thirdOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.FusedMultiplyAddNegated(firstOp[0], secondOp[0], thirdOp[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplyAddNegatedScalar)}<Double>(Vector64<Double>, Vector64<Double>, Vector64<Double>): {method} failed:");
