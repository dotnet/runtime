...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareGreaterThan_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__CompareGreaterThan_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThan_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareGreaterThan_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareGreaterThan_Vector64_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareGreaterThan_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__CompareGreaterThan_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareGreaterThan), new Type[] { typeof(Vector64<SByte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareGreaterThan)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:");
