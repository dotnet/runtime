...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16()
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16 testClass)
            {
                var result = AdvSimd.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16 testClass)
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)
                fixed (Vector128<Int16>* pFld2 = &_fld2)
                fixed (Vector64<Int16>* pFld3 = &_fld3)
                {
                    var result = AdvSimd.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate(
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int16>), typeof(Vector64<Int16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate(op1, op2, op3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningUpperByScalarAndSubtractSaturate_Vector128_Int16_Vector64_Int16();
            var result = AdvSimd.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Int32[] firstOp, Int16[] secondOp, Int16[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate(firstOp, secondOp, thirdOp[0], i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningUpperByScalarAndSubtractSaturate)}<Int32>(Vector128<Int32>, Vector128<Int16>, Vector64<Int16>): {method} failed:");
