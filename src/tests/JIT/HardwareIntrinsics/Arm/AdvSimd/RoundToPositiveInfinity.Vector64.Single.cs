...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void RoundToPositiveInfinity_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single testClass)
            {
        ...
        static SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.RoundToPositiveInfinity), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToPositiveInfinity)}<Single>(Vector64<Single>): {method} failed:");
