...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingle_Vector128_UInt32()
        {
            var test = new SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32 testClass)
            {
                var result = AdvSimd.ConvertToSingle(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32 testClass)
            {
                fixed (Vector128<UInt32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.ConvertToSingle(
        ...
        static SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToSingle), new Type[] { typeof(Vector128<UInt32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToSingle(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToSingle_Vector128_UInt32();
            var result = AdvSimd.ConvertToSingle(test._fld1);
        ...
        private void ValidateResult(UInt32[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.ConvertToSingle(firstOp[i])) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToSingle)}<Single>(Vector128<UInt32>): {method} failed:");
