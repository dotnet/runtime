...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7()
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7 testClass)
            {
                var result = AdvSimd.MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate(_fld1, _fld2, _fld3, 7);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7 testClass)
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)
                fixed (Vector64<Int16>* pFld2 = &_fld2)
                fixed (Vector128<Int16>* pFld3 = &_fld3)
                {
                    var result = AdvSimd.MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate(
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate), new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int16>), typeof(Vector128<Int16>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate(op1, op2, op3, 7);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate_Vector64_Int16_Vector128_Int16_7();
            var result = AdvSimd.MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate(test._fld1, test._fld2, test._fld3, 7);
        ...
        private void ValidateResult(Int32[] firstOp, Int16[] secondOp, Int16[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningAndSubtractSaturate(firstOp[i], secondOp[i], thirdOp[Imm]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningLowerBySelectedScalarAndSubtractSaturate)}<Int32>(Vector128<Int32>, Vector64<Int16>, Vector128<Int16>): {method} failed:");
