...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_UInt16_31()
        {
            var test = new ImmOpTest__DuplicateToVector64_UInt16_31();
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_UInt16_31
    {
        ...
        public ImmOpTest__DuplicateToVector64_UInt16_31()
        {
            Succeeded = true;
        ...
        private void ValidateResult(UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<UInt16>(31): {method} failed:");
