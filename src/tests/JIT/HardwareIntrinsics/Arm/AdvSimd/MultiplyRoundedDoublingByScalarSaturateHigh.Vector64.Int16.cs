...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
