...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void Extract_Vector64_Int16_1()
        {
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_Int16_1
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector64<Int16>), typeof(byte) })
        ...
        private void ValidateResult(Vector64<Int16> op1, Int16 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] firstOp, Int16 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<Int16>, 1): {method} failed:");
