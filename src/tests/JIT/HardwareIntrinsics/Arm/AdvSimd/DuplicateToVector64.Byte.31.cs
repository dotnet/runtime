...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_Byte_31()
        {
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_Byte_31
    {
        private struct DataTable
        {
            ...
            public DataTable(Byte[] outArray, int alignment)
            {
        ...
        public ImmOpTest__DuplicateToVector64_Byte_31()
        {
            Succeeded = true;

            _dataTable = new DataTable(new Byte[RetElementCount], LargestVectorSize);
        }
        ...
        private void ValidateResult(Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<Byte>(31): {method} failed:");
