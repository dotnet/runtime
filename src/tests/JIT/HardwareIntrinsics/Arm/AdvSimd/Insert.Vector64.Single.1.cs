...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class InsertTest__Insert_Vector64_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(InsertTest__Insert_Vector64_Single_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(InsertTest__Insert_Vector64_Single_1 testClass)
            {
        ...
        static InsertTest__Insert_Vector64_Single_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public InsertTest__Insert_Vector64_Single_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Insert), new Type[] { typeof(Vector64<Single>), typeof(byte), typeof(Single) })
        ...
        private void ValidateResult(Single[] firstOp, Single thirdOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Insert)}<Single>(Vector64<Single>, 1, Single): {method} failed:");
