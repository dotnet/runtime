...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningUpper_Vector128_UInt16_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddWideningUpper), new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<Byte>) })
        ...
        private void ValidateResult(UInt16[] left, Byte[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<UInt16>(Vector128<UInt16>, Vector128<Byte>): {method} failed:");
