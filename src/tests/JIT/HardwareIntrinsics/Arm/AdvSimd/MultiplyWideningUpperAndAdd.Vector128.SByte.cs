...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte
    {
        private struct DataTable
        {
            ...
            public DataTable(Int16[] inArray1, SByte[] inArray2, SByte[] inArray3, Int16[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningUpperAndAdd), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<SByte>), typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(Vector128<Int16> op1, Vector128<SByte> op2, Vector128<SByte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndAdd)}<Int16>(Vector128<Int16>, Vector128<SByte>, Vector128<SByte>): {method} failed:");
