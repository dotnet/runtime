...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToNearestScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Double testClass)
            {
        ...
        static SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.RoundToNearestScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.RoundToNearest(firstOp[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToNearestScalar)}<Double>(Vector64<Double>): {method} failed:");
