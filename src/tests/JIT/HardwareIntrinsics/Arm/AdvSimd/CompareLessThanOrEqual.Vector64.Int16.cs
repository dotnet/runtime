...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThanOrEqual_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__CompareLessThanOrEqual_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqual_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThanOrEqual_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThanOrEqual_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareLessThanOrEqual_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__CompareLessThanOrEqual_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareLessThanOrEqual), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareLessThanOrEqual)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
