...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToPositiveInfinity_Vector128_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single testClass)
            {
                var result = AdvSimd.RoundToPositiveInfinity(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single testClass)
            {
                fixed (Vector128<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.RoundToPositiveInfinity(
        ...
        static SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector128<Single>, byte>(ref _clsVar1), ref Unsafe.As<Single, byte>(ref _data1[0]), (uint)Unsafe.SizeOf<Vector128<Single>>());
        }

        public SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.RoundToPositiveInfinity), new Type[] { typeof(Vector128<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.RoundToPositiveInfinity(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Single();
            var result = AdvSimd.RoundToPositiveInfinity(test._fld1);
