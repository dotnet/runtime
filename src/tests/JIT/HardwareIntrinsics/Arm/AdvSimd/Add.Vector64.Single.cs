...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Add_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__Add_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__Add_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Add_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__Add_Vector64_Single testClass)
            {
        ...
        static SimpleBinaryOpTest__Add_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleBinaryOpTest__Add_Vector64_Single()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.Add(left[i], right[i])) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
