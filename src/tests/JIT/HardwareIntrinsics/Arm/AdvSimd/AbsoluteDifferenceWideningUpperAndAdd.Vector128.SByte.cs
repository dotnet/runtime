...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte()
        {
            var test = new SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte testClass)
            {
                var result = AdvSimd.AbsoluteDifferenceWideningUpperAndAdd(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte testClass)
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)
                fixed (Vector128<SByte>* pFld2 = &_fld2)
                fixed (Vector128<SByte>* pFld3 = &_fld3)
                {
                    var result = AdvSimd.AbsoluteDifferenceWideningUpperAndAdd(
        ...
        static SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifferenceWideningUpperAndAdd), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<SByte>), typeof(Vector128<SByte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AbsoluteDifferenceWideningUpperAndAdd(op1, op2, op3);
        ...
        private void ValidateResult(Int16[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.AbsoluteDifferenceWideningUpperAndAdd(firstOp, secondOp, thirdOp, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningUpperAndAdd)}<Int16>(Vector128<Int16>, Vector128<SByte>, Vector128<SByte>): {method} failed:");
