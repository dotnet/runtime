...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWidening_Vector128_Int16()
        {
            var test = new SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16 testClass)
            {
        ...
        static SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWidening), new Type[] { typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<Int32>(Vector128<Int16>): {method} failed:");
