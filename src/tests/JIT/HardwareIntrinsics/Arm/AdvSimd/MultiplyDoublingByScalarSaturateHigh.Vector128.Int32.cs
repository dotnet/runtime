...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyDoublingByScalarSaturateHigh_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector128_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingByScalarSaturateHigh), new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingByScalarSaturateHigh)}<Int32>(Vector128<Int32>, Vector64<Int32>): {method} failed:");
