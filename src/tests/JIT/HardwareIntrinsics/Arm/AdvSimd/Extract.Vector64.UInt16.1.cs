...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void Extract_Vector64_UInt16_1()
        {
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_UInt16_1
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector64<UInt16>), typeof(byte) })
        ...
        private void ValidateResult(Vector64<UInt16> op1, UInt16 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<UInt16>, 1): {method} failed:");
