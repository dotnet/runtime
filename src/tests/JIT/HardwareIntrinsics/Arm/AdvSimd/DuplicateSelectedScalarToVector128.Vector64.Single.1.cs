...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void DuplicateSelectedScalarToVector128_Vector64_Single_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector64_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector64<Single>, byte>(ref testStruct._fld), ref Unsafe.As<Single, byte>(ref _data[0]), (uint)Unsafe.SizeOf<Vector64<Single>>());
            ...
            public void RunStructFldScenario_Load(ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector64_Single_1 testClass)
            {
                fixed (Vector64<Single>* pFld = &_fld)
                {
                    var result = AdvSimd.DuplicateSelectedScalarToVector128(
                        AdvSimd.LoadVector64((Single*)(pFld)),
                        1
                    );
        ...
        private static Vector64<Single> _clsVar;

        private Vector64<Single> _fld;
        ...
        public ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector64_Single_1()
        {
            ...
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector64<Single>, byte>(ref _fld), ref Unsafe.As<Single, byte>(ref _data[0]), (uint)Unsafe.SizeOf<Vector64<Single>>());
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector128(
                Unsafe.Read<Vector64<Single>>(_dataTable.inArrayPtr),
                1
            );
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector128(
                AdvSimd.LoadVector64((Single*)(_dataTable.inArrayPtr)),
                1
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.DuplicateSelectedScalarToVector128), new Type[] { typeof(Vector64<Single>), typeof(byte) })
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Single>* pClsVar = &_clsVar)
            {
                var result = AdvSimd.DuplicateSelectedScalarToVector128(
                    AdvSimd.LoadVector64((Single*)(pClsVar)),
                    1
                );
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var firstOp = Unsafe.Read<Vector64<Single>>(_dataTable.inArrayPtr);
        ...
        public void RunLclVarScenario_Load()
        {
            ...
            var firstOp = AdvSimd.LoadVector64((Single*)(_dataTable.inArrayPtr));
            var result = AdvSimd.DuplicateSelectedScalarToVector128(firstOp, 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.DuplicateSelectedScalarToVector128(
                AdvSimd.LoadVector64((Single*)(&test._fld)),
                1
            );
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector128)}<Single>(Vector64<Single>, 1): {method} failed:");
