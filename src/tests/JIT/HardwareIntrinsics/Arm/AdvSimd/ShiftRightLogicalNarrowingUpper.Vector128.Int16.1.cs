...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalNarrowingUpper_Vector128_Int16_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalNarrowingUpper_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__ShiftRightLogicalNarrowingUpper_Vector128_Int16_1 testClass)
            {
        ...
        static ImmBinaryOpTest__ShiftRightLogicalNarrowingUpper_Vector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ImmBinaryOpTest__ShiftRightLogicalNarrowingUpper_Vector128_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightLogicalNarrowingUpper), new Type[] { typeof(Vector64<Int16>), typeof(Vector128<Int32>), typeof(byte) })
        ...
        private void ValidateResult(Vector64<Int16> firstOp, Vector128<Int32> secondOp, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] firstOp, Int32[] secondOp, Int16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
