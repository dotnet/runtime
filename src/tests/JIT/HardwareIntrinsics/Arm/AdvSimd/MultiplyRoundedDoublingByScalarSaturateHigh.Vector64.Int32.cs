...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
