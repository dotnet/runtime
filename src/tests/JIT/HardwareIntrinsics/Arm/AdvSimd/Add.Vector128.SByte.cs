...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Add_Vector128_SByte()
        {
            var test = new SimpleBinaryOpTest__Add_Vector128_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__Add_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Add_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__Add_Vector128_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__Add_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__Add_Vector128_SByte()
        {
            Succeeded = true;
