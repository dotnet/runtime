...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void AddPairwiseWidening_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWidening), new Type[] { typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Byte[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<UInt16>(Vector64<Byte>): {method} failed:");
