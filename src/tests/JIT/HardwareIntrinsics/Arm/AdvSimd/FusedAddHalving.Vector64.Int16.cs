...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void FusedAddHalving_Vector64_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedAddHalving_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__FusedAddHalving_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__FusedAddHalving_Vector64_Int16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.FusedAddHalving), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedAddHalving)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
