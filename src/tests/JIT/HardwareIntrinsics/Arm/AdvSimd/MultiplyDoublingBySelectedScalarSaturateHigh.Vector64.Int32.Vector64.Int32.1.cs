...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1()
        {
            var test = new ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1 testClass)
            {
        ...
        static ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingBySelectedScalarSaturateHigh), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>), typeof(byte) })
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingBySelectedScalarSaturateHigh)}<Int32>(Vector64<Int32>, Vector64<Int32>, 1): {method} failed:");
