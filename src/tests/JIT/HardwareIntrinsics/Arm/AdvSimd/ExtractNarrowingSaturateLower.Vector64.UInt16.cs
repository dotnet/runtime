...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void ExtractNarrowingSaturateLower_Vector64_UInt16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateLower), new Type[] { typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateLower)}<UInt16>(Vector128<UInt32>): {method} failed:");
