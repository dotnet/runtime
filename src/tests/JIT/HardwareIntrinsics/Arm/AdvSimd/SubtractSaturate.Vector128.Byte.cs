...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractSaturate_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte testClass)
            {
                var result = AdvSimd.SubtractSaturate(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractSaturate), new Type[] { typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SubtractSaturate(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__SubtractSaturate_Vector128_Byte();
            var result = AdvSimd.SubtractSaturate(test._fld1, test._fld2);
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.SubtractSaturate(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractSaturate)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:");
