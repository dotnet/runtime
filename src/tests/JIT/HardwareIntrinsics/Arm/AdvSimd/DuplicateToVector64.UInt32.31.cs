...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void DuplicateToVector64_UInt32_31()
        {
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_UInt32_31
    {
        ...
        private void ValidateResult(UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<UInt32>(31): {method} failed:");
