...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void DuplicateToVector128_UInt32()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector128_UInt32 testClass)
            {
        ...
        private void ValidateResult(UInt32 data, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<UInt32>(UInt32): DuplicateToVector128 failed:");
