...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWidening_Vector64_Int16()
        {
            var test = new SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16
    {
        private struct DataTable
        {
            ...
            public DataTable(Int16[] inArray1, Int32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16 testClass)
            {
        ...
        static SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWidening), new Type[] { typeof(Vector64<Int16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AddPairwiseWidening(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16();
            var result = AdvSimd.AddPairwiseWidening(test._fld1);
        ...
        private void ValidateResult(Int16[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.AddPairwiseWidening(firstOp, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<Int32>(Vector64<Int16>): {method} failed:");
