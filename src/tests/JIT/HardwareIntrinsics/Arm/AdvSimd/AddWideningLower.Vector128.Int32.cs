...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningLower_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__AddWideningLower_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddWideningLower_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddWideningLower_Vector128_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddWideningLower), new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int32[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<Int32>(Vector128<Int32>, Vector64<Int16>): {method} failed:");
