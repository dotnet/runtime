...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddRoundedHighNarrowingUpper_Vector128_Int32()
        {
            var test = new SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_Int32 testClass)
            {
        ...
        public SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddRoundedHighNarrowingUpper), new Type[] { typeof(Vector64<Int32>), typeof(Vector128<Int64>), typeof(Vector128<Int64>) })
        ...
        private void ValidateResult(Int32[] firstOp, Int64[] secondOp, Int64[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingUpper)}<Int32>(Vector64<Int32>, Vector128<Int64>, Vector128<Int64>): {method} failed:");
