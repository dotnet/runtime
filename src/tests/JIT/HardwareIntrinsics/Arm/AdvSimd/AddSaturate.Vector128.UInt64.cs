...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_UInt64()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_UInt64 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_UInt64()
        {
            Succeeded = true;
