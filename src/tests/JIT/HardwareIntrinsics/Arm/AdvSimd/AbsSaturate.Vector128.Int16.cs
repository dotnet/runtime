...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsSaturate_Vector128_Int16()
        {
            var test = new SimpleUnaryOpTest__AbsSaturate_Vector128_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturate_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AbsSaturate_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsSaturate_Vector128_Int16 testClass)
            {
        ...
        static SimpleUnaryOpTest__AbsSaturate_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = Int16.MinValue; }
        ...
        public SimpleUnaryOpTest__AbsSaturate_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsSaturate), new Type[] { typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsSaturate)}<Int16>(Vector128<Int16>): {method} failed:");
