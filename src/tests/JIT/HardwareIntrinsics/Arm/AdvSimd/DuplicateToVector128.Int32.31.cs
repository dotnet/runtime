...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_Int32_31()
        {
            var test = new ImmOpTest__DuplicateToVector128_Int32_31();
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_Int32_31
    {
        ...
        public ImmOpTest__DuplicateToVector128_Int32_31()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Int32>(31): {method} failed:");
