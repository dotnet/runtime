...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_Int16()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector128_Int16 testClass)
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector128_Int16()
        {
            _clsVar = TestLibrary.Generator.GetInt16();
        }

        public DuplicateUnaryOpTest__DuplicateToVector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.DuplicateToVector128), new Type[] { typeof(Int16) })
        ...
        private void ValidateResult(Int16 data, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Int16>(Int16): DuplicateToVector128 failed:");
