...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsSaturate_Vector128_Int32()
        {
            var test = new SimpleUnaryOpTest__AbsSaturate_Vector128_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturate_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = Int32.MinValue; }
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AbsSaturate_Vector128_Int32 testClass)
            {
                var result = AdvSimd.AbsSaturate(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsSaturate_Vector128_Int32 testClass)
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.AbsSaturate(
        ...
        static SimpleUnaryOpTest__AbsSaturate_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = Int32.MinValue; }
        ...
        public SimpleUnaryOpTest__AbsSaturate_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsSaturate), new Type[] { typeof(Vector128<Int32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AbsSaturate(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__AbsSaturate_Vector128_Int32();
            var result = AdvSimd.AbsSaturate(test._fld1);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.AbsSaturate(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsSaturate)}<Int32>(Vector128<Int32>): {method} failed:");
