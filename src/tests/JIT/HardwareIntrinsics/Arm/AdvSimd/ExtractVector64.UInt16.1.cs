...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector64_UInt16_1()
        {
            var test = new ExtractVectorTest__ExtractVector64_UInt16_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector64_UInt16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector64_UInt16_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractVectorTest__ExtractVector64_UInt16_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector64_UInt16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public ExtractVectorTest__ExtractVector64_UInt16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractVector64), new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<UInt16>), typeof(byte) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] secondOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector64)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>, 1): {method} failed:");
