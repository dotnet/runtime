...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void SubtractWideningUpper_Vector128_Int16_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int16_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int16_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int16_Vector128_Int16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningUpper), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<Int32>(Vector128<Int16>, Vector128<Int16>): {method} failed:");
