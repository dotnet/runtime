...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void DuplicateToVector128_Byte()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector128_Byte testClass)
            {
        ...
        private void ValidateResult(Byte data, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Byte>(Byte): DuplicateToVector128 failed:");
