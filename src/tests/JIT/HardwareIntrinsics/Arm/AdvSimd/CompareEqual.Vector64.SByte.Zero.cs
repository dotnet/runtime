...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_SByte_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector64<SByte>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero testClass)
            {
        ...
        static ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero()
        {
            Succeeded = true;
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector64<SByte>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector64_SByte_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector64<SByte>.Zero);
        ...
        private void ValidateResult(SByte[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<SByte>(Vector64<SByte>): {method} failed:");
