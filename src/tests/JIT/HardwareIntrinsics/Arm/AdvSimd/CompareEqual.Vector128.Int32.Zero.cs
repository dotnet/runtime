...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector128_Int32_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector128<Int32>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero testClass)
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.CompareEqual(
                        AdvSimd.LoadVector128((Int32*)(pFld1)),
                        Vector128<Int32>.Zero
                    );
        ...
        static ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero()
        {
            Succeeded = true;
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector128<Int32>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector128_Int32_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector128<Int32>.Zero);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<Int32>(Vector128<Int32>): {method} failed:");
