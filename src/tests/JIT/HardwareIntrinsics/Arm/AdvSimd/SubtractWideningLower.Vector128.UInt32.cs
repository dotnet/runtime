...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningLower_Vector128_UInt32()
        {
            var test = new SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningLower), new Type[] { typeof(Vector128<UInt32>), typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(Vector128<UInt32> op1, Vector64<UInt16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] left, UInt16[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<UInt32>(Vector128<UInt32>, Vector64<UInt16>): {method} failed:");
