...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector128_Int16_Zero()
        {
            var test = new ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero();
    ...
    public sealed unsafe class ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero testClass)
            {
                var result = AdvSimd.CompareEqual(_fld1, Vector128<Int16>.Zero);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero testClass)
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.CompareEqual(
                        AdvSimd.LoadVector128((Int16*)(pFld1)),
                        Vector128<Int16>.Zero
                    );
        ...
        static ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero()
        {
            Succeeded = true;
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CompareEqual(op1, Vector128<Int16>.Zero);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ZeroUnOpTest__CompareEqual_Vector128_Int16_Zero();
            var result = AdvSimd.CompareEqual(test._fld1, Vector128<Int16>.Zero);
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<Int16>(Vector128<Int16>): {method} failed:");
