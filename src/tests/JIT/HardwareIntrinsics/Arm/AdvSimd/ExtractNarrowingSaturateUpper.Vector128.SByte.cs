...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void ExtractNarrowingSaturateUpper_Vector128_SByte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_SByte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateUpper), new Type[] { typeof(Vector64<SByte>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(SByte[] left, Int16[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUpper)}<SByte>(Vector64<SByte>, Vector128<Int16>): {method} failed:");
