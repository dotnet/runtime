...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticScalar_Vector64_Int64_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1 testClass)
            {
                var result = AdvSimd.ShiftRightArithmeticScalar(_fld, 1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1 testClass)
            {
                fixed (Vector64<Int64>* pFld = &_fld)
                {
                    var result = AdvSimd.ShiftRightArithmeticScalar(
        ...
        static ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightArithmeticScalar), new Type[] { typeof(Vector64<Int64>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftRightArithmeticScalar(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftRightArithmeticScalar_Vector64_Int64_1();
            var result = AdvSimd.ShiftRightArithmeticScalar(test._fld, 1);
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.ShiftRightArithmetic(firstOp[0], Imm) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticScalar)}<Int64>(Vector64<Int64>, 1): {method} failed:");
