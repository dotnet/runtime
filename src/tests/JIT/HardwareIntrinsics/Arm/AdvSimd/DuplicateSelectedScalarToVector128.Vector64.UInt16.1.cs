...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void DuplicateSelectedScalarToVector128_Vector64_UInt16_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector64_UInt16_1
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.DuplicateSelectedScalarToVector128), new Type[] { typeof(Vector64<UInt16>), typeof(byte) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector128)}<UInt16>(Vector64<UInt16>, 1): {method} failed:");
