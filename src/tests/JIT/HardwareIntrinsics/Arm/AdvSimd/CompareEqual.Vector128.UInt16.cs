...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__CompareEqual_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqual_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareEqual_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareEqual_Vector128_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareEqual_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__CompareEqual_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:");
