...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector64_Int16_3()
        {
            var test = new ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector64_Int16_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector64_Int16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector64_Int16_3 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector64_Int16_3 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingBySelectedScalarSaturateHigh), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>), typeof(byte) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] secondOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingBySelectedScalarSaturateHigh)}<Int16>(Vector64<Int16>, Vector64<Int16>, 3): {method} failed:");
