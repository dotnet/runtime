...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningLowerAndSubtract_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt16[] inArray1, Byte[] inArray2, Byte[] inArray3, UInt16[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningLowerAndSubtract), new Type[] { typeof(Vector128<UInt16>), typeof(Vector64<Byte>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Vector128<UInt16> op1, Vector64<Byte> op2, Vector64<Byte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndSubtract)}<UInt16>(Vector128<UInt16>, Vector64<Byte>, Vector64<Byte>): {method} failed:");
