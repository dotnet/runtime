...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32()
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate), new Type[] { typeof(Vector128<Int64>), typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int64[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate)}<Int64>(Vector128<Int64>, Vector64<Int32>, Vector64<Int32>): {method} failed:");
