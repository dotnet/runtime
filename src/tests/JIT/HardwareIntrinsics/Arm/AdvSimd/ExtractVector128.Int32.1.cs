...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector128_Int32_1()
        {
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector128_Int32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractVectorTest__ExtractVector128_Int32_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector128_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public ExtractVectorTest__ExtractVector128_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractVector128), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>), typeof(byte) })
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Int32>(Vector128<Int32>, Vector128<Int32>, 1): {method} failed:");
