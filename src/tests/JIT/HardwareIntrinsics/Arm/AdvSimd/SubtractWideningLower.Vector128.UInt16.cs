...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void SubtractWideningLower_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningLower), new Type[] { typeof(Vector128<UInt16>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Vector128<UInt16> op1, Vector64<Byte> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] left, Byte[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<UInt16>(Vector128<UInt16>, Vector64<Byte>): {method} failed:");
