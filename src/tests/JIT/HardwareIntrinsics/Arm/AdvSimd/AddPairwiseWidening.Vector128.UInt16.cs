...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWidening_Vector128_UInt16()
        {
            var test = new SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt16 testClass)
            {
        ...
        static SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWidening), new Type[] { typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<UInt32>(Vector128<UInt16>): {method} failed:");
