...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyWideningLowerAndAdd_Vector64_SByte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningLowerAndAdd), new Type[] { typeof(Vector128<Int16>), typeof(Vector64<SByte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(Int16[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndAdd)}<Int16>(Vector128<Int16>, Vector64<SByte>, Vector64<SByte>): {method} failed:");
