...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedAddRoundedHalving_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedAddRoundedHalving_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__FusedAddRoundedHalving_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__FusedAddRoundedHalving_Vector128_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__FusedAddRoundedHalving_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__FusedAddRoundedHalving_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.FusedAddRoundedHalving), new Type[] { typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedAddRoundedHalving)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:");
