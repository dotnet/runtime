...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalSaturate_Vector128_Int32_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1 testClass)
            {
                var result = AdvSimd.ShiftLeftLogicalSaturate(_fld, 1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1 testClass)
            {
                fixed (Vector128<Int32>* pFld = &_fld)
                {
                    var result = AdvSimd.ShiftLeftLogicalSaturate(
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftLeftLogicalSaturate), new Type[] { typeof(Vector128<Int32>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalSaturate(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Int32_1();
            var result = AdvSimd.ShiftLeftLogicalSaturate(test._fld, 1);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.ShiftLeftLogicalSaturate(firstOp[i], Imm) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalSaturate)}<Int32>(Vector128<Int32>, 1): {method} failed:");
