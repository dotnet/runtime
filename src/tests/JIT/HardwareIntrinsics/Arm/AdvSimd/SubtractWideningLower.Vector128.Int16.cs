...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningLower_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningLower), new Type[] { typeof(Vector128<Int16>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(Int16[] left, SByte[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<Int16>(Vector128<Int16>, Vector64<SByte>): {method} failed:");
