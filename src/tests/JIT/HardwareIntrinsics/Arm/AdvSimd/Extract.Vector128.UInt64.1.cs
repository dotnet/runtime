...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void Extract_Vector128_UInt64_1()
        {
    ...
    public sealed unsafe class ExtractTest__Extract_Vector128_UInt64_1
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector128<UInt64>), typeof(byte) })
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector128((UInt64*)pClsVar1), ElementIndex);
        ...
        private void ValidateResult(Vector128<UInt64> op1, UInt64 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector128<UInt64>, 1): {method} failed:");
