...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector128_Int16_1()
        {
            var test = new ExtractVectorTest__ExtractVector128_Int16_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector128_Int16_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractVectorTest__ExtractVector128_Int16_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ExtractVectorTest__ExtractVector128_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractVector128), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<Int16>), typeof(byte) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] secondOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Int16>(Vector128<Int16>, Vector128<Int16>, 1): {method} failed:");
