...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadVector128_Int16()
        {
            var test = new LoadUnaryOpTest__LoadVector128_Int16();
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector128_Int16
    {
        ...
        public LoadUnaryOpTest__LoadVector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.LoadVector128), new Type[] { typeof(Int16*) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector128)}<Int16>(Vector128<Int16>): {method} failed:");
