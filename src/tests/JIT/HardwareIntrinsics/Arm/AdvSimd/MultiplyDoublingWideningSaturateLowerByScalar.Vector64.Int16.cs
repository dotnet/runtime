...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16();
            var result = AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar)}<Int32>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
