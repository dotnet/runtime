...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingUpper_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt16 testClass)
            {
        ...
        public SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingUpper), new Type[] { typeof(Vector64<UInt16>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt16[] left, UInt32[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingUpper)}<UInt16>(Vector64<UInt16>, Vector128<UInt32>): {method} failed:");
