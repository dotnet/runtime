...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpperAndSubtract_Vector128_UInt32()
        {
            var test = new SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_UInt32 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningUpperAndSubtract), new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<UInt32>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt64[] firstOp, UInt32[] secondOp, UInt32[] thirdOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndSubtract)}<UInt64>(Vector128<UInt64>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
