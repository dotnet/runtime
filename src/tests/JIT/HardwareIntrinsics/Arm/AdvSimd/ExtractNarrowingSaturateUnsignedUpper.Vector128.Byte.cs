...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd
{
    ...
    {
        [Fact]
        public static void ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper), new Type[] { typeof(Vector64<Byte>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Vector64<Byte> op1, Vector128<Int16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Byte[] left, Int16[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper)}<Byte>(Vector64<Byte>, Vector128<Int16>): {method} failed:");
