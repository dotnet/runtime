...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingleRoundToOddLower_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single
    {
        private struct DataTable
        {
            ...
            public DataTable(Double[] inArray1, Single[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int64BitsToDouble(0x3FF9E427C7C5260FL); }
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single testClass)
            {
                var result = AdvSimd.Arm64.ConvertToSingleRoundToOddLower(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single testClass)
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.ConvertToSingleRoundToOddLower(
        ...
        static SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int64BitsToDouble(0x3FF9E427C7C5260FL); }
        ...
        public SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToSingleRoundToOddLower), new Type[] { typeof(Vector128<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToSingleRoundToOddLower(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToSingleRoundToOddLower_Vector64_Single();
            var result = AdvSimd.Arm64.ConvertToSingleRoundToOddLower(test._fld1);
        ...
        private void ValidateResult(Double[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (0x3FCF213F != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToSingleRoundToOddLower)}<Single>(Vector128<Double>): {method} failed:");
