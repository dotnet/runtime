...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairVector64NonTemporal_Int64()
        {
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Int64
    {
        ...
        {
            public (Vector64<Int64>,Vector64<Int64>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_Int64 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int64*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector64<Int64>,Vector64<Int64>)>() / sizeof(Int64);
        private static readonly int Op1ElementCount = RetElementCount;

        private static Int64[] _data = new Int64[Op1ElementCount];

        private static (Vector64<Int64>,Vector64<Int64>) _clsVar;

        private (Vector64<Int64>,Vector64<Int64>) _fld;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int64*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            Unsafe.Write(_dataTable.outArrayPtr, ((Vector64<Int64>,Vector64<Int64>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int64*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector64NonTemporal_Int64();
            test._fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int64*)(_dataTable.inArrayPtr));
