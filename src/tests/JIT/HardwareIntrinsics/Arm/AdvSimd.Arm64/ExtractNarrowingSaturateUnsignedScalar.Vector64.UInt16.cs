...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16
    {
        private struct DataTable
        {
            ...
            public DataTable(Int32[] inArray1, UInt16[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16 testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar), new Type[] { typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar)}<UInt16>(Vector64<Int32>): {method} failed:");
