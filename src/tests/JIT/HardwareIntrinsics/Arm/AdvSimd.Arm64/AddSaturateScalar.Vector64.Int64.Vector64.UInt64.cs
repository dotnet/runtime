...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void AddSaturateScalar_Vector64_Int64_Vector64_UInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturateScalar), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<UInt64>) })
        ...
        private void ValidateResult(Vector64<Int64> op1, Vector64<UInt64> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, UInt64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<UInt64>): {method} failed:");
