...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareLessThanOrEqualScalar_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single testClass)
            {
        ...
        static SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AbsoluteCompareLessThanOrEqualScalar), new Type[] { typeof(Vector64<Single>), typeof(Vector64<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareLessThanOrEqualScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Single();
            var result = AdvSimd.Arm64.AbsoluteCompareLessThanOrEqualScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.SingleToInt32Bits(Helpers.AbsoluteCompareLessThanOrEqual(left[0], right[0])) != BitConverter.SingleToInt32Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareLessThanOrEqualScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
