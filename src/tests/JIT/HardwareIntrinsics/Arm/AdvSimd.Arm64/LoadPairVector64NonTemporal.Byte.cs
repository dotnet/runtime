...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairVector64NonTemporal_Byte()
        {
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Byte
    {
        ...
        {
            public (Vector64<Byte>,Vector64<Byte>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_Byte testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Byte*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector64<Byte>,Vector64<Byte>)>() / sizeof(Byte);
        private static readonly int Op1ElementCount = RetElementCount;

        private static Byte[] _data = new Byte[Op1ElementCount];

        private static (Vector64<Byte>,Vector64<Byte>) _clsVar;

        private (Vector64<Byte>,Vector64<Byte>) _fld;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((Byte*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            Unsafe.Write(_dataTable.outArrayPtr, ((Vector64<Byte>,Vector64<Byte>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64NonTemporal((Byte*)(_dataTable.inArrayPtr));
