...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector128_UInt64()
        {
            var test = new StoreBinaryOpTest__StorePair_Vector128_UInt64();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector128_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePair_Vector128_UInt64 testClass)
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public StoreBinaryOpTest__StorePair_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePair), new Type[] { typeof(UInt64*), typeof(Vector128<UInt64>), typeof(Vector128<UInt64>) })
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] secondOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:");
