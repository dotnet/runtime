...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar), new Type[] { typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar)}<Byte>(Vector64<Int16>): {method} failed:");
