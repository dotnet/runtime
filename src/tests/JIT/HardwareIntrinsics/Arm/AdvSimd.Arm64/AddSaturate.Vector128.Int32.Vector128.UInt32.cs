...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void AddSaturate_Vector128_Int32_Vector128_UInt32()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_Int32_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Int32_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_Int32_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_Int32_Vector128_UInt32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_Int32_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_Int32_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(Int32[] left, UInt32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int32>(Vector128<Int32>, Vector128<UInt32>): {method} failed:");
