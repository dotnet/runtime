...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToDouble_Vector128_UInt64()
        {
            var test = new SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64 testClass)
            {
                var result = AdvSimd.Arm64.ConvertToDouble(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64 testClass)
            {
                fixed (Vector128<UInt64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.ConvertToDouble(
        ...
        static SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToDouble), new Type[] { typeof(Vector128<UInt64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToDouble(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToDouble_Vector128_UInt64();
            var result = AdvSimd.Arm64.ConvertToDouble(test._fld1);
        ...
        private void ValidateResult(UInt64[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.DoubleToInt64Bits(Helpers.ConvertToDouble(firstOp[i])) != BitConverter.DoubleToInt64Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToDouble)}<Double>(Vector128<UInt64>): {method} failed:");
