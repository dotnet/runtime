...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector64_UInt16_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<Int16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AddSaturate(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16();
            var result = AdvSimd.Arm64.AddSaturate(test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt16[] left, Int16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<UInt16>(Vector64<UInt16>, Vector64<Int16>): {method} failed:");
