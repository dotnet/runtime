...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_Int16_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(Vector128<Int16> op1, Vector128<UInt16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] left, UInt16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int16>(Vector128<Int16>, Vector128<UInt16>): {method} failed:");
