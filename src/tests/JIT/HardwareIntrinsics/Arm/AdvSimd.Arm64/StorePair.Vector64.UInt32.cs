...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_UInt32()
        {
            var test = new StoreBinaryOpTest__StorePair_Vector64_UInt32();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_UInt32 testClass)
            {
                AdvSimd.Arm64.StorePair((UInt32*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePair_Vector64_UInt32 testClass)
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public StoreBinaryOpTest__StorePair_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePair), new Type[] { typeof(UInt32*), typeof(Vector64<UInt32>), typeof(Vector64<UInt32>) })
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((UInt32*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePair((UInt32*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePair_Vector64_UInt32();
            AdvSimd.Arm64.StorePair((UInt32*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((UInt32*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        private void ValidateResult(Vector64<UInt32> op1, Vector64<UInt32> op2, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt32, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)(RetElementCount * Unsafe.SizeOf<UInt32>()));
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] secondOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
