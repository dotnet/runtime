...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void StorePairNonTemporal_Vector64_UInt16()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt16 testClass)
            {
                AdvSimd.Arm64.StorePairNonTemporal((UInt16*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePairNonTemporal), new Type[] { typeof(UInt16*), typeof(Vector64<UInt16>), typeof(Vector64<UInt16>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt16();
            AdvSimd.Arm64.StorePairNonTemporal((UInt16*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] secondOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
