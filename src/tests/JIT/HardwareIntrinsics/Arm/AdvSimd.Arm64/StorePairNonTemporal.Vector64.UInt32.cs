...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void StorePairNonTemporal_Vector64_UInt32()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePairNonTemporal_Vector64_UInt32 testClass)
            {
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] secondOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
