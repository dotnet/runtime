...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void ShiftRightLogicalRoundedNarrowingSaturateScalar_Vector64_UInt16_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalRoundedNarrowingSaturateScalar_Vector64_UInt16_1
    {
        ...
        private void ValidateResult(UInt32[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftRightLogicalRoundedNarrowingSaturateScalar)}<UInt16>(Vector64<UInt32>, 5): {method} failed:");
