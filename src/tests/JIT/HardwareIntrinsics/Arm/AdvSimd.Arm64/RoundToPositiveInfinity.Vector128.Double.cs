...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToPositiveInfinity_Vector128_Double()
        {
            var test = new SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double testClass)
            {
                var result = AdvSimd.Arm64.RoundToPositiveInfinity(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double testClass)
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.RoundToPositiveInfinity(
        ...
        static SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.RoundToPositiveInfinity), new Type[] { typeof(Vector128<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.RoundToPositiveInfinity(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundToPositiveInfinity_Vector128_Double();
            var result = AdvSimd.Arm64.RoundToPositiveInfinity(test._fld1);
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.DoubleToInt64Bits(Helpers.RoundToPositiveInfinity(firstOp[i])) != BitConverter.DoubleToInt64Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.RoundToPositiveInfinity)}<Double>(Vector128<Double>): {method} failed:");
