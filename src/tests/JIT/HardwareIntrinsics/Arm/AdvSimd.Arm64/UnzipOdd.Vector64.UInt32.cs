...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void UnzipOdd_Vector64_UInt32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__UnzipOdd_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__UnzipOdd_Vector64_UInt32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.UnzipOdd), new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.UnzipOdd)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
