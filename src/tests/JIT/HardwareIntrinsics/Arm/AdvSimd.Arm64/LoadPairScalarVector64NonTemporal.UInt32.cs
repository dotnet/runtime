...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairScalarVector64NonTemporal_UInt32()
        {
    ...
    public sealed unsafe class LoadPairScalarVector64NonTemporal_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                _fld = AdvSimd.Arm64.LoadPairScalarVector64NonTemporal((UInt32*)(testClass._dataTable.inArrayPtr));
        ...
        public LoadPairScalarVector64NonTemporal_UInt32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairScalarVector64NonTemporal((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairScalarVector64NonTemporal), new Type[] { typeof(UInt32*) })
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairScalarVector64NonTemporal((UInt32*)(_dataTable.inArrayPtr));
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairScalarVector64NonTemporal)}<UInt32>(Vector64<UInt32>): {method} failed:");
