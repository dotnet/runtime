...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadPairVector128NonTemporal_UInt16
    {
        ...
        {
            public (Vector128<UInt16>,Vector128<UInt16>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector128NonTemporal_UInt16 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt16*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector128<UInt16>,Vector128<UInt16>)>() / sizeof(UInt16);
        private static readonly int Op1ElementCount = RetElementCount;

        private static UInt16[] _data = new UInt16[Op1ElementCount];

        private static (Vector128<UInt16>,Vector128<UInt16>) _clsVar;

        private (Vector128<UInt16>,Vector128<UInt16>) _fld;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt16*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            Unsafe.Write(_dataTable.outArrayPtr, ((Vector128<UInt16>,Vector128<UInt16>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt16*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector128NonTemporal_UInt16();
            test._fld = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt16*)(_dataTable.inArrayPtr));
