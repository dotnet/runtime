...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128NonTemporal_UInt16()
        {
            var test = new LoadPairVector128NonTemporal_UInt16();
    ...
    public sealed unsafe class LoadPairVector128NonTemporal_UInt16
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt16[] inArray1, UInt16[] outArray1, UInt16[] outArray2, int alignment)
            {
                int sizeOfinArray1  = inArray1.Length * Unsafe.SizeOf<UInt16>();
                int sizeOfoutArray1 = outArray1.Length * Unsafe.SizeOf<UInt16>();
                int sizeOfoutArray2 = outArray2.Length * Unsafe.SizeOf<UInt16>();
        ...
        private static readonly int Ret1ElementCount = Unsafe.SizeOf<Vector128<UInt16>>() / sizeof(UInt16);
        private static readonly int Ret2ElementCount = Unsafe.SizeOf<Vector128<UInt16>>() / sizeof(UInt16);
        ...
        public LoadPairVector128NonTemporal_UInt16()
        {
            Succeeded = true;

            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetUInt16(); }
            _dataTable = new DataTable(_data, new UInt16[Ret1ElementCount], new UInt16[Ret2ElementCount], LargestVectorSize);
        }
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var (value1, value2) = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt16*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128NonTemporal), new Type[] { typeof(UInt16*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArray1Ptr, typeof(UInt16*))
                                     });

            var (value1, value2) = ((Vector128<UInt16>, Vector128<UInt16>))result;
        ...
        private void ValidateResult(void* firstOp, void* result1, void* result2, [CallerMemberName] string method = "")
        {
            ...
            UInt16[] outArray1 = new UInt16[Ret1ElementCount];
            UInt16[] outArray2 = new UInt16[Ret2ElementCount];
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt16, byte>(ref outArray1[0]), ref Unsafe.AsRef<byte>(result1), (uint)Unsafe.SizeOf<Vector128<UInt16>>());
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt16, byte>(ref outArray2[0]), ref Unsafe.AsRef<byte>(result2), (uint)Unsafe.SizeOf<Vector128<UInt16>>());

            ValidateResult(inArray, outArray1, outArray2, method);
        }

        private void ValidateResult(UInt16[] firstOp, UInt16[] firstResult, UInt16[] secondResult, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128NonTemporal)}<UInt16>(Vector128<UInt16>): {method} failed:");
