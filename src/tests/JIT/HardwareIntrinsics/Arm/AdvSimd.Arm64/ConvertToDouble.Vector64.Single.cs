...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToDouble_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToDouble_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToDouble_Vector64_Single
    {
        private struct DataTable
        {
            ...
            public DataTable(Single[] inArray1, Double[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToDouble_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToDouble_Vector64_Single testClass)
            {
        ...
        static SimpleUnaryOpTest__ConvertToDouble_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__ConvertToDouble_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToDouble), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToDouble)}<Double>(Vector64<Single>): {method} failed:");
