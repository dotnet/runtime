...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_SByte_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector128<SByte>), typeof(Vector128<Byte>) })
        ...
        private void ValidateResult(Vector128<SByte> op1, Vector128<Byte> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(SByte[] left, Byte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<SByte>(Vector128<SByte>, Vector128<Byte>): {method} failed:");
