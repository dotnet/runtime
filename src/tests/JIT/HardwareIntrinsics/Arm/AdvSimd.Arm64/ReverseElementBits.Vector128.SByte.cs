...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReverseElementBits_Vector128_SByte()
        {
            var test = new SimpleUnaryOpTest__ReverseElementBits_Vector128_SByte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReverseElementBits_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ReverseElementBits_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ReverseElementBits_Vector128_SByte testClass)
            {
        ...
        static SimpleUnaryOpTest__ReverseElementBits_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleUnaryOpTest__ReverseElementBits_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ReverseElementBits), new Type[] { typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(SByte[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReverseElementBits)}<SByte>(Vector128<SByte>): {method} failed:");
