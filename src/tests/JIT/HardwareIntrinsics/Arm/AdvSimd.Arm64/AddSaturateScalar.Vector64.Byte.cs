...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_Byte()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte()
        {
            Succeeded = true;
