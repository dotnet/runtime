...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairScalarVector64_Single()
        {
    ...
    public sealed unsafe class LoadPairScalarVector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            {
                _fld = AdvSimd.Arm64.LoadPairScalarVector64((Single*)(testClass._dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairScalarVector64), new Type[] { typeof(Single*) })
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairScalarVector64)}<Single>(Vector64<Single>): {method} failed:");
