...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairVector128_UInt32()
        {
    ...
    public sealed unsafe class LoadPairVector128_UInt32
    {
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector128<UInt32>,Vector128<UInt32>)>() / sizeof(UInt32);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(UInt32*) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<UInt32>(Vector128<UInt32>): {method} failed:");
