...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_Byte()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePair_Vector64_Byte testClass)
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public StoreBinaryOpTest__StorePair_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePair), new Type[] { typeof(Byte*), typeof(Vector64<Byte>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Byte[] firstOp, Byte[] secondOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:");
