...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairScalarVector64NonTemporal_Single()
        {
    ...
    public sealed unsafe class LoadPairScalarVector64NonTemporal_Single
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var (value1, value2) = AdvSimd.Arm64.LoadPairScalarVector64NonTemporal((Single*)(_dataTable.inArray1Ptr));
        ...
        private void ValidateResult(Single[] firstOp, Single[] firstResult, Single[] secondResult, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.Take(firstOp, 2, i)) != BitConverter.SingleToInt32Bits(Helpers.ConcatScalar(firstResult, secondResult, i)))
                {
                    succeeded = false;
                    break;
                }
