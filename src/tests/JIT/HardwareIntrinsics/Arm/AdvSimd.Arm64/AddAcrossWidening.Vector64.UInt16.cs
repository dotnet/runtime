...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddAcrossWidening_Vector64_UInt16()
        {
            var test = new SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16 testClass)
            {
        ...
        static SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddAcrossWidening), new Type[] { typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddAcrossWidening)}<UInt32>(Vector64<UInt16>): {method} failed:");
