...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void StorePairScalarNonTemporal_Vector64_Single()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single testClass)
            {
                AdvSimd.Arm64.StorePairScalarNonTemporal((Single*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePairScalarNonTemporal), new Type[] { typeof(Single*), typeof(Vector64<Single>), typeof(Vector64<Single>) })
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((Single*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single();
            AdvSimd.Arm64.StorePairScalarNonTemporal((Single*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        private void ValidateResult(Vector64<Single> op1, Vector64<Single> op2, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Single, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)(RetElementCount * Unsafe.SizeOf<Single>()));
        ...
        private void ValidateResult(Single[] firstOp, Single[] secondOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.ConcatScalar(firstOp, secondOp, i)) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairScalarNonTemporal)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
