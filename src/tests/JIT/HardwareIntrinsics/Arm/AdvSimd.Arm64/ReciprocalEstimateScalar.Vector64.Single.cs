...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalEstimateScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single testClass)
            {
                var result = AdvSimd.Arm64.ReciprocalEstimateScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single testClass)
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.ReciprocalEstimateScalar(
        ...
        static SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int32BitsToSingle(0x3e4ed9ed); }
        ...
        public SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ReciprocalEstimateScalar), new Type[] { typeof(Vector64<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalEstimateScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Single();
            var result = AdvSimd.Arm64.ReciprocalEstimateScalar(test._fld1);
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.SingleToInt32Bits(result[0]) != 0x409e8000)
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalEstimateScalar)}<Single>(Vector64<Single>): {method} failed:");
