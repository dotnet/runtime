...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairNonTemporal_Vector128_Double()
        {
            var test = new StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double testClass)
            {
                AdvSimd.Arm64.StorePairNonTemporal((Double*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double testClass)
            {
        ...
        static StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePairNonTemporal), new Type[] { typeof(Double*), typeof(Vector128<Double>), typeof(Vector128<Double>) })
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePairNonTemporal((Double*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePairNonTemporal((Double*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePairNonTemporal_Vector128_Double();
            AdvSimd.Arm64.StorePairNonTemporal((Double*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePairNonTemporal((Double*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        private void ValidateResult(Double[] firstOp, Double[] secondOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:");
