...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32 testClass)
            {
                var result = AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32 testClass)
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)
                fixed (Vector64<Int32>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar(
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int32();
            var result = AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.MultiplyRoundedDoublingSaturateHigh(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
