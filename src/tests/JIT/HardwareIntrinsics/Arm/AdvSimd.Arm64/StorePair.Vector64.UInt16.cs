...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void StorePair_Vector64_UInt16()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePair_Vector64_UInt16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePair), new Type[] { typeof(UInt16*), typeof(Vector64<UInt16>), typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] secondOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
