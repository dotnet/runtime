...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingleRoundToOddUpper_Vector128_Single()
        {
            var test = new SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single
    {
        private struct DataTable
        {
            ...
            public DataTable(Single[] inArray1, Double[] inArray2, Single[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int32BitsToSingle(0x3FCF213E); }
                ...
                for (var i = 0; i < Op2ElementCount; i++) { _data2[i] = BitConverter.Int64BitsToDouble(0x3FF9E427C7C5260FL); }
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single testClass)
            {
                var result = AdvSimd.Arm64.ConvertToSingleRoundToOddUpper(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single testClass)
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                fixed (Vector128<Double>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.Arm64.ConvertToSingleRoundToOddUpper(
        ...
        static SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int32BitsToSingle(0x3FCF213E); }
        ...
        public SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToSingleRoundToOddUpper), new Type[] { typeof(Vector64<Single>), typeof(Vector128<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToSingleRoundToOddUpper(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single();
            var result = AdvSimd.Arm64.ConvertToSingleRoundToOddUpper(test._fld1, test._fld2);
        ...
        private void ValidateResult(Vector64<Single> op1, Vector128<Double> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] left, Double[] right, Single[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;

            for (var i = 0; i < RetElementCount; i++)
            {
                if ((i < 2 ? 0x3FCF213E : 0x3FCF213F) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToSingleRoundToOddUpper)}<Single>(Vector64<Single>, Vector128<Double>): {method} failed:");
