...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar)}<Int64>(Vector64<Double>): {method} failed:");
