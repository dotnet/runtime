...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void ConvertToInt64RoundToPositiveInfinity_Vector128_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinity_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinity_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinity_Vector128_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinity_Vector128_Double testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinity), new Type[] { typeof(Vector128<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinity)}<Int64>(Vector128<Double>): {method} failed:");
