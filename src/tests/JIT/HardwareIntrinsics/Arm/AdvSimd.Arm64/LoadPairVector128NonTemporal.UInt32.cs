...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairVector128NonTemporal_UInt32()
        {
    ...
    public sealed unsafe class LoadPairVector128NonTemporal_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                _fld = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt32*)(testClass._dataTable.inArrayPtr));
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt32*)(_dataTable.inArrayPtr));
