...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void TransposeOdd_Vector128_Single()
        {
            var test = new SimpleBinaryOpTest__TransposeOdd_Vector128_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__TransposeOdd_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__TransposeOdd_Vector128_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__TransposeOdd_Vector128_Single testClass)
            {
        ...
        static SimpleBinaryOpTest__TransposeOdd_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleBinaryOpTest__TransposeOdd_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.TransposeOdd), new Type[] { typeof(Vector128<Single>), typeof(Vector128<Single>) })
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.TransposeOdd)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:");
