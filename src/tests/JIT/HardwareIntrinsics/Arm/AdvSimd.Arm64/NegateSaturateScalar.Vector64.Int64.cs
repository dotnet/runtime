...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void NegateSaturateScalar_Vector64_Int64()
        {
            var test = new SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int64();
    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int64 testClass)
            {
        ...
        static SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = Int64.MinValue; }
        ...
        public SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.NegateSaturateScalar), new Type[] { typeof(Vector64<Int64>) })
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.NegateSaturateScalar)}<Int64>(Vector64<Int64>): {method} failed:");
