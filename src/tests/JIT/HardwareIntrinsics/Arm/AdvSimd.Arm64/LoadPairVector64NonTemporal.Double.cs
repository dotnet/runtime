...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairVector64NonTemporal_Double()
        {
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Double
    {
        ...
        private struct TestStruct
        {
            ...
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Double*)(testClass._dataTable.inArrayPtr));
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((Double*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal), new Type[] { typeof(Double*) })
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<Double>(Vector64<Double>): {method} failed:");
