...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int64 testClass)
            {
                var result = AdvSimd.Arm64.AbsSaturateScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int64 testClass)
            {
        ...
        static SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = Int64.MinValue; }
        ...
        public SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AbsSaturateScalar), new Type[] { typeof(Vector64<Int64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AbsSaturateScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int64();
            var result = AdvSimd.Arm64.AbsSaturateScalar(test._fld1);
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.AbsSaturate(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsSaturateScalar)}<Int64>(Vector64<Int64>): {method} failed:");
