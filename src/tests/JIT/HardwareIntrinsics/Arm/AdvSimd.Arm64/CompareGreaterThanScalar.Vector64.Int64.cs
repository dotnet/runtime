...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void CompareGreaterThanScalar_Vector64_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThanScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareGreaterThanScalar_Vector64_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareGreaterThanScalar_Vector64_Int64 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.CompareGreaterThanScalar), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>) })
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareGreaterThanScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:");
