...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void DuplicateToVector128_UInt64_31()
        {
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_UInt64_31
    {
        ...
        private void ValidateResult(UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateToVector128)}<UInt64>(31): {method} failed:");
