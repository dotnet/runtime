...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64NonTemporal_Int16()
        {
            var test = new LoadPairVector64NonTemporal_Int16();
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Int16
    {
        ...
        {
            public (Vector64<Int16>,Vector64<Int16>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_Int16 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int16*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector64<Int16>,Vector64<Int16>)>() / sizeof(Int16);
        private static readonly int Op1ElementCount = RetElementCount;

        private static Int16[] _data = new Int16[Op1ElementCount];

        private static (Vector64<Int16>,Vector64<Int16>) _clsVar;

        private (Vector64<Int16>,Vector64<Int16>) _fld;

        private DataTable _dataTable;

        public LoadPairVector64NonTemporal_Int16()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int16*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal), new Type[] { typeof(Int16*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArrayPtr, typeof(Int16*))
                                     });

            Unsafe.Write(_dataTable.outArrayPtr, ((Vector64<Int16>,Vector64<Int16>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int16*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector64NonTemporal_Int16();
            test._fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int16*)(_dataTable.inArrayPtr));
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<Int16>(Vector64<Int16>): {method} failed:");
