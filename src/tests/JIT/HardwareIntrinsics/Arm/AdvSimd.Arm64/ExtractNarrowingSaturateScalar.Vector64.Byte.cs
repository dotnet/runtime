...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void ExtractNarrowingSaturateScalar_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ExtractNarrowingSaturateScalar), new Type[] { typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateScalar)}<Byte>(Vector64<UInt16>): {method} failed:");
