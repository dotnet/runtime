...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadPairVector128_Int16
    {
        private struct DataTable
        {
            ...
            public DataTable(Int16[] inArray1, Int16[] outArray1, Int16[] outArray2, int alignment)
            {
                int sizeOfinArray1  = inArray1.Length * Unsafe.SizeOf<Int16>();
                int sizeOfoutArray1 = outArray1.Length * Unsafe.SizeOf<Int16>();
                int sizeOfoutArray2 = outArray2.Length * Unsafe.SizeOf<Int16>();
        ...
        private static readonly int Ret1ElementCount = Unsafe.SizeOf<Vector128<Int16>>() / sizeof(Int16);
        private static readonly int Ret2ElementCount = Unsafe.SizeOf<Vector128<Int16>>() / sizeof(Int16);
        ...
        public LoadPairVector128_Int16()
        {
            ...
            _dataTable = new DataTable(_data, new Int16[Ret1ElementCount], new Int16[Ret2ElementCount], LargestVectorSize);
        }
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var (value1, value2) = AdvSimd.Arm64.LoadPairVector128((Int16*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(Int16*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArray1Ptr, typeof(Int16*))
                                     });

            var (value1, value2) = ((Vector128<Int16>, Vector128<Int16>))result;
        ...
        private void ValidateResult(void* firstOp, void* result1, void* result2, [CallerMemberName] string method = "")
        {
            ...
            Int16[] outArray1 = new Int16[Ret1ElementCount];
            Int16[] outArray2 = new Int16[Ret2ElementCount];
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Int16, byte>(ref outArray1[0]), ref Unsafe.AsRef<byte>(result1), (uint)Unsafe.SizeOf<Vector128<Int16>>());
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Int16, byte>(ref outArray2[0]), ref Unsafe.AsRef<byte>(result2), (uint)Unsafe.SizeOf<Vector128<Int16>>());

            ValidateResult(inArray, outArray1, outArray2, method);
        }

        private void ValidateResult(Int16[] firstOp, Int16[] firstResult, Int16[] secondResult, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<Int16>(Vector128<Int16>): {method} failed:");
