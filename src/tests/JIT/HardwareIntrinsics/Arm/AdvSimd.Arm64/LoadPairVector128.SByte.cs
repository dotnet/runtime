...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadPairVector128_SByte
    {
        ...
        private static readonly int Ret1ElementCount = Unsafe.SizeOf<Vector128<SByte>>() / sizeof(SByte);
        private static readonly int Ret2ElementCount = Unsafe.SizeOf<Vector128<SByte>>() / sizeof(SByte);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var (value1, value2) = AdvSimd.Arm64.LoadPairVector128((SByte*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var (value1, value2) = ((Vector128<SByte>, Vector128<SByte>))result;
        ...
        private void ValidateResult(void* firstOp, void* result1, void* result2, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<SByte, byte>(ref outArray1[0]), ref Unsafe.AsRef<byte>(result1), (uint)Unsafe.SizeOf<Vector128<SByte>>());
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<SByte, byte>(ref outArray2[0]), ref Unsafe.AsRef<byte>(result2), (uint)Unsafe.SizeOf<Vector128<SByte>>());
