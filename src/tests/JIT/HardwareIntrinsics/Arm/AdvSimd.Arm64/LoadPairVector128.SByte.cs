...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128_SByte()
        {
            var test = new LoadPairVector128_SByte();
    ...
    public sealed unsafe class LoadPairVector128_SByte
    {
        ...
        {
            public (Vector128<SByte>,Vector128<SByte>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector128_SByte testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector128((SByte*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector128<SByte>,Vector128<SByte>)>() / sizeof(SByte);
        private static readonly int Op1ElementCount = RetElementCount;

        private static SByte[] _data = new SByte[Op1ElementCount];

        private static (Vector128<SByte>,Vector128<SByte>) _clsVar;

        private (Vector128<SByte>,Vector128<SByte>) _fld;

        private DataTable _dataTable;

        public LoadPairVector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128((SByte*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(SByte*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArrayPtr, typeof(SByte*))
                                     });

            Unsafe.Write(_dataTable.outArrayPtr, ((Vector128<SByte>,Vector128<SByte>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128((SByte*)(_dataTable.inArrayPtr));
        ...
        private void ValidateResult(SByte[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<SByte>(Vector128<SByte>): {method} failed:");
