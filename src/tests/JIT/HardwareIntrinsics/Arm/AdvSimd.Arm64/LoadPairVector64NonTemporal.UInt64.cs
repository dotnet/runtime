...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64NonTemporal_UInt64()
        {
            var test = new LoadPairVector64NonTemporal_UInt64();
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_UInt64
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt64[] inArray1, UInt64[] outArray1, UInt64[] outArray2, int alignment)
            {
                int sizeOfinArray1  = inArray1.Length * Unsafe.SizeOf<UInt64>();
                int sizeOfoutArray1 = outArray1.Length * Unsafe.SizeOf<UInt64>();
                int sizeOfoutArray2 = outArray2.Length * Unsafe.SizeOf<UInt64>();
        ...
        private static readonly int Ret1ElementCount = Unsafe.SizeOf<Vector64<UInt64>>() / sizeof(UInt64);
        private static readonly int Ret2ElementCount = Unsafe.SizeOf<Vector64<UInt64>>() / sizeof(UInt64);
        ...
        public LoadPairVector64NonTemporal_UInt64()
        {
            Succeeded = true;

            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetUInt64(); }
            _dataTable = new DataTable(_data, new UInt64[Ret1ElementCount], new UInt64[Ret2ElementCount], LargestVectorSize);
        }
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var (value1, value2) = AdvSimd.Arm64.LoadPairVector64NonTemporal((UInt64*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal), new Type[] { typeof(UInt64*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArray1Ptr, typeof(UInt64*))
                                     });

            var (value1, value2) = ((Vector64<UInt64>, Vector64<UInt64>))result;
        ...
        private void ValidateResult(void* firstOp, void* result1, void* result2, [CallerMemberName] string method = "")
        {
            ...
            UInt64[] outArray1 = new UInt64[Ret1ElementCount];
            UInt64[] outArray2 = new UInt64[Ret2ElementCount];
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt64, byte>(ref outArray1[0]), ref Unsafe.AsRef<byte>(result1), (uint)Unsafe.SizeOf<Vector64<UInt64>>());
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt64, byte>(ref outArray2[0]), ref Unsafe.AsRef<byte>(result2), (uint)Unsafe.SizeOf<Vector64<UInt64>>());

            ValidateResult(inArray, outArray1, outArray2, method);
        }

        private void ValidateResult(UInt64[] firstOp, UInt64[] firstResult, UInt64[] secondResult, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<UInt64>(Vector64<UInt64>): {method} failed:");
