...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_UInt64 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((UInt64*)(testClass._dataTable.inArrayPtr));
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((UInt64*)(_dataTable.inArrayPtr));
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64NonTemporal((UInt64*)(_dataTable.inArrayPtr));
