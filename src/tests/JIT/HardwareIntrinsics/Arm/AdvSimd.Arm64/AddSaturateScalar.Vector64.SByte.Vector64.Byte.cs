...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_SByte_Vector64_Byte()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturateScalar), new Type[] { typeof(Vector64<SByte>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Vector64<SByte> op1, Vector64<Byte> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(SByte[] left, Byte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<SByte>(Vector64<SByte>, Vector64<Byte>): {method} failed:");
