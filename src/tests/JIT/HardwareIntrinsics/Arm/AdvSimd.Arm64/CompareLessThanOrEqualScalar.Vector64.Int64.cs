...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThanOrEqualScalar_Vector64_Int64()
        {
            var test = new SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Int64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Int64 testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.CompareLessThanOrEqualScalar), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>) })
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareLessThanOrEqualScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:");
