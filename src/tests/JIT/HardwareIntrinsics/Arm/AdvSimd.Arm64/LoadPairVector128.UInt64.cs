...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128_UInt64()
        {
            var test = new LoadPairVector128_UInt64();
    ...
    public sealed unsafe class LoadPairVector128_UInt64
    {
        ...
        {
            public (Vector128<UInt64>,Vector128<UInt64>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector128_UInt64 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector128((UInt64*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector128<UInt64>,Vector128<UInt64>)>() / sizeof(UInt64);
        private static readonly int Op1ElementCount = RetElementCount;

        private static UInt64[] _data = new UInt64[Op1ElementCount];

        private static (Vector128<UInt64>,Vector128<UInt64>) _clsVar;

        private (Vector128<UInt64>,Vector128<UInt64>) _fld;

        private DataTable _dataTable;

        public LoadPairVector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128((UInt64*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(UInt64*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArrayPtr, typeof(UInt64*))
                                     });

            Unsafe.Write(_dataTable.outArrayPtr, ((Vector128<UInt64>,Vector128<UInt64>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128((UInt64*)(_dataTable.inArrayPtr));
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<UInt64>(Vector128<UInt64>): {method} failed:");
