...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void RoundToZero_Vector128_Double()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToZero_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__RoundToZero_Vector128_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToZero_Vector128_Double testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.RoundToZero), new Type[] { typeof(Vector128<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.DoubleToInt64Bits(Helpers.RoundToZero(firstOp[i])) != BitConverter.DoubleToInt64Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.RoundToZero)}<Double>(Vector128<Double>): {method} failed:");
