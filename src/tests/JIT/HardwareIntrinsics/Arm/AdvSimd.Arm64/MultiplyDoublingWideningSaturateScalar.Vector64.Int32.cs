...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateScalar_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int32();
            var result = AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar)}<Int64>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
