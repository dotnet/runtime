...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void StorePairNonTemporal_Vector128_UInt64()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePairNonTemporal), new Type[] { typeof(UInt64*), typeof(Vector128<UInt64>), typeof(Vector128<UInt64>) })
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] secondOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:");
