...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector128_Int64()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector128_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(StoreBinaryOpTest__StorePair_Vector128_Int64 testClass)
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public StoreBinaryOpTest__StorePair_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.StorePair), new Type[] { typeof(Int64*), typeof(Vector128<Int64>), typeof(Vector128<Int64>) })
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] secondOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:");
