...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToDoubleScalar_Vector64_UInt64()
        {
            var test = new SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_UInt64();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_UInt64 testClass)
            {
        ...
        static SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToDoubleScalar), new Type[] { typeof(Vector64<UInt64>) })
        ...
        private void ValidateResult(UInt64[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.ConvertToDouble(firstOp[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToDoubleScalar)}<Double>(Vector64<UInt64>): {method} failed:");
