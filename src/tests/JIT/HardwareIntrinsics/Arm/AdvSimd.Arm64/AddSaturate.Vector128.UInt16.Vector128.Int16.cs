...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_UInt16_Vector128_Int16()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_UInt16_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_UInt16_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_UInt16_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_UInt16_Vector128_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_UInt16_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_UInt16_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(UInt16[] left, Int16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<UInt16>(Vector128<UInt16>, Vector128<Int16>): {method} failed:");
