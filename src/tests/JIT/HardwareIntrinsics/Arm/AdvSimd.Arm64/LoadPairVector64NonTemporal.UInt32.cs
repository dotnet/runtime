...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    {
        [Fact]
        public static void LoadPairVector64NonTemporal_UInt32()
        {
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((UInt32*)(testClass._dataTable.inArrayPtr));
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal), new Type[] { typeof(UInt32*) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<UInt32>(Vector64<UInt32>): {method} failed:");
