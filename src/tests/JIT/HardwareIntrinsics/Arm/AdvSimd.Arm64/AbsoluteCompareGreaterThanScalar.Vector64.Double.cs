...
namespace JIT.HardwareIntrinsics.Arm._AdvSimd.Arm64
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Double testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar), new Type[] { typeof(Vector64<Double>), typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.AbsoluteCompareGreaterThan(left[0], right[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:");
