...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_UInt16_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16_Vector64_Int16
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt16[] inArray1, Int16[] inArray2, UInt16[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturateScalar), new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Vector64<UInt16> op1, Vector64<Int16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] left, Int16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<UInt16>(Vector64<UInt16>, Vector64<Int16>): {method} failed:");
