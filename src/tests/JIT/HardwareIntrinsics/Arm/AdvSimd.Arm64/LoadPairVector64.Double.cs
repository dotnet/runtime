...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64_Double()
        {
            var test = new LoadPairVector64_Double();
    ...
    public sealed unsafe class LoadPairVector64_Double
    {
        ...
        {
            public (Vector64<Double>,Vector64<Double>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector64_Double testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64((Double*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount = Unsafe.SizeOf<(Vector64<Double>,Vector64<Double>)>() / sizeof(Double);
        private static readonly int Op1ElementCount = RetElementCount;

        private static Double[] _data = new Double[Op1ElementCount];

        private static (Vector64<Double>,Vector64<Double>) _clsVar;

        private (Vector64<Double>,Vector64<Double>) _fld;

        private DataTable _dataTable;

        public LoadPairVector64_Double()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64((Double*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64), new Type[] { typeof(Double*) })
                                     .Invoke(null, new object[] {
                                        Pointer.Box(_dataTable.inArrayPtr, typeof(Double*))
                                     });

            Unsafe.Write(_dataTable.outArrayPtr, ((Vector64<Double>,Vector64<Double>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64((Double*)(_dataTable.inArrayPtr));
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64)}<Double>(Vector64<Double>): {method} failed:");
