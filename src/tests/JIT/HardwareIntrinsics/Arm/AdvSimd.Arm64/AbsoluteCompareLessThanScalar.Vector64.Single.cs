...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareLessThanScalar_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Single testClass)
            {
        ...
        static SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AbsoluteCompareLessThanScalar), new Type[] { typeof(Vector64<Single>), typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.SingleToInt32Bits(Helpers.AbsoluteCompareLessThan(left[0], right[0])) != BitConverter.SingleToInt32Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareLessThanScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
