...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingleUpper_Vector128_Single()
        {
            var test = new SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single testClass)
            {
                var result = AdvSimd.Arm64.ConvertToSingleUpper(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single testClass)
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                fixed (Vector128<Double>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.Arm64.ConvertToSingleUpper(
        ...
        static SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToSingleUpper), new Type[] { typeof(Vector64<Single>), typeof(Vector128<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToSingleUpper(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ConvertToSingleUpper_Vector128_Single();
            var result = AdvSimd.Arm64.ConvertToSingleUpper(test._fld1, test._fld2);
        ...
        private void ValidateResult(Single[] left, Double[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (BitConverter.SingleToInt32Bits(Helpers.ConvertToSingleUpper(left, right, i)) != BitConverter.SingleToInt32Bits(result[i]))
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToSingleUpper)}<Single>(Vector64<Single>, Vector128<Double>): {method} failed:");
