...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingZeroCount_Int32()
        {
    ...
    public sealed unsafe class ScalarUnaryOpTest__LeadingZeroCount_Int32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarUnaryOpTest__LeadingZeroCount_Int32 testClass)
            {
        ...
        static ScalarUnaryOpTest__LeadingZeroCount_Int32()
        {
            _clsVar = TestLibrary.Generator.GetInt32();
        }

        public ScalarUnaryOpTest__LeadingZeroCount_Int32()
        {
            Succeeded = true;
