...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3()
        {
            var test = new SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3 testClass)
            {
        ...
        static SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector128_Byte_3()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProductBySelectedQuadruplet), new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<Byte>), typeof(Vector128<Byte>), typeof(byte) })
        ...
        private void ValidateResult(Vector128<UInt32> op1, Vector128<Byte> op2, Vector128<Byte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<UInt32>(Vector128<UInt32>, Vector128<Byte>, Vector128<Byte>): {method} failed:");
