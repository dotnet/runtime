...
namespace JIT.HardwareIntrinsics.Arm._Dp
{
    public static partial class Program
    {
        [Fact]
        public static void DotProduct_Vector128_Int32()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProduct_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__DotProduct_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__DotProduct_Vector128_Int32 testClass)
            {
        ...
        static SimpleTernaryOpTest__DotProduct_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleTernaryOpTest__DotProduct_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProduct), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<SByte>), typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(Vector128<Int32> op1, Vector128<SByte> op2, Vector128<SByte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProduct)}<Int32>(Vector128<Int32>, Vector128<SByte>, Vector128<SByte>): {method} failed:");
