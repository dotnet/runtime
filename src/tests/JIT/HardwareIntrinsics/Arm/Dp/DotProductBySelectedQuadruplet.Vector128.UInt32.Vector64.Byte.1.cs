...
namespace JIT.HardwareIntrinsics.Arm._Dp
{
    ...
    {
        [Fact]
        public static void DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProductBySelectedQuadruplet), new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<Byte>), typeof(Vector64<Byte>), typeof(byte) })
        ...
        private void ValidateResult(Vector128<UInt32> op1, Vector128<Byte> op2, Vector64<Byte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<UInt32>(Vector128<UInt32>, Vector128<Byte>, Vector64<Byte>): {method} failed:");
