...
namespace JIT.HardwareIntrinsics.Arm._Dp
{
    ...
    {
        [Fact]
        public static void DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProductBySelectedQuadruplet), new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<Byte>), typeof(Vector128<Byte>), typeof(byte) })
        ...
        private void ValidateResult(Vector64<UInt32> op1, Vector64<Byte> op2, Vector128<Byte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<UInt32>(Vector64<UInt32>, Vector64<Byte>, Vector128<Byte>): {method} failed:");
