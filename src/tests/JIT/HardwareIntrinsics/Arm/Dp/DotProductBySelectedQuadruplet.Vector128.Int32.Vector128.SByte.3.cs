...
namespace JIT.HardwareIntrinsics.Arm._Dp
{
    ...
    {
        [Fact]
        public static void DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProductBySelectedQuadruplet), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<SByte>), typeof(Vector128<SByte>), typeof(byte) })
        ...
        private void ValidateResult(Int32[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<Int32>(Vector128<Int32>, Vector128<SByte>, Vector128<SByte>): {method} failed:");
