...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16()
        {
            var test = new SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16 testClass)
            {
                var result = Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16 testClass)
            {
                fixed (Vector64<Int16>* pFld1 = &_fld1)
                fixed (Vector64<Int16>* pFld2 = &_fld2)
                fixed (Vector64<Int16>* pFld3 = &_fld3)
                {
                    var result = Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar(
        ...
        static SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm.Arm64).GetMethod(nameof(Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar(op1, op2, op3);
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] secondOp, Int16[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.MultiplyRoundedDoublingAndSubtractSaturateHigh(firstOp[0], secondOp[0], thirdOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Rdm.Arm64)}.{nameof(Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar)}<Int16>(Vector64<Int16>, Vector64<Int16>, Vector64<Int16>): {method} failed:");
