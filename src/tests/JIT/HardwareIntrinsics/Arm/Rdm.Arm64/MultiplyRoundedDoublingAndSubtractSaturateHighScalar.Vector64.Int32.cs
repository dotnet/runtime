...
namespace JIT.HardwareIntrinsics.Arm._Rdm.Arm64
{
    ...
    {
        [Fact]
        public static void MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int32()
        {
            var test = new SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm.Arm64).GetMethod(nameof(Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Rdm.Arm64)}.{nameof(Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar)}<Int32>(Vector64<Int32>, Vector64<Int32>, Vector64<Int32>): {method} failed:");
