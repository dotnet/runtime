...
namespace JIT.HardwareIntrinsics.Arm._Rdm.Arm64
{
    ...
    {
        [Fact]
        public static void MultiplyRoundedDoublingAndAddSaturateHighScalar_Vector64_Int32()
        {
            var test = new SimpleTernaryOpTest__MultiplyRoundedDoublingAndAddSaturateHighScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingAndAddSaturateHighScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyRoundedDoublingAndAddSaturateHighScalar_Vector64_Int32 testClass)
            {
                var result = Rdm.Arm64.MultiplyRoundedDoublingAndAddSaturateHighScalar(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyRoundedDoublingAndAddSaturateHighScalar_Vector64_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm.Arm64).GetMethod(nameof(Rdm.Arm64.MultiplyRoundedDoublingAndAddSaturateHighScalar), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyRoundedDoublingAndAddSaturateHighScalar_Vector64_Int32();
            var result = Rdm.Arm64.MultiplyRoundedDoublingAndAddSaturateHighScalar(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.MultiplyRoundedDoublingAndAddSaturateHigh(firstOp[0], secondOp[0], thirdOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Rdm.Arm64)}.{nameof(Rdm.Arm64.MultiplyRoundedDoublingAndAddSaturateHighScalar)}<Int32>(Vector64<Int32>, Vector64<Int32>, Vector64<Int32>): {method} failed:");
