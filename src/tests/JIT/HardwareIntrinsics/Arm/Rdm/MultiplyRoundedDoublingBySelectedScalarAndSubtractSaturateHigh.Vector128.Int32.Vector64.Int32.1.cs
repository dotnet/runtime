...
namespace JIT.HardwareIntrinsics.Arm._Rdm
{
    ...
    {
        [Fact]
        public static void MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector64_Int32_1()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector64_Int32_1 testClass)
            {
                var result = Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh(_fld1, _fld2, _fld3, 1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector64_Int32_1 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm).GetMethod(nameof(Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>), typeof(Vector64<Int32>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh(op1, op2, op3, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector64_Int32_1();
            var result = Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh(test._fld1, test._fld2, test._fld3, 1);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Rdm)}.{nameof(Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh)}<Int32>(Vector128<Int32>, Vector128<Int32>, Vector64<Int32>): {method} failed:");
