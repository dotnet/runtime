...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void OnesComplementUInt32()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__OnesComplementUInt32
    {
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.OnesComplement)}<UInt32>(Vector64<UInt32>): {method} failed:");
