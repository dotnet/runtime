...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotSingle
    {
        ...
        private void ValidateResult(Vector64<Single> op1, Vector64<Single> op2, Single result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] left, Single[] right, Single result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
