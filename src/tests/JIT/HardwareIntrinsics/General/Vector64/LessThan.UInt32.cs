...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void LessThanUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__LessThanUInt32
    {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.LessThan)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
