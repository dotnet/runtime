...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void OnesComplementInt32()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__OnesComplementInt32
    {
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.OnesComplement)}<Int32>(Vector64<Int32>): {method} failed:");
