...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotUInt32
    {
        ...
        private void ValidateResult(Vector64<UInt32> op1, Vector64<UInt32> op2, UInt32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
