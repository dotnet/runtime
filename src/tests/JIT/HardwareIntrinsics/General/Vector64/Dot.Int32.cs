...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.Dot), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.Dot), 1, new Type[] {
        ...
        private void ValidateResult(Vector64<Int32> op1, Vector64<Int32> op2, Int32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32 result, [CallerMemberName] string method = "")
        {
            ...
            Int32 actualResult = ComputeExpectedResult(left, right);
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
        ...
        private Int32 ComputeExpectedResult(ReadOnlySpan<Int32> left, ReadOnlySpan<Int32> right)
        {
