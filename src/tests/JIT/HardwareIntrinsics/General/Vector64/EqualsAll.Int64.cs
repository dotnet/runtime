...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void EqualsAllInt64()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAllInt64
    {
        ...
        private void ValidateResult(Int64[] left, Int64[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.EqualsAll)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:");
