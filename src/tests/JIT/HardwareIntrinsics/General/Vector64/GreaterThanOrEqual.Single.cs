...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void GreaterThanOrEqualSingle()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__GreaterThanOrEqualSingle
    {
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.GreaterThanOrEqual)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
