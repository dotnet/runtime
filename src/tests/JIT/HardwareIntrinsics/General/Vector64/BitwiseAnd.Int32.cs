...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void BitwiseAndInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseAndInt32
    {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.BitwiseAnd)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
