...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt64
    {
        ...
        private void ValidateResult(Vector64<Int64> op1, Vector64<Int64> op2, Int64 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:");
