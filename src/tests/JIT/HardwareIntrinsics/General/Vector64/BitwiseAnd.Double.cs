...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void BitwiseAndDouble()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseAndDouble
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.BitwiseAnd(_fld1, _fld2);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.BitwiseAnd(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.BitwiseAnd), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.BitwiseAnd), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.BitwiseAnd(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__BitwiseAndDouble();
            var result = Vector64.BitwiseAnd(test._fld1, test._fld2);
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.BitwiseAnd)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:");
