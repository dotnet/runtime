...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void GreaterThanOrEqualAnyUInt16()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__GreaterThanOrEqualAnyUInt16
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.GreaterThanOrEqualAny(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.GreaterThanOrEqualAny), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.GreaterThanOrEqualAny), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.GreaterThanOrEqualAny(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBooleanBinaryOpTest__GreaterThanOrEqualAnyUInt16();
            var result = Vector64.GreaterThanOrEqualAny(test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.GreaterThanOrEqualAny)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
