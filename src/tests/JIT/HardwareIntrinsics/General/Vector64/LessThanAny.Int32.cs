...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void LessThanAnyInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAnyInt32
    {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.LessThanAny)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
