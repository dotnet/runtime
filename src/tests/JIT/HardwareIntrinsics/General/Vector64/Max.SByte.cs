...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    public sealed unsafe class VectorBinaryOpTest__MaxSByte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.Max(_fld1, _fld2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.Max), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.Max), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Max(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__MaxSByte();
            var result = Vector64.Max(test._fld1, test._fld2);
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Max)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:");
