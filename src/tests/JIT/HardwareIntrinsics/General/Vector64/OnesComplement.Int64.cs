...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void OnesComplementInt64()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__OnesComplementInt64
    {
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.OnesComplement)}<Int64>(Vector64<Int64>): {method} failed:");
