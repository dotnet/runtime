...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void OnesComplementSingle()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__OnesComplementSingle
    {
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.OnesComplement)}<Single>(Vector64<Single>): {method} failed:");
