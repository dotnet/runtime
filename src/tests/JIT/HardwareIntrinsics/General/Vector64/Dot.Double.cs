...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotDouble
    {
        ...
        private void ValidateResult(Vector64<Double> op1, Vector64<Double> op2, Double result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Double[] left, Double[] right, Double result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:");
