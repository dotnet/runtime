...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectInt64
    {
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] secondOp, Int64[] thirdOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.ConditionalSelect)}<Int64>(Vector64<Int64>, Vector64<Int64>, Vector64<Int64>): {method} failed:");
