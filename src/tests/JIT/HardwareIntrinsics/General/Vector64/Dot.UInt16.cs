...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotUInt16
    {
        ...
        private void ValidateResult(Vector64<UInt16> op1, Vector64<UInt16> op2, UInt16 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, UInt16 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
