...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotByte
    {
        ...
        private void ValidateResult(Vector64<Byte> op1, Vector64<Byte> op2, Byte result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:");
