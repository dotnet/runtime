...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToUInt32Single
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.ConvertToUInt32(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.ConvertToUInt32(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.ConvertToUInt32), new Type[] {
                typeof(Vector64<Single>)
            });

            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.ConvertToUInt32), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.ConvertToUInt32(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__ConvertToUInt32Single();
            var result = Vector64.ConvertToUInt32(test._fld1);
        ...
        private void ValidateResult(Single[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.ConvertToUInt32)}<UInt32>(Vector64<Single>): {method} failed:");
