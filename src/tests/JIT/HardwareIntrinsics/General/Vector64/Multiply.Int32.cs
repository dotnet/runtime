...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void MultiplyInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__MultiplyInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.Multiply(_fld1, _fld2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.Multiply), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.Multiply), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Multiply(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__MultiplyInt32();
            var result = Vector64.Multiply(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Multiply)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
