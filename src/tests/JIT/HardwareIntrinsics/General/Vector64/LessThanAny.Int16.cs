...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void LessThanAnyInt16()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAnyInt16
    {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.LessThanAny)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
