...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void GreaterThanAllSingle()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__GreaterThanAllSingle
    {
        ...
        private void ValidateResult(Single[] left, Single[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.GreaterThanAll)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
