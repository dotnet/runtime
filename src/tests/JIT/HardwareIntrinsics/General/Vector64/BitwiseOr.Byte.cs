...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void BitwiseOrByte()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseOrByte
    {
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.BitwiseOr)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:");
