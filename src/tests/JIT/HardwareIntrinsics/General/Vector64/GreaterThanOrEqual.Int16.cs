...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void GreaterThanOrEqualInt16()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__GreaterThanOrEqualInt16
    {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.GreaterThanOrEqual)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
