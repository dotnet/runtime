...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void EqualsAllInt16()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAllInt16
    {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.EqualsAll)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
