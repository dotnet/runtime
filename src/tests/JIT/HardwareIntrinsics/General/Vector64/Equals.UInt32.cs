...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void EqualsUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsUInt32
    {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Equals)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
