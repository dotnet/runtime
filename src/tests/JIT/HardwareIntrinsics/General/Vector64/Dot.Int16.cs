...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt16
    {
        ...
        private void ValidateResult(Vector64<Int16> op1, Vector64<Int16> op2, Int16 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:");
