...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void AndNotSingle()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotSingle
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.AndNot(_fld1, _fld2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(nameof(Vector64.AndNot), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector64).GetMethod(nameof(Vector64.AndNot), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.AndNot(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__AndNotSingle();
            var result = Vector64.AndNot(test._fld1, test._fld2);
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.AndNot)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:");
