...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void GreaterThanAnyInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__GreaterThanAnyInt32
    {
        ...
        private void ValidateResult(Vector64<Int32> op1, Vector64<Int32> op2, bool result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.GreaterThanAny)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
