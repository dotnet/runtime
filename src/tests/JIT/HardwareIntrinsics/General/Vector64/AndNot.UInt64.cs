...
namespace JIT.HardwareIntrinsics.General._Vector64
{
    ...
    {
        [Fact]
        public static void AndNotUInt64()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotUInt64
    {
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.{nameof(Vector64.AndNot)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:");
