...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotUInt64
    {
        ...
        private void ValidateResult(Vector128<UInt64> op1, Vector128<UInt64> op2, UInt64 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64 result, [CallerMemberName] string method = "")
        {
            ...
            UInt64 actualResult = ComputeExpectedResult(left, right);
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:");
        ...
        private UInt64 ComputeExpectedResult(ReadOnlySpan<UInt64> left, ReadOnlySpan<UInt64> right)
        {
