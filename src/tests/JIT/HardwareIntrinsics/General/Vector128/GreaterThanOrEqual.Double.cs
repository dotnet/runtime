...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    {
        [Fact]
        public static void GreaterThanOrEqualDouble()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__GreaterThanOrEqualDouble
    {
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.GreaterThanOrEqual)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:");
