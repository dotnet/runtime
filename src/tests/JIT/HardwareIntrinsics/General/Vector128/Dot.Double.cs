...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotDouble
    {
        ...
        private void ValidateResult(Vector128<Double> op1, Vector128<Double> op2, Double result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Double[] left, Double[] right, Double result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:");
