...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAllDouble
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.EqualsAll(_fld1, _fld2);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector128.EqualsAll(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector128).GetMethod(nameof(Vector128.EqualsAll), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector128).GetMethod(nameof(Vector128.EqualsAll), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.EqualsAll(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBooleanBinaryOpTest__EqualsAllDouble();
            var result = Vector128.EqualsAll(test._fld1, test._fld2);
        ...
        private void ValidateResult(Double[] left, Double[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.EqualsAll)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:");
