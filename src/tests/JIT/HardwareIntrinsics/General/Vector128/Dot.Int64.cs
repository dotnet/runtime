...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt64
    {
        ...
        private void ValidateResult(Vector128<Int64> op1, Vector128<Int64> op2, Int64 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:");
