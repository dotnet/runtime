...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt32
    {
        ...
        private void ValidateResult(Vector128<Int32> op1, Vector128<Int32> op2, Int32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:");
