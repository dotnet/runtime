...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    {
        [Fact]
        public static void DivideUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__DivideUInt32
    {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Divide)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
