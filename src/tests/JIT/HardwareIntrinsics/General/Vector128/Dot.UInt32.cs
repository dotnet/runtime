...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotUInt32
    {
        ...
        private void ValidateResult(Vector128<UInt32> op1, Vector128<UInt32> op2, UInt32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
