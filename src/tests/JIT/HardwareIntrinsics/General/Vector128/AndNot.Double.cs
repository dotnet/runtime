...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    {
        [Fact]
        public static void AndNotDouble()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotDouble
    {
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.AndNot)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:");
