...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotByte
    {
        ...
        private void ValidateResult(Vector128<Byte> op1, Vector128<Byte> op2, Byte result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:");
