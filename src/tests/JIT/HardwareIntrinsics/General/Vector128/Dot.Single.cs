...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotSingle
    {
        ...
        private void ValidateResult(Vector128<Single> op1, Vector128<Single> op2, Single result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] left, Single[] right, Single result, [CallerMemberName] string method = "")
        {
            ...
            Single actualResult = ComputeExpectedResult(left, right);
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:");
        ...
        private Single ComputeExpectedResult(ReadOnlySpan<Single> left, ReadOnlySpan<Single> right)
        {
