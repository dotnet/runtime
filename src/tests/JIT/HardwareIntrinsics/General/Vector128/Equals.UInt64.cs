...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    {
        [Fact]
        public static void EqualsUInt64()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector128).GetMethod(nameof(Vector128.Equals), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector128).GetMethod(nameof(Vector128.Equals), 1, new Type[] {
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Equals)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:");
