...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    {
        [Fact]
        public static void EqualsAnyInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAnyInt32
    {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.EqualsAny)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:");
