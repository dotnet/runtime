...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    {
        [Fact]
        public static void BitwiseOrInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseOrInt32
    {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.BitwiseOr)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:");
