...
namespace JIT.HardwareIntrinsics.General._Vector128
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt16
    {
        ...
        private void ValidateResult(Vector128<Int16> op1, Vector128<Int16> op2, Int16 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16 result, [CallerMemberName] string method = "")
        {
            ...
            Int16 actualResult = ComputeExpectedResult(left, right);
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:");
        ...
        private Int16 ComputeExpectedResult(ReadOnlySpan<Int16> left, ReadOnlySpan<Int16> right)
        {
