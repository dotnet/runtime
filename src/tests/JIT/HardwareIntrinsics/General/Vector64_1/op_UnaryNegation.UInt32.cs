...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    {
        [Fact]
        public static void op_UnaryNegationUInt32()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationUInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = -Unsafe.Read<Vector64<UInt32>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<UInt32>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_UnaryNegation<UInt32>(Vector64<UInt32>): {method} failed:");
