...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_InequalityInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr) != Unsafe.Read<Vector64<Int32>>(_dataTable.inArray2Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Int32>).GetMethod("op_Inequality", new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_Inequality<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
