...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_MultiplyInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Int32>).GetMethod("op_Multiply", new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_Multiply<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
