...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_OnesComplementSByte
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = ~Unsafe.Read<Vector64<SByte>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<SByte>).GetMethod("op_OnesComplement", new Type[] { typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(SByte[] firstOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_OnesComplement<SByte>(Vector64<SByte>): {method} failed:");
