...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    {
        [Fact]
        public static void op_ExclusiveOrUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_ExclusiveOrUInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Unsafe.Read<Vector64<UInt32>>(_dataTable.inArray1Ptr) ^ Unsafe.Read<Vector64<UInt32>>(_dataTable.inArray2Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<UInt32>).GetMethod("op_ExclusiveOr", new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_ExclusiveOr<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
