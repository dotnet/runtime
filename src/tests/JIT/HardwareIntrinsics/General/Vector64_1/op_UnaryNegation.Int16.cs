...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationInt16
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = -Unsafe.Read<Vector64<Int16>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Int16>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_UnaryNegation<Int16>(Vector64<Int16>): {method} failed:");
