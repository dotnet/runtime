...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_SubtractionUInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<UInt16>).GetMethod("op_Subtraction", new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_Subtraction<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
