...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_SubtractionByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Byte>).GetMethod("op_Subtraction", new Type[] { typeof(Vector64<Byte>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_Subtraction<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:");
