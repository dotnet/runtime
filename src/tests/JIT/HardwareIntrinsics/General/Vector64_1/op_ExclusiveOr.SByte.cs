...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    {
        [Fact]
        public static void op_ExclusiveOrSByte()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_ExclusiveOrSByte
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Unsafe.Read<Vector64<SByte>>(_dataTable.inArray1Ptr) ^ Unsafe.Read<Vector64<SByte>>(_dataTable.inArray2Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<SByte>).GetMethod("op_ExclusiveOr", new Type[] { typeof(Vector64<SByte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_ExclusiveOr<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:");
