...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Byte>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Byte[] firstOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_UnaryNegation<Byte>(Vector64<Byte>): {method} failed:");
