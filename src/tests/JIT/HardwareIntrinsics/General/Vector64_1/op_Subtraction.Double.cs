...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_SubtractionDouble
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Double>).GetMethod("op_Subtraction", new Type[] { typeof(Vector64<Double>), typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_Subtraction<Double>(Vector64<Double>, Vector64<Double>): {method} failed:");
