...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    {
        [Fact]
        public static void op_InequalityUInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_InequalityUInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<UInt32>).GetMethod("op_Inequality", new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_Inequality<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
