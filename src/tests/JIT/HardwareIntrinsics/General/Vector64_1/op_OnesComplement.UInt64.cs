...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    {
        [Fact]
        public static void op_OnesComplementUInt64()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__op_OnesComplementUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<UInt64>).GetMethod("op_OnesComplement", new Type[] { typeof(Vector64<UInt64>) })
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_OnesComplement<UInt64>(Vector64<UInt64>): {method} failed:");
