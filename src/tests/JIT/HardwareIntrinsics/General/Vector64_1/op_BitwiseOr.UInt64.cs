...
namespace JIT.HardwareIntrinsics.General._Vector64_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseOrUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<UInt64>).GetMethod("op_BitwiseOr", new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<UInt64>) })
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector64)}.op_BitwiseOr<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:");
