...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void EqualsDouble()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsDouble
    {
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Equals)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:");
