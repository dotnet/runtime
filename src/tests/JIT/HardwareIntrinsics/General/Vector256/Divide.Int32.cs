...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void DivideInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__DivideInt32
    {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Divide)}<Int32>(Vector256<Int32>, Vector256<Int32>): {method} failed:");
