...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void AndNotInt16()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotInt16
    {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.AndNot)}<Int16>(Vector256<Int16>, Vector256<Int16>): {method} failed:");
