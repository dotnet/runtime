...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    public sealed unsafe class VectorUnaryOpTest__SqrtInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.Sqrt(_fld1);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.Sqrt), new Type[] {
                typeof(Vector256<Int32>)
            });

            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.Sqrt), 1, new Type[] {
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__SqrtInt32();
            var result = Vector256.Sqrt(test._fld1);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Sqrt)}<Int32>(Vector256<Int32>): {method} failed:");
