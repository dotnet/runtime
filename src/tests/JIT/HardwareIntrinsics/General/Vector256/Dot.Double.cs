...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotDouble
    {
        ...
        private void ValidateResult(Vector256<Double> op1, Vector256<Double> op2, Double result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Double[] left, Double[] right, Double result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:");
