...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void BitwiseAndInt64()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseAndInt64
    {
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.BitwiseAnd)}<Int64>(Vector256<Int64>, Vector256<Int64>): {method} failed:");
