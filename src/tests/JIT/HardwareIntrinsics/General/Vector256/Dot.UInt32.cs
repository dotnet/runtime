...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotUInt32
    {
        ...
        private void ValidateResult(Vector256<UInt32> op1, Vector256<UInt32> op2, UInt32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<UInt32>(Vector256<UInt32>, Vector256<UInt32>): {method} failed:");
