...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotSingle
    {
        ...
        private void ValidateResult(Vector256<Single> op1, Vector256<Single> op2, Single result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] left, Single[] right, Single result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:");
