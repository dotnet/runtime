...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void LessThanAllInt16()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAllInt16
    {
        ...
        private void ValidateResult(Int16[] left, Int16[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.LessThanAll)}<Int16>(Vector256<Int16>, Vector256<Int16>): {method} failed:");
