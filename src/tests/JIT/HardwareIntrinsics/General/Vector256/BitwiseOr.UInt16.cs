...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseOrUInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.BitwiseOr), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.BitwiseOr), 1, new Type[] {
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.BitwiseOr)}<UInt16>(Vector256<UInt16>, Vector256<UInt16>): {method} failed:");
