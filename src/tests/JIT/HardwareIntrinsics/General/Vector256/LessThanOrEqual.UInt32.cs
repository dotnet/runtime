...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void LessThanOrEqualUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__LessThanOrEqualUInt32
    {
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.LessThanOrEqual)}<UInt32>(Vector256<UInt32>, Vector256<UInt32>): {method} failed:");
