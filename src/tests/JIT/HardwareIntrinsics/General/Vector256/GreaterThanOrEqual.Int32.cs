...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void GreaterThanOrEqualInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__GreaterThanOrEqualInt32
    {
        private struct DataTable
        {
            ...
            public DataTable(Int32[] inArray1, Int32[] inArray2, Int32[] outArray, int alignment)
            {
                ...
                if ((alignment != 64 && alignment != 32 && alignment != 16 && alignment != 8) || (alignment * 2) < sizeOfinArray1 || (alignment * 2) < sizeOfinArray2 || (alignment * 2) < sizeOfoutArray)
                {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.GreaterThanOrEqual(_fld1, _fld2);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.GreaterThanOrEqual(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.GreaterThanOrEqual), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.GreaterThanOrEqual), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.GreaterThanOrEqual(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__GreaterThanOrEqualInt32();
            var result = Vector256.GreaterThanOrEqual(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.GreaterThanOrEqual)}<Int32>(Vector256<Int32>, Vector256<Int32>): {method} failed:");
