...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.Dot), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.Dot), 1, new Type[] {
        ...
        private void ValidateResult(Vector256<Int32> op1, Vector256<Int32> op2, Int32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, Int32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<Int32>(Vector256<Int32>, Vector256<Int32>): {method} failed:");
