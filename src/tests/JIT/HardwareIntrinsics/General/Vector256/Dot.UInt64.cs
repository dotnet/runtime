...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotUInt64
    {
        ...
        private void ValidateResult(Vector256<UInt64> op1, Vector256<UInt64> op2, UInt64 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:");
