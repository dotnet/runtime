...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotByte
    {
        ...
        private void ValidateResult(Vector256<Byte> op1, Vector256<Byte> op2, Byte result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<Byte>(Vector256<Byte>, Vector256<Byte>): {method} failed:");
