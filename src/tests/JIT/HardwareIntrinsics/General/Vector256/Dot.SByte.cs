...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotSByte
    {
        ...
        private void ValidateResult(Vector256<SByte> op1, Vector256<SByte> op2, SByte result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<SByte>(Vector256<SByte>, Vector256<SByte>): {method} failed:");
