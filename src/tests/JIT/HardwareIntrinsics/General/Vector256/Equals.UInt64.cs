...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.Equals), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.Equals), 1, new Type[] {
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Equals)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:");
