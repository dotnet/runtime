...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void EqualsAllInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAllInt32
    {
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.EqualsAll)}<Int32>(Vector256<Int32>, Vector256<Int32>): {method} failed:");
