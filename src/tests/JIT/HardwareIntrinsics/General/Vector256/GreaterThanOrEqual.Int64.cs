...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void GreaterThanOrEqualInt64()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__GreaterThanOrEqualInt64
    {
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.GreaterThanOrEqual)}<Int64>(Vector256<Int64>, Vector256<Int64>): {method} failed:");
