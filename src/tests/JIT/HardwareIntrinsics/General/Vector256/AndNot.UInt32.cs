...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void AndNotUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotUInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.AndNot(_fld1, _fld2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.AndNot), new Type[] {
            ...
            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.AndNot), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.AndNot(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__AndNotUInt32();
            var result = Vector256.AndNot(test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.AndNot)}<UInt32>(Vector256<UInt32>, Vector256<UInt32>): {method} failed:");
