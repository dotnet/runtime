...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt64
    {
        ...
        private void ValidateResult(Vector256<Int64> op1, Vector256<Int64> op2, Int64 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Dot)}<Int64>(Vector256<Int64>, Vector256<Int64>): {method} failed:");
