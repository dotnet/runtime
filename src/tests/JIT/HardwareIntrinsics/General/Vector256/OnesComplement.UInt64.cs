...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void OnesComplementUInt64()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__OnesComplementUInt64
    {
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.OnesComplement)}<UInt64>(Vector256<UInt64>): {method} failed:");
