...
namespace JIT.HardwareIntrinsics.General._Vector256
{
    ...
    {
        [Fact]
        public static void CeilingSingle()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__CeilingSingle
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.Ceiling(_fld1);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(nameof(Vector256.Ceiling), new Type[] {
                typeof(Vector256<Single>)
            });

            if (method is null)
            {
                method = typeof(Vector256).GetMethod(nameof(Vector256.Ceiling), 1, new Type[] {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.Ceiling(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__CeilingSingle();
            var result = Vector256.Ceiling(test._fld1);
        ...
        private void ValidateResult(Single[] firstOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.{nameof(Vector256.Ceiling)}<Single>(Vector256<Single>): {method} failed:");
