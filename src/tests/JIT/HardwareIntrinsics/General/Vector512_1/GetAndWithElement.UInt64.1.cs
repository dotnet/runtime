...
namespace JIT.HardwareIntrinsics.General._Vector512_1
{
    ...
    {
        [Fact]
        public static void GetAndWithElementUInt641()
        {
    ...
    public sealed unsafe class VectorGetAndWithElement__GetAndWithElementUInt641
    {
        ...
        public void RunBasicScenario(int imm = 1, bool expectedOutOfRangeException = false)
        {
            ...
            Vector512<UInt64> value = Vector512.Create(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7]);
