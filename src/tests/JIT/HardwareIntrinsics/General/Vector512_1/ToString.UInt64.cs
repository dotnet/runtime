...
namespace JIT.HardwareIntrinsics.General._Vector512_1
{
    ...
    {
        [Fact]
        public unsafe static void ToStringUInt64()
        {
            ...
            Vector512<UInt64> vector = Vector512.Create(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7]);
