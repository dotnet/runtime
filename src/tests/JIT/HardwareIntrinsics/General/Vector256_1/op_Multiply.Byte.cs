...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    {
        [Fact]
        public static void op_MultiplyByte()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_MultiplyByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Byte>).GetMethod("op_Multiply", new Type[] { typeof(Vector256<Byte>), typeof(Vector256<Byte>) })
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Multiply<Byte>(Vector256<Byte>, Vector256<Byte>): {method} failed:");
