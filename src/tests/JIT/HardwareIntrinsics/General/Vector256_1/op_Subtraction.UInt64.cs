...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_SubtractionUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<UInt64>).GetMethod("op_Subtraction", new Type[] { typeof(Vector256<UInt64>), typeof(Vector256<UInt64>) })
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Subtraction<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:");
