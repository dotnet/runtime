...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_MultiplyDouble
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Double>).GetMethod("op_Multiply", new Type[] { typeof(Vector256<Double>), typeof(Vector256<Double>) })
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Multiply<Double>(Vector256<Double>, Vector256<Double>): {method} failed:");
