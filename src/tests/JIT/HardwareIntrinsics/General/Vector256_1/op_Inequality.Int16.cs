...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    {
        [Fact]
        public static void op_InequalityInt16()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_InequalityInt16
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Unsafe.Read<Vector256<Int16>>(_dataTable.inArray1Ptr) != Unsafe.Read<Vector256<Int16>>(_dataTable.inArray2Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Int16>).GetMethod("op_Inequality", new Type[] { typeof(Vector256<Int16>), typeof(Vector256<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Inequality<Int16>(Vector256<Int16>, Vector256<Int16>): {method} failed:");
