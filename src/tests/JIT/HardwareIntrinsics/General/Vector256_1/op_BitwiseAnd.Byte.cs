...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseAndByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Byte>).GetMethod("op_BitwiseAnd", new Type[] { typeof(Vector256<Byte>), typeof(Vector256<Byte>) })
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_BitwiseAnd<Byte>(Vector256<Byte>, Vector256<Byte>): {method} failed:");
