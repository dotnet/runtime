...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<UInt64>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector256<UInt64>) })
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_UnaryNegation<UInt64>(Vector256<UInt64>): {method} failed:");
