...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_SubtractionInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Int16>).GetMethod("op_Subtraction", new Type[] { typeof(Vector256<Int16>), typeof(Vector256<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Subtraction<Int16>(Vector256<Int16>, Vector256<Int16>): {method} failed:");
