...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Int64>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector256<Int64>) })
        ...
        private void ValidateResult(Vector256<Int64> op1, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_UnaryNegation<Int64>(Vector256<Int64>): {method} failed:");
