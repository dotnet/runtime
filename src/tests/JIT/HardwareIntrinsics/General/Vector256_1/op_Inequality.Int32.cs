...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    {
        [Fact]
        public static void op_InequalityInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_InequalityInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Int32>).GetMethod("op_Inequality", new Type[] { typeof(Vector256<Int32>), typeof(Vector256<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Inequality<Int32>(Vector256<Int32>, Vector256<Int32>): {method} failed:");
