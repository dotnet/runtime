...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_ExclusiveOrInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Int64>).GetMethod("op_ExclusiveOr", new Type[] { typeof(Vector256<Int64>), typeof(Vector256<Int64>) })
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_ExclusiveOr<Int64>(Vector256<Int64>, Vector256<Int64>): {method} failed:");
