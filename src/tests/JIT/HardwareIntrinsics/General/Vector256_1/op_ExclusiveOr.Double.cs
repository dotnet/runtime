...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    {
        [Fact]
        public static void op_ExclusiveOrDouble()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_ExclusiveOrDouble
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Double>).GetMethod("op_ExclusiveOr", new Type[] { typeof(Vector256<Double>), typeof(Vector256<Double>) })
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_ExclusiveOr<Double>(Vector256<Double>, Vector256<Double>): {method} failed:");
