...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetUInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector256<UInt64> result = Vector256<UInt64>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector256<UInt64>)
                                .GetProperty(nameof(Vector256<UInt64>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
        ...
        private unsafe void ValidateResult(UInt64[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector256.AllBitsSet(UInt64): {method} failed:");
