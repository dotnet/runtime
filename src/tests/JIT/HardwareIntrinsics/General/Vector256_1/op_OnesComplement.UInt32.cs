...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    {
        [Fact]
        public static void op_OnesComplementUInt32()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__op_OnesComplementUInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = ~Unsafe.Read<Vector256<UInt32>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<UInt32>).GetMethod("op_OnesComplement", new Type[] { typeof(Vector256<UInt32>) })
        ...
        private void ValidateResult(Vector256<UInt32> op1, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_OnesComplement<UInt32>(Vector256<UInt32>): {method} failed:");
