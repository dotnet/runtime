...
namespace JIT.HardwareIntrinsics.General._Vector256_1
{
    ...
    {
        [Fact]
        public static void op_EqualityUInt32()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_EqualityUInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<UInt32>).GetMethod("op_Equality", new Type[] { typeof(Vector256<UInt32>), typeof(Vector256<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector256)}.op_Equality<UInt32>(Vector256<UInt32>, Vector256<UInt32>): {method} failed:");
