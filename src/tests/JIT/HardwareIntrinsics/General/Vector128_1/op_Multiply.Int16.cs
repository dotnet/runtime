...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_MultiplyInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Int16>).GetMethod("op_Multiply", new Type[] { typeof(Vector128<Int16>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Int16[] left, Int16[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_Multiply<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:");
