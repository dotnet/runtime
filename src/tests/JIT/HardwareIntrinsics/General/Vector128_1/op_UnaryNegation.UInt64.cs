...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_UnaryNegationUInt64()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationUInt64
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = -Unsafe.Read<Vector128<UInt64>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<UInt64>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector128<UInt64>) })
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_UnaryNegation<UInt64>(Vector128<UInt64>): {method} failed:");
