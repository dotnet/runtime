...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseAndSByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<SByte>).GetMethod("op_BitwiseAnd", new Type[] { typeof(Vector128<SByte>), typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_BitwiseAnd<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:");
