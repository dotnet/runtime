...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_BitwiseOrInt64()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseOrInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Int64>).GetMethod("op_BitwiseOr", new Type[] { typeof(Vector128<Int64>), typeof(Vector128<Int64>) })
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_BitwiseOr<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:");
