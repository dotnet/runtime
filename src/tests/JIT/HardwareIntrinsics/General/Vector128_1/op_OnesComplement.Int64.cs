...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_OnesComplementInt64()
        {
    ...
    public sealed unsafe class VectorUnaryOpTest__op_OnesComplementInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Int64>).GetMethod("op_OnesComplement", new Type[] { typeof(Vector128<Int64>) })
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_OnesComplement<Int64>(Vector128<Int64>): {method} failed:");
