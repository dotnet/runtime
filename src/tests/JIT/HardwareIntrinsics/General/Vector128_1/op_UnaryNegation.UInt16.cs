...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationUInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<UInt16>).GetMethod("op_UnaryNegation", new Type[] { typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_UnaryNegation<UInt16>(Vector128<UInt16>): {method} failed:");
