...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_ExclusiveOrSingle()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_ExclusiveOrSingle
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Single>).GetMethod("op_ExclusiveOr", new Type[] { typeof(Vector128<Single>), typeof(Vector128<Single>) })
        ...
        private void ValidateResult(Single[] left, Single[] right, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_ExclusiveOr<Single>(Vector128<Single>, Vector128<Single>): {method} failed:");
