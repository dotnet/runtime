...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_EqualityUInt64()
        {
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_EqualityUInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<UInt64>).GetMethod("op_Equality", new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<UInt64>) })
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_Equality<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:");
