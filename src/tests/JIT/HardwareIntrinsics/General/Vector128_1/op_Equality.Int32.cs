...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__op_EqualityInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Int32>).GetMethod("op_Equality", new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, bool result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_Equality<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:");
