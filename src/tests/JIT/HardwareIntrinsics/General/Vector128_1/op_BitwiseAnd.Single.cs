...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_BitwiseAndSingle()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseAndSingle
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Single>).GetMethod("op_BitwiseAnd", new Type[] { typeof(Vector128<Single>), typeof(Vector128<Single>) })
