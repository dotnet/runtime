...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseAndByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<Byte>).GetMethod("op_BitwiseAnd", new Type[] { typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_BitwiseAnd<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:");
