...
namespace JIT.HardwareIntrinsics.General._Vector128_1
{
    ...
    {
        [Fact]
        public static void op_BitwiseOrUInt32()
        {
    ...
    public sealed unsafe class VectorBinaryOpTest__op_BitwiseOrUInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector128<UInt32>).GetMethod("op_BitwiseOr", new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector128)}.op_BitwiseOr<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
