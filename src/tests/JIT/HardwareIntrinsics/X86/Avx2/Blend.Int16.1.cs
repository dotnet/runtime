...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendInt161()
        {
            var test = new ImmBinaryOpTest__BlendInt161();
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendInt161
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__BlendInt161 testClass)
            {
        ...
        static ImmBinaryOpTest__BlendInt161()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ImmBinaryOpTest__BlendInt161()
        {
            Succeeded = true;
