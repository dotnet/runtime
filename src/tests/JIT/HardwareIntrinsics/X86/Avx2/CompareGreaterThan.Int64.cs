...
namespace JIT.HardwareIntrinsics.X86._Avx2
{
    ...
    {
        [Fact]
        public static void CompareGreaterThanInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThanInt64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(nameof(Avx2.CompareGreaterThan), new Type[] { typeof(Vector256<Int64>), typeof(Vector256<Int64>) })
