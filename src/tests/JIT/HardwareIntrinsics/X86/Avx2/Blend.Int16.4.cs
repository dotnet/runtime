...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendInt164()
        {
            var test = new ImmBinaryOpTest__BlendInt164();
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendInt164
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__BlendInt164 testClass)
            {
        ...
        public ImmBinaryOpTest__BlendInt164()
        {
            Succeeded = true;
