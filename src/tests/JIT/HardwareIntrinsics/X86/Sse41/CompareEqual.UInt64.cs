...
namespace JIT.HardwareIntrinsics.X86._Sse41
{
    ...
    {
        [Fact]
        public static void CompareEqualUInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqualUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareEqualUInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareEqualUInt64 testClass)
            {
