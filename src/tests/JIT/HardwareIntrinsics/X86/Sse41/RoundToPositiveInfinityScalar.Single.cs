...
namespace JIT.HardwareIntrinsics.X86._Sse41
{
    ...
    {
        [Fact]
        public static void RoundToPositiveInfinityScalarSingle()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__RoundToPositiveInfinityScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__RoundToPositiveInfinityScalarSingle testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__RoundToPositiveInfinityScalarSingle testClass)
            {
