...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    public static partial class Program
    {
        ...
        [Fact]
        public static void ConvertToVector128Int64Int32()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int64Int32
    {
        ...
        private static readonly int Op1ElementCount = sizeof(Vector128<Int32>) / sizeof(Int32);
        ...
        static SimpleUnaryOpTest__ConvertToVector128Int64Int32()
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector128<Int32>, byte>(ref _clsVar), ref Unsafe.As<Int32, byte>(ref _data[0]), (uint)sizeof(Vector128<Int32>));
        }
        ...
        public SimpleUnaryOpTest__ConvertToVector128Int64Int32()
        {
            ...
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = (int)(random.Next(int.MinValue, int.MaxValue)); }
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector128<Int32>, byte>(ref _fld), ref Unsafe.As<Int32, byte>(ref _data[0]), (uint)sizeof(Vector128<Int32>));
        ...
        private void ValidateResult(void* firstOp, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Int32, byte>(ref inArray[0]), ref Unsafe.AsRef<byte>(firstOp), (uint)sizeof(Vector128<Int32>));
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Int64, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)sizeof(Vector128<Int64>));
