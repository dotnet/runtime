...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToVector128Int32WithTruncationVector128Single()
        {
            var test = new SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single();
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single testClass)
            {
        ...
        static SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single()
        {
            Succeeded = true;
