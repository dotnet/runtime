...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToInt32Vector128Double()
        {
            var test = new SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double testClass)
            {
                var result = Sse2.ConvertToInt32(_fld);
        ...
        static SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ConvertToInt32(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2).GetMethod(nameof(Sse2.ConvertToInt32), new Type[] { typeof(Vector128<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ConvertToInt32(firstOp);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double();
            var result = Sse2.ConvertToInt32(test._fld);
