...
namespace JIT.HardwareIntrinsics.X86._Sse2
{
    ...
    {
        [Fact]
        public static void CompareLessThanSByte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanSByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThanSByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThanSByte testClass)
            {
