...
namespace JIT.HardwareIntrinsics.X86._Sse2
{
    ...
    {
        [Fact]
        public static void ConvertToInt32WithTruncationVector128Double()
        {
            var test = new SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double testClass)
            {
