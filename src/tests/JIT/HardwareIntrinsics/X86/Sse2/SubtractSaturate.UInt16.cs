...
namespace JIT.HardwareIntrinsics.X86._Sse2
{
    ...
    {
        [Fact]
        public static void SubtractSaturateUInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractSaturateUInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractSaturateUInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractSaturateUInt16 testClass)
            {
