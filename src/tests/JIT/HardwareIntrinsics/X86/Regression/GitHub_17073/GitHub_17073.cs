...
public class GitHub_17073
{
    ...
    public static void Test()
    {
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedNotEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedNotEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedNotEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedNotEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedNotEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedNotEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedLessThan_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedLessThan_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThan_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedLessThan_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedLessThan_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThan_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedLessThanOrEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedLessThanOrEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedLessThanOrEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedLessThanOrEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedLessThanOrEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedLessThanOrEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedGreaterThan_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedGreaterThan_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThan_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedGreaterThan_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedGreaterThan_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThan_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarOrderedGreaterThanOrEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarOrderedGreaterThanOrEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedNotEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedNotEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedNotEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedNotEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedNotEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedNotEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedLessThan_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedLessThan_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThan_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedLessThan_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedLessThan_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThan_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedLessThanOrEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedLessThanOrEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedLessThanOrEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedLessThanOrEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedGreaterThan_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedGreaterThan_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThan_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedGreaterThan_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedGreaterThan_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThan_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Normal(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Normal(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_LogicalNot(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(true, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_LogicalNot(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Branch(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Branch(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Branch_Swap(Vector128.Create(42.0f), Vector128<float>.NaN));
        r &= !Sse.IsSupported || Check(false, Test_Sse_CompareScalarUnorderedGreaterThanOrEqual_Branch_Swap(Vector128<float>.NaN, Vector128<float>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Normal(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Normal(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_LogicalNot(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(true, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_LogicalNot(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Branch(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Branch(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        ...
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Branch_Swap(Vector128.Create(42.0), Vector128<double>.NaN));
        r &= !Sse2.IsSupported || Check(false, Test_Sse2_CompareScalarUnorderedGreaterThanOrEqual_Branch_Swap(Vector128<double>.NaN, Vector128<double>.NaN));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestZ_Normal(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestZ_Normal(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestZ_LogicalNot(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestZ_LogicalNot(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestZ_Branch(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestZ_Branch(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestZ_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestZ_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestZ_LogicalNot_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestZ_LogicalNot_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Swap(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Swap(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestC_Normal(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestC_Normal(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestC_LogicalNot(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestC_LogicalNot(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestC_Branch(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestC_Branch(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestC_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestC_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestC_LogicalNot_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestC_LogicalNot_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Normal(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Normal(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Branch(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Branch(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Normal(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Normal(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Branch(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Branch(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Swap(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Swap(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot_Swap(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot_Swap(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestNotZAndNotC_Normal(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestNotZAndNotC_Normal(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestNotZAndNotC_LogicalNot(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestNotZAndNotC_LogicalNot(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestNotZAndNotC_Branch(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestNotZAndNotC_Branch(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestNotZAndNotC_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(false, Test_Sse41_TestNotZAndNotC_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestNotZAndNotC_LogicalNot_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Sse41.IsSupported || Check(true, Test_Sse41_TestNotZAndNotC_LogicalNot_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Swap(Vector128<int>.Zero, Vector128<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Swap(Vector128<int>.One, Vector128.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Swap(Vector256<int>.Zero, Vector256<int>.Zero));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Swap(Vector256<int>.One, Vector256.Create(2)));
        ...
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_Normal(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_LogicalNot(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_Branch(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_Swap(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Branch_Swap(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Branch_Swap(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_LogicalNot_Branch_Swap(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Normal(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_Normal(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_LogicalNot(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Branch(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_Branch(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_Swap(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_Swap(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Branch_Swap(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestZ_LogicalNot_Branch_Swap(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestZ_LogicalNot_Branch_Swap(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Normal(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Normal(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Normal(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Branch(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Branch(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Branch(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Swap(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Swap(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Swap(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot_Branch_Swap(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot_Branch_Swap(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot_Branch_Swap(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Normal(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Normal(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Normal(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Branch(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Branch(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Branch(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Swap(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_Swap(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_Swap(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot_Branch_Swap(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestC_LogicalNot_Branch_Swap(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestC_LogicalNot_Branch_Swap(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Branch_Swap(Vector128<float>.One, Vector128<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Branch_Swap(Vector128<float>.One, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Branch_Swap(Vector128<float>.NegativeOne, Vector128<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Normal(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Branch(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(false, Test_Avx_TestNotZAndNotC_Swap(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Branch_Swap(Vector256<float>.One, Vector256<float>.One));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Branch_Swap(Vector256<float>.One, Vector256<float>.NegativeOne));
        r &= !Avx.IsSupported || Check(true, Test_Avx_TestNotZAndNotC_LogicalNot_Branch_Swap(Vector256<float>.NegativeOne, Vector256<float>.NegativeOne));
        Assert.True(r);
    }
