...
namespace JIT.HardwareIntrinsics.X86._Avx2_Vector128
{
    ...
    {
        [Fact]
        public static void ShiftRightArithmeticVariableInt32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftRightArithmeticVariableInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ShiftRightArithmeticVariableInt32 testClass)
            {
