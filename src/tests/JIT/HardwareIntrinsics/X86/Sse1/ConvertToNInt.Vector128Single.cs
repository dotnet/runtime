...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToNIntVector128Single()
        {
            var test = new SimdScalarUnaryOpConvertTest__ConvertToNIntVector128Single();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToNIntVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimdScalarUnaryOpConvertTest__ConvertToNIntVector128Single testClass)
            {
                var result = Sse.ConvertToNInt(_fld);
        ...
        static SimdScalarUnaryOpConvertTest__ConvertToNIntVector128Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimdScalarUnaryOpConvertTest__ConvertToNIntVector128Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(nameof(Sse.ConvertToNInt), new Type[] { typeof(Vector128<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToNInt(firstOp);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimdScalarUnaryOpConvertTest__ConvertToNIntVector128Single();
            var result = Sse.ConvertToNInt(test._fld);
        ...
        private void ValidateResult(Single[] firstOp, IntPtr result, [CallerMemberName] string method = "")
        {
            ...
            if ((nint)(long)Math.Round(firstOp[0]) != result)
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sse)}.{nameof(Sse.ConvertToNInt)}<IntPtr>(Vector128<Single>): {method} failed:");
