...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToNIntWithTruncationVector128Single()
        {
            var test = new SimdScalarUnaryOpConvertTest__ConvertToNIntWithTruncationVector128Single();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToNIntWithTruncationVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimdScalarUnaryOpConvertTest__ConvertToNIntWithTruncationVector128Single testClass)
            {
                var result = Sse.ConvertToNIntWithTruncation(_fld);
        ...
        static SimdScalarUnaryOpConvertTest__ConvertToNIntWithTruncationVector128Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimdScalarUnaryOpConvertTest__ConvertToNIntWithTruncationVector128Single()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToNIntWithTruncation(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(nameof(Sse.ConvertToNIntWithTruncation), new Type[] { typeof(Vector128<Single>) })
                                     .Invoke(null, new object[] {
                                        Unsafe.Read<Vector128<Single>>(_dataTable.inArrayPtr)
                                     });

            ValidateResult(_dataTable.inArrayPtr, (IntPtr)(result));
        }
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToNIntWithTruncation(firstOp);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimdScalarUnaryOpConvertTest__ConvertToNIntWithTruncationVector128Single();
            var result = Sse.ConvertToNIntWithTruncation(test._fld);
        ...
        private void ValidateResult(Vector128<Single> firstOp, IntPtr result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(void* firstOp, IntPtr result, [CallerMemberName] string method = "")
        {
            Single[] inArray = new Single[Op1ElementCount];
        ...
        private void ValidateResult(Single[] firstOp, IntPtr result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;

            if ((nint) firstOp[0] != result)
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sse)}.{nameof(Sse.ConvertToNIntWithTruncation)}<IntPtr>(Vector128<Single>): {method} failed:");
