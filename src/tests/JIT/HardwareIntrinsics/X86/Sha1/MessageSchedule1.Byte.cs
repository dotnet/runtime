...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__MessageSchedule1Byte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Sha1.MessageSchedule1(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MessageSchedule1Byte testClass)
            {
                ...
                {
                    var result = Sha1.MessageSchedule1(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha1).GetMethod(nameof(Sha1.MessageSchedule1), new Type[] { typeof(Vector128<Byte>), typeof(Vector256<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sha1.MessageSchedule1(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MessageSchedule1Byte();
            var result = Sha1.MessageSchedule1(test._fld1, test._fld2);
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sha1)}.{nameof(Sha1.MessageSchedule1)}<Byte>(Vector128<Byte>, Vector256<Byte>): {method} failed:");
