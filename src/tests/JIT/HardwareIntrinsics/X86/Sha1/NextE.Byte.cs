...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void NextEByte()
        {
            var test = new SimpleBinaryOpTest__NextEByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__NextEByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__NextEByte testClass)
            {
                var result = Sha1.NextE(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__NextEByte testClass)
            {
                fixed (Vector128<Byte>* pFld1 = &_fld1)
                fixed (Vector256<Byte>* pFld2 = &_fld2)
                {
                    var result = Sha1.NextE(
                        Sha1.LoadVector128((Byte*)(pFld1)),
                        Sha1.LoadVector256((Byte*)(pFld2))
                    );
        ...
        static SimpleBinaryOpTest__NextEByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__NextEByte()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sha1.NextE(
                Sha1.LoadVector128((Byte*)(_dataTable.inArray1Ptr)),
                Sha1.LoadVector256((Byte*)(_dataTable.inArray2Ptr))
            );
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Sha1.NextE(
                Sha1.LoadAlignedVector128((Byte*)(_dataTable.inArray1Ptr)),
                Sha1.LoadAlignedVector256((Byte*)(_dataTable.inArray2Ptr))
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha1).GetMethod(nameof(Sha1.NextE), new Type[] { typeof(Vector128<Byte>), typeof(Vector256<Byte>) })
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sha1.NextE(
                    Sha1.LoadVector128((Byte*)(pClsVar1)),
                    Sha1.LoadVector256((Byte*)(pClsVar2))
                );
        ...
        public void RunLclVarScenario_Load()
        {
            ...
            var op1 = Sha1.LoadVector128((Byte*)(_dataTable.inArray1Ptr));
            var op2 = Sha1.LoadVector256((Byte*)(_dataTable.inArray2Ptr));
            var result = Sha1.NextE(op1, op2);
        ...
        public void RunLclVarScenario_LoadAligned()
        {
            ...
            var op1 = Sha1.LoadAlignedVector128((Byte*)(_dataTable.inArray1Ptr));
            var op2 = Sha1.LoadAlignedVector256((Byte*)(_dataTable.inArray2Ptr));
            var result = Sha1.NextE(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__NextEByte();
            var result = Sha1.NextE(test._fld1, test._fld2);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sha1.NextE(
                Sha1.LoadVector128((Byte*)(&test._fld1)),
                Sha1.LoadVector256((Byte*)(&test._fld2))
            );
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sha1)}.{nameof(Sha1.NextE)}<Byte>(Vector128<Byte>, Vector256<Byte>): {method} failed:");
