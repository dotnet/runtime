...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleBinaryOpTest__Sha256TwoRoundsByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__Sha256TwoRoundsByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Sha256TwoRoundsByte testClass)
            {
                var result = Sha.Sha256TwoRounds(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__Sha256TwoRoundsByte testClass)
            {
                fixed (Vector128<Byte>* pFld1 = &_fld1)
                fixed (Vector256<Byte>* pFld2 = &_fld2)
                {
                    var result = Sha.Sha256TwoRounds(
        ...
        static SimpleBinaryOpTest__Sha256TwoRoundsByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__Sha256TwoRoundsByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha).GetMethod(nameof(Sha.Sha256TwoRounds), new Type[] { typeof(Vector128<Byte>), typeof(Vector256<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sha.Sha256TwoRounds(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__Sha256TwoRoundsByte();
            var result = Sha.Sha256TwoRounds(test._fld1, test._fld2);
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sha)}.{nameof(Sha.Sha256TwoRounds)}<Byte>(Vector128<Byte>, Vector256<Byte>): {method} failed:");
