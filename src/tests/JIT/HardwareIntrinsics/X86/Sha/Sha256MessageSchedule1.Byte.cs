...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void Sha256MessageSchedule1Byte()
        {
            var test = new SimpleBinaryOpTest__Sha256MessageSchedule1Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__Sha256MessageSchedule1Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Sha256MessageSchedule1Byte testClass)
            {
                var result = Sha.Sha256MessageSchedule1(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__Sha256MessageSchedule1Byte testClass)
            {
                fixed (Vector128<Byte>* pFld1 = &_fld1)
                fixed (Vector128<Byte>* pFld2 = &_fld2)
                {
                    var result = Sha.Sha256MessageSchedule1(
        ...
        static SimpleBinaryOpTest__Sha256MessageSchedule1Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__Sha256MessageSchedule1Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha).GetMethod(nameof(Sha.Sha256MessageSchedule1), new Type[] { typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sha.Sha256MessageSchedule1(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__Sha256MessageSchedule1Byte();
            var result = Sha.Sha256MessageSchedule1(test._fld1, test._fld2);
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sha)}.{nameof(Sha.Sha256MessageSchedule1)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:");
