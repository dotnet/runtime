...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__Sha256MessageSchedule2Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Sha256MessageSchedule2Byte testClass)
            {
                var result = Sha.Sha256MessageSchedule2(_fld1, _fld2);
        ...
        static SimpleBinaryOpTest__Sha256MessageSchedule2Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__Sha256MessageSchedule2Byte();
            var result = Sha.Sha256MessageSchedule2(test._fld1, test._fld2);
