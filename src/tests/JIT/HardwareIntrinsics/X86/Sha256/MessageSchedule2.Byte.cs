...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__MessageSchedule2Byte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Sha256.MessageSchedule2(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MessageSchedule2Byte testClass)
            {
                ...
                {
                    var result = Sha256.MessageSchedule2(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha256).GetMethod(nameof(Sha256.MessageSchedule2), new Type[] { typeof(Vector128<Byte>), typeof(Vector256<Byte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sha256.MessageSchedule2(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MessageSchedule2Byte();
            var result = Sha256.MessageSchedule2(test._fld1, test._fld2);
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sha256)}.{nameof(Sha256.MessageSchedule2)}<Byte>(Vector128<Byte>, Vector256<Byte>): {method} failed:");
