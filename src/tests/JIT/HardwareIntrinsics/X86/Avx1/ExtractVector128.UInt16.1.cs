...
namespace JIT.HardwareIntrinsics.X86._Avx1
{
    ...
    {
        [Fact]
        public static void ExtractVector128UInt161()
        {
            var test = new ImmUnaryOpTest__ExtractVector128UInt161();
    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128UInt161
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ExtractVector128UInt161 testClass)
            {
        ...
        static ImmUnaryOpTest__ExtractVector128UInt161()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public ImmUnaryOpTest__ExtractVector128UInt161()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.ExtractVector128), new Type[] { typeof(Vector256<UInt16>), typeof(byte) })
