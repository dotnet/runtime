...
namespace JIT.HardwareIntrinsics.X86._Avx1
{
    ...
    {
        [Fact]
        public static void Permute2x128SByte2()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__Permute2x128SByte2
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.Permute2x128), new Type[] { typeof(Vector256<SByte>), typeof(Vector256<SByte>), typeof(byte) })
