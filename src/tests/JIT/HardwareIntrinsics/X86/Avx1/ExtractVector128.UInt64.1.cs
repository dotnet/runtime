...
namespace JIT.HardwareIntrinsics.X86._Avx1
{
    ...
    {
        [Fact]
        public static void ExtractVector128UInt641()
        {
            var test = new ImmUnaryOpTest__ExtractVector128UInt641();
    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128UInt641
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ExtractVector128UInt641 testClass)
            {
        ...
        static ImmUnaryOpTest__ExtractVector128UInt641()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public ImmUnaryOpTest__ExtractVector128UInt641()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.ExtractVector128), new Type[] { typeof(Vector256<UInt64>), typeof(byte) })
