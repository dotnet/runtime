...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int32Double
    {
        ...
        {
            var result = typeof(Avx).GetMethod(nameof(Avx.ConvertToVector128Int32), new Type[] { typeof(Vector256<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!Succeeded)
            {
                Console.WriteLine($"{nameof(Avx)}.{nameof(Avx.ConvertToVector128Int32)}(Vector256<Double>): {method} failed:");
