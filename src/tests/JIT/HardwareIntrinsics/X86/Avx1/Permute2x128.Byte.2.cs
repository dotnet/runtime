...
namespace JIT.HardwareIntrinsics.X86._Avx1
{
    ...
    {
        [Fact]
        public static void Permute2x128Byte2()
        {
            var test = new ImmBinaryOpTest__Permute2x128Byte2();
    ...
    public sealed unsafe class ImmBinaryOpTest__Permute2x128Byte2
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__Permute2x128Byte2 testClass)
            {
        ...
        static ImmBinaryOpTest__Permute2x128Byte2()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public ImmBinaryOpTest__Permute2x128Byte2()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.Permute2x128), new Type[] { typeof(Vector256<Byte>), typeof(Vector256<Byte>), typeof(byte) })
