...
namespace JIT.HardwareIntrinsics.X86._Avx1
{
    ...
    {
        [Fact]
        public static void ExtractVector128SByte1()
        {
            var test = new ImmUnaryOpTest__ExtractVector128SByte1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128SByte1
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ExtractVector128SByte1 testClass)
            {
        ...
        static ImmUnaryOpTest__ExtractVector128SByte1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public ImmUnaryOpTest__ExtractVector128SByte1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.ExtractVector128), new Type[] { typeof(Vector256<SByte>), typeof(byte) })
