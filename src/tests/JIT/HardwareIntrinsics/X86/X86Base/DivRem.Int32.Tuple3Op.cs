...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void DivRemInt32Tuple3Op()
        {
            var test = new ScalarTernOpTupleTest__DivRemInt32();
    ...
    public sealed unsafe class ScalarTernOpTupleTest__DivRemInt32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarTernOpTupleTest__DivRemInt32 testClass)
            {
        ...
        static ScalarTernOpTupleTest__DivRemInt32()
        {
        ...
        public ScalarTernOpTupleTest__DivRemInt32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = X86Base.DivRem(
                ...
                Unsafe.ReadUnaligned<Int32>(ref Unsafe.As<Int32, byte>(ref _data2)),
                Unsafe.ReadUnaligned<Int32>(ref Unsafe.As<Int32, byte>(ref _data3))
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(X86Base).GetMethod(nameof(X86Base.DivRem), new Type[] { typeof(UInt32), typeof(Int32), typeof(Int32) })
            ...
            ValidateResult(_data1, _data2, _data3, ((Int32, Int32))result);
        }
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var data2 = Unsafe.ReadUnaligned<Int32>(ref Unsafe.As<Int32, byte>(ref _data2));
            var data3 = Unsafe.ReadUnaligned<Int32>(ref Unsafe.As<Int32, byte>(ref _data3));
        ...
        private void ValidateResult(UInt32 op1, Int32 op2, Int32 op3, (Int32, Int32) result, [CallerMemberName] string method = "")
        {
            (var ret1, var ret2) = result;
            var isUnexpectedResult = false;

             int expectedQuotient = 0xFFFF;  int expectedReminder = -2; isUnexpectedResult = (expectedQuotient != ret1) || (expectedReminder != ret2);

            if (isUnexpectedResult)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(X86Base)}.{nameof(X86Base.DivRem)}<(Int32, Int32)>(UInt32, Int32, Int32): DivRem failed:");
