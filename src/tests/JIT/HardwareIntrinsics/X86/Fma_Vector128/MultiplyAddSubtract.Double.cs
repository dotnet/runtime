...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void MultiplyAddSubtractDouble()
        {
    ...
    public sealed unsafe class AlternatingTernaryOpTest__MultiplyAddSubtractDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(AlternatingTernaryOpTest__MultiplyAddSubtractDouble testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Fma).GetMethod(nameof(Fma.MultiplyAddSubtract), new Type[] { typeof(Vector128<Double>), typeof(Vector128<Double>), typeof(Vector128<Double>) })
