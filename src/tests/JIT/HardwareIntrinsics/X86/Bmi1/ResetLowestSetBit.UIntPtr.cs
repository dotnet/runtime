...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ResetLowestSetBitUIntPtr()
        {
            var test = new ScalarUnaryOpTest__ResetLowestSetBitUIntPtr();
    ...
    public sealed unsafe class ScalarUnaryOpTest__ResetLowestSetBitUIntPtr
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarUnaryOpTest__ResetLowestSetBitUIntPtr testClass)
            {
        ...
        static ScalarUnaryOpTest__ResetLowestSetBitUIntPtr()
        {
            _clsVar = TestLibrary.Generator.GetUIntPtr();
        }

        public ScalarUnaryOpTest__ResetLowestSetBitUIntPtr()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Bmi1).GetMethod(nameof(Bmi1.ResetLowestSetBit), new Type[] { typeof(UIntPtr) })
        ...
        private void ValidateResult(UIntPtr data, UIntPtr result, [CallerMemberName] string method = "")
        {
            ...
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Bmi1)}.{nameof(Bmi1.ResetLowestSetBit)}<UIntPtr>(UIntPtr): ResetLowestSetBit failed:");
