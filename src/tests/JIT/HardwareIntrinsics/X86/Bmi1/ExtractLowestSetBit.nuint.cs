...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ExtractLowestSetBitnuint()
        {
            var test = new ScalarUnaryOpTest__ExtractLowestSetBitnuint();
    ...
    public sealed unsafe class ScalarUnaryOpTest__ExtractLowestSetBitnuint
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarUnaryOpTest__ExtractLowestSetBitnuint testClass)
            {
        ...
        static ScalarUnaryOpTest__ExtractLowestSetBitnuint()
        {
            _clsVar = TestLibrary.Generator.GetUIntPtr();
        }

        public ScalarUnaryOpTest__ExtractLowestSetBitnuint()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Bmi1).GetMethod(nameof(Bmi1.ExtractLowestSetBit), new Type[] { typeof(nuint) })
        ...
        private void ValidateResult(nuint data, nuint result, [CallerMemberName] string method = "")
        {
            ...
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Bmi1)}.{nameof(Bmi1.ExtractLowestSetBit)}<nuint>(nuint): ExtractLowestSetBit failed:");
