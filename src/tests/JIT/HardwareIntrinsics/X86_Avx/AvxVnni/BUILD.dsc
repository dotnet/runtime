...
@@public
export const jIT_HardwareIntrinsics_X86_Avx_AvxVnni_multiplyWideningAndAdd_r = CoreClr.coreclr_test({
...
@@public
export const jIT_HardwareIntrinsics_X86_Avx_AvxVnni_multiplyWideningAndAdd_ro = CoreClr.coreclr_test({
