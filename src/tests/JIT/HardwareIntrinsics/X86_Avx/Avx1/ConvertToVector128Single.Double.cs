...
namespace JIT.HardwareIntrinsics.X86._Avx1.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128SingleDouble
    {
        ...
        private static readonly int Op1ElementCount = sizeof(Vector256<Double>) / sizeof(Double);
        private static readonly int RetElementCount = sizeof(Vector128<Single>) / sizeof(Single);
        ...
        static SimpleUnaryOpTest__ConvertToVector128SingleDouble()
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector256<Double>, byte>(ref _clsVar), ref Unsafe.As<Double, byte>(ref _data[0]), (uint)sizeof(Vector256<Double>));
        }
        ...
        public SimpleUnaryOpTest__ConvertToVector128SingleDouble()
        {
            ...
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = (double)(random.NextDouble()); }
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Vector256<Double>, byte>(ref _fld), ref Unsafe.As<Double, byte>(ref _data[0]), (uint)sizeof(Vector256<Double>));
        ...
        private void ValidateResult(Vector256<Double> firstOp, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Single, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)sizeof(Vector128<Single>));
        ...
        private void ValidateResult(void* firstOp, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Double, byte>(ref inArray[0]), ref Unsafe.AsRef<byte>(firstOp), (uint)sizeof(Vector256<Double>));
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Single, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)sizeof(Vector128<Single>));
