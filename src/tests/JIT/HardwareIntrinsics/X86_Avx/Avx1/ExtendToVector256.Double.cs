...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class GenericUnaryOpTest__ExtendToVector256Double
    {
        ...
        private static readonly int RetElementCount = sizeof(Vector256<Double>) / sizeof(Double);
        ...
        private void ValidateResult(Vector128<Double> firstOp, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Double, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)sizeof(Vector256<Double>));
