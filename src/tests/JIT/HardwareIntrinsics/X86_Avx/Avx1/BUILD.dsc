...
@@public
export const jIT_HardwareIntrinsics_X86_Avx_Avx1_avx1_handwritten_ro = CoreClr.coreclr_test({
...
@@public
export const jIT_HardwareIntrinsics_X86_Avx_Avx1_avx1_r = CoreClr.coreclr_test({
    name: "Avx1_r",
    srcs: ["Program.Avx1.cs", "//src/tests/JIT/HardwareIntrinsics/X86/Shared:Program.cs"],
});

@@public
export const jIT_HardwareIntrinsics_X86_Avx_Avx1_avx1_ro = CoreClr.coreclr_test({
    name: "Avx1_ro",
    srcs: ["Program.Avx1.cs", "//src/tests/JIT/HardwareIntrinsics/X86/Shared:Program.cs"],
    optimize: true,
});
