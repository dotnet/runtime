...
@@public
export const jIT_HardwareIntrinsics_X86_Avx_Avx2_avx2_handwritten_ro = CoreClr.coreclr_test({
...
@@public
export const jIT_HardwareIntrinsics_X86_Avx_Avx2_avx2_r = CoreClr.coreclr_test({
    name: "Avx2_r",
    srcs: ["Program.Avx2.cs", "//src/tests/JIT/HardwareIntrinsics/X86/Shared:Program.cs"],
});

@@public
export const jIT_HardwareIntrinsics_X86_Avx_Avx2_avx2_ro = CoreClr.coreclr_test({
    name: "Avx2_ro",
    srcs: ["Program.Avx2.cs", "//src/tests/JIT/HardwareIntrinsics/X86/Shared:Program.cs"],
    optimize: true,
});
