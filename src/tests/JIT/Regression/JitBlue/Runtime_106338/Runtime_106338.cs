...
public class Runtime_106338
{
    ...
    public static void TestEntryPoint()
    {
        ...
        if ((RuntimeInformation.ProcessArchitecture == Architecture.Arm64) || (RuntimeInformation.ProcessArchitecture == Architecture.X64) || Avx512DQ.VL.IsSupported || Avx10v1.IsSupported)
        {
