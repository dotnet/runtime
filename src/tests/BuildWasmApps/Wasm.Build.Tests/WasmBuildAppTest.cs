...
{
    public class WasmBuildAppTest : BuildTestBase, IDisposable
    {
        public WasmBuildAppTest(ITestOutputHelper output, SharedBuildClassFixture buildContext) : base(output, buildContext)
        {}
