...
static class Templates
{
    ...
    public static TemplateConfig SveSimpleVecOpDiffRetTypeTest = new TemplateConfig("_SveUnaryOpDifferentRetTypeTestTemplate.template", "Simple", SimpleVecOpTest_ValidationLogicForNarrowing, SimpleVecOpTest_ValidationLogicForCndSelForNarrowing, SimpleVecOpTest_ValidationLogicForCndSelForNarrowing_FalseValue);
