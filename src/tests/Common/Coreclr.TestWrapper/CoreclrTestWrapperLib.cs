...
namespace CoreclrTestLib
{
    ...
    public class CoreclrTestWrapperLib
    {
        ...
        public int RunTest(string executable, string outputFile, string errorFile, string appFilename, string category, string testBinaryBase, string outputDir)
        {
            ...
            using (Process process = new Process())
            {
                ...
                else
                {
                    ...
                    process.StartInfo.EnvironmentVariables.Add("__AppFilename", appFilename);
