...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void AlignRightSByte228()
        {
            var test = new ImmBinaryOpTest__AlignRightSByte228();
    ...
    public sealed unsafe class ImmBinaryOpTest__AlignRightSByte228
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__AlignRightSByte228 testClass)
            {
        ...
        static ImmBinaryOpTest__AlignRightSByte228()
        {
            var random = new Random();
