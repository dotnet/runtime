...
{    
    NSLog(@"Collation GlobalizationNative_CompareStringNative non-default case - %d", (int32_t)comparisonOptions);
    ...
    NSLog(@"Collation GlobalizationNative_CompareStringNative before switch");
    switch (comparisonOptions)
    {
        ...
        default:
            ...
            NSLog(@"Collation GlobalizationNative_CompareStringNative default case - %d", (int32_t)comparisonOptions);
            NSComparisonResult res = [firstString compare:secondString];
            NSLog(@"Collation GlobalizationNative_CompareStringNative default case result is - %d", (int32_t)res);
            return (int32_t)res;
    }
    ...
    NSLog(@"Collation GlobalizationNative_CompareStringNative non-default case - %d", (int32_t)result);

    return result == NSOrderedAscending ? -1 : result == NSOrderedDescending ? 1 : 0;
}
