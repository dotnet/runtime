...
static const Entry s_sysNative[] =
{
    ...
    DllImportEntry(SystemNative_PortCreate)
    DllImportEntry(SystemNative_PortAssociate)
    DllImportEntry(SystemNative_PortDissociate)
    DllImportEntry(SystemNative_PortGet)
    DllImportEntry(SystemNative_PortSend)
