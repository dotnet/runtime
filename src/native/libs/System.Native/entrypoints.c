...
static const Entry s_sysNative[] =
{
    ...
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_Size)
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_Init)
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_Acquire)
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_Release)
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_Destroy)
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_GetOwnerProcessAndThreadId)
    DllImportEntry(SystemNative_LowLevelCrossPlatformMutex_SetOwnerProcessAndThreadId)
