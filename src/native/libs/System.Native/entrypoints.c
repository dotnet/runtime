...
static const Entry s_sysNative[] =
{
    ...
    DllImportEntry(SystemNative_SpawnProcess)
    DllImportEntry(SystemNative_SendSignal)
    DllImportEntry(SystemNative_WaitForExitAndReap)
    DllImportEntry(SystemNative_TryWaitForExit)
    DllImportEntry(SystemNative_TryWaitForExitCancellable)
    DllImportEntry(SystemNative_WaitForExitOrKillOnTimeout)
    DllImportEntry(SystemNative_TryGetExitCode)
