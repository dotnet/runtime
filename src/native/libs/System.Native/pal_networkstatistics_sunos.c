...
// Stub implementations of network statistics functions for SunOS.
// These are currently unimplemented; all APIs return ENOTSUP.
// A future implementation may obtain these using kstats.
