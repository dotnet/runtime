...
static const Entry s_cryptoNative[] =
{
    ...
    DllImportEntry(CryptoNative_SslSetKtls)
    ...
    DllImportEntry(CryptoNative_SslWriteBlocking)
    DllImportEntry(CryptoNative_SslDoHandshakeBlocking)
    DllImportEntry(CryptoNative_SslGetKtlsRecv)
    DllImportEntry(CryptoNative_SslGetKtlsSend)
    DllImportEntry(CryptoNative_SslReadBlocking)
