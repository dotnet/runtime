...
static const Entry s_cryptoNative[] =
{
    ...
    DllImportEntry(CryptoNative_BioGetReplayPrefix)
    ...
    DllImportEntry(CryptoNative_BioPeekTlsFrame)
    ...
    DllImportEntry(CryptoNative_EvpAes128Wrap)
    ...
    DllImportEntry(CryptoNative_EvpAes192Wrap)
    ...
    DllImportEntry(CryptoNative_EvpAes256Wrap)
