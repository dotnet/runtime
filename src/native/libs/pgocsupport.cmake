...
if(NOT WIN32)
  ...
  function(check_have_lto)
    ...
    check_c_source_compiles("int main() { return 0; }" HAVE_LTO)
  endfunction(check_have_lto)
  check_have_lto()

  check_c_compiler_flag(-faligned-new COMPILER_SUPPORTS_F_ALIGNED_NEW)
endif(NOT WIN32)
    ...
    elseif(CLR_CMAKE_PGO_OPTIMIZE)
        ...
        elseif(CMAKE_GENERATOR MATCHES "Visual Studio")
            ...
            if(CLR_CMAKE_HOST_WIN32)
                ...
                if(UPPERCASE_CMAKE_BUILD_TYPE STREQUAL RELEASE OR UPPERCASE_CMAKE_BUILD_TYPE STREQUAL RELWITHDEBINFO)
                    if((CMAKE_C_COMPILER_ID MATCHES "Clang") AND (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 3.6))
                        if(HAVE_LTO)
                    ...
                    else((CMAKE_C_COMPILER_ID MATCHES "Clang") AND (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 3.6))
                        message(WARNING "PGO is not supported; Clang 3.6 or later is required for profile guided optimizations")
                    endif((CMAKE_C_COMPILER_ID MATCHES "Clang") AND (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 3.6))
                endif(UPPERCASE_CMAKE_BUILD_TYPE STREQUAL RELEASE OR UPPERCASE_CMAKE_BUILD_TYPE STREQUAL RELWITHDEBINFO)
            endif(CLR_CMAKE_HOST_WIN32)
