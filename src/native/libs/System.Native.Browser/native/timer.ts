...
import { DOTNET, Module, safeSetTimeout, _SystemJS_ExecuteTimerCallback, _SystemJS_ExecuteBackgroundJobCallback } from "../../Common/JavaScript/cross-linked"; // ensure ambient symbols are declared
