...
if [[ "$__TargetOS" == browser ]]; then
    ...
    __CMakeArgs="-DCLR_CMAKE_TARGET_OS=wasi -DCLR_CMAKE_TARGET_ARCH=wasm -DWASI_SDK_PREFIX=$WASI_SDK22_PATH -DCMAKE_TOOLCHAIN_FILE=${__RepoRootDir}/src/native/external/wasi-sdk-p2.cmake $__CMakeArgs"
