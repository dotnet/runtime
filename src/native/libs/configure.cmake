...
if (CLR_CMAKE_TARGET_OPENBSD OR (CLR_CMAKE_TARGET_LINUX AND NOT CLR_CMAKE_TARGET_ANDROID))
    find_library(LIBUTIL_LIBRARY util)
    if (LIBUTIL_LIBRARY)
        set(PREVIOUS_CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES})
        list(APPEND CMAKE_REQUIRED_LIBRARIES ${LIBUTIL_LIBRARY})
        set(ADDED_UTIL_TO_CMAKE_REQUIRED_LIBRARIES ON)
    endif()
endif()
...
if (ADDED_UTIL_TO_CMAKE_REQUIRED_LIBRARIES)
