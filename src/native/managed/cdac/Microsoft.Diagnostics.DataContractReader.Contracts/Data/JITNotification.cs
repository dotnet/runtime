...
{
    [Field(Writable = true)] public partial ushort State { get; private set; }
    [Field(Writable = true)] public partial TargetNUInt ClrModule { get; private set; }
    [Field(Writable = true)] public partial uint MethodToken { get; private set; }
