...
internal struct ComWrappers_2 : IComWrappers
{
    ...
    public TargetPointer GetComWrappersRCWForObject(TargetPointer obj)
    {
        ...
        if (_target.Contracts.ManagedTypeSource.TryGetTypeHandle(Data.ComObjectBase.ManagedTypeName, out ITypeHandle? baseType))
        {
            ...
            while (methodTable != TargetPointer.Null)
            {
                ...
                {
                    return _target.ProcessedData.GetOrAdd<Data.ComObjectBase>(obj).NativeObjectWrapper;
                }
