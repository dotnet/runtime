...
internal class ARMGCInfoTraits : IGCInfoTraits
{
    ...
    public static int DenormalizeStackSlot(int x) => x << 2;
    public static uint DenormalizeSizeOfStackArea(uint size) => size << 2;

    public static int GENERICS_INST_CONTEXT_STACK_SLOT_ENCBASE => 5;

    public static int GS_COOKIE_STACK_SLOT_ENCBASE => 5;
    public static int CODE_LENGTH_ENCBASE => 7;

    public static int STACK_BASE_REGISTER_ENCBASE => 1;
    public static int SIZE_OF_STACK_AREA_ENCBASE => 3;
    public static int SIZE_OF_EDIT_AND_CONTINUE_PRESERVED_AREA_ENCBASE => 3;
    public static int REVERSE_PINVOKE_FRAME_ENCBASE => 5;
    public static int NUM_REGISTERS_ENCBASE => 2;
    public static int NUM_STACK_SLOTS_ENCBASE => 3;
