...
internal class Wasm32GCInfoTraits : IGCInfoTraits
{
    ...
    public static int DenormalizeStackSlot(int x) => x;
    public static uint DenormalizeSizeOfStackArea(uint size) => size;

    public static int GENERICS_INST_CONTEXT_STACK_SLOT_ENCBASE => 6;
    public static int GS_COOKIE_STACK_SLOT_ENCBASE => 6;
    public static int CODE_LENGTH_ENCBASE => 6;
    public static int STACK_BASE_REGISTER_ENCBASE => 3;
    public static int SIZE_OF_STACK_AREA_ENCBASE => 6;
    ...
    public static int NUM_STACK_SLOTS_ENCBASE => 5;
    public static int NUM_UNTRACKED_SLOTS_ENCBASE => 5;
    public static int NORM_PROLOG_SIZE_ENCBASE => 4;
    public static int NORM_EPILOG_SIZE_ENCBASE => 3;
    public static int INTERRUPTIBLE_RANGE_DELTA1_ENCBASE => 5;
    public static int INTERRUPTIBLE_RANGE_DELTA2_ENCBASE => 5;
    public static int REGISTER_ENCBASE => 3;
    public static int REGISTER_DELTA_ENCBASE => 3;
    public static int STACK_SLOT_ENCBASE => 6;
    public static int STACK_SLOT_DELTA_ENCBASE => 4;
    public static int NUM_SAFE_POINTS_ENCBASE => 4;
    public static int NUM_INTERRUPTIBLE_RANGES_ENCBASE => 1;

    public static bool HAS_FIXED_STACK_PARAMETER_SCRATCH_AREA => false;

    // RyuJIT does not place GC references in WASM locals. If a malformed encoding reports a
    // register slot, treat it as volatile so it is never reported for a non-leaf frame.
