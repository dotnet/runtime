...
{
    [Field] public partial uint A { get; }
    [Field] public partial TargetPointer B { get; }
}
...
{
    [Field("_a")] public partial uint A { get; }
}
...
{
    [Field("A", "A_old")] public partial uint A { get; }
}
...
{
    [Field("_a", "_a_old")] public partial uint A { get; }
}
...
{
    [Field("A", "A_old", "_a", "_a_old")] public partial uint A { get; }
}
...
{
    [Field("_flags", Writable = true)] public partial uint Flags { get; private set; }
}
...
{
    [Field] public partial uint Required { get; }
    [Field] public partial uint? Optional { get; }
}
...
{
    [Field]      public partial uint A { get; }
    [FieldAddress("Anchor")] public partial TargetPointer AnchorAddress { get; }
}
...
{
    [Field]        public partial uint Required { get; }
    [FieldAddress] public partial TargetPointer? OptionalAddress { get; }
}
...
{
    [Field("m_flags", UsePropertyName = false)] public partial uint Flags { get; }
}
...
{
    [Field(Pointer = true)] public partial TestNative Inner { get; }
}
...
{
    [Field] public partial uint _value { get; }
    [Field] public partial TargetPointer _ptr { get; }
}
...
{
    [Field(Writable = true)] public partial uint _flags { get; private set; }
}
