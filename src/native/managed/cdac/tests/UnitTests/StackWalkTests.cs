...
public unsafe class StackWalkTests
{
    ...
    public void GetStackSizeSkipped_ReturnsBytesSkippedByFiltering()
    {
        IXCLRDataStackWalk stackWalk = CreateClrDataStackWalk(
            ...
            new TestStackDataFrameHandle(StackWalkState.Frameless, 0x1100),
            new TestStackDataFrameHandle(StackWalkState.InitialNativeContext, 0x1200),
            new TestStackDataFrameHandle(StackWalkState.NativeMarker, 0x1300),
            new TestStackDataFrameHandle(StackWalkState.Frameless, 0x1600));
        ...
        Assert.Equal(HResults.E_POINTER, stackWalk.GetStackSizeSkipped(null));
    }
