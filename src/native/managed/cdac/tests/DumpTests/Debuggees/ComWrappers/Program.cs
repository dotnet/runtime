...
/// Creates table-backed and field-backed RCWs, including an RCW also exposed as a CCW, then crashes via FailFast.
/// </summary>
internal static class Program
{
    ...
    private static IntPtr s_rcwMow;
    ...
    private static void Main()
    {
        ...
        s_rcwMow = wrappers.GetOrCreateComInterfaceForObject(directProxy, CreateComInterfaceFlags.None);
#endif
...
#if NET11_0_OR_GREATER
internal class FieldBackedProxy : ComObjectBase { }
