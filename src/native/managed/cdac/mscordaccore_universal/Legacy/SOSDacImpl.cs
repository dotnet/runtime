      ...
      ISOSDacInterface16
{
    ...
    int ISOSDacInterface5.GetTieredVersions(ClrDataAddress methodDesc, int rejitId, DacpTieredVersionData* nativeCodeAddrs, int cNativeCodeAddrs, int* pcNativeCodeAddrs)
    {
        ...
        try
        {
            ...
            int count = 0;
            foreach ((TargetPointer nativeCode, TargetPointer nativeCodeVersionNodePtr, Contracts.OptimizationTierEnum optTier) in _target.Contracts.ReJIT.GetTieredVersions(methodDescPtr, rejitId))
            {
