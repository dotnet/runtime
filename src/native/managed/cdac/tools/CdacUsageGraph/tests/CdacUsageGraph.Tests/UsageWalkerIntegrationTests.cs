...
public sealed class UsageWalkerIntegrationTests
{
    ...
    [InlineData("IRuntimeInfo", "c1", "RuntimeFileVersionBuild", "uint32", false)]
    [InlineData("IRuntimeInfo", "c1", "RuntimeFileVersionMajor", "uint32", false)]
    [InlineData("IRuntimeInfo", "c1", "RuntimeFileVersionMinor", "uint32", false)]
    [InlineData("IRuntimeInfo", "c1", "RuntimeFileVersionRevision", "uint32", false)]
