...
//   handle: handle to the reader
//   legacyImpl: optional legary implemantion of the interface tha will be used as a fallback
//   obj: returned SOS interface that can be QI'd to ISOSDacInterface*
int cdac_reader_get_sos_interface(intptr_t handle, IUnknown* legacyImpl, IUnknown** obj);
