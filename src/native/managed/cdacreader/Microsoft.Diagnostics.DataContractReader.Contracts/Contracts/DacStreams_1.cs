...
internal class DacStreams_1 : IDacStreams
{
    ...
    internal DacStreams_1(AbstractTarget target)
    {
        _target = target;
    }
    ...
    {
        static DacStreams_1_Data IData<DacStreams_1_Data>.Create(AbstractTarget target, TargetPointer address) => new DacStreams_1_Data(target);

        public DacStreams_1_Data(AbstractTarget target)
        {
        ...
        internal static Dictionary<TargetPointer, string> GetEEAddressToStringMap(AbstractTarget target)
        {
