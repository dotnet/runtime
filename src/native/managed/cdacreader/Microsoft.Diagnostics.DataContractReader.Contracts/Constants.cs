...
internal static class Constants
{
    internal static class Globals
    {
        ...
        internal const string StressLogHasModuleTable = nameof(StressLogHasModuleTable);
        ...
        internal const string StressLogValidChunkSig = nameof(StressLogValidChunkSig);
