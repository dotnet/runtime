...
internal interface IRuntimeTypeSystem : IContract, IContractFactory<IRuntimeTypeSystem>
{
    static string IContract.Name => nameof(RuntimeTypeSystem);
    static IRuntimeTypeSystem IContractFactory<IRuntimeTypeSystem>.Create(ITarget target, int version)
    {
