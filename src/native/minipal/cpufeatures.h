...
enum XArchIntrinsicConstants
{
    ...
    XArchIntrinsicConstants_Avx512Vbmi_vl = 0x20000,
    XArchIntrinsicConstants_Serialize = 0x40000,
    XArchIntrinsicConstants_Avx10v1 = 0x80000,
    XArchIntrinsicConstants_Avx10v1_V256 = 0x100000,
    XArchIntrinsicConstants_Avx10v1_V512 = 0x200000,
    XArchIntrinsicConstants_Apx = 0x400000,
};
