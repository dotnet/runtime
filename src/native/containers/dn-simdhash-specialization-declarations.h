...
#define DN_SIMDHASH_FOREACH(t) DN_SIMDHASH_GLUE_3(t,_foreach,DN_SIMDHASH_ACCESSOR_SUFFIX)
#define DN_SIMDHASH_FOREACH_FUNC(t) DN_SIMDHASH_GLUE_3(t,_foreach_func,DN_SIMDHASH_ACCESSOR_SUFFIX)

typedef void (*DN_SIMDHASH_FOREACH_FUNC(DN_SIMDHASH_T)) (DN_SIMDHASH_KEY_T key, DN_SIMDHASH_VALUE_T value, void *user_data);
