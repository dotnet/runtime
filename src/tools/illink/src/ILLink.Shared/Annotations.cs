	...
	internal static class Annotations
	{
		...
		public static (DiagnosticId Id, string[] Arguments) GetDiagnosticForAnnotationMismatch (ValueWithDynamicallyAccessedMembers source, ValueWithDynamicallyAccessedMembers target, string missingAnnotations)
		{
			DiagnosticId diagnosticId = (source, target) switch {
				...
				(MethodParameterValue maybeThis, GenericParameterValue) when maybeThis.IsThisParameter () => throw new UnreachableException(),
				...
				(MethodParameterValue, GenericParameterValue) => throw new UnreachableException(),
				...
				(MethodReturnValue, GenericParameterValue) => throw new UnreachableException(),
				...
				(FieldValue, GenericParameterValue) => throw new UnreachableException(),
