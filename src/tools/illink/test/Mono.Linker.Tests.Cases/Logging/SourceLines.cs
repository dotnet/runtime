...
namespace Mono.Linker.Tests.Cases.Logging
{
	...
	public class SourceLines
	{
		...
		[ExpectedMissingWarning ("IL2074", nameof (SourceLines) + "." + nameof (type), nameof (SourceLines) + "." + nameof (GetUnknownType) + "()", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2074", nameof (SourceLines) + "." + nameof (type), nameof (SourceLines) + "." + nameof (GetUnknownType) + "()", ProducedBy = Tool.Analyzer)]
		...
		[ExpectedMissingWarning ("IL2091", "LocalFunction()", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2089", nameof (SourceLines) + "." + nameof (type), "TOuterMethod", ProducedBy = Tool.Analyzer)]
