...
namespace Mono.Linker.Tests.Cases.Reflection
{
	...
	public class ActivatorCreateInstance
	{
		...
		[ExpectedMissingWarning ("IL2067", nameof (Activator) + "." + nameof (Activator.CreateInstance) + "(Type, Object[])", ProducedBy = Tool.Trimmer)]
		[ExpectedMissingWarning ("IL2067", nameof (Activator) + "." + nameof (Activator.CreateInstance) + "(Type, params Object[])", ProducedBy = Tool.Analyzer)]
		...
		[ExpectedMissingWarning ("IL2061", nameof (Activator) + "." + nameof (Activator.CreateInstance), "NonExistingAssembly", ProducedBy = Tool.Trimmer)]
