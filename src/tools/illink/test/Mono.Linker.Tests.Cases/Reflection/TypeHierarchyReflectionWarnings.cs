	...
	public class TypeHierarchyReflectionWarnings
	{
		...
		class AnnotatedPublicEvents
		{
			...
			public event MyEventHandler RUCEvent {
				...
				[ExpectedMissingWarning ("IL2112", nameof (AnnotatedPublicEvents), "--RUC on add_RUCEvent--", ProducedBy = Tool.Trimmer)]
				[KeptAttributeAttribute (typeof (RequiresUnreferencedCodeAttribute))]
		...
		class DerivedFromAnnotatedPublicParameterlessConstructor : AnnotatedPublicParameterlessConstructor
		{
			...
			[ExpectedMissingWarning ("IL2112", "--RUC on DerivedFromAnnotatedPublicParameterlessConstructor()--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		class RUCOnVirtualOnAnnotatedBaseUsedByDerived
		{
			...
			[KeptBaseType (typeof (Base))]
			// https://github.com/dotnet/runtime/issues/86580
			[ExpectedMissingWarning ("IL2113", "--RUCOnVirtualMethodDerivedAnnotated.Base.RUCVirtualMethod--", ProducedBy = Tool.Trimmer)]
			public class Derived : Base
			{
				[Kept]
				[KeptAttributeAttribute (typeof (RequiresUnreferencedCodeAttribute))]
		...
		class UseByDerived
		{
			...
			[KeptMember (".ctor()")]
			// https://github.com/dotnet/runtime/issues/86580
			[ExpectedMissingWarning ("IL2113", "--AnnotatedBase.VirtualMethodWithRequires--", ProducedBy = Tool.Trimmer)]
		...
		class CompilerGeneratedCodeDAM
		{
			...
			[Kept]
			[KeptAttributeAttribute (typeof (IteratorStateMachineAttribute))]
			[ExpectedMissingWarning ("IL2119", nameof (IteratorWithGenericDAM), CompilerGeneratedCode = true, ProducedBy = Tool.Trimmer)]
			...
			[KeptAttributeAttribute (typeof (AsyncStateMachineAttribute))]
			[KeptAttributeAttribute (typeof (DebuggerStepThroughAttribute))]
			[ExpectedMissingWarning ("IL2119", nameof (AsyncWithGenericDAM), CompilerGeneratedCode = true, ProducedBy = Tool.Trimmer)]
			...
			[Kept]
			[KeptAttributeAttribute (typeof (AsyncIteratorStateMachineAttribute))]
			[ExpectedMissingWarning("IL2119", nameof(AsyncIteratorWithGenericDAM), CompilerGeneratedCode = true, ProducedBy = Tool.Trimmer)]
