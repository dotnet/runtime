...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	public class RequiresInCompilerGeneratedCode
	{
		...
		class WarnInIteratorBody
		{
			...
			[ExpectedWarning ("IL2026", "--MethodWithRequires--", CompilerGeneratedCode = true)]
			[ExpectedMissingWarning ("IL3002", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.NativeAot)]
...
#if !RELEASE
			[ExpectedMissingWarning ("IL2026", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3002", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.NativeAot)]
#else
			// In release mode, the compiler optimizes away the unused Action (and reference to MethodWithRequires)
#endif
			[ExpectedMissingWarning ("IL2026", "--MethodWithRequires--", ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL3002", "--MethodWithRequires--", ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithRequires--", ProducedBy = Tool.Analyzer)]
			...
			[ExpectedMissingWarning ("IL3002", "Message from --MethodWithRequiresAndReturns--", CompilerGeneratedCode = true, ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "Message from --MethodWithRequiresAndReturns--", CompilerGeneratedCode = true, ProducedBy = Tool.Analyzer | Tool.NativeAot)]
...
#if !RELEASE
			[ExpectedMissingWarning ("IL2026", "--MethodWithRequires--", ProducedBy = Tool.Trimmer | Tool.NativeAot, CompilerGeneratedCode = true)]
			[ExpectedMissingWarning ("IL3002", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.NativeAot)]
#endif
			[ExpectedMissingWarning ("IL2026", "--MethodWithRequires--", ProducedBy = Tool.Analyzer)]
		...
		class WarnInLocalFunction
		{
			...
			[ExpectedMissingWarning ("IL3002", "--LocalFunctionWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--LocalFunctionWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			static void TestReflectionAccess ()
			{
				...
				[ExpectedWarning ("IL2026", "--MethodWithRequires--")]
				[ExpectedMissingWarning ("IL3002", "--MethodWithRequires--", ProducedBy = Tool.NativeAot)]
				[ExpectedMissingWarning ("IL3050", "--MethodWithRequires--", ProducedBy = Tool.NativeAot)]
...
#if !RELEASE
				[ExpectedMissingWarning ("IL2026", "--MethodWithRequires--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
				[ExpectedMissingWarning ("IL3002", "--MethodWithRequires--", ProducedBy = Tool.NativeAot)]
				[ExpectedMissingWarning ("IL3050", "--MethodWithRequires--", ProducedBy = Tool.NativeAot)]
#endif
				[ExpectedMissingWarning ("IL2026", "--MethodWithRequires--", ProducedBy = Tool.Analyzer)]
		...
		class SuppressInLocalFunction
		{
			...
			{
				[ExpectedMissingWarning ("IL2118", nameof (TestCallMethodWithRequiresInDynamicallyAccessedLocalFunction), "LocalFunction", ProducedBy = Tool.Trimmer)]
				public static void TestCallMethodWithRequiresInDynamicallyAccessedLocalFunction ()
				{
			...
			[ExpectedMissingWarning ("IL3002", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			static void TestSuppressionOnLocalFunctionWithNestedLocalFunction ()
			{
				...
				void LocalFunction ()
				{
					...
					[ExpectedMissingWarning ("IL2026", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
					[ExpectedMissingWarning ("IL3002", ProducedBy = Tool.NativeAot)]
					[ExpectedMissingWarning ("IL3050", ProducedBy = Tool.NativeAot)]
					void NestedLocalFunction () => MethodWithRequires ();
				}
			}
			...
			class TestSuppressionOnOuterWithSameName
			{
				...
				[ExpectedMissingWarning ("IL3002", nameof (Outer) + "()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				[ExpectedMissingWarning ("IL3050", nameof (Outer) + "()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				public static void Test ()
				{
					Outer ();
					Outer (0);
		...
		[ExpectedMissingWarning ("IL3002", "--MethodWithNonNestedLocalFunction--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--MethodWithNonNestedLocalFunction--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class WarnInLambda
		{
			...
			[ExpectedMissingWarning ("IL3002", "--LambdaWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--LambdaWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--MethodWithRequiresAndReturns--", CompilerGeneratedCode = true, ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithRequiresAndReturns--", CompilerGeneratedCode = true, ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			public static Lazy<string> _default = new Lazy<string> (MethodWithRequiresAndReturns);
		...
		class SuppressInLambda
		{
			...
			static void TestSuppressionOnLambdaWithNestedLambda ()
			{
				...
				() => {
					...
					var nestedLambda =
					[ExpectedMissingWarning ("IL2026", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
					[ExpectedMissingWarning ("IL3002", ProducedBy = Tool.NativeAot | Tool.NativeAot)]
					[ExpectedMissingWarning ("IL3050", ProducedBy = Tool.NativeAot | Tool.NativeAot)]
					() => MethodWithRequires ();
				};
		...
		class SuppressInComplex
		{
			...
			[ExpectedMissingWarning ("IL3002", "--IteratorLocalFunction--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--IteratorLocalFunction--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			static void TestLocalFunctionInIteratorLocalFunction ()
			{
				IteratorLocalFunction ();
		...
		class StateMachinesOnlyReferencedViaReflection
		{
			...
			[ExpectedMissingWarning ("IL3002", ProducedBy = Tool.Analyzer | Tool.NativeAot, CompilerGeneratedCode = true)]
			[ExpectedMissingWarning ("IL3050", ProducedBy = Tool.Analyzer | Tool.NativeAot, CompilerGeneratedCode = true)]
			...
			[ExpectedMissingWarning ("IL3002", "--TestIteratorOnlyReferencedViaReflectionWhichShouldSuppress--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestIteratorOnlyReferencedViaReflectionWhichShouldSuppress--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "--TestAsyncOnlyReferencedViaReflectionWhichShouldSuppress--")]
			[ExpectedMissingWarning ("IL3002", "--TestAsyncOnlyReferencedViaReflectionWhichShouldSuppress--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestAsyncOnlyReferencedViaReflectionWhichShouldSuppress--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2118", nameof (StateMachinesOnlyReferencedViaReflection), "<" + nameof (TestAsyncOnlyReferencedViaReflectionWhichShouldWarn) + ">", "MoveNext()",
				ProducedBy = Tool.Trimmer)]
			[ExpectedMissingWarning ("IL2118", nameof (StateMachinesOnlyReferencedViaReflection), "<" + nameof (TestIteratorOnlyReferencedViaReflectionWhichShouldWarn) + ">", "MoveNext()",
				ProducedBy = Tool.Trimmer)]
			static void TestAll ()
			{
		...
		class LocalFunctionsReferencedViaReflection
		{
			...
			[ExpectedMissingWarning ("IL3002", "--TestLocalFunctionWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLocalFunctionWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			static void TestLocalFunctionWithRequires ()
			{
				LocalFunction ();
			...
			[ExpectedMissingWarning ("IL3002", "LocalFunction", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "LocalFunction", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--TestLocalFunctionInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLocalFunctionInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "--TestLocalFunctionWithClosureInMethodWithRequires--")]
			[ExpectedMissingWarning ("IL3002", "--TestLocalFunctionWithClosureInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLocalFunctionWithClosureInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "--TestLocalFunctionInMethodWithRequiresOnlyAccessedViaReflection--")]
			[ExpectedMissingWarning ("IL3002", "--TestLocalFunctionInMethodWithRequiresOnlyAccessedViaReflection--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLocalFunctionInMethodWithRequiresOnlyAccessedViaReflection--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2118", nameof (LocalFunctionsReferencedViaReflection), nameof (TestLocalFunctionInMethodWithRequiresOnlyAccessedViaReflection),
				ProducedBy = Tool.Trimmer)]
			static void TestAll ()
			{
		...
		class LambdasReferencedViaReflection
		{
			...
			[ExpectedMissingWarning ("IL3002", "--TestLambdaWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLambdaWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			static void TestLambdaWithRequires ()
			{
				var lambda =
			...
			[ExpectedMissingWarning ("IL3002", "Lambda", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "Lambda", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--TestLambdaInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLambdaInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "--TestLambdaWithClosureInMethodWithRequires--")]
			[ExpectedMissingWarning ("IL3002", "--TestLambdaWithClosureInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--TestLambdaWithClosureInMethodWithRequires--", ProducedBy = Tool.NativeAot)]
			static void TestAll ()
			{
		...
		class ComplexCases
		{
			public class AsyncBodyCallingMethodWithRequires
			{
				...
				[ExpectedMissingWarning ("IL3002", "ParentSuppression", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				[ExpectedMissingWarning ("IL3050", "ParentSuppression", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				public static void Test ()
				{
