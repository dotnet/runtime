...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	public class RequiresInCompilerGeneratedCode
	{
		...
		class SuppressInLocalFunction
		{
			...
			{
				[ExpectedWarning ("IL2118", [nameof (TestCallMethodWithRequiresInDynamicallyAccessedLocalFunction), "LocalFunction"], Tool.Trimmer, "")]
				public static void TestCallMethodWithRequiresInDynamicallyAccessedLocalFunction ()
				{
		...
		class StateMachinesOnlyReferencedViaReflection
		{
			...
			[ExpectedWarning ("IL2118", [nameof (StateMachinesOnlyReferencedViaReflection), "<" + nameof (TestAsyncOnlyReferencedViaReflectionWhichShouldWarn) + ">", "MoveNext()"], Tool.Trimmer, "")]
			[ExpectedWarning ("IL2118", [nameof (StateMachinesOnlyReferencedViaReflection), "<" + nameof (TestIteratorOnlyReferencedViaReflectionWhichShouldWarn) + ">", "MoveNext()"], Tool.Trimmer, "")]
			static void TestAll ()
			{
		...
		class LocalFunctionsReferencedViaReflection
		{
			...
			[ExpectedWarning ("IL2118", nameof (LocalFunctionsReferencedViaReflection), nameof (TestLocalFunctionInMethodWithRequiresOnlyAccessedViaReflection), Tool.Trimmer, "")]
			static void TestAll ()
			{
