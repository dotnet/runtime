...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	public class ReflectionAccessFromCompilerGeneratedCode
	{
		...
		class ReflectionAccessFromStateMachine
		{
			...
			[ExpectedWarning ("IL3002", "--TestIteratorWithRUC--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL3050", "--TestIteratorWithRUC--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "--TestAsyncWithRUC--")]
			[ExpectedWarning ("IL3002", "--TestAsyncWithRUC--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL3050", "--TestAsyncWithRUC--", ProducedBy = Tool.NativeAot)]
		...
		class ReflectionAccessFromLocalFunction
		{
			...
			[ExpectedWarning ("IL3002", "--LocalFunction--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL3050", "--LocalFunction--", ProducedBy = Tool.NativeAot)]
			...
			[ExpectedWarning ("IL3002", "--TestLocalFunctionInMethodWithRUC--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL3050", "--TestLocalFunctionInMethodWithRUC--", ProducedBy = Tool.NativeAot)]
			public static void Test ()
			{
				TestLocalFunction ();
		...
		class ReflectionAccessFromLambda
		{
			...
			[ExpectedWarning ("IL3002", "--TestLambdaInMethodWithRUC--", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL3050", "--TestLambdaInMethodWithRUC--", ProducedBy = Tool.NativeAot)]
		...
		class TypeWithMethodWithRequires
		{
			...
			public static void MethodWithLocalFunctionCallsRUC ()
			{
				...
				[ExpectedWarning ("IL3002", "--MethodWithRUC--", ProducedBy = Tool.NativeAot)]
				[ExpectedWarning ("IL3050", "--MethodWithRUC--", ProducedBy = Tool.NativeAot)]
