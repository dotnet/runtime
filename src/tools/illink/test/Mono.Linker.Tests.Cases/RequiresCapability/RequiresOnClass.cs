...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	class RequiresOnClass
	{
		...
		class ReflectionAccessOnEvents
		{
			...
			[ExpectedWarning ("IL2026", nameof (WithRequires), "InstanceEvent.remove")]
			[ExpectedWarning ("IL3050", nameof (WithRequires), "InstanceEvent.remove", Tool.NativeAot, "")]
			[UnexpectedWarning ("IL2026", nameof (WithRequires), "StaticEvent.add", Tool.Trimmer | Tool.Analyzer, "https://github.com/dotnet/runtime/issues/102525")]
			[UnexpectedWarning ("IL2026", nameof (WithRequires), "StaticEvent.remove", Tool.Trimmer | Tool.Analyzer, "https://github.com/dotnet/runtime/issues/102525")]
