	...
	class RequiresOnClass
	{
		...
		class ClassWithRequires
		{
			...
			public class NestedClass
			{
				...
				[ExpectedMissingWarning ("IL3050", "RequiresOnClass.RequiresOnMethod.MethodWithRequires()", "MethodWithRequires", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				public static void CallMethodWithRequires () => RequiresOnMethod.MethodWithRequires ();
			}
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.StaticCtor.StaticCtor()", "Message for --StaticCtor--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "StaticCtorTriggeredByFieldAccess.field", "Message for --StaticCtorTriggeredByFieldAccess--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "StaticCCtorTriggeredByFieldAccessRead.field", "Message for --StaticCCtorTriggeredByFieldAccessRead--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "StaticCtorTriggeredByCtorCalls.StaticCtorTriggeredByCtorCalls()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "ClassWithInstanceField.ClassWithInstanceField()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "Calling the constructor is dangerous", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.ClassWithRequires.StaticMethod()", "--ClassWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.ClassWithRequires", "--ClassWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.ClassWithRequires.CallMethodWithRequires()", "--ClassWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedWarning ("IL2026", "ClassWithRequires.Instance", "--ClassWithRequires--")]
		[ExpectedMissingWarning ("IL3050", "ClassWithRequires.Instance", "--ClassWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.DerivedWithRequires.StaticMethodInInheritedClass()", "--DerivedWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.DerivedWithRequires2.StaticMethodInInheritedClass()", "--DerivedWithRequires2--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedWarning ("IL2026", "RequiresOnClass.ClassWithRequires.StaticMethod()", "--ClassWithRequires--")]
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.ClassWithRequires.StaticMethod()", "--ClassWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "RequiresOnClass.ClassWithRequires.TestSuppressions(", "Type[])", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3050", "MemberTypesWithRequires.field", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedWarning ("IL2026", "MemberTypesWithRequires.Property.set")]
		[ExpectedMissingWarning ("IL3050", "MemberTypesWithRequires.Property.set", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedWarning ("IL2026", "MemberTypesWithRequires.Event.remove")]
		[ExpectedMissingWarning ("IL3050", "MemberTypesWithRequires.Event.remove", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class ReflectionAccessOnMethod
		{
			...
			[ExpectedMissingWarning ("IL3050", "BaseWithRequiresOnType.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "BaseWithRequiresOnType.Method()")]
			[ExpectedMissingWarning ("IL3050", "BaseWithRequiresOnType.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "BaseWithoutRequiresOnType.Method()")]
			[ExpectedMissingWarning ("IL3050", "BaseWithoutRequiresOnType.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "BaseWithoutRequiresOnType.Method()")]
			[ExpectedMissingWarning ("IL3050", "BaseWithoutRequiresOnType.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequiresOnType.Method()")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequiresOnType.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "InterfaceWithoutRequires.Method(Int32)")]
			[ExpectedMissingWarning ("IL3050", "InterfaceWithoutRequires.Method(Int32)", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "InterfaceWithoutRequires.Method()")]
			[ExpectedMissingWarning ("IL3050", "InterfaceWithoutRequires.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "ImplementationWithRequiresOnType.Method()")]
			[ExpectedMissingWarning ("IL3050", "ImplementationWithRequiresOnType.Method()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "ImplementationWithRequiresOnType.Method(Int32)")]
			[ExpectedMissingWarning ("IL3050", "ImplementationWithRequiresOnType.Method(Int32)", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequiresOnTypeOverBaseWithNoRequires.Method()")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequiresOnTypeOverBaseWithNoRequires.Method()", ProducedBy = Tool.NativeAot)]
		...
		class ReflectionAccessOnCtor
		{
			...
			class DerivedWithoutRequires : BaseWithRequires
			{
				...
				[ExpectedMissingWarning ("IL3050", "--BaseWithRequires--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				public DerivedWithoutRequires () { }
			}
			...
			[ExpectedMissingWarning ("IL3050", "BaseWithRequires.BaseWithRequires()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "BaseWithRequires.BaseWithRequires()")]
			[ExpectedMissingWarning ("IL3050", "BaseWithRequires.BaseWithRequires()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequiresOnBaseWithRequires.DerivedWithRequiresOnBaseWithRequires()")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequiresOnBaseWithRequires.DerivedWithRequiresOnBaseWithRequires()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequiresOnBaseWithoutRequires.DerivedWithRequiresOnBaseWithoutRequires()")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequiresOnBaseWithoutRequires.DerivedWithRequiresOnBaseWithoutRequires()", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequiresOnBaseWithoutRequires.DerivedWithRequiresOnBaseWithoutRequires()")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequiresOnBaseWithoutRequires.DerivedWithRequiresOnBaseWithoutRequires()", ProducedBy = Tool.NativeAot)]
			static void TestDAMAccess ()
			{
		...
		class ReflectionAccessOnField
		{
			...
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticField", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticField")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticField", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticField")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticField", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.PrivateStaticField")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.PrivateStaticField", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequires.DerivedStaticField")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequires.DerivedStaticField", ProducedBy = Tool.NativeAot)]
			static void TestDAMAccess ()
			{
			...
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticField", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticField", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticField", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticField", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticField", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL2026", "DerivedWithRequires.DerivedStaticField", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequires.DerivedStaticField", ProducedBy = Tool.NativeAot)]
			...
			[RequiresUnreferencedCode ("This class is dangerous")]
			[RequiresDynamicCode ("This class is dangerous")]
			[ExpectedMissingWarning ("IL2113", "BaseForDAMAnnotatedClass.baseField", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			class DAMAnnotatedClass : BaseForDAMAnnotatedClass
			{
				[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClass.publicField", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
				public static int publicField;

				[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClass.privatefield", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			{
				[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClassAccessedFromRUCScope.RUCMethod", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3050", "NonGenericField", "--GenericTypeWithRequires--", ProducedBy = Tool.NativeAot)]
		...
		class ReflectionAccessOnEvents
		{
			...
			[ExpectedMissingWarning ("IL3050", "StaticEvent.add", ProducedBy = Tool.NativeAot)]
			// https://github.com/dotnet/runtime/issues/100499
			[ExpectedMissingWarning ("IL2026", "StaticEvent.add", ProducedBy = Tool.Trimmer)]
			[ExpectedWarning ("IL2026", "StaticEvent.remove")]
			[ExpectedMissingWarning ("IL3050", "StaticEvent.remove", ProducedBy = Tool.NativeAot)]
			static void TestDirectReflectionAccess ()
			{
		...
		class ReflectionAccessOnProperties
		{
			...
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.InstanceProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.InstanceProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.InstanceProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.InstanceProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.InstanceProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.StaticProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.PrivateStaticProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.PrivateStaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequires.PrivateStaticProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequires.PrivateStaticProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequiresOnlyInstanceProperties.InstanceProperty.get")]
			[ExpectedMissingWarning ("IL3050", "WithRequiresOnlyInstanceProperties.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "WithRequiresOnlyInstanceProperties.InstanceProperty.set")]
			[ExpectedMissingWarning ("IL3050", "WithRequiresOnlyInstanceProperties.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequires.DerivedStaticProperty.get")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequires.DerivedStaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedWarning ("IL2026", "DerivedWithRequires.DerivedStaticProperty.set")]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequires.DerivedStaticProperty.set", ProducedBy = Tool.NativeAot)]
			static void TestDAMAccess ()
			{
			...
			[ExpectedMissingWarning ("IL2026", "WithRequires.InstanceProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.InstanceProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.InstanceProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.InstanceProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.InstanceProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.InstanceProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.InstanceProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "WithRequires.StaticProperty.set", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "WithRequires.StaticProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL2026", "DerivedWithRequires.DerivedStaticProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequires.DerivedStaticProperty.get", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "DerivedWithRequires.DerivedStaticProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "DerivedWithRequires.DerivedStaticProperty.set", ProducedBy = Tool.NativeAot)]
			...
			[RequiresUnreferencedCode ("This class is dangerous")]
			[RequiresDynamicCode ("This class is dangerous")]
			[ExpectedMissingWarning ("IL2113", "BaseForDAMAnnotatedClass.baseProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2113", "BaseForDAMAnnotatedClass.baseProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			class DAMAnnotatedClass : BaseForDAMAnnotatedClass
			{
				public static int publicProperty {
					[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClass.publicProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
					get;
					[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClass.publicProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
					set;
				}

				static int privateProperty {
					[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClass.privateProperty.get", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
					get;
					[ExpectedMissingWarning ("IL2112", "DAMAnnotatedClass.privateProperty.set", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
					set;
				}
			}
		...
		[ExpectedMissingWarning ("IL3050", "AttributeWithRequires.AttributeWithRequires()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class MembersOnClassWithRequires<T>
		{
			...
			public class ClassWithRequires
			{
				...
				[ExpectedMissingWarning ("IL2026", "--RequiresOnCtorAttribute--", ProducedBy = Tool.Trimmer)]
				[RequiresOnCtor]
		...
		class ConstFieldsOnClassWithRequires
		{
			...
			[ExpectedMissingWarning ("IL3050", "--ConstClassWithRequires--", nameof (ConstClassWithRequires.Method), ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3050", "--ConstClassWithRequiresUsingField--", nameof (ConstClassWithRequiresUsingField.Method), ProducedBy = Tool.Analyzer | Tool.NativeAot)]
