...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	class RequiresAccessedThrough
	{
		...
		[ExpectedMissingWarning ("IL3002", "--RequiresOnlyThroughReflection--", ProducedBy = Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--RequiresOnlyThroughReflection--", ProducedBy = Tool.NativeAot)]
		...
		class AccessedThroughReflectionOnGenericType<T>
		{
			...
			[ExpectedMissingWarning ("IL3002", "--GenericType.RequiresOnlyThroughReflection--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--GenericType.RequiresOnlyThroughReflection--", ProducedBy = Tool.NativeAot)]
		...
		class AccessThroughPInvoke
		{
			...
			[ExpectedMissingWarning ("IL2026", "--PInvokeReturnType.ctor--", ProducedBy = Tool.Trimmer)]
			[DllImport ("nonexistent")]
			static extern PInvokeReturnType PInvokeReturnsType ();

			// Analyzer doesn't support IL2050 yet
			[ExpectedMissingWarning ("IL2050", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			public static void Test ()
			{
				PInvokeReturnsType ();
			}
		...
		class AccessThroughNewConstraint
		{
			...
			[ExpectedMissingWarning ("IL3002", "--NewConstraintTestType.ctor--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--NewConstraintTestType.ctor--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--AnnotatedMethod--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--AnnotatedMethod--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class AccessThroughLdToken
		{
			...
			[ExpectedMissingWarning ("IL2026", "--PropertyWithLdToken.get--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3002", "--PropertyWithLdToken.get--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3002", "--PropertyWithLdToken.get--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--PropertyWithLdToken.get--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--PropertyWithLdToken.get--", ProducedBy = Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--MethodWithLdToken--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithLdToken--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3050", "--FieldWithLdToken--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class AccessThroughDelegate
		{
			...
			[ExpectedMissingWarning ("IL3002", "--MethodWithDelegate--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--MethodWithDelegate--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--LambdaThroughDelegate--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--LambdaThroughDelegate--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL3002", "--LocalFunctionThroughDelegate--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--LocalFunctionThroughDelegate--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class AccessThroughUnsafeAccessor
		{
			...
			[ExpectedMissingWarning ("IL2026", "--Target.MethodRequires--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3002", "--Target.MethodRequires--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--Target.MethodRequires--", ProducedBy = Tool.NativeAot)]
			[UnsafeAccessor (UnsafeAccessorKind.StaticMethod)]
			extern static void MethodRequires (Target target);

			[ExpectedMissingWarning ("IL2026", "--Target..ctor--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3002", "--Target..ctor--", ProducedBy = Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", "--Target..ctor--", ProducedBy = Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL2026", "--TargetWitRequires--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[UnsafeAccessor (UnsafeAccessorKind.Constructor)]
			...
			[ExpectedMissingWarning ("IL2026", "--TargetWitRequires--", ProducedBy = Tool.Trimmer)]
