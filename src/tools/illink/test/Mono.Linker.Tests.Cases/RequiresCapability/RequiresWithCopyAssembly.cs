...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	class RequiresWithCopyAssembly
	{
		...
		[ExpectedMissingWarning ("IL3002", "--IDerivedInterface.MethodInDerivedInterface--", ProducedBy = Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--IDerivedInterface.MethodInDerivedInterface--", ProducedBy = Tool.NativeAot)]
		[ExpectedWarning ("IL2026", "--IBaseInterface.MethodInBaseInterface--")]
		[ExpectedMissingWarning ("IL3002", "--IBaseInterface.MethodInBaseInterface--", ProducedBy = Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--IBaseInterface.MethodInBaseInterface--", ProducedBy = Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3002", "--Method--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--Method--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3002", "--MethodCalledThroughReflection--", ProducedBy = Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--MethodCalledThroughReflection--", ProducedBy = Tool.NativeAot)]
