...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	class RequiresOnStaticConstructor
	{
		...
		class StaticCtorForRunClassConstructorWithRequires
		{
			...
			[ExpectedMissingWarning ("IL3004", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3056", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[RequiresUnreferencedCode ("Message for --StaticCtorOnTypeWithRequires--")]
		...
		class StaticCtorTriggeredByMethodCall
		{
			...
			[ExpectedMissingWarning ("IL3004", "StaticCtorTriggeredByMethodCall..cctor()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3056", "StaticCtorTriggeredByMethodCall..cctor()", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL3002", "--StaticCtorTriggeredByMethodCall.TriggerStaticCtorMarking--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL3050", "--StaticCtorTriggeredByMethodCall.TriggerStaticCtorMarking--", ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		{
			[ExpectedMissingWarning ("IL2026", "Message from --TypeIsBeforeFieldInit.AnnotatedMethod--", ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL3002", "Message from --TypeIsBeforeFieldInit.AnnotatedMethod--", ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL3050", "Message from --TypeIsBeforeFieldInit.AnnotatedMethod--", ProducedBy = Tool.Analyzer)]
