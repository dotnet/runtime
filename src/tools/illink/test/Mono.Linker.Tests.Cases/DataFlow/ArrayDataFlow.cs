...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class ArrayDataFlow
	{
		...
		[ExpectedMissingWarning ("IL2072", nameof (GetUnknownType), nameof (DataFlowTypeExtensions.RequiresAll),
			ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2072", nameof (GetTypeWithPublicConstructors), nameof (DataFlowTypeExtensions.RequiresAll),
			ProducedBy = Tool.Analyzer)]
		// https://github.com/dotnet/linker/issues/2737
		[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresAll),
		...
		[UnexpectedWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresAll),
			IssueLinkOrReason = "https://github.com/dotnet/runtime/issues/93416", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2072", nameof (GetMethods), nameof (DataFlowTypeExtensions.RequiresAll),
			IssueLinkOrReason = "https://github.com/dotnet/runtime/issues/93416", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2072", nameof (GetFields), nameof (DataFlowTypeExtensions.RequiresAll),
			IssueLinkOrReason = "https://github.com/dotnet/runtime/issues/93416", ProducedBy = Tool.Analyzer)]
		...
		[UnexpectedWarning ("IL2072", nameof (ArrayDataFlow.GetMethods), IssueLinkOrReason = "https://github.com/dotnet/runtime/issues/93416", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresPublicFields), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		// https://github.com/dotnet/linker/issues/2680 - analyzer doesn't reset array in this case
		[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresPublicMethods), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		static class TestMultiDimensionalArray
		{
			...
			[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresAll), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			static void TestArrayWithInitializerOneElementStaticType ()
			{
				Type[,] arr = new Type[,] { { typeof (TestType) } };
				arr[0, 0].RequiresAll ();
			...
			// Below are because we do not handle Multi dimensional arrays
			[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresAll), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresPublicProperties), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresPublicFields), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresAll), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			static void TestArrayWithInitializerMultipleElementsMix<[DynamicallyAccessedMembers (DynamicallyAccessedMemberTypes.PublicProperties)] TProperties> (
				[DynamicallyAccessedMembers (DynamicallyAccessedMemberTypes.All)] Type typeAll)
		...
		class WriteElementOfCapturedArray
		{
			...
			[ExpectedMissingWarning ("IL2087", nameof (T), nameof (DataFlowTypeExtensions.RequiresAll), ProducedBy = Tool.Analyzer)]
			[ExpectedWarning ("IL2087", nameof (U), nameof (DataFlowTypeExtensions.RequiresPublicFields))]
			// Missing warnings for 'V' possibly assigned to arr or arr2 because write to temp
			// array isn't reflected back in the local variables. https://github.com/dotnet/linker/issues/2158
			...
			[ExpectedMissingWarning ("IL2087", nameof (U), nameof (DataFlowTypeExtensions.RequiresAll), ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL2062", nameof (DataFlowTypeExtensions.RequiresAll), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
