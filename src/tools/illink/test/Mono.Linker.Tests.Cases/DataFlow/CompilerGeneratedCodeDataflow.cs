...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class CompilerGeneratedCodeDataflow
	{
		...
		class Iterator
		{
			...
			[ExpectedMissingWarning ("IL2072", nameof (GetWithPublicMethods), nameof (DataFlowTypeExtensions.RequiresPublicFields), CompilerGeneratedCode = true,
				ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2072", nameof (GetWithPublicFields), nameof (DataFlowTypeExtensions.RequiresPublicMethods), CompilerGeneratedCode = true,
				ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		class LocalFunction
		{
			...
			[ExpectedMissingWarning ("IL2072", "tParameter", nameof (GetWithPublicFields), ProducedBy = Tool.Analyzer)]
