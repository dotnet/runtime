	...
	class VirtualMethodHierarchyDataflowAnnotationValidation
	{
		...
		static class StaticInterfaceMethods
		{
			...
			class ImplIDamOnAllMissing : IDamOnAll
			{
				...
				[ExpectedMissingWarning ("IL2092", ProducedBy = Tool.Trimmer | Tool.Analyzer)]
				[ExpectedMissingWarning ("IL2093", ProducedBy = Tool.Trimmer | Tool.Analyzer)]
				[ExpectedMissingWarning ("IL2095", ProducedBy = Tool.Trimmer | Tool.Analyzer)]
		...
		class DirectCall
		{
			...
			{
				[ExpectedWarning ("IL2092")]
				[ExpectedMissingWarning ("IL2092", ProducedBy = Tool.Analyzer)] // https://github.com/dotnet/linker/issues/3121
		...
		class RequiresAndDynamicallyAccessedMembersValidation
		{
			...
			[ExpectedMissingWarning ("IL3050", nameof (DerivedTypeWithRequires_BaseMethodWithRequires), ProducedBy = Tool.NativeAot | Tool.Analyzer)]
			[ExpectedMissingWarning ("IL3050", nameof (DerivedTypeWithRequires_BaseMethodWithRequires.MethodWithRequires), ProducedBy = Tool.NativeAot | Tool.Analyzer)]
