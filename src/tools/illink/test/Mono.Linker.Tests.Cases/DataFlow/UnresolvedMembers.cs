...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class UnresolvedMembers
	{
		...
		[Kept]
		[ExpectedMissingWarning ("IL2066", "TypeWithUnresolvedGenericArgument", ProducedBy = Tool.Trimmer | Tool.Analyzer)] // Local variable type
		[ExpectedMissingWarning ("IL2066", "TypeWithUnresolvedGenericArgument", ProducedBy = Tool.Trimmer | Tool.Analyzer)] // Called method declaring type
		[ExpectedMissingWarning ("IL2066", nameof (MethodWithUnresolvedGenericArgument), ProducedBy = Tool.Trimmer | Tool.Analyzer)]
		...
		[Kept]
		[ExpectedMissingWarning ("IL2062", nameof (AttributeWithRequirements), ProducedBy = Tool.Trimmer | Tool.Analyzer)]
		...
		[Kept]
		[ExpectedMissingWarning ("IL2062", nameof (AttributeWithRequirements.PropertyWithRequirements), ProducedBy = Tool.Trimmer | Tool.Analyzer)]
		[KeptAttributeAttribute (typeof (AttributeWithRequirements))]
		...
		[Kept]
		[ExpectedMissingWarning ("IL2064", nameof (AttributeWithRequirements.FieldWithRequirements), ProducedBy = Tool.Trimmer | Tool.Analyzer)]
		[KeptAttributeAttribute (typeof (AttributeWithRequirements))]
		...
		[Kept]
		[ExpectedMissingWarning ("IL2072", nameof (Object.GetType), ProducedBy = Tool.Trimmer | Tool.Analyzer)]
