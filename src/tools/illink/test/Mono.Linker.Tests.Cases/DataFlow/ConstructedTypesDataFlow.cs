...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class ConstructedTypesDataFlow
	{
		...
		class DeconstructedVariable
		{
			...
			[ExpectedMissingWarning ("IL2077", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			// https://github.com/dotnet/linker/issues/3158
			[ExpectedMissingWarning ("IL2062", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2078", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			[ExpectedMissingWarning ("IL2067", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
