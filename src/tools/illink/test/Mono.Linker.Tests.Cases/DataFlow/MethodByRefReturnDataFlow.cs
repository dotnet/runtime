...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class MethodByRefReturnDataFlow
	{
		...
		[ExpectedMissingWarning ("IL2026", "Message for --TestType.Requires--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		// https://github.com/dotnet/linker/issues/2158
		[ExpectedMissingWarning ("IL2073", nameof (GetWithPublicFields), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL2073", nameof (ReturnAnnotatedTypeWithRequirements), nameof (GetWithPublicFields), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
