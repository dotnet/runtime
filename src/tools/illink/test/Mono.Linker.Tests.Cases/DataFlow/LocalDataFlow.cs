...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class LocalDataFlow
	{
		...
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicFields) + "(String)",
			nameof (LocalDataFlow) + "." + nameof (GetWithPublicMethods) + "()",
		...
		// Analyzer gets this right (no warning), but trimmer merges all branches going forward.
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicFields),
			ProducedBy = Tool.Trimmer)]
		...
		// Analyzer gets this right (no warning), but trimmer merges all branches going forward.
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresNonPublicMethods) + "(String)",
			ProducedBy = Tool.Trimmer)]
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicMethods) + "(String)",
			ProducedBy = Tool.Trimmer)]
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicMethods) + "(String)",
			ProducedBy = Tool.Trimmer)]
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicConstructors) + "(String)",
			ProducedBy = Tool.Trimmer)]
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicConstructors) + "(String)",
			ProducedBy = Tool.Trimmer)]
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowStringExtensions) + "." + nameof (DataFlowStringExtensions.RequiresPublicConstructors) + "(String)",
		...
		[ExpectedMissingWarning ("IL2063", ProducedBy = Tool.Trimmer)] // The types loaded from the array don't have annotations, so the "return" should warn
		[ExpectedMissingWarning ("IL2073", ProducedBy = Tool.Analyzer)] // Analyzer tracks resultType as the value from IEnumerable.Current.get()
