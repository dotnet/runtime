...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class CompilerGeneratedCodeAccessedViaReflection
	{
		...
		class IteratorStateMachines : BaseTypeWithIteratorStateMachines
		{
			...
			[ExpectedWarning ("IL3002", "--MethodWithRequires--", CompilerGeneratedCode = true,
				ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedWarning ("IL3050", "--MethodWithRequires--", CompilerGeneratedCode = true,
				ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			...
			class RUCTypeWithIterators
			{
				[ExpectedWarning ("IL2112", "<" + nameof (StaticIteratorCallsMethodWithRequires) + ">", "(Int32)", "--RUCTypeWithIterators--", CompilerGeneratedCode = true,
					ProducedBy = Tool.Trimmer | Tool.NativeAot)] // state machine ctor
				[ExpectedWarning ("IL2112", nameof (StaticIteratorCallsMethodWithRequires) + "()", "--RUCTypeWithIterators--",
					ProducedBy = Tool.Trimmer | Tool.NativeAot)]
				[ExpectedWarning ("IL3002", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.Analyzer | Tool.NativeAot)]
				[ExpectedWarning ("IL3050", "--MethodWithRequires--", CompilerGeneratedCode = true, ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class LocalFunctions
		{
			...
			[ExpectedWarning ("IL2026", "<" + nameof (RUCTypeWithLocalFunctions.MethodWithLocalFunctions) + ">", "LocalFunctionWithCapturedState",
				ProducedBy = Tool.Trimmer | Tool.NativeAot)] // displayclass ctor
