...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class MakeGenericDataflowIntrinsics
	{
		...
		class MakeGenericType
		{
			...
			[ExpectedMissingWarning ("IL3050", nameof (Type.MakeGenericType), ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class MakeGenericMethod
		{
			...
			[ExpectedMissingWarning ("IL3050", nameof (MethodInfo.MakeGenericMethod), ProducedBy = Tool.Analyzer | Tool.NativeAot)]
