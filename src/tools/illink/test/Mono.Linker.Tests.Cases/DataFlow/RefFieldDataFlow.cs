...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class RefFieldDataFlow
	{
		...
		[ExpectedMissingWarning ("IL2089", "RefFieldWithMethods", "T", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2089", "RefFieldWithFields", "T", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2089", "RefFieldWithMethodsAndFields", "T", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2089", "RefFieldWithMethodsAndFields", "T", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2089", "RefFieldWithFields", "T", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		[ExpectedMissingWarning ("IL2064", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2064", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2064", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2064", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2064", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2069", "RefFieldWithMethods.T", "param", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2069", "RefFieldWithMethods.T", "paramWithFields", ProducedBy = Tool.Analyzer)]
		...
		[ExpectedMissingWarning ("IL2079", "RefFieldWithMethods.T", "RefFieldUnannotated.T", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2079", "RefFieldWithMethods.T", "RefFieldWithFields.T", ProducedBy = Tool.Analyzer)]
		// IL2064's are bugs - shouldn't be unknown values
		// https://github.com/dotnet/runtime/issues/85465
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = unannotated.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withMethods.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withFields.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withMethodsAndFields.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withMethodsAndFields.T;
		...
		[ExpectedWarning ("IL2074", "RefFieldWithMethods.T", "GetRefUnannotated")]
		[ExpectedWarning ("IL2074", "RefFieldWithMethods.T", "GetRefWithFields")]
		[ExpectedMissingWarning ("IL2074", "RefFieldWithMethods.T", "GetRefUnannotated", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2074", "RefFieldWithMethods.T", "GetRefWithFields", ProducedBy = Tool.Analyzer)]
		// IL2064's are bugs - shouldn't be unknown values
		// https://github.com/dotnet/runtime/issues/85465
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
		...
		// target.T = x.T
		[ExpectedMissingWarning ("IL2074", "RefFieldWithMethods.T", "RefPropUnannotated.T", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2074", "RefFieldWithMethods.T", "RefPropWithFields.T", ProducedBy = Tool.Analyzer)]
		// target.T = t;
		[ExpectedMissingWarning ("IL2074", "RefFieldWithMethods.T", "RefPropUnannotated.T", ProducedBy = Tool.Analyzer)]
		[ExpectedMissingWarning ("IL2074", "RefFieldWithMethods.T", "RefPropWithFields.T", ProducedBy = Tool.Analyzer)]
		// target.T = ref x.T
		...
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withMethods.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withFields.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withMethodsAndFieldswithMtho.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = withMethods.T;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
		[ExpectedMissingWarning ("IL2064", "RefFieldWithMethods.T", ProducedBy = Tool.Trimmer | Tool.NativeAot)] // target.T = t;
