...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class FeatureCheckDataFlow
	{
		...
		class CallFeatureUnguarded
		{
			...
			[ExpectedMissingWarning ("IL3050", nameof (RequiresDynamicCode), ProducedBy = Tool.Analyzer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3002", nameof (RequiresAssemblyFiles), ProducedBy = Tool.Analyzer | Tool.NativeAot)]
		...
		class CallFeatureGuarded
		{
			...
			[ExpectedMissingWarning ("IL3050", nameof (RequiresDynamicCode), ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL3002", nameof (RequiresAssemblyFiles), ProducedBy = Tool.Analyzer)]
			...
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		class FeatureCheckBooleanExpressions
		{
			...
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL3050", nameof (RequiresDynamicCode), ProducedBy = Tool.NativeAot)]
			static void And ()
			{
		...
		class FeatureCheckCombinations
		{
			...
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode), ProducedBy = Tool.Analyzer | Tool.Trimmer)]
		...
		class ExceptionalDataFlow
		{
			...
			[ExpectedWarning ("IL2026", nameof (RequiresUnreferencedCode0))]
			// Trimmer/NativeAot don't optimize branches away based on DoesNotReturnIfAttribute
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode1), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			[ExpectedWarning ("IL2026", nameof (RequiresUnreferencedCode1))]
			// Trimmer/NativeAot don't optimize branches away based on DoesNotReturnIfAttribute
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode2), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			...
			// Trimmer/NativeAot don't optimize branches away based on DoesNotReturnIfAttribute
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode1), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode3), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		class CompilerGeneratedCodeDataflow
		{
			...
			[ExpectedMissingWarning ("IL2026", nameof (RequiresUnreferencedCode), ProducedBy = Tool.Trimmer,
