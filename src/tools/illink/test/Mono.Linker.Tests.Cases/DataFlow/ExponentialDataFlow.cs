...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class ExponentialDataFlow
	{
		...
		class ArrayStatesDataFlow
		{
			...
			[ExpectedMissingWarning ("IL3050", ProducedBy = Tool.Analyzer)]
		...
		class ExponentialArrayStatesDataFlow
		{
			...
			// this warning.
			[ExpectedMissingWarning ("IL2055", ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL2090", "'T'", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2090", "'T'", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2090", "'T'", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2090", "'T'", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2090", "'T'", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
