...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class MethodByRefParameterDataFlow
	{
		...
		[ExpectedMissingWarning ("IL2072", nameof (DataFlowTypeExtensions.RequiresPublicMethods), ProducedBy = Tool.Analyzer)]
		...
		[ExpectedMissingWarning ("IL2072", nameof (TryGetAnnotatedValue), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		...
		// https://github.com/dotnet/linker/issues/2158
		[ExpectedMissingWarning ("IL2068", nameof (TryGetAnnotatedValue), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
		[ExpectedMissingWarning ("IL2072", nameof (TryGetAnnotatedValue), ProducedBy = Tool.Trimmer | Tool.NativeAot)]
