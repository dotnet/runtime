...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class GetTypeDataFlow
	{
		...
		class TypeWithWarnings
		{
			...
			[ExpectedMissingWarning ("IL2026", "--Method1--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2026", "--Method2--", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
