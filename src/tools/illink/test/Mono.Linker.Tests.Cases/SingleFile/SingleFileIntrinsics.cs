...
namespace Mono.Linker.Tests.Cases.SingleFile
{
    ...
    public class SingleFileIntrinsics
    {
        ...
        [ExpectedWarning("IL3000", Tool.Analyzer | Tool.NativeAot, "NativeAOT specific warning")]
        ...
        [ExpectedWarning("IL3001", Tool.Analyzer | Tool.NativeAot, "NativeAOT specific warning")]
