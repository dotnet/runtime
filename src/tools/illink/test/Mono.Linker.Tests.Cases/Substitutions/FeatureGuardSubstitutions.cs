...
namespace Mono.Linker.Tests.Cases.Substitutions
{
	...
	public class FeatureGuardSubstitutions
	{
		...
		class DefineFeatureGuard {
			...
			[ExpectedMissingWarning ("IL4000", nameof (RequiresDynamicCodeAttribute), ProducedBy = Tool.Analyzer)]
			[ExpectedMissingWarning ("IL4000", nameof (RequiresUnreferencedCodeAttribute), ProducedBy = Tool.Analyzer)]
			[FeatureGuard (typeof (RequiresDynamicCodeAttribute))]
			[FeatureGuard (typeof (RequiresUnreferencedCodeAttribute))]
			...
			[ExpectedMissingWarning ("IL2026", ProducedBy = Tool.Analyzer)] // Analyzer doesn't respect FeatureSwitchDefinition or feature settings
			[ExpectedInstructionSequence (new[] {
				"nop",
				"ldc.i4.0",
				"stloc.0",
