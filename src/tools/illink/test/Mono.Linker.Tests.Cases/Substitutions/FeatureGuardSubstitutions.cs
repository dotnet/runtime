...
namespace Mono.Linker.Tests.Cases.Substitutions
{
    ...
    public class FeatureGuardSubstitutions
    {
        ...
        class DefineFeatureGuard
        {
            ...
            [ExpectedWarning("IL4000", nameof(RequiresUnreferencedCodeAttribute), Tool.Analyzer, "Analyzer does not support feature guard substitutions")]
            [FeatureGuard(typeof(RequiresDynamicCodeAttribute))]
            [FeatureGuard(typeof(RequiresUnreferencedCodeAttribute))]
            ...
            [ExpectedWarning("IL2026", Tool.Analyzer, "Analyzer does not support compiler-generated code warning suppression")] // Analyzer doesn't respect FeatureSwitchDefinition or feature settings
            [ExpectedInstructionSequence(new[] {
                "nop",
                "ldc.i4.0",
                "stloc.0",
