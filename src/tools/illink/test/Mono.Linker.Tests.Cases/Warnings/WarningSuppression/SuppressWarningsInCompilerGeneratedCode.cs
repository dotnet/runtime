...
namespace Mono.Linker.Tests.Cases.Warnings.WarningSuppression
{
	...
	public class SuppressWarningsInCompilerGeneratedCode
	{
		...
		class SuppressInLocalFunction
		{
			...
			[UnconditionalSuppressMessage ("Test", "IL2121", Justification = "The IL2026 warning is issued only by the analyzer, for the ILLink this suppression is redundant.")]
			[UnconditionalSuppressMessage ("Test", "IL2026")]
			...
			{
				[ExpectedMissingWarning ("IL2118", "LocalFunction", ProducedBy = Tool.Trimmer)]
				[UnconditionalSuppressMessage ("Test", "IL2026")]
		...
		class SuppressInLambda
		{
			...
			{
				[ExpectedMissingWarning ("IL2118", nameof (TestCallRUCMethodInDynamicallyAccessedLambda), ProducedBy = Tool.Trimmer)]
				[UnconditionalSuppressMessage ("Test", "IL2026")]
		...
		class SuppressInComplex
		{
			...
			[ExpectedMissingWarning ("IL2026", CompilerGeneratedCode = true, ProducedBy = Tool.Trimmer | Tool.NativeAot)]
			[ExpectedMissingWarning ("IL2121", CompilerGeneratedCode = true, ProducedBy = Tool.Trimmer)]
