...
namespace Mono.Linker.Tests.Cases.Expectations.Assertions
{
    ...
    public class KeptByAttribute : KeptAttribute
    {
        ...
        /// <summary>
        /// Place on an type member to indicate that the trimming tool should log that the member is kept as a depenendency of <paramref name="dependencyProvider"/> with reason <paramref name="reason"/>.
        /// </summary>
        ...
        /// <summary>
        /// Place on an type member to indicate that the trimming tool should log that the member is kept as a depenendency of <paramref name="dependencyProviderType"/> with reason <paramref name="reason"/>.
        /// </summary>
        ...
        /// <summary>
        /// Place on an type member to indicate that the trimming tool should log that the member is kept as a depenendency of <paramref name="dependencyProviderType"/>.<paramref name="memberName"/> with reason <paramref name="reason"/>.
        /// </summary>
