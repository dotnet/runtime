...
public partial class CILParser : Parser {
	...
	public const int
		...
		INSTR_FIELD=285, INSTR_TOK=286, DOTTEDNAME=287, ID=288, WS=289, SINGLE_LINE_COMMENT=290, 
		COMMENT=291, PERMISSION=292, PERMISSIONSET=293, EMITBYTE=294, MAXSTACK=295, 
		ENTRYPOINT=296, ZEROINIT=297, LOCALS=298, EXPORT=299, OVERRIDE=300, VTENTRY=301, 
		IncludedFileEof=302, SyntheticIncludedFileEof=303;
	public const int
	...
	public DeclsContext decls() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 986285952729088L) != 0) || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & 281474976710659L) != 0) || ((((_la - 139)) & ~0x3f) == 0 && ((1L << (_la - 139)) & 288230376218820609L) != 0) || ((((_la - 263)) & ~0x3f) == 0 && ((1L << (_la - 263)) & 1660946425L) != 0)) {
				{
				{
				State = 389;
				decl();
	...
	public ClassDeclsContext classDecls() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (((((_la - 26)) & ~0x3f) == 0 && ((1L << (_la - 26)) & 211106240921889L) != 0) || ((((_la - 116)) & ~0x3f) == 0 && ((1L << (_la - 116)) & 562949961945115L) != 0) || ((((_la - 254)) & ~0x3f) == 0 && ((1L << (_la - 254)) & 106403520311809L) != 0)) {
				{
				{
				State = 772;
				classDecl();
	...
	public AssemblyDeclsContext assemblyDecls() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (_la==T__30 || _la==T__33 || ((((_la - 167)) & ~0x3f) == 0 && ((1L << (_la - 167)) & 4103L) != 0) || ((((_la - 263)) & ~0x3f) == 0 && ((1L << (_la - 263)) & 1660945401L) != 0)) {
				{
				{
				State = 1115;
				assemblyDecl();
	...
	public MethodDeclsContext methodDecls() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 19394592766L) != 0) || _la==T__71 || _la==T__72 || _la==T__157 || _la==T__164 || ((((_la - 246)) & ~0x3f) == 0 && ((1L << (_la - 246)) & 71993822228381953L) != 0)) {
				{
				{
				State = 2063;
				methodDecl();
	...
	private static int[] _serializedATN = {
		4,1,303,2836,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		172,288,288,2,0,178,178,263,263,1,0,50,51,3241,0,366,1,0,0,0,2,378,1,0,
		...
		894,896,5,296,0,0,895,893,1,0,0,0,895,894,1,0,0,0,896,91,1,0,0,0,897,898,
		...
		1377,1,0,0,0,1379,169,1,0,0,0,1380,1381,5,292,0,0,1381,1382,3,184,92,0,
		1382,1383,3,142,71,0,1383,1384,5,29,0,0,1384,1385,3,176,88,0,1385,1386,
		5,30,0,0,1386,1421,1,0,0,0,1387,1388,5,292,0,0,1388,1389,3,184,92,0,1389,
		1390,3,142,71,0,1390,1391,5,35,0,0,1391,1392,5,16,0,0,1392,1393,3,48,24,
		0,1393,1394,5,17,0,0,1394,1421,1,0,0,0,1395,1396,5,292,0,0,1396,1397,3,
		184,92,0,1397,1398,3,142,71,0,1398,1421,1,0,0,0,1399,1400,5,293,0,0,1400,
		...
		154,0,1407,1408,5,30,0,0,1408,1421,1,0,0,0,1409,1410,5,293,0,0,1410,1411,
		3,184,92,0,1411,1412,3,4,2,0,1412,1421,1,0,0,0,1413,1414,5,293,0,0,1414,
		...
		1687,5,17,0,0,1687,1771,1,0,0,0,1688,1689,5,300,0,0,1689,1690,3,142,71,
		...
		5,300,0,0,1701,1702,5,225,0,0,1702,1703,3,188,94,0,1703,1704,3,156,78,
		...
		2178,3,122,61,0,2070,2071,5,294,0,0,2071,2178,3,28,14,0,2072,2178,3,274,
		137,0,2073,2074,5,295,0,0,2074,2178,3,28,14,0,2075,2076,5,298,0,0,2076,
		2178,3,130,65,0,2077,2078,5,298,0,0,2078,2079,5,157,0,0,2079,2178,3,130,
		65,0,2080,2178,5,296,0,0,2081,2178,5,297,0,0,2082,2178,3,292,146,0,2083,
		2178,3,268,134,0,2084,2178,3,170,85,0,2085,2178,3,84,42,0,2086,2178,3,
		24,12,0,2087,2178,3,270,135,0,2088,2178,3,36,18,0,2089,2090,5,299,0,0,
		2090,2091,5,41,0,0,2091,2092,3,28,14,0,2092,2093,5,42,0,0,2093,2178,1,
		0,0,0,2094,2095,5,299,0,0,2095,2096,5,41,0,0,2096,2097,3,28,14,0,2097,
		2098,5,42,0,0,2098,2099,5,33,0,0,2099,2100,3,0,0,0,2100,2178,1,0,0,0,2101,
		2102,5,301,0,0,2102,2103,3,28,14,0,2103,2104,5,74,0,0,2104,2105,3,28,14,
		0,2105,2178,1,0,0,0,2106,2107,5,300,0,0,2107,2108,3,142,71,0,2108,2109,
		5,175,0,0,2109,2110,3,260,130,0,2110,2178,1,0,0,0,2111,2112,5,300,0,0,
		...
		349,1,0,0,0,2747,2751,5,299,0,0,2748,2750,3,352,176,0,2749,2748,1,0,0,
