...
public static class DiagnosticIds
{
    ...
    public const string PseudoCustomAttributeInvalidTarget = "ILA0046";
    public const string PseudoCustomAttributeInvalidValue = "ILA0047";
    public const string PseudoCustomAttributeInvalidBlob = "ILA0048";
    public const string PseudoCustomAttributeInvalidGuid = "ILA0049";
