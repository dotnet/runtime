...
internal sealed partial class GrammarActions
{
    ...
    private sealed class DataDeclarationFrame
    {
        ...
        public List<DataLabelReference>? ReferenceFixups { get; set; }
    ...
    internal void EndDataDeclaration(CILParser.DataDeclContext context)
    {
        ...
        foreach (DataLabelReference reference in frame.ReferenceFixups)
        {
...
#pragma warning restore CA1822
    ...
    internal void AddDataReference(CILParser.DdItemContext context, IToken targetToken)
    {
        ...
        frame.ReferenceFixups ??= new List<DataLabelReference>();
        frame.ReferenceFixups.Add(new DataLabelReference(
            target,
            frame.Data.Count,
            pointerSize,
            context));
        frame.Data.ReserveBytes(pointerSize);
    }
