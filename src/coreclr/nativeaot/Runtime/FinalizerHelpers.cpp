...
QCIMPL(void, RhInitializeFinalizerThread)
{
    g_FinalizerEvent.Set();
}

QCIMPL(void, RhWaitForPendingFinalizers, UInt32_BOOL allowReentrantWait)
{
...
QCIMPL(UInt32_BOOL, RhpWaitForFinalizerRequest)
{
...
QCIMPL(void, RhpSignalFinalizationComplete, uint32_t fcount)
{
