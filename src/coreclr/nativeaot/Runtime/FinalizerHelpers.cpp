...
EXTERN_C NATIVEAOT_API void QCALLTYPE ProcessFinalizers();
...
EXTERN_C NATIVEAOT_API void QCALLTYPE RhInitializeFinalizerThread()
{
    g_FinalizerEvent.Set();
}

EXTERN_C NATIVEAOT_API void QCALLTYPE RhWaitForPendingFinalizers(UInt32_BOOL allowReentrantWait)
{
...
EXTERN_C NATIVEAOT_API UInt32_BOOL QCALLTYPE RhpWaitForFinalizerRequest()
{
...
EXTERN_C NATIVEAOT_API void QCALLTYPE RhpSignalFinalizationComplete(uint32_t fcount)
{
