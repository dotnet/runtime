...
ASM_OFFSET(   2c,    3c, Thread, m_generation)
ASM_OFFSET(   30,    40, Thread, m_pTransitionFrame)
ASM_OFFSET(   34,    48, Thread, m_pDeferredTransitionFrame)
ASM_OFFSET(   44,    68, Thread, m_ppvHijackedReturnAddressLocation)
ASM_OFFSET(   48,    70, Thread, m_pvHijackedReturnAddress)
ASM_OFFSET(   4c,    78, Thread, m_uHijackedReturnValueFlags)
ASM_OFFSET(   50,    80, Thread, m_pExInfoStackHead)
ASM_OFFSET(   54,    88, Thread, m_threadAbortException)
