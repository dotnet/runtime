...
ASM_OFFSET(   0,      0, Thread, m_ThreadStateFlags)
ASM_OFFSET(   4,      8, Thread, m_pTransitionFrame)
ASM_OFFSET(   8,     10, Thread, m_pDeferredTransitionFrame)
ASM_OFFSET(  18,     30, Thread, m_ppvHijackedReturnAddressLocation)
ASM_OFFSET(  1c,     38, Thread, m_pvHijackedReturnAddress)
ASM_OFFSET(  20,     40, Thread, m_uHijackedReturnValueFlags)
ASM_OFFSET(  24,     48, Thread, m_pExInfoStackHead)
ASM_OFFSET(  28,     50, Thread, m_threadAbortException)
ASM_OFFSET(  2c,     58, Thread, m_palloc_context)
