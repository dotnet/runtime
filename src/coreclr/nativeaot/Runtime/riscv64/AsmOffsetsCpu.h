...
PLAT_ASM_SIZEOF(328, StackFrameIterator)
...
PLAT_ASM_OFFSET(318, StackFrameIterator, m_OriginalControlPC)
PLAT_ASM_OFFSET(320, StackFrameIterator, m_pPreviousTransitionFrame)
...
PLAT_ASM_OFFSET(40, REGDISPLAY, pS1)
PLAT_ASM_OFFSET(88, REGDISPLAY, pS2)
PLAT_ASM_OFFSET(90, REGDISPLAY, pS3)
PLAT_ASM_OFFSET(98, REGDISPLAY, pS4)
PLAT_ASM_OFFSET(A0, REGDISPLAY, pS5)
PLAT_ASM_OFFSET(A8, REGDISPLAY, pS6)
PLAT_ASM_OFFSET(B0, REGDISPLAY, pS7)
PLAT_ASM_OFFSET(B8, REGDISPLAY, pS8)
PLAT_ASM_OFFSET(C0, REGDISPLAY, pS9)
PLAT_ASM_OFFSET(C8, REGDISPLAY, pS10)
PLAT_ASM_OFFSET(D0, REGDISPLAY, pS11)
PLAT_ASM_OFFSET(38, REGDISPLAY, pFP)
