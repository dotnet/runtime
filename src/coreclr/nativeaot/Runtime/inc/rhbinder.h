...
enum PInvokeTransitionFrameFlags : uint64_t
{
    ...
    // used by hijack handler to report return value of hijacked method
    PTFF_A0_IS_GCREF    = 0x0000000080000000,
    PTFF_A0_IS_BYREF    = 0x0000000100000000,
    PTFF_A1_IS_GCREF    = 0x0000000200000000,
    PTFF_A1_IS_BYREF    = 0x0000000400000000,

    PTFF_THREAD_ABORT   = 0x0000000800000000,
};
