...
// A few settings are now backed by the cut-down version of NativeAOT configuration values.
...
// -----------------------------------------------------------------------------------------------------------
//
// The automatically generated part of the NativeAOT ETW infrastructure (EtwEvents.h) calls the following
...
// -----------------------------------------------------------------------------------------------------------
//
// The rest of NativeAOT needs to be able to talk to the GC/HandleTable code (to initialize it, allocate
// objects etc.) without pulling in the entire adaptation layer provided by this file and gcrhenv.h. To this
// end the rest of NativeAOT talks to us via a simple interface described in gcrhinterface.h. We provide the
...
bool NativeAOTGCInterface::InitializeSubsystems()
{
    ...
    // Register the NativeAOT event provider with the system.
...
bool GCToEEInterface::CreateThread(void (*threadStart)(void*), void* arg, bool is_suspendable, const char* name)
{
    ...
    // NativeAOT thread state which requires running in the new thread's context.
