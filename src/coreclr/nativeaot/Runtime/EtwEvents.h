...
// merges any additional NativeAOT-specific events from EtwNativeAOTEvents.xml. The result is an updated version
// of this header file plus EtwEvents.man, a new ETW manifest file describing the final NativeAOT events which
...
extern "C" __declspec(selectany) REGHANDLE Microsoft_Windows_NativeAOT_GC_PublicHandle;
extern "C" __declspec(selectany) RH_ETW_CONTEXT MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context;

#define RH_ETW_REGISTER_Microsoft_Windows_NativeAOT_GC_Public() do { PalEventRegister(&MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER, RhEtwControlCallback, &MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context, &Microsoft_Windows_NativeAOT_GC_PublicHandle); } while (false)
#define RH_ETW_UNREGISTER_Microsoft_Windows_NativeAOT_GC_Public() do { PalEventUnregister(Microsoft_Windows_NativeAOT_GC_PublicHandle); } while (false)

#define FireEtwBulkType(Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &BulkType)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_BulkType(Microsoft_Windows_NativeAOT_GC_PublicHandle, &BulkType, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwDestroyGCHandle(HandleID, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &DestroyGCHandle)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_DestroyGCHandle(Microsoft_Windows_NativeAOT_GC_PublicHandle, &DestroyGCHandle, HandleID, ClrInstanceID) : 0

#define FireEtwExceptionThrown_V1(ExceptionType, ExceptionMessage, ExceptionEIP, ExceptionHRESULT, ExceptionFlags, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &ExceptionThrown_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Exception(Microsoft_Windows_NativeAOT_GC_PublicHandle, &ExceptionThrown_V1, ExceptionType, ExceptionMessage, ExceptionEIP, ExceptionHRESULT, ExceptionFlags, ClrInstanceID) : 0

#define FireEtwGCAllocationTick_V1(AllocationAmount, AllocationKind, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCAllocationTick_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCAllocationTick_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCAllocationTick_V1, AllocationAmount, AllocationKind, ClrInstanceID) : 0

#define FireEtwGCAllocationTick_V2(AllocationAmount, AllocationKind, ClrInstanceID, AllocationAmount64, TypeID, TypeName, HeapIndex) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCAllocationTick_V2)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCAllocationTick_V2(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCAllocationTick_V2, AllocationAmount, AllocationKind, ClrInstanceID, AllocationAmount64, TypeID, TypeName, HeapIndex) : 0

#define FireEtwGCAllocationTick_V3(AllocationAmount, AllocationKind, ClrInstanceID, AllocationAmount64, TypeID, TypeName, HeapIndex, Address) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCAllocationTick_V3)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCAllocationTick_V3(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCAllocationTick_V3, AllocationAmount, AllocationKind, ClrInstanceID, AllocationAmount64, TypeID, TypeName, HeapIndex, Address) : 0

#define FireEtwGCBulkEdge(Index, Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkEdge)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkEdge(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkEdge, Index, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkMovedObjectRanges(Index, Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkMovedObjectRanges)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkMovedObjectRanges(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkMovedObjectRanges, Index, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkNode(Index, Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkNode)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkNode(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkNode, Index, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkRCW(Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRCW)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkRCW(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRCW, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkRootCCW(Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRootCCW)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkRootCCW(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRootCCW, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkRootConditionalWeakTableElementEdge(Index, Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRootConditionalWeakTableElementEdge)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkRootConditionalWeakTableElementEdge(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRootConditionalWeakTableElementEdge, Index, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkRootEdge(Index, Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRootEdge)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkRootEdge(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkRootEdge, Index, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCBulkSurvivingObjectRanges(Index, Count, ClrInstanceID, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkSurvivingObjectRanges)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCBulkSurvivingObjectRanges(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCBulkSurvivingObjectRanges, Index, Count, ClrInstanceID, Values_Len_, Values) : 0

#define FireEtwGCCreateConcurrentThread_V1(ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCCreateConcurrentThread_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCCreateConcurrentThread(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCCreateConcurrentThread_V1, ClrInstanceID) : 0

#define FireEtwGCCreateSegment_V1(Address, Size, Type, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCCreateSegment_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCCreateSegment_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCCreateSegment_V1, Address, Size, Type, ClrInstanceID) : 0

#define FireEtwGCEnd_V1(Count, Depth, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCEnd_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCEnd_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCEnd_V1, Count, Depth, ClrInstanceID) : 0

#define FireEtwGCFreeSegment_V1(Address, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCFreeSegment_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCFreeSegment_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCFreeSegment_V1, Address, ClrInstanceID) : 0

#define FireEtwGCGenerationRange(Generation, RangeStart, RangeUsedLength, RangeReservedLength, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCGenerationRange)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCGenerationRange(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCGenerationRange, Generation, RangeStart, RangeUsedLength, RangeReservedLength, ClrInstanceID) : 0

#define FireEtwGCGlobalHeapHistory_V2(FinalYoungestDesired, NumHeaps, CondemnedGeneration, Gen0ReductionCount, Reason, GlobalMechanisms, ClrInstanceID, PauseMode, MemoryPressure) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCGlobalHeapHistory_V2)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCGlobalHeap_V2(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCGlobalHeapHistory_V2, FinalYoungestDesired, NumHeaps, CondemnedGeneration, Gen0ReductionCount, Reason, GlobalMechanisms, ClrInstanceID, PauseMode, MemoryPressure) : 0

#define FireEtwGCHeapStats_V1(GenerationSize0, TotalPromotedSize0, GenerationSize1, TotalPromotedSize1, GenerationSize2, TotalPromotedSize2, GenerationSize3, TotalPromotedSize3, FinalizationPromotedSize, FinalizationPromotedCount, PinnedObjectCount, SinkBlockCount, GCHandleCount, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCHeapStats_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCHeapStats_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCHeapStats_V1, GenerationSize0, TotalPromotedSize0, GenerationSize1, TotalPromotedSize1, GenerationSize2, TotalPromotedSize2, GenerationSize3, TotalPromotedSize3, FinalizationPromotedSize, FinalizationPromotedCount, PinnedObjectCount, SinkBlockCount, GCHandleCount, ClrInstanceID) : 0

#define FireEtwGCJoin_V2(Heap, JoinTime, JoinType, ClrInstanceID, JoinID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCJoin_V2)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCJoin_V2(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCJoin_V2, Heap, JoinTime, JoinType, ClrInstanceID, JoinID) : 0

#define FireEtwGCMarkFinalizeQueueRoots(HeapNum, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkFinalizeQueueRoots)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCMark(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkFinalizeQueueRoots, HeapNum, ClrInstanceID) : 0

#define FireEtwGCMarkHandles(HeapNum, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkHandles)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCMark(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkHandles, HeapNum, ClrInstanceID) : 0

#define FireEtwGCMarkOlderGenerationRoots(HeapNum, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkOlderGenerationRoots)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCMark(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkOlderGenerationRoots, HeapNum, ClrInstanceID) : 0

#define FireEtwGCMarkStackRoots(HeapNum, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkStackRoots)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCMark(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkStackRoots, HeapNum, ClrInstanceID) : 0

#define FireEtwGCMarkWithType(HeapNum, ClrInstanceID, Type, Bytes) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkWithType)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCMarkWithType(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCMarkWithType, HeapNum, ClrInstanceID, Type, Bytes) : 0

#define FireEtwGCPerHeapHistory_V3(ClrInstanceID, FreeListAllocated, FreeListRejected, EndOfSegAllocated, CondemnedAllocated, PinnedAllocated, PinnedAllocatedAdvance, RunningFreeListEfficiency, CondemnReasons0, CondemnReasons1, CompactMechanisms, ExpandMechanisms, HeapIndex, ExtraGen0Commit, Count, Values_Len_, Values) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCPerHeapHistory_V3)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCPerHeapHistory_V3(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCPerHeapHistory_V3, ClrInstanceID, FreeListAllocated, FreeListRejected, EndOfSegAllocated, CondemnedAllocated, PinnedAllocated, PinnedAllocatedAdvance, RunningFreeListEfficiency, CondemnReasons0, CondemnReasons1, CompactMechanisms, ExpandMechanisms, HeapIndex, ExtraGen0Commit, Count, Values_Len_, Values) : 0

#define FireEtwGCRestartEEBegin_V1(ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCRestartEEBegin_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCNoUserData(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCRestartEEBegin_V1, ClrInstanceID) : 0

#define FireEtwGCRestartEEEnd_V1(ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCRestartEEEnd_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCNoUserData(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCRestartEEEnd_V1, ClrInstanceID) : 0

#define FireEtwGCStart_V1(Count, Depth, Reason, Type, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCStart_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCStart_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCStart_V1, Count, Depth, Reason, Type, ClrInstanceID) : 0

#define FireEtwGCStart_V2(Count, Depth, Reason, Type, ClrInstanceID, ClientSequenceNumber) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCStart_V2)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCStart_V2(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCStart_V2, Count, Depth, Reason, Type, ClrInstanceID, ClientSequenceNumber) : 0

#define FireEtwGCSuspendEEBegin_V1(Reason, Count, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCSuspendEEBegin_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCSuspendEE_V1(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCSuspendEEBegin_V1, Reason, Count, ClrInstanceID) : 0

#define FireEtwGCSuspendEEEnd_V1(ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCSuspendEEEnd_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCNoUserData(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCSuspendEEEnd_V1, ClrInstanceID) : 0

#define FireEtwGCTerminateConcurrentThread_V1(ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCTerminateConcurrentThread_V1)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCTerminateConcurrentThread(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCTerminateConcurrentThread_V1, ClrInstanceID) : 0

#define FireEtwGCTriggered(Reason, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCTriggered)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_GCTriggered(Microsoft_Windows_NativeAOT_GC_PublicHandle, &GCTriggered, Reason, ClrInstanceID) : 0

#define FireEtwModuleLoad_V2(ModuleID, AssemblyID, ModuleFlags, Reserved1, ModuleILPath, ModuleNativePath, ClrInstanceID, ManagedPdbSignature, ManagedPdbAge, ManagedPdbBuildPath, NativePdbSignature, NativePdbAge, NativePdbBuildPath) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &ModuleLoad_V2)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_ModuleLoadUnload_V2(Microsoft_Windows_NativeAOT_GC_PublicHandle, &ModuleLoad_V2, ModuleID, AssemblyID, ModuleFlags, Reserved1, ModuleILPath, ModuleNativePath, ClrInstanceID, ManagedPdbSignature, ManagedPdbAge, ManagedPdbBuildPath, NativePdbSignature, NativePdbAge, NativePdbBuildPath) : 0

#define FireEtwSetGCHandle(HandleID, ObjectID, Kind, Generation, AppDomainID, ClrInstanceID) (MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_Context.IsEnabled && PalEventEnabled(Microsoft_Windows_NativeAOT_GC_PublicHandle, &SetGCHandle)) ? Template_MICROSOFT_WINDOWS_NativeAOT_GC_PUBLIC_PROVIDER_SetGCHandle(Microsoft_Windows_NativeAOT_GC_PublicHandle, &SetGCHandle, HandleID, ObjectID, Kind, Generation, AppDomainID, ClrInstanceID) : 0
