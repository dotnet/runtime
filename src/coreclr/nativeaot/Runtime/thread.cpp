...
EXTERN_C NativeAOT_API void* NativeAOT_CALLCONV RhpHandleAlloc(void* pObject, int type);
EXTERN_C NativeAOT_API void NativeAOT_CALLCONV RhHandleSet(void* handle, void* pObject);
EXTERN_C NativeAOT_API void NativeAOT_CALLCONV RhHandleFree(void* handle);
...
// NativeAOT-specific data is stored.
