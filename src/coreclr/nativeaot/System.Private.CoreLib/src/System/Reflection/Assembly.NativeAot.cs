    ...
    public abstract partial class Assembly : ICustomAttributeProvider, ISerializable
    {
        ...
        internal static uint GetAssemblyCount()
        {
            if (s_assemblyCount == 0)
                s_assemblyCount = (uint)Internal.Reflection.Core.Execution.ReflectionCoreExecution.ExecutionDomain.ExecutionEnvironment.AssemblyBinder.GetLoadedAssemblies().Count;
