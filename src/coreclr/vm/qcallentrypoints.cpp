...
static const Entry s_QCall[] =
{
    ...
    DllImportEntry(COMModule_GetType)
    DllImportEntry(COMModule_GetScopeName)
    DllImportEntry(COMModule_GetFullyQualifiedName)
    DllImportEntry(COMModule_GetStringConstant)
    DllImportEntry(COMModule_GetTypeRef)
    DllImportEntry(COMModule_GetTokenFromTypeSpec)
    DllImportEntry(COMModule_GetMemberRef)
    DllImportEntry(COMModule_GetMemberRefOfMethodInfo)
    DllImportEntry(COMModule_GetMemberRefOfFieldInfo)
    DllImportEntry(COMModule_GetMemberRefFromSignature)
    DllImportEntry(COMModule_GetHINSTANCE)
    DllImportEntry(COMModule_GetArrayMethodToken)
    DllImportEntry(COMModule_SetFieldRVAContent)
    ...
    DllImportEntry(COMDynamicWrite_DefineGenericParam)
    DllImportEntry(COMDynamicWrite_DefineType)
    DllImportEntry(COMDynamicWrite_SetParentType)
    DllImportEntry(COMDynamicWrite_AddInterfaceImpl)
    DllImportEntry(COMDynamicWrite_DefineMethod)
    DllImportEntry(COMDynamicWrite_DefineMethodSpec)
    DllImportEntry(COMDynamicWrite_SetMethodIL)
    DllImportEntry(COMDynamicWrite_TermCreateClass)
    DllImportEntry(COMDynamicWrite_DefineField)
    DllImportEntry(COMDynamicWrite_DefineProperty)
    DllImportEntry(COMDynamicWrite_DefineEvent)
    DllImportEntry(COMDynamicWrite_DefineMethodSemantics)
    DllImportEntry(COMDynamicWrite_SetMethodImpl)
    DllImportEntry(COMDynamicWrite_DefineMethodImpl)
    DllImportEntry(COMDynamicWrite_GetTokenFromSig)
    DllImportEntry(COMDynamicWrite_SetFieldLayoutOffset)
    DllImportEntry(COMDynamicWrite_SetClassLayout)
    DllImportEntry(COMDynamicWrite_SetParamInfo)
    DllImportEntry(COMDynamicWrite_SetPInvokeData)
    DllImportEntry(COMDynamicWrite_SetConstantValue)
    DllImportEntry(COMDynamicWrite_DefineCustomAttribute)
...
{
    return ResolveDllImport(s_QCall, lengthof(s_QCall), name);
}
