...
PTR_Bucket HashMap::Buckets()
{
    ...
    _ASSERTE (!g_fEEStarted || !m_fAsyncMode || GetThread() == NULL || GetThreaNotOk()->PreemptiveGCDisabled() || IsGCThread());
#endif
...
void HashMap::Rehash()
{
    ...
    _ASSERTE (!g_fEEStarted || !m_fAsyncMode || GetThread() == NULL || GetThreaNotOk()->PreemptiveGCDisabled());
    _ASSERTE (OwnLock());
#endif
