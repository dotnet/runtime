...
PTR_Bucket HashMap::Buckets()
{
    ...
    _ASSERTE (!g_fEEStarted || !m_fAsyncMode || GetThreadNULLOk() == NULL || GetThreaNotOk()->PreemptiveGCDisabled() || IsGCThread());
#endif
...
void HashMap::Rehash()
{
    ...
    _ASSERTE (!g_fEEStarted || !m_fAsyncMode || GetThreadNULLOk() == NULL || GetThreaNotOk()->PreemptiveGCDisabled());
    _ASSERTE (OwnLock());
#endif
