                                                  ...
                                                  BOOL getWrappedCode)
{
...

    {
        ...
        pNewMD = FindLoadedInstantiatedMethodDesc(pExactMT,
                                                  ...
                                                  methodInst,
                                                  getWrappedCode,
                                                  pGenericMDescInRepMT->IsAsyncHelperMethod());
                                                     ...
                                                     MethodDesc *pCanonicalMD)
{
    ...
    InstantiatedMethodDesc *pInstMD = FindLoadedInstantiatedMethodDesc(pExactMT,
                                                                       ...
                                                                       Instantiation(),
                                                                       FALSE,
                                                                       pCanonicalMD->IsAsyncHelperMethod());
    ...
    else if (forceBoxedEntryPoint)
    {
        ...
        if (methodInst.IsEmpty())
        {
            ...
            pResultMD = pTable->FindMethodDesc(TypeHandle(pRepMT),
                                               ...
                                               Instantiation(),
                                               FALSE /* no inst param */,
                                               pMDescInCanonMT->IsAsyncHelperMethod());
        ...
        else
        {
            ...
            if (!pResultMD)
            {
                ...
                _ASSERTE(pNonUnboxingStub->IsAsyncHelperMethod() == pMDescInCanonMT->IsAsyncHelperMethod());
                ...
                pResultMD = pTable->FindMethodDesc(TypeHandle(pExactMT),
                                                   ...
                                                   methodInst,
                                                   FALSE /* no inst param */,
                                                   pNonUnboxingStub->IsAsyncHelperMethod());
