...
void GCToEEInterface::UpdateGCEventStatus(int currentPublicLevel, int currentPublicKeywords, int currentPrivateLevel, int currentPrivateKeywords)
{
    ...
    BOOL keyword_gc_pause_informational = EventXplatEnabledGCPause_V1() || EventPipeEventEnabledGCPause_V1();
    ...
    int publicProviderLevel = keyword_gc_verbose ? GCEventLevel_Verbose :
                                 ((keyword_gc_informational || keyword_gc_pause_informational || keyword_gc_heapsurvival_and_movement_informational) ? GCEventLevel_Information : GCEventLevel_None);
    int publicProviderKeywords = (keyword_gc_informational ? GCEventKeyword_GC : GCEventKeyword_None) |
                                 (keyword_gc_pause_informational ? GCEventKeyword_GCPause : GCEventKeyword_None) |
