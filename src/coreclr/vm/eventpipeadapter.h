...
public:
	...
	static inline EventPipeProvider * CreateProvider(const WCHAR* providerName, EventPipeCallback callback, void* callbackContext = nullptr, bool callbackDataIncludesGeneration = false)
	{
		CONTRACTL
		{
			NOTHROW;
		...
		EventPipeProvider * provider = ep_create_provider_2 (providerNameUTF8, callback, callbackContext, callbackDataIncludesGeneration);
