...
DEFINE_METHOD(STRING,               GET_NONRANDOMIZED_HASHCODE, GetNonRandomizedHashCode, IM_RetInt)
DEFINE_METHOD(STRING,               GET_NONRANDOMIZED_HASHCODE_IGNORECASE, GetNonRandomizedHashCodeOrdinalIgnoreCase, IM_RetInt)
