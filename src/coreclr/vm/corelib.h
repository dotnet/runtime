...
DEFINE_METHOD(APPCONTEXT,   SETUP,              Setup,          SM_PtrPtrChar_PtrPtrChar_Int_PtrObjectHandleOnStack_RetVoid)
...
DEFINE_CLASS(OBJECT_HANDLE_ON_STACK, CompilerServices, ObjectHandleOnStack)
...
DEFINE_METHOD(MNGD_REF_CUSTOM_MARSHALER, CONVERT_CONTENTS_TO_NATIVE_UCO,  ConvertContentsToNative,    SM_PtrObjectHandleOnStack_PtrObjectHandleOnStack_PtrIntPtr_PtrObjectHandleOnStack_RetVoid)
DEFINE_METHOD(MNGD_REF_CUSTOM_MARSHALER, CONVERT_CONTENTS_TO_MANAGED_UCO, ConvertContentsToManaged,   SM_PtrObjectHandleOnStack_PtrObjectHandleOnStack_PtrIntPtr_PtrObjectHandleOnStack_RetVoid)
DEFINE_METHOD(MNGD_REF_CUSTOM_MARSHALER, CLEAR_NATIVE_UCO,                ClearNative,                SM_PtrObjectHandleOnStack_PtrObjectHandleOnStack_PtrIntPtr_PtrObjectHandleOnStack_RetVoid)
DEFINE_METHOD(MNGD_REF_CUSTOM_MARSHALER, CLEAR_MANAGED_UCO,               ClearManaged,               SM_PtrObjectHandleOnStack_PtrObjectHandleOnStack_PtrIntPtr_PtrObjectHandleOnStack_RetVoid)
