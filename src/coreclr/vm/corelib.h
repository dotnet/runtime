...
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  RESOLVE,               Resolve,                   SM_IntPtr_PtrObj_PtrObj_PtrObj_RetVoid)
...
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  RESOLVEUSINGEVENT,             ResolveUsingResolvingEvent,    SM_IntPtr_PtrObj_PtrObj_PtrObj_RetVoid)
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  RESOLVESATELLITEASSEMBLY,      ResolveSatelliteAssembly,      SM_IntPtr_PtrObj_PtrObj_PtrObj_RetVoid)
DEFINE_FIELD(ASSEMBLYLOADCONTEXT,   ASSEMBLY_LOAD,              AssemblyLoad)
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  ON_ASSEMBLY_LOAD,           OnAssemblyLoad,             SM_PtrObj_PtrObj_RetVoid)
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  ON_RESOURCE_RESOLVE,        OnResourceResolve,          SM_PtrObj_PtrSByte_PtrObj_PtrObj_RetVoid)
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  ON_TYPE_RESOLVE,            OnTypeResolve,              SM_PtrObj_PtrSByte_PtrObj_PtrObj_RetVoid)
DEFINE_METHOD(ASSEMBLYLOADCONTEXT,  ON_ASSEMBLY_RESOLVE,        OnAssemblyResolve,          SM_PtrObj_PtrSByte_PtrObj_PtrObj_RetVoid)
