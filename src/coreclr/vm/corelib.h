...
DEFINE_METHOD(STARTUP_HOOK_PROVIDER, MAIN_WRAPPER, MainWrapper, SM_Obj_RetVoid)
DEFINE_METHOD(STARTUP_HOOK_PROVIDER, MAIN_WRAPPER_VOID, MainWrapperVoid, SM_Obj_RetVoid)
