...
DEFINE_METHOD(UTF8STRINGMARSHALLER_IN, FROM_UNMANAGED, FromUnmanaged, IM_PtrByte_RetVoid)
DEFINE_METHOD(UTF8STRINGMARSHALLER_IN, TO_MANAGED, ToManaged, IM_RetStr)
