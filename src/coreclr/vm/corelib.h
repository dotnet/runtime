...
DEFINE_METHOD(RESOLVER,             GET_EH_INFO,            GetEHInfo,                  SM_PtrResolver_Int_PtrVoid_PtrException_RetVoid)
DEFINE_METHOD(RESOLVER,             GET_RAW_EH_INFO,        GetRawEHInfo,               SM_PtrResolver_PtrArrByte_PtrException_RetVoid)
