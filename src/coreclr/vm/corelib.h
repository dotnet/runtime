...
DEFINE_CLASS(BINDER_ASSEMBLYBINDER, InternalLoader, AssemblyBinder)
DEFINE_METHOD(BINDER_ASSEMBLYBINDER, GETLOADERALLOCATOR, GetLoaderAllocator, IM_RetObj)
DEFINE_METHOD(BINDER_ASSEMBLYBINDER, ADDLOADEDASSEMBLY, AddLoadedAssembly, IM_VoidPtr_RetVoid)
DEFINE_METHOD(BINDER_ASSEMBLYBINDER, BINDUSINGPEIMAGE, BindUsingPEImage, IM_IntPtr_Bool_RefObj_RetInt)
DEFINE_METHOD(BINDER_ASSEMBLYBINDER, BINDASSEMBLYBYNAME, BindAssemblyByName, IM_PtrVoid_RefObj_RetInt)
