...
DEFINE_METHOD(TASK, FROM_EXCEPTION_T, FromException, GM_Exception_RetTaskOfT)
...
DEFINE_METHOD(RUNTIME_TASK_STATE_1, PUSH, Push, NoSig)
DEFINE_METHOD(RUNTIME_TASK_STATE_1, POP, Pop, NoSig)
...
DEFINE_CLASS(RUNTIME_TASK_STATE, Tasks, RuntimeTaskState)
DEFINE_METHOD(RUNTIME_TASK_STATE, PUSH, Push, NoSig)
DEFINE_METHOD(RUNTIME_TASK_STATE, POP, Pop, NoSig)
DEFINE_METHOD(RUNTIME_TASK_STATE, FROM_EXCEPTION, FromException, IM_Exception_RetTask)
DEFINE_METHOD(RUNTIME_TASK_STATE, FROM_RESULT, FromResult, IM_RetTask)

DEFINE_CLASS(RUNTIME_VALUETASK_STATE_1, Tasks, RuntimeValueTaskState`1)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE_1, PUSH, Push, NoSig)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE_1, POP, Pop, NoSig)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE_1, FROM_EXCEPTION, FromException, IM_Exception_RetValueTaskOfT)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE_1, FROM_RESULT, FromResult, IM_T_RetValueTaskOfT)

DEFINE_CLASS(RUNTIME_VALUETASK_STATE, Tasks, RuntimeValueTaskState)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE, PUSH, Push, NoSig)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE, POP, Pop, NoSig)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE, FROM_EXCEPTION, FromException, IM_Exception_RetValueTask)
DEFINE_METHOD(RUNTIME_VALUETASK_STATE, FROM_RESULT, FromResult, IM_RetValueTask)
