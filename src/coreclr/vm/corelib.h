...
DEFINE_METHOD(ASYNC_HELPERS,      EXECUTE_ASYNC_ENTRYPOINT, ExecuteAsyncEntryPoint, SM_Obj_RetVoid)
DEFINE_METHOD(ASYNC_HELPERS,      EXECUTE_ASYNC_ENTRYPOINT_VOID, ExecuteAsyncEntryPointVoid, SM_Obj_RetVoid)
