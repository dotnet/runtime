...
DEFINE_METHOD(ASYNC_HELPERS,      RESTORE_INLINED_FRAME_EXECUTION_CONTEXT, RestoreInlinedFrameExecutionContext, NoSig)
DEFINE_METHOD(ASYNC_HELPERS,      RESTORE_INLINED_FRAME_CONTINUATION_CONTEXT, RestoreInlinedFrameContinuationContext, NoSig)
DEFINE_METHOD(ASYNC_HELPERS,      CAPTURE_INLINED_FRAME_TRANSITION, CaptureInlinedFrameTransition, NoSig)
