...
DEFINE_FIELD_U(_firstParameter,             DelegateObject,                 _firstParameter)
DEFINE_FIELD_U(_functionPointer,            DelegateObject,                 _functionPointer)
DEFINE_FIELD_U(_extraFunctionPointerOrData, DelegateObject,                 _extraFunctionPointerOrData)
DEFINE_FIELD_U(_invocationCount,            DelegateObject,                 _invocationCount)
DEFINE_FIELD_U(_methodDesc,                 DelegateObject,                 _methodDesc)
DEFINE_CLASS(DELEGATE,                      System,                         Delegate)
DEFINE_FIELD(DELEGATE,                      HELPER_OBJECT,                  _helperObject)
DEFINE_FIELD(DELEGATE,                      FIRST_PARAMETER,                _firstParameter)
DEFINE_FIELD(DELEGATE,                      FUNCTION_POINTER,               _functionPointer)
DEFINE_FIELD(DELEGATE,                      EXTRA_FUNCTION_POINTER_OR_DATA, _extraFunctionPointerOrData)
DEFINE_FIELD(DELEGATE,                      INVOCATION_COUNT,               _invocationCount)
