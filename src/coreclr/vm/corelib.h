...
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_PARAMETER_INFO_NAME, GetDispatchParameterInfoName, SM_PtrParameter_PtrStr_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_MEMBER_INFO_NAME, GetDispatchMemberInfoName, SM_PtrMember_PtrStr_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_MEMBER_INFO_TYPE, GetDispatchMemberInfoType, SM_PtrMember_PtrInt_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          HAS_DISPATCH_CUSTOM_ATTRIBUTE, HasDispatchCustomAttribute, SM_PtrMember_PtrType_PtrBool_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_MEMBER_PARAMETERS, GetDispatchMemberParameters, SM_PtrMember_PtrArrParameter_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_METHOD_DESC, GetDispatchMethodDesc, SM_PtrMethodBase_PtrIntPtr_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_FIELD_DESC, GetDispatchFieldDesc, SM_PtrFieldInfo_PtrIntPtr_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_PROPERTY_TOKEN, GetDispatchPropertyToken, SM_PtrPropertyInfo_PtrInt_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_PROPERTY_MODULE, GetDispatchPropertyModule, SM_PtrPropertyInfo_PtrModule_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_PROPERTY_ACCESSOR, GetDispatchPropertyAccessor, SM_PtrPropertyInfo_Bool_Bool_PtrIntPtr_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_FIELD_VALUE, GetDispatchFieldValue, SM_PtrFieldInfo_PtrObj_PtrObj_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          SET_DISPATCH_FIELD_VALUE, SetDispatchFieldValue, SM_PtrFieldInfo_PtrObj_PtrObj_Int_PtrBinder_PtrCultureInfo_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_PROPERTY_VALUE, GetDispatchPropertyValue, SM_PtrPropertyInfo_PtrObj_Int_PtrBinder_PtrArrObj_PtrCultureInfo_PtrObj_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          SET_DISPATCH_PROPERTY_VALUE, SetDispatchPropertyValue, SM_PtrPropertyInfo_PtrObj_PtrObj_Int_PtrBinder_PtrArrObj_PtrCultureInfo_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          INVOKE_DISPATCH_METHOD_INFO, InvokeDispatchMethodInfo, SM_PtrMethodInfo_PtrObj_Int_PtrBinder_PtrArrObj_PtrCultureInfo_PtrObj_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          INVOKE_DISPATCH_REFLECT_MEMBER, InvokeDispatchReflectMember, SM_PtrIReflect_PtrStr_Int_PtrBinder_PtrObj_PtrArrObj_PtrArrParameterModifier_PtrCultureInfo_PtrArrStr_PtrObj_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_PROPERTIES, GetDispatchProperties, SM_PtrIReflect_Int_PtrArrPropertyInfo_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_FIELDS, GetDispatchFields, SM_PtrIReflect_Int_PtrArrFieldInfo_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_METHODS, GetDispatchMethods, SM_PtrIReflect_Int_PtrArrMethodInfo_PtrException_RetVoid)
DEFINE_METHOD(STUBHELPERS,          GET_DISPATCH_INNER_EXCEPTION, GetDispatchInnerException, SM_PtrException_PtrException_PtrException_RetVoid)
#endif // FEATURE_COMINTEROP
