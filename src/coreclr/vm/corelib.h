...
DEFINE_METHOD(STUBHELPERS,          CONVERT_SAFE_ARRAY_CONTENTS_TO_UNMANAGED, ConvertSafeArrayContentsToUnmanaged, NoSig)
DEFINE_METHOD(STUBHELPERS,          CONVERT_SAFE_ARRAY_CONTENTS_TO_MANAGED,   ConvertSafeArrayContentsToManaged,   NoSig)
