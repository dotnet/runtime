...
DEFINE_METHOD(ENVIRONMENT,       CALL_ENTRY_POINT, CallEntryPoint, SM_IntPtr_PtrArrStr_Bool_Bool_PtrInt_RetVoid)
DEFINE_METHOD(ENVIRONMENT,       CALL_ENTRY_POINT_WITH_CATCH, CallEntryPointWithCatch, SM_IntPtr_PtrArrStr_Bool_Bool_PtrInt_PtrException_RetVoid)
DEFINE_METHOD(ENVIRONMENT,       CALL_ENTRY_POINT_UTF16_STRING_RET_INT, CallEntryPointUtf16StringRetInt, SM_IntPtr_PtrChar_PtrException_RetInt)
