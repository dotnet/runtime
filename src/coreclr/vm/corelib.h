...
DEFINE_METHOD(STUBHELPERS,          INVOKE_CLR_TO_COM_EVENT_PROVIDER_METHOD, InvokeClrToComEventProviderMethod, SM_PtrComObject_PtrClass_IntPtr_PtrDelegate_PtrIntPtr_PtrException_RetVoid)
#endif // FEATURE_COMINTEROP
