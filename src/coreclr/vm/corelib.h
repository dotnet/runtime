...
DEFINE_METHOD(IDISPATCHHELPERS,     GET_DISPATCH_MEMBER_INFO_TYPE, GetDispatchMemberInfoType, SM_PtrMember_PtrInt_PtrException_RetVoid)
...
DEFINE_METHOD(IDISPATCHHELPERS,     GET_DISPATCH_METHOD_DESC, GetDispatchMethodDesc, SM_PtrMethodBase_PtrIntPtr_PtrException_RetVoid)
DEFINE_METHOD(IDISPATCHHELPERS,     GET_DISPATCH_FIELD_DESC, GetDispatchFieldDesc, SM_PtrFieldInfo_PtrIntPtr_PtrException_RetVoid)
DEFINE_METHOD(IDISPATCHHELPERS,     GET_DISPATCH_PROPERTY_TOKEN, GetDispatchPropertyToken, SM_PtrPropertyInfo_PtrInt_PtrException_RetVoid)
DEFINE_METHOD(IDISPATCHHELPERS,     GET_DISPATCH_PROPERTY_MODULE, GetDispatchPropertyModule, SM_PtrPropertyInfo_PtrModule_PtrException_RetVoid)
