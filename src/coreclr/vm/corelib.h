...
DEFINE_METHOD(VIRTUALDISPATCHHELPERS, VIRTUALFUNCTIONPOINTER2, VirtualFunctionPointer2, NoSig)
...
DEFINE_FIELD(VIRTUALDISPATCHHELPERS, CACHE2, s_virtualFunctionPointerCache2)
