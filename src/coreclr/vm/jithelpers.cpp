...
HCIMPL3(VOID, FillNullable, uint8_t* destPtr, MethodTable* typeMT, Object* objToCopyFrom)
{
    FCALL_CONTRACT;

    Nullable::UnboxWriteValue(destPtr, ObjectToOBJECTREF(objToCopyFrom), typeMT);
}
HCIMPLEND
