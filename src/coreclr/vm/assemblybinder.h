...
public:
    ...
    virtual HRESULT BindUsingPEImage(PEImage* pPEImage, bool excludeAppPaths, BINDER_SPACE::Assembly** ppAssembly, SString* pLoadedAssemblyNameForMvidMismatch = nullptr) = 0;
