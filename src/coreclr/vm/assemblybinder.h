...
public:
    ...
    virtual HRESULT BindUsingPEImage(PEImage* pPEImage, bool excludeAppPaths, BINDER_SPACE::Assembly** ppAssembly, BINDER_SPACE::Assembly** ppExistingAssemblyOnMvidMismatch = nullptr) = 0;
