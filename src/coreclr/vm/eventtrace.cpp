    ...
    BOOL fAllowProfApiNotification /* = TRUE */)
{
    ...
    if (fCompacting)
    {
        ...
        _ASSERTE(pContext->cBulkMovedObjectRanges < MINIPAL_LENGTHOF(pContext->rgGCBulkMovedObjectRanges));
        ...
        if (pContext->cBulkMovedObjectRanges == MINIPAL_LENGTHOF(pContext->rgGCBulkMovedObjectRanges))
        {
    ...
    else
    {
        ...
        _ASSERTE(pContext->cBulkSurvivingObjectRanges < MINIPAL_LENGTHOF(pContext->rgGCBulkSurvivingObjectRanges));
        ...
        // If buffer is now full, empty it into ETW
        if (pContext->cBulkSurvivingObjectRanges == MINIPAL_LENGTHOF(pContext->rgGCBulkSurvivingObjectRanges))
        {
...
void BulkComLogger::FlushRcw()
{
    ...
    ULONG result = EventWrite(Microsoft_Windows_DotNETRuntimeHandle, &GCBulkRCW, MINIPAL_LENGTHOF(eventData), eventData);
#else
...
void BulkComLogger::FlushCcw()
{
    ...
    ULONG result = EventWrite(Microsoft_Windows_DotNETRuntimeHandle, &GCBulkRootCCW, MINIPAL_LENGTHOF(eventData), eventData);
#else
...
void BulkComLogger::AddCcwHandle(Object **handle)
{
    ...
    if (curr->Count == MINIPAL_LENGTHOF(curr->Handles))
    {
...
void BulkStaticsLogger::FireBulkStaticsEvent()
{
    ...
    ULONG result = EventWrite(Microsoft_Windows_DotNETRuntimeHandle, &GCBulkRootStaticVar, MINIPAL_LENGTHOF(eventData), eventData);
#else
...
int BulkTypeEventLogger::LogSingleType(TypeHandle th)
{
    ...
    if (m_nBulkTypeValueCount == MINIPAL_LENGTHOF(m_rgBulkTypeValues))
    {
        FireBulkTypeEvent();
    }

    _ASSERTE(m_nBulkTypeValueCount < (int)MINIPAL_LENGTHOF(m_rgBulkTypeValues));
    ...
    DWORD rootFlags)
{
    ...
    if (fDependentHandle)
    {
        _ASSERTE(pContext->cGCBulkRootConditionalWeakTableElementEdges <
            MINIPAL_LENGTHOF(pContext->rgGCBulkRootConditionalWeakTableElementEdges));
    ...
    {
        _ASSERTE(pContext->cGcBulkRootEdges < MINIPAL_LENGTHOF(pContext->rgGcBulkRootEdges));
        ...
        if (pContext->cGcBulkRootEdges == MINIPAL_LENGTHOF(pContext->rgGcBulkRootEdges))
        {
    ...
    Object ** rgObjReferenceTargets)
{
    ...
    _ASSERTE(pContext->cGcBulkNodeValues < MINIPAL_LENGTHOF(pContext->rgGcBulkNodeValues));
    ...
    if (pContext->cGcBulkNodeValues == MINIPAL_LENGTHOF(pContext->rgGcBulkNodeValues))
    {
        FireEtwGCBulkNode(
    ...
    {
        _ASSERTE(pContext->cGcBulkEdgeValues < MINIPAL_LENGTHOF(pContext->rgGcBulkEdgeValues));
        ...
        if (pContext->cGcBulkEdgeValues == MINIPAL_LENGTHOF(pContext->rgGcBulkEdgeValues))
        {
            FireEtwGCBulkEdge(
