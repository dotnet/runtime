...
#define SET_TRUE(flag)      ((flag) & 0xffff)
    ...
    enum WFLAGS_HIGH_ENUM
    {
        ...
        enum_flag_Category_Primitive        = 0x00060000, // sub-category of ValueType, Primitive (ELEMENT_TYPE_I, etc.). [cDAC] [RuntimeTypeSystem]: Contract depends on this value
        enum_flag_Category_Enum             = 0x00070000, // sub-category of ValueType, Enum. [cDAC] [RuntimeTypeSystem]: Contract depends on this value
