...
public:
    ...
    static FCDECL1(ReflectClassBaseObject*, GetTypeObject, void *th);
...
extern "C" void QCALLTYPE RuntimeTypeHandle_GetTypeObjectSlow(void* typeHandleRaw, QCall::ObjectHandleOnStack result);
