                                    ...
                                    int funCallDepth /* = 1 */)
{
    ...
    ctx.PSWAddr = baseState->m_CaptureRip;
    ctx.R15 = baseState->m_CaptureRsp;  // FIXME + 8; // +8 for return addr pushed before calling LazyMachStateCaptureState
...
#undef CALLEE_SAVED_REGISTER
    ...
    unwoundState->m_Rip = ctx.PSWAddr;
    unwoundState->m_Rsp = ctx.R15;
    ...
    unwoundState->_pRetAddr = PTR_TADDR(unwoundState->m_Rsp + 14*8);
