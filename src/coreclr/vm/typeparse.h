...
public:
    InlineEString<128, EncodingUnicode>* GetAssembly() { WRAPPER_NO_CONTRACT; return &m_assembly; }
...
private:
    ...
    SString* AddName()
    {
        ...
        return m_names.AppendEx((SString*)m_nestNameFactory.Create());
    }
...
private:
    ...
    InlineEString<128, EncodingUnicode> m_assembly;
    Factory<InlineEString<128, EncodingUnicode> > m_nestNameFactory;
};
