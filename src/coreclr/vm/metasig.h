...
// static methods:
DEFINE_METASIG_T(SM(Int_RuntimeTypeHandle_IntPtr_RetException, i g(RT_TYPE_HANDLE) I, C(EXCEPTION)))
...
DEFINE_METASIG_T(SM(PtrObj_PtrExInfo_PtrException_RetVoid, P(j) P(g(EXINFO)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(UInt_PtrExInfo_PtrException_RetVoid, K P(g(EXINFO)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrExInfo_PtrExInfo_PtrException_RetVoid, P(g(EXINFO)) P(g(EXINFO)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrObj_PtrExInfo_RetVoid, P(j) P(g(EXINFO)), v))
DEFINE_METASIG_T(SM(UInt_PtrExInfo_RetVoid, K P(g(EXINFO)), v))
DEFINE_METASIG_T(SM(PtrExInfo_PtrExInfo_RetVoid, P(g(EXINFO)) P(g(EXINFO)), v))
#ifdef FEATURE_COMINTEROP
DEFINE_METASIG(SM(Obj_IntPtr_Int_RefIntPtr_RefBool_RetIntPtr, j I i r(I) r(F), I))
...
DEFINE_METASIG(SM(IntPtr_IntPtr_Int_Bool_RetVoid, I I i F, v))
...
DEFINE_METASIG_T(SM(PtrVoid_PtrVoid_PtrException_RetVoid, P(v) P(v) P(C(EXCEPTION)), v))
...
DEFINE_METASIG_T(SM(IntPtr_PtrException_RetVoid, I P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(IntPtr_PtrArrStr_PtrInt_Bool_PtrException_RetVoid, I P(a(s)) P(i) F P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(IntPtr_PtrChar_PtrException_RetInt, I P(u) P(C(EXCEPTION)), i))
...
DEFINE_METASIG_T(SM(PtrResolver_Int_PtrArrByte_PtrVoid_PtrException_RetVoid, P(C(RESOLVER)) i P(a(b)) P(v) P(C(EXCEPTION)), v))
...
DEFINE_METASIG_T(SM(PtrComObject_PtrClass_IntPtr_PtrDelegate_PtrULong_PtrException_RetVoid, P(C(COM_OBJECT)) P(C(CLASS)) I P(C(DELEGATE)) P(L) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrParameter_PtrStr_PtrException_RetVoid, P(C(PARAMETER)) P(s) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrMember_PtrStr_PtrException_RetVoid, P(C(MEMBER)) P(s) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrMember_PtrException_RetInt, P(C(MEMBER)) P(C(EXCEPTION)), i))
DEFINE_METASIG_T(SM(PtrMember_PtrType_PtrBool_PtrException_RetVoid, P(C(MEMBER)) P(C(TYPE)) P(F) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrMember_PtrArrParameter_PtrException_RetVoid, P(C(MEMBER)) P(a(C(PARAMETER))) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrPropertyInfo_PtrInt_PtrModule_PtrException_RetVoid, P(C(PROPERTY_INFO)) P(i) P(C(MODULE)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrPropertyInfo_Bool_Bool_PtrIntPtr_PtrException_RetVoid, P(C(PROPERTY_INFO)) F F P(I) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrFieldInfo_PtrObj_PtrObj_PtrException_RetVoid, P(C(FIELD_INFO)) P(j) P(j) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrFieldInfo_PtrObj_PtrObj_Int_PtrBinder_PtrCultureInfo_PtrException_RetVoid, P(C(FIELD_INFO)) P(j) P(j) i P(C(BINDER)) P(C(CULTURE_INFO)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrPropertyInfo_PtrObj_Int_PtrBinder_PtrArrObj_PtrCultureInfo_PtrObj_PtrException_RetVoid, P(C(PROPERTY_INFO)) P(j) i P(C(BINDER)) P(a(j)) P(C(CULTURE_INFO)) P(j) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrPropertyInfo_PtrObj_PtrObj_Int_PtrBinder_PtrArrObj_PtrCultureInfo_PtrException_RetVoid, P(C(PROPERTY_INFO)) P(j) P(j) i P(C(BINDER)) P(a(j)) P(C(CULTURE_INFO)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrMethodInfo_PtrObj_Int_PtrBinder_PtrArrObj_PtrCultureInfo_PtrObj_PtrException_RetVoid, P(C(METHOD_INFO)) P(j) i P(C(BINDER)) P(a(j)) P(C(CULTURE_INFO)) P(j) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrIReflect_PtrStr_Int_PtrBinder_PtrObj_PtrArrObj_PtrArrParameterModifier_PtrCultureInfo_PtrArrStr_PtrObj_PtrException_RetVoid, P(C(IREFLECT)) P(s) i P(C(BINDER)) P(j) P(a(j)) P(a(g(PARAMETER_MODIFIER))) P(C(CULTURE_INFO)) P(a(s)) P(j) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrIReflect_Int_PtrArrPropertyInfo_PtrException_RetVoid, P(C(IREFLECT)) i P(a(C(PROPERTY_INFO))) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrIReflect_Int_PtrArrFieldInfo_PtrException_RetVoid, P(C(IREFLECT)) i P(a(C(FIELD_INFO))) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrIReflect_Int_PtrArrMethodInfo_PtrException_RetVoid, P(C(IREFLECT)) i P(a(C(METHOD_INFO))) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrException_PtrException_PtrException_RetVoid, P(C(EXCEPTION)) P(C(EXCEPTION)) P(C(EXCEPTION)), v))
#endif // FEATURE_COMINTEROP
...
DEFINE_METASIG_T(SM(PtrThread_RetVoid, P(C(THREAD)), v))
...
DEFINE_METASIG_T(SM(PtrAssemblyName_PtrNativeAssemblyNameParts_PtrException_RetVoid, P(C(ASSEMBLY_NAME)) P(g(NATIVE_ASSEMBLY_NAME_PARTS)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrChar_Int_PtrPtrChar_PtrArrStr_PtrException_RetVoid, P(u) i P(P(u)) P(a(s)) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrIDynamicInterfaceCastable_PtrClass_CLR_BOOL_PtrCLR_BOOL_PtrException_RetVoid, P(C(IDYNAMICINTERFACECASTABLE)) P(C(CLASS)) F P(F) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrIDynamicInterfaceCastable_PtrClass_PtrClass_PtrException_RetVoid, P(C(IDYNAMICINTERFACECASTABLE)) P(C(CLASS)) P(C(CLASS)) P(C(EXCEPTION)), v))
...
DEFINE_METASIG_T(SM(PtrChar_IntPtr_PtrException_RetIntPtr, P(u) I P(C(EXCEPTION)), I))
DEFINE_METASIG_T(SM(PtrChar_PtrAssemblyBase_CLR_BOOL_UInt_PtrException_RetIntPtr, P(u) P(C(ASSEMBLYBASE)) F K P(C(EXCEPTION)), I))
DEFINE_METASIG_T(SM(PtrChar_PtrAssemblyBase_IntPtr_PtrException_RetIntPtr, P(u) P(C(ASSEMBLYBASE)) I P(C(EXCEPTION)), I))
#ifdef FEATURE_COMINTEROP
