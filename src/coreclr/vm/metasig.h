...
DEFINE_METASIG(SM(IntPtr_PtrArrStr_Bool_Bool_PtrInt_RetVoid, I P(a(s)) F F P(i), v))
DEFINE_METASIG_T(SM(IntPtr_PtrArrStr_Bool_Bool_PtrInt_PtrException_RetVoid, I P(a(s)) F F P(i) P(C(EXCEPTION)), v))
