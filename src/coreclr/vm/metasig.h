...
DEFINE_METASIG_T(SM(PtrObjectHandleOnStack_PtrObjectHandleOnStack_PtrIntPtr_PtrObjectHandleOnStack_RetVoid, P(g(OBJECT_HANDLE_ON_STACK)) P(g(OBJECT_HANDLE_ON_STACK)) P(I) P(g(OBJECT_HANDLE_ON_STACK)), v))
...
DEFINE_METASIG_T(SM(PtrPtrChar_PtrPtrChar_Int_PtrObjectHandleOnStack_RetVoid, P(P(u)) P(P(u)) i P(g(OBJECT_HANDLE_ON_STACK)), v))
