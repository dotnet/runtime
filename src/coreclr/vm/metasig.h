...
DEFINE_METASIG_T(SM(ObjectHandleOnStack_ObjectHandleOnStack_PtrIntPtr_ObjectHandleOnStack_RetVoid, g(OBJECT_HANDLE_ON_STACK) g(OBJECT_HANDLE_ON_STACK) P(I) g(OBJECT_HANDLE_ON_STACK), v))
...
DEFINE_METASIG_T(SM(PtrPtrChar_PtrPtrChar_Int_ObjectHandleOnStack_RetVoid, P(P(u)) P(P(u)) i g(OBJECT_HANDLE_ON_STACK), v))
