...
DEFINE_METASIG_T(SM(PtrMember_PtrInt_PtrException_RetVoid, P(C(MEMBER)) P(i) P(C(EXCEPTION)), v))
...
DEFINE_METASIG_T(SM(PtrMethodBase_PtrIntPtr_PtrException_RetVoid, P(C(METHOD_BASE)) P(I) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrFieldInfo_PtrIntPtr_PtrException_RetVoid, P(C(FIELD_INFO)) P(I) P(C(EXCEPTION)), v))
DEFINE_METASIG_T(SM(PtrPropertyInfo_PtrModule_PtrException_RetVoid, P(C(PROPERTY_INFO)) P(C(MODULE)) P(C(EXCEPTION)), v))
