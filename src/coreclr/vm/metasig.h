...
DEFINE_METASIG_T(SM(Obj_RefExInfo_RefUIntPtr_RefBytePtr_RefBytePtr_RetVoid, j r(g(EXINFO)) r(U) r(P(b)) r(P(b)), v))
DEFINE_METASIG_T(SM(UInt_RefExInfo_RefUIntPtr_RefBytePtr_RefBytePtr_RetVoid, K r(g(EXINFO)) r(U) r(P(b)) r(P(b)), v))
DEFINE_METASIG_T(SM(RefExInfo_UIntPtr_RetVoid, r(g(EXINFO)) U, v))
DEFINE_METASIG_T(SM(RefExInfo_RefExInfo_RefUIntPtr_RefBytePtr_RefBytePtr_RetVoid, r(g(EXINFO)) r(g(EXINFO)) r(U) r(P(b)) r(P(b)), v))
