...
DEFINE_METASIG_T(SM(PtrComObject_PtrClass_IntPtr_IntPtr_PtrDelegate_PtrULong_PtrException_RetVoid, P(C(COM_OBJECT)) P(C(CLASS)) I I P(C(DELEGATE)) P(L) P(C(EXCEPTION)), v))
