    ...
    SString *       pDumpILStubCode)
{
    ...
    if (isLabeled)
    {
        strLabel.Printf(W("IL_%04zx:"), curOffset);
    }
    else
    {
        strLabel.Set(W("        "));
    ...
    if (ILCodeStream::IsBranchInstruction(instr))
    {
        ...
        strArgument.Printf(W("IL_%04zx"), targetOffset);
    }
    ...
    else
    {
        ...
        case InlineTok:
            ...
            if (pDumpILStubCode == NULL)
                strArgument.Printf(W("0x%08zx"), pInstruction->uArg);
    ...
    SString *       pDumpILStubCode)
{
    ...
    if (isLabeled)
    {
        if (pDumpILStubCode)
        {
            pDumpILStubCode->AppendPrintf(W("IL_%04zx:\n"), *pcbCode);
        }
        else
        {
