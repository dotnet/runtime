    ...
    DWORD *      pdwModuleFlags)
{
    ...
    EX_TRY
    {
        ...
        ULONG trueLen = (ULONG)(minipal_u16_strlen((const CHAR16_T*)wszFileName) + 1);
    ...
    ProcessID   *pProcessId)
{
    ...
    {
        // Get the module file name
        ULONG trueLen = (ULONG)(minipal_u16_strlen((const CHAR16_T*)szFriendlyName) + 1);
            ...
            _Out_writes_to_opt_(cchName, *pcchName) WCHAR wszName[])
{
    ...
    EX_TRY
    {
        ...
        ULONG trueLen = (ULONG)(minipal_u16_strlen((const CHAR16_T*)methodName) + 1);
                                                     ...
                                                     _Out_writes_to_opt_(cchVersionString, *pcchVersionString) WCHAR  szVersionString[])
{
    ...
    if (pcchVersionString != NULL)
    {
        ...
        // Get the module file name
        ULONG trueLen = (ULONG)(minipal_u16_strlen((const CHAR16_T*)pczVersionString) + 1);
