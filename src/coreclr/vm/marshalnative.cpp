...
extern "C" PVOID QCALLTYPE MarshalNative_GetFunctionPointerForDelegateInternal(QCall::ObjectHandleOnStack d, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" void QCALLTYPE MarshalNative_GetExceptionForHR(INT32 errorCode, LPVOID errorInfo, QCall::ObjectHandleOnStack retVal, QCallException* qcallError)
{
    CONTRACTL
    {
        QCALL_CHECK;
