...
public:
    ...
    enum  GCStressFlags {
        ...
        GCSTRESS_CDAC               = 0x20, // Verify cDAC GC references at stress points
        GCSTRESS_ALLSTRESS          = GCSTRESS_ALLOC | GCSTRESS_TRANSITION | GCSTRESS_INSTR_JIT | GCSTRESS_INSTR_NGEN | GCSTRESS_CDAC,
    };
