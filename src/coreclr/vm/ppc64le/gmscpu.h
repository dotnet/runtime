...
#ifndef __gmsPPC64LE_h__
#define __gmsPPC64LE_h__
...
struct MachState
{
    MachState()
    {
        ...
        INDEBUG(memset((void*)this, 0, sizeof(MachState));)
    }
    ...
    void SetRetAddr(TADDR* addr) { _ASSERTE(isValid()); _pRetAddr = addr; }  //not used
#endif
...
inline void LazyMachState::setLazyStateFromUnwind(MachState* copy)
{
    ...
    VolatileStore(&_pRetAddr, (PTR_TADDR)(TADDR)&m_nip);
