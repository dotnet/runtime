...
EXTERN_C FCIMPL1(Object*, RhpNew, MethodTable* pMT)
{
...
EXTERN_C FCIMPL1(Object*, RhpNewMaybeFrozen, MethodTable* pMT)
{
    PREPARE_TRANSITION_ARG();
...
EXTERN_C FCIMPL2(Object*, RhpNewArrayMaybeFrozen, MethodTable* pMT, INT_PTR size)
{
    PREPARE_TRANSITION_ARG();
