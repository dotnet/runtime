...
#define X86_WRITE_BARRIER_REGISTER(reg) \
    ...
    SetInterestingJitHelperFunction(GetWriteBarrierCodeLocation((void*)JIT_WriteBarrier##reg), W("JIT_WriteBarrier" #reg)); \
...
#undef X86_WRITE_BARRIER_REGISTER
        ...
        SetInterestingJitHelperFunction(GetWriteBarrierCodeLocation((void*)JIT_WriteBarrier), W("JIT_WriteBarrier"));
        ...
        SetInterestingJitHelperFunction(GetWriteBarrierCodeLocation((void*)JIT_CheckedWriteBarrier), W("JIT_CheckedWriteBarrier"));
        ...
        SetInterestingJitHelperFunction(GetWriteBarrierCodeLocation((void*)JIT_ByRefWriteBarrier), W("JIT_ByRefWriteBarrier"));
