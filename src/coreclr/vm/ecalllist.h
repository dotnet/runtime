...
FCFuncStart(gRuntimeHelpers)
    ...
    FCFuncElement("UnwindToFunctionWithAsyncFrame", RuntimeSuspension_UnwindToFunctionWithAsyncFrame)
    FCFuncElement("ResumeTaskletReferenceReturn", RuntimeSuspension_ResumeTaskletReferenceReturn)
    FCFuncElement("ResumeTaskletIntegerRegisterReturn", RuntimeSuspension_ResumeTaskletIntegerRegisterReturn)
FCFuncEnd()
