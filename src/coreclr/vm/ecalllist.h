...
FCFuncStart(gInteropMarshalFuncs)
    ...
    FCFuncElement("BeginTrackingSystemCallErrors", MarshalNative::BeginTrackingSystemCallErrors)
    FCFuncElement("EndTrackingSystemCallErrors", MarshalNative::EndTrackingSystemCallErrors)
