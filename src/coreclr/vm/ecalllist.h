...
FCFuncStart(gEventLogger)
    ...
    QCFuncElement("LogThreadPoolWorkerThreadStart", XplatEventSourceLogger::LogThreadPoolWorkerThreadStart)
    QCFuncElement("LogThreadPoolWorkerThreadStop", XplatEventSourceLogger::LogThreadPoolWorkerThreadStop)
    QCFuncElement("LogThreadPoolWorkerThreadWait", XplatEventSourceLogger::LogThreadPoolWorkerThreadWait)
    QCFuncElement("LogThreadPoolWorkerThreadAdjustmentSample", XplatEventSourceLogger::LogThreadPoolWorkerThreadAdjustmentSample)
    QCFuncElement("LogThreadPoolWorkerThreadAdjustmentAdjustment", XplatEventSourceLogger::LogThreadPoolWorkerThreadAdjustmentAdjustment)
    QCFuncElement("LogThreadPoolWorkerThreadAdjustmentStats", XplatEventSourceLogger::LogThreadPoolWorkerThreadAdjustmentStats)
    QCFuncElement("LogThreadPoolIOEnqueue", XplatEventSourceLogger::LogThreadPoolIOEnqueue)
    QCFuncElement("LogThreadPoolIODequeue", XplatEventSourceLogger::LogThreadPoolIODequeue)
    QCFuncElement("LogThreadPoolWorkingThreadCount", XplatEventSourceLogger::LogThreadPoolWorkingThreadCount)
FCFuncEnd()
