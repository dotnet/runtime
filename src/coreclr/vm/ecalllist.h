...
FCFuncStart(gRuntimeMethodHandle)
    ...
    FCFuncElement("GetAttributesInternal", RuntimeMethodHandle::GetAttributesInternal)
    FCFuncElement("GetMethodTable", RuntimeMethodHandle::GetMethodTable)
    FCFuncElement("GetSlotInternal", RuntimeMethodHandle::GetSlotInternal)
...
FCFuncStart(gCOMFieldHandleNewFuncs)
    ...
    FCFuncElement("GetAttributesInternal", RuntimeFieldHandle::GetAttributesInternal)
