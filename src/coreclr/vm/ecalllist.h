...
FCFuncStart(gCOMTypeHandleFuncs)
    ...
    FCFuncElement("_IsUnmanagedFunctionPointer", RuntimeTypeHandle::IsUnmanagedFunctionPointer)
...
FCFuncStart(gSignatureNative)
    ...
    FCFuncElement("GetSignatureFromFunctionPointer", SignatureNative::GetSignatureFromFunctionPointer)
