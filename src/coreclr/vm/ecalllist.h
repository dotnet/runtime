...
FCFuncStart(gInterlockedFuncs)
    FCFuncElementSig("Exchange", &gsig_SM_RefByte_Byte_RetByte, COMInterlocked::Exchange8)
    FCFuncElementSig("Exchange", &gsig_SM_RefShrt_Shrt_RetShrt, COMInterlocked::Exchange16)
    ...
    FCFuncElementSig("CompareExchange", &gsig_SM_RefByte_Byte_Byte_RetByte, COMInterlocked::CompareExchange8)
    FCFuncElementSig("CompareExchange", &gsig_SM_RefShrt_Shrt_Shrt_RetShrt, COMInterlocked::CompareExchange16)
