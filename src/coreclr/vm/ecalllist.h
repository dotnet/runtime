...
FCFuncStart(gCOMTypeHandleFuncs)
    ...
    FCFuncElement("GetCustomModifiersFromFunctionPointer", RuntimeTypeHandle::GetCustomModifiersFromFunctionPointer)
    FCFuncElement("GetRawCallingConventionsFromFunctionPointer", RuntimeTypeHandle::GetRawCallingConventionsFromFunctionPointer)
