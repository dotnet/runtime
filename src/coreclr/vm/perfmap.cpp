...
void PerfMap::LogImage(PEAssembly * pPEAssembly)
{
    ...
    EX_TRY
    {
        ...
        GetNativeImageSignature(pPEAssembly, wszSignature, MINIPAL_LENGTHOF(wszSignature));
  ...
  : PerfMap()
{
    ...
    WCHAR wszSignature[39];
    GetNativeImageSignature(pAssembly->GetManifestFile(), wszSignature, MINIPAL_LENGTHOF(wszSignature));
