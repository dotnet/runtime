                                      ...
                                      VARIANT**             aByrefArgOleVariant)
{
    ...
    else
    {
        ...
        {
            WCHAR strTmp[64];
            _snwprintf_s(strTmp, MINIPAL_LENGTHOF(strTmp), _TRUNCATE, DISPID_NAME_FORMAT_STRING, id);
        ...
        *pNamedParamArray = (PTRARRAYREF)AllocateObjectArray(NumNamedArgs, g_pObjectClass);
        ...
        for (iSrcArg = 0, iDestArg = 0; iSrcArg < NumNamedArgs; iSrcArg++, iDestArg++)
        {
            ...
            if (!bParamNameSet)
            {
                ...
                _snwprintf_s(wszTmp, MINIPAL_LENGTHOF(wszTmp), _TRUNCATE, DISPID_NAME_FORMAT_STRING, pSrcArgNames[iSrcArg]);
