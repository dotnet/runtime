...
const USHORT c_nCoreLibClassDescriptions = MINIPAL_LENGTHOF(c_rgCoreLibClassDescriptions);
...
const USHORT c_nCoreLibMethodDescriptions = MINIPAL_LENGTHOF(c_rgCoreLibMethodDescriptions) + 1;
...
const USHORT c_nCoreLibFieldDescriptions = MINIPAL_LENGTHOF(c_rgCoreLibFieldDescriptions) + 1;
...
const int c_nECClasses = MINIPAL_LENGTHOF(c_rgECClasses);
