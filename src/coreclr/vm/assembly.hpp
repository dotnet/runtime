...
public:
    ...
    static Assembly* CreateDynamic(OBJECTHANDLE pBinder, NativeAssemblyNameParts* pAssemblyNameParts, INT32 hashAlgorithm, INT32 access, LOADERALLOCATORREF* pKeepAlive);
