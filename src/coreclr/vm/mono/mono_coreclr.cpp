...
struct HostStruct
{
    ...
    MonoException* (*exception_from_class_msg)(MonoClass* klass, const char* msg);
...
// Generated by UnityEmbedHost.Generator - Commit these changes
extern "C" EXPORT_API MonoException* EXPORT_CC mono_exception_from_class_msg(MonoClass* klass, const char* msg)
{
    GCX_PREEMP(); // temporary until we sort out our GC thread model
    return g_HostStruct->exception_from_class_msg(klass, msg);
}
...
extern "C" EXPORT_API MonoException* EXPORT_CC mono_exception_from_name_msg(MonoImage *image, const char *name_space, const char *name, const char *msg)
{
    ...
    return mono_exception_from_class_msg(exclass, msg);
}
