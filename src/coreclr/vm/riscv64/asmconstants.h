...
ASMCONSTANTS_C_ASSERT(OFFSETOF__CONTEXT__Gp == offsetof(CONTEXT, Gp));

#define OFFSETOF__CONTEXT__Tp         0x28
ASMCONSTANTS_C_ASSERT(OFFSETOF__CONTEXT__Tp == offsetof(CONTEXT, Tp));
...
ASMCONSTANTS_C_ASSERT(OFFSETOF__CONTEXT__S1 == offsetof(CONTEXT, S1));

#define OFFSETOF__CONTEXT__S2         0x98
ASMCONSTANTS_C_ASSERT(OFFSETOF__CONTEXT__S2 == offsetof(CONTEXT, S2));
