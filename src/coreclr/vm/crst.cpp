...
VOID CrstBase::InitWorker(INDEBUG_COMMA(CrstType crstType) CrstFlags flags)
{
    ...
    bool suc = minipal_critsect_init(&m_criticalsection);
    _ASSERTE(suc);
...
void CrstBase::Destroy()
{
    ...
    {
        minipal_critsect_destroy(&m_criticalsection);
    }
...
void CrstBase::Enter(INDEBUG(NoLevelCheckFlag noLevelCheckFlag/* = CRST_LEVEL_CHECK*/))
{
    ...
    minipal_critsect_enter(&m_criticalsection);
...
void CrstBase::Leave()
{
    ...
    minipal_critsect_leave(&m_criticalsection);
