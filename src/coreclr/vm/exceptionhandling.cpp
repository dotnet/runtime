...
void InitializeExceptionHandling()
{
    ...
    g_isNewExceptionHandlingEnabled = Configuration::GetKnobBooleanValue(W("System.Runtime.EnableNewExceptionHandling"), CLRConfig::EXTERNAL_EnableNewExceptionHandling) != 0;
