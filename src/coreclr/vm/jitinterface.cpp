...
CorInfoType CEEInfo::asCorInfoType(CorElementType eeType,
    ...
    if (!typeHnd.IsNull())
    {
        ...
        if (!typeHnd.IsTypeDesc() && typeHnd.AsMethodTable()->IsPrimitive() && typeHnd != TypeHandle(g_TypedReferenceMT))
        {
    ...
    static const BYTE map[] = {
        ...
        CORINFO_TYPE_CLASS,          // GENERICINST
        CORINFO_TYPE_VALUECLASS,     // TypedReference
