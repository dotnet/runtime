                        ...
                        _Out_ ULONG* pSizeOfCode)
{
    ...
    *isInterpreterCode = false;
    ...
    if (interpreterMgr->IsInterpreterLoaded() && (!ftn->IsILStub() || !ftn->AsDynamicMethodDesc()->IsAsyncResumeStub())) // Async resumt stubs cannot be generated by the interpreter
    {
