                                  ...
                                  INT32        addlDelta)
{
    ...
    case CorInfoReloc::RELATIVE32:
    {
        ...
        LOG((LF_JIT, LL_INFO100000, "Encoded a PCREL32 at" FMT_ADDR "to" FMT_ADDR "+%lld,  delta is 0x%04x\n",
               DBG_ADDR(fixupLocation), DBG_ADDR(target), (long long)addlDelta, (unsigned int)delta));
