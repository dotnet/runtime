...
public:
    ...
    void LogILStub(CORJIT_FLAGS jitFlags, EString<EncodingUTF8> *pDumpILStubCode = NULL);
protected:
    void DumpIL_FormatToken(mdToken token, EString<EncodingUTF8> &strTokenFormatting);
    void LogILStubWorker(ILInstruction* pInstrBuffer, UINT numInstr, size_t* pcbCode, INT* piCurStack, EString<EncodingUTF8> *pDumpILStubCode = NULL);
    void LogILInstruction(size_t curOffset, bool isLabeled, INT iCurStack, ILInstruction* pInstruction, EString<EncodingUTF8> *pDumpILStubCode = NULL);
