...
void MethodTable::AllocateWriteableData(LoaderAllocator *pAllocator, AllocMemTracker *pamTracker, WORD nonVirtualSlots)
{
    ...
    if (pAllocator->IsCollectible())
    {
        *((LoaderAllocator**)pWriteableDataRegion) = pAllocator;
        pMTWriteableData = (MethodTableWriteableData *)(pWriteableDataRegion + sizeof(TADDR));
    }
    else
    {
                                      ...
                                      AllocMemTracker* pamTracker)
{
    ...
    pMT->AllocateWriteableData(pLoaderAllocator, pamTracker);
