...
{
public:
        static FCDECL2(UINT8, Exchange8, UINT8 *location, UINT8 value);
        static FCDECL2(INT16, Exchange16, INT16 *location, INT16 value);
        static FCDECL2(INT32, Exchange, INT32 *location, INT32 value);
        static FCDECL2_IV(INT64,   Exchange64, INT64 *location, INT64 value);
        static FCDECL3(UINT8, CompareExchange8,        UINT8* location, UINT8 value, UINT8 comparand);
        static FCDECL3(INT16, CompareExchange16,        INT16* location, INT16 value, INT16 comparand);
