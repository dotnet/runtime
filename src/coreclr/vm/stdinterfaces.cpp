            ...
            else
            {
                ...
                switch (MemberType)
                {
                    ...
                    case Property:
                    {
                        ...
                        COMPILER_ASSUME_MSG((pCanReadMD != NULL), "Unable to find getter method for property PropertyInfo::CanRead");
                        ...
                        COMPILER_ASSUME_MSG((pCanWriteMD != NULL), "Unable to find setter method for property PropertyInfo::CanWrite");
