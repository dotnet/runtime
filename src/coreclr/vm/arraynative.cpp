...
extern "C" PCODE QCALLTYPE Array_GetElementConstructorEntrypoint(QCall::TypeHandle pArrayTypeHnd, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" void QCALLTYPE Array_CreateInstance(QCall::TypeHandle pTypeHnd, INT32 rank, INT32* pLengths, INT32* pLowerBounds, BOOL createFromArrayType, QCall::ObjectHandleOnStack retArray, QCallException* qcallError)
{
    CONTRACTL {
        QCALL_CHECK;
        PRECONDITION(rank > 0);
...
extern "C" void QCALLTYPE Array_Ctor(MethodTable* pArrayMT, UINT32 dwNumArgs, INT32* pArgList, QCall::ObjectHandleOnStack retArray, QCallException* qcallError)
{
    QCALL_CONTRACT;
