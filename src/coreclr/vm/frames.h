...
//    |   |
//    |   +-CRLToCOMMethodFrame  - represents a CLR to COM call using the generic worker
//    |   |
...
ClrToCom:
 Late-bound or eventing: The stub is generated by GenerateGenericComplusWorker
    ...
    and it erects a CRLToCOMMethodFrame frame.
...
FRAME_TYPE_NAME(CRLToCOMMethodFrame)
...
public:
    ...
    static int GetFPArgOffset(int iArg)
    {
        ...
        // (code:TPMethodFrame and code:CRLToCOMMethodFrame)
...
class CRLToCOMMethodFrame : public FramedMethodFrame
{
    VPTR_VTABLE_CLASS(CRLToCOMMethodFrame, FramedMethodFrame)

public:
    CRLToCOMMethodFrame(TransitionBlock * pTransitionBlock, MethodDesc * pMethodDesc);
    ...
    // Keep as last entry in class
    DEFINE_VTABLE_GETTER_AND_CTOR_AND_DTOR(CRLToCOMMethodFrame)
};
