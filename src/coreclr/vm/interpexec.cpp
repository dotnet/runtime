...
static void CallPreStub(MethodDesc *pMD, CallerGCMode callerGCMode = CallerGCMode::Preemptive)
{
    ...
    param = { pMD, callerGCMode };

    PAL_TRY(Param *, pParam, &param)
    {
        (void)pParam->pMethodDesc->DoPrestub(NULL /* MethodTable */, pParam->callerGCMode);
    }
