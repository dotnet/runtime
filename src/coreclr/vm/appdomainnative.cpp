...
// static
extern "C" void QCALLTYPE AppDomain_CreateDynamicAssembly(QCall::ObjectHandleOnStack assemblyLoadContext, NativeAssemblyNameParts* pAssemblyNameParts, INT32 hashAlgorithm, INT32 access, QCall::ObjectHandleOnStack retAssembly, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" void QCALLTYPE AssemblyNative_GetLoadedAssemblies(QCall::ObjectHandleOnStack retAssemblies, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" BOOL QCALLTYPE AppContext_TryGetHostPropertyValue(LPCWSTR name, QCall::StringHandleOnStack retValue, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" void QCALLTYPE String_IsInterned(QCall::StringHandleOnStack str, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" void QCALLTYPE String_Intern(QCall::StringHandleOnStack str, QCallException* qcallError)
{
    QCALL_CONTRACT;
