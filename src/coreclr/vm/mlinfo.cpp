...
#include "dispparammarshaler.h"
    ...
    static const int        ENUMERATOR_TO_ENUM_VARIANT_CM_NAME_LEN    = MINIPAL_LENGTHOF(ENUMERATOR_TO_ENUM_VARIANT_CM_NAME);
    static const char       ENUMERATOR_TO_ENUM_VARIANT_CM_COOKIE[]    = {""};
    static const int        ENUMERATOR_TO_ENUM_VARIANT_CM_COOKIE_LEN  = MINIPAL_LENGTHOF(ENUMERATOR_TO_ENUM_VARIANT_CM_COOKIE);
