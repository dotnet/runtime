...
extern "C" void QCALLTYPE EventPipeInternal_Disable(UINT64 sessionID, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" BOOL QCALLTYPE EventPipeInternal_GetSessionInfo(UINT64 sessionID, EventPipeSessionInfo *pSessionInfo, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" INT_PTR QCALLTYPE EventPipeInternal_GetProvider(_In_z_ LPCWSTR providerName, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" void QCALLTYPE EventPipeInternal_DeleteProvider(INT_PTR provHandle, QCallException* qcallError)
{
    QCALL_CONTRACT;
    BEGIN_QCALL;
...
extern "C" int QCALLTYPE EventPipeInternal_EventActivityIdControl(uint32_t controlCode, GUID *pActivityId, QCallException* qcallError)
{
...
extern "C" BOOL QCALLTYPE EventPipeInternal_GetNextEvent(UINT64 sessionID, EventPipeEventInstanceData *pInstance, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" BOOL QCALLTYPE EventPipeInternal_SignalSession(UINT64 sessionID, QCallException* qcallError)
{
    QCALL_CONTRACT;
...
extern "C" BOOL QCALLTYPE EventPipeInternal_WaitForSessionSignal(UINT64 sessionID, INT32 timeoutMs, QCallException* qcallError)
{
    QCALL_CONTRACT;
