...
static_assert_no_msg(MINIPAL_LENGTHOF(SHARED_MEMORY_LOCK_FILES_DIRECTORY_NAME) >= MINIPAL_LENGTHOF(SHARED_MEMORY_SHARED_MEMORY_DIRECTORY_NAME));

#define SHARED_MEMORY_GLOBAL_DIRECTORY_NAME "global"
#define SHARED_MEMORY_SESSION_DIRECTORY_NAME_PREFIX "session"
static_assert_no_msg(MINIPAL_LENGTHOF(SHARED_MEMORY_SESSION_DIRECTORY_NAME_PREFIX) >= MINIPAL_LENGTHOF(SHARED_MEMORY_GLOBAL_DIRECTORY_NAME));
