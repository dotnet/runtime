...
#if defined(HOST_ARM64) && !defined(TARGET_APPLE) && !defined(TARGET_FREEBSD)
...
#endif // HOST_ARM64 && !TARGET_APPLE && !TARGET_FREEBSD
...
#if defined(HOST_64BIT) && defined(HOST_ARM64) && !defined(TARGET_FREEBSD) && !defined(TARGET_APPLE)
/*++
Function :
...
#endif // HOST_64BIT && HOST_ARM64 && !TARGET_FREEBSD && !TARGET_APPLE
