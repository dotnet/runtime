...
#define CONTEXT_HWCAP_LSX_BIT (4)
#define CONTEXT_HWCAP_LASX_BIT (5)
#define CONTEXT_HWCAP_LSX (1 << CONTEXT_HWCAP_LSX_BIT)
#define CONTEXT_HWCAP_LASX (1 << CONTEXT_HWCAP_LASX_BIT)
