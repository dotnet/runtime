...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("// IF YOU NEED TO UPDATE UNICODE VERSION FOLLOW THE GUIDE AT src\coreclr\System.Private.CoreLib\Tools\GenUnicodeProp\Updating-Unicode-Versions.md");
        Console.WriteLine("//");
        Console.WriteLine();
