...
./runpaltests.sh $HELIX_WORKITEM_ROOT $HELIX_WORKITEM_ROOT/testoutput $HELIX_WORKITEM_ROOT/testoutputtmp
exit_code_paltests=$?
cp $TEST_OUTPUT_DIR_HELIX/pal_tests.xml testResults.xml
