...
DEFINE_METASIG_T(SM(ComWrappers_Obj_CreateFlags_Scenario_RefInt_RetPtrVoid, C(COMWRAPPERS) j g(CREATECOMINTERFACEFLAGS) g(COMWRAPPERSSCENARIO) r(i), P(v)))
DEFINE_METASIG_T(SM(ComWrappers_IntPtr_CreateFlags_Scenario_RetObj, C(COMWRAPPERS) I g(CREATEOBJECTFLAGS) g(COMWRAPPERSSCENARIO), j))
