...
FCFuncStart(gCOMTypeHandleFuncs)
    ...
    QCFuncElement("GetAllocatorFtn", RuntimeTypeHandle::GetAllocatorFtn)
    QCFuncElement("GetDefaultCtor", RuntimeTypeHandle::GetDefaultCtor)
    QCFuncElement("AllocateComObject", RuntimeTypeHandle::AllocateComObject)
