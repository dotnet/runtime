...
FCFuncStart(gMathFuncs)
    QCFuncElement("Abs", fabs)
    QCFuncElement("AbsF", fabsf)
    QCFuncElement("Acos", acos)
    QCFuncElement("Acosh", acosh)
    QCFuncElement("Asin", asin)
    QCFuncElement("Asinh", asinh)
    QCFuncElement("Atan", atan)
    QCFuncElement("Atanh", atanh)
    QCFuncElement("Atan2", atan2)
    QCFuncElement("Cbrt", cbrt)
    QCFuncElement("Ceiling", ceil)
    QCFuncElement("Cos", cos)
    QCFuncElement("Cosh", cosh)
    QCFuncElement("Exp", exp)
    QCFuncElement("Floor", floor)
    QCFuncElement("FMod", fmod)
    QCFuncElement("FusedMultiplyAdd", fma)
    QCFuncElement("ILogB", ilogb)
    QCFuncElement("Log", log)
    QCFuncElement("Log2", log2)
    QCFuncElement("Log10", log10)
    QCFuncElement("ModF", modf)
    QCFuncElement("Pow", pow)
    QCFuncElement("ScaleB", scalbn)
    QCFuncElement("Sin", sin)
    QCFuncElement("Sinh", sinh)
    QCFuncElement("Sqrt", sqrt)
    QCFuncElement("Tan", tan)
    QCFuncElement("Tanh", tanh)
FCFuncEnd()

FCFuncStart(gMathFFuncs)
    QCFuncElement("Acos", acosf)
    QCFuncElement("Acosh", acoshf)
    QCFuncElement("Asin", asinf)
    QCFuncElement("Asinh", asinhf)
    QCFuncElement("Atan", atanf)
    QCFuncElement("Atanh", atanhf)
    QCFuncElement("Atan2", atan2f)
    QCFuncElement("Cbrt", cbrtf)
    QCFuncElement("Ceiling", ceilf)
    QCFuncElement("Cos", cosf)
    QCFuncElement("Cosh", coshf)
    QCFuncElement("Exp", expf)
    QCFuncElement("Floor", floorf)
    QCFuncElement("FMod", fmodf)
    QCFuncElement("FusedMultiplyAdd", fmaf)
    QCFuncElement("ILogB", ilogbf)
    QCFuncElement("Log", logf)
    QCFuncElement("Log2", log2f)
    QCFuncElement("Log10", log10f)
    QCFuncElement("ModF", modff)
    QCFuncElement("Pow", powf)
    QCFuncElement("ScaleB", scalbnf)
    QCFuncElement("Sin", sinf)
    QCFuncElement("Sinh", sinhf)
    QCFuncElement("Sqrt", sqrtf)
    QCFuncElement("Tan", tanf)
    QCFuncElement("Tanh", tanhf)
FCFuncEnd()
