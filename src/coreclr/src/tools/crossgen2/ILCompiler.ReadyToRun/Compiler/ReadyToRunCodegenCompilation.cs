    ...
    public sealed class ReadyToRunCodegenCompilation : Compilation
    {
        ...
        public override void Compile(string outputFile)
        {
            ...
            using (PerfEventSource.StartStopEvents.EmittingEvents())
            {
                ...
                ReadyToRunObjectWriter.EmitObject(outputFile, componentModule: null, nodes, NodeFactory, _generateMapFile, _customPESectionAllignment);
        ...
        private void RewriteComponentFile(string inputFile, string outputFile, string ownerExecutableName)
        {
            ...
            ReadyToRunObjectWriter.EmitObject(outputFile, componentModule: inputModule, componentGraph.MarkedNodeList, componentFactory, generateMapFile: false, customPESectionAllignment: null);
        }
