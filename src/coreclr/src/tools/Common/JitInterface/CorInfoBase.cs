...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedFunctionPointerAttribute(default(CallingConvention))]
        delegate void __setPatchpointInfo(IntPtr _this, IntPtr* ppException, CORINFO_PATCHPOINT_INFO* patchpointInfo);
        [UnmanagedFunctionPointerAttribute(default(CallingConvention))]
        ...
        static void _setPatchpointInfo(IntPtr thisHandle, IntPtr* ppException, CORINFO_PATCHPOINT_INFO* patchpointInfo)
        {
            var _this = GetThis(thisHandle);
            try
            {
        ...
        static IntPtr GetUnmanagedCallbacks(out Object keepAlive)
        {
            ...
            delegates[93] = d93;
            var d94 = new __setPatchpointInfo(_setPatchpointInfo);
