...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedFunctionPointerAttribute(default(CallingConvention))]
        delegate CORINFO_CLASS_STRUCT_* __getUniqueImplementingClass(IntPtr _this, IntPtr* ppException, CORINFO_CLASS_STRUCT_* baseType);
        [UnmanagedFunctionPointerAttribute(default(CallingConvention))]
        ...
        static CORINFO_CLASS_STRUCT_* _getUniqueImplementingClass(IntPtr thisHandle, IntPtr* ppException, CORINFO_CLASS_STRUCT_* baseType)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getUniqueImplementingClass(baseType);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        {
            IntPtr * callbacks = (IntPtr *)Marshal.AllocCoTaskMem(sizeof(IntPtr) * 171);
            Object[] delegates = new Object[171];
            ...
            delegates[14] = d14;
            var d15 = new __getUniqueImplementingClass(_getUniqueImplementingClass);
            callbacks[15] = Marshal.GetFunctionPointerForDelegate(d15);
            delegates[15] = d15;
            var d16 = new __expandRawHandleIntrinsic(_expandRawHandleIntrinsic);
            callbacks[16] = Marshal.GetFunctionPointerForDelegate(d16);
            delegates[16] = d16;
            var d17 = new __getIntrinsicID(_getIntrinsicID);
            callbacks[17] = Marshal.GetFunctionPointerForDelegate(d17);
            delegates[17] = d17;
            var d18 = new __isIntrinsicType(_isIntrinsicType);
            callbacks[18] = Marshal.GetFunctionPointerForDelegate(d18);
            delegates[18] = d18;
            var d19 = new __getUnmanagedCallConv(_getUnmanagedCallConv);
            callbacks[19] = Marshal.GetFunctionPointerForDelegate(d19);
            delegates[19] = d19;
            var d20 = new __pInvokeMarshalingRequired(_pInvokeMarshalingRequired);
            callbacks[20] = Marshal.GetFunctionPointerForDelegate(d20);
            delegates[20] = d20;
            var d21 = new __satisfiesMethodConstraints(_satisfiesMethodConstraints);
            callbacks[21] = Marshal.GetFunctionPointerForDelegate(d21);
            delegates[21] = d21;
            var d22 = new __isCompatibleDelegate(_isCompatibleDelegate);
            ...
            delegates[25] = d25;
            var d26 = new __setPatchpointInfo(_setPatchpointInfo);
            callbacks[26] = Marshal.GetFunctionPointerForDelegate(d26);
            delegates[26] = d26;
            var d27 = new __getOSRInfo(_getOSRInfo);
            ...
            delegates[34] = d34;
            var d35 = new __getStringLiteral(_getStringLiteral);
            ...
            delegates[37] = d37;
            var d38 = new __getClassNameFromMetadata(_getClassNameFromMetadata);
            callbacks[38] = Marshal.GetFunctionPointerForDelegate(d38);
            delegates[38] = d38;
            var d39 = new __getTypeInstantiationArgument(_getTypeInstantiationArgument);
            callbacks[39] = Marshal.GetFunctionPointerForDelegate(d39);
            delegates[39] = d39;
            var d40 = new __appendClassName(_appendClassName);
            callbacks[40] = Marshal.GetFunctionPointerForDelegate(d40);
            delegates[40] = d40;
            var d41 = new __isValueClass(_isValueClass);
            callbacks[41] = Marshal.GetFunctionPointerForDelegate(d41);
            delegates[41] = d41;
            var d42 = new __canInlineTypeCheck(_canInlineTypeCheck);
            callbacks[42] = Marshal.GetFunctionPointerForDelegate(d42);
            delegates[42] = d42;
            var d43 = new __getClassAttribs(_getClassAttribs);
            callbacks[43] = Marshal.GetFunctionPointerForDelegate(d43);
            delegates[43] = d43;
            var d44 = new __isStructRequiringStackAllocRetBuf(_isStructRequiringStackAllocRetBuf);
            callbacks[44] = Marshal.GetFunctionPointerForDelegate(d44);
            delegates[44] = d44;
            var d45 = new __getClassModule(_getClassModule);
            callbacks[45] = Marshal.GetFunctionPointerForDelegate(d45);
            delegates[45] = d45;
            var d46 = new __getModuleAssembly(_getModuleAssembly);
            callbacks[46] = Marshal.GetFunctionPointerForDelegate(d46);
            delegates[46] = d46;
            var d47 = new __getAssemblyName(_getAssemblyName);
            callbacks[47] = Marshal.GetFunctionPointerForDelegate(d47);
            delegates[47] = d47;
            var d48 = new __LongLifetimeMalloc(_LongLifetimeMalloc);
            callbacks[48] = Marshal.GetFunctionPointerForDelegate(d48);
            delegates[48] = d48;
            var d49 = new __LongLifetimeFree(_LongLifetimeFree);
            callbacks[49] = Marshal.GetFunctionPointerForDelegate(d49);
            delegates[49] = d49;
            var d50 = new __getClassModuleIdForStatics(_getClassModuleIdForStatics);
            callbacks[50] = Marshal.GetFunctionPointerForDelegate(d50);
            delegates[50] = d50;
            var d51 = new __getClassSize(_getClassSize);
            callbacks[51] = Marshal.GetFunctionPointerForDelegate(d51);
            delegates[51] = d51;
            var d52 = new __getHeapClassSize(_getHeapClassSize);
            callbacks[52] = Marshal.GetFunctionPointerForDelegate(d52);
            delegates[52] = d52;
            var d53 = new __canAllocateOnStack(_canAllocateOnStack);
            callbacks[53] = Marshal.GetFunctionPointerForDelegate(d53);
            delegates[53] = d53;
            var d54 = new __getClassAlignmentRequirement(_getClassAlignmentRequirement);
            callbacks[54] = Marshal.GetFunctionPointerForDelegate(d54);
            delegates[54] = d54;
            var d55 = new __getClassGClayout(_getClassGClayout);
            callbacks[55] = Marshal.GetFunctionPointerForDelegate(d55);
            delegates[55] = d55;
            var d56 = new __getClassNumInstanceFields(_getClassNumInstanceFields);
            callbacks[56] = Marshal.GetFunctionPointerForDelegate(d56);
            delegates[56] = d56;
            var d57 = new __getFieldInClass(_getFieldInClass);
            callbacks[57] = Marshal.GetFunctionPointerForDelegate(d57);
            delegates[57] = d57;
            var d58 = new __checkMethodModifier(_checkMethodModifier);
            callbacks[58] = Marshal.GetFunctionPointerForDelegate(d58);
            delegates[58] = d58;
            var d59 = new __getNewHelper(_getNewHelper);
            callbacks[59] = Marshal.GetFunctionPointerForDelegate(d59);
            delegates[59] = d59;
            var d60 = new __getNewArrHelper(_getNewArrHelper);
            callbacks[60] = Marshal.GetFunctionPointerForDelegate(d60);
            delegates[60] = d60;
            var d61 = new __getCastingHelper(_getCastingHelper);
            callbacks[61] = Marshal.GetFunctionPointerForDelegate(d61);
            delegates[61] = d61;
            var d62 = new __getSharedCCtorHelper(_getSharedCCtorHelper);
            ...
            delegates[131] = d131;
            var d132 = new __getAddressOfPInvokeTarget(_getAddressOfPInvokeTarget);
            callbacks[132] = Marshal.GetFunctionPointerForDelegate(d132);
            delegates[132] = d132;
            var d133 = new __GetCookieForPInvokeCalliSig(_GetCookieForPInvokeCalliSig);
            callbacks[133] = Marshal.GetFunctionPointerForDelegate(d133);
            delegates[133] = d133;
            var d134 = new __canGetCookieForPInvokeCalliSig(_canGetCookieForPInvokeCalliSig);
            callbacks[134] = Marshal.GetFunctionPointerForDelegate(d134);
            delegates[134] = d134;
            var d135 = new __getJustMyCodeHandle(_getJustMyCodeHandle);
            callbacks[135] = Marshal.GetFunctionPointerForDelegate(d135);
            delegates[135] = d135;
            var d136 = new __GetProfilingHandle(_GetProfilingHandle);
            callbacks[136] = Marshal.GetFunctionPointerForDelegate(d136);
            delegates[136] = d136;
            var d137 = new __getCallInfo(_getCallInfo);
            callbacks[137] = Marshal.GetFunctionPointerForDelegate(d137);
            delegates[137] = d137;
            var d138 = new __canAccessFamily(_canAccessFamily);
            callbacks[138] = Marshal.GetFunctionPointerForDelegate(d138);
            delegates[138] = d138;
            var d139 = new __isRIDClassDomainID(_isRIDClassDomainID);
            callbacks[139] = Marshal.GetFunctionPointerForDelegate(d139);
            delegates[139] = d139;
            var d140 = new __getClassDomainID(_getClassDomainID);
            callbacks[140] = Marshal.GetFunctionPointerForDelegate(d140);
            delegates[140] = d140;
            var d141 = new __getFieldAddress(_getFieldAddress);
            callbacks[141] = Marshal.GetFunctionPointerForDelegate(d141);
            delegates[141] = d141;
            var d142 = new __getStaticFieldCurrentClass(_getStaticFieldCurrentClass);
            ...
            delegates[153] = d153;
            var d154 = new __notifyInstructionSetUsage(_notifyInstructionSetUsage);
            ...
            delegates[163] = d163;
            var d164 = new __allocMethodBlockCounts(_allocMethodBlockCounts);
            callbacks[164] = Marshal.GetFunctionPointerForDelegate(d164);
            delegates[164] = d164;
            var d165 = new __getMethodBlockCounts(_getMethodBlockCounts);
            ...
            delegates[168] = d168;
            var d169 = new __getExpectedTargetArchitecture(_getExpectedTargetArchitecture);
            callbacks[169] = Marshal.GetFunctionPointerForDelegate(d169);
            delegates[169] = d169;
            var d170 = new __getJitFlags(_getJitFlags);
