...
namespace R2RTest
{
    ...
    public abstract class CompilerRunner
    {
        ...
        public virtual ProcessParameters CompilationProcess(string outputFileName, IEnumerable<string> inputAssemblyFileNames)
        {
            ...
            // Native Crossgen1 on Linux ARM / ARM64 needs to be run using Shell execute
            processParameters.UseShellExecute = _options.ArchitectureIsARM || _options.ArchitectureIsARM64;
