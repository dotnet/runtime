...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public static class Avx
    {
        ...
        /// </summary>
        public static unsafe Vector128<float> BroadcastElementToVector128(float* source) => BroadcastElementToVector128(source);

        /// <summary>
        /// __m256 _mm256_broadcast_ss (float const * mem_addr)
        ///   VBROADCASTSS ymm, m32
        /// </summary>
        public static unsafe Vector256<float> BroadcastElementToVector256(float* source) => BroadcastElementToVector256(source);
        /// <summary>
        /// __m256d _mm256_broadcast_sd (double const * mem_addr)
        ///   VBROADCASTSD ymm, m64
        /// </summary>
        public static unsafe Vector256<double> BroadcastElementToVector256(double* source) => BroadcastElementToVector256(source);
