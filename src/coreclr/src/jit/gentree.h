...
//---------------------------------------------------------------------
    ...
    // This returns true for any node that is represented by 'GenTreeIndir'.
    // It includes indirections of all types, include structs, as well as GT_NULLCHECK.
    // isIndir() returns true only for GT_IND and GT_STOREIND.
