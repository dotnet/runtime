...
enum CrstType
{
    ...
    CrstExternalObjectContextCache = 34,
    CrstFCall = 35,
    CrstFuncPtrStubs = 36,
    CrstFusionAppCtx = 37,
    CrstGCCover = 38,
    ...
    CrstHandleTable = 40,
    CrstHostAssemblyMap = 41,
    CrstHostAssemblyMapAdd = 42,
    CrstIbcProfile = 43,
    CrstIJWFixupData = 44,
    CrstIJWHash = 45,
    CrstILStubGen = 46,
    ...
    CrstPinnedByrefValidation = 77,
    CrstProfilerGCRefDataFreeList = 78,
    CrstProfilingAPIStatus = 79,
    CrstRCWCache = 80,
    CrstRCWCleanupList = 81,
    CrstReadyToRunEntryPointToMethodDescMap = 82,
    CrstReflection = 83,
    CrstReJITGlobalRequest = 84,
    CrstRemoting = 85,
