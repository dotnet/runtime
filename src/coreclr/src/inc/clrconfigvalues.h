...
// Diagnostics Server
//
RETAIL_CONFIG_STRING_INFO(EXTERNAL_DiagnosticsServerAddress, W("DiagnosticsServerAddress"), "The full path including filename for the OS transport (NamedPipe on Windows; Unix Domain Socket on Linux) to be used by the Diagnostics Server");
