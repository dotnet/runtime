...
//-------------------------------------------------------------------------------------------
void GetHRMsg(HRESULT hresult, SString<EncodingUnicode> &result, BOOL bNoGeekStuff = FALSE);
...
class Exception
{
 ...
 public:
    ...
    virtual void GetMessage(SString<EncodingUnicode> &s);
...
class HRMsgException : public HRException
{
 ...
 protected:
    SString<EncodingUnicode> m_msg;

 public:
    HRMsgException();
    HRMsgException(HRESULT hr, SString<EncodingUnicode> const &msg);

    // Virtual overrides
    void GetMessage(SString<EncodingUnicode> &s);
...
class OutOfMemoryException : public Exception
{
 ...
 public:
    ...
    void GetMessage(SString<EncodingUnicode> &result) { WRAPPER_NO_CONTRACT; result.Set(W("Out Of Memory")); }
...
inline HRMsgException::HRMsgException(HRESULT hr, SString<EncodingUnicode> const &s)
...
inline HRESULT IfFailThrow(HRESULT hr, SString<EncodingUnicode> &msg)
{
    WRAPPER_NO_CONTRACT;
