...
HELPER(READYTORUN_HELPER_AsyncHelpersAllocContinuation,         CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION,                )
HELPER(READYTORUN_HELPER_AsyncHelpersAllocContinuationClass,    CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION_CLASS,          )
HELPER(READYTORUN_HELPER_AsyncHelpersAllocContinuationMethod,   CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION_METHOD,         )
HELPER(READYTORUN_HELPER_AsyncHelpersCaptureContexts,      CORINFO_HELP_ASYNC_HELPERS_CAPTURE_CONTEXTS,            )
HELPER(READYTORUN_HELPER_AsyncHelpersRestoreContexts,      CORINFO_HELP_ASYNC_HELPERS_RESTORE_CONTEXTS,            )
HELPER(READYTORUN_HELPER_AsyncHelpersCaptureExecutionContext,       CORINFO_HELP_ASYNC_HELPERS_CAPTURE_EXECUTION_CONTEXT,   )
HELPER(READYTORUN_HELPER_AsyncHelpersRestoreExecutionContext,       CORINFO_HELP_ASYNC_HELPERS_RESTORE_EXECUTION_CONTEXT,   )
HELPER(READYTORUN_HELPER_AsyncHelpersRestoreContextsOnSuspension,     CORINFO_HELP_ASYNC_HELPERS_RESTORE_CONTEXTS_ON_SUSPENSION, )
HELPER(READYTORUN_HELPER_AsyncHelpersCaptureContinuationContext,     CORINFO_HELP_ASYNC_HELPERS_CAPTURE_CONTINUATION_CONTEXT, )
