...
RETAIL_CONFIG_DWORD_INFO(INTERNAL_SendMethodDetailsForInlinees, W("SendMethodDetailsForInlinees"), 0, "Specifies whether the runtime should send MethodDetails events for inlinees")
