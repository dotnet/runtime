...
#if defined(TARGET_IOS) || defined(TARGET_TVOS) || defined(TARGET_MACCATALYST) || defined(FEATURE_NO_DYNAMIC_CODEGEN)
...
#endif // defined(TARGET_IOS) || defined(TARGET_TVOS) || defined(TARGET_MACCATALYST) || defined(FEATURE_NO_DYNAMIC_CODEGEN)
