...
RETAIL_CONFIG_STRING_INFO(INTERNAL_CrashReportMaxFileCount, W("CrashReportMaxFileCount"), "Maximum number of lifecycle-managed in-proc crash report JSON files to retain (positive integer); default 32")
