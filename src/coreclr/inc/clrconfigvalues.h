...
RETAIL_CONFIG_DWORD_INFO(UNSUPPORTED_ForceDisableGCWriteBarrierCopy, W("ForceDisableGCWriteBarrierCopy"), 0, "Forces the GC write barrier copy to be disabled")
