...
// It will be set in InitJITHelpers2
    ...
    DYNAMICJITHELPER(CORINFO_HELP_MEMSET,       NULL,                  CORINFO_HELP_SIG_CANNOT_USE_ALIGN_STUB)
    DYNAMICJITHELPER(CORINFO_HELP_MEMCPY,       NULL,                  CORINFO_HELP_SIG_CANNOT_USE_ALIGN_STUB)
