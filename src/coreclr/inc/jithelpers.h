...
//
    ...
    DYNAMICJITHELPER(CORINFO_HELP_MON_ENTER,               NULL, METHOD__SYNCHRONIZEDMETHODHELPERS__MONITOR_ENTER)
    DYNAMICJITHELPER(CORINFO_HELP_MON_EXIT,                NULL, METHOD__SYNCHRONIZEDMETHODHELPERS__MONITOR_EXIT)
#else
