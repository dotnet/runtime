...
// It will be set in InitJITHelpers2
    ...
    JITHELPER(CORINFO_HELP_DBL2INT_XCOMPAT,     JIT_Dbl2IntXCompat,    CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2INT_XCOMPAT_OVF, JIT_Dbl2IntXCompatOvf, CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2UINT_XCOMPAT,    JIT_Dbl2UIntXCompat,   CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2UINT_XCOMPAT_OVF,JIT_Dbl2UIntXCompatOvf,CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2LNG_XCOMPAT,     JIT_Dbl2LngXCompat,    CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2LNG_XCOMPAT_OVF, JIT_Dbl2LngXCompatOvf, CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2ULNG_XCOMPAT,    JIT_Dbl2ULngXCompat,   CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2ULNG_XCOMPAT_OVF,JIT_Dbl2ULngXCompatOvf,CORINFO_HELP_SIG_8_STACK)
