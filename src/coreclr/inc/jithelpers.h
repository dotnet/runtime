...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_CALLCONSTRUCTORSTRUCT,  NULL,   METHOD__ACTIVATOR__CALL_CONSTRUCTOR_STRUCT)
    DYNAMICJITHELPER(CORINFO_HELP_CALLCONSTRUCTOR,        NULL,   METHOD__ACTIVATOR__CALL_CONSTRUCTOR)
