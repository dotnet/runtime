...
// It will be set in InitJITHelpers2
    ...
    DYNAMICJITHELPER(CORINFO_HELP_THROWEXACT,   IL_ThrowExact,      CORINFO_HELP_SIG_REG_ONLY)
    ...
    DYNAMICJITHELPER(CORINFO_HELP_ALLOC_CONTINUATION, NULL, CORINFO_HELP_SIG_REG_ONLY)
