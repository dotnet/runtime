...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_PATCHPOINT, NULL, METHOD__THREAD__PATCHPOINT)
    DYNAMICJITHELPER(CORINFO_HELP_PATCHPOINT_FORCED, NULL, METHOD__THREAD__PATCHPOINT_FORCED)
