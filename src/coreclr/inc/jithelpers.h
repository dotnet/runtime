...
//
    ...
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_ASYNCCALLCONTINUATION, NULL, METHOD__ASYNC_HELPERS__ASYNC_CALL_CONTINUATION)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_TASKFROMEXCEPTION, NULL, METHOD__ASYNC_HELPERS__TASK_FROM_EXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_VALUETASKFROMEXCEPTION, NULL, METHOD__ASYNC_HELPERS__VALUETASK_FROM_EXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_FINALIZETASKRETURNINGTHUNK, NULL, METHOD__ASYNC_HELPERS__FINALIZE_TASK_RETURNING_THUNK)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_FINALIZEVALUETASKRETURNINGTHUNK, NULL, METHOD__ASYNC_HELPERS__FINALIZE_VALUETASK_RETURNING_THUNK)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_TRANSPARENTAWAIT, NULL, METHOD__ASYNC_HELPERS__TRANSPARENT_AWAIT)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_COMPLETEDTASK, NULL, METHOD__ASYNC_HELPERS__COMPLETED_TASK)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNCHELPERS_COMPLETEDTASKRESULT, NULL, METHOD__ASYNC_HELPERS__COMPLETED_TASK_RESULT)

    // ExecutionAndSyncBlockStore methods
    DYNAMICJITHELPER(CORINFO_HELP_EXECUTIONANDSYNCBLOCKSTORE_PUSH, NULL, METHOD__EXECUTIONANDSYNCBLOCKSTORE__PUSH)
    DYNAMICJITHELPER(CORINFO_HELP_EXECUTIONANDSYNCBLOCKSTORE_POP, NULL, METHOD__EXECUTIONANDSYNCBLOCKSTORE__POP)

    // Task methods
    DYNAMICJITHELPER(CORINFO_HELP_TASK_FROMRESULT_T, NULL, METHOD__TASK__FROM_RESULT_T)
    DYNAMICJITHELPER(CORINFO_HELP_TASK_GET_COMPLETEDTASK, NULL, METHOD__TASK__GET_COMPLETED_TASK)
    DYNAMICJITHELPER(CORINFO_HELP_TASK_GET_ISCOMPLETED, NULL, METHOD__TASK__GET_ISCOMPLETED)
    DYNAMICJITHELPER(CORINFO_HELP_TASK_GET_RESULT, NULL, METHOD__TASK_1__GET_RESULT)

    // ValueTask methods
    DYNAMICJITHELPER(CORINFO_HELP_VALUETASK_FROMRESULT_T, NULL, METHOD__VALUETASK__FROM_RESULT_T)
    DYNAMICJITHELPER(CORINFO_HELP_VALUETASK_GET_COMPLETEDTASK, NULL, METHOD__VALUETASK__GET_COMPLETED_TASK)
    DYNAMICJITHELPER(CORINFO_HELP_VALUETASK_GET_ISCOMPLETED, NULL, METHOD__VALUETASK__GET_ISCOMPLETED)
    DYNAMICJITHELPER(CORINFO_HELP_VALUETASK_THROWIFCOMPLETEDUNSUCCESSFULLY, NULL, METHOD__VALUETASK__THROW_IF_COMPLETED_UNSUCCESSFULLY)
    DYNAMICJITHELPER(CORINFO_HELP_VALUETASK_ASTASKORNOTIFIER, NULL, METHOD__VALUETASK__AS_TASK_OR_NOTIFIER)
    DYNAMICJITHELPER(CORINFO_HELP_VALUETASK_GET_RESULT, NULL, METHOD__VALUETASK_1__GET_RESULT)
