...
// It will be set in InitJITHelpers2
    ...
    DYNAMICJITHELPER(CORINFO_HELP_RNGCHKFAIL,   NULL,               METHOD__THROW_HELPERS__THROWINDEXOUTOFRANGEEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_OVERFLOW,     NULL,               METHOD__THROW_HELPERS__THROWOVERFLOWEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROWDIVZERO, NULL,               METHOD__THROW_HELPERS__THROWDIVIDEBYZEROEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROWNULLREF, NULL,               METHOD__THROW_HELPERS__THROWNULLREFEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_VERIFICATION, NULL,               METHOD__THROW_HELPERS__THROWVERIFICATIONEXCEPTION)
    ...
    DYNAMICJITHELPER(CORINFO_HELP_THROW_ARGUMENTEXCEPTION,              NULL,   METHOD__THROW_HELPERS__THROWARGUMENTEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROW_ARGUMENTOUTOFRANGEEXCEPTION,    NULL,   METHOD__THROW_HELPERS__THROWARGUMENTOUTOFRANGEEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROW_NOT_IMPLEMENTED,                NULL,   METHOD__THROW_HELPERS__THROWNOTIMPLEMENTEDEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROW_PLATFORM_NOT_SUPPORTED,         NULL,   METHOD__THROW_HELPERS__THROWPLATFORMNOTSUPPORTEDEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROW_TYPE_NOT_SUPPORTED,             NULL,   METHOD__THROW_HELPERS__THROWTYPENOTSUPPORTED)
    DYNAMICJITHELPER(CORINFO_HELP_THROW_AMBIGUOUS_RESOLUTION_EXCEPTION, NULL,   METHOD__THROW_HELPERS__THROWAMBIGUOUSRESOLUTIONEXCEPTION)
    DYNAMICJITHELPER(CORINFO_HELP_THROW_ENTRYPOINT_NOT_FOUND_EXCEPTION, NULL,   METHOD__THROW_HELPERS__THROWENTRYPOINTNOTFOUNDEXCEPTION)
