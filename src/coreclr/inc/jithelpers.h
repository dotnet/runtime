...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF,   NULL,   METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF, NULL, METHOD__NIL)
    ...
    DYNAMICJITHELPER(CORINFO_HELP_GET_GCSTATIC_BASE,                NULL, METHOD__STATICSHELPERS__GET_GC_STATIC)
    DYNAMICJITHELPER(CORINFO_HELP_GET_NONGCSTATIC_BASE,             NULL, METHOD__STATICSHELPERS__GET_NONGC_STATIC)
    DYNAMICJITHELPER(CORINFO_HELP_GETDYNAMIC_GCSTATIC_BASE,         NULL, METHOD__STATICSHELPERS__GET_DYNAMIC_GC_STATIC)
    DYNAMICJITHELPER(CORINFO_HELP_GETDYNAMIC_NONGCSTATIC_BASE,      NULL, METHOD__STATICSHELPERS__GET_DYNAMIC_NONGC_STATIC)
    DYNAMICJITHELPER(CORINFO_HELP_GETPINNED_GCSTATIC_BASE,          NULL, METHOD__STATICSHELPERS__GET_DYNAMIC_GC_STATIC)
    DYNAMICJITHELPER(CORINFO_HELP_GETPINNED_NONGCSTATIC_BASE,       NULL, METHOD__STATICSHELPERS__GET_DYNAMIC_NONGC_STATIC)
...
#ifdef TARGET_X86
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF_EAX, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF_EBX, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF_ECX, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF_ESI, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF_EDI, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF_EBP, NULL, METHOD__NIL)

    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF_EAX, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF_EBX, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF_ECX, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF_ESI, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF_EDI, NULL, METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF_EBP, NULL, METHOD__NIL)
#else
