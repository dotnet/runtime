...
// It will be set in InitJITHelpers2
    ...
    JITHELPER(GetNonGCMaxThreadStaticBlocksAddr,       GetNonGCMaxThreadStaticBlocksAddr, CORINFO_HELP_SIG_REG_ONLY)
    JITHELPER(GetGCMaxThreadStaticBlocksAddr,          GetGCMaxThreadStaticBlocksAddr, CORINFO_HELP_SIG_REG_ONLY)
