...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_NEWSFAST_ALIGN_2XPTR,    RhpNew,                   METHOD__NIL)
    DYNAMICJITHELPER(CORINFO_HELP_NEWSFAST_ALIGN_2XPTR_VC, RhpNew,                   METHOD__NIL)
    JITHELPER(CORINFO_HELP_NEWSFAST_ALIGN_2XPTR_FINALIZE,  NULL,                     METHOD__NIL)
    ...
    DYNAMICJITHELPER(CORINFO_HELP_NEWARR_1_ALIGN_2XPTR,    RhpNewVariableSizeObject, METHOD__NIL)
