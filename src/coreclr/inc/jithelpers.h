...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION, NULL, METHOD__ASYNC_HELPERS__ALLOC_CONTINUATION)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION_METHOD, NULL, METHOD__ASYNC_HELPERS__ALLOC_CONTINUATION_METHOD)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION_CLASS, NULL, METHOD__ASYNC_HELPERS__ALLOC_CONTINUATION_CLASS)

    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_CAPTURE_CONTEXTS, NULL, METHOD__ASYNC_HELPERS__CAPTURE_CONTEXTS)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_RESTORE_CONTEXTS, NULL, METHOD__ASYNC_HELPERS__RESTORE_CONTEXTS)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_CAPTURE_EXECUTION_CONTEXT, NULL, METHOD__ASYNC_HELPERS__CAPTURE_EXECUTION_CONTEXT)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_RESTORE_EXECUTION_CONTEXT, NULL, METHOD__ASYNC_HELPERS__RESTORE_EXECUTION_CONTEXT)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_RESTORE_CONTEXTS_ON_SUSPENSION, NULL, METHOD__ASYNC_HELPERS__RESTORE_CONTEXTS_ON_SUSPENSION)
    DYNAMICJITHELPER(CORINFO_HELP_ASYNC_HELPERS_CAPTURE_CONTINUATION_CONTEXT, NULL, METHOD__ASYNC_HELPERS__CAPTURE_CONTINUATION_CONTEXT)
