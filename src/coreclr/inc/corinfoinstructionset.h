...
inline CORINFO_InstructionSetFlags EnsureInstructionSetFlagsAreValid(CORINFO_InstructionSetFlags input)
{
    ...
    do
    {
        ...
        if (resultflags.HasInstructionSet(InstructionSet_AVXVNNI_V512) && !resultflags.HasInstructionSet(InstructionSet_AVX512))
            resultflags.RemoveInstructionSet(InstructionSet_AVXVNNI_V512);
...
#pragma warning(disable: 4065) // disable warning for switch statement with only default label.
    ...
    switch (instructionSet)
    {
        ...
        case InstructionSet_AVX512v3_X64 :
            return "AVX512v3_X64";
        case InstructionSet_AVXVNNI_V512 :
            return "AVXVNNI_V512";
...
#pragma warning(disable: 4065) // disable warning for switch statement with only default label.
    ...
    switch (r2rSet)
    {
        ...
        case READYTORUN_INSTRUCTION_Avx512Vnni: return InstructionSet_AVXVNNI_V512;
