...
DEFINE_DACVAR(PTR_SString, StaticStringHelpers__s_EmptyUnicode, StaticStringHelpers::s_EmptyUnicode)
DEFINE_DACVAR(PTR_EString<EncodingUTF8>, StaticStringHelpers__s_EmptyUtf8, StaticStringHelpers::s_EmptyUtf8)
DEFINE_DACVAR(PTR_EString<EncodingASCII>, StaticStringHelpers__s_EmptyAscii, StaticStringHelpers::s_EmptyAscii)
