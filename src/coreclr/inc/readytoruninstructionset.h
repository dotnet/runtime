...
enum ReadyToRunInstructionSet
{
    ...
    READYTORUN_INSTRUCTION_AvxVnniInt8=84,
    READYTORUN_INSTRUCTION_AvxVnniInt8_V512=85,
    READYTORUN_INSTRUCTION_AvxVnniInt16=86,
    READYTORUN_INSTRUCTION_AvxVnniInt16_V512=87,
