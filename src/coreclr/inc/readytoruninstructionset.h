...
enum ReadyToRunInstructionSet
{
    ...
    READYTORUN_INSTRUCTION_Sha3=85,
    READYTORUN_INSTRUCTION_Sm4=86,
    READYTORUN_INSTRUCTION_SveAes=87,
    READYTORUN_INSTRUCTION_SveSha3=88,
    READYTORUN_INSTRUCTION_SveSm4=89,
