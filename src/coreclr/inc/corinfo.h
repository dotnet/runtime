...
enum CorInfoHelpFunc
{
    ...
    CORINFO_HELP_DBL2INT_XCOMPAT,
    CORINFO_HELP_DBL2INT_XCOMPAT_OVF,
    CORINFO_HELP_DBL2UINT_XCOMPAT,
    CORINFO_HELP_DBL2UINT_XCOMPAT_OVF,
    CORINFO_HELP_DBL2LNG_XCOMPAT,
    CORINFO_HELP_DBL2LNG_XCOMPAT_OVF,
    CORINFO_HELP_DBL2ULNG_XCOMPAT,
    CORINFO_HELP_DBL2ULNG_XCOMPAT_OVF,
