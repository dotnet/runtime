...
enum CorInfoHelpFunc
{
    ...
    CORINFO_HELP_ASYNCHELPERS_ASYNCCALLCONTINUATION,
    CORINFO_HELP_ASYNCHELPERS_TASKFROMEXCEPTION,
    CORINFO_HELP_ASYNCHELPERS_VALUETASKFROMEXCEPTION,
    CORINFO_HELP_ASYNCHELPERS_FINALIZETASKRETURNINGTHUNK,
    CORINFO_HELP_ASYNCHELPERS_FINALIZEVALUETASKRETURNINGTHUNK,
    CORINFO_HELP_ASYNCHELPERS_TRANSPARENTAWAIT,
    CORINFO_HELP_ASYNCHELPERS_COMPLETEDTASK,
    CORINFO_HELP_ASYNCHELPERS_COMPLETEDTASKRESULT,

    // ExecutionAndSyncBlockStore methods
    CORINFO_HELP_EXECUTIONANDSYNCBLOCKSTORE_PUSH,
    CORINFO_HELP_EXECUTIONANDSYNCBLOCKSTORE_POP,

    // Task methods
    CORINFO_HELP_TASK_FROMRESULT_T,
    CORINFO_HELP_TASK_GET_COMPLETEDTASK,
    CORINFO_HELP_TASK_GET_ISCOMPLETED,
    CORINFO_HELP_TASK_GET_RESULT,

    // ValueTask methods
    CORINFO_HELP_VALUETASK_FROMRESULT_T,
    CORINFO_HELP_VALUETASK_GET_COMPLETEDTASK,
    CORINFO_HELP_VALUETASK_GET_ISCOMPLETED,
    CORINFO_HELP_VALUETASK_THROWIFCOMPLETEDUNSUCCESSFULLY,
    CORINFO_HELP_VALUETASK_ASTASKORNOTIFIER,
    CORINFO_HELP_VALUETASK_GET_RESULT,
