...
enum CorInfoHelpFunc
{
    ...
    CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION,
    CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION_METHOD,
    CORINFO_HELP_ASYNC_HELPERS_ALLOC_CONTINUATION_CLASS,

    CORINFO_HELP_ASYNC_HELPERS_CAPTURE_CONTEXTS,
    CORINFO_HELP_ASYNC_HELPERS_RESTORE_CONTEXTS,
    CORINFO_HELP_ASYNC_HELPERS_CAPTURE_EXECUTION_CONTEXT,
    CORINFO_HELP_ASYNC_HELPERS_RESTORE_EXECUTION_CONTEXT,
    CORINFO_HELP_ASYNC_HELPERS_RESTORE_CONTEXTS_ON_SUSPENSION,
    CORINFO_HELP_ASYNC_HELPERS_CAPTURE_CONTINUATION_CONTEXT,
