...
inline RVA PEDecoder::OffsetToRva(COUNT_T fileOffset) const
{
    ...
    if(fileOffset > 0)
    {
        ...
        COMPILER_ASSUME (section!=NULL); //TODO: actually it is possible that it si null we need to rethink how we handle this cases and do better there
...
inline PTR_VOID PEDecoder::GetTlsRange(COUNT_T * pSize) const
{
    ...
    COMPILER_ASSUME (pTlsHeader!=NULL);
