...
CDAC_TYPE_INDETERMINATE(BinderSpaceAssembly)
CDAC_TYPE_FIELD(BinderSpaceAssembly, /*pointer*/, Binder, cdac_data<BINDER_SPACE::Assembly>::Binder)
CDAC_TYPE_END(BinderSpaceAssembly)
