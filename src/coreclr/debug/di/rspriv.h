...
public:
    ...
    void TypeToTypeArgData(DebuggerIPCE_TypeArgData_DebuggerSide *data);
    ...
    static void GatherTypeData(CordbType *type, DebuggerIPCE_TypeArgData_DebuggerSide **curr_tyargData);
    static void GatherTypeDataForInstantiation(unsigned int genericArgsCount, ICorDebugType *genericArgs[], DebuggerIPCE_TypeArgData_DebuggerSide **curr_tyargData);
