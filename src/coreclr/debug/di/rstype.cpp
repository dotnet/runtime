...
ETObject:
    ...
    case ELEMENT_TYPE_VALUETYPE:  // OK: this E_T_VALUETYPE comes from the EE
    {
        ...
        EX_TRY
        {
            pClassModule = pAppDomain->LookupOrCreateModule(data->ClassTypeData.vmModule, data->ClassTypeData.vmAssembly);
        }
        EX_CATCH_HRESULT(hr);
...
HRESULT CordbType::InitStringOrObjectClass(BOOL fForceInit)
{
    ...
    EX_TRY
    {
        ...
        //
        CordbModule * pTypeModule = m_appdomain->LookupOrCreateModule(vmModule, vmAssembly);
