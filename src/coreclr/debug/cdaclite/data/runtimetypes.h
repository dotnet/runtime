...
namespace data
{
    ...
    struct MethodDescChunk : Struct
    {
        MethodDescChunk() : Struct("MethodDescChunk") {}
        CDAC_PTR(Next)
    };
    ...
    struct StubDispatchFrame : Struct
    {
        ...
        CDAC_PTR(MethodDescPtr)
        CDAC_PTR(RepresentativeMTPtr)
        CDAC_U32(RepresentativeSlot)
    };
    ...
    struct ReadyToRunInfo : Struct
    {
        ...
        CDAC_OPT_PTR(DelayLoadMethodCallThunks)
        ...
        CDAC_OPT_PTR(HotColdMap)
        CDAC_U32(NumHotColdMap)
    };
    ...
    struct InterpreterRealCodeHeader : Struct
    {
        InterpreterRealCodeHeader() : Struct("InterpreterRealCodeHeader") {}
        CDAC_PTR(MethodDesc)
        CDAC_PTR(GCInfo)
    };
