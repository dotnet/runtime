...
namespace cdac
{
    ...
    {
        static const uint32_t MaxRegisterValues = 128;

        uint64_t instructionPointer;
        uint64_t registerValues[MaxRegisterValues];
        uint32_t registerValueCount;
    };

    typedef bool (*ReadThreadContextCallback)(void* context, uint64_t osThreadId, ThreadContext& threadContext);
    ...
    public:
        ...
        Target(const DataDescriptor* descriptor,
               ...
               void* readContext,
               ReadThreadContextCallback readThreadContext = nullptr);
        ...
        bool TryReadThreadContext(uint64_t osThreadId, ThreadContext& threadContext) const;
    ...
    private:
        ...
        void* m_readContext;
        ReadThreadContextCallback m_readThreadContext;
