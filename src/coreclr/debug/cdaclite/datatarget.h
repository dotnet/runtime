...
//
//  * DataTargetAdapter exposes the ICLRDataTarget supplied by createdump as the
//    ICorDebugDataTarget that dbgutil's TryGetSymbol requires.
...
namespace cdac
{
    ...
    public:
        ...
        {
            return m_target->GetThreadContext(dwThreadID, contextFlags, contextSize, pContext);
        }
    };
