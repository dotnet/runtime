...
public:
    ...
    // bool suppressUMChainFromCRLToCOMMethodFrameGeneric - A ridiculous flag that is trying to narrowly
    ...
    void GetStackInfo(
        ...
        CONTEXT *pContext,
        bool suppressUMChainFromCRLToCOMMethodFrameGeneric = false
        );
...
private:
    ...
    bool                    m_suppressUMChainFromCRLToCOMMethodFrameGeneric;
