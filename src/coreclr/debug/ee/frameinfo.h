...
public:
    ...
    // This is set when the currently walked frame is a CRLToCOMMethodFrameGeneric. If the
    // dude doing the walking is trying to ignore such frames (see
    // code:ControllerStackInfo::m_suppressUMChainFromCRLToCOMMethodFrameGeneric), AND
    ...
    bool                fIgnoreThisFrameIfSuppressingUMChainFromCRLToCOMMethodFrameGeneric;
