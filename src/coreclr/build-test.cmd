...
set __FrameworkOutputFolder=%CORE_ROOT%
...
if defined __DoCrossgen (
    ...
    set __FrameworkOutputFolder=!__FrameworkOutputFolder!\Crossgen-ret.out
) else (
    set __FrameworkOutputFolder=!__FrameworkOutputFolder!\CPAOT-ret.out
)
