...
public abstract  class GenSub<T> : IGen<T> 
{
	public abstract bool InstVerify(System.Type t1);
}
	
public class Gen<T> : GenSub<T>
{	
	public T Fld1;
	...
	public override bool InstVerify(System.Type t1)
	{
		bool result = true;
