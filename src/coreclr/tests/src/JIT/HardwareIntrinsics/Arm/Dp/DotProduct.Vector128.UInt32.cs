...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProduct_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__DotProduct_Vector128_UInt32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProduct), new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        private void ValidateResult(UInt32[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProduct)}<UInt32>(Vector128<UInt32>, Vector128<Byte>, Vector128<Byte>): {method} failed:");
