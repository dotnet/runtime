...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DotProduct_Vector64_UInt32()
        {
            var test = new SimpleTernaryOpTest__DotProduct_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProduct_Vector64_UInt32
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt32[] inArray1, Byte[] inArray2, Byte[] inArray3, UInt32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__DotProduct_Vector64_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__DotProduct_Vector64_UInt32 testClass)
            {
        ...
        static SimpleTernaryOpTest__DotProduct_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleTernaryOpTest__DotProduct_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(nameof(Dp.DotProduct), new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<Byte>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Vector64<UInt32> op1, Vector64<Byte> op2, Vector64<Byte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;

            for (var i = 0; i < RetElementCount; i++)
            {
                if (Helpers.DotProduct(firstOp, secondOp, thirdOp, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Dp)}.{nameof(Dp.DotProduct)}<UInt32>(Vector64<UInt32>, Vector64<Byte>, Vector64<Byte>): {method} failed:");
