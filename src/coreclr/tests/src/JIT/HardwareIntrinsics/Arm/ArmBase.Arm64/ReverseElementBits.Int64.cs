...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReverseElementBits_Int64()
        {
            var test = new ScalarUnaryOpTest__ReverseElementBits_Int64();
    ...
    public sealed unsafe class ScalarUnaryOpTest__ReverseElementBits_Int64
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarUnaryOpTest__ReverseElementBits_Int64 testClass)
            {
        ...
        static ScalarUnaryOpTest__ReverseElementBits_Int64()
        {
            _clsVar = TestLibrary.Generator.GetInt64();
        }

        public ScalarUnaryOpTest__ReverseElementBits_Int64()
        {
            Succeeded = true;
