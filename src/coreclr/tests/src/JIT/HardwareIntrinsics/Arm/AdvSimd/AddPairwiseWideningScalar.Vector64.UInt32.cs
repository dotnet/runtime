...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningScalar_Vector64_UInt32()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_UInt32
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt32[] inArray1, UInt64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_UInt32 testClass)
            {
                var result = AdvSimd.AddPairwiseWideningScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_UInt32 testClass)
            {
        ...
        static SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWideningScalar), new Type[] { typeof(Vector64<UInt32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AddPairwiseWideningScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_UInt32();
            var result = AdvSimd.AddPairwiseWideningScalar(test._fld1);
        ...
        private void ValidateResult(UInt32[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.AddPairwiseWidening(firstOp, 0) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningScalar)}<UInt64>(Vector64<UInt32>): {method} failed:");
