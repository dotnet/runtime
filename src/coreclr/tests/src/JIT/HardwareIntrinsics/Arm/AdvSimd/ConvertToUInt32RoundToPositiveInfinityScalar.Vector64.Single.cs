...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar)}<UInt32>(Vector64<Single>): {method} failed:");
