...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingLower_Vector64_Int32()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int32 testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingLower), new Type[] { typeof(Vector128<Int64>) })
        ...
        private void ValidateResult(Int64[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<Int32>(Vector128<Int64>): {method} failed:");
