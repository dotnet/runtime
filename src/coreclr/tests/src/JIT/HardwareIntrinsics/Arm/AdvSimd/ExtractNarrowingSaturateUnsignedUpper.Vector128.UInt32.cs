...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper), new Type[] { typeof(Vector64<UInt32>), typeof(Vector128<Int64>) })
        ...
        private void ValidateResult(Vector64<UInt32> op1, Vector128<Int64> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] left, Int64[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper)}<UInt32>(Vector64<UInt32>, Vector128<Int64>): {method} failed:");
