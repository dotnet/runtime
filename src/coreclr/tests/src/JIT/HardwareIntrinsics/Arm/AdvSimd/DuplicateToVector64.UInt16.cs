...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_UInt16()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector64_UInt16
    {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector64_UInt16()
        {
            _clsVar = TestLibrary.Generator.GetUInt16();
        }

        public DuplicateUnaryOpTest__DuplicateToVector64_UInt16()
        {
            Succeeded = true;
