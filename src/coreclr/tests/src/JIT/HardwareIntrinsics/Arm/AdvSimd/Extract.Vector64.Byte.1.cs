...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector64_Byte_1()
        {
            var test = new ExtractTest__Extract_Vector64_Byte_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector64_Byte_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector64_Byte_1 testClass)
            {
                fixed (Vector64<Byte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Extract(AdvSimd.LoadVector64((Byte*)pFld1), ElementIndex);
        ...
        static ExtractTest__Extract_Vector64_Byte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public ExtractTest__Extract_Vector64_Byte_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector64<Byte>), typeof(byte) })
                                     .Invoke(null, new object[] {
                                        Unsafe.Read<Vector64<Byte>>(_dataTable.inArray1Ptr),
                                        ElementIndex
                                     });

            ValidateResult(_dataTable.inArray1Ptr, (Byte)result);
        }
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector64((Byte*)pClsVar1), ElementIndex);
        ...
        private void ValidateResult(Vector64<Byte> op1, Byte result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(void* op1, Byte result, [CallerMemberName] string method = "")
        {
            Byte[] inArray1 = new Byte[Op1ElementCount];
        ...
        private void ValidateResult(Byte[] firstOp, Byte result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<Byte>, 1): {method} failed:");
