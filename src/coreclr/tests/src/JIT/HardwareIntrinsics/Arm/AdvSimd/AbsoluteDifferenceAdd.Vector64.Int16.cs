...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceAdd_Vector64_Int16()
        {
            var test = new SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector64_Int16 testClass)
            {
        ...
        static SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifferenceAdd), new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] secondOp, Int16[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceAdd)}<Int16>(Vector64<Int16>, Vector64<Int16>, Vector64<Int16>): {method} failed:");
