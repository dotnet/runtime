...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticAdd_Vector128_Int32_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int32_1 testClass)
            {
                var result = AdvSimd.ShiftRightArithmeticAdd(_fld1, _fld2, 1);
        ...
        static ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightArithmeticAdd), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>), typeof(byte) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int32_1();
            var result = AdvSimd.ShiftRightArithmeticAdd(test._fld1, test._fld2, 1);
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.ShiftRightArithmeticAdd(firstOp[i], secondOp[i], Imm) != result[i])
                {
                    succeeded = false;
                    break;
                }
