...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingSignCount_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingSignCount_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__LeadingSignCount_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__LeadingSignCount_Vector128_Int16 testClass)
            {
        ...
        static SimpleUnaryOpTest__LeadingSignCount_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = (short)-TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleUnaryOpTest__LeadingSignCount_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.LeadingSignCount), new Type[] { typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingSignCount)}<Int16>(Vector128<Int16>): {method} failed:");
