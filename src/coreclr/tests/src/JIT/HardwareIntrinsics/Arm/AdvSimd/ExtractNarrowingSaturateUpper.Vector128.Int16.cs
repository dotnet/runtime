...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUpper_Vector128_Int16()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateUpper), new Type[] { typeof(Vector64<Int16>), typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Int16[] left, Int32[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUpper)}<Int16>(Vector64<Int16>, Vector128<Int32>): {method} failed:");
