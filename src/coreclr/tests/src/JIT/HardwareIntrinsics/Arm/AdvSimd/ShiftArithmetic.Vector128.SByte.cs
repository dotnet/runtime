...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftArithmetic_Vector128_SByte()
        {
            var test = new SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte testClass)
            {
                var result = AdvSimd.ShiftArithmetic(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftArithmetic), new Type[] { typeof(Vector128<SByte>), typeof(Vector128<SByte>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftArithmetic(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte();
            var result = AdvSimd.ShiftArithmetic(test._fld1, test._fld2);
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.ShiftArithmetic(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmetic)}<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:");
