...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningUpper_Vector128_Int16_Vector128_SByte()
        {
            var test = new SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddWideningUpper), new Type[] { typeof(Vector128<Int16>), typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(Vector128<Int16> op1, Vector128<SByte> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] left, SByte[] right, Int16[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<Int16>(Vector128<Int16>, Vector128<SByte>): {method} failed:");
