...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpperAndAdd_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningUpperAndAdd), new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<Byte>), typeof(Vector128<Byte>) })
        ...
        private void ValidateResult(Vector128<UInt16> op1, Vector128<Byte> op2, Vector128<Byte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndAdd)}<UInt16>(Vector128<UInt16>, Vector128<Byte>, Vector128<Byte>): {method} failed:");
