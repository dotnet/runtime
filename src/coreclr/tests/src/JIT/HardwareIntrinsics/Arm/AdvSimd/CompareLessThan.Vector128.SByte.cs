...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThan_Vector128_SByte()
        {
            var test = new SimpleBinaryOpTest__CompareLessThan_Vector128_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThan_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThan_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThan_Vector128_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareLessThan_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__CompareLessThan_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareLessThan), new Type[] { typeof(Vector128<SByte>), typeof(Vector128<SByte>) })
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareLessThan)}<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:");
