...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32()
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32 testClass)
            {
                var result = AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate), new Type[] { typeof(Vector128<Int64>), typeof(Vector128<Int32>), typeof(Vector128<Int32>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int32();
            var result = AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Int64[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningUpperAndSubtractSaturate(firstOp, secondOp, thirdOp, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate)}<Int64>(Vector128<Int64>, Vector128<Int32>, Vector128<Int32>): {method} failed:");
