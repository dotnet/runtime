...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyAdd_Vector64_UInt16()
        {
            var test = new SimpleTernaryOpTest__MultiplyAdd_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAdd_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyAdd_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyAdd_Vector64_UInt16 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyAdd_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleTernaryOpTest__MultiplyAdd_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyAdd), new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<UInt16>), typeof(Vector64<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, UInt16[] secondOp, UInt16[] thirdOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyAdd)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
