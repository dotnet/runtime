...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_Byte()
        {
            Succeeded = true;
