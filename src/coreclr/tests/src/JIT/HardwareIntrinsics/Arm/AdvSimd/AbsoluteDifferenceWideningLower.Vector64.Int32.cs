...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningLower_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int32
    {
        private struct DataTable
        {
            ...
            public DataTable(Int32[] inArray1, Int32[] inArray2, UInt64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifferenceWideningLower), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningLower)}<UInt64>(Vector64<Int32>, Vector64<Int32>): {method} failed:");
