...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalNarrowingSaturateLower_Vector64_UInt32_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateLower_Vector64_UInt32_1
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt64[] inArray, UInt32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateLower_Vector64_UInt32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateLower_Vector64_UInt32_1 testClass)
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateLower_Vector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateLower_Vector64_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightLogicalNarrowingSaturateLower), new Type[] { typeof(Vector128<UInt64>), typeof(byte) })
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<UInt64>* pClsVar = &_clsVar)
            {
                var result = AdvSimd.ShiftRightLogicalNarrowingSaturateLower(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt64>* pFld = &test._fld)
            {
                var result = AdvSimd.ShiftRightLogicalNarrowingSaturateLower(
                    AdvSimd.LoadVector128((UInt64*)(pFld)),
                    1
        ...
        private void ValidateResult(UInt64[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalNarrowingSaturateLower)}<UInt32>(Vector128<UInt64>, 1): {method} failed:");
