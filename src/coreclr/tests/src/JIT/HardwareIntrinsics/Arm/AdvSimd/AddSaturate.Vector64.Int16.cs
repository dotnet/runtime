...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector64_Int16()
        {
            Succeeded = true;
