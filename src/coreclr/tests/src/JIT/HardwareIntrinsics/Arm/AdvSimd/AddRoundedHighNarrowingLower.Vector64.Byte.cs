...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddRoundedHighNarrowingLower_Vector64_Byte()
        {
            var test = new SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddRoundedHighNarrowingLower), new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(UInt16[] left, UInt16[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingLower)}<Byte>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:");
