...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplySubtract_Vector64_Int32()
        {
            var test = new SimpleTernaryOpTest__MultiplySubtract_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtract_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplySubtract_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplySubtract_Vector64_Int32 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplySubtract_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleTernaryOpTest__MultiplySubtract_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplySubtract), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        private void ValidateResult(Int32[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtract)}<Int32>(Vector64<Int32>, Vector64<Int32>, Vector64<Int32>): {method} failed:");
