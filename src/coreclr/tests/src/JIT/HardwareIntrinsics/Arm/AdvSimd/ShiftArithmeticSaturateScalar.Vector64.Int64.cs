...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftArithmeticSaturateScalar_Vector64_Int64()
        {
            var test = new SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64 testClass)
            {
                var result = AdvSimd.ShiftArithmeticSaturateScalar(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64 testClass)
            {
                fixed (Vector64<Int64>* pFld1 = &_fld1)
                fixed (Vector64<Int64>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.ShiftArithmeticSaturateScalar(
        ...
        static SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftArithmeticSaturateScalar), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftArithmeticSaturateScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftArithmeticSaturateScalar_Vector64_Int64();
            var result = AdvSimd.ShiftArithmeticSaturateScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Int64[] left, Int64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmeticSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:");
