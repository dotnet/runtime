...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingLower_Vector128_Int64()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingLower_Vector128_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingLower_Vector128_Int64 testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingLower_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingLower_Vector128_Int64()
        {
            Succeeded = true;
