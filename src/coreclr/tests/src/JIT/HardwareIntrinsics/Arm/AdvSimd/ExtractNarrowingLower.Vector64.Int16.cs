...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingLower_Vector64_Int16()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16 testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingLower), new Type[] { typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Int32[] firstOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<Int16>(Vector128<Int32>): {method} failed:");
