...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_Byte()
        {
            var test = new SimpleBinaryOpTest__CompareEqual_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqual_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareEqual_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareEqual_Vector64_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareEqual_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__CompareEqual_Vector64_Byte()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Byte[] left, Byte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:");
