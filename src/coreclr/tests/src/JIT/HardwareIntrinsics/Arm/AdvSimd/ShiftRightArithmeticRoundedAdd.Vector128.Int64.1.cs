...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticRoundedAdd_Vector128_Int64_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int64_1 testClass)
            {
        ...
        static ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightArithmeticRoundedAdd), new Type[] { typeof(Vector128<Int64>), typeof(Vector128<Int64>), typeof(byte) })
