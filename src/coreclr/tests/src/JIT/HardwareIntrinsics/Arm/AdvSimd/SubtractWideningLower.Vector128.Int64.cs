...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningLower_Vector128_Int64()
        {
            var test = new SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningLower), new Type[] { typeof(Vector128<Int64>), typeof(Vector64<Int32>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SubtractWideningLower(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int64();
            var result = AdvSimd.SubtractWideningLower(test._fld1, test._fld2);
        ...
        private void ValidateResult(Vector128<Int64> op1, Vector64<Int32> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, Int32[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.SubtractWidening(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<Int64>(Vector128<Int64>, Vector64<Int32>): {method} failed:");
