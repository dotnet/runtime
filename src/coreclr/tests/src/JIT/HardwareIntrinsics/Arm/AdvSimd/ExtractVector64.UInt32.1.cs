...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector64_UInt32_1()
        {
            var test = new ExtractVectorTest__ExtractVector64_UInt32_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector64_UInt32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractVectorTest__ExtractVector64_UInt32_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public ExtractVectorTest__ExtractVector64_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractVector64), new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>), typeof(byte) })
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32[] secondOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector64)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>, 1): {method} failed:");
