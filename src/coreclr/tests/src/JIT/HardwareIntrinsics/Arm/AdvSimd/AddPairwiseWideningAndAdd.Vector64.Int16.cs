...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningAndAdd_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16
    {
        private struct DataTable
        {
            ...
            public DataTable(Int32[] inArray1, Int16[] inArray2, Int32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWideningAndAdd), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Vector64<Int32> op1, Vector64<Int16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAdd)}<Int32>(Vector64<Int32>, Vector64<Int16>): {method} failed:");
