...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifference_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__AbsoluteDifference_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifference_Vector128_Int32
    {
        private struct DataTable
        {
            ...
            public DataTable(Int32[] inArray1, Int32[] inArray2, UInt32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteDifference_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteDifference_Vector128_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AbsoluteDifference_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AbsoluteDifference_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifference), new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Int32[] left, Int32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifference)}<UInt32>(Vector128<Int32>, Vector128<Int32>): {method} failed:");
