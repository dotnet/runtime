...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateLower_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Byte testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateLower), new Type[] { typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(UInt16[] firstOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateLower)}<Byte>(Vector128<UInt16>): {method} failed:");
