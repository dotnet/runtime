...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7()
        {
            var test = new ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7 testClass)
            {
                var result = AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh(_fld1, _fld2, 7);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7 testClass)
            {
        ...
        static ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh), new Type[] { typeof(Vector64<Int16>), typeof(Vector128<Int16>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh(op1, op2, 7);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector64_Int16_Vector128_Int16_7();
            var result = AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh(test._fld1, test._fld2, 7);
        ...
        private void ValidateResult(Int16[] firstOp, Int16[] secondOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh)}<Int16>(Vector64<Int16>, Vector128<Int16>, 7): {method} failed:");
