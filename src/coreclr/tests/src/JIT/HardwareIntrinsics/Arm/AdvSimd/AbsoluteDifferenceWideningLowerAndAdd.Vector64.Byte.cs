...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte()
        {
            var test = new SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte testClass)
            {
        ...
        static SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifferenceWideningLowerAndAdd), new Type[] { typeof(Vector128<UInt16>), typeof(Vector64<Byte>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(UInt16[] firstOp, Byte[] secondOp, Byte[] thirdOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningLowerAndAdd)}<UInt16>(Vector128<UInt16>, Vector64<Byte>, Vector64<Byte>): {method} failed:");
