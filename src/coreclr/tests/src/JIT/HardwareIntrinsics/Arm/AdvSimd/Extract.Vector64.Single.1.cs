...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_Single_1
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector64<Single>), typeof(byte) })
        ...
        private void ValidateResult(Vector64<Single> op1, Single result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] firstOp, Single result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<Single>, 1): {method} failed:");
