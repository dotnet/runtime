...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16 testClass)
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingSaturateUnsignedLower), new Type[] { typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Int32[] firstOp, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedLower)}<UInt16>(Vector128<Int32>): {method} failed:");
