...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsoluteDifferenceWideningLowerAndAdd), new Type[] { typeof(Vector128<Int16>), typeof(Vector64<SByte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(Vector128<Int16> op1, Vector64<SByte> op2, Vector64<SByte> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] firstOp, SByte[] secondOp, SByte[] thirdOp, Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningLowerAndAdd)}<Int16>(Vector128<Int16>, Vector64<SByte>, Vector64<SByte>): {method} failed:");
