...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_Single_31()
        {
            var test = new ImmOpTest__DuplicateToVector64_Single_31();
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_Single_31
    {
        ...
        public ImmOpTest__DuplicateToVector64_Single_31()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<Single>(31): {method} failed:");
