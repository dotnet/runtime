...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void BitwiseSelect_Vector64_Int64()
        {
            var test = new SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64();
    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64 testClass)
            {
                fixed (Vector64<Int64>* pFld1 = &_fld1)
                fixed (Vector64<Int64>* pFld2 = &_fld2)
                fixed (Vector64<Int64>* pFld3 = &_fld3)
                {
                    var result = AdvSimd.BitwiseSelect(
                        AdvSimd.LoadVector64((Int64*)(pFld1)),
                        AdvSimd.LoadVector64((Int64*)(pFld2)),
                        AdvSimd.LoadVector64((Int64*)(pFld3))
                    );
        ...
        static SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.BitwiseSelect), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>), typeof(Vector64<Int64>) })
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld3 = &test._fld3)
            {
                var result = AdvSimd.BitwiseSelect(
                    AdvSimd.LoadVector64((Int64*)(pFld1)),
                    AdvSimd.LoadVector64((Int64*)(pFld2)),
        ...
        private void ValidateResult(Vector64<Int64> op1, Vector64<Int64> op2, Vector64<Int64> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] secondOp, Int64[] thirdOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Int64>(Vector64<Int64>, Vector64<Int64>, Vector64<Int64>): {method} failed:");
