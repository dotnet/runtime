...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareGreaterThanOrEqual_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector64_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareGreaterThanOrEqual), new Type[] { typeof(Vector64<SByte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(SByte[] left, SByte[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.CompareGreaterThanOrEqual(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            {
                ...
                {
                    if (Helpers.CompareGreaterThanOrEqual(left[i], right[i]) != result[i])
                    {
                        succeeded = false;
                        break;
                    }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareGreaterThanOrEqual)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:");
