...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Abs_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__Abs_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Abs_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Abs_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Abs_Vector64_Byte testClass)
            {
        ...
        static SimpleUnaryOpTest__Abs_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = (sbyte)-TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleUnaryOpTest__Abs_Vector64_Byte()
        {
            Succeeded = true;
