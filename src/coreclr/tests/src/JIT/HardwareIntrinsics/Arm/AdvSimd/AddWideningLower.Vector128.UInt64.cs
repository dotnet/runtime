...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningLower_Vector128_UInt64()
        {
            var test = new SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt64[] inArray1, UInt32[] inArray2, UInt64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddWideningLower), new Type[] { typeof(Vector128<UInt64>), typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(Vector128<UInt64> op1, Vector64<UInt32> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, UInt32[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<UInt64>(Vector128<UInt64>, Vector64<UInt32>): {method} failed:");
