...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningLower_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningLower), new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Vector128<Int32> op1, Vector64<Int16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] left, Int16[] right, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<Int32>(Vector128<Int32>, Vector64<Int16>): {method} failed:");
