...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_SByte_1
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector64<SByte>), typeof(byte) })
        ...
        private void ValidateResult(Vector64<SByte> op1, SByte result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(SByte[] firstOp, SByte result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<SByte>, 1): {method} failed:");
