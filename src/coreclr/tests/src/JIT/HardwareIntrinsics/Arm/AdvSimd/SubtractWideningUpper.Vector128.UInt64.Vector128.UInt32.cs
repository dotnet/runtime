...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningUpper), new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(Vector128<UInt64> op1, Vector128<UInt32> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, UInt32[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<UInt64>(Vector128<UInt64>, Vector128<UInt32>): {method} failed:");
