...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningAndAddScalar_Vector64_UInt32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_UInt32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWideningAndAddScalar), new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(Vector64<UInt64> op1, Vector64<UInt32> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] left, UInt32[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAddScalar)}<UInt64>(Vector64<UInt64>, Vector64<UInt32>): {method} failed:");
