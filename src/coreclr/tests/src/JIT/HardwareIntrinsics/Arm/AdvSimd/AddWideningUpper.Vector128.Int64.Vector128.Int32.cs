...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningUpper_Vector128_Int64_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__AddWideningUpper_Vector128_Int64_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_Int64_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddWideningUpper_Vector128_Int64_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddWideningUpper_Vector128_Int64_Vector128_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddWideningUpper_Vector128_Int64_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public SimpleBinaryOpTest__AddWideningUpper_Vector128_Int64_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddWideningUpper), new Type[] { typeof(Vector128<Int64>), typeof(Vector128<Int32>) })
        ...
        private void ValidateResult(Vector128<Int64> op1, Vector128<Int32> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, Int32[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<Int64>(Vector128<Int64>, Vector128<Int32>): {method} failed:");
