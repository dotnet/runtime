...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadVector64_Double()
        {
            var test = new LoadUnaryOpTest__LoadVector64_Double();
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector64_Double
    {
        ...
        public LoadUnaryOpTest__LoadVector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.LoadVector64), new Type[] { typeof(Double*) })
        ...
        private void ValidateResult(Vector64<Double> firstOp, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(void* firstOp, void* result, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Double, byte>(ref inArray[0]), ref Unsafe.AsRef<byte>(firstOp), (uint)Unsafe.SizeOf<Vector64<Double>>());
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<Double, byte>(ref outArray[0]), ref Unsafe.AsRef<byte>(result), (uint)Unsafe.SizeOf<Vector64<Double>>());
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector64)}<Double>(Vector64<Double>): {method} failed:");
