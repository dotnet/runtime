...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Insert_Vector64_SByte_1()
        {
            var test = new InsertTest__Insert_Vector64_SByte_1();
    ...
    public sealed unsafe class InsertTest__Insert_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(InsertTest__Insert_Vector64_SByte_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(InsertTest__Insert_Vector64_SByte_1 testClass)
            {
        ...
        static InsertTest__Insert_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public InsertTest__Insert_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Insert), new Type[] { typeof(Vector64<SByte>), typeof(byte), typeof(SByte) })
        ...
        private void ValidateResult(SByte[] firstOp, SByte thirdOp, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Insert)}<SByte>(Vector64<SByte>, 1, SByte): {method} failed:");
