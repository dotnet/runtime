...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingUpper_Vector128_SByte()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractNarrowingUpper), new Type[] { typeof(Vector64<SByte>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(SByte[] left, Int16[] right, SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingUpper)}<SByte>(Vector64<SByte>, Vector128<Int16>): {method} failed:");
