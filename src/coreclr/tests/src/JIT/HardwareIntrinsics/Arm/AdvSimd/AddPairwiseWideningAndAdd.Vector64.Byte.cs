...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningAndAdd_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Byte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddPairwiseWideningAndAdd), new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<Byte>) })
        ...
        private void ValidateResult(Vector64<UInt16> op1, Vector64<Byte> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] left, Byte[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAdd)}<UInt16>(Vector64<UInt16>, Vector64<Byte>): {method} failed:");
