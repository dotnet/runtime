...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt32RoundToPositiveInfinity_Vector64_Single()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single testClass)
            {
        ...
        static SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinity), new Type[] { typeof(Vector64<Single>) })
        ...
        private void ValidateResult(Single[] firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinity)}<UInt32>(Vector64<Single>): {method} failed:");
