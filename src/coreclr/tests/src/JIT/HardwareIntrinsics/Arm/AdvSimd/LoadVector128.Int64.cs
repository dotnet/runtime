...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadVector128_Int64()
        {
            var test = new LoadUnaryOpTest__LoadVector128_Int64();
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector128_Int64
    {
        ...
        public LoadUnaryOpTest__LoadVector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.LoadVector128), new Type[] { typeof(Int64*) })
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector128)}<Int64>(Vector128<Int64>): {method} failed:");
