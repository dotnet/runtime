...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.BitwiseSelect), new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<UInt64>), typeof(Vector64<UInt64>) })
        ...
        private void ValidateResult(Vector64<UInt64> op1, Vector64<UInt64> op2, Vector64<UInt64> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] firstOp, UInt64[] secondOp, UInt64[] thirdOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>, Vector64<UInt64>): {method} failed:");
