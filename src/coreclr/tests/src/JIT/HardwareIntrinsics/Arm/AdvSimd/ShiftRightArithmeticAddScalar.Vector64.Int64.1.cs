...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticAddScalar_Vector64_Int64_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticAddScalar_Vector64_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__ShiftRightArithmeticAddScalar_Vector64_Int64_1 testClass)
            {
                var result = AdvSimd.ShiftRightArithmeticAddScalar(_fld1, _fld2, 1);
        ...
        static ImmBinaryOpTest__ShiftRightArithmeticAddScalar_Vector64_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt64(); }
        ...
        public ImmBinaryOpTest__ShiftRightArithmeticAddScalar_Vector64_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ShiftRightArithmeticAddScalar), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>), typeof(byte) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmBinaryOpTest__ShiftRightArithmeticAddScalar_Vector64_Int64_1();
            var result = AdvSimd.ShiftRightArithmeticAddScalar(test._fld1, test._fld2, 1);
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] secondOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.ShiftRightArithmeticAdd(firstOp[0], secondOp[0], Imm) != result[0])
            {
                succeeded = false;
            }
            else
