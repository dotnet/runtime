...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_Int32()
        {
            Succeeded = true;
