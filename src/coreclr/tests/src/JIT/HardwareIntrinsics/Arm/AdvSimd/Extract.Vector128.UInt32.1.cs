...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector128_UInt32_1()
        {
            var test = new ExtractTest__Extract_Vector128_UInt32_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector128_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector128_UInt32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector128_UInt32_1 testClass)
            {
                fixed (Vector128<UInt32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Extract(AdvSimd.LoadVector128((UInt32*)pFld1), ElementIndex);
        ...
        static ExtractTest__Extract_Vector128_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public ExtractTest__Extract_Vector128_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.Extract), new Type[] { typeof(Vector128<UInt32>), typeof(byte) })
                                     .Invoke(null, new object[] {
                                        Unsafe.Read<Vector128<UInt32>>(_dataTable.inArray1Ptr),
                                        ElementIndex
                                     });

            ValidateResult(_dataTable.inArray1Ptr, (UInt32)result);
        }
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector128((UInt32*)pClsVar1), ElementIndex);
        ...
        private void ValidateResult(Vector128<UInt32> op1, UInt32 result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(void* op1, UInt32 result, [CallerMemberName] string method = "")
        {
            UInt32[] inArray1 = new UInt32[Op1ElementCount];
        ...
        private void ValidateResult(UInt32[] firstOp, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector128<UInt32>, 1): {method} failed:");
