...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractHighNarrowingUpper_Vector128_SByte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_SByte
    {
        private struct DataTable
        {
            ...
            public DataTable(SByte[] inArray1, Int16[] inArray2, Int16[] inArray3, SByte[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_SByte testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractHighNarrowingUpper), new Type[] { typeof(Vector64<SByte>), typeof(Vector128<Int16>), typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Vector64<SByte> op1, Vector128<Int16> op2, Vector128<Int16> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(SByte[] firstOp, Int16[] secondOp, Int16[] thirdOp, SByte[] result, [CallerMemberName] string method = "")
        {
            bool succeeded = true;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractHighNarrowingUpper)}<SByte>(Vector64<SByte>, Vector128<Int16>, Vector128<Int16>): {method} failed:");
