...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddRoundedHighNarrowingLower_Vector64_UInt16()
        {
            var test = new SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt16 testClass)
            {
        ...
        public SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AddRoundedHighNarrowingLower), new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingLower)}<UInt16>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:");
