...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__AbsScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AbsScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsScalar_Vector64_Double testClass)
            {
        ...
        static SimpleUnaryOpTest__AbsScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = -TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleUnaryOpTest__AbsScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.AbsScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.Abs(firstOp[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsScalar)}<Double>(Vector64<Double>): {method} failed:");
