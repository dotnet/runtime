...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThan_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThan_Vector64_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThan_Vector64_UInt32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.CompareLessThan), new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>) })
        ...
        private void ValidateResult(UInt32[] left, UInt32[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareLessThan)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:");
