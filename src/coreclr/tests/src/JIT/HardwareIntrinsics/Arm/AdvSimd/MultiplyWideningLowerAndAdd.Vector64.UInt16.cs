...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningLowerAndAdd_Vector64_UInt16()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_UInt16 testClass)
            {
                var result = AdvSimd.MultiplyWideningLowerAndAdd(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_UInt16 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.MultiplyWideningLowerAndAdd), new Type[] { typeof(Vector128<UInt32>), typeof(Vector64<UInt16>), typeof(Vector64<UInt16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyWideningLowerAndAdd(op1, op2, op3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_UInt16();
            var result = AdvSimd.MultiplyWideningLowerAndAdd(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(UInt32[] firstOp, UInt16[] secondOp, UInt16[] thirdOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.MultiplyWideningAndAdd(firstOp[i], secondOp[i], thirdOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndAdd)}<UInt32>(Vector128<UInt32>, Vector64<UInt16>, Vector64<UInt16>): {method} failed:");
