...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt32[] inArray1, UInt16[] inArray2, UInt32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt32(); }
        ...
        public SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.SubtractWideningUpper), new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<UInt16>) })
        ...
        private void ValidateResult(Vector128<UInt32> op1, Vector128<UInt16> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] left, UInt16[] right, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<UInt32>(Vector128<UInt32>, Vector128<UInt16>): {method} failed:");
