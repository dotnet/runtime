...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(ExtractVectorTest__ExtractVector128_Single_1 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(nameof(AdvSimd.ExtractVector128), new Type[] { typeof(Vector128<Single>), typeof(Vector128<Single>), typeof(byte) })
        ...
        private void ValidateResult(Single[] firstOp, Single[] secondOp, Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Single>(Vector128<Single>, Vector128<Single>, 1): {method} failed:");
