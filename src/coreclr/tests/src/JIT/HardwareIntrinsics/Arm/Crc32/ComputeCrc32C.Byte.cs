...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ComputeCrc32C_Byte()
        {
            var test = new ScalarBinaryOpTest__ComputeCrc32C_Byte();
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32C_Byte
    {
        ...
        static ScalarBinaryOpTest__ComputeCrc32C_Byte()
        {
            _clsVar1 = 0xFFFFFFFF;
            _clsVar2 = 0x20;
        }

        public ScalarBinaryOpTest__ComputeCrc32C_Byte()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Crc32.ComputeCrc32C(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32).GetMethod(nameof(Crc32.ComputeCrc32C), new Type[] { typeof(UInt32), typeof(Byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Crc32.ComputeCrc32C(data1, data2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ScalarBinaryOpTest__ComputeCrc32C_Byte();
            var result = Crc32.ComputeCrc32C(test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt32 left, Byte right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            uint expectedResult = 0x8D3F2270; isUnexpectedResult = (expectedResult != result);

            if (isUnexpectedResult)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Crc32)}.{nameof(Crc32.ComputeCrc32C)}<UInt32>(UInt32, Byte): ComputeCrc32C failed:");
