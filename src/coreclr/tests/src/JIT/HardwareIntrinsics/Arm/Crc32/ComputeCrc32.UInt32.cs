...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ComputeCrc32_UInt32()
        {
            var test = new ScalarBinaryOpTest__ComputeCrc32_UInt32();
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32_UInt32
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                testStruct._fld2 = 0x20191113;

                return testStruct;
            }

            public void RunStructFldScenario(ScalarBinaryOpTest__ComputeCrc32_UInt32 testClass)
            {
        ...
        static ScalarBinaryOpTest__ComputeCrc32_UInt32()
        {
            _clsVar1 = 0xFFFFFFFF;
            _clsVar2 = 0x20191113;
        }

        public ScalarBinaryOpTest__ComputeCrc32_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32).GetMethod(nameof(Crc32.ComputeCrc32), new Type[] { typeof(UInt32), typeof(UInt32) })
        ...
        private void ValidateResult(UInt32 left, UInt32 right, UInt32 result, [CallerMemberName] string method = "")
        {
            ...
            uint expectedResult = 0x219D9805; isUnexpectedResult = (expectedResult != result);

            if (isUnexpectedResult)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Crc32)}.{nameof(Crc32.ComputeCrc32)}<UInt32>(UInt32, UInt32): ComputeCrc32 failed:");
