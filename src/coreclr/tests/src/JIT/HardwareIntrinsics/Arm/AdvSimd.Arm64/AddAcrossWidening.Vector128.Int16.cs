...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddAcrossWidening), new Type[] { typeof(Vector128<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddAcrossWidening)}<Int32>(Vector128<Int16>): {method} failed:");
