...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double testClass)
            {
                var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinityScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double testClass)
            {
                fixed (Vector64<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinityScalar(
        ...
        static SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinityScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinityScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinityScalar_Vector64_Double();
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinityScalar(test._fld1);
        ...
        private void ValidateResult(Double[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.ConvertToUInt64RoundToNegativeInfinity(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinityScalar)}<UInt64>(Vector64<Double>): {method} failed:");
