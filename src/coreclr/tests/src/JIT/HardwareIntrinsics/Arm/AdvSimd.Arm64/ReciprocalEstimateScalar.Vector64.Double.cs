...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalEstimateScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Double testClass)
            {
        ...
        static SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int64BitsToDouble(0x3fc9db3dab555868); }
        ...
        public SimpleUnaryOpTest__ReciprocalEstimateScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ReciprocalEstimateScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(result[0]) != 0x4013d00000000000)
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalEstimateScalar)}<Double>(Vector64<Double>): {method} failed:");
