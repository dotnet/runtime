...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturate_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AbsSaturate_Vector128_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsSaturate_Vector128_Int64 testClass)
            {
                fixed (Vector128<Int64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.AbsSaturate(
        ...
        static SimpleUnaryOpTest__AbsSaturate_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = Int64.MinValue; }
        ...
        public SimpleUnaryOpTest__AbsSaturate_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AbsSaturate), new Type[] { typeof(Vector128<Int64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AbsSaturate(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__AbsSaturate_Vector128_Int64();
            var result = AdvSimd.Arm64.AbsSaturate(test._fld1);
        ...
        private void ValidateResult(Int64[] firstOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsSaturate)}<Int64>(Vector128<Int64>): {method} failed:");
