...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThan_Vector128_UInt64()
        {
            var test = new SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64 testClass)
            {
                var result = AdvSimd.Arm64.CompareLessThan(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64 testClass)
            {
                fixed (Vector128<UInt64>* pFld1 = &_fld1)
                fixed (Vector128<UInt64>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.Arm64.CompareLessThan(
        ...
        static SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt64(); }
        ...
        public SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.CompareLessThan), new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<UInt64>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.CompareLessThan(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__CompareLessThan_Vector128_UInt64();
            var result = AdvSimd.Arm64.CompareLessThan(test._fld1, test._fld2);
        ...
        private void ValidateResult(UInt64[] left, UInt64[] right, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.CompareLessThan(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            {
                ...
                {
                    if (Helpers.CompareLessThan(left[i], right[i]) != result[i])
                    {
                        succeeded = false;
                        break;
                    }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareLessThan)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:");
