...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThanOrEqualScalar_Vector64_Double()
        {
            var test = new SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double testClass)
            {
                var result = AdvSimd.Arm64.CompareLessThanOrEqualScalar(_fld1, _fld2);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double testClass)
            {
                fixed (Vector64<Double>* pFld1 = &_fld1)
                fixed (Vector64<Double>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.Arm64.CompareLessThanOrEqualScalar(
        ...
        static SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.CompareLessThanOrEqualScalar), new Type[] { typeof(Vector64<Double>), typeof(Vector64<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.CompareLessThanOrEqualScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Double();
            var result = AdvSimd.Arm64.CompareLessThanOrEqualScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.CompareLessThanOrEqual(left[0], right[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareLessThanOrEqualScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:");
