...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector64_Byte_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetByte(); }
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector64<Byte>), typeof(Vector64<SByte>) })
        ...
        private void ValidateResult(Byte[] left, SByte[] right, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Byte>(Vector64<Byte>, Vector64<SByte>): {method} failed:");
