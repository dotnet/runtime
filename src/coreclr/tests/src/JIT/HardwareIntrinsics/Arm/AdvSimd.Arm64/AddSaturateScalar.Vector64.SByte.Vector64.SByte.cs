...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_SByte_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_SByte testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetSByte(); }
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_SByte()
        {
            Succeeded = true;
