...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt64RoundToZero_Vector128_Double()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundToZero_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ConvertToUInt64RoundToZero_Vector128_Double testClass)
            {
                var result = AdvSimd.Arm64.ConvertToUInt64RoundToZero(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ConvertToUInt64RoundToZero_Vector128_Double testClass)
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.ConvertToUInt64RoundToZero(
        ...
        static SimpleUnaryOpTest__ConvertToUInt64RoundToZero_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleUnaryOpTest__ConvertToUInt64RoundToZero_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ConvertToUInt64RoundToZero), new Type[] { typeof(Vector128<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToZero(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToZero_Vector128_Double();
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToZero(test._fld1);
        ...
        private void ValidateResult(Double[] firstOp, UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            {
                if (Helpers.ConvertToUInt64RoundToZero(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToUInt64RoundToZero)}<UInt64>(Vector128<Double>): {method} failed:");
