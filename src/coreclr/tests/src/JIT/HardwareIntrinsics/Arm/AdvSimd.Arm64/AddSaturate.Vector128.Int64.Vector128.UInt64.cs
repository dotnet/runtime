...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddSaturate), new Type[] { typeof(Vector128<Int64>), typeof(Vector128<UInt64>) })
        ...
        private void ValidateResult(Vector128<Int64> op1, Vector128<UInt64> op2, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] left, UInt64[] right, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int64>(Vector128<Int64>, Vector128<UInt64>): {method} failed:");
