...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalExponentScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double testClass)
            {
                var result = AdvSimd.Arm64.ReciprocalExponentScalar(_fld1);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double testClass)
            {
                fixed (Vector64<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.ReciprocalExponentScalar(
        ...
        static SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = BitConverter.Int64BitsToDouble(0x3fc9db3dab555868); }
        ...
        public SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ReciprocalExponentScalar), new Type[] { typeof(Vector64<Double>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalExponentScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ReciprocalExponentScalar_Vector64_Double();
            var result = AdvSimd.Arm64.ReciprocalExponentScalar(test._fld1);
        ...
        private void ValidateResult(Double[] firstOp, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(result[0]) != 0x4030000000000000)
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalExponentScalar)}<Double>(Vector64<Double>): {method} failed:");
