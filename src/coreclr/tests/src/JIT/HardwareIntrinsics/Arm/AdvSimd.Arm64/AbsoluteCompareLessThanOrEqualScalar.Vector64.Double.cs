...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareLessThanOrEqualScalar_Vector64_Double()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Double testClass)
            {
        ...
        static SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetDouble(); }
        ...
        public SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqualScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AbsoluteCompareLessThanOrEqualScalar), new Type[] { typeof(Vector64<Double>), typeof(Vector64<Double>) })
        ...
        private void ValidateResult(Double[] left, Double[] right, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (BitConverter.DoubleToInt64Bits(Helpers.AbsoluteCompareLessThanOrEqual(left[0], right[0])) != BitConverter.DoubleToInt64Bits(result[0]))
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareLessThanOrEqualScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:");
