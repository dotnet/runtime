...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddAcrossWidening_Vector64_Int16()
        {
            var test = new SimpleUnaryOpTest__AddAcrossWidening_Vector64_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddAcrossWidening_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AddAcrossWidening_Vector64_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AddAcrossWidening_Vector64_Int16 testClass)
            {
        ...
        static SimpleUnaryOpTest__AddAcrossWidening_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt16(); }
        ...
        public SimpleUnaryOpTest__AddAcrossWidening_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.AddAcrossWidening), new Type[] { typeof(Vector64<Int16>) })
        ...
        private void ValidateResult(Int16[] firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddAcrossWidening)}<Int32>(Vector64<Int16>): {method} failed:");
