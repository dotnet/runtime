...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_Int64()
        {
            var test = new DuplicateUnaryOpTest__DuplicateToVector64_Int64();
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector64_Int64 testClass)
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector64_Int64()
        {
            _clsVar = TestLibrary.Generator.GetInt64();
        }

        public DuplicateUnaryOpTest__DuplicateToVector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.DuplicateToVector64), new Type[] { typeof(Int64) })
        ...
        private void ValidateResult(Int64 data, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateToVector64)}<Int64>(Int64): DuplicateToVector64 failed:");
