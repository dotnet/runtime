...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt16()
        {
            Succeeded = true;
