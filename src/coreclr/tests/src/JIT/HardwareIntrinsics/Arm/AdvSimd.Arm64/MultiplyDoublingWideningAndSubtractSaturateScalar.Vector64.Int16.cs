...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16()
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16 testClass)
            {
                var result = AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16 testClass)
            {
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar), new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int16>), typeof(Vector64<Int16>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar(op1, op2, op3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int16();
            var result = AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Vector64<Int32> op1, Vector64<Int16> op2, Vector64<Int16> op3, void* result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] firstOp, Int16[] secondOp, Int16[] thirdOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.MultiplyDoublingWideningAndSubtractSaturate(firstOp[0], secondOp[0], thirdOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar)}<Int32>(Vector64<Int32>, Vector64<Int16>, Vector64<Int16>): {method} failed:");
