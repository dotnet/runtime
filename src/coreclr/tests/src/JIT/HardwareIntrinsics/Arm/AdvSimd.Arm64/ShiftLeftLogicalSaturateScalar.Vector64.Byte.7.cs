...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalSaturateScalar_Vector64_Byte_7()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7 testClass)
            {
                var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(_fld, 7);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7 testClass)
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetByte(); }
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar), new Type[] { typeof(Vector64<Byte>), typeof(byte) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(firstOp, 7);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7();
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(test._fld, 7);
        ...
        private void ValidateResult(Byte[] firstOp, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar)}<Byte>(Vector64<Byte>, 7): {method} failed:");
