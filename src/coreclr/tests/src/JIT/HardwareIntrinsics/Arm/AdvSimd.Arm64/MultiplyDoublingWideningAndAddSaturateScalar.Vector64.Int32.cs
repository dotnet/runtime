...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32 testClass)
            {
                var result = AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar(_fld1, _fld2, _fld3);

                Unsafe.Write(testClass._dataTable.outArrayPtr, result);
                testClass.ValidateResult(_fld1, _fld2, _fld3, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32 testClass)
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar), new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int32>), typeof(Vector64<Int32>) })
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32();
            var result = AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar(test._fld1, test._fld2, test._fld3);
        ...
        private void ValidateResult(Int64[] firstOp, Int32[] secondOp, Int32[] thirdOp, Int64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (Helpers.MultiplyDoublingWideningAndAddSaturate(firstOp[0], secondOp[0], thirdOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<Int32>, Vector64<Int32>): {method} failed:");
