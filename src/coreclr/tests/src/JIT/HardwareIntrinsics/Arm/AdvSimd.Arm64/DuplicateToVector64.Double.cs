...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_Double()
        {
            var test = new DuplicateUnaryOpTest__DuplicateToVector64_Double();
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(DuplicateUnaryOpTest__DuplicateToVector64_Double testClass)
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector64_Double()
        {
            _clsVar = TestLibrary.Generator.GetDouble();
        }

        public DuplicateUnaryOpTest__DuplicateToVector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(nameof(AdvSimd.Arm64.DuplicateToVector64), new Type[] { typeof(Double) })
        ...
        private void ValidateResult(Double data, Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateToVector64)}<Double>(Double): DuplicateToVector64 failed:");
