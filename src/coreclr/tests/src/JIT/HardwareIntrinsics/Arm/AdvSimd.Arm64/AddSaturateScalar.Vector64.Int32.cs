...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32 testClass)
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetInt32(); }
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32()
        {
            Succeeded = true;
