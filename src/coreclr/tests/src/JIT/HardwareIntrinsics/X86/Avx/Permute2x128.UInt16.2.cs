...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void Permute2x128UInt162()
        {
            var test = new ImmBinaryOpTest__Permute2x128UInt162();
    ...
    public sealed unsafe class ImmBinaryOpTest__Permute2x128UInt162
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__Permute2x128UInt162 testClass)
            {
        ...
        static ImmBinaryOpTest__Permute2x128UInt162()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = TestLibrary.Generator.GetUInt16(); }
        ...
        public ImmBinaryOpTest__Permute2x128UInt162()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(nameof(Avx.Permute2x128), new Type[] { typeof(Vector256<UInt16>), typeof(Vector256<UInt16>), typeof(byte) })
