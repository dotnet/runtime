...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector128<Int32> result = Vector128<Int32>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector128<Int32>)
                                .GetProperty(nameof(Vector128<Int32>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
        ...
        private unsafe void ValidateResult(Int32[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector128.AllBitsSet(Int32): {method} failed:");
