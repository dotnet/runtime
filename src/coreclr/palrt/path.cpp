    ...
    if (lpszDest)
    {
        ...
        *szTemp = W('\0');
        ...
        if (lpszDir && *lpszDir)
        {
            ...
            {
                // lpszFile is empty
                StringCchCopyNW(szTemp, MINIPAL_LENGTHOF(szTemp), lpszDir, MINIPAL_LENGTHOF(szTemp));
            }
            else if (PathIsRelativeW(lpszFile))
            {
                ...
                if (pszT)
                {
                    size_t iRemaining = MINIPAL_LENGTHOF(szTemp) - (pszT - szTemp);
            ...
            else if (IsPathSeparator(*lpszFile) && !PathIsUNCW(lpszFile))
            {
                ...
                if (pszT)
                {
                    ...
                    int iRemaining = (int)(MINIPAL_LENGTHOF(szTemp) - (pszT - szTemp));
            ...
            else
            {
                ...
                StringCchCopyNW(szTemp, MINIPAL_LENGTHOF(szTemp), lpszFile, MINIPAL_LENGTHOF(szTemp));
            }
        }
