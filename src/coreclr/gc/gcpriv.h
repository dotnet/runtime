...
#define DYNAMIC_ADAPTATION_TO_APP
//#define STRESS_DYNAMIC_ADAPTATION_TO_APP
...
#ifdef DYNAMIC_ADAPTATION_TO_APP
...
#ifdef STRESS_DYNAMIC_ADAPTATION_TO_APP
    PER_HEAP_FIELD_SINGLE_GC_ALLOC bool uoh_msl_before_gc_p;
#endif //STRESS_DYNAMIC_ADAPTATION_TO_APP
