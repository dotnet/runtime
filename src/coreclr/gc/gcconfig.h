...
#define GC_CONFIGURATION_KEYS \
    BOOL_CONFIG  (ServerGC,                  "gcServer",                  "System.GC.Server",                  false,              true,  "Whether we should be using Server GC")                                                   \
    BOOL_CONFIG  (ConcurrentGC,              "gcConcurrent",              "System.GC.Concurrent",              true,               true, "Whether we should be using Concurrent GC")                                                \
    ...
    BOOL_CONFIG  (RetainVM,                  "GCRetainVM",                "System.GC.RetainVM",                false,              true, "When set we put the segments that should be deleted on a standby list (instead of "       \
    ...
    STRING_CONFIG(GCHeapAffinitizeRanges,    "GCHeapAffinitizeRanges",    "System.GC.HeapAffinitizeRanges",                        true, "Specifies list of processors for Server GC threads. The format is a comma separated "     \
    ...
    INT_CONFIG   (GCRegionRange,             "GCRegionRange",             NULL,                                274877906944L,      true, "Specifies the range for the GC heap")                                                     \
    INT_CONFIG   (GCRegionSize,              "GCRegionSize",              NULL,                                4194304,            true, "Specifies the size for a basic GC region")                                                \
    ...
    INT_CONFIG   (BGCMemGoalSlack,           "BGCMemGoalSlack",           NULL,                                10,                 false, "Specifies comfort zone of going above goal")                                             \
    INT_CONFIG   (BGCFLSweepGoal,            "BGCFLSweepGoal",            NULL,                                0,                  false, "Specifies the gen2 sweep FL ratio goal")                                                 \
    INT_CONFIG   (BGCFLSweepGoalLOH,         "BGCFLSweepGoalLOH",         NULL,                                0,                  false, "Specifies the LOH sweep FL ratio goal")                                                  \
    INT_CONFIG   (BGCFLkp,                   "BGCFLkp",                   NULL,                                6000,               false, "Specifies kp for above goal tuning")                                                     \
    INT_CONFIG   (BGCFLki,                   "BGCFLki",                   NULL,                                1000,               false, "Specifies ki for above goal tuning")                                                     \
    INT_CONFIG   (BGCFLkd,                   "BGCFLkd",                   NULL,                                11,                 false, "Specifies kd for above goal tuning")                                                     \
    INT_CONFIG   (BGCFLff,                   "BGCFLff",                   NULL,                                100,                false, "Specifies ff ratio")                                                                     \
    INT_CONFIG   (BGCFLSmoothFactor,         "BGCFLSmoothFactor",         NULL,                                150,                false, "Smoothing over these")                                                                   \
    INT_CONFIG   (BGCFLGradualD,             "BGCFLGradualD",             NULL,                                0,                  false, "Enable gradual D instead of cutting off at the value")                                   \
    INT_CONFIG   (BGCMLkp,                   "BGCMLkp",                   NULL,                                1000,               false, "Specifies kp for ML tuning")                                                             \
    INT_CONFIG   (BGCMLki,                   "BGCMLki",                   NULL,                                16,                 false, "Specifies ki for ML tuning")                                                             \
    INT_CONFIG   (BGCFLEnableKi,             "BGCFLEnableKi",             NULL,                                1,                  false, "Enables ki for above goal tuning")                                                       \
    INT_CONFIG   (BGCFLEnableKd,             "BGCFLEnableKd",             NULL,                                0,                  false, "Enables kd for above goal tuning")                                                       \
    INT_CONFIG   (BGCFLEnableSmooth,         "BGCFLEnableSmooth",         NULL,                                0,                  false, "Enables smoothing")                                                                      \
