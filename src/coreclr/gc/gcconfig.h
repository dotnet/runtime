...
#define GC_CONFIGURATION_KEYS \
    ...
    INT_CONFIG   (GCLargePages,              "GCLargePages",              "System.GC.LargePages",              0,                  "Enables Large Pages in the GC (1=real large pages, 2=emulation mode for testing)")             \
    ...
    INT_CONFIG   (UOHDataAlignment,          "GCUOHDataAlignment",        NULL,                                64,                 "Specifies the alignment of the data of objects on LOH/POH (0 to disable the padding)")  \
