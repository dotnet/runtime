...
#if defined(FEATURE_COMINTEROP) || defined(FEATURE_COMWRAPPERS) || defined(FEATURE_OBJCBRIDGE) || defined(FEATURE_REDHAWK)
/*
...
#endif // FEATURE_COMINTEROP || FEATURE_COMWRAPPERS || FEATURE_OBJCBRIDGE || FEATURE_REDHAWK
