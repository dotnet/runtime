...
CompPhaseNameMacro(PHASE_AUTO_VECTORIZE_ANALYZE,     "Auto vectorization analysis",    false, -1, false)
CompPhaseNameMacro(PHASE_IF_CONVERSION,              "If conversion",                  false, -1, false)
CompPhaseNameMacro(PHASE_AUTO_VECTORIZE_REWRITE,     "Auto vectorization rewrite",     false, -1, false)
