...
{
    regSelector  = new (theCompiler, CMK_LSRA) LinearScan::RegisterSelection(this);
...
LinearScan::RegisterSelection::RegisterSelection(LinearScan* linearScan)
{
    ...
    mappingTable->Set(FREE, &LinearScan::RegisterSelection::tryFree);
    mappingTable->Set(CONST_AVAILABLE, &LinearScan::RegisterSelection::tryConstAvailable);
    mappingTable->Set(THIS_ASSIGNED, &LinearScan::RegisterSelection::tryThisAssigned);
    mappingTable->Set(COVERS, &LinearScan::RegisterSelection::tryCovers);
    mappingTable->Set(OWN_PREFERENCE, &LinearScan::RegisterSelection::tryOwnPreference);
    mappingTable->Set(COVERS_RELATED, &LinearScan::RegisterSelection::tryCoversRelated);
    mappingTable->Set(RELATED_PREFERENCE, &LinearScan::RegisterSelection::tryRelatedPreference);
    mappingTable->Set(CALLER_CALLEE, &LinearScan::RegisterSelection::tryCallerCallee);
    mappingTable->Set(UNASSIGNED, &LinearScan::RegisterSelection::tryUnassigned);
    mappingTable->Set(COVERS_FULL, &LinearScan::RegisterSelection::tryCoversFull);
    mappingTable->Set(BEST_FIT, &LinearScan::RegisterSelection::tryBestFit);
    mappingTable->Set(IS_PREV_REG, &LinearScan::RegisterSelection::tryIsPrevReg);
    mappingTable->Set(REG_ORDER, &LinearScan::RegisterSelection::tryRegOrder);
    mappingTable->Set(SPILL_COST, &LinearScan::RegisterSelection::trySpillCost);
    mappingTable->Set(FAR_NEXT_REF, &LinearScan::RegisterSelection::tryFarNextRef);
...
void LinearScan::RegisterSelection::tryFree()
{
    assert(!found);
    if (freeCandidates == RBM_NONE)
    {
...
void LinearScan::RegisterSelection::tryConstAvailable()
{
    assert(!found);
    if (freeCandidates == RBM_NONE)
    {
...
void LinearScan::RegisterSelection::tryThisAssigned()
{
    assert(!found);
    if (freeCandidates == RBM_NONE)
    {
...
void LinearScan::RegisterSelection::tryCovers()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryOwnPreference()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryCoversRelated()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryRelatedPreference()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryCallerCallee()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryUnassigned()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryCoversFull()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryBestFit()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryRegOrder()
{
    assert(!found);
...
void LinearScan::RegisterSelection::trySpillCost()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryFarNextRef()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryPrevRegOpt()
{
    assert(!found);
...
void LinearScan::RegisterSelection::tryRegNum()
{
    assert(!found);
