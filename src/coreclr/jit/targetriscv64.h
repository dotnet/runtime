...
// clang-format off
#define CORINFO_ARCH_TARGET      CORINFO_ARCH_RISCV64
...
#define FEATURE_HAS_ZERO_REG          1  // Target has a hardware "zero register" (e.g. REG_R0/x0) usable as a containable source for zero stores
