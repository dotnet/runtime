...
// Extract/replace lane operations (lane index byte)
INST2(i8x16_extract_lane_s, "i8x16.extract_lane_s", 0, IF_LANE,     0xFD, 21)
INST2(i8x16_extract_lane_u, "i8x16.extract_lane_u", 0, IF_LANE,     0xFD, 22)
INST2(i8x16_replace_lane,   "i8x16.replace_lane",   0, IF_LANE,     0xFD, 23)
INST2(i16x8_extract_lane_s, "i16x8.extract_lane_s", 0, IF_LANE,     0xFD, 24)
INST2(i16x8_extract_lane_u, "i16x8.extract_lane_u", 0, IF_LANE,     0xFD, 25)
INST2(i16x8_replace_lane,   "i16x8.replace_lane",   0, IF_LANE,     0xFD, 26)
INST2(i32x4_extract_lane,   "i32x4.extract_lane",   0, IF_LANE,     0xFD, 27)
INST2(i32x4_replace_lane,   "i32x4.replace_lane",   0, IF_LANE,     0xFD, 28)
INST2(i64x2_extract_lane,   "i64x2.extract_lane",   0, IF_LANE,     0xFD, 29)
INST2(i64x2_replace_lane,   "i64x2.replace_lane",   0, IF_LANE,     0xFD, 30)
INST2(f32x4_extract_lane,   "f32x4.extract_lane",   0, IF_LANE,     0xFD, 31)
INST2(f32x4_replace_lane,   "f32x4.replace_lane",   0, IF_LANE,     0xFD, 32)
INST2(f64x2_extract_lane,   "f64x2.extract_lane",   0, IF_LANE,     0xFD, 33)
INST2(f64x2_replace_lane,   "f64x2.replace_lane",   0, IF_LANE,     0xFD, 34)
...
// Load/store lane operations (memarg + lane index)
INST2(v128_load8_lane,     "v128.load8_lane",     0, IF_MEMARG_LANE, 0xFD, 84)
INST2(v128_load16_lane,    "v128.load16_lane",    0, IF_MEMARG_LANE, 0xFD, 85)
INST2(v128_load32_lane,    "v128.load32_lane",    0, IF_MEMARG_LANE, 0xFD, 86)
INST2(v128_load64_lane,    "v128.load64_lane",    0, IF_MEMARG_LANE, 0xFD, 87)
INST2(v128_store8_lane,    "v128.store8_lane",    0, IF_MEMARG_LANE, 0xFD, 88)
INST2(v128_store16_lane,   "v128.store16_lane",   0, IF_MEMARG_LANE, 0xFD, 89)
INST2(v128_store32_lane,   "v128.store32_lane",   0, IF_MEMARG_LANE, 0xFD, 90)
INST2(v128_store64_lane,   "v128.store64_lane",   0, IF_MEMARG_LANE, 0xFD, 91)
