...
GTNODE(SELECT_INC       , GenTreeConditional ,0,0,GTK_SPECIAL)
...
GTNODE(SELECT_INV       , GenTreeConditional ,0,0,GTK_SPECIAL)
...
// If op2 is null, computes result = condition ? -op1 : op1.
GTNODE(SELECT_NEG       , GenTreeConditional ,0,0,GTK_SPECIAL)
