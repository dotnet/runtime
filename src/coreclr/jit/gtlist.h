...
GTNODE(ASYNC_RESUME_TRAMPOLINE, GenTreeVal   ,0,0,GTK_LEAF)             // Address of async resume trampoline
...
GTNODE(RECORD_ASYNC_JOIN, GenTreeVal         ,0,0,GTK_LEAF|GTK_NOVALUE|DBK_NOTHIR)  // records native offset of async suspension point for async stackwalking purposes
