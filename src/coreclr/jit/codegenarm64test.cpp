...
// IF_SVE_GS_3A
    ...
    theEmitter->emitIns_R_R_R_I(INS_sve_adr, EA_SCALABLE, REG_V0, REG_V2, REG_V3, 0, INS_OPTS_SCALABLE_S);
    theEmitter->emitIns_R_R_R_I(INS_sve_adr, EA_SCALABLE, REG_V0, REG_V2, REG_V3, 0, INS_OPTS_SCALABLE_D);
    theEmitter->emitIns_R_R_R_I(INS_sve_adr, EA_SCALABLE, REG_V0, REG_V2, REG_V3, 1, INS_OPTS_SCALABLE_S);
    theEmitter->emitIns_R_R_R_I(INS_sve_adr, EA_SCALABLE, REG_V0, REG_V2, REG_V3, 1, INS_OPTS_SCALABLE_D);
