...
CONFIG_INTEGER(JitExtendedDefaultPolicyMaxBBCount, W("JitExtendedDefaultPolicyMaxBBCount"), 20)
CONFIG_INTEGER(JitExtendedDefaultPolicyMaxILSize, W("JitExtendedDefaultPolicyMaxILSize"), 600)
