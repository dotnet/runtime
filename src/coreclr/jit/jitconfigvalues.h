...
RELEASE_CONFIG_INTEGER(EnableAVX512BITALG,          "EnableAVX512BITALG",        1) // Allows AVX512BITALG+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512BF16,            "EnableAVX512BF16",          1) // Allows AVX512BF16+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512FP16,            "EnableAVX512FP16",          1) // Allows AVX512FP16+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512IFMA,            "EnableAVX512IFMA",          1) // Allows AVX512IFMA+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512VBMI,            "EnableAVX512VBMI",          1) // Allows AVX512VBMI+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512VBMI2,           "EnableAVX512VBMI2",         1) // Allows AVX512VBMI2+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512VNNI,            "EnableAVX512VNNI",          1) // Allows AVX512VNNI+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512VP2INTERSECT,    "EnableAVX512VP2INTERSECT",  1) // Allows AVX512VP2INTERSECT+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX512VPOPCNTDQ,       "EnableAVX512VPOPCNTDQ",     1) // Allows AVX512VPOPCNTDQ+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX10v1,               "EnableAVX10v1",             1) // Allows AVX10v1+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVX10v2,               "EnableAVX10v2",             0) // Allows AVX10v2+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableAVXIFMA,               "EnableAVXIFMA",             1) // Allows AVXIFMA+ hardware intrinsics to be disabled
...
RELEASE_CONFIG_INTEGER(EnableF16C,                  "EnableF16C",                1) // Allows F16C+ hardware intrinsics to be disabled
...
RELEASE_CONFIG_INTEGER(EnableMOVBE,                 "EnableMOVBE",               1) // Allows MOVBE+ hardware intrinsics to be disabled
...
RELEASE_CONFIG_INTEGER(EnableSHA,                   "EnableSHA",                 1) // Allows SHA+ hardware intrinsics to be disabled
...
RELEASE_CONFIG_INTEGER(EnableVAES,                  "EnableVAES",                1) // Allows VAES+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableVPCLMULQDQ,            "EnableVPCLMULQDQ",          1) // Allows VPCLMULQDQ+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableWAITPKG,               "EnableWAITPKG",             1) // Allows WAITPKG+ hardware intrinsics to be disabled
RELEASE_CONFIG_INTEGER(EnableX86Serialize,          "EnableX86Serialize",        1) // Allows X86Serialize+ hardware intrinsics to be disabled
