...
static code_t insEncodeBTypeInstr(unsigned opcode, unsigned funct3, unsigned rs1, unsigned rs2, unsigned imm12);
static code_t insEncodeJTypeInstr(unsigned opcode, unsigned rd, unsigned imm20);
