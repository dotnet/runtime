...
emitter::insExecutionCharacteristics emitter::getInsExecutionCharacteristics(instrDesc* id)
{
    ...
    if (CombinedInsCnt > 1)
    {
        ...
        { // pcalau12i + (addi.d or ld.d)
            ...
            result.insMemoryAccessKind = id->idIsCnsReloc() ? PerfScoreMemoryAccessKind::None : PerfScoreMemoryAccessKind::Read;
        }
        else
        {
    ...
    if (emitInsIsLoadOrStore(ins))
    {
        ...
        {
            result.insMemoryAccessKind = emitInsIsStore(ins) ? PerfScoreMemoryAccessKind::ReadWrite : PerfScoreMemoryAccessKind::Read;
        }
        else
        {
