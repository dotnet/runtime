...
template <typename TOper, typename TSimd, typename TBase>
void EvaluateSimdUnary(TOper oper, bool scalar, TSimd* result, TSimd arg0)
{
    ...
    for (uint32_t i = 0; i < count; i++)
    {
        ...
        TBase output = static_cast<TBase>(oper(input0));
        memcpy(&result->u8[i * sizeof(TBase)], &output, sizeof(TBase));
    }
}

template <typename TOper, typename TSimd>
void EvaluateSimdUnary(TOper oper, bool scalar, var_types baseType, TSimd* result, TSimd arg0)
{
    switch (baseType)
    {
        case TYP_FLOAT:
        {
            EvaluateSimdUnary<TOper, TSimd, float>(oper, scalar, result, arg0);
            break;
        }

        case TYP_DOUBLE:
        {
            EvaluateSimdUnary<TOper, TSimd, double>(oper, scalar, result, arg0);
            break;
        }

        case TYP_BYTE:
        {
            EvaluateSimdUnary<TOper, TSimd, int8_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_SHORT:
        {
            EvaluateSimdUnary<TOper, TSimd, int16_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_INT:
        {
            EvaluateSimdUnary<TOper, TSimd, int32_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_LONG:
        {
            EvaluateSimdUnary<TOper, TSimd, int64_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_UBYTE:
        {
            EvaluateSimdUnary<TOper, TSimd, uint8_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_USHORT:
        {
            EvaluateSimdUnary<TOper, TSimd, uint16_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_UINT:
        {
            EvaluateSimdUnary<TOper, TSimd, uint32_t>(oper, scalar, result, arg0);
            break;
        }

        case TYP_ULONG:
        {
            EvaluateSimdUnary<TOper, TSimd, uint64_t>(oper, scalar, result, arg0);
            break;
        }
...
template <typename TOper, typename TSimd, typename TBase>
void EvaluateSimdBinary(TOper oper, bool scalar, TSimd* result, TSimd arg0, TSimd arg1)
{
    uint32_t count = sizeof(TSimd) / sizeof(TBase);
    ...
    for (uint32_t i = 0; i < count; i++)
    {
        ...
        TBase output = static_cast<TBase>(oper(input0, input1));
        memcpy(&result->u8[i * sizeof(TBase)], &output, sizeof(TBase));
    }
}

template <typename TOper, typename TSimd>
void EvaluateSimdBinary(TOper oper, bool scalar, var_types baseType, TSimd* result, TSimd arg0, TSimd arg1)
{
    switch (baseType)
    {
        case TYP_FLOAT:
        {
            EvaluateSimdBinary<TOper, TSimd, float>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_DOUBLE:
        {
            EvaluateSimdBinary<TOper, TSimd, double>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_BYTE:
        {
            EvaluateSimdBinary<TOper, TSimd, int8_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_SHORT:
        {
            EvaluateSimdBinary<TOper, TSimd, int16_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_INT:
        {
            EvaluateSimdBinary<TOper, TSimd, int32_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_LONG:
        {
            EvaluateSimdBinary<TOper, TSimd, int64_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_UBYTE:
        {
            EvaluateSimdBinary<TOper, TSimd, uint8_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_USHORT:
        {
            EvaluateSimdBinary<TOper, TSimd, uint16_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_UINT:
        {
            EvaluateSimdBinary<TOper, TSimd, uint32_t>(oper, scalar, result, arg0, arg1);
            break;
        }

        case TYP_ULONG:
        {
            EvaluateSimdBinary<TOper, TSimd, uint64_t>(oper, scalar, result, arg0, arg1);
            break;
        }
