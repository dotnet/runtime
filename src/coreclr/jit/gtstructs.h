...
GTSTRUCT_2(FlagsCC     , GT_JCC, GT_SETCC)
#if !defined(TARGET_64BIT)
GTSTRUCT_2(OpFlags     , GT_ADD_HI, GT_SUB_HI)
#endif
#if defined(TARGET_ARM64)
GTSTRUCT_N(OpFlagsCC   , GT_SELECTCC, GT_CSNEG, GT_CNEG)
#else
GTSTRUCT_1(OpFlagsCC   , GT_SELECTCC)
#endif
