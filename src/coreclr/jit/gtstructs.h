...
GTSTRUCT_N(Val         , GT_END_LFIN, GT_JMP, GT_RECORD_ASYNC_JOIN, GT_ASYNC_RESUME_TRAMPOLINE)
#else
GTSTRUCT_N(Val         , GT_JMP, GT_RECORD_ASYNC_JOIN, GT_ASYNC_RESUME_TRAMPOLINE)
#endif
