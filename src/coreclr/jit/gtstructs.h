...
GTSTRUCT_0(Op          , GT_OP)
GTSTRUCT_N(Val         , GT_JMP, GT_RECORD_ASYNC_RESUME, GT_ASYNC_RESUME_INFO, GT_CONTINUATION_MEMBER_OFFSET)
...
GTSTRUCT_1(StoreLclVars, GT_STORE_LCL_VARS)
