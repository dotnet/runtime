...
GTSTRUCT_N(Val         , GT_END_LFIN, GT_JMP, GT_RECORD_ASYNC_RESUME, GT_ASYNC_RESUME_INFO)
#else
GTSTRUCT_N(Val         , GT_JMP, GT_RECORD_ASYNC_RESUME, GT_ASYNC_RESUME_INFO)
#endif
...
GTSTRUCT_1(RecordAsyncJoin, GT_RECORD_ASYNC_JOIN)
