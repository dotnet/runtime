...
#define MULTIREG_LAST_USE_SHIFT 26
    ...
    GTF_INX_MUST_NULLCHECK      = 0x20000000, // GT_INDEX_ADDR -- this array must be null checked
...
struct GenTreeIndexAddr : public GenTreeOp
{
    ...
    bool IsNullChecked() const
    {
        return (gtFlags & GTF_INX_MUST_NULLCHECK) != 0;
    }

    bool IsNotNull() const
    {
        return IsBoundsChecked() || IsNullChecked() || ((gtFlags & GTF_INX_ADDR_NONNULL) != 0);
    }
};
