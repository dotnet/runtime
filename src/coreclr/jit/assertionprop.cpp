...
Compiler::fgWalkResult Compiler::optVNConstantPropCurStmt(BasicBlock* block, Statement* stmt, GenTree* tree)
{
    ...
    // Successful propagation, mark as assertion propagated
    // TODO https://github.com/dotnet/runtime/issues/10450: at that moment stmt could be already removed from the stmt
    // list.
