                                                ...
                                                unsigned    innermostLoopNum)
{
    ...
    if (memoryKind == GcHeap)
    {
        ...
        {
            for (Compiler::LoopDsc::FieldHandleSet::Node* const ki : *fieldsMod)
            {
        ...
        {
            for (Compiler::LoopDsc::ClassHandleSet::Node* const ki : *elemTypesMod)
            {
                CORINFO_CLASS_HANDLE elemClsHnd = ki->GetKey();
