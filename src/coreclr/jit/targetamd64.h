...
#define MIN_ARG_AREA_FOR_CALL     (4 * REGSIZE_BYTES)       // Minimum required outgoing argument space for a call.
  ...
  #define RBM_FLT_CALLEE_TRASH_OLD    (RBM_XMM0|RBM_XMM1|RBM_XMM2|RBM_XMM3|RBM_XMM4|RBM_XMM5|RBM_XMM16|RBM_XMM17|RBM_XMM18|RBM_XMM19|RBM_XMM20|RBM_XMM21|RBM_XMM22|RBM_XMM23|RBM_XMM24|RBM_XMM25|RBM_XMM26|RBM_XMM27|RBM_XMM28|RBM_XMM29|RBM_XMM30|RBM_XMM31)
  #define RBM_FLT_CALLEE_TRASH(c) (c->DoJitStressEvexEncoding() ? RBM_FLT_CALLEE_TRASH_OLD : (RBM_FLT_CALLEE_TRASH_OLD & ~RBM_HIGHFLOAT))
#endif // !UNIX_AMD64_ABI
  ...
  #define RBM_CALLEE_TRASH_NOGC(c)   RBM_CALLEE_TRASH(c)

  // Registers killed by CORINFO_HELP_ASSIGN_REF and CORINFO_HELP_CHECKED_ASSIGN_REF.
  #define RBM_CALLEE_TRASH_WRITEBARRIER(c)         RBM_CALLEE_TRASH_NOGC(c)

  // Registers no longer containing GC pointers after CORINFO_HELP_ASSIGN_REF and CORINFO_HELP_CHECKED_ASSIGN_REF.
  #define RBM_CALLEE_GCTRASH_WRITEBARRIER(c)       RBM_CALLEE_TRASH_NOGC(c)

  // Registers killed by CORINFO_HELP_ASSIGN_BYREF.
  #define RBM_CALLEE_TRASH_WRITEBARRIER_BYREF(c)   (RBM_RSI | RBM_RDI | RBM_CALLEE_TRASH_NOGC(c))
  ...
  #define RBM_CALLEE_GCTRASH_WRITEBARRIER_BYREF(c) (RBM_CALLEE_TRASH_NOGC(c) & ~(RBM_RDI | RBM_RSI))
...
#define REG_VAR_ORDER            REG_EAX,REG_EDX,REG_ECX,REG_ESI,REG_EDI,REG_EBX,REG_ETW_FRAMED_EBP_LIST \
  ...
  #define REG_VAR_ORDER_FLT      REG_XMM0,REG_XMM1,REG_XMM2,REG_XMM3,REG_XMM4,REG_XMM5,REG_XMM6,REG_XMM7,REG_XMM8,REG_XMM9,REG_XMM10,REG_XMM11,REG_XMM12,REG_XMM13,REG_XMM14,REG_XMM15,REG_XMM16,REG_XMM17,REG_XMM18,REG_XMM19,REG_XMM20,REG_XMM21,REG_XMM22,REG_XMM23,REG_XMM24,REG_XMM25,REG_XMM26,REG_XMM27,REG_XMM28,REG_XMM29,REG_XMM30,REG_XMM31
...
#define RBM_DOUBLERET_1            RBM_XMM1
  ...
  #define RBM_PROFILER_ENTER_TRASH(c)     RBM_CALLEE_TRASH(c)
  #define RBM_PROFILER_TAILCALL_TRASH(c)  RBM_PROFILER_LEAVE_TRASH(c)
  ...
  #define RBM_STOP_FOR_GC_TRASH(c)     (RBM_CALLEE_TRASH(c) & ~(RBM_FLOATRET | RBM_INTRET | RBM_FLOATRET_1 | RBM_INTRET_1))
  #define RBM_PROFILER_LEAVE_TRASH(c)  (RBM_CALLEE_TRASH(c) & ~(RBM_FLOATRET | RBM_INTRET | RBM_FLOATRET_1 | RBM_INTRET_1))
#else
  // See vm\amd64\asmhelpers.asm for more details.
  #define RBM_STOP_FOR_GC_TRASH(c)     (RBM_CALLEE_TRASH(c) & ~(RBM_FLOATRET | RBM_INTRET))
  #define RBM_PROFILER_LEAVE_TRASH(c)  (RBM_CALLEE_TRASH(c) & ~(RBM_FLOATRET | RBM_INTRET))
#endif

  // The registers trashed by the CORINFO_HELP_INIT_PINVOKE_FRAME helper.
  #define RBM_INIT_PINVOKE_FRAME_TRASH(c)  RBM_CALLEE_TRASH(c)
