...
#define MIN_ARG_AREA_FOR_CALL     (4 * REGSIZE_BYTES)       // Minimum required outgoing argument space for a call.
  ...
  #define RBM_ALLINT_STATIC_ALL         (RBM_INT_CALLEE_SAVED | RBM_INT_CALLEE_TRASH_STATIC_ALL)
...
#define RBM_DOUBLERET_1            RBM_XMM1
  ...
  #define RBM_VALIDATE_INDIRECT_CALL_TRASH_STATIC_ALL (RBM_INT_CALLEE_TRASH_STATIC_ALL & ~(RBM_R10 | RBM_RCX))
