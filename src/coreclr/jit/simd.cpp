...
GenTree* Compiler::createAddressNodeForSIMDInit(GenTree* tree, unsigned simdSize)
{
    ...
    else if (tree->OperGet() == GT_INDEX)
    {
        ...
        GenTreeBoundsChk* arrBndsChk = new (this, GT_BOUNDS_CHECK)
            GenTreeBoundsChk(checkIndexExpr, arrLen, SCK_ARG_RNG_EXCPN);
                                    ...
                                    int                   memberRef)
{
    ...
    switch (simdIntrinsicID)
    {
        ...
        case SIMDIntrinsicCopyToArrayX:
        {
            ...
            GenTreeBoundsChk* argChk = new (this, GT_BOUNDS_CHECK)
                GenTreeBoundsChk(checkIndexExpr, arrLen, op2CheckKind);
