...
void LinearScan::AddDelayFreeUses()
{
    ...
    for (DelayFreeCandidates::Node* const iter : DelayFreeCandidates::KeyValueIteration(delayFreeCandidatesMap))
    {
        RefPosition* useRefPosition = iter->GetKey();
        GenTree*     rmwNode        = iter->GetValue();
