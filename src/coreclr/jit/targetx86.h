...
// clang-format off
  ...
  // See the same defines in targetamd64.h for an explanation of REG_VAR_ORDER_*
  ...
  #define REG_VAR_ORDER_CALLEE_TRASH    REG_EAX,REG_ECX,REG_EDX
  #define REG_VAR_ORDER_CALLEE_SAVED    REG_ESI,REG_EDI,REG_EBX
