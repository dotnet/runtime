...
void CodeGen::genLockedInstructions(GenTreeOp* treeNode)
{
...
#endif // TARGET_ARM64
    {
        ...
        // Emit code like this on arm32:
        //     dmb ish
        //   retry:
        //     ldrex loadReg, [addrReg]
        //     add storeDataReg, loadReg, dataReg      # Only for GT_XADD
        //                                         # GT_XCHG storeDataReg === dataReg
        //     strex tempReg, storeDataReg, [addrReg]
        //     cmp tempReg, 0
        //     bne retry
        //     dmb ish
...
void CodeGen::genCodeForCmpXchg(GenTreeCmpXchg* treeNode)
{
...
#endif // TARGET_ARM64
    {
        ...
        if (comparand->isContainedIntOrIImmed())
        {
            ...
            {
                ssize_t value = comparand->AsIntConCommon()->IconValue();
                assert(value <= TARGET_SSIZE_MAX && value >= TARGET_SSIZE_MIN);
                GetEmitter()->emitIns_R_I(INS_cmp, emitActualTypeSize(treeNode), targetReg, (target_ssize_t)value);
