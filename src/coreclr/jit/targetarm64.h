...
// clang-format off
  ...
  #define RBM_VALIDATE_INDIRECT_CALL_TRASH (RBM_CALLEE_TRASH & ~(RBM_R0 | RBM_R1 | RBM_R2 | RBM_R3 | RBM_R4 | RBM_R5 | RBM_R6 | RBM_R7 | RBM_R8 | RBM_R15 | RBM_V0 | RBM_V1 | RBM_V2 | RBM_V3 | RBM_V4 | RBM_V5 | RBM_V6 | RBM_V7))
  #define REG_VALIDATE_INDIRECT_CALL_ADDR REG_R15
  #define REG_DISPATCH_INDIRECT_CALL_ADDR REG_R15
