...
// clang-format off
  ...
  #define AllRegsMask_PROFILER_ENTER_TRASH     AllRegsMask((RBM_INT_CALLEE_TRASH & ~(RBM_ARG_REGS|RBM_ARG_RET_BUFF|RBM_FP)), (RBM_FLT_CALLEE_TRASH & ~RBM_FLTARG_REGS), RBM_MSK_CALLEE_TRASH)
#else
  #define AllRegsMask_PROFILER_ENTER_TRASH     AllRegsMask((RBM_INT_CALLEE_TRASH & ~(RBM_ARG_REGS|RBM_ARG_RET_BUFF|RBM_FP)), (RBM_FLT_CALLEE_TRASH & ~RBM_FLTARG_REGS) | RBM_MSK_CALLEE_TRASH)
#endif
