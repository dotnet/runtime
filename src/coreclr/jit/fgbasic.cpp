            ...
            case CEE_CALLVIRT:
            {
                ...
                if (isIntrinsic)
                {
                    ...
                    else if (ni != NI_Illegal)
                    {
                        ...
                        // NI_System_String_Concat is excluded: it is only marked [Intrinsic] so it can be
                        // constant-folded later (assertion prop); it should not bias inliner heuristics.
