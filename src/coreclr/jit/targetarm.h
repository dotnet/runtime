...
// clang-format off
  ...
  #define AllRegsMask_STOP_FOR_GC_TRASH     (AllRegsMask_CALLEE_TRASH & Create_AllRegsMask(~(RBM_LNGRET|RBM_R7|RBM_R8|RBM_R11), ~(RBM_DOUBLERET|RBM_F2|RBM_F3|RBM_F4|RBM_F5|RBM_F6|RBM_F7)))
