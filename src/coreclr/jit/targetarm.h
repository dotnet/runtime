...
// clang-format off
  ...
  #define RBM_FLT_CALLEE_TRASH(c)    (RBM_F0|RBM_F1|RBM_F2|RBM_F3|RBM_F4|RBM_F5|RBM_F6|RBM_F7|RBM_F8|RBM_F9|RBM_F10|RBM_F11|RBM_F12|RBM_F13|RBM_F14|RBM_F15)
  ...
  #define RBM_CALLEE_TRASH_NOGC(c)          (RBM_R2|RBM_R3|RBM_LR|RBM_DEFAULT_HELPER_CALL_TARGET)

  // Registers killed by CORINFO_HELP_ASSIGN_REF and CORINFO_HELP_CHECKED_ASSIGN_REF.
  #define RBM_CALLEE_TRASH_WRITEBARRIER(c)         (RBM_R0|RBM_R3|RBM_LR|RBM_DEFAULT_HELPER_CALL_TARGET)

  // Registers no longer containing GC pointers after CORINFO_HELP_ASSIGN_REF and CORINFO_HELP_CHECKED_ASSIGN_REF.
  #define RBM_CALLEE_GCTRASH_WRITEBARRIER(c)       RBM_CALLEE_TRASH_WRITEBARRIER(c)
  ...
  #define RBM_PROFILER_LEAVE_TRASH(c)     RBM_PROFILER_RET_SCRATCH
  #define RBM_PROFILER_TAILCALL_TRASH(c)  RBM_NONE
  ...
  #define RBM_STOP_FOR_GC_TRASH(c)     (RBM_CALLEE_TRASH(c) & ~(RBM_LNGRET|RBM_R7|RBM_R8|RBM_R11|RBM_DOUBLERET|RBM_F2|RBM_F3|RBM_F4|RBM_F5|RBM_F6|RBM_F7))

  // The registers trashed by the CORINFO_HELP_INIT_PINVOKE_FRAME helper.
  #define RBM_INIT_PINVOKE_FRAME_TRASH(c) (RBM_CALLEE_TRASH(c) | RBM_PINVOKE_TCB | RBM_PINVOKE_SCRATCH)
