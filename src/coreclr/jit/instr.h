...
enum insOpts : unsigned
{
    ...
    INS_OPTS_SCALABLE_B_TO_SIMD_VECTOR,
    INS_OPTS_SCALABLE_H_TO_SIMD_VECTOR,
    INS_OPTS_SCALABLE_S_TO_SIMD_VECTOR,
    INS_OPTS_SCALABLE_D_TO_SIMD_VECTOR,

    INS_OPTS_SCALABLE_B_TO_SIMD_SCALAR,
    INS_OPTS_SCALABLE_H_TO_SIMD_SCALAR,
    INS_OPTS_SCALABLE_S_TO_SIMD_SCALAR,
    INS_OPTS_SCALABLE_D_TO_SIMD_SCALAR,
