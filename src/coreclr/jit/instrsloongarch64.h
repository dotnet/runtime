...
INST(rotr_w,        "rotr.w",         0,    0x001b0000,0xffff8000,DF_G_3R)
...
INST(amcas_b,       "amcas_b",        0,    0x38580000,0xffff8000,DF_G_3R) // rd,rk,rj
INST(amcas_h,       "amcas_h",        0,    0x38588000,0xffff8000,DF_G_3R)
INST(amcas_w,       "amcas_w",        0,    0x38590000,0xffff8000,DF_G_3R)
INST(amcas_d,       "amcas_d",        0,    0x38598000,0xffff8000,DF_G_3R)
INST(amswap_b,      "amswap.b",       LD|ST,0x385c0000,0xffff8000,DF_G_3R)
INST(amswap_h,      "amswap.h",       LD|ST,0x385c8000,0xffff8000,DF_G_3R)
INST(amswap_w,      "amswap.w",       LD|ST,0x38600000,0xffff8000,DF_G_3R)
INST(amswap_d,      "amswap.d",       LD|ST,0x38608000,0xffff8000,DF_G_3R)
INST(amadd_b,       "amadd.b",        LD|ST,0x385d0000,0xffff8000,DF_G_3R)
INST(amadd_h,       "amadd.h",        LD|ST,0x385d8000,0xffff8000,DF_G_3R)
INST(amadd_w,       "amadd.w",        LD|ST,0x38610000,0xffff8000,DF_G_3R)
INST(amadd_d,       "amadd.d",        LD|ST,0x38618000,0xffff8000,DF_G_3R)
INST(amand_w,       "amand.w",        LD|ST,0x38620000,0xffff8000,DF_G_3R)
INST(amand_d,       "amand.d",        LD|ST,0x38628000,0xffff8000,DF_G_3R)
INST(amor_w,        "amor.w",         LD|ST,0x38630000,0xffff8000,DF_G_3R)
INST(amor_d,        "amor.d",         LD|ST,0x38638000,0xffff8000,DF_G_3R)
INST(amxor_w,       "amxor.w",        LD|ST,0x38640000,0xffff8000,DF_G_3R)
INST(amxor_d,       "amxor.d",        LD|ST,0x38648000,0xffff8000,DF_G_3R)
INST(ammax_w,       "ammax.w",        LD|ST,0x38650000,0xffff8000,DF_G_3R)
INST(ammax_d,       "ammax.d",        LD|ST,0x38658000,0xffff8000,DF_G_3R)
INST(ammin_w,       "ammin.w",        LD|ST,0x38660000,0xffff8000,DF_G_3R)
INST(ammin_d,       "ammin.d",        LD|ST,0x38668000,0xffff8000,DF_G_3R)
INST(ammax_wu,      "ammax.wu",       LD|ST,0x38670000,0xffff8000,DF_G_3R)
INST(ammax_du,      "ammax.du",       LD|ST,0x38678000,0xffff8000,DF_G_3R)
INST(ammin_wu,      "ammin.wu",       LD|ST,0x38680000,0xffff8000,DF_G_3R)
INST(ammin_du,      "ammin.du",       LD|ST,0x38688000,0xffff8000,DF_G_3R)
INST(amcas_db_b,    "amcas_db_b",     0,    0x385a0000,0xffff8000,DF_G_3R)
INST(amcas_db_h,    "amcas_db.h",     0,    0x385a8000,0xffff8000,DF_G_3R)
INST(amcas_db_w,    "amcas_db.w",     0,    0x385b0000,0xffff8000,DF_G_3R)
INST(amcas_db_d,    "amcas_db.d",     0,    0x385b8000,0xffff8000,DF_G_3R)
INST(amswap_db_b,   "amswap_db.b",    LD|ST,0x385e0000,0xffff8000,DF_G_3R)
INST(amswap_db_h,   "amswap_db.h",    LD|ST,0x385e8000,0xffff8000,DF_G_3R)
INST(amswap_db_w,   "amswap_db.w",    LD|ST,0x38690000,0xffff8000,DF_G_3R)
INST(amswap_db_d,   "amswap_db.d",    LD|ST,0x38698000,0xffff8000,DF_G_3R)
INST(amadd_db_b,    "amadd_db.b",     LD|ST,0x385f0000,0xffff8000,DF_G_3R)
INST(amadd_db_h,    "amadd_db.h",     LD|ST,0x385f8000,0xffff8000,DF_G_3R)
INST(amadd_db_w,    "amadd_db.w",     LD|ST,0x386a0000,0xffff8000,DF_G_3R)
INST(amadd_db_d,    "amadd_db.d",     LD|ST,0x386a8000,0xffff8000,DF_G_3R)
INST(amand_db_w,    "amand_db.w",     LD|ST,0x386b0000,0xffff8000,DF_G_3R)
INST(amand_db_d,    "amand_db.d",     LD|ST,0x386b8000,0xffff8000,DF_G_3R)
INST(amor_db_w,     "amor_db.w",      LD|ST,0x386c0000,0xffff8000,DF_G_3R)
INST(amor_db_d,     "amor_db.d",      LD|ST,0x386c8000,0xffff8000,DF_G_3R)
INST(amxor_db_w,    "amxor_db.w",     LD|ST,0x386d0000,0xffff8000,DF_G_3R)
INST(amxor_db_d,    "amxor_db.d",     LD|ST,0x386d8000,0xffff8000,DF_G_3R)
INST(ammax_db_w,    "ammax_db.w",     LD|ST,0x386e0000,0xffff8000,DF_G_3R)
INST(ammax_db_d,    "ammax_db.d",     LD|ST,0x386e8000,0xffff8000,DF_G_3R)
INST(ammin_db_w,    "ammin_db.w",     LD|ST,0x386f0000,0xffff8000,DF_G_3R)
INST(ammin_db_d,    "ammin_db.d",     LD|ST,0x386f8000,0xffff8000,DF_G_3R)
INST(ammax_db_wu,   "ammax_db.wu",    LD|ST,0x38700000,0xffff8000,DF_G_3R)
INST(ammax_db_du,   "ammax_db.du",    LD|ST,0x38708000,0xffff8000,DF_G_3R)
INST(ammin_db_wu,   "ammin_db.wu",    LD|ST,0x38710000,0xffff8000,DF_G_3R)
INST(ammin_db_du,   "ammin_db.du",    LD|ST,0x38718000,0xffff8000,DF_G_3R)
...
INST(ll_w,          "ll.w",           LD,   0x20000000,0xff000000,DF_G_2R14I)
INST(ll_d,          "ll.d",           LD,   0x22000000,0xff000000,DF_G_2R14I)
...
INST(ldgt_b,        "ldgt.b",         LD,   0x38780000,0xffff8000,DF_G_3R)
INST(ldgt_h,        "ldgt.h",         LD,   0x38788000,0xffff8000,DF_G_3R)
INST(ldgt_w,        "ldgt.w",         LD,   0x38790000,0xffff8000,DF_G_3R)
INST(ldgt_d,        "ldgt.d",         LD,   0x38798000,0xffff8000,DF_G_3R)
INST(ldle_b,        "ldle.b",         LD,   0x387a0000,0xffff8000,DF_G_3R)
INST(ldle_h,        "ldle.h",         LD,   0x387a8000,0xffff8000,DF_G_3R)
INST(ldle_w,        "ldle.w",         LD,   0x387b0000,0xffff8000,DF_G_3R)
INST(ldle_d,        "ldle.d",         LD,   0x387b8000,0xffff8000,DF_G_3R)
...
INST(sc_w,          "sc.w",           ST,   0x21000000,0xff000000,DF_G_2R14I)
INST(sc_d,          "sc.d",           ST,   0x23000000,0xff000000,DF_G_2R14I)
...
INST(stgt_b,        "stgt.b",         ST,   0x387c0000,0xffff8000,DF_G_3R)
INST(stgt_h,        "stgt.h",         ST,   0x387c8000,0xffff8000,DF_G_3R)
INST(stgt_w,        "stgt.w",         ST,   0x387d0000,0xffff8000,DF_G_3R)
INST(stgt_d,        "stgt.d",         ST,   0x387d8000,0xffff8000,DF_G_3R)
INST(stle_b,        "stle.b",         ST,   0x387e0000,0xffff8000,DF_G_3R)
INST(stle_h,        "stle.h",         ST,   0x387e8000,0xffff8000,DF_G_3R)
INST(stle_w,        "stle.w",         ST,   0x387f0000,0xffff8000,DF_G_3R)
INST(stle_d,        "stle.d",         ST,   0x387f8000,0xffff8000,DF_G_3R)
...
INST(vfrecipe_s,        "vfrecipe.s",       0,  0x729d1400,0xfffffc00,DF_S_2R)
INST(vfrecipe_d,        "vfrecipe.d",       0,  0x729d1800,0xfffffc00,DF_S_2R)
INST(vfrsqrte_s,        "vfrsqrte.s",       0,  0x729d2400,0xfffffc00,DF_S_2R)
INST(vfrsqrte_d,        "vfrsqrte.d",       0,  0x729d2800,0xfffffc00,DF_S_2R)
...
// R_R_I_I.
// vd, rj, si8, idx
INST(vstelm_b,          "vstelm.b",         ST, 0x31800000,0xffc00000,DF_S_2R8IX)
INST(vstelm_h,          "vstelm.h",         ST, 0x31400000,0xffe00000,DF_S_2R8IX)
INST(vstelm_w,          "vstelm.w",         ST, 0x31200000,0xfff00000,DF_S_2R8IX)
INST(vstelm_d,          "vstelm.d",         ST, 0x31100000,0xfff80000,DF_S_2R8IX)
...
// si9
INST(vldrepl_d,         "vldrepl.d",        LD, 0x30100000,0xfff80000,DF_S_RGX) // vd,rj,si9
// si10
INST(vldrepl_w,         "vldrepl.w",        LD, 0x30200000,0xfff00000,DF_S_RGX) // vd,rj,si10
// si11
INST(vldrepl_h,         "vldrepl.h",        LD, 0x30400000,0xffe00000,DF_S_RGX) // vd,rj,si11
// si12
INST(vld,               "vld",              LD, 0x2c000000,0xffc00000,DF_S_RGX) // vd,rj,si12
INST(vldrepl_b,         "vldrepl.b",        LD, 0x30800000,0xffc00000,DF_S_RGX)
...
INST(vslti_bu,          "vslti.bu",         0,  0x72880000,0xffff8000,DF_S_2R5IU)
...
INST(xvfrecipe_s,       "xvfrecipe.s",      0,  0x769d1400,0xfffffc00,DF_A_2R)
INST(xvfrecipe_d,       "xvfrecipe.d",      0,  0x769d1800,0xfffffc00,DF_A_2R)
INST(xvfrsqrte_s,       "xvfrsqrte.s",      0,  0x769d2400,0xfffffc00,DF_A_2R)
INST(xvfrsqrte_d,       "xvfrsqrte.d",      0,  0x769d2800,0xfffffc00,DF_A_2R)
...
// R_R_I_I.
// xd, rj, si8, idx
INST(xvstelm_b,         "xvstelm.b",        ST, 0x33800000,0xffc00000,DF_A_RG8IX)
INST(xvstelm_h,         "xvstelm.h",        ST, 0x33400000,0xffe00000,DF_A_RG8IX)
INST(xvstelm_w,         "xvstelm.w",        ST, 0x33200000,0xfff00000,DF_A_RG8IX)
INST(xvstelm_d,         "xvstelm.d",        ST, 0x33100000,0xfff80000,DF_A_RG8IX)
...
// si9
INST(xvldrepl_d,        "xvldrepl.d",       LD, 0x32100000,0xfff80000,DF_A_RGX) // xd,rj,si9
// si10
INST(xvldrepl_w,        "xvldrepl.w",       LD, 0x32200000,0xfff00000,DF_A_RGX) // xd,rj,si10
// si11
INST(xvldrepl_h,        "xvldrepl.h",       LD, 0x32400000,0xffe00000,DF_A_RGX) // xd,rj,si11
// si12
INST(xvld,              "xvld",             LD, 0x2c800000,0xffc00000,DF_A_RGX) // xd,rj,si12
INST(xvldrepl_b,        "xvldrepl.b",       LD, 0x32800000,0xffc00000,DF_A_RGX)
