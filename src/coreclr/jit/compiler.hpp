...
inline GenTree* Compiler::gtNewIconEmbObjHndNode(CORINFO_OBJECT_HANDLE objHnd, CORINFO_CLASS_HANDLE compileTimeHnd)
{
    return gtNewIconEmbHndNode((void*)objHnd, nullptr, GTF_ICON_OBJ_HDL, (void*)compileTimeHnd);
}
