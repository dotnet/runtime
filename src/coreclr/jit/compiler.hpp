...
inline bool Compiler::IsSharedStaticHelper(GenTree* tree)
{
    ...
    bool result1 =
        ...
        helper == CORINFO_HELP_READYTORUN_STATIC_BASE || helper == CORINFO_HELP_READYTORUN_CCTOR_TRIGGER ||
        helper == CORINFO_HELP_READYTORUN_GENERIC_STATIC_BASE || helper == CORINFO_HELP_READYTORUN_STATIC_BASE ||
