...
function(add_pgo TargetName)
    ...
    elseif(CLR_CMAKE_PGO_OPTIMIZE)
        ...
        elseif((NOT (CLR_CMAKE_HOST_LINUX OR CLR_CMAKE_HOST_OSX)) OR CLR_CMAKE_TARGET_ARCH_ARM64 OR CLR_CMAKE_TARGET_ARCH_ARM)
            # Skip PGO on unsupported platforms
            message("PGO optimization is not available for this platform")
        else(CLR_CMAKE_HOST_WIN32)
            if(UPPERCASE_CMAKE_BUILD_TYPE STREQUAL RELEASE OR UPPERCASE_CMAKE_BUILD_TYPE STREQUAL RELWITHDEBINFO)
