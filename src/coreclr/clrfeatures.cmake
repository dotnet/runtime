if (NOT CLR_CMAKE_TARGET_ARCH_WASM AND NOT CLR_CMAKE_TARGET_IOS AND NOT CLR_CMAKE_TARGET_TVOS AND NOT CLR_CMAKE_TARGET_MACCATALYST AND NOT FEATURE_NO_DYNAMIC_CODEGEN)
  set(FEATURE_TIERED_COMPILATION 1)
  set(FEATURE_REJIT 1)
  set(FEATURE_JIT 1)
endif()

if (CLR_CMAKE_TARGET_ARCH_WASM OR CLR_CMAKE_TARGET_IOS OR CLR_CMAKE_TARGET_TVOS OR CLR_CMAKE_TARGET_MACCATALYST OR FEATURE_NO_DYNAMIC_CODEGEN)
...
if(NOT DEFINED FEATURE_NO_DYNAMIC_CODEGEN)
  set(FEATURE_NO_DYNAMIC_CODEGEN 0)
endif(NOT DEFINED FEATURE_NO_DYNAMIC_CODEGEN)
...
if (CLR_CMAKE_TARGET_MACCATALYST OR CLR_CMAKE_TARGET_IOS OR CLR_CMAKE_TARGET_TVOS OR FEATURE_NO_DYNAMIC_CODEGEN)
  set(FEATURE_STUBPRECODE_DYNAMIC_HELPERS 1)
endif()

if (CLR_CMAKE_TARGET_MACCATALYST OR CLR_CMAKE_TARGET_IOS OR CLR_CMAKE_TARGET_TVOS OR CLR_CMAKE_TARGET_ARCH_WASM OR FEATURE_NO_DYNAMIC_CODEGEN)
