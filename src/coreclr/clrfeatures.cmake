...
if(NOT DEFINED FEATURE_INPROC_CRASHREPORT)
  if(CLR_CMAKE_TARGET_ANDROID OR CLR_CMAKE_TARGET_IOS OR CLR_CMAKE_TARGET_TVOS OR CLR_CMAKE_TARGET_MACCATALYST OR CLR_CMAKE_TARGET_LINUX OR CLR_CMAKE_TARGET_OSX)
...
# When set, the in-proc crash reporter registers the PAL signal-path callback and
# thereby replaces the out-of-proc createdump utility as the crash mechanism. Enabled
# only on platforms where createdump is unavailable (mobile). On desktop the wider
# FEATURE_INPROC_CRASHREPORT still compiles the reporter for on-demand use, but the
# signal callback is never registered so createdump remains the crash mechanism.
if(NOT DEFINED FEATURE_INPROC_CRASHREPORT_REPLACE_CREATEDUMP)
  if(FEATURE_INPROC_CRASHREPORT AND (CLR_CMAKE_TARGET_ANDROID OR CLR_CMAKE_TARGET_IOS OR CLR_CMAKE_TARGET_TVOS OR CLR_CMAKE_TARGET_MACCATALYST))
    set(FEATURE_INPROC_CRASHREPORT_REPLACE_CREATEDUMP 1)
  else()
    set(FEATURE_INPROC_CRASHREPORT_REPLACE_CREATEDUMP 0)
  endif()
endif(NOT DEFINED FEATURE_INPROC_CRASHREPORT_REPLACE_CREATEDUMP)
