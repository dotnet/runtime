...
if(CLR_CMAKE_PLATFORM_UNIX_ARM)
    ...
    set(CLR_CMAKE_PLATFORM_ARCH "arm")
elseif(CLR_CMAKE_PLATFORM_UNIX_ARM64)
    set(CLR_CMAKE_PLATFORM_ARCH_ARM64 1)
    set(CLR_CMAKE_PLATFORM_ARCH "arm64")
elseif(CLR_CMAKE_PLATFORM_UNIX_AMD64)
    set(CLR_CMAKE_PLATFORM_ARCH_AMD64 1)
    set(CLR_CMAKE_PLATFORM_ARCH "x64")
elseif(CLR_CMAKE_PLATFORM_UNIX_X86)
    set(CLR_CMAKE_PLATFORM_ARCH_I386 1)
    set(CLR_CMAKE_PLATFORM_ARCH "x86")
elseif(WIN32)
    # CLR_CMAKE_PLATFORM_ARCH is passed in as param to cmake
    if (CLR_CMAKE_PLATFORM_ARCH STREQUAL x64)
        set(CLR_CMAKE_PLATFORM_ARCH_AMD64 1)
    elseif(CLR_CMAKE_PLATFORM_ARCH STREQUAL x86)
        set(CLR_CMAKE_PLATFORM_ARCH_I386 1)
    elseif(CLR_CMAKE_PLATFORM_ARCH STREQUAL arm)
        set(CLR_CMAKE_PLATFORM_ARCH_ARM 1)
    elseif(CLR_CMAKE_PLATFORM_ARCH STREQUAL arm64)
        set(CLR_CMAKE_PLATFORM_ARCH_ARM64 1)
    else()
        clr_unknown_arch()
    endif()
...
if(NOT DEFINED CLR_CMAKE_TARGET_ARCH OR CLR_CMAKE_TARGET_ARCH STREQUAL "" )
  set(CLR_CMAKE_TARGET_ARCH ${CLR_CMAKE_PLATFORM_ARCH})
endif()
...
if (CLR_CMAKE_TARGET_OS STREQUAL CLR_CMAKE_PLATFORM_OS)
    if(NOT(CLR_CMAKE_TARGET_ARCH STREQUAL CLR_CMAKE_PLATFORM_ARCH))
...
if (CLR_CMAKE_PLATFORM_ARCH_AMD64)
  ...
  add_definitions(-DPLATFORM_AMD64)
  add_definitions(-DBIT64)
  add_definitions(-DPLATFORM_BIT64)
...
if (CLR_CMAKE_PLATFORM_UNIX)
  if(CLR_CMAKE_PLATFORM_LINUX)
    if(CLR_CMAKE_PLATFORM_UNIX_AMD64)
      ...
      add_definitions(-DPLATFORM_LINUX64)
    elseif(CLR_CMAKE_PLATFORM_UNIX_ARM)
      message("Detected Linux ARM")
      add_definitions(-DLINUX32)
      add_definitions(-DPLATFORM_LINUX32)
    elseif(CLR_CMAKE_PLATFORM_UNIX_ARM64)
...
if (CLR_CMAKE_TARGET_UNIX)
  ...
  if(CLR_CMAKE_TARGET_LINUX)
    if(CLR_CMAKE_TARGET_UNIX_AMD64)
      add_definitions(-DTARGET_LINUX64)
    elseif(CLR_CMAKE_TARGET_UNIX_ARM)
      add_definitions(-DTARGET_LINUX32)
    elseif(CLR_CMAKE_TARGET_UNIX_ARM64)
      add_definitions(-DTARGET_LINUX64)
    elseif(CLR_CMAKE_TARGET_UNIX_X86)
      add_definitions(-DTARGET_LINUX32)
    else()
      clr_unknown_arch()
    endif()
