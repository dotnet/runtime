    ...
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            using (StreamWriter file = File.CreateText(SOURCE_NAME))
            {
                ...
                file.Write("        // IF YOU NEED TO UPDATE UNICODE VERSION FOLLOW THE GUIDE AT src\coreclr\System.Private.CoreLib\Tools\GenUnicodeProp\Updating-Unicode-Versions.md\n");
