...
namespace System
{
    ...
    public unsafe ref partial struct ArgIterator
    {
        ...
        public ArgIterator(RuntimeArgumentHandle arglist)
        {
            ...
            Init(ThisPtr, cookie, out _);
        }

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "ArgIterator_Init")]
        private static partial void Init(ArgIterator* thisPtr, IntPtr cookie, out QCallExceptionStatus qcallException);
        ...
        public ArgIterator(RuntimeArgumentHandle arglist, void* ptr)
        {
            ...
            if (cookie == 0)
                throw new ArgumentException(SR.InvalidOperation_HandleIsNotInitialized);
            Init(ThisPtr, cookie, ptr, out _);
        }

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "ArgIterator_Init2")]
        private static partial void Init(ArgIterator* thisPtr, IntPtr cookie, void* ptr, out QCallExceptionStatus qcallException);
        ...
        public TypedReference GetNextArg()
        {
            ...
            GetNextArg(ThisPtr, &result, out _);
            return result;
        }

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "ArgIterator_GetNextArg")]
        private static partial void GetNextArg(ArgIterator* thisPtr, TypedReference* pResult, out QCallExceptionStatus qcallException);
        ...
        public TypedReference GetNextArg(RuntimeTypeHandle rth)
        {
            ...
            TypedReference result = default;
            GetNextArg(ThisPtr, new QCallTypeHandle(ref rth), &result, out _);
            return result;
        }

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "ArgIterator_GetNextArg2")]
        private static partial void GetNextArg(ArgIterator* thisPtr, QCallTypeHandle rth, TypedReference* pResult, out QCallExceptionStatus qcallException);
        ...
        {
            return RuntimeTypeHandle.FromIntPtr(GetNextArgType(ThisPtr, out _));
        }

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "ArgIterator_GetNextArgType")]
        private static partial IntPtr GetNextArgType(ArgIterator* thisPtr, out QCallExceptionStatus qcallException);
