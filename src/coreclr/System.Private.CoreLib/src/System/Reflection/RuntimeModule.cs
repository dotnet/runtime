...
namespace System.Reflection
{
    internal class RuntimeModule : Module
    {
        ...
        #region FCalls
        [DllImport(RuntimeHelpers.QCall, EntryPoint = "COMModule_GetType", CharSet = CharSet.Unicode)]
        ...
        [DllImport(RuntimeHelpers.QCall, EntryPoint = "COMModule_GetScopeName")]
        private static extern void GetScopeName(QCallModule module, StringHandleOnStack retString);

        [DllImport(RuntimeHelpers.QCall, EntryPoint = "COMModule_GetFullyQualifiedName")]
