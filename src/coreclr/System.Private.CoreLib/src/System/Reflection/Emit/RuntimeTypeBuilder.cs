...
namespace System.Reflection.Emit
{
    internal sealed partial class RuntimeTypeBuilder : TypeBuilder
    {
        ...
        private static partial void SetParentType(QCallModule module, int tdTypeDef, int tkParent, out QCallException qcallException);

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "TypeBuilder_AddInterfaceImpl")]
        private static partial void AddInterfaceImpl(QCallModule module, int tdTypeDef, int tkInterface, out QCallException qcallException);
        #endregion
        ...
        internal static partial int DefineMethodSpec(QCallModule module, int tkParent, byte[] signature, int sigLength, out QCallException qcallException);
        ...
        internal static partial int DefineEvent(QCallModule module, int tkParent, string name, EventAttributes attributes, int tkEventType, out QCallException qcallException);
        ...
        internal static partial void DefineMethodImpl(QCallModule module, int tkType, int tkBody, int tkDecl, out QCallException qcallException);

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "TypeBuilder_SetMethodImpl")]
        internal static partial void SetMethodImpl(QCallModule module, int tkMethod, MethodImplAttributes MethodImplAttributes, out QCallException qcallException);
        ...
        internal static partial int GetTokenFromSig(QCallModule module, byte[] signature, int sigLength, out QCallException qcallException);

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "TypeBuilder_SetFieldLayoutOffset")]
        internal static partial void SetFieldLayoutOffset(QCallModule module, int fdToken, int iOffset, out QCallException qcallException);

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "TypeBuilder_SetClassLayout")]
        internal static partial void SetClassLayout(QCallModule module, int tk, PackingSize iPackingSize, int iTypeSize, out QCallException qcallException);

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "TypeBuilder_SetConstantValue")]
        private static unsafe partial void SetConstantValue(QCallModule module, int tk, int corType, void* pValue, out QCallException qcallException);

        [LibraryImport(RuntimeHelpers.QCall, EntryPoint = "TypeBuilder_SetPInvokeData", StringMarshalling = StringMarshalling.Utf16)]
        private static partial void SetPInvokeData(QCallModule module, string DllName, string name, int token, int linkFlags, out QCallException qcallException);
        ...
        private static partial void TermCreateClass(QCallModule module, int tk, ObjectHandleOnStack type, out QCallException qcallException);
        #endregion
