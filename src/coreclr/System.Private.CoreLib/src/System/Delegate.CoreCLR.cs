...
namespace System
{
    ...
    public abstract partial class Delegate : ICloneable, ISerializable
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        private extern void DelegateConstruct(object target, nint slot);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern nint GetMulticastInvoke();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern nint GetInvokeMethod();
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern nint AdjustTarget(object target, nint methodPtr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern nint GetCallStub(nint methodPtr);
