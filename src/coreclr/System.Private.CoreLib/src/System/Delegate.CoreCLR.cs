...
namespace System
{
    ...
    public abstract partial class Delegate : ICloneable, ISerializable
    {
        ...
        internal bool IsSpecialDelegate => _invocationCount != 0;
        ...
        {
            ref MulticastDelegate first = ref Unsafe.As<object, MulticastDelegate>(ref MemoryMarshal.GetArrayDataReference(GetObjectArray()));
            return MemoryMarshal.CreateReadOnlySpan(ref first, (int)_invocationCount);
        }

        internal MulticastDelegate GetLastInvocationUnchecked()
        {
            object last = Unsafe.Add(ref MemoryMarshal.GetArrayDataReference(GetObjectArray()), (nuint)_invocationCount - 1);
            return Unsafe.AsAssert<MulticastDelegate>(last);
        }
        ...
        protected virtual MethodInfo GetMethodImpl()
        {
            return _invocationList switch
            {
                ...
                Delegate wrapper => wrapper.Method,
                _ => GetMethodImplUncached()
            };
