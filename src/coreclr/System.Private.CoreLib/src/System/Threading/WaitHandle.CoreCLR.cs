...
namespace System.Threading
{
    public abstract partial class WaitHandle
    {
        ...
        private static partial int WaitOneCore(IntPtr waitHandle, int millisecondsTimeout, [MarshalAs(UnmanagedType.Bool)] bool useTrivialWaits, [MarshalAs(UnmanagedType.Bool)] bool hasAssociatedObject);
