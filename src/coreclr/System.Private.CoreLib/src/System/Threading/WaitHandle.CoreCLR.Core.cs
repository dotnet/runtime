...
namespace System.Threading
{
    public abstract partial class WaitHandle
    {
        ...
        private static extern int WaitOnePortableCore(IntPtr waitHandle, int millisecondsTimeout);

        private static unsafe int WaitMultipleIgnoringSyncContextPortableCore(Span<IntPtr> waitHandles, bool waitAll, int millisecondsTimeout)
        {
        ...
        private static int SignalAndWaitPortableCore(IntPtr waitHandleToSignal, IntPtr waitHandleToWaitOn, int millisecondsTimeout)
        {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern unsafe int WaitMultipleIgnoringSyncContextPortableCore(IntPtr* waitHandles, int numHandles, bool waitAll, int millisecondsTimeout);
