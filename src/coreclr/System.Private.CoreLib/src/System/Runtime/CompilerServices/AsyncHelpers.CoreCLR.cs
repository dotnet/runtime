                ...
                try
                {
                    ...
                    else if (calledTask != null)
                    {
                        if (calledTask is IValueTaskAsTask vtTask)
                        {
                            ...
                            {
                                // ValueTaskSource can be configured to use scheduling context or not.
                                ...
                                // the source of what awaiting frame wants.
                                ...
                                if ((headContinuation.Next!.Flags & continueOnContextFlags) != 0)
                                {
