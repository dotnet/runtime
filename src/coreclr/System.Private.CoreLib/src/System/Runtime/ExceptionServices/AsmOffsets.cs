...
#elif TARGET_ARM64
#if TARGET_UNIX
    public const int SIZEOF__REGDISPLAY = 0x970;
    public const int OFFSETOF__REGDISPLAY__SP = 0x8b8;
    public const int OFFSETOF__REGDISPLAY__ControlPC = 0x8c0;
#else // TARGET_UNIX
    public const int SIZEOF__REGDISPLAY = 0x950;
...
#elif TARGET_ARM64
#if TARGET_UNIX
    public const int SIZEOF__REGDISPLAY = 0x960;
    public const int OFFSETOF__REGDISPLAY__SP = 0x8b0;
    public const int OFFSETOF__REGDISPLAY__ControlPC = 0x8b8;
#else // TARGET_UNIX
...
#endif // TARGET_UNIX
#elif TARGET_ARM
    public const int SIZEOF__REGDISPLAY = 0x400;
    public const int OFFSETOF__REGDISPLAY__SP = 0x3e0;
    public const int OFFSETOF__REGDISPLAY__ControlPC = 0x3e4;
#elif TARGET_X86
    public const int SIZEOF__REGDISPLAY = 0x5f4;
    public const int OFFSETOF__REGDISPLAY__SP = 0x5e8;
    public const int OFFSETOF__REGDISPLAY__ControlPC = 0x5ec;
#elif TARGET_RISCV64
...
#elif TARGET_WASM
    public const int SIZEOF__REGDISPLAY = 0x50;
    public const int OFFSETOF__REGDISPLAY__SP = 0x48;
    public const int OFFSETOF__REGDISPLAY__ControlPC = 0x4c;
#endif
...
#elif TARGET_ARM64
#if TARGET_UNIX
    public const int SIZEOF__PAL_LIMITED_CONTEXT = 0x3a0;
#else // TARGET_UNIX
