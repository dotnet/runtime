...
namespace Internal.Runtime.InteropServices
{
    ...
    public static class InMemoryAssemblyLoader
    {
        ...
        private static bool InitializeIsSupported() => AppContext.TryGetSwitch("System.Runtime.InteropServices.CPlusPlusCLIHostActivation.IsSupported", out bool isSupported) ? isSupported : true;
