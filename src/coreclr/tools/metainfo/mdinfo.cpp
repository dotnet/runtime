...
void MDInfo::DisplayScopeInfo()
{
    ...
    char scopeNameUtf8[STRING_BUFFER_LEN];
...
void MDInfo::DisplayMemberRefInfo(mdMemberRef inMemRef, const char *preFix)
{
    ...
    char memRefNameUtf8[STRING_BUFFER_LEN];
    ULONG nameLen;
    mdToken token;
...
void MDInfo::DisplayModuleRefInfo(mdModuleRef inModuleRef)
{
    ...
    char moduleRefNameUtf8[STRING_BUFFER_LEN];
    ULONG nameLen;
...
void MDInfo::DisplayMethodInfo(mdMethodDef inMethod, DWORD *pflags)
{
    ...
    char memberNameUtf8[STRING_BUFFER_LEN];
    ULONG nameLen;
    DWORD flags;
    PCCOR_SIGNATURE pbSigBlob;
    ULONG ulSigBlob;
...
void MDInfo::DisplayParamInfo(mdParamDef inParamDef)
{
    ...
    char paramNameUtf8[STRING_BUFFER_LEN];
    ULONG nameLen;
    DWORD flags;
    VARIANT defValue;
    DWORD dwCPlusFlags;
...
void MDInfo::DisplayTypeDefProps(mdTypeDef inTypeDef)
{
    ...
    char typeDefNameUtf8[STRING_BUFFER_LEN];
    ULONG nameLen;
    DWORD flags;
    mdToken extends;
...
void MDInfo::DisplayTypeRefInfo(mdTypeRef tr)
{
    ...
    char typeRefNameUtf8[STRING_BUFFER_LEN];
    ULONG nameLen;
...
void MDInfo::DisplayPropertyInfo(mdProperty inProp)
{
    ...
    char        propNameUtf8[STRING_BUFFER_LEN];
    DWORD       flags;
#ifdef FEATURE_COMINTEROP
    VARIANT     defaultValue;
#endif
...
void MDInfo::DisplayEventInfo(mdEvent inEvent)
{
    ...
    char eventNameUtf8[STRING_BUFFER_LEN];
    DWORD flags;
    mdToken eventType;
...
void MDInfo::DisplayCustomAttributeInfo(mdCustomAttribute inValue, const char *preFix)
{
    ...
    char        rcNameUtf8[MAX_CLASS_NAME]; // Name of the type.
...
void MDInfo::DisplayPinvokeInfo(mdToken inToken)
{
    ...
    DWORD flags;
    WCHAR rcImport[512];
    char rcImportUtf8[ARRAY_SIZE(rcImport)];
...
void MDInfo::DisplayAssemblyInfo()
{
    ...
    char            szNameUtf8[STRING_BUFFER_LEN];
