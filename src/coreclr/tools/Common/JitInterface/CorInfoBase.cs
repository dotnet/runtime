...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static CORINFO_CLASS_STRUCT_* _getObjectType(IntPtr thisHandle, IntPtr* ppException, void* typeObj)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getObjectType(typeObj);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[68] = (delegate* unmanaged<IntPtr, IntPtr*, void*, CORINFO_CLASS_STRUCT_*>)&_getObjectType;
            ...
            callbacks[149] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_FIELD_STRUCT_*, ulong*, byte>)&_getReadonlyStaticFieldValue;
            ...
            callbacks[156] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_MODULE_STRUCT_*, CORINFO_MODULE_STRUCT_*, void>)&_addActiveDependency;
