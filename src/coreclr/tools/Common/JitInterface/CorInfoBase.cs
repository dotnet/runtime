...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static UIntPtr _printObjectDescription(IntPtr thisHandle, IntPtr* ppException, void* handle, byte* buffer, UIntPtr bufferSize)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.printObjectDescription(handle, buffer, bufferSize);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[37] = (delegate* unmanaged<IntPtr, IntPtr*, void*, byte*, UIntPtr, UIntPtr>)&_printObjectDescription;
