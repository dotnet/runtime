...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        static CorInfoCallConvExtension _getUnmanagedCallConv(IntPtr thisHandle, IntPtr* ppException, CORINFO_METHOD_STRUCT_* method, CORINFO_SIG_INFO* callSiteSig, byte* pSuppressGCTransition)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getUnmanagedCallConv(method, callSiteSig, pSuppressGCTransition);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[18] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_METHOD_STRUCT_*, CORINFO_SIG_INFO*, byte*, CorInfoCallConvExtension>)&_getUnmanagedCallConv;
