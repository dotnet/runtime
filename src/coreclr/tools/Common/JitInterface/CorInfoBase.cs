...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static int _objectToString(IntPtr thisHandle, IntPtr* ppException, void* handle, char* buffer, int bufferSize)
        {
            var _this = GetThis(thisHandle);
            try
            {
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[37] = (delegate* unmanaged<IntPtr, IntPtr*, void*, char*, int, int>)&_objectToString;
