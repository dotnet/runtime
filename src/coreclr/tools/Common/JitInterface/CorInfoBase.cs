...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        static UIntPtr _getIsClassInitedFieldAddress(IntPtr thisHandle, IntPtr* ppException, CORINFO_CLASS_STRUCT_* cls, int* pIsInitedMask)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getIsClassInitedFieldAddress(cls, ref *pIsInitedMask);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[14] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CLASS_STRUCT_*, int*, UIntPtr>)&_getIsClassInitedFieldAddress;
