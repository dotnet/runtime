        ...
        public static IEnumerable<InstructionSetInfo> ArchitectureToValidInstructionSets(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    yield return new InstructionSetInfo("avx512v2", "AvxIfma_V512", InstructionSet.X64_AVX512v2, true);
                ...
                case TargetArchitecture.X86:
                    ...
                    yield return new InstructionSetInfo("avx512v2", "AvxIfma_V512", InstructionSet.X86_AVX512v2, true);
    ...
    public static class InstructionSetParser
    {
        ...
        public static IEnumerable<MetadataType> LookupPlatformIntrinsicTypes(TypeSystemContext context, InstructionSet instructionSet)
        {
            switch ((instructionSet, context.Target.Architecture))
            {
                ...
                {
                    var parentType = context.SystemModule.GetType("System.Runtime.Intrinsics.X86"u8, "AvxIfma"u8, false);
                    if (parentType != null)
                    {
                        yield return parentType;
