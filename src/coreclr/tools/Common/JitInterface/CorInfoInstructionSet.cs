...
namespace Internal.JitInterface
{
    public enum InstructionSet
    {
        ...
        X64_AVX512_VBMI_VL = InstructionSet_X64.AVX512_VBMI_VL,
        ...
        X64_AVX512_VBMI_VL_X64 = InstructionSet_X64.AVX512_VBMI_VL_X64,
        ...
        X86_AVX512_VBMI_VL = InstructionSet_X86.AVX512_VBMI_VL,
        ...
        X86_AVX512_VBMI_VL_X64 = InstructionSet_X86.AVX512_VBMI_VL_X64,
    }
        ...
        public static InstructionSetFlags ExpandInstructionSetByImplicationHelper(TargetArchitecture architecture, InstructionSetFlags input)
        {
            ...
            do
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    if (resultflags.HasInstructionSet(InstructionSet.X64_AVX512_VBMI_VL))
                        resultflags.AddInstructionSet(InstructionSet.X64_AVX512_VBMI_VL_X64);
                    if (resultflags.HasInstructionSet(InstructionSet.X64_AVX512_VBMI_VL_X64))
                        resultflags.AddInstructionSet(InstructionSet.X64_AVX512_VBMI_VL);
                    if (resultflags.HasInstructionSet(InstructionSet.X64_SSE))
                        resultflags.AddInstructionSet(InstructionSet.X64_X86Base);
                    if (resultflags.HasInstructionSet(InstructionSet.X64_SSE2))
                        resultflags.AddInstructionSet(InstructionSet.X64_SSE);
                ...
                case TargetArchitecture.X86:
                    ...
                    if (resultflags.HasInstructionSet(InstructionSet.X86_AVX512_VBMI_VL))
        ...
        private static InstructionSetFlags ExpandInstructionSetByReverseImplicationHelper(TargetArchitecture architecture, InstructionSetFlags input)
        {
            ...
            do
            {
                ...
                case TargetArchitecture.X86:
                    ...
                    if (resultflags.HasInstructionSet(InstructionSet.X86_AVX512BW_VL))
                        resultflags.AddInstructionSet(InstructionSet.X86_AVX512_VBMI_VL);
                    break;
                }
            } while (!oldflags.Equals(resultflags));
        ...
        public static IEnumerable<InstructionSetInfo> ArchitectureToValidInstructionSets(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    yield return new InstructionSetInfo("avx512_vbmi", "Avx512_VBMI", InstructionSet.X64_AVX512_VBMI, true);
                    yield return new InstructionSetInfo("avx512_vbmi_vl", "Avx512_VBMI_VL", InstructionSet.X64_AVX512_VBMI_VL, true);
                    break;
                ...
                case TargetArchitecture.X86:
                    ...
                    yield return new InstructionSetInfo("avx512_vbmi", "Avx512_VBMI", InstructionSet.X86_AVX512_VBMI, true);
                    yield return new InstructionSetInfo("avx512_vbmi_vl", "Avx512_VBMI_VL", InstructionSet.X86_AVX512_VBMI_VL, true);
                    break;
            }
        }
        ...
        public void Set64BitInstructionSetVariants(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    if (HasInstructionSet(InstructionSet.X64_AVX512_VBMI_VL))
                        AddInstructionSet(InstructionSet.X64_AVX512_VBMI_VL_X64);
                    break;
        ...
        public void Set64BitInstructionSetVariantsUnconditionally(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X86:
                    ...
                    AddInstructionSet(InstructionSet.X86_AVX512_VBMI_VL_X64);
                    break;
            }
        }
    }
