        ...
        public static IEnumerable<InstructionSetInfo> ArchitectureToValidInstructionSets(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    yield return new InstructionSetInfo("sse", "Sse", InstructionSet.X64_X86Base, true);
                    yield return new InstructionSetInfo("sse2", "Sse2", InstructionSet.X64_X86Base, true);
                ...
                case TargetArchitecture.X86:
                    ...
                    yield return new InstructionSetInfo("sse", "Sse", InstructionSet.X86_X86Base, true);
                    yield return new InstructionSetInfo("sse2", "Sse2", InstructionSet.X86_X86Base, true);
