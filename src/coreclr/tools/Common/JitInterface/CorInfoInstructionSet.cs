        ...
        private static Dictionary<(string, TargetArchitecture), string> AllInstructionSetGroups { get; } = new()
            {
                ...
                { ("x86-x64-v3", TargetArchitecture.X64),   "x86-x64-v2 avx2 bmi bmi2 lznct pclmul movbe fma" },
                { ("x86-x64-v3", TargetArchitecture.X86),   "x86-x64-v2 avx2 bmi bmi2 lznct pclmul movbe fma" },
                { ("skylake",    TargetArchitecture.X64),   "x86-x64-v2 avx2 bmi bmi2 lznct pclmul movbe fma" },
                { ("skylake",    TargetArchitecture.X86),   "x86-x64-v2 avx2 bmi bmi2 lznct pclmul movbe fma" },
                { ("x86-x64-v4", TargetArchitecture.X64),   "x86-x64-v3" },
                { ("x86-x64-v4", TargetArchitecture.X86),   "x86-x64-v3" },
