...
namespace Internal.JitInterface
{
    public enum InstructionSet
    {
        ...
        X64_EVEX_X64 = InstructionSet_X64.EVEX_X64,
        ...
        X64_APX_X64 = InstructionSet_X64.APX_X64,
        ...
        X86_EVEX_X64 = InstructionSet_X86.EVEX_X64,
        ...
        X86_APX_X64 = InstructionSet_X86.APX_X64,
    }
            ...
            do
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    if (resultflags.HasInstructionSet(InstructionSet.X64_EVEX))
                        resultflags.AddInstructionSet(InstructionSet.X64_EVEX_X64);
                    ...
                    if (resultflags.HasInstructionSet(InstructionSet.X64_APX))
                        resultflags.AddInstructionSet(InstructionSet.X64_APX_X64);
                    if (resultflags.HasInstructionSet(InstructionSet.X64_APX_X64))
                        resultflags.AddInstructionSet(InstructionSet.X64_APX);
                    if (resultflags.HasInstructionSet(InstructionSet.X64_SSE))
                        resultflags.AddInstructionSet(InstructionSet.X64_X86Base);
                    if (resultflags.HasInstructionSet(InstructionSet.X64_SSE2))
                        resultflags.AddInstructionSet(InstructionSet.X64_SSE);
        ...
        public void Set64BitInstructionSetVariants(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X64:
                    ...
                    if (HasInstructionSet(InstructionSet.X64_EVEX))
                        AddInstructionSet(InstructionSet.X64_EVEX_X64);
                    ...
                    if (HasInstructionSet(InstructionSet.X64_APX))
        ...
        public void Set64BitInstructionSetVariantsUnconditionally(TargetArchitecture architecture)
        {
            switch (architecture)
            {
                ...
                case TargetArchitecture.X86:
                    ...
                    AddInstructionSet(InstructionSet.X86_EVEX_X64);
                    ...
                    AddInstructionSet(InstructionSet.X86_APX_X64);
                    break;
            }
        }
    }
        ...
        public static InstructionSet LookupPlatformIntrinsicInstructionSet(TargetArchitecture targetArch, TypeDesc intrinsicType)
        {
            ...
            switch (targetArch)
            {
                ...
                switch (typeName)
                {
                    ...
                    case "Apx":
                        if (nestedTypeName == "X64")
                        { return InstructionSet.X64_APX_X64; }
                        else
