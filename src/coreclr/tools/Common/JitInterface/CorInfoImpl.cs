...
namespace Internal.JitInterface
{
    internal unsafe sealed partial class CorInfoImpl
    {
        ...
        private void getEEInfo(ref CORINFO_EE_INFO pEEInfoOut)
        {
            ...
            pEEInfoOut.osType = _compilation.NodeFactory.Target.IsWindows ? CORINFO_OS.CORINFO_WINNT : 
                                _compilation.NodeFactory.Target.IsOSX ? CORINFO_OS.CORINFO_MACOS : CORINFO_OS.CORINFO_UNIX;
        }
