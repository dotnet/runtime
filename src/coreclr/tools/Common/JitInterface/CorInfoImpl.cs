...
#pragma warning restore CA1822 // Mark members as static
        ...
        private RelocType GetRelocType(CorInfoReloc reloc)
            => reloc switch
            {
                ...
                CorInfoReloc.WASM_FUNCTION_INDEX_LEB => RelocType.IMAGE_REL_WASM_FUNCTION_INDEX_LEB,
                CorInfoReloc.WASM_TABLE_INDEX_SLEB => RelocType.IMAGE_REL_WASM_TABLE_INDEX_SLEB,
                CorInfoReloc.WASM_TABLE_INDEX_I32 => RelocType.IMAGE_REL_WASM_TABLE_INDEX_I32,
                CorInfoReloc.WASM_MEMORY_ADDR_LEB => RelocType.IMAGE_REL_WASM_MEMORY_ADDR_LEB,
                CorInfoReloc.WASM_MEMORY_ADDR_SLEB => RelocType.IMAGE_REL_WASM_MEMORY_ADDR_SLEB,
                CorInfoReloc.WASM_MEMORY_ADDR_I32 => RelocType.IMAGE_REL_WASM_MEMORY_ADDR_I32,
                CorInfoReloc.WASM_TYPE_INDEX_LEB => RelocType.IMAGE_REL_WASM_TYPE_INDEX_LEB,
                CorInfoReloc.WASM_GLOBAL_INDEX_LEB => RelocType.IMAGE_REL_WASM_GLOBAL_INDEX_LEB,
                CorInfoReloc.WASM_EVENT_INDEX_LEB => RelocType.IMAGE_REL_WASM_EVENT_INDEX_LEB,
                CorInfoReloc.WASM_TABLE_NUMBER_LEB => RelocType.IMAGE_REL_WASM_TABLE_NUMBER_LEB,
