...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static byte _getObjectContent(IntPtr thisHandle, IntPtr* ppException, CORINFO_OBJECT_STRUCT_* obj, byte* buffer, int bufferSize, int valueOffset, ObjectContentType* type)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getObjectContent(obj, buffer, bufferSize, valueOffset, type) ? (byte)1 : (byte)0;
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[141] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_OBJECT_STRUCT_*, byte*, int, int, ObjectContentType*, byte>)&_getObjectContent;
