...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static void _getTlsIndexInfo(IntPtr thisHandle, IntPtr* ppException, CORINFO_CONST_LOOKUP* addr)
        {
            var _this = GetThis(thisHandle);
            try
            {
                _this.getTlsIndexInfo(ref *addr);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[95] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CONST_LOOKUP*, void>)&_getTlsRootInfo;
            callbacks[96] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CONST_LOOKUP*, void>)&_getTlsIndexInfo;
            callbacks[97] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CONST_LOOKUP*, void>)&_getThreadStaticBaseSlowInfo;
            callbacks[98] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CLASS_STRUCT_*, CORINFO_CONST_LOOKUP*, CORINFO_CONST_LOOKUP*, int>)&_getEnsureClassCtorRunAndReturnThreadStaticBaseHelper;
