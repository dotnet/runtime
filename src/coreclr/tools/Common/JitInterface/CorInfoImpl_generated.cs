...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static uint _getNonGCThreadLocalFieldInfo(IntPtr thisHandle, IntPtr* ppException, CORINFO_FIELD_STRUCT_* field)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getNonGCThreadLocalFieldInfo(field);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        [UnmanagedCallersOnly]
        private static uint _getGCThreadLocalFieldInfo(IntPtr thisHandle, IntPtr* ppException, CORINFO_FIELD_STRUCT_* field)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getGCThreadLocalFieldInfo(field);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[98] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_FIELD_STRUCT_*, uint>)&_getNonGCThreadLocalFieldInfo;
            callbacks[99] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_FIELD_STRUCT_*, uint>)&_getGCThreadLocalFieldInfo;
