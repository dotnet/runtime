...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static void _getTlsRootInfo(IntPtr thisHandle, IntPtr* ppException, CORINFO_CONST_LOOKUP* addr)
        {
            var _this = GetThis(thisHandle);
            try
            {
                _this.getTlsRootInfo(ref *addr);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        [UnmanagedCallersOnly]
        private static void _getThreadStaticBaseSlowInfo(IntPtr thisHandle, IntPtr* ppException, CORINFO_CONST_LOOKUP* addr)
        {
            var _this = GetThis(thisHandle);
            try
            {
                _this.getThreadStaticBaseSlowInfo(ref *addr);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
