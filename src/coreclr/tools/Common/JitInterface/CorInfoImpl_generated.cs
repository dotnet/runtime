...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        private struct ICorJitInfoCallbacks
        {
            ...
            public delegate* unmanaged<IntPtr, IntPtr*, CORINFO_METHOD_STRUCT_*, byte, CORINFO_LOOKUP*, CORINFO_METHOD_STRUCT_*> getAwaitReturnCall;
        ...
        [UnmanagedCallersOnly]
        private static CORINFO_METHOD_STRUCT_* _getAwaitReturnCall(IntPtr thisHandle, IntPtr* ppException, CORINFO_METHOD_STRUCT_* callerHandle, byte transparent, CORINFO_LOOKUP* instArg)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getAwaitReturnCall(callerHandle, transparent != 0, ref *instArg);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
