...
namespace Internal.IL
{
    ...
    public class KnownILStubReferences
    {
        ...
        /// </summary>
        public static List<TypeSystemEntity> ExtractReferencesFromIL(MethodIL methodIL)
        {
            ...
            {
                TypeDesc localType = local.Type;
                if (localType is TypeDesc ecmaType)
                {
                    references.Add(ecmaType);
                }
            }
