...
namespace System.CommandLine
{
    ...
    internal static partial class Helpers
    {
        ...
        public static string[] ValidOS { get; } = ["windows", "linux", "linux-musl", "linux-bionic", "freebsd", "openbsd", "osx", "maccatalyst", "ios", "iossimulator", "tvos", "tvossimulator", "android", "browser", "wasi"];
        ...
        public static TargetOS GetTargetOS(string token)
        {
            ...
            {
                "linux" or "linux-musl" or "linux-bionic" or "android" => TargetOS.Linux,
        ...
        public static (TargetArchitecture, TargetOS, TargetAbi) GetTargetSpec(string targetArchitectureToken, string targetOSToken)
        {
            ...
            TargetAbi targetAbi = (targetOSToken, targetArchitectureToken) switch
            {
                ...
                ("linux-bionic", "arm") => TargetAbi.NativeAotArmel,
