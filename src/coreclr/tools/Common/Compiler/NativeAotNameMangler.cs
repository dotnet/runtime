...
namespace ILCompiler
{
    public class NativeAotNameMangler : NameMangler
    {
        ...
        private Utf8String ComputeMangledFieldName(FieldDesc field)
        {
            ...
            if (field is EcmaField)
            {
                ...
                lock (this)
                {
                    if (!_mangledFieldNames.ContainsKey(field))
                    {
                        ...
                        {
                            sb.Clear().Append(prependTypeName).Append("__field__"u8);
            ...
            Utf8String utf8MangledName = new Utf8StringBuilder().Append(prependTypeName).Append("__field__"u8).Append(mangledName).ToUtf8String();
