...
#if NET11_0       
		public const string TFMDirectoryName = "net11.0";
#elif NET10_0
		public const string TFMDirectoryName = "net10.0";
#elif NET9_0
...
#error "Unknown TFM"
        ...
        public static string GetTestsSourceRootDirectory ([CallerFilePath] string? thisFile = null)
		{
			...
			return Path.GetFullPath (Path.Combine (GetArtifactsBinDirectory (), "..", "..", "src", "coreclr", "tools", "ILTrim"));
#else
