...
namespace ILTrim.DependencyAnalysis
{
    ...
    /// </summary>
    public class ObjectGetTypeFlowDependenciesNode : DependencyNodeCore<NodeFactory>
    {
        private readonly EcmaType _type;

        public ObjectGetTypeFlowDependenciesNode(EcmaType type)
        {
            _type = type;
        }
        ...
        public override IEnumerable<DependencyListEntry> GetStaticDependencies(NodeFactory factory)
        {
            ...
            return ILCompiler.Dataflow.ReflectionMethodBodyScanner.ProcessTypeGetTypeDataflow(factory, factory.FlowAnnotations, factory.Logger, _type);
        }
