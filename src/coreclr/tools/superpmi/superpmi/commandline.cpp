                               ...
                               LightWeightMap<DWORD, DWORD>** pForceJitOptions)
{
    ...
    DWORD keyIndex =
        (DWORD)targetjitOptions->AddBuffer((unsigned char*)key, sizeof(WCHAR) * ((unsigned int)minipal_u16_strlen((const CHAR16_T*)key) + 1));
    DWORD valueIndex =
        (DWORD)targetjitOptions->AddBuffer((unsigned char*)value, sizeof(WCHAR) * ((unsigned int)minipal_u16_strlen((const CHAR16_T*)value) + 1));
