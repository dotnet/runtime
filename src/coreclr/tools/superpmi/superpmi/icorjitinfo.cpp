...
CORINFO_METHOD_HANDLE MyICJI::getAwaitReturnCall(CORINFO_METHOD_HANDLE callerHandle, CORINFO_CONTEXT_HANDLE callerContext, CORINFO_LOOKUP* instArg)
{
    jitInstance->mc->cr->AddCall("getAwaitReturnCall");
    return jitInstance->mc->repGetAwaitReturnCall(callerHandle, callerContext, instArg);
}
