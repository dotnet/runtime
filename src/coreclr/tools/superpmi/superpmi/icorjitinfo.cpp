...
void MyICJI::expandRawHandleIntrinsic(CORINFO_RESOLVED_TOKEN*       pResolvedToken,
                                      CorInfoLookupIntrinsicType    type,
                                      CORINFO_METHOD_HANDLE         callerHandle,
                                      CORINFO_GENERICHANDLE_RESULT* pResult)
{
    jitInstance->mc->cr->AddCall("expandRawHandleIntrinsic");
    jitInstance->mc->repExpandRawHandleIntrinsic(pResolvedToken, type, callerHandle, pResult);
}
