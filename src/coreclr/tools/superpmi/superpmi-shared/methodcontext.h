...
public:
    ...
    void recGetAwaitReturnCall(CORINFO_METHOD_HANDLE callerHnd, bool transparent, CORINFO_LOOKUP* instArg, CORINFO_METHOD_HANDLE methHnd);
    void dmpGetAwaitReturnCall(DLD key, Agnostic_GetAwaitReturnCallResult& value);
    CORINFO_METHOD_HANDLE repGetAwaitReturnCall(CORINFO_METHOD_HANDLE callerHnd, bool transparent, CORINFO_LOOKUP* instArg);
