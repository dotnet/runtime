...
LWM(GetThreadLocalStaticInfo_ReadyToRun, DWORDLONG, Agnostic_GetThreadStaticInfo_ReadyToRun)
LWM(GetTlsRootInfo, DWORD, Agnostic_CORINFO_CONST_LOOKUP)
LWM(GetTlsIndexInfo, DWORD, Agnostic_CORINFO_CONST_LOOKUP)
LWM(GetThreadStaticBaseSlowInfo, DWORD, Agnostic_CORINFO_CONST_LOOKUP)
LWM(GetEnsureClassCtorRunAndReturnThreadStaticBaseHelper, DWORDLONG, Agnostic_GetClassCtorInitializationInfo)
