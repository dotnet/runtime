                        ...
                        else if (popped.ValueKind == StackValueKind.Float)
                        {
                            ...
                            switch (opcode)
                            {
                                ...
                                case ILOpcode.conv_u:
                                    ...
                                    break;
                                case ILOpcode.conv_i1:
                                    stack.Push(StackValueKind.Int32, ValueTypeValue.FromInt32((sbyte)(int)Math.Clamp(double.IsNaN(val) ? 0 : val, sbyte.MinValue, sbyte.MaxValue)));
                                    break;
                                case ILOpcode.conv_i2:
                                    stack.Push(StackValueKind.Int32, ValueTypeValue.FromInt32((short)(int)Math.Clamp(double.IsNaN(val) ? 0 : val, short.MinValue, short.MaxValue)));
                                    break;
                                case ILOpcode.conv_i4:
                                    stack.Push(StackValueKind.Int32, ValueTypeValue.FromInt32((int)val));
                                    break;
                                case ILOpcode.conv_i8:
                                    ...
                                    break;
                                case ILOpcode.conv_u1:
                                    stack.Push(StackValueKind.Int32, ValueTypeValue.FromInt32((byte)(int)Math.Clamp(double.IsNaN(val) ? 0 : val, byte.MinValue, byte.MaxValue)));
                                    break;
                                case ILOpcode.conv_u2:
                                    stack.Push(StackValueKind.Int32, ValueTypeValue.FromInt32((ushort)(int)Math.Clamp(double.IsNaN(val) ? 0 : val, ushort.MinValue, ushort.MaxValue)));
                                    break;
                                case ILOpcode.conv_u4:
