        ...
        public static void GetEntryPoint(TypeSystemContext context, ReadyToRunHelper id, out string mangledName, out MethodDesc methodDesc)
        {
            ...
            switch (id)
            {
                ...
                case ReadyToRunHelper.MonitorEnter:
                    methodDesc = context.GetCoreLibEntryPoint("System.Threading"u8, "Monitor"u8, "SynchronizedMethodEnter"u8);
                    break;
                case ReadyToRunHelper.MonitorExit:
                    methodDesc = context.GetCoreLibEntryPoint("System.Threading"u8, "Monitor"u8, "SynchronizedMethodExit"u8);
                    break;
