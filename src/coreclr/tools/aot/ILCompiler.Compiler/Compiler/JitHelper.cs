    ...
    internal static class JitHelper
    {
        ...
        public static void GetEntryPoint(TypeSystemContext context, ReadyToRunHelper id, out string mangledName, out MethodDesc methodDesc)
        {
            ...
            switch (id)
            {
                ...
                case ReadyToRunHelper.AsyncHelpers_AsyncCallContinuation:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("AsyncCallContinuation"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_TaskFromException:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("TaskFromException"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_ValueTaskFromException:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("ValueTaskFromException"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_FinalizeTaskReturningThunk:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("FinalizeTaskReturningThunk"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_FinalizeValueTaskReturningThunk:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("FinalizeValueTaskReturningThunk"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_TransparentAwait:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("TransparentAwait"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_CompletedTask:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("CompletedTask"u8, null);
                    break;
                case ReadyToRunHelper.AsyncHelpers_CompletedTaskResult:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "AsyncHelpers"u8).GetKnownMethod("CompletedTaskResult"u8, null);
                    break;

                case ReadyToRunHelper.ExecutionAndSyncBlockStore_Push:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "ExecutionAndSyncBlockStore"u8).GetKnownMethod("Push"u8, null);
                    break;
                case ReadyToRunHelper.ExecutionAndSyncBlockStore_Pop:
                    methodDesc = context.SystemModule.GetKnownType("System.Runtime.CompilerServices"u8, "ExecutionAndSyncBlockStore"u8).GetKnownMethod("Pop"u8, null);
                    break;

                case ReadyToRunHelper.Task_FromResult:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "Task"u8).GetKnownMethod("FromResult"u8, null);
                    break;
                case ReadyToRunHelper.Task_get_CompletedTask:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "Task"u8).GetKnownMethod("get_CompletedTask"u8, null);
                    break;
                case ReadyToRunHelper.Task_get_IsCompleted:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "Task"u8).GetKnownMethod("get_IsCompleted"u8, null);
                    break;
                case ReadyToRunHelper.Task_get_Result:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "Task`1"u8).GetKnownMethod("get_Result"u8, null);
                    break;

                case ReadyToRunHelper.ValueTask_FromResult:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "ValueTask"u8).GetKnownMethod("FromResult"u8, null);
                    break;
                case ReadyToRunHelper.ValueTask_get_CompletedTask:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "ValueTask"u8).GetKnownMethod("get_CompletedTask"u8, null);
                    break;
                case ReadyToRunHelper.ValueTask_get_IsCompleted:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "ValueTask"u8).GetKnownMethod("get_IsCompleted"u8, null);
                    break;
                case ReadyToRunHelper.ValueTask_ThrowIfCompletedUnsuccessfully:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "ValueTask"u8).GetKnownMethod("ThrowIfCompletedUnsuccessfully"u8, null);
                    break;
                case ReadyToRunHelper.ValueTask_AsTaskOrNotifier:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "ValueTask"u8).GetKnownMethod("AsTaskOrNotifier"u8, null);
                    break;
                case ReadyToRunHelper.ValueTask_get_Result:
                    methodDesc = context.SystemModule.GetKnownType("System.Threading.Tasks"u8, "ValueTask`1"u8).GetKnownMethod("get_Result"u8, null);
                    break;
