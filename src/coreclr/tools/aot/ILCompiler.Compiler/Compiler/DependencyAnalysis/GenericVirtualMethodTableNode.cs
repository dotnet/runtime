...
namespace ILCompiler.DependencyAnalysis
{
    ...
    public sealed class GenericVirtualMethodTableNode : ObjectNode, ISymbolDefinitionNode
    {
        ...
        /// </summary>
        public static void GetGenericVirtualMethodImplementationDependencies(DependencySink<NodeFactory> dependencies, NodeFactory factory, MethodDesc callingMethod, MethodDesc implementationMethod)
        {
