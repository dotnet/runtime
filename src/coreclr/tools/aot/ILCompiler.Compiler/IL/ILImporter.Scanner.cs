    ...
    internal partial class ILImporter
    {
        ...
        public (DependencyList, CombinedDependencyList) Import()
        {
            ...
            if (_canonMethod.IsSynchronized)
            {
                ...
                {
                    _dependencies.Add(_compilation.NodeFactory.MethodEntrypoint(_compilation.NodeFactory.TypeSystemContext.GetCoreLibEntryPoint("System.Threading"u8, "Monitor"u8, "GetSyncObjectFromClassHandle"u8)), reason);
                    ...
                    if (_canonMethod.IsCanonicalMethod(CanonicalFormKind.Any))
                    {
                        if (_canonMethod.RequiresInstMethodDescArg())
                            _dependencies.Add(_compilation.NodeFactory.MethodEntrypoint(_compilation.NodeFactory.TypeSystemContext.GetCoreLibEntryPoint("System.Threading"u8, "Monitor"u8, "GetClassHandleFromMethodParam"u8)), reason);
                    }
                }
            }
