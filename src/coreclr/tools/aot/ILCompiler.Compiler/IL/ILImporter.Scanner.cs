        ...
        private void ImportCall(ILOpcode opcode, int token)
        {
                ...
                && _canonMethod.IsAsyncCall())
            {
                ...
                if (!_asyncDependenciesReported && method.IsAsync)
                {
                    ...
                    var resumptionStub = ((CompilerTypeSystemContext)_canonMethod.Context).GetAsyncResumptionStub(_canonMethod, _compilation.TypeSystemContext.GeneratedAssembly.GetGlobalModuleType());
