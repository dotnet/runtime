...
namespace ILCompiler
{
    internal class Crossgen2RootCommand : RootCommand
    {
        ...
        public static void PrintExtendedHelp(ParseResult _)
        {
            ...
            string[] ValidArchitectures = new string[] {"arm", "armel", "arm64", "x86", "x64", "riscv64", "loongarch64", "wasm"};
            string[] ValidOS = new string[] {"windows", "linux", "osx", "ios", "iossimulator", "maccatalyst", "wasi"};
