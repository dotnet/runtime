        ...
        private int Run(string[] args)
        {
            using (PerfEventSource.StartStopEvents.CompilationEvents())
            {
                ...
                using (PerfEventSource.StartStopEvents.LoadingEvents())
                {
                    ...
                    switch (_commandLineOptions.CallChainOptimizationMethod?.ToLower())
                    {
                        case null:
                        case "none":
                            callChainOptimizationMethod = CallChainOptimizationMethod.None;
                            break;

                        case "sort":
                            callChainOptimizationMethod = CallChainOptimizationMethod.Sort;
                            break;

                        default:
                            throw new CommandLineException(string.Format(SR.UnsupportedCallChainOptimizationMethod, _commandLineOptions.CallChainOptimizationMethod));
                    }
