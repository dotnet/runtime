...
namespace ILCompiler
{
    internal sealed class ILCompilerRootCommand : RootCommand
    {
        ...
        public Option<string[]> FatExeLibrary { get; } =
            new("--fatexe") { Description = "Specify fat executable library entrypoint modules (format: 'assemblyName=MainEntryPointName')" };
