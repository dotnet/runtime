    ...
    public class InheritedVirtualMethodsNode : DependencyNodeCore<NodeFactory>
    {
        ...
        public override IEnumerable<CombinedDependencyListEntry> GetConditionalStaticDependencies(NodeFactory factory)
        {
            ...
            foreach (MethodDesc decl in defType.EnumAllVirtualSlots())
            {
                ...
                // Given we are scanning for GVMs here, if the type has no generic type arguments
                // or they are Canon, they should already be included in the compilation, given
                // we should compile all non-generic methods and the canonicalized versions.
