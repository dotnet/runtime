...
namespace ILCompiler
{
    ...
    public partial class ReadyToRunCompilerContext : CompilerTypeSystemContext
    {
        ...
        /// </summary>
        public LayoutInt CalculateFieldBaseOffset(MetadataType type) => _r2rFieldLayoutAlgorithm.CalculateFieldBaseOffset(type, type.RequiresAlign2xPtr(), requiresAlignedBase: true);
