...
struct JitInterfaceCallbacks
{
    ...
    CORINFO_METHOD_HANDLE (* getAwaitReturnCall)(void * thisHandle, CorInfoExceptionClass** ppException, CORINFO_METHOD_HANDLE callerHandle, bool transparent, CORINFO_LOOKUP* instArg);
...
{
    CorInfoExceptionClass* pException = nullptr;
    CORINFO_METHOD_HANDLE temp = _callbacks->getAwaitReturnCall(_thisHandle, &pException, callerHandle, transparent, instArg);
    if (pException != nullptr) throw pException;
    return temp;
}
