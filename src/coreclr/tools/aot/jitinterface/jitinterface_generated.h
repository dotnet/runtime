...
struct JitInterfaceCallbacks
{
    ...
    CORINFO_WASM_TYPE_SYMBOL_HANDLE (* getWasmTypeSymbol)(void * thisHandle, CorInfoExceptionClass** ppException, CorInfoType* types);
...
{
    CorInfoExceptionClass* pException = nullptr;
    CORINFO_WASM_TYPE_SYMBOL_HANDLE temp = _callbacks->getWasmTypeSymbol(_thisHandle, &pException, types);
    if (pException != nullptr) throw pException;
    return temp;
}
