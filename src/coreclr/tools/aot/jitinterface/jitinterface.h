...
struct JitInterfaceCallbacks
{
    ...
    void (* getFunctionFixedEntryPoint)(void * thisHandle, CorInfoExceptionClass** ppException, CORINFO_METHOD_HANDLE ftn, bool prepareForFPtr, CORINFO_CONST_LOOKUP* pResult);
...
{
    CorInfoExceptionClass* pException = nullptr;
    _callbacks->getFunctionFixedEntryPoint(_thisHandle, &pException, ftn, prepareForFPtr, pResult);
    if (pException != nullptr) throw pException;
}
