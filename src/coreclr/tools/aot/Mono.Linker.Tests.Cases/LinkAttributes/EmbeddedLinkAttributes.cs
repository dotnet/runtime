...
namespace Mono.Linker.Tests.Cases.LinkAttributes
{
	...
	class EmbeddedLinkAttributes
	{
		...
		[ExpectedWarning ("IL2077", nameof (DataFlowTypeExtensions) + "." + nameof (DataFlowTypeExtensions.RequiresPublicParameterlessConstructor), ProducedBy = ProducedBy.NativeAot)]
		...
		[ExpectedWarning ("IL2077", nameof (DataFlowTypeExtensions) + "." + nameof (DataFlowTypeExtensions.RequiresPublicConstructors))]
		[ExpectedWarning ("IL2077", nameof (DataFlowTypeExtensions) + "." + nameof (DataFlowTypeExtensions.RequiresPublicFields), ProducedBy = ProducedBy.NativeAot)]
