...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	public class MethodThisDataFlow
	{
		...
		[ExpectedWarning ("IL2065", nameof (MethodThisDataFlowTypeTest) + "." + nameof (MethodThisDataFlowTypeTest.RequireThisNonPublicMethods), "'this'", ProducedBy = ProducedBy.Trimmer | ProducedBy.NativeAot)]
