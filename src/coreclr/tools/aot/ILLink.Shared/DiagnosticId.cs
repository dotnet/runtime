...
namespace ILLink.Shared
{
	public enum DiagnosticId
	{
		...
		MissingArgumentForCommandLineOptionName = 1018,
		...
		XmlCouldNotFindGetAccessorOfPropertyOnType = 2018,
		XmlCouldNotFindSetAccessorOfPropertyOnType = 2019,
