...
#define OPDEF(c,s,pop,push,args,type,l,s1,s2,ctrl) { s, args, c, MINIPAL_LENGTHOF(s)-1 },
#define OPALIAS(alias_c, s, c) { s, NO_VALUE, c, MINIPAL_LENGTHOF(s)-1 },
#include "opcode.def"
#undef OPALIAS
#undef OPDEF

                /* keywords */
#define KYWD(name, sym, val)    { name, sym, val, MINIPAL_LENGTHOF(name)-1 },
#include "il_kywd.h"
#undef KYWD
