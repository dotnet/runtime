...
const char *DumpMD_DumpRawNameOfType(RegMeta *pMD, ULONG iType)
{
    ...
    // default:
    static char buf[30];
    sprintf_s(buf, MINIPAL_LENGTHOF(buf), "unknown type 0x%02x", iType);
    return buf;
    ...
    RegMeta     *pMD)                   // The scope to dump.
{
    ...
    do
    {
        ...
        sprintf_s(rcPrefix, MINIPAL_LENGTHOF(rcPrefix), "%5x,%-2x", oData, cbData);
    ...
    do
    {
        ...
        sprintf_s(rcPrefix, MINIPAL_LENGTHOF(rcPrefix), "%08x", oData);
