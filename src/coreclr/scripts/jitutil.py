...
def require_azure_storage_libraries(need_azure_storage_blob=True, need_azure_identity=True):
    ...
    if not azure_storage_blob_import_ok or not azure_identity_import_ok:
        ...
        logging.error("See also https://learn.microsoft.com/en-us/azure/storage/blobs/storage-quickstart-blobs-python")
...
def report_azure_error():
    ...
    logging.error("Install the Azure CLI from https://learn.microsoft.com/en-us/cli/azure/install-azure-cli.")
