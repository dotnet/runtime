...
def main(main_args):
    ...
    if coreclr_args.collection_name == "benchmarks" or coreclr_args.collection_name == "realworld":
        ...
        if coreclr_args.collection_type == "nativeaot":
            ...
            run_command([os.path.join(tests_directory, tests_build_file), "nativeaot", arch, coreclr_args.build_type, "tree", "nativeaot/SmokeTests", "skipnative"], source_directory)
