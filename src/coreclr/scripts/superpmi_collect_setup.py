...
parser.add_argument("-collection_name", required=True, help="Name of the SPMI collection to be done (e.g., libraries, libraries_tests, coreclr_tests, benchmarks, aspnet2, sourcegit, corelib)")
...
def main(main_args):
    ...
    elif coreclr_args.collection_name == "aspnet2" or coreclr_args.collection_name == "sourcegit":
        # Nothing to prepare for aspnet2/sourcegit, their scripts are fully self-contained.
