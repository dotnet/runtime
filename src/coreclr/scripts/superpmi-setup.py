...
# | Arch  | windows                           | Linux                                                                                                                                |
# |-------|-----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
# | x86   | Windows.10.Amd64.CoreAppCompat.Pr | -                                                                                                                                    |
# | x64   | Windows.10.Amd64.CoreAppCompat.Pr | Ubuntu.1804.Amd64                                                                                                                    |
...
def main(main_args):
    ...
    ci = True
    if is_windows:
        helix_queue = "Windows.10.Arm64" if arch == "arm64" else "Windows.10.Amd64.CoreAppCompat.Pr"
    else:
        if arch == "arm":
