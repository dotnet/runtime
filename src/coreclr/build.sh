...
build_CoreLib()
{
    ...
    if [[ "$__BuildManagedTools" -eq "1" ]]; then
        ...
        "$__RepoRootDir/dotnet.sh" publish --self-contained -r $__DistroRid -c $__BuildType -o "$__BinDir/crossgen2" "$__ProjectRoot/src/tools/crossgen2/crossgen2/crossgen2.csproj" /nologo /p:ArchGroup=$__BuildArch
