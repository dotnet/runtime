...
function(generate_data_descriptors)
  ...
  if (NOT CDAC_BUILD_TOOL_BINARY_PATH)
    ...
    add_custom_command(
      ...
      VERBATIM
      COMMAND dotnet ${CDAC_BUILD_TOOL_BINARY_PATH} compose -i "${CONTRACT_DESCRIPTOR_INPUT}" -o "${CONTRACT_DESCRIPTOR_OUTPUT}" -b "${CONTRACT_BASELINE_DIR}" $<TARGET_OBJECTS:${INTERMEDIARY_LIBRARY}>
