...
For dispatch token and map implementation details, please see [clr/src/vm/contractImpl.h](/src/coreclr/vm/contractimpl.h) and [clr/src/vm/contractImpl.cpp](/src/coreclr/vm/contractimpl.cpp).

For virtual stub dispatch implementation details, please see [clr/src/vm/virtualcallstub.h](/src/coreclr/vm/virtualcallstub.h) and [clr/src/vm/virtualcallstub.cpp](/src/coreclr/vm/virtualcallstub.cpp).
