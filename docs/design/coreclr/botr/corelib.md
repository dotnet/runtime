...
[qcall-entrypoints]: /src/coreclr/vm/qcallentrypoints.cpp
...
Setting a breakpoint inside an FCall implementation may confuse the epilog walker. It leads to an "Invalid breakpoint in a helpermethod frame epilog" assert inside [vm\i386\gmsx86.cpp](/src/coreclr/vm/i386/gmsx86.cpp).
...
[ecalllist]: /src/coreclr/vm/ecalllist.h
...
[corelib.h]: /src/coreclr/vm/corelib.h
...
[object.h]: /src/coreclr/vm/object.h
