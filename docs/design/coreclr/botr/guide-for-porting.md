...
-   Throughput performance at this time is likely to be not that great. There
    ...
    -   Tune the assembly stubs generate to be high performance on the platform,
...
1.  Calling convention rules – Caller pop vs Callee pop, HFA arguments,
    ...
    small set of tweaks extensions to the ABI for VM efficiency purposes, but it
...
3.  System.Private.CoreLib/System.Reflection. There is little to no architecture
...
2.  Features which are only enabled on certain architectures. Eg. FEATURE_HFA.

3.  Adhoc \#if blocks used for specific architectures. As needed these are
