...
Small primitive arguments follow the platform ABI. As an example small primitive arguments are sign/zero extended to 32 bits on ARM32 and Apple ARM64, while upper bits are left undefined for other ARM64 platforms and on win-x64 and SysV x64.
