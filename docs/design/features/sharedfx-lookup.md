...
The exact algorithm how versions as matched is described (with some history) in the [docs](https://learn.microsoft.com/en-us/dotnet/core/tools/global-json#matching-rules)
