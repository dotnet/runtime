...
Assembly are found by looking through probing paths in a certain order. The first found matching assembly wins, and that location will be passed to coreclr. For example:
