...
| SEH | Structured Exception Handling - Microsoft extension to C see [details](https://docs.microsoft.com/en-us/cpp/cpp/structured-exception-handling-c-cpp) |
...
| TFM | [Target Framework Moniker](https://docs.microsoft.com/en-us/dotnet/standard/frameworks) such as `net6.0` or `wpa81`. |
