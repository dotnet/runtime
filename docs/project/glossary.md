...
| SEH | [Structured Exception Handling](https://docs.microsoft.com/en-us/windows/win32/debug/structured-exception-handling). Unified mechanism for handling hardware and software exceptions on Windows. |
...
| TFM | [Target Framework Moniker](https://docs.microsoft.com/en-us/dotnet/standard/frameworks) such as `net6.0` or `netstandard2.0`. |
