...
|  __`SYSLIB0066`__ | Implement IAsyncStartupValidator instead. |
...
|  __`SYSLIB1105`__ | Configuration binding generator: an opted-in property converter, init-only setter, or required-member initialization cannot be handled statically and requires reflection. This is an error for Native AOT or trimmed publishing. |
