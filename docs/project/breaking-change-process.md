...
* [Breaking changes](/docs/coding-guidelines/breaking-changes.md)
* [Breaking change definitions](/docs/coding-guidelines/breaking-change-definitions.md)
* [Breaking change rules](/docs/coding-guidelines/breaking-change-rules.md)
