...
```
dotnet msbuild System.Net.ServicePoint.Tests.csproj /t:rebuildandtest /p:BuildTargetFramework=netcoreapp2.0 /p:OuterLoop=true /p:xunitoptions=-showprogress /p:ConfigurationGroup=Debug
```
