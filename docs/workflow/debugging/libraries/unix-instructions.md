...
- Install SOS and lldb. See https://github.com/dotnet/diagnostics/blob/main/documentation/sos.md and https://learn.microsoft.com/en-us/dotnet/core/diagnostics/dotnet-sos for setup instructions.
