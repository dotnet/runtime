...
8. Set `Environment=CORE_LIBRARIES=$(SolutionDir)\..\..\..\..\bin\runtime\<target-framework>-windows-$(Configuration)-$(Platform)`, where '\<target-framework\>' is the target framework of current branch: `net12.0`. A few notes on this step:
...
```json
    {
      ...
      "environment": [
        ...
        {
          "name": "CORE_LIBRARIES",
          // for example netXY.0-windows-debug-x64
