...
|-------|------|-------------|
| `id` | long | Unique graph identifier (allows multiple graphs in one trace) |
...
| Field | Type | Description |
|-------|------|-------------|
| `id` | long | Identifier of the graph this node belongs to |
| `index` | long | Unique node identifier within the graph |
...
| Field | Type | Description |
|-------|------|-------------|
| `id` | long | Identifier of the graph this edge belongs to |
| `dependentIndex` | long | Source node (the one that depends on the target) |
| `dependencyIndex` | long | Target node (the dependency) |
...
| Field | Type | Description |
|-------|------|-------------|
| `id` | long | Identifier of the graph this conditional edge belongs to |
| `dependencyIndex` | long | The dependency node |
| `dependentIndex1` | long | First dependent node |
| `dependentIndex2` | long | Second dependent node |
