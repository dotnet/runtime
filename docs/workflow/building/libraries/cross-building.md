...
Build artifacts can be found in `artifacts/bin/native/net12.0-<TargetOS>-<BuildArch>-<BuildType>/`:

    $ ls artifacts/bin/native/net12.0-Linux-Release-arm/*
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Globalization.Native.a
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Globalization.Native.so
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Globalization.Native.so.dbg
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.IO.Compression.Native.a
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.IO.Compression.Native.so
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.IO.Compression.Native.so.dbg
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.IO.Ports.Native.a
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.IO.Ports.Native.so
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.IO.Ports.Native.so.dbg
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Native.a
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Native.so
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Native.so.dbg
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Net.Security.Native.a
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Net.Security.Native.so
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Net.Security.Native.so.dbg
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Security.Cryptography.Native.OpenSsl.a
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Security.Cryptography.Native.OpenSsl.so
    artifacts/bin/native/net12.0-Linux-Release-arm/libSystem.Security.Cryptography.Native.OpenSsl.so.dbg

    $ file artifacts/bin/native/net12.0-linux-release-arm/libSystem.Native.so
    artifacts/bin/native/net12.0-linux-release-arm/libSystem.Native.so: ELF 32-bit LSB shared object, ARM, EABI5 version 1 (SYSV), dynamically linked, BuildID[sha1]=5f6f6f9c4012dffed133624867adf32ac2af130d, stripped
...
Build artifacts can be found in `artifacts/bin/microsoft.netcore.app.runtime.<TargetOS>-<BuildArch>/<BuildType>/runtimes/<TargetOS>-<BuildArch>/lib/net12.0/`. For more details on the build configurations see [project-guidelines](/docs/coding-guidelines/project-guidelines.md).
