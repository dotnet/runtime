...
```
dotnet test artifacts/bin/HostActivation.Tests/Debug/net12.0/HostActivation.Tests.dll --filter category!=failing
```
...
```
dotnet test artifacts/bin/HostActivation.Tests/Debug/net12.0/HostActivation.Tests.dll --filter "DependencyResolution&category!=failing"
```
