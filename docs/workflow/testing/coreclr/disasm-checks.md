...
- `<check-prefix>-FULL-LINE-NEXT:` - same as using FileCheck's `<check-prefix>-NEXT:`, but checks that line matches exactly; leading and trailing whitespace is ignored.