...
[safemath.h]: /src/coreclr/inc/safemath.h
...
[objecthandle.h]: /src/coreclr/gc/objecthandle.h
[handletable.h]: /src/coreclr/gc/handletable.h
...
[holder.h]: /src/coreclr/inc/holder.h
...
[sstring.h]: /src/coreclr/inc/sstring.h
...
Because of this, we have gathered definition all of the "blessed" CLR types in a single header file, [clrtypes.h](/src/coreclr/inc/clrtypes.h). In general, you should only use primitive types which are defined in this file. As an exception, you may use built-in primitive types like int and short when precision isn't particularly interesting.
...
This item asserts that the function may invoke the loader and cause a type to loaded up to (and including) the indicated loadlevel. Valid load levels are taken from ClassLoadLevel enumerationin [classLoadLevel.h](/src/coreclr/vm/classloadlevel.h).
...
[contract.h]: /src/coreclr/inc/contract.h
...
- The best documentation is in the code itself. See the large comments at the top of [src\inc\daccess.h](/src/coreclr/inc/daccess.h).
