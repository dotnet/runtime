...
- `$(BuildTargetFramework) -> Any .NETCoreApp or .NETFramework TFM, e.g. netXY.0`
...
2. If nothing is passed to the build then we will default value of these properties from the environment. Example: `netXY.0-[TargetOS Running On]-Debug-x64`.
